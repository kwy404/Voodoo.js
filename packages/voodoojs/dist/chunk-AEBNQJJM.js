import { http, HttpError, request } from './chunk-7JP5EGZM.js';
...
import { ref, reactive, handleError, nextTick, queuePostFlush, warn, watch, EffectScope, computed, effect, toRaw, flushSync, effectScope, stop, unref, markRaw, watchEffect, shallowRef, setErrorHandler } from './chunk-3MG773JD.js';
import { warnDuplicateKey, warn as warn$1, describeElement, warnUnknownComponent, warnAlias, warnRequiredProp } from './chunk-3DK5HG37.js';
import { parseDuration, debounce, utils_exports, throttle, uid, device, escapeHtml } from './chunk-WA7IIJWH.js';
import { injectStyle, ensureTokens } from './chunk-VWD2BQ7Y.js';
import { defineDirective, config, PRIORITY, directives, normalizeComponentName, components, usePlugin } from './chunk-U5C24RIK.js';
...
function injectJSONStyles() {
  ...
  void import('./style-BTYP46QK.js').then(({ injectStyle: injectStyle2 }) => {
    injectStyle2(
      "json-render",
      `
...
//# sourceMappingURL=chunk-AEBNQJJM.js.map
//# sourceMappingURL=chunk-AEBNQJJM.js.map