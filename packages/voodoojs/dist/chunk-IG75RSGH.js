import { http, HttpError, request } from './chunk-TSCMFRF6.js';
...
import { ref, reactive, handleError, nextTick, queuePostFlush, warn, watch, EffectScope, computed, effect, toRaw, flushSync, effectScope, stop, unref, markRaw, watchEffect, shallowRef, setErrorHandler } from './chunk-KBGRB5IB.js';
import { warnDuplicateKey, warn as warn$1, describeElement, warnUnknownComponent, warnAlias, warnRequiredProp } from './chunk-VE7SPUTF.js';
import { parseDuration, debounce, utils_exports, throttle, uid, device, escapeHtml } from './chunk-JOALQ5UO.js';
import { injectStyle, ensureTokens } from './chunk-OBBELEY5.js';
import { defineDirective, config, PRIORITY, directives, normalizeComponentName, components, usePlugin } from './chunk-LKPICJ77.js';
import { __publicField } from './chunk-P4MQN45W.js';
...
function createApp(options = {}) {
  ...
  function mountOn(el) {
    ...
    if (instance) {
      const queue2 = waiting;
      waiting = [];
      for (const resolver of queue2) resolver(instance);
    }
    return instance;
  }
  const app = {
...
function injectJSONStyles() {
  ...
  void import('./style-4I3OU23W.js').then(({ injectStyle: injectStyle2 }) => {
    injectStyle2(
      "json-render",
      `
...
//# sourceMappingURL=chunk-IG75RSGH.js.map
//# sourceMappingURL=chunk-IG75RSGH.js.map