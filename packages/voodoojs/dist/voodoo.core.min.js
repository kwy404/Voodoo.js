...
`});var Uc={};Vt(Uc,{default:()=>Bc});Z();var L=class extends Error{constructor(n,r,o){let s=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${s}`);M(this,"source",r);M(this,"position",o);this.name="VoodooSyntaxError"}},Ri=[">>>=","===","!==","**=","...",">>>","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","&=","|=","^=","<<",">>","+","-","*","/","%","!","<",">","=","&","|","^","~","(",")","[","]","{","}",",",".","?",":",";"],Ci=/[A-Za-z_$À-￿]/,Pi=/[A-Za-z0-9_$À-￿]/;function Mi(e){return Ci.test(e)}function Li(e){return Pi.test(e)}function Xt(e){return e>="0"&&e<="9"}var ro={n:`
...
`;function bs(e){let t=e.name||"v-fade";return{enterFrom:e.enterFrom||`${t}-enter-from`,enterActive:e.enterActive||`${t}-enter-active`,enterTo:e.enterTo||`${t}-enter-to`,leaveFrom:e.leaveFrom||`${t}-leave-from`,leaveActive:e.leaveActive||`${t}-leave-active`,leaveTo:e.leaveTo||`${t}-leave-to`}}function pt(e,t){for(let n of t.split(/\s+/).filter(Boolean))e.classList.add(n)}function mt(e,t){for(let n of t.split(/\s+/).filter(Boolean))e.classList.remove(n)}function ws(e){let t=getComputedStyle(e),n=r=>Math.max(0,...r.split(",").map(o=>parseFloat(o)*(o.includes("ms")?1:1e3)||0));return Math.max(n(t.transitionDuration)+n(t.transitionDelay),n(t.animationDuration)+n(t.animationDelay))}function Ts(e){requestAnimationFrame(()=>requestAnimationFrame(e))}function Ot(e,t={}){Ee("transitions",vs);let n=bs(t);return Be.reducedMotion?Promise.resolve():new Promise(r=>{pt(e,n.enterFrom),pt(e,n.enterActive),Ts(()=>{var i;mt(e,n.enterFrom),pt(e,n.enterTo);let o=(i=t.duration)!=null?i:ws(e),s=()=>{mt(e,n.enterActive),mt(e,n.enterTo),r()};o<=0?s():setTimeout(s,o+20)})})}function $t(e,t={}){Ee("transitions",vs);let n=bs(t);return Be.reducedMotion?Promise.resolve():new Promise(r=>{pt(e,n.leaveFrom),pt(e,n.leaveActive),Ts(()=>{var i;mt(e,n.leaveFrom),pt(e,n.leaveTo);let o=(i=t.duration)!=null?i:ws(e),s=()=>{mt(e,n.leaveActive),mt(e,n.leaveTo),r()};o<=0?s():setTimeout(s,o+20)})})}function Ht(e,t=240){return new Promise(n=>{e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display="block");let r=e.scrollHeight;e.style.overflow="hidden",e.style.height="0px",e.style.paddingTop="0px",e.style.paddingBottom="0px",e.style.transition=`height ${t}ms var(--v-ease, ease), padding ${t}ms var(--v-ease, ease)`,requestAnimationFrame(()=>{e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.height=`${r}px`}),setTimeout(()=>{e.style.removeProperty("height"),e.style.removeProperty("overflow"),e.style.removeProperty("transition"),n()},t+20)})}function Dt(e,t=240){return new Promise(n=>{e.style.height=`${e.scrollHeight}px`,e.style.overflow="hidden",e.style.transition=`height ${t}ms var(--v-ease, ease), padding ${t}ms var(--v-ease, ease)`,requestAnimationFrame(()=>{e.style.height="0px",e.style.paddingTop="0px",e.style.paddingBottom="0px"}),setTimeout(()=>{e.style.display="none",e.style.removeProperty("height"),e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("overflow"),e.style.removeProperty("transition"),n()},t+20)})}function wn(e,t=220){return new Promise(n=>{e.style.opacity="0",e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display=""),e.style.transition=`opacity ${t}ms ease`,requestAnimationFrame(()=>{e.style.opacity="1"}),setTimeout(()=>{e.style.removeProperty("transition"),e.style.removeProperty("opacity"),n()},t+20)})}function Tn(e,t=220){return new Promise(n=>{e.style.transition=`opacity ${t}ms ease`,e.style.opacity="0",setTimeout(()=>{e.style.display="none",e.style.removeProperty("transition"),e.style.removeProperty("opacity"),n()},t+20)})}function xs(e){let t=document;typeof t.startViewTransition=="function"&&!Be.reducedMotion?t.startViewTransition(e):e()}Z();re();function Ka(e,t,n){try{let o={t:"assign",op:"=",target:le(e),value:{t:"lit",v:n}};x(o,t)}catch(r){$(r,`assignment in "${e}"`)}}function Rs(e){let t=w.prefix,n=e.hasAttribute(`${t}transition`),r=e.hasAttribute(`${t}enter-class`)||e.hasAttribute(`${t}leave-class`)||e.hasAttribute(`${t}enter-active-class`)||e.hasAttribute(`${t}leave-active-class`);if(!n&&!r)return null;let o=e.getAttribute(`${t}transition`)||"fade";return{name:o.startsWith("v-")?o:`v-${o}`,enterFrom:e.getAttribute(`${t}enter-class`)||void 0,enterActive:e.getAttribute(`${t}enter-active-class`)||void 0,enterTo:e.getAttribute(`${t}enter-to-class`)||void 0,leaveFrom:e.getAttribute(`${t}leave-class`)||void 0,leaveActive:e.getAttribute(`${t}leave-active-class`)||void 0,leaveTo:e.getAttribute(`${t}leave-to-class`)||void 0,duration:e.hasAttribute(`${t}duration`)?_(e.getAttribute(`${t}duration`)):void 0}}A("text",({el:e,effect:t,evaluate:n})=>{t(()=>{e.textContent=ye(n());let r=e.firstChild;r&&r.nodeType===3&&ur(r)})});A("html",e=>{let{el:t,effect:n,evaluate:r,scope:o}=e;Io(t),n(()=>{let s=r();for(let i of Array.from(t.children))H(i);t.innerHTML=s==null?"":String(s);for(let i of Array.from(t.children))j(i,o)})});A("show",({el:e,effect:t,evaluate:n})=>{let r=e.style.display==="none"?"":e.style.display,o=!0,s=Rs(e);t(()=>{let i=!!n();if(o){o=!1,e.style.display=i?r:"none";return}if(!s){e.style.display=i?r:"none";return}i?(e.style.display=r,Ot(e,s)):$t(e,s).then(()=>{e.style.display="none"})})});A("if",({el:e,scope:t,expression:n,effect:r})=>{var p;let o=w.prefix,s=[{expression:n,template:e}],i=e.nextElementSibling;for(;i;)if(i.hasAttribute(`${o}else-if`))s.push({expression:i.getAttribute(`${o}else-if`)||"false",template:i}),i=i.nextElementSibling;else if(i.hasAttribute(`${o}else`)){s.push({expression:null,template:i}),i=i.nextElementSibling;break}else break;let a=document.createComment(w.devtools?` v-if: ${n} `:"");(p=e.parentNode)==null||p.insertBefore(a,e);for(let d of s)lr(d.template),d.template.removeAttribute(`${o}if`),d.template.removeAttribute(`${o}else-if`),d.template.removeAttribute(`${o}else`),ur(d.template);let c=Rs(e),u=-1,l=[],f=()=>{let d=l;if(l=[],!d.length)return;let m=()=>{for(let g of d)H(g),g.remove()};c&&d[0]instanceof HTMLElement?$t(d[0],c).then(m):m()};r(()=>{let d=-1;for(let h=0;h<s.length;h++){let y=s[h];if(y.expression===null||O(y.expression,t,"v-if")){d=h;break}}if(d===u||(u=d,f(),d===-1))return;let m=s[d].template,g=Cs(m,a,t);l=g,c&&g[0]instanceof HTMLElement&&Ot(g[0],c)}),fe(e,f)},{priority:U.IF,terminal:!0});function Cs(e,t,n,r){let o=t.parentNode;if(!o)return[];let s=[];if(e.tagName==="TEMPLATE"){let i=e.content.cloneNode(!0),a=Array.from(i.childNodes);o.insertBefore(i,t);for(let c of a)s.push(c),c.nodeType===1&&(At(c,n),j(c,n))}else{let i=e.cloneNode(!0);s.push(i),At(i,n),r?(r.fragment.appendChild(i),r.pending.push([i,n])):(o.insertBefore(i,t),j(i,n))}return s}A("else-if",()=>{},{priority:U.IF,terminal:!0});A("else",()=>{},{priority:U.IF,terminal:!0});var Ga=/^\s*\(?\s*([^)]*?)\s*\)?\s+(?:in|of)\s+(.+?)\s*$/;A("for",({el:e,scope:t,expression:n,effect:r})=>{var h;let o=Ga.exec(n);if(!o){$(new Error(`Invalid syntax in v-for="${n}". Use "item in items".`),"v-for");return}let s=o[1].split(",").map(y=>y.trim()).filter(Boolean),i=o[2],[a,c,u]=s,l=w.prefix,f=e.getAttribute(":key")||e.getAttribute(`${l}bind:key`)||e.getAttribute(`${l}key`),p=document.createComment(w.devtools?` v-for: ${n} `:"");(h=e.parentNode)==null||h.insertBefore(p,e);let d=e.cloneNode(!0);d.removeAttribute(`${l}for`),d.removeAttribute(":key"),d.removeAttribute(`${l}bind:key`),d.removeAttribute(`${l}key`),lr(e);let m=[];fe(p,()=>{for(let y of m)for(let S of y.nodes)H(S),S.remove();m=[]}),r(()=>{var W,P,ee;let y=O(i,t,"v-for"),S=Ya(y,a,c,u),V=new Map;for(let q of m)V.set(q.key,q);let k=[],v=new Set,I={fragment:document.createDocumentFragment(),pending:[]};S.forEach((q,T)=>{let b=f?O(f,t.child(q),":key"):`__index_${T}`;f&&v.has(b)&&xo(e,b,n);let R=V.get(b);if(R&&!v.has(b)){v.add(b);for(let[di,fi]of Object.entries(q))R.data[di]=fi;k.push(R);return}let Me=t.reactiveChild(q),Mn=Cs(d,p,Me,I);v.add(b),k.push({key:b,scope:Me,nodes:Mn,data:Me.data})}),I.fragment.firstChild&&((W=p.parentNode)==null||W.insertBefore(I.fragment,p));for(let[q,T]of I.pending)j(q,T);let D=new Set(k);for(let q of m)if(!(v.has(q.key)&&D.has(q)))for(let T of q.nodes)H(T),T.remove();let C=p;for(let q=k.length-1;q>=0;q--){let T=k[q],b=T.nodes[T.nodes.length-1];if(b&&b.nextSibling!==C)for(let R of T.nodes)(P=p.parentNode)==null||P.insertBefore(R,C);C=(ee=T.nodes[0])!=null?ee:C}m=k})},{priority:U.FOR,terminal:!0});function Ya(e,t,n,r){let o=[];if(Array.isArray(e))return e.forEach((s,i)=>{let a={[t]:s};n&&(a[n]=i),o.push(a)}),o;if(typeof e=="number"){for(let s=1;s<=e;s++){let i={[t]:s};n&&(i[n]=s-1),o.push(i)}return o}return typeof e=="string"?(Array.from(e).forEach((s,i)=>{let a={[t]:s};n&&(a[n]=i),o.push(a)}),o):(e&&typeof e=="object"&&(e instanceof Map?Array.from(e.entries()):e instanceof Set?Array.from(e).map((i,a)=>[a,i]):Object.entries(e)).forEach(([i,a],c)=>{let u={[t]:a};n&&(u[n]=i),r&&(u[r]=c),o.push(u)}),o)}var Xa=new Set(["disabled","checked","readonly","required","selected","hidden","open","multiple","autofocus","novalidate","inert"]),Ja=new Set(["href","src","action","formaction","xlink:href","ping","poster"]),Za=/[\s\x00-\x1f]/g;function ec(e){let t=e.replace(Za,"").toLowerCase();return t.startsWith("javascript:")||t.startsWith("vbscript:")||t.startsWith("data:text/html")||t.startsWith("data:application/xhtml")}function Es(e,t,n,r=!1,o=!1){if(t==="class")return Ps(e,n);if(t==="style")return Pr(e,n);if(w.sanitizeUrls&&!o&&t==="srcdoc"){Ie(`:srcdoc refused in ${we(e)}: the value becomes a document with active script inside the iframe, the same way v-html becomes markup. If the content is trusted, write :srcdoc.dangerous="..."; to turn off this protection on the entire application, set V.config.sanitizeUrls = false.`),e.removeAttribute(t);return}if(w.sanitizeUrls&&!r){if(Ja.has(t)&&typeof n=="string"&&ec(n)){Ie(`value refused in :${t} of ${we(e)}: "${n.slice(0,60)}" uses a scheme that executes code. Use an http(s) or relative address. To turn off this protection, set V.config.sanitizeUrls = false.`),e.removeAttribute(t);return}if(t.length>2&&/^on[a-z]/.test(t)){Ie(`attribute "${t}" refused in ${we(e)}: linking event by attribute creates an inline handler. Use @${t.slice(2)}="..." instead.`),e.removeAttribute(t);return}}if(r){e[t]=n;return}if(Xa.has(t)){n===!1||n==null?e.removeAttribute(t):e.setAttribute(t,""),t in e&&(e[t]=!!n);return}if(t==="value"&&"value"in e){e.value=n==null?"":n;return}n==null||n===!1?e.removeAttribute(t):e.setAttribute(t,n===!0?"":String(n))}var ks=new WeakMap;function Ps(e,t){let n=ks.get(e);n||(n=(e.getAttribute("class")||"").split(/\s+/).filter(Boolean),ks.set(e,n));let r=new Set(n);Ms(t,r),e.setAttribute("class",Array.from(r).join(" ")),e.getAttribute("class")||e.removeAttribute("class")}function Ms(e,t){if(e){if(typeof e=="string"){for(let n of e.split(/\s+/))n&&t.add(n);return}if(Array.isArray(e)){for(let n of e)Ms(n,t);return}if(typeof e=="object"){for(let[n,r]of Object.entries(e))if(r)for(let o of n.split(/\s+/))o&&t.add(o)}}}function Pr(e,t){if(t){if(typeof t=="string"){e.style.cssText=t;return}if(Array.isArray(t)){for(let n of t)Pr(e,n);return}for(let[n,r]of Object.entries(t)){if(r==null||r===!1){e.style.removeProperty(n);continue}let o=n.startsWith("--")?n:n.replace(/[A-Z]/g,i=>`-${i.toLowerCase()}`),s=String(r);o.startsWith("--"),e.style.setProperty(o,s)}}}A("bind",({el:e,arg:t,modifiers:n,effect:r,evaluate:o,expression:s})=>{if(!t){r(()=>{let c=o();if(c&&typeof c=="object")for(let[u,l]of Object.entries(c))Es(e,u,l)});return}if(t==="key")return;let i=!!n.prop,a=!!n.dangerous;r(()=>{Es(e,t,o(),i,a)})},{priority:U.BIND});A("class",({el:e,effect:t,evaluate:n})=>{t(()=>Ps(e,n()))});A("style",({el:e,effect:t,evaluate:n})=>{t(()=>Pr(e,n()))});var Ss={enter:["Enter"],esc:["Escape"],escape:["Escape"],space:[" ","Spacebar"],tab:["Tab"],delete:["Delete","Backspace"],backspace:["Backspace"],up:["ArrowUp"],down:["ArrowDown"],left:["ArrowLeft"],right:["ArrowRight"]},tc=["ctrl","shift","alt","meta"];function As(e,t,n,r){let o=n.detail,s=n.__voodoo===!0,i=t.child({$event:s?o:n,$rawEvent:n,$el:r,$detail:o});try{let a=le(e),c=x(a,i);typeof c=="function"&&(a.t==="id"||a.t==="member")&&c.call(t.data,s?o:n)}catch(a){$(a,`event ${n.type} ("${e}")`)}}var nc={hover:"mouseenter",unhover:"mouseleave",tap:"click",press:"pointerdown",release:"pointerup",rightclick:"contextmenu",enterkey:"keydown",type:"input",submitform:"submit"},Ls={hold(e,t,n,r){let o=_(typeof n.duration=="string"&&n.duration||Object.keys(n).find(l=>/^[\d.]+(ms|s)?$/.test(l))||e.getAttribute(`${w.prefix}hold-duration`)||800,800),s=null,i=!1,a=l=>{i=!1,e.classList.add("v-holding"),e.style.setProperty("--v-hold-duration",`${o}ms`),s=setTimeout(()=>{i=!0,e.classList.remove("v-holding"),t(l)},o)},c=()=>{s&&clearTimeout(s),s=null,e.classList.remove("v-holding")},u=l=>{i&&(l.preventDefault(),l.stopPropagation(),i=!1)};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",c),e.addEventListener("pointerleave",c),e.addEventListener("pointercancel",c),e.addEventListener("click",u,!0),r(()=>{c(),e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",c),e.removeEventListener("pointerleave",c),e.removeEventListener("pointercancel",c),e.removeEventListener("click",u,!0)})},outside(e,t,n,r){let o=s=>{e.isConnected&&(e===s.target||e.contains(s.target)||t(s))};document.addEventListener("click",o,!0),r(()=>document.removeEventListener("click",o,!0))},visible(e,t,n,r){var s,i;if(typeof IntersectionObserver=="undefined"){t(new CustomEvent("visible"));return}let o=new IntersectionObserver(a=>{for(let c of a)c.isIntersecting&&(t(new CustomEvent("visible",{detail:c})),n.repeat!==!0&&o.unobserve(e))},{threshold:Number((s=n.threshold)!=null?s:.1),rootMargin:String((i=n.margin)!=null?i:"0px")});o.observe(e),r(()=>o.disconnect())}};for(let e of["left","right","up","down"])Ls[`swipe${e}`]=(t,n,r,o)=>{let s=0,i=0,a=!1,c=l=>{a=!0,s=l.clientX,i=l.clientY},u=l=>{if(!a)return;a=!1;let f=l.clientX-s,p=l.clientY-i,d=40;(e==="left"?f<-d&&Math.abs(f)>Math.abs(p):e==="right"?f>d&&Math.abs(f)>Math.abs(p):e==="up"?p<-d&&Math.abs(p)>Math.abs(f):p>d&&Math.abs(p)>Math.abs(f))&&n(new CustomEvent(`swipe${e}`,{detail:{dx:f,dy:p}}))};t.addEventListener("pointerdown",c),window.addEventListener("pointerup",u),o(()=>{t.removeEventListener("pointerdown",c),window.removeEventListener("pointerup",u)})};function Ns(e,t,n,r,o,s){var d;let i=(d=nc[t])!=null?d:t,a=Ls[t];if(a){a(e,m=>{o.prevent&&m.preventDefault(),o.stop&&m.stopPropagation(),As(n,r,m,e)},o,s);return}let c=o.window?window:o.document||o.outside?document:e,u=m=>{if(!(o.self&&m.target!==e)&&!(o.outside&&(e===m.target||e.contains(m.target)||!e.isConnected))){if(m instanceof KeyboardEvent){for(let h of tc)if(o[h]&&!m[`${h}Key`])return;let g=Object.keys(o).filter(h=>h in Ss||/^[a-z0-9]$/.test(h));if(g.length&&!g.some(y=>{let S=Ss[y];return S?S.includes(m.key):m.key.toLowerCase()===y}))return}o.prevent&&m.preventDefault(),o.stop&&m.stopPropagation(),As(n,r,m,e)}},l=o.debounce;l!==void 0&&(u=Fe(u,_(l===!0?250:l,250)));let f=o.throttle;f!==void 0&&(u=br(u,_(f===!0?250:f,250)));let p={capture:!!o.capture,once:!!o.once,passive:!!o.passive};c.addEventListener(i,u,p),s(()=>c.removeEventListener(i,u,p))}A("on",({el:e,arg:t,expression:n,scope:r,modifiers:o,cleanup:s})=>{t&&Ns(e,t,n,r,o,s)});var rc=["click","dblclick","input","change","keyup","keydown","keypress","mouseenter","mouseleave","mouseover","mousedown","mouseup","contextmenu","wheel","paste","dragstart","dragover","dragleave","drop"];for(let e of rc)A(e,({el:t,expression:n,scope:r,modifiers:o,cleanup:s})=>{Ns(t,e,n,r,o,s)});A("model",({el:e,expression:t,scope:n,modifiers:r,effect:o,cleanup:s})=>{let i=e,a=i.tagName,c=(i.getAttribute("type")||"text").toLowerCase(),u=a==="INPUT"&&c==="checkbox",l=a==="INPUT"&&c==="radio",f=a==="SELECT",p=f&&i.multiple,d=a==="INPUT"&&c==="file",m=c==="number"||c==="range",g=!!r.lazy,h=!!r.number||m,y=!!r.trim,S=r.debounce?_(r.debounce===!0?250:r.debounce,250):e.getAttribute(`${w.prefix}debounce`)?_(e.getAttribute(`${w.prefix}debounce`),250):0,V=g||f||u||l||d?"change":"input",k=()=>{var I,D;let v;if(u){let C=O(t,n,"v-model");if(Array.isArray(C)){let W=i.value,P=[...C],ee=P.indexOf(W);i.checked&&ee===-1?P.push(W):!i.checked&&ee>-1&&P.splice(ee,1),v=P}else v=i.checked}else if(l){if(!i.checked)return;v=i.value}else if(p)v=Array.from(i.selectedOptions).map(C=>C.value);else if(d)v=r.single?(D=(I=i.files)==null?void 0:I[0])!=null?D:null:i.files;else if(v=i.value,y&&typeof v=="string"&&(v=v.trim()),h&&typeof v=="string"){let C=v===""?null:Number(v);v=C===null||Number.isNaN(C)?v:C}Ka(t,n,v)};S>0&&(k=Fe(k,S)),i.addEventListener(V,k),s(()=>i.removeEventListener(V,k)),o(()=>{let v=O(t,n,"v-model");if(u){i.checked=Array.isArray(v)?v.includes(i.value):!!v;return}if(l){i.checked=String(v)===i.value;return}if(p){let D=Array.isArray(v)?v.map(String):[];for(let C of Array.from(i.options))C.selected=D.includes(C.value);return}if(d)return;let I=v==null?"":String(v);i.value!==I&&(i.value=I),f&&i.value!==I&&$e(()=>{i.value!==I&&(i.value=I)})})},{priority:U.MODEL});A("init",({el:e,expression:t,scope:n})=>{Ae(()=>{let r=n.child({$el:e}),o=O(t,r,"v-init");typeof o=="function"&&o.call(n.data)})},{priority:U.INIT});A("ref",({el:e,expression:t,scope:n,cleanup:r})=>{var i;let o=t.trim();if(!o)return;let s=(i=n.owner)!=null?i:n;s.refs[o]=e,r(()=>{s.refs[o]===e&&delete s.refs[o]})},{priority:U.REF});A("effect",({effect:e,evaluate:t})=>{e(()=>{t()})});A("watch",({el:e,expression:t,scope:n,effect:r})=>{let o=e.getAttribute(`${w.prefix}model`),s,i=!0;r(()=>{let a=o?O(o,n,"v-watch"):O(t,n,"v-watch");if(i){i=!1,s=a;return}if(a===s)return;let c=s;if(s=a,o){let u=n.child({$value:a,$old:c,$el:e}),l=O(t,u,"v-watch");typeof l=="function"&&l.call(n.data,a,c)}})});A("cloak",({el:e})=>{e.removeAttribute(`${w.prefix}cloak`)});A("once",({el:e,effect:t,evaluate:n})=>{let r=n();r!==void 0&&(e.textContent=ye(r))});A("teleport",({el:e,expression:t,cleanup:n})=>{var i;let r=t.trim()||"body",o=r==="body"?document.body:document.querySelector(r);if(!o){$(new Error(`v-teleport destination not found: ${r}`),"v-teleport");return}let s=document.createComment(" v-teleport ");(i=e.parentNode)==null||i.insertBefore(s,e),o.appendChild(e),n(()=>{var a;(a=s.parentNode)==null||a.insertBefore(e,s),s.remove()})},{priority:U.DATA});for(let e of["transition","enter-class","enter-active-class","enter-to-class","leave-class","leave-active-class","leave-to-class","duration","key","slot","ignore","pre"])A(e,()=>{},{priority:U.TRANSITION});A("data",()=>{},{priority:U.DATA});A("component",()=>{},{priority:U.COMPONENT});Z();re();var Hs=()=>w.prefix;function E(e,t){return No(e,`${Hs()}${t}`)}function Nr(e,t){return Oo(e,`${Hs()}${t}`)}function oc(e,t){var i,a,c;let n=E(e,"target"),r=E(e,"loading"),o={},s=E(e,"headers");if(s){let u=O(s,t,"v-headers");u&&typeof u=="object"&&(o=u)}return{target:n?document.querySelector(n):null,swap:E(e,"swap")||"innerHTML",loadingTarget:r?document.querySelector(r):null,loadingClass:E(e,"loading-class")||"v-loading",disableWhileLoading:Nr(e,"disable-loading"),confirmMessage:E(e,"confirm"),toastSuccess:E(e,"toast-success"),toastError:E(e,"toast-error"),onSuccess:E(e,"on-success"),onError:E(e,"on-error"),onComplete:E(e,"on-complete"),cacheMs:_((i=E(e,"cache"))!=null?i:void 0,0),retry:Number((a=E(e,"retry"))!=null?a:0),timeout:_((c=E(e,"timeout"))!=null?c:void 0,oe.defaults.timeout),storeAs:E(e,"as"),jsonPath:E(e,"json-path"),templateSelector:E(e,"template"),offlineQueue:Nr(e,"offline-queue"),headers:o,redirect:E(e,"redirect"),scrollTo:E(e,"scroll-to")}}function Os(e,t,n,r){var s,i;let o=a=>{for(let c of Array.from(a))c.nodeType===1&&j(c,r)};switch(n){case"none":return;case"delete":H(e),e.remove();return;case"textContent":e.textContent=t;return;case"outerHTML":case"replace":{let a=document.createElement("template");a.innerHTML=t;let c=Array.from(a.content.childNodes);H(e),e.replaceWith(a.content),o(c);return}case"beforebegin":case"afterbegin":case"beforeend":case"afterend":{let a=new Set(Array.from((i=(s=e.parentElement)==null?void 0:s.childNodes)!=null?i:[]));e.insertAdjacentHTML(n,t);let c=n==="afterbegin"||n==="beforeend"?e:e.parentElement;if(c)for(let u of Array.from(c.childNodes))u.nodeType===1&&!a.has(u)&&j(u,r);return}case"append":e.insertAdjacentHTML("beforeend",t),o(e.childNodes);return;case"prepend":e.insertAdjacentHTML("afterbegin",t),o(e.childNodes);return;default:{for(let a of Array.from(e.children))H(a);e.innerHTML=t,o(e.childNodes)}}}function xn(e,t=0){if(e==null)return"";if(typeof e!="object")return Ct(String(e));if(Array.isArray(e)){if(!e.length)return'<p class="v-json-empty">No results.</p>';if(e.every(o=>o&&typeof o=="object"&&!Array.isArray(o))&&t===0){let o=Array.from(e.reduce((a,c)=>{for(let u of Object.keys(c))a.add(u);return a},new Set)),s=o.map(a=>`<th>${Ct(a)}</th>`).join(""),i=e.map(a=>`<tr>${o.map(c=>`<td>${xn(a[c],t+1)}</td>`).join("")}</tr>`).join("");return`<table class="v-json-table"><thead><tr>${s}</tr></thead><tbody>${i}</tbody></table>`}return`<ul class="v-json-list">${e.map(o=>`<li>${xn(o,t+1)}</li>`).join("")}</ul>`}let n=Object.entries(e);return n.length?`<dl class="v-json-object">${n.map(([r,o])=>`<dt>${Ct(r)}</dt><dd>${xn(o,t+1)}</dd>`).join("")}</dl>`:""}function sc(e,t,n,r){let o=document.querySelector(e);if(!o){$(new Error(`Template not found: ${e}`),"v-template");return}for(let i of Array.from(r.children))H(i);r.innerHTML="";let s=Array.isArray(t)?t:[t];for(let[i,a]of s.entries()){let c=o.content.cloneNode(!0),u=Array.from(c.childNodes);r.appendChild(c);let l=n.reactiveChild({item:a,index:i,...a&&typeof a=="object"?a:{}});for(let f of u)f.nodeType===1&&j(f,l)}}var Mr=new WeakMap;async function It(e){var f,p,d,m,g;let{el:t,scope:n,method:r}=e,o=oc(t,n),s=ve.has("confirm");if(o.confirmMessage&&!s&&!await ic(o.confirmMessage))return;(f=Mr.get(t))==null||f.abort();let i=new AbortController;Mr.set(t,i);let a=(p=o.target)!=null?p:t,c=t instanceof HTMLFormElement?t.querySelector('[type="submit"], button:not([type])'):null,u=()=>{if(t.classList.add(o.loadingClass),t.setAttribute("aria-busy","true"),o.loadingTarget&&o.loadingTarget.style.removeProperty("display"),o.disableWhileLoading){let h=c!=null?c:t;"disabled"in h&&(h.disabled=!0)}},l=()=>{if(t.classList.remove(o.loadingClass),t.removeAttribute("aria-busy"),o.loadingTarget&&(o.loadingTarget.style.display="none"),o.disableWhileLoading){let h=c!=null?c:t;"disabled"in h&&(h.disabled=!1)}};u(),ht(t,"voodoo:before-request",{method:r,url:e.url});try{let h=await oe.request({url:e.url,method:r,body:e.body,params:e.params,headers:o.headers,timeout:o.timeout,retry:o.retry,cache:o.cacheMs||void 0,signal:i.signal,offlineQueue:o.offlineQueue}),y=Rr(h.data,o.jsonPath);o.storeAs?n.set(o.storeAs,y):o.templateSelector?sc(o.templateSelector,y,n,a):typeof y=="string"?Os(a,y,o.swap,n):y!=null&&(ac(),Os(a,xn(y),o.swap,n)),o.toastSuccess&&Pe.success(o.toastSuccess),o.onSuccess&&Lr(o.onSuccess,n,t,{data:y,response:h}),ht(t,"voodoo:success",{data:y,response:h}),o.scrollTo&&((d=document.querySelector(o.scrollTo))==null||d.scrollIntoView({behavior:"smooth"})),o.redirect&&location.assign(o.redirect)}catch(h){if((h==null?void 0:h.name)==="AbortError")return;let y=h instanceof X?(m=Cr(h))!=null?m:h.message:(g=h==null?void 0:h.message)!=null?g:"Unknown error";o.toastError?Pe.error(o.toastError):o.onError||Pe.error(y),o.onError&&Lr(o.onError,n,t,{error:h,message:y}),ht(t,"voodoo:error",{error:h,message:y}),$(h,`request ${r} ${e.url}`)}finally{l(),Mr.delete(t),o.onComplete&&Lr(o.onComplete,n,t,{}),ht(t,"voodoo:complete",{})}}function ht(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function Lr(e,t,n,r){var i;let o=t.child({$el:n,...r}),s=O(e,o,"HTTP callback");typeof s=="function"&&s.call(t.data,(i=r.data)!=null?i:r.error)}async function ic(e){let t=globalThis.V;return t&&typeof t.confirm=="function"&&t.confirm!==globalThis.confirm?!!await t.confirm(e):globalThis.confirm(e)}var $s=!1;function ac(){$s||($s=!0,Promise.resolve().then(()=>(ut(),ms)).then(({injectStyle:e})=>{e("json-render",`
...
`)}))}function cc(e){let t=e.tagName;if(t==="FORM")return"submit";if(t==="INPUT"||t==="SELECT"||t==="TEXTAREA"){let n=e.type;return n==="button"||n==="submit"?"click":"change"}return"click"}function uc({el:e,cleanup:t,run:n}){var l,f;let r=E(e,"trigger")||cc(e),[o,...s]=r.split(/[.\s]+/),i=_((l=E(e,"poll"))!=null?l:void 0,0);if(i>0){n();let p=setInterval(()=>{document.visibilityState==="visible"&&n()},i);t(()=>clearInterval(p));return}if(o==="load"||o==="ready"){n();return}if(o==="visible"||o==="revealed"){if(typeof IntersectionObserver=="undefined"){n();return}let p=new IntersectionObserver(d=>{for(let m of d)m.isIntersecting&&(n(),s.includes("repeat")||p.unobserve(e))},{rootMargin:"80px"});p.observe(e),t(()=>p.disconnect());return}let a=s.includes("once"),c=_((f=E(e,"debounce"))!=null?f:void 0,0),u=p=>{(e.tagName==="FORM"||e.href)&&p.preventDefault(),n(p)};c>0&&(u=Fe(u,c)),e.addEventListener(o,u,{once:a}),t(()=>e.removeEventListener(o,u))}var lc=[["get","GET"],["post","POST"],["put","PUT"],["patch","PATCH"],["delete","DELETE"]];for(let[e,t]of lc)A(e,({el:n,scope:r,expression:o,cleanup:s})=>{uc({el:n,scope:r,cleanup:s,run:a=>{let c=jt(o,r);if(!c)return;let u=E(n,"body")||E(n,"data-body"),l=u?O(u,r.child({$event:a}),"v-body"):void 0,f=E(n,"params"),p=f?O(f,r,"v-params"):void 0;It({el:n,scope:r,method:t,url:c,body:l,params:p,event:a})}})});function jt(e,t){let n=e.trim();if(!n)return"";if((/^[./#?]/.test(n)||/^https?:\/\//i.test(n)||/^[\w-]+\/[\w\-/.]*$/.test(n))&&!/[+`'"]|\$\{/.test(n))return n;let o=O(n,t,"URL");return typeof o=="string"?o:n}A("load",({el:e,scope:t,expression:n})=>{let r=jt(n,t);r&&It({el:e,scope:t,method:"GET",url:r})});A("load-visible",({el:e,scope:t,cleanup:n,expression:r})=>{let o=jt(r,t);if(!o)return;if(typeof IntersectionObserver=="undefined"){It({el:e,scope:t,method:"GET",url:o});return}let s=new IntersectionObserver(i=>{for(let a of i)a.isIntersecting&&(s.unobserve(e),It({el:e,scope:t,method:"GET",url:o}))},{rootMargin:"120px"});s.observe(e),n(()=>s.disconnect())});A("search",({el:e,scope:t,expression:n,cleanup:r})=>{var f,p;let o=e,s=jt(n,t),i=E(e,"param")||o.getAttribute("name")||"q",a=_((f=E(e,"debounce"))!=null?f:void 0,300),c=Number((p=E(e,"min-length"))!=null?p:0),u=Fe(()=>{let d=o.value.trim();d.length<c||It({el:e,scope:t,method:"GET",url:s,params:{[i]:d}})},a),l=()=>u();o.addEventListener("input",l),r(()=>{o.removeEventListener("input",l),u.cancel()})});A("resource",({el:e,scope:t,expression:n,cleanup:r})=>{var c,u,l,f;let o=n.indexOf(":"),s=E(e,"as")||"resource",i=n.trim();if(o>-1){let p=n.slice(0,o).trim();/^[A-Za-z_$][\w$]*$/.test(p)&&(s=p,i=n.slice(o+1).trim())}let a=bn(()=>jt(i,t),{method:(E(e,"method")||"GET").toUpperCase(),params:()=>E(e,"params")?O(E(e,"params"),t,"v-params"):void 0,cache:_((c=E(e,"cache"))!=null?c:void 0,0)||void 0,retry:Number((u=E(e,"retry"))!=null?u:0),timeout:_((l=E(e,"timeout"))!=null?l:void 0,oe.defaults.timeout),jsonPath:E(e,"json-path"),poll:_((f=E(e,"poll"))!=null?f:void 0,0),manual:Nr(e,"manual"),onSuccess:p=>ht(e,"voodoo:success",{data:p}),onError:(p,d)=>ht(e,"voodoo:error",{error:p,message:d})});t.set(s,a),r(()=>a.stop())},{priority:U.DATA});for(let e of["target","swap","trigger","poll","param","params","body","data-body","headers","cache","retry","timeout","as","json-path","template","offline-queue","min-length","scroll-to","manual","debounce","throttle","indicator"])A(e,()=>{},{priority:U.TRANSITION});jo(Wo);Vo(At);Xo(Is);ys();var Ft=new Map;function Ds(e,t){let n=Ft.get(e);return n||Ft.set(e,n=new Set),n.add(t),()=>n.delete(t)}function dc(e,t){let n=Ds(e,r=>{n(),t(r)});return n}function fc(e,t){let n=Ft.get(e);if(n)for(let r of[...n])try{r(t)}catch(o){$(o,`event "${e}"`)}}function pc(e,t){var n;if(!t){Ft.delete(e);return}(n=Ft.get(e))==null||n.delete(t)}function Is(e,t){var r,o;let n=typeof t=="function"?{mounted:t,updated:t}:t;A(e,s=>{var l,f;let i,a=!1,c=p=>{var d,m;return{el:s.el,value:p,oldValue:i,arg:s.arg,modifiers:s.modifiers,expression:s.expression,scope:s.scope,instance:(m=(d=s.scope.owner)==null?void 0:d.component)!=null?m:null}},u=n.raw?s.expression:s.evaluate();(l=n.created)==null||l.call(n,s.el,c(u)),(f=n.beforeMount)==null||f.call(n,s.el,c(u)),s.effect(()=>{var m,g;let p=n.raw?s.expression:s.evaluate();if(!a){a=!0,i=p,(m=n.mounted)==null||m.call(n,s.el,c(p));return}if(p===i)return;let d=c(p);(g=n.updated)==null||g.call(n,s.el,d),i=p}),s.cleanup(()=>{var d,m;let p=c(i);(d=n.beforeUnmount)==null||d.call(n,s.el,p),(m=n.unmounted)==null||m.call(n,s.el,p)})},{priority:(r=n.priority)!=null?r:U.DEFAULT,terminal:(o=n.terminal)!=null?o:!1})}function mc(e){return Object.defineProperties(de.data,Object.getOwnPropertyDescriptors(e)),de.data}var hc="0.10.0",En={...wr,version:hc,config:w,reactive:F,ref:Tt,shallowRef:Kn,computed:xt,effect:te,watch:ue,watchEffect:Yn,nextTick:$e,toRaw:K,markRaw:zn,unref:Gn,stop:qn,effectScope:_n,EffectScope:ne,flushSync:jn,data:mc,store:ts,stores:ln,removeStore:ns,storeNames:rs,scope:de,component:rt,components:z,directive:Is,directives:ve,magic:N,magics:kt,createApp:Jo,start:Bo,whenReady:an,whenElement:cn,walk:j,refresh:qo,destroy:H,stopObserving:Uo,getScope:et,findScope:xe,addCleanup:fe,parseAttribute:Je,parse:le,tokenize:Jt,evaluate:x,evaluateIn:O,stringify:ye,clearParseCache:uo,globals:G,http:oe,request:Lt,HttpError:X,resource:bn,toast:Pe,storage:se,session:mn,cookie:hn,cache:yn,url:gn,theme:ft,clipboard:Ar,screen:ie,network:_e,enter:Ot,leave:$t,fadeIn:wn,fadeOut:Tn,slideUp:Dt,slideDown:Ht,viewTransition:xs,injectStyle:Ee,ensureTokens:Ue,on:Ds,once:dc,off:pc,emit:fc,use(e,t){Zt(En,e,t)},onError(e){Fn(e)},instances:on,Scope:De,PRIORITY:U,VoodooSyntaxError:L,VoodooRuntimeError:B};es(En);Z();var gc=new Set(["animation-iteration-count","aspect-ratio","border-image-slice","column-count","flex","flex-grow","flex-shrink","font-weight","grid-area","grid-column","grid-row","line-height","opacity","order","orphans","scale","tab-size","widows","z-index","zoom"]);function zs(e){return e.startsWith("--")?e:e.replace(/[A-Z]/g,t=>`-${t.toLowerCase()}`)}function ae(e){return e.length<2?e:Array.from(new Set(e))}function Ve(e){return String(e!=null?e:"").split(/\s+/).filter(Boolean)}function Or(e){if(typeof document=="undefined")return[];let t=document.createElement("template");t.innerHTML=e.trim();let n=[];for(let r of Array.from(t.content.children))n.push(r);return n}function Qs(e){return e.length>2&&e.charCodeAt(0)===60&&e.endsWith(">")}function yc(e){if(e==null)return typeof document=="undefined"?[]:[document];if(e instanceof pe)return e.toArray();if(typeof e=="string")return We(e);if(typeof e=="function")return typeof document=="undefined"?[]:[document];let t=We(e);return t.length?t:typeof document=="undefined"?[]:[document]}function We(e,t){if(e==null)return[];if(typeof e=="string"){let o=e.trim();if(!o)return[];if(Qs(o))return Or(o);let s=[];for(let i of yc(t))try{for(let a of Array.from(i.querySelectorAll(o)))s.push(a)}catch(a){}return ae(s)}if(e instanceof pe)return e.toArray();if(typeof e=="function")return[];let n=e;if(typeof n.nodeType=="number"){if(n.nodeType===1)return[n];if(n.nodeType===9){let o=n;return o.documentElement?[o.documentElement]:[]}return n.nodeType===11?Array.from(n.children):[]}let r=e;if(typeof r.length=="number"){let o=[];for(let s=0;s<r.length;s++){let i=r[s];i&&i.nodeType===1&&o.push(i)}return ae(o)}return[]}function js(e){if(e==null)return[];if(typeof e=="string"){let r=e;return Qs(r.trim())?Or(r):[document.createTextNode(r)]}if(e instanceof pe)return e.toArray();if(typeof e=="function")return[];let t=e;if(typeof t.nodeType=="number")return[t];let n=e;if(typeof n.length=="number"){let r=[];for(let o=0;o<n.length;o++)n[o]&&r.push(n[o]);return r}return[]}function kn(e,t,n){let r=zs(t);if(n===null||n===""){e.style.removeProperty(r);return}let o=typeof n=="number"&&!gc.has(r)&&!r.startsWith("--")?`${n}px`:String(n);e.style.setProperty(r,o)}function vc(e,t){for(let[n,r]of Object.entries(t))kn(e,n,r)}function Fs(e){if(e===void 0)return;if(e==="")return"";if(e==="true")return!0;if(e==="false")return!1;if(e==="null")return null;if(/^-?\d+(\.\d+)?$/.test(e))return Number(e);let t=e.charCodeAt(0);if(t===123||t===91||t===34)try{return JSON.parse(e)}catch(n){return e}return e}function Bs(e){return e.replace(/-([a-z0-9])/g,(t,n)=>n.toUpperCase())}var Ks=new WeakMap;function Us(e){return e.hasAttribute("hidden")||e.style.display==="none"?!0:e.isConnected?getComputedStyle(e).display==="none":!1}function qs(e){e.removeAttribute("hidden");let t=Ks.get(e);t!==void 0&&t!=="none"?e.style.display=t:e.style.removeProperty("display"),e.isConnected&&getComputedStyle(e).display==="none"&&(e.style.display="block")}function _s(e){let t=e.style.display;t&&t!=="none"&&Ks.set(e,t),e.style.display="none"}var Vs="input,select,textarea";function Ws(e){return e.matches(Vs)?[e]:Array.from(e.querySelectorAll(Vs))}function bc(e){let t=e;if(!t.name||t.disabled)return!1;let n=(t.getAttribute("type")||"").toLowerCase();return!(n==="file"||n==="submit"||n==="reset"||n==="button"||(n==="checkbox"||n==="radio")&&!t.checked)}var Sn=new WeakMap;function wc(e){let t=Sn.get(e);return t||Sn.set(e,t=[]),t}var pe=class e{constructor(t=[]){M(this,"length");M(this,"elements");this.elements=t,this.length=t.length;let n=this;for(let r=0;r<t.length;r++)n[r]=t[r]}[Symbol.iterator](){return this.elements[Symbol.iterator]()}find(t){let n=[];for(let r of this.elements)try{for(let o of Array.from(r.querySelectorAll(t)))n.push(o)}catch(o){}return new e(ae(n))}closest(t){let n=[];for(let r of this.elements){let o=r.closest(t);o&&n.push(o)}return new e(ae(n))}parent(t){let n=[];for(let r of this.elements){let o=r.parentElement;o&&(!t||o.matches(t))&&n.push(o)}return new e(ae(n))}parents(t){let n=[];for(let r of this.elements){let o=r.parentElement;for(;o;)(!t||o.matches(t))&&n.push(o),o=o.parentElement}return new e(ae(n))}children(t){let n=[];for(let r of this.elements)for(let o of Array.from(r.children))(!t||o.matches(t))&&n.push(o);return new e(ae(n))}siblings(t){let n=[];for(let r of this.elements){let o=r.parentElement;if(o)for(let s of Array.from(o.children))s!==r&&(!t||s.matches(t))&&n.push(s)}return new e(ae(n))}next(t){let n=[];for(let r of this.elements){let o=r.nextElementSibling;o&&(!t||o.matches(t))&&n.push(o)}return new e(ae(n))}prev(t){let n=[];for(let r of this.elements){let o=r.previousElementSibling;o&&(!t||o.matches(t))&&n.push(o)}return new e(ae(n))}first(){return this.eq(0)}last(){return this.eq(-1)}eq(t){let n=t<0?this.elements.length+t:t,r=this.elements[n];return new e(r?[r]:[])}filter(t){let n=this.elements.filter((r,o)=>typeof t=="function"?t(r,o):r.matches(t));return new e(n)}not(t){let n=this.elements.filter((r,o)=>typeof t=="function"?!t(r,o):!r.matches(t));return new e(n)}has(t){let n=this.elements.filter(r=>typeof t=="string"?r.querySelector(t)!==null:r.contains(t));return new e(n)}is(t){return this.elements.some((n,r)=>typeof t=="function"?t(n,r):n.matches(t))}map(t){return this.elements.map((n,r)=>t(n,r))}each(t){for(let n=0;n<this.elements.length;n++){let r=this.elements[n];if(t.call(r,r,n)===!1)break}return this}get(...t){if(!t.length)return this.toArray();let n=Number(t[0]);return this.elements[n<0?this.elements.length+n:n]}toArray(){return this.elements.slice()}add(t,n){return new e(ae([...this.elements,...We(t,n)]))}slice(t,n){return new e(this.elements.slice(t,n))}text(...t){var o,s;if(!t.length)return(s=(o=this.elements[0])==null?void 0:o.textContent)!=null?s:"";let n=t[0],r=n==null?"":String(n);for(let i of this.elements){for(let a of Array.from(i.childNodes))H(a);i.textContent=r}return this}html(...t){var o,s;if(!t.length)return(s=(o=this.elements[0])==null?void 0:o.innerHTML)!=null?s:"";let n=t[0],r=n==null?"":String(n);for(let i of this.elements){for(let a of Array.from(i.childNodes))H(a);i.innerHTML=r}return this}val(...t){var r;if(!t.length){let o=this.elements[0];if(!o)return"";let s=o;return o.tagName==="SELECT"&&s.multiple?Array.from(s.selectedOptions).map(i=>i.value):o.type==="checkbox"?o.checked?o.value||"on":"":(r=o.value)!=null?r:""}let n=t[0];for(let o of this.elements){let s=o,i=o;if(s.tagName==="SELECT"&&i.multiple){let a=(Array.isArray(n)?n:[n]).map(String);for(let c of Array.from(i.options))c.selected=a.includes(c.value);continue}if(s.type==="checkbox"||s.type==="radio"){s.checked=Array.isArray(n)?n.map(String).includes(s.value):n===!0||String(n)===s.value;continue}s.value=n==null?"":String(n)}return this}attr(...t){var s,i;let n=t[0];if(n!==null&&typeof n=="object"){for(let a of this.elements)for(let[c,u]of Object.entries(n))u===null||u===!1?a.removeAttribute(c):a.setAttribute(c,u===!0?"":String(u));return this}let r=String(n);if(t.length<2)return(i=(s=this.elements[0])==null?void 0:s.getAttribute(r))!=null?i:void 0;let o=t[1];for(let a of this.elements)o===null||o===!1?a.removeAttribute(r):a.setAttribute(r,o===!0?"":String(o));return this}removeAttr(t){let n=Ve(t);for(let r of this.elements)for(let o of n)r.removeAttribute(o);return this}prop(...t){let n=String(t[0]);if(t.length<2){let r=this.elements[0];return r?r[n]:void 0}for(let r of this.elements)r[n]=t[1];return this}data(...t){let n=t[0];if(!t.length){let s=this.elements[0];if(!s)return{};let i={};for(let[a,c]of Object.entries(s.dataset))i[a]=Fs(c);return i}if(n!==null&&typeof n=="object"){for(let s of this.elements)for(let[i,a]of Object.entries(n))s.dataset[Bs(i)]=typeof a=="string"?a:JSON.stringify(a!=null?a:null);return this}let r=Bs(String(n));if(t.length<2){let s=this.elements[0];return s?Fs(s.dataset[r]):void 0}let o=t[1];for(let s of this.elements)s.dataset[r]=typeof o=="string"?o:JSON.stringify(o!=null?o:null);return this}css(...t){let n=t[0];if(n!==null&&typeof n=="object"){for(let o of this.elements)vc(o,n);return this}let r=String(n);if(t.length<2){let o=this.elements[0];if(!o)return"";let s=zs(r);return((o.isConnected?getComputedStyle(o).getPropertyValue(s):"")||o.style.getPropertyValue(s)).trim()}for(let o of this.elements)kn(o,r,t[1]);return this}width(...t){if(!t.length){let n=this.elements[0];return n?n.getBoundingClientRect().width:0}for(let n of this.elements)kn(n,"width",t[0]);return this}height(...t){if(!t.length){let n=this.elements[0];return n?n.getBoundingClientRect().height:0}for(let n of this.elements)kn(n,"height",t[0]);return this}offset(){let t=this.elements[0];if(!t)return{top:0,left:0};let n=t.getBoundingClientRect();return{top:n.top+window.scrollY,left:n.left+window.scrollX}}position(){let t=this.elements[0];return t?{top:t.offsetTop,left:t.offsetLeft}:{top:0,left:0}}scrollTop(...t){var r,o;if(!t.length)return(o=(r=this.elements[0])==null?void 0:r.scrollTop)!=null?o:0;let n=Number(t[0])||0;for(let s of this.elements)s.scrollTop=n;return this}addClass(t){let n=Ve(t);if(n.length)for(let r of this.elements)r.classList.add(...n);return this}removeClass(t){let n=Ve(t);if(n.length)for(let r of this.elements)r.classList.remove(...n);return this}toggleClass(t,n){let r=Ve(t);for(let o of this.elements)for(let s of r)n===void 0?o.classList.toggle(s):o.classList.toggle(s,n);return this}hasClass(t){let n=Ve(t);return n.length?this.elements.some(r=>n.every(o=>r.classList.contains(o))):!1}insert(t,n){let r=this.elements.length;for(let o=0;o<r;o++){let s=this.elements[o];for(let i of js(t))n(s,o===r-1?i:i.cloneNode(!0))}return this}append(t){return this.insert(t,(n,r)=>n.appendChild(r))}prepend(t){return this.insert(t,(n,r)=>n.insertBefore(r,n.firstChild))}before(t){return this.insert(t,(n,r)=>{var o;return(o=n.parentNode)==null?void 0:o.insertBefore(r,n)})}after(t){return this.insert(t,(n,r)=>{var o;return(o=n.parentNode)==null?void 0:o.insertBefore(r,n.nextSibling)})}appendTo(t){let n=We(t);for(let r=0;r<n.length;r++)for(let o of this.elements)n[r].appendChild(r===n.length-1?o:o.cloneNode(!0));return this}prependTo(t){let n=We(t);for(let r=0;r<n.length;r++){let o=n[r],s=this.elements.map(i=>r===n.length-1?i:i.cloneNode(!0));for(let i=s.length-1;i>=0;i--)o.insertBefore(s[i],o.firstChild)}return this}replaceWith(t){for(let n of this.elements){let r=n.parentNode;if(r){for(let o of js(t))r.insertBefore(o,n);H(n),n.remove()}}return this}wrap(t){var n;for(let r of this.elements){let o=We(t)[0];if(!o)continue;let s=o.cloneNode(!0);(n=r.parentNode)==null||n.insertBefore(s,r);let i=s;for(;i.firstElementChild;)i=i.firstElementChild;i.appendChild(r)}return this}unwrap(){let t=new Set;for(let n of this.elements){let r=n.parentElement;r&&r!==document.body&&t.add(r)}for(let n of t){let r=n.parentNode;if(r){for(;n.firstChild;)r.insertBefore(n.firstChild,n);H(n),n.remove()}}return this}remove(){for(let t of this.elements)H(t),t.remove();return this}empty(){for(let t of this.elements){for(let n of Array.from(t.childNodes))H(n);t.replaceChildren()}return this}clone(t=!0){return new e(this.elements.map(n=>n.cloneNode(t)))}on(t,...n){var a;let r=typeof n[0]=="string",o=r?n[0]:null,s=r?n[1]:n[0],i=(a=r?n[2]:n[1])!=null?a:{};if(typeof s!="function")return this;for(let c of this.elements)for(let u of Ve(t)){let l=f=>{if(!o){s.call(c,f);return}let p=f.target,d=p==null?void 0:p.closest(o);!d||!c.contains(d)||s.call(d,f)};c.addEventListener(u,l,i),wc(c).push({type:u,selector:o,handler:s,wrapped:l,options:i})}return this}off(t,n,r){let o=typeof n=="string"?n:null,s=typeof n=="function"?n:r!=null?r:null,i=t?Ve(t):null;for(let a of this.elements){let c=Sn.get(a);if(!c)continue;let u=[];for(let l of c){let f=!i||i.includes(l.type),p=o===null||l.selector===o,d=s===null||l.handler===s;f&&p&&d?a.removeEventListener(l.type,l.wrapped,l.options):u.push(l)}Sn.set(a,u)}return this}once(t,...n){let r=typeof n[0]=="string",o=r?n[0]:null,s=r?n[1]:n[0];if(typeof s!="function")return this;let i=this,a=function(c){return o?i.off(t,o,a):i.off(t,a),s.call(this,c)};return o?this.on(t,o,a):this.on(t,a)}trigger(t,n){for(let r of this.elements){if(n===void 0&&typeof r[t]=="function"){r[t]();continue}let o=new CustomEvent(t,{detail:n,bubbles:!0,cancelable:!0});o.__voodoo=!0,r.dispatchEvent(o)}return this}emit(t,n){for(let r of this.elements){let o=new CustomEvent(t,{detail:n,bubbles:!0,cancelable:!0});o.__voodoo=!0,r.dispatchEvent(o)}return this}show(){for(let t of this.elements)qs(t);return this}hide(){for(let t of this.elements)_s(t);return this}toggle(t){for(let n of this.elements)(t===void 0?Us(n):t)?qs(n):_s(n);return this}fadeIn(t=220){for(let n of this.elements)n.removeAttribute("hidden"),wn(n,t);return this}fadeOut(t=220){for(let n of this.elements)Tn(n,t);return this}slideUp(t=240){for(let n of this.elements)Dt(n,t);return this}slideDown(t=240){for(let n of this.elements)n.removeAttribute("hidden"),Ht(n,t);return this}slideToggle(t=240){for(let n of this.elements)Us(n)?(n.removeAttribute("hidden"),Ht(n,t)):Dt(n,t);return this}animate(t,n=300){for(let r of this.elements)typeof r.animate=="function"&&r.animate(t,n);return this}scrollIntoView(t={behavior:"smooth",block:"start"}){var n;return(n=this.elements[0])==null||n.scrollIntoView(t),this}serialize(){let t=this.elements[0];if(!t)return"";let n=new URLSearchParams;for(let r of Ws(t)){if(!bc(r))continue;let o=r,s=r;if(o.tagName==="SELECT"&&s.multiple){for(let i of Array.from(s.selectedOptions))n.append(o.name,i.value);continue}n.append(o.name,o.value)}return n.toString()}serializeObject(){var r,o,s,i;let t=this.elements[0],n={};if(!t)return n;for(let a of Ws(t)){let c=a;if(!c.name||c.disabled)continue;let u=(c.getAttribute("type")||"").toLowerCase();if(u==="submit"||u==="reset"||u==="button")continue;let l=c.name.endsWith("[]"),f=l?c.name.slice(0,-2):c.name,p=a,d;if(u==="checkbox"){if(!c.checked&&!l){n[f]=(r=n[f])!=null?r:!1;continue}if(!c.checked)continue;d=c.value==="on"?!0:c.value}else if(u==="radio"){if(!c.checked)continue;d=c.value}else u==="file"?d=c.multiple?Array.from((o=c.files)!=null?o:[]):(i=(s=c.files)==null?void 0:s[0])!=null?i:null:c.tagName==="SELECT"&&p.multiple?d=Array.from(p.selectedOptions).map(m=>m.value):u==="number"||u==="range"?d=c.value===""?null:Number(c.value):d=c.value;if(l){let m=n[f];Array.isArray(m)?m.push(d):n[f]=[d];continue}if(Object.prototype.hasOwnProperty.call(n,f)){let m=n[f];Array.isArray(m)?m.push(d):m===void 0||m===!1?n[f]=d:n[f]=[m,d];continue}n[f]=d}return n}focus(t){var n;return(n=this.elements[0])==null||n.focus(t),this}blur(){for(let t of this.elements)t.blur();return this}select(){for(let t of this.elements){let n=t;typeof n.select=="function"&&n.select()}return this}walk(t=!1){for(let n of this.elements)t&&H(n),j(n,xe(n.parentNode));return this}destroy(){for(let t of this.elements)H(t);return this}};function $r(e,t){if(typeof e=="function"){Hr(e);let n=typeof document!="undefined"?document.documentElement:null;return new pe(n?[n]:[])}return new pe(We(e,t))}function Hr(e){return typeof document=="undefined"?Promise.resolve():new Promise(t=>{Yo(()=>{try{e==null||e()}catch(n){$(n,"V.ready")}t()})})}function Gs(e){return new pe(Or(e))}var Ys=((e,t)=>$r(e,t));Object.assign(Ys,En,{query:$r,ready:Hr,fromHtml:Gs,Collection:pe,magic:N});var Dr=Ys;re();ut();re();var Tc=/^#([0-9a-f])([0-9a-f])([0-9a-f])[0-9a-f]?$/i,xc=/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})(?:[0-9a-f]{2})?$/i,Ec=/^rgba?\(([^)]+)\)$/i,kc=/^hsla?\(([^)]+)\)$/i;function Xs(e){return e.split(/[\s,/]+/).map(t=>parseFloat(t)).filter(t=>!Number.isNaN(t))}function Sc(e,t,n){let r=(e%360+360)%360,o=J(t/100,0,1),s=J(n/100,0,1),i=(1-Math.abs(2*s-1))*o,a=i*(1-Math.abs(r/60%2-1)),c=s-i/2,u=Math.floor(r/60)%6,l=[[i,a,0],[a,i,0],[0,i,a],[0,a,i],[a,0,i],[i,0,a]],[f,p,d]=l[u];return{r:Math.round((f+c)*255),g:Math.round((p+c)*255),b:Math.round((d+c)*255)}}function me(e){let t=String(e!=null?e:"").trim();if(!t)return null;let n=Tc.exec(t);if(n)return{r:parseInt(n[1]+n[1],16),g:parseInt(n[2]+n[2],16),b:parseInt(n[3]+n[3],16)};let r=xc.exec(t);if(r)return{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)};let o=Ec.exec(t);if(o){let[i,a,c]=Xs(o[1]);return i===void 0||a===void 0||c===void 0?null:{r:J(i,0,255),g:J(a,0,255),b:J(c,0,255)}}let s=kc.exec(t);if(s){let[i,a,c]=Xs(s[1]);return i===void 0||a===void 0||c===void 0?null:Sc(i,a,c)}return null}function J(e,t,n){return e<t?t:e>n?n:e}function vt(e){let t=e/255;return t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function Ir(e){return e<=.0031308?e*12.92:1.055*Math.pow(e,.4166666666666667)-.055}function Ac(e){let t=vt(e.r),n=vt(e.g),r=vt(e.b),o=.4122214708*t+.5363325363*n+.0514459929*r,s=.2119034982*t+.6806995451*n+.1073969566*r,i=.0883024619*t+.2817188376*n+.6299787005*r,a=Math.cbrt(o),c=Math.cbrt(s),u=Math.cbrt(i);return{l:.2104542553*a+.793617785*c-.0040720468*u,a:1.9779984951*a-2.428592205*c+.4505937099*u,b:.0259040371*a+.7827717662*c-.808675766*u}}function Rc(e){let t=e.l+.3963377774*e.a+.2158037573*e.b,n=e.l-.1055613458*e.a-.0638541728*e.b,r=e.l-.0894841775*e.a-1.291485548*e.b,o=t*t*t,s=n*n*n,i=r*r*r;return{r:Ir(4.0767416621*o-3.3077115913*s+.2309699292*i),g:Ir(-1.2684380046*o+2.6097574011*s-.3413193965*i),b:Ir(-.0041960863*o-.7034186147*s+1.707614701*i)}}function Rn(e){let t=Ac(e),n=Math.sqrt(t.a*t.a+t.b*t.b),r=Math.atan2(t.b,t.a)*180/Math.PI;return r<0&&(r+=360),{l:t.l,c:n,h:n<1e-5?0:r}}function Js(e){let t=e.h*Math.PI/180;return Rc({l:e.l,a:Math.cos(t)*e.c,b:Math.sin(t)*e.c})}function yt(e){let t=Math.max(0,e.c);for(let r=0;r<32;r++){let o=Js({l:J(e.l,0,1),c:t,h:e.h});if(o.r>=-.001&&o.r<=1.001&&o.g>=-.001&&o.g<=1.001&&o.b>=-.001&&o.b<=1.001)return{r:Math.round(J(o.r,0,1)*255),g:Math.round(J(o.g,0,1)*255),b:Math.round(J(o.b,0,1)*255)};t*=.92}let n=Js({l:J(e.l,0,1),c:0,h:e.h});return{r:Math.round(J(n.r,0,1)*255),g:Math.round(J(n.g,0,1)*255),b:Math.round(J(n.b,0,1)*255)}}function jr(e){return J(Math.round(e),0,255).toString(16).padStart(2,"0")}function ze(e){return`#${jr(e.r)}${jr(e.g)}${jr(e.b)}`}function gt(e,t){return`rgba(${Math.round(e.r)}, ${Math.round(e.g)}, ${Math.round(e.b)}, ${Number(t.toFixed(3))})`}function ri(e){return ze(yt(e))}function Br(e){return .2126*vt(e.r)+.7152*vt(e.g)+.0722*vt(e.b)}function Ur(e,t){let n=typeof e=="string"?me(e):e,r=typeof t=="string"?me(t):t;if(!n||!r)return 1;let o=Br(n),s=Br(r),i=Math.max(o,s),a=Math.min(o,s);return(i+.05)/(a+.05)}var oi={r:255,g:255,b:255},Cn={r:0,g:0,b:0};function Bt(e){let t=typeof e=="string"?me(e):e;return t?Ur(t,oi)>=Ur(t,Cn)?"#ffffff":"#000000":"#ffffff"}var qr=[50,100,200,300,400,500,600,700,800,900],si=[.973,.941,.889,.819,.732,.638,.558,.478,.399,.327],Cc=[.14,.26,.46,.68,.88,1,.97,.89,.78,.65],ii=[.244,.286,.343,.408,.484,.588,.668,.748,.836,.928],Pc=[.3,.42,.6,.78,.92,1,.92,.78,.57,.33];function ai(e,t=!1){var a;let n=typeof e=="string"?(a=me(e))!=null?a:Cn:e,r=Rn(n),o=t?ii:si,s=t?Pc:Cc,i={};return qr.forEach((c,u)=>{i[String(c)]=ri({l:o[u],c:r.c*s[u],h:r.h})}),i}var Pn={violeta:{primary:"#6D3BF5",accent:"#FF3D8B",success:"#16A34A",warning:"#D97706",danger:"#E11D48",info:"#7C6BFF"},oceano:{primary:"#0E7BC4",accent:"#0FB5C9",success:"#0F9D6E",warning:"#D08700",danger:"#DC2F3E",info:"#3B82F6"},floresta:{primary:"#1F8A4C",accent:"#7FA80E",success:"#18A05A",warning:"#C97A0A",danger:"#C93A2E",info:"#2C8FA8"},poente:{primary:"#E4632A",accent:"#D62F63",success:"#3E9B52",warning:"#D99000",danger:"#D32F2F",info:"#B45FC0"},grafite:{primary:"#4C5A70",accent:"#2E7FD1",success:"#2F8F60",warning:"#B57A12",danger:"#C2453F",info:"#5B7A99"}},ci=["primary","accent","success","warning","danger","info"],_r="voodoo:palette",Zs="voodoo-palette",Mc="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif",Lc="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace";function ei(e,t){let n=(e!=null?e:"").trim();return n?n.includes(",")?n:`${/^['"]/.test(n)?n:`'${n}'`}, ${t}`:t}var Nc=/^([\d.]+)(px|rem|em)$/;function Oc(e){let t=(e||"12px").trim(),n=Nc.exec(t);if(!n)return{"--v-radius":t,"--v-radius-sm":`calc(${t} * 0.6)`,"--v-radius-lg":`calc(${t} * 1.5)`,"--v-radius-xl":`calc(${t} * 2)`,"--v-radius-full":"999px"};let r=parseFloat(n[1]),o=n[2],s=i=>`${Math.round(i*1e3)/1e3}${o}`;return{"--v-radius":s(r),"--v-radius-sm":s(Math.max(r*.55,0)),"--v-radius-lg":s(r*1.5),"--v-radius-xl":s(r*2),"--v-radius-full":"999px"}}function ti(e,t){var u,l,f,p;let n={},r={},o={};for(let d of ci){let m=(u=me(e[d]))!=null?u:Cn,g=Rn(m),h=ai(m,t);r[d]=h;for(let P of qr)n[`--v-${d}-${P}`]=h[String(P)];let y=t?{l:Math.max(g.l,.62),c:g.c*.95,h:g.h}:g,S=t?{l:Math.min(y.l+.07,.94),c:y.c*.95,h:y.h}:{l:Math.max(y.l-.055,.12),c:y.c,h:y.h},V=t?{l:Math.min(y.l+.13,.97),c:y.c*.88,h:y.h}:{l:Math.max(y.l-.105,.1),c:y.c,h:y.h},k=yt(y),v=yt(S),I=yt(V);n[`--v-${d}`]=ze(t?k:m),n[`--v-${d}-hover`]=ze(v),n[`--v-${d}-active`]=ze(I),n[`--v-${d}-contrast`]=Bt(t?k:m),n[`--v-${d}-contrast-hover`]=Bt(v),n[`--v-${d}-contrast-active`]=Bt(I);let D=h[50],C=h[100],W=t?h[800]:h[700];n[`--v-${d}-soft`]=D,n[`--v-${d}-soft-hover`]=C,n[`--v-${d}-soft-text`]=W,n[`--v-${d}-ring`]=gt(k,t?.45:.32),n[`--v-${d}-border`]=t?h[300]:h[200],o[d]=n[`--v-${d}-contrast`]}let s=(f=me((l=e.neutral)!=null?l:e.primary))!=null?f:Cn,i=Rn(s).h,a=(d,m)=>ri({l:d,c:m,h:i}),c={};if(qr.forEach((d,m)=>{let g=t?ii:si;c[String(d)]=a(g[m],.012),n[`--v-neutral-${d}`]=c[String(d)]}),r.neutral=c,t)n["--v-surface"]=a(.248,.021),n["--v-surface-2"]=a(.196,.021),n["--v-surface-3"]=a(.305,.024),n["--v-surface-inset"]=a(.17,.02),n["--v-text"]=a(.965,.008),n["--v-text-muted"]=a(.748,.017),n["--v-text-soft"]=a(.63,.017),n["--v-border"]=a(.355,.023),n["--v-border-strong"]=a(.46,.026),n["--v-overlay"]="rgba(0, 0, 0, 0.62)",n["--v-shadow-sm"]="0 1px 2px rgba(0, 0, 0, 0.5)",n["--v-shadow"]="0 10px 30px rgba(0, 0, 0, 0.5)",n["--v-shadow-lg"]="0 24px 60px rgba(0, 0, 0, 0.62)";else{let d=yt({l:.24,c:.028,h:i});n["--v-surface"]=a(1,0),n["--v-surface-2"]=a(.981,.006),n["--v-surface-3"]=a(.955,.009),n["--v-surface-inset"]=a(.968,.008),n["--v-text"]=ze(d),n["--v-text-muted"]=a(.53,.023),n["--v-text-soft"]=a(.655,.018),n["--v-border"]=a(.906,.012),n["--v-border-strong"]=a(.828,.016),n["--v-overlay"]=gt(d,.45),n["--v-shadow-sm"]=`0 1px 2px ${gt(d,.08)}`,n["--v-shadow"]=`0 10px 30px ${gt(d,.14)}`,n["--v-shadow-lg"]=`0 24px 60px ${gt(d,.2)}`}return n["--v-focus-ring"]=n["--v-primary-ring"],o.surface=Bt((p=me(n["--v-surface"]))!=null?p:oi),{vars:n,scales:r,contrast:o}}function Fr(e,t){let n=Object.entries(t).map(([r,o])=>`  ${r}: ${o};`).join(`
`);return`${e} {
${n}
}`}var qt=null,Ut=null;function $c(e){var r,o,s,i,a,c,u,l,f;let t=(r=Pn[e.preset])!=null?r:Pn.violeta,n={primary:(o=e.primary)!=null?o:t.primary,accent:(s=e.accent)!=null?s:t.accent,success:(i=e.success)!=null?i:t.success,warning:(a=e.warning)!=null?a:t.warning,danger:(c=e.danger)!=null?c:t.danger,info:(u=e.info)!=null?u:t.info,neutral:(l=e.neutral)!=null?l:t.neutral};for(let p of ci)me(n[p])||(console.warn(`[Voodoo] invalid color in palette.${p}: "${n[p]}". Using preset.`),n[p]=t[p]);return{colors:n,radius:(f=e.radius)!=null?f:"12px",font:ei(e.font,Mc),mono:ei(e.monoFont,Lc)}}function Hc(e){if(typeof document=="undefined"||!w.injectStyles)return;Ue();let t=document.getElementById(Zs);t||(t=document.createElement("style"),t.id=Zs,t.setAttribute("data-voodoo","palette"),document.head.appendChild(t)),t.textContent=e}function An(e={}){let{colors:t,radius:n,font:r,mono:o}=$c(e),s=ti(t,!1),i=ti(t,!0),a={...Oc(n),"--v-font-sans":r,"--v-font-mono":o},c=["/* Palette generated by V.palette(). Do not edit manually. */",Fr(":root",{...a,...s.vars}),`@media (prefers-color-scheme: dark) {
${Fr(':root:not([data-theme="light"])',i.vars)}
}`,Fr(':root[data-theme="dark"]',i.vars)].join(`
`);Hc(c);let u={colors:t,radius:n,font:r,monoFont:o,light:s.scales,dark:i.scales,contrast:s.contrast,css:c};if(qt=u,Ut={...e},e.persist!==!1&&typeof document!="undefined"){let l={...e};delete l.persist,se.set(_r,l)}return typeof document!="undefined"&&document.dispatchEvent(new CustomEvent("voodoo:palette",{detail:u})),u}var ni=!1;function Vr(){if(qt&&ni)return qt;ni=!0;let e=se.get(_r),t=e&&typeof e=="object"?{...e,persist:!1}:{persist:!1};return An(t)}function Dc(){qt||Vr()}function ui(){return Vr()}var Gl=Object.assign(An,{presets:Pn,get names(){return Object.keys(Pn)},get current(){return qt},get options(){return Ut},init:Vr,ensure:Dc,reset(){return se.remove(_r),An({persist:!1})},use(e){return An({...Ut!=null?Ut:{},preset:e,primary:void 0,accent:void 0})},scale:ai,contrastText:Bt,contrastRatio:Ur,luminance(e){let t=typeof e=="string"?me(e):e;return t?Br(t):0},convert:{parseColor:me,rgbToOklch:Rn,oklchToRgb:yt,toHex:ze,toRgba:gt}});function Ic(e){if(window.VOODOO_DEVTOOLS===!0)return!0;for(let t of["devtools","data-devtools"]){if(!e.hasAttribute(t))continue;let n=e.getAttribute(t);return n===null||n===""||n.toLowerCase()!=="false"}return!1}function jc(){var i;if(typeof document=="undefined")return{manual:!1};let e=(i=document.currentScript)!=null?i:document.querySelector('script[src*="voodoo"]');if(!e)return{manual:!1};let t=e.hasAttribute("data-manual")||e.hasAttribute("data-defer-init"),n=e.getAttribute("data-prefix");n&&(w.prefix=n);let r=e.getAttribute("data-base-url");r&&(w.baseURL=r);let o=e.getAttribute("data-locale");o&&(w.locale=o),Ic(e)&&(w.devtools=!0);let s=e.getAttribute("data-xray-shortcut");return s!==null&&(w.xrayShortcut=s==="false"||s===""?!1:s),e.hasAttribute("data-no-styles")&&(w.injectStyles=!1),e.hasAttribute("data-no-observer")&&(w.autoDiscover=!1),e.hasAttribute("data-keep-attributes")&&(w.cleanAttributes=!1),{manual:t}}function Fc(e){if(typeof e.devtoolsWidget=="function"){e.devtoolsWidget(!0);return}console.info("[Voodoo] devtools requested, but this build does not include the inspector. Use voodoo.full.min.js to get the widget and full devtools panel.")}function li(e){var o;if(typeof window=="undefined")return;let t=jc(),n=window;if(n.V=e,n.Voodoo=e,G.V=e,G.Voodoo=e,w.baseURL&&((o=e.http)!=null&&o.setBaseURL)&&e.http.setBaseURL(w.baseURL),t.manual||!w.autoStart)return;an(()=>{ft.init(),ui(),typeof e.extractJsx=="function"&&e.extractJsx(),e.start(),typeof e.activateJsx=="function"&&e.activateJsx(),typeof e.enableXrayShortcut=="function"&&e.enableXrayShortcut(),w.devtools&&Fc(e)})}li(Dr);var Bc=Dr;return vi(Uc);})();
