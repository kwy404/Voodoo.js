...
Suggestion: attribute expressions accept a single value. If the logic spans more than one line, move it to a component method and call the method here.`
  ...
  function hasDirectives(el) {
    ...
    for (let i = 0; i < attrs.length; i++) {
      ...
      if (n2.startsWith(config.prefix) || n2.charCodeAt(0) === 64 || n2.charCodeAt(0) === 58 || n2.startsWith("data-v-")) {
        return true;
      }
    }
    return false;
  ...
  function coerce(value, def) {
    ...
    switch (def.type) {
      case "number": {
        ...
        return Number.isNaN(n2) ? (_b = def.default) != null ? _b : value : n2;
      }
      case "boolean":
  ...
  function uuid() {
    ...
    if (c2 == null ? void 0 : c2.randomUUID) return c2.randomUUID();
    if (c2 == null ? void 0 : c2.getRandomValues) {
  ...
  function formatNumber(value, options = {}) {
    ...
    return new Intl.NumberFormat(locale != null ? locale : defaultLocale, rest).format(n2);
  }
  ...
  var toast = Object.assign(
    ...
    (message, options = {}) => render({ ...normalize(message, "default"), ...options }),
    {
      ...
      async promise(promise, messages2 = {}) {
        var _a2, _b, _c;
        const handle = render({ title: (_a2 = messages2.loading) != null ? _a2 : "Loading...", type: "loading", duration: 0 });
        try {
          const value = await promise;
          handle.update({
            title: typeof messages2.success === "function" ? messages2.success(value) : (_b = messages2.success) != null ? _b : "Done",
            type: "success",
          ...
          handle.update({
            title: typeof messages2.error === "function" ? messages2.error(err) : (_c = messages2.error) != null ? _c : "Something went wrong",
            type: "error",
            duration: settings.duration
          });
          throw err;
...
`;
  ...
  async function runRequest(options) {
    ...
    const target = (_b = settings4.target) != null ? _b : el;
    ...
    try {
      ...
      if (settings4.scrollTo) {
        (_c = document.querySelector(settings4.scrollTo)) == null ? void 0 : _c.scrollIntoView({ behavior: "smooth" });
      }
...
`
  ...
  var devtoolsBus = {
    ...
    on(type, callback) {
      ...
      set2.add(callback);
      return () => {
        set2 == null ? void 0 : set2.delete(callback);
      };
    },
    /** Cancels a specific subscription. */
    off(type, callback) {
      var _a2;
      (_a2 = listeners.get(type)) == null ? void 0 : _a2.delete(callback);
    },
    ...
    count(type) {
      var _a2, _b;
      return (_b = (_a2 = listeners.get(type)) == null ? void 0 : _a2.size) != null ? _b : 0;
    }
  };
  ...
  function findRecord(pattern) {
    ...
    return (_b = (_a2 = compiled.find((item) => item.pattern === pattern)) == null ? void 0 : _a2.record) != null ? _b : null;
  }
  ...
  function locationFor(path, query2, hash) {
    ...
    return {
      ...
      query: query2,
      hash,
      name: (_a2 = found == null ? void 0 : found.route.record.name) != null ? _a2 : "",
      meta: (_b = found == null ? void 0 : found.route.record.meta) != null ? _b : {},
  ...
  function scheduleScroll(to, from, saved) {
    ...
    queuePostFlush(() => {
      requestAnimationFrame(() => {
        ...
        if (to.hash) {
          const anchor = (_a2 = document.getElementById(to.hash)) != null ? _a2 : /^[\w-]+$/.test(to.hash) ? document.querySelector(`[name="${to.hash}"]`) : null;
          if (anchor) {
            anchor.scrollIntoView({ behavior: "smooth", block: "start" });
            return;
          }
        }
        moveTo(saved != null ? saved : 0);
      });
    });
  }
  async function navigate(target, options = {}) {
    ...
    (_b = settings2.afterEach) == null ? void 0 : _b.call(settings2, snapshot(), from);
    devtoolsBus.emit("navigation", {
      from: from.fullPath,
      to: destination.fullPath,
      matched: destination.matched
  ...
  async function onHistoryChange(event) {
    ...
    currentKey = key;
    applyLocation(destination);
    scheduleScroll(destination, from, (_a2 = scrollPositions.get(key)) != null ? _a2 : 0);
    (_b = settings2.afterEach) == null ? void 0 : _b.call(settings2, snapshot(), from);
    devtoolsBus.emit("navigation", {
      from: from.fullPath,
      to: destination.fullPath,
  ...
  function configureRouter(options) {
    ...
    settings2.mode = (_a2 = options.mode) != null ? _a2 : "history";
    settings2.base = normalizePath((_b = options.base) != null ? _b : "/");
    settings2.beforeEach = (_c = options.beforeEach) != null ? _c : null;
    settings2.afterEach = (_d = options.afterEach) != null ? _d : null;
    settings2.linkActiveClass = (_e = options.linkActiveClass) != null ? _e : "v-link-active";
    settings2.linkExactActiveClass = (_f = options.linkExactActiveClass) != null ? _f : "v-link-exact-active";
    settings2.transition = (_g = options.transition) != null ? _g : true;
  ...
  async function loadView(url2) {
    ...
    const text = typeof html === "string" ? html : String(html != null ? html : "");
  ...
  function linkTarget(el, expression, evaluate2) {
    ...
    const href = (_a2 = el.getAttribute("href")) != null ? _a2 : "";
  ...
  defineDirective("link", ({ el, expression, modifiers, effect: effect2, cleanup, evaluate: evaluate2 }) => {
    ...
    const onClick = (event) => {
      ...
      if (((_a2 = anchor.getAttribute("rel")) != null ? _a2 : "").split(/\s+/).includes("external")) return;
  ...
  defineDirective("route-active", ({ el, expression, arg, modifiers, effect: effect2, evaluate: evaluate2 }) => {
    ...
    effect2(() => {
      var _a2;
      const raw = expression.trim();
      const target = raw.startsWith("/") || !raw ? raw : (_a2 = evaluate2(raw)) != null ? _a2 : raw;
  ...
  function choosePlural(forms, count, locale) {
    var _a2;
    if (forms.length <= 1) return (_a2 = forms[0]) != null ? _a2 : "";
  ...
  function t(key, params) {
    ...
    if (message.includes("|")) {
      const count = Number((_b = (_a2 = values.n) != null ? _a2 : values.count) != null ? _b : 0);
  ...
  function te(key, locale) {
    const target = locale != null ? locale : state.locale;
  ...
  function c(value, currency) {
    return formatCurrency(value, { locale: state.locale, currency: currency != null ? currency : state.currency });
  }
  ...
  function messagesOf(locale) {
    var _a2;
    return (_a2 = state.messages[locale != null ? locale : state.locale]) != null ? _a2 : {};
  }
  ...
  function setLocale(locale) {
    const target = locale == null ? void 0 : locale.trim();
  ...
  function detectLocale() {
    ...
    const preferred = ((_a2 = navigator.languages) == null ? void 0 : _a2.length) ? [...navigator.languages] : [navigator.language];
  ...
  function configureI18n(options = {}) {
    ...
    state.fallback = (_a2 = options.fallback) != null ? _a2 : state.fallback;
    state.currency = (_c = (_b = options.currency) != null ? _b : config.currency) != null ? _c : state.currency;
    loadPath = (_d = options.loadPath) != null ? _d : loadPath;
  ...
  function readParams(el, evaluate2) {
    var _a2;
    const attr2 = (_a2 = readAttr(el, `${config.prefix}t-params`)) != null ? _a2 : readAttr(el, "data-v-t-params");
    if (!attr2) return {};
  ...
  function callExpression(expression, scope, el, event, detail) {
    ...
    const local = scope.child({ $el: el, $event: event != null ? event : null, $detail: detail });
    const value = evaluateIn(expression, local, "directive de UI");
    if (typeof value === "function") {
      return value.call(scope.data, detail != null ? detail : event);
    }
    return value;
  }
  var LIVE_CSS = `
...
`;
  ...
  function groupOf(el, own) {
    ...
    return (holder == null ? void 0 : holder.getAttribute("data-v-dnd-group")) || null;
  }
  ...
  function moveGhost(x, y) {
    if (!(session2 == null ? void 0 : session2.ghost)) return;
  ...
  function autoScroll() {
    ...
    const container2 = scrollParent(under != null ? under : session2.overList);
    if (container2) {
  ...
  function updateDrag(x, y) {
    ...
    (_c = session2.ghost) == null ? void 0 : _c.classList.toggle("v-drag-invalid", !!drop && !valid);
  }
  ...
  function teardown(current2) {
    ...
    (_c = current2.overList) == null ? void 0 : _c.classList.remove("v-drop-over");
  ...
  defineDirective("sortable", ({ el, expression, cleanup }) => {
    ...
    observer4 == null ? void 0 : observer4.observe(el, { childList: true });
    installPointerDrag(
      el,
      {
        mode: "sort",
    ...
    cleanup(() => {
      ...
      observer4 == null ? void 0 : observer4.disconnect();
...
`;
  ...
  var Drawer = class {
    ...
    hide() {
      ...
      unlockScroll();
      (_b = this.lastFocus) == null ? void 0 : _b.focus();
      this.sync();
  ...
  function commandPalette() {
    ...
    const close = () => {
      ...
      overlay.remove();
      unlockScroll();
      lastFocus == null ? void 0 : lastFocus.focus();
    };
    const execute = () => {
  ...
  function formatMessage(template, data2) {
    ...
    const replacements = {
      param,
      field: (_b = data2.field) != null ? _b : "field",
      value: (_c = data2.value) != null ? _c : "",
      min: ((_d = parts[0]) != null ? _d : "").trim(),
      max: ((_f = (_e = parts[1]) != null ? _e : parts[0]) != null ? _f : "").trim()
    };
  ...
  function fieldLabel(el) {
    ...
    const wrapperText = (_b = wrapper == null ? void 0 : wrapper.textContent) == null ? void 0 : _b.trim();
  ...
  validator("minlength", (value, param) => value.trim().length >= Number(param != null ? param : 0));
  validator("maxlength", (value, param) => value.trim().length <= Number(param != null ? param : Infinity));
  validator("min", (value, param, el) => {
    ...
    return toNumber(value) >= Number(param != null ? param : 0);
  });
  validator("max", (value, param, el) => {
    ...
    return toNumber(value) <= Number(param != null ? param : Infinity);
  });
  validator("between", (value, param) => {
    const [min, max] = (param != null ? param : "").split(",").map((part) => Number(part.trim()));
  ...
  validator("regex", (value, param, el) => {
    var _a2;
    if (!param) return true;
    const flags2 = (_a2 = readDirectiveAttr(el, "regex-flags")) != null ? _a2 : "";
    try {
  ...
  validator(
    "in",
    (value, param) => (param != null ? param : "").split(",").map((part) => part.trim()).includes(value.trim())
  );
  validator(
    "notin",
    (value, param) => !(param != null ? param : "").split(",").map((part) => part.trim()).includes(value.trim())
...
`;
    ...
    for (let i = 0; i < keys.length; i++) {
      ...
      if (Array.isArray(node)) {
        ...
        if (child2 == null || typeof child2 !== "object") {
          child2 = next === "" || /^\d+$/.test(next != null ? next : "") ? [] : {};
          node[index] = child2;
        }
        node = child2;
        continue;
      ...
      if (child == null || typeof child !== "object") {
        child = next === "" || /^\d+$/.test(next != null ? next : "") ? [] : {};
        node[key] = child;
      }
      node = child;
    }
  ...
  function collectEntries(form, options) {
    ...
    for (const field of fields) {
      ...
      if (type === "file") {
        const files = Array.from((_b = field.files) != null ? _b : []);
      ...
      if (type === "checkbox") {
        const many = ((_c = checkboxCount.get(field.name)) != null ? _c : 1) > 1 || field.name.endsWith("[]");
        if (many) {
          if (!field.checked) continue;
      ...
      let value = (_d = field.value) != null ? _d : "";
  ...
  function defineFormOption(name, validate2) {
    defineDirective(name, ({ el, expression }) => {
      ...
      const problem = validate2 == null ? void 0 : validate2(expression);
...
`;
  ...
  defineDirective("dropzone", ({ el, scope, expression, cleanup }) => {
    ...
    if (!el.hasAttribute("role")) el.setAttribute("role", "button");
    if (!((_a2 = el.textContent) == null ? void 0 : _a2.trim())) el.textContent = "Drag files here or click to choose";
    ...
    picker.hidden = true;
    picker.tabIndex = -1;
    if (el.hasAttribute("accept")) picker.accept = (_c = el.getAttribute("accept")) != null ? _c : "";
  ...
  function getAudioContext() {
    ...
    const Constructor = (_a2 = window.AudioContext) != null ? _a2 : window.webkitAudioContext;
  ...
  function playLayer(ctx, layer, effectVolume) {
    var _a2, _b, _c, _d;
    const start2 = ctx.currentTime + ((_a2 = layer.atraso) != null ? _a2 : 0);
    const end = start2 + layer.duracao;
    const oscillator = ctx.createOscillator();
    oscillator.type = (_b = layer.forma) != null ? _b : "sine";
    ...
    const peak = masterVolume * effectVolume * ((_c = layer.volume) != null ? _c : 1);
    const attack = (_d = layer.ataque) != null ? _d : 8e-3;
  ...
  var sound = {
    ...
    play(name, options = {}) {
      ...
      const volume = (_a2 = options.volume) != null ? _a2 : 1;
      ...
      if (!ctx) return;
      const pitch = (_b = options.tom) != null ? _b : 1;
      const effectVolume = ((_c = effect2.volume) != null ? _c : 1) * volume;
    ...
    tone(frequency, duration = 200, options = {}) {
      ...
      playLayer(
        ctx,
        { frequencia: frequency, duracao: duration / 1e3, forma: (_a2 = options.forma) != null ? _a2 : "sine" },
        (_b = options.volume) != null ? _b : 0.5
      );
    },
    /**
  ...
  function parseColor(input) {
    ...
    const tokens = (_a2 = text.match(/-?(?:\d+\.?\d*|\.\d+)%?/g)) != null ? _a2 : [];
    const at = (index, scale) => {
      var _a3;
      const raw = (_a3 = tokens[index]) != null ? _a3 : "0";
    ...
    if (text.startsWith("hsl")) {
      ...
      const rgb = hslToRgb(parseFloat((_b = tokens[0]) != null ? _b : "0"), ratio(1), ratio(2));
  ...
  function buildTrack(el, name, spec) {
    var _a2;
    const prop = (_a2 = TRANSFORM_ALIASES[name]) != null ? _a2 : name;
  ...
  function animateOne(el, keyframes, options) {
    ...
    if (prefersReducedMotion() && !options.force) {
      ...
      (_a2 = options.onUpdate) == null ? void 0 : _a2.call(options, 1);
      (_b = options.onComplete) == null ? void 0 : _b.call(options);
      return instantControl();
    }
    const duration = Math.max(0, (_c = options.duration) != null ? _c : 400);
    const delay = Math.max(0, (_d = options.delay) != null ? _d : 0);
    const ease = resolveEasing(options.easing);
    const repeat = Math.max(0, Math.floor((_e = options.repeat) != null ? _e : 0));
    const repeatType = (_f = options.repeatType) != null ? _f : "loop";
    ...
    let springVelocity = (_g = springConfig == null ? void 0 : springConfig.velocity) != null ? _g : 0;
    function frame(now2) {
      ...
      if (springConfig) {
        const stiffness = (_a3 = springConfig.stiffness) != null ? _a3 : 170;
        const damping = (_b2 = springConfig.damping) != null ? _b2 : 26;
        const mass = (_c2 = springConfig.mass) != null ? _c2 : 1;
        ...
        const restDelta = (_d2 = springConfig.restDelta) != null ? _d2 : 1e-3;
        const restSpeed = (_e2 = springConfig.restSpeed) != null ? _e2 : 0.01;
        if (Math.abs(1 - springPosition) < restDelta && Math.abs(springVelocity) < restSpeed) {
          complete(1);
          return;
        }
        applyTracks(el, tracks, springPosition);
        (_f2 = options.onUpdate) == null ? void 0 : _f2.call(options, springPosition);
        return;
      }
      if (duration === 0) {
        complete(1);
      ...
      (_g2 = options.onUpdate) == null ? void 0 : _g2.call(options, progress);
    }
    function complete(progress) {
      ...
      removeFrame(frame);
      applyTracks(el, tracks, progress);
      (_a3 = options.onUpdate) == null ? void 0 : _a3.call(options, progress);
      settle();
  ...
  function spring(from, to, options = {}) {
    ...
    if (prefersReducedMotion()) {
      (_a2 = options.onUpdate) == null ? void 0 : _a2.call(options, to);
      (_b = options.onComplete) == null ? void 0 : _b.call(options);
      return instantControl();
    }
    const stiffness = (_c = options.stiffness) != null ? _c : 170;
    const damping = (_d = options.damping) != null ? _d : 26;
    const mass = (_e = options.mass) != null ? _e : 1;
    const range = Math.abs(to - from) || 1;
    const restDelta = (_f = options.restDelta) != null ? _f : range * 1e-3;
    const restSpeed = (_g = options.restSpeed) != null ? _g : range * 0.01;
    let position = from;
    let velocity = (_h = options.velocity) != null ? _h : 0;
    let running = true;
    let previous = -1;
    let elapsed = 0;
    let settle;
    ...
    function frame(now2) {
      ...
      if (previous < 0) {
        previous = now2;
        (_a3 = options.onUpdate) == null ? void 0 : _a3.call(options, position);
        return;
      }
      const delta = Math.min(64, Math.max(0, now2 - previous));
      previous = now2;
      ...
      if (rested || elapsed > MAX_DURATION) {
        ...
        removeFrame(frame);
        position = to;
        (_b2 = options.onUpdate) == null ? void 0 : _b2.call(options, to);
        settle();
        (_c2 = options.onComplete) == null ? void 0 : _c2.call(options);
        return;
      }
      (_d2 = options.onUpdate) == null ? void 0 : _d2.call(options, position);
    }
    addFrame(frame);
    return {
      finished,
  ...
  function stagger(targets, keyframes, options = {}) {
    ...
    if (elements.length === 0) return instantControl();
    const step2 = (_a2 = options.delay) != null ? _a2 : 60;
    const start2 = (_b = options.start) != null ? _b : 0;
    const from = (_c = options.from) != null ? _c : "first";
  ...
  function inView(el, callback, options = {}) {
    var _a2, _b, _c;
    const once2 = (_a2 = options.once) != null ? _a2 : true;
    let leaveHandler;
    if (typeof IntersectionObserver === "undefined") {
    ...
    const observer4 = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: (_c = options.margin) != null ? _c : "0px",
  ...
  defineDirective("motion", ({ el, expression, evaluate: evaluate2, cleanup }) => {
    ...
    if (extra > 0) options.delay = ((_a2 = options.delay) != null ? _a2 : 0) + extra;
  ...
  defineDirective("motion-scroll", ({ el, expression, evaluate: evaluate2, modifiers, cleanup }) => {
    ...
    const stopWatching = inView(
      el,
      () => {
        control == null ? void 0 : control.stop();
      ...
      { once: once2, amount, margin: (_b = readAttr2(el, "motion-scroll-margin")) != null ? _b : "0px" }
    );
    cleanup(() => {
      stopWatching();
      control == null ? void 0 : control.stop();
  ...
  function runFlipPass() {
    ...
    for (const entry of flipEntries.values()) {
      ...
      (_a2 = entry.control) == null ? void 0 : _a2.stop();
  ...
  function ensureFlipWatcher() {
    ...
    const root = (_a2 = config.root) != null ? _a2 : document.body;
    if (!root) return;
  ...
  defineDirective("flip", ({ el, expression, evaluate: evaluate2, cleanup }) => {
    ...
    cleanup(() => {
      var _a2, _b;
      (_b = (_a2 = flipEntries.get(el)) == null ? void 0 : _a2.control) == null ? void 0 : _b.stop();
  ...
  defineDirective("count", ({ el, evaluate: evaluate2, effect: effect2, cleanup }) => {
    var _a2, _b, _c, _d, _e;
    const duration = parseDuration((_a2 = readAttr2(el, "count-duration")) != null ? _a2 : void 0, 1400);
    const decimals = Math.max(0, Math.min(6, parseInt((_b = readAttr2(el, "count-decimals")) != null ? _b : "0", 10) || 0));
    const format = (_c = readAttr2(el, "count-format")) != null ? _c : "number";
    const prefix = (_d = readAttr2(el, "count-prefix")) != null ? _d : "";
    const suffix = (_e = readAttr2(el, "count-suffix")) != null ? _e : "";
    ...
    cleanup(() => control == null ? void 0 : control.stop());
  });
  defineDirective("typewriter", ({ el, expression, evaluate: evaluate2, effect: effect2, cleanup }) => {
    var _a2;
    const speed = parseDuration((_a2 = readAttr2(el, "typewriter-speed")) != null ? _a2 : void 0, 45);
    const dynamic = looksLikeExpression2(expression);
    let control = null;
    effect2(() => {
      var _a3;
      const text = dynamic ? String((_a3 = evaluate2()) != null ? _a3 : "") : expression;
      control == null ? void 0 : control.stop();
      el.textContent = "";
      if (!text) return;
      let shown = -1;
...
`;
  ...
  function numberFormatter(key, options) {
    const cacheKey2 = `${config.locale}|${config.currency}|${key}`;
  ...
  function normalize2(options, type) {
    ...
    if (categorical) {
      for (let i = 0; i < ((_c = (_b = series[0]) == null ? void 0 : _b.values.length) != null ? _c : 0); i++) {
  ...
  function applyHidden(dataset, hidden, palette2) {
    ...
    if (dataset.categorical) {
      ...
      return {
        series: [{ ...first, values, xs: null, color: (_a2 = colors[0]) != null ? _a2 : first.color }],
        labels: labels2,
        categorical: true
      };
    }
  ...
  function renderProgress(ctx) {
    ...
    const max = (_a2 = ctx.options.max) != null ? _a2 : 100;
    const min = (_b = ctx.options.min) != null ? _b : 0;
  ...
  function draw(state2) {
    ...
    const type = (_a2 = options.type) != null ? _a2 : "line";
    const palette2 = options.colors && options.colors.length > 0 ? options.colors : CHART_COLORS;
  ...
  function showTooltip(state2, event) {
    ...
    tip.innerHTML = tooltipHtml(hit, (_a2 = state2.options.format) != null ? _a2 : "number");
  ...
  function attachEvents(state2) {
    ...
    const onClick = (event) => {
      ...
      const key = (_a2 = target.closest("[data-key]")) == null ? void 0 : _a2.getAttribute("data-key");
  ...
  function colorScale(color, dark = false) {
    var _a2;
    const rgb = typeof color === "string" ? (_a2 = parseColor2(color)) != null ? _a2 : BLACK : color;
  ...
  function buildTheme(colors, dark) {
    ...
    for (const role of ROLES) {
      const rgb = (_a2 = parseColor2(colors[role])) != null ? _a2 : BLACK;
      const base = rgbToOklch(rgb);
    ...
    const neutralRgb = (_c = parseColor2((_b = colors.neutral) != null ? _b : colors.primary)) != null ? _c : BLACK;
    ...
    contrast.surface = contrastText((_d = parseColor2(vars["--v-surface"])) != null ? _d : WHITE);
...
${block(':root:not([data-theme="light"])', dark.vars)}
  ...
  function fromOuterScope(instance, raw) {
    ...
    const parent = (_a2 = instance.$scope) == null ? void 0 : _a2.parent;
...
`;
  ...
  function register(name, definition) {
    ...
    definition.methods = {
      ...
      ...(_a2 = definition.methods) != null ? _a2 : {}
    };
    definition.beforeMount = function() {
      ensureStyles3();
      original == null ? void 0 : original.call(this);
    };
    defineComponent(name, definition);
  }
  register("v-button", {
  ...
  register("v-textarea", {
    ...
    computed: {
      ...
      counterText() {
        var _a2;
        const used = String((_a2 = this.value) != null ? _a2 : "").length;
  ...
  function normalizeOptions(raw) {
    ...
    return list.map((item) => {
      ...
      if (item != null && typeof item === "object") {
        const source = item;
        const value = (_d = (_c = (_b = (_a2 = source.value) != null ? _a2 : source.id) != null ? _b : source.key) != null ? _c : source.label) != null ? _d : "";
        const label = (_h = (_g = (_f = (_e = source.label) != null ? _e : source.text) != null ? _f : source.name) != null ? _g : source.title) != null ? _h : value;
  ...
  register("v-select", {
    ...
    computed: {
      ...
      allOptions() {
        var _a2;
        return normalizeOptions((_a2 = fromOuterScope(this, this.options)) != null ? _a2 : this.options);
      },
      filtered() {
        var _a2;
        const term = String((_a2 = this.query) != null ? _a2 : "").trim().toLowerCase();
    ...
    beforeMount() {
      hostModel(this, {
        ...
        set: (next) => {
          if (flag(this.multiple)) {
            this.selectedList = Array.isArray(next) ? next.map(String) : splitList(String(next != null ? next : ""));
            return;
          }
  ...
  register("v-radio", {
    ...
    state(props) {
      ...
      return {
        ...
        selected: flag(props.checked) ? String((_a2 = props.value) != null ? _a2 : "") : ""
      };
    },
    computed: {
      ...
      isChecked() {
        var _a2;
        return this.selected !== "" && this.selected === String((_a2 = this.value) != null ? _a2 : "");
      }
    },
    methods: {
      onPick() {
        var _a2;
        this.selected = String((_a2 = this.value) != null ? _a2 : "");
  ...
  register("v-tag", {
    ...
    methods: {
      remove() {
        var _a2, _b;
        this.emit("remove", (_b = (_a2 = this.$el.textContent) == null ? void 0 : _a2.trim()) != null ? _b : "");
      }
    },
    template: `
  ...
  register("v-avatar", {
    ...
    computed: {
      initials() {
        var _a2;
        const parts = String((_a2 = this.name) != null ? _a2 : "").trim().split(/\s+/).filter(Boolean);
      ...
      tone() {
        var _a2;
        const text = String((_a2 = this.name) != null ? _a2 : "");
        let sum = 0;
  ...
  function parseColumns(raw) {
    if (Array.isArray(raw)) {
      return raw.map((item) => {
        ...
        if (item != null && typeof item === "object") {
          const source = item;
          const key2 = String((_c = (_b = (_a2 = source.key) != null ? _a2 : source.field) != null ? _b : source.name) != null ? _c : "");
          return {
            key: key2,
            label: String((_e = (_d = source.label) != null ? _d : source.title) != null ? _e : titleCase(key2)),
            align: String((_f = source.align) != null ? _f : "left"),
  ...
  register("v-table", {
    ...
    computed: {
      ...
      cols() {
        var _a2;
        return parseColumns((_a2 = fromOuterScope(this, this.columns)) != null ? _a2 : this.columns);
      },
      allRows() {
        var _a2;
        const source = (_a2 = fromOuterScope(this, this.rows)) != null ? _a2 : this.rows;
    ...
    if (Array.isArray(raw)) {
      return raw.map((item) => {
        ...
        if (item != null && typeof item === "object") {
          const source = item;
          return {
            label: String((_c = (_b = (_a2 = source.label) != null ? _a2 : source.text) != null ? _b : source.title) != null ? _c : ""),
            href: String((_f = (_e = (_d = source.href) != null ? _d : source.url) != null ? _e : source.to) != null ? _f : "")
          };
        }
  ...
  register("v-breadcrumb", {
    ...
    computed: {
      crumbs() {
        var _a2;
        return parseCrumbs((_a2 = fromOuterScope(this, this.items)) != null ? _a2 : this.items);
      }
    },
    methods: {
      isLast(index) {
  ...
  function parseTimeline(raw) {
    if (Array.isArray(raw)) {
      return raw.map((item) => {
        ...
        if (item != null && typeof item === "object") {
          const source = item;
          return {
            title: String((_b = (_a2 = source.title) != null ? _a2 : source.label) != null ? _b : ""),
            description: String((_d = (_c = source.description) != null ? _c : source.text) != null ? _d : ""),
            time: String((_f = (_e = source.time) != null ? _e : source.date) != null ? _f : ""),
            tone: String((_g = source.tone) != null ? _g : "primary")
          };
        }
    ...
    return raw.split(";").map((entry) => entry.trim()).filter(Boolean).map((entry) => {
      ...
      return {
        title: (_a2 = parts[0]) != null ? _a2 : "",
        description: (_b = parts[1]) != null ? _b : "",
        time: (_c = parts[2]) != null ? _c : "",
  ...
  register("v-timeline", {
    ...
    computed: {
      entries() {
        var _a2;
        return parseTimeline((_a2 = fromOuterScope(this, this.items)) != null ? _a2 : this.items);
      }
    },
    template: `
    <ol class="v-timeline">
  ...
  register("v-steps", {
    ...
    computed: {
      ...
      list() {
        var _a2;
        const source = (_a2 = fromOuterScope(this, this.steps)) != null ? _a2 : this.steps;
        if (Array.isArray(source)) {
          return source.map(
            (item) => {
              var _a3, _b;
              return item != null && typeof item === "object" ? String((_b = (_a3 = item.label) != null ? _a3 : item.title) != null ? _b : "") : String(item);
            }
          );
        }
  ...
  register("v-code-block", {
    ...
    methods: {
      async copy() {
        ...
        const text = this.code || (holder == null ? void 0 : holder.textContent) || "";
  ...
  var iconNames = Object.keys(ICON_PATHS);
...
`;
  ...
  function openDialog(request2) {
    ...
    root.id = id;
    root.setAttribute("data-size", (_a2 = request2.size) != null ? _a2 : settings3.size);
    ...
    panel.setAttribute("role", (_c = request2.role) != null ? _c : "dialog");
    panel.setAttribute("aria-modal", "true");
    panel.tabIndex = -1;
    ...
    if (request2.source) {
      ...
      (_d = request2.source.parentNode) == null ? void 0 : _d.insertBefore(anchor, request2.source);
    ...
    const handle = {
      ...
      panel,
      body,
      key: (_e = request2.key) != null ? _e : null,
      source: (_f = request2.source) != null ? _f : null,
      closed,
      close(result) {
        if (settled) return;
        settled = true;
    ...
    (_g = request2.onOpen) == null ? void 0 : _g.call(request2, handle);
    return handle;
  }
  ...
  function resolveTarget2(target) {
    ...
    const selector = String(target != null ? target : "").trim();
  ...
  var modal = {
    ...
    open(target, options = {}) {
      ...
      return openDialog({
        ...
        source: element,
        key,
        labelledBy: (_b = heading == null ? void 0 : heading.id) != null ? _b : null
      });
    },
    ...
    close(target, result) {
      ...
      entry == null ? void 0 : entry.handle.close(result);
    },
  ...
  function dialog(options) {
    ...
    const buttons = (_b = options.buttons) != null ? _b : [
  ...
  function confirm(message, options = {}) {
    ...
    return dialog({
      ...
      text: message,
      buttons: [
        { label: (_b = options.cancelLabel) != null ? _b : labels.cancel, value: false, variant: "secondary" },
        {
          label: (_c = options.confirmLabel) != null ? _c : labels.confirm,
          value: true,
  ...
  function prompt(label, options = {}) {
    ...
    input.value = (_b = options.value) != null ? _b : "";
    ...
    return dialog({
      ...
      text: void 0,
      buttons: [
        { label: (_c = options.cancelLabel) != null ? _c : labels.cancel, value: null, variant: "secondary" },
        {
          label: (_d = options.confirmLabel) != null ? _d : labels.confirm,
          variant: "primary",
          close: false,
          onClick(handle) {
  ...
  function maskCurrency(value, options = {}) {
    ...
    const suffix = (_e = options.suffix) != null ? _e : "";
  ...
  function installMask(input, options, cleanup) {
    ...
    const reformat = () => {
      ...
      if (options.rightToLeft) setCaret(Math.max(0, formatted.length - ((_b = options.suffixLength) != null ? _b : 0)));
    ...
    ({ el, expression, modifiers, cleanup }) => {
      ...
      installMask(
        input,
        {
          ...
          rightToLeft: true,
          suffixLength: ((_d = options.suffix) != null ? _d : "").length
        },
        cleanup
      );
    },
...
`;
  ...
  function preview(value, max = 64) {
    ...
    try {
      return truncate((_a2 = JSON.stringify(value)) != null ? _a2 : String(value), max);
    } catch (e) {
      return String(value);
    }
  }
  ...
  function refreshOutlines() {
    ...
    for (const el of inspectableElements()) {
      ...
      const isComponent = !!((_a2 = getScope(el)) == null ? void 0 : _a2.component);
  ...
  function buildCard(el) {
    ...
    const owner = (_a2 = scope.owner) == null ? void 0 : _a2.component;
  ...
  function renderComponentsTab() {
    ...
    for (const instance of list) {
      ...
      group.appendChild(head);
      const rows = h("div", "v-xray-rows");
      const props = (_a2 = instance.$props) != null ? _a2 : {};
  ...
  function listenEvents() {
    const handler = (event) => {
      ...
      pushEvent({
        at: Date.now(),
        type: event.type,
        target: describeElement2(owner != null ? owner : target),
    ...
    disposers.push(
      devtoolsBus.on("event", (data2) => {
        ...
        pushEvent({
          at: Date.now(),
          type: data2.type,
          target: describeElement2((_a2 = data2.el) != null ? _a2 : null),
          detail: preview(data2.detail),
          source: (_b = data2.source) != null ? _b : "bus"
        });
      })
    );
  }
  function listenNetwork() {
    ...
    disposers.push(
      http.interceptors.response.use((response) => {
        var _a2, _b;
        const started2 = (_a2 = requestStarts.get(response.config)) != null ? _a2 : performance.now();
        pushNetwork({
          at: Date.now(),
          method: ((_b = response.config.method) != null ? _b : "GET").toUpperCase(),
    ...
    disposers.push(
      http.interceptors.error.use((error) => {
        ...
        const started2 = requestConfig ? (_a2 = requestStarts.get(requestConfig)) != null ? _a2 : performance.now() : performance.now();
        pushNetwork({
          at: Date.now(),
          method: ((_b = requestConfig == null ? void 0 : requestConfig.method) != null ? _b : "GET").toUpperCase(),
          url: (_c = requestConfig == null ? void 0 : requestConfig.url) != null ? _c : "(unknown)",
          status: error.status,
          ok: false,
          duration: performance.now() - started2,
          source: "http"
    ...
    disposers.push(
      devtoolsBus.on("network", (data2) => {
        ...
        pushNetwork({
          at: Date.now(),
          method: ((_a2 = data2.method) != null ? _a2 : "GET").toUpperCase(),
          url: data2.url,
          status: (_b = data2.status) != null ? _b : 0,
          ok: (_c = data2.ok) != null ? _c : !data2.error,
          duration: (_d = data2.duration) != null ? _d : 0,
          source: (_e = data2.source) != null ? _e : "bus"
        });
      })
    );
  }
  ...
  function disableXray() {
    ...
    observer3 == null ? void 0 : observer3.disconnect();
    observer3 = null;
    ...
    outlined.length = 0;
    hoverTarget = null;
    refs == null ? void 0 : refs.root.remove();
    refs = null;
  }
  ...
  function xray(force) {
    enableXrayShortcut();
    const next = force != null ? force : !enabled;
    if (next) enableXray();
    else disableXray();
    return enabled;
  }
...
<circle cx="12" cy="7.5" r="2" fill="#FF3D8B"/>
  ...
  // src/browser.ts
  bootstrap(src_default);
  var browser_default = src_default;
  return __toCommonJS(browser_exports);
})();
if(typeof window!=="undefined"){window.V=Voodoo.default||Voodoo;window.Voodoo=window.V;}
//# sourceMappingURL=voodoo.full.js.map