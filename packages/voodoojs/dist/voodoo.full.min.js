 ...
 */
"use strict";var Voodoo=(()=>{var Do=Object.defineProperty;var Tm=Object.getOwnPropertyDescriptor;var Lm=Object.getOwnPropertyNames;var Mm=Object.prototype.hasOwnProperty;var Sm=(e,t,n)=>t in e?Do(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var As=(e,t)=>()=>(e&&(t=e(e=0)),t);var Po=(e,t)=>{for(var n in t)Do(e,n,{get:t[n],enumerable:!0})},Cm=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Lm(t))!Mm.call(e,o)&&o!==n&&Do(e,o,{get:()=>t[o],enumerable:!(r=Tm(t,o))||r.enumerable});return e};var Am=e=>Cm(Do({},"__esModule",{value:!0}),e);var H=(e,t,n)=>Sm(e,typeof t!="symbol"?t+"":t,n);var Uc={};Po(Uc,{EffectScope:()=>rt,ITERATE_KEY:()=>rn,ReactiveEffect:()=>Dn,TriggerType:()=>Bc,computed:()=>an,effect:()=>De,effectScope:()=>Bs,enableTracking:()=>zc,flushSync:()=>Os,getActiveEffect:()=>$m,getActiveScope:()=>Pm,handleError:()=>W,hasChanged:()=>$r,isReactive:()=>Vs,isRef:()=>on,markRaw:()=>Rr,nextTick:()=>ut,pauseTracking:()=>Ic,queueJob:()=>Io,queuePostFlush:()=>Se,reactive:()=>Y,ref:()=>ft,resetTracking:()=>zs,setErrorHandler:()=>Fs,shallowRef:()=>Us,stop:()=>Pn,toRaw:()=>Me,track:()=>dt,trigger:()=>Et,unref:()=>_s,warn:()=>X,watch:()=>Ie,watchEffect:()=>Ws});function ut(e){let t=Oo||Hs;return e?t.then(e):t}function Io(e){e.queued||(e.queued=!0,Rn.push(e),Fc())}function Se(e){Ho.push(e),Fc()}function Fc(){No||Ar||(Ar=!0,Oo=Hs.then(Ns))}function Ns(){Ar=!1,No=!0;let e=new Map;try{for(let t=0;t<Rn.length;t++){let n=Rn[t];if(!n.active)continue;let r=(e.get(n)||0)+1;if(e.set(n,r),r>Rm){X("Infinite update loop detected. A reactive effect keeps triggering itself without ever settling. Check whether some expression writes to state that it also reads.");continue}try{n.run()}catch(o){W(o,"effect")}}}finally{for(let n of Rn)n.queued=!1;Rn=[],No=!1;let t=Ho;Ho=[];for(let n of t)try{n()}catch(r){W(r,"post-flush")}Rn.length||Ho.length?(Oo=Hs.then(Ns),Ar=!0):Oo=null}}function Os(){No||(Ar=!1,Ns())}function Fs(e){Rs=e}function W(e,t){if(Rs){Rs(e,t);return}console.error(`[Voodoo] error in ${t}:`,e)}function X(e,...t){console.warn(`[Voodoo] ${e}`,...t)}function Ic(){Is.push(sn),sn=!1}function zc(){Is.push(sn),sn=!0}function zs(){var e;sn=(e=Is.pop())!=null?e:!0}function $m(){return Fe}function Pc(e){let{deps:t}=e;for(let n=0;n<t.length;n++)t[n].delete(e);t.length=0}function De(e,t){let n=new Dn(e,t);t!=null&&t.lazy||n.run();let r=(()=>n.run());return r.effect=n,r}function Pn(e){e instanceof Dn?e.stop():e.effect.stop()}function Bs(e=!1){return new rt(e)}function Pm(){return Ot}function dt(e,t){if(!sn||!Fe)return;let n=$s.get(e);n||$s.set(e,n=new Map);let r=n.get(t);r||n.set(t,r=new Set),r.has(Fe)||(r.add(Fe),Fe.deps.push(r))}function Et(e,t,n,r){let o=$s.get(e);if(!o)return;let i=new Set,s=a=>{if(a)for(let l of a)(l!==Fe||t==="clear")&&i.add(l)};if(t==="clear")o.forEach(s);else{n!==void 0&&s(o.get(n));let a=Array.isArray(e);if(t==="add")a?Ds(n)&&s(o.get("length")):s(o.get(rn));else if(t==="delete")a||s(o.get(rn));else if(a&&n==="length"){let l=Number(r);o.forEach((c,d)=>{(d==="length"||typeof d!="symbol"&&Number(d)>=l)&&s(c)})}}for(let a of i)a.scheduler?a.scheduler():Io(a)}function Ds(e){return typeof e=="string"&&e!=="NaN"&&e[0]!=="-"&&String(parseInt(e,10))===e}function Ft(e){return e!==null&&typeof e=="object"}function Nm(e){if(!Ft(e)||e[jc]||Object.isFrozen(e)||typeof Node!="undefined"&&e instanceof Node)return!1;let t=Object.prototype.toString.call(e).slice(8,-1);return Hm.has(t)?!1:t==="Object"||t==="Array"||t==="Map"||t==="Set"}function Rr(e){return Object.defineProperty(e,jc,{value:!0,enumerable:!1,configurable:!0}),e}function Me(e){let t=e&&e[js];return t?Me(t):e}function Vs(e){return!!(e&&e[qs])}function Y(e){if(!Ft(e)||Vs(e)||!Nm(e))return e;let t=Hc.get(e);if(t)return t;let n=e instanceof Map||e instanceof Set,r=new Proxy(e,n?Fm:Om);return Hc.set(e,r),r}function $r(e,t){return!Object.is(e,t)}function on(e){return!!(e&&e.__v_isRef===!0)}function Oc(e){return Ft(e)?Y(e):e}function qc(e){!sn||!Fe||e.dep.has(Fe)||(e.dep.add(Fe),Fe.deps.push(e.dep))}function Vc(e){for(let t of[...e.dep])t.scheduler?t.scheduler():Io(t)}function ft(e){return new Fo(e)}function Us(e){return new Fo(e,!0)}function _s(e){return on(e)?e.value:e}function an(e){let t=typeof e=="function",n=t?e:e.get,r=t?void 0:e.set;return new Ps(n,r)}function Ie(e,t,n={}){let{immediate:r=!1,deep:o=!1,flush:i="pre"}=n,s;if(on(e)?s=()=>e.value:typeof e=="function"?s=e:Vs(e)?s=()=>$n(e):s=()=>e,o){let p=s;s=()=>$n(p())}let a,l,c=p=>{l=p},d=()=>{if(!f.effect.active)return;let p=f();(o||$r(p,a))&&(l==null||l(),l=void 0,t(p,a,c),a=p)},f=i==="pre"?De(s,{lazy:!0,scheduler:()=>Se(d)}):De(s,{lazy:!0,scheduler:i==="sync"?d:i==="post"?()=>Se(d):()=>Io(f.effect)});return a=f(),r&&t(a,void 0,c),()=>f.effect.stop()}function Ws(e){let t,n=o=>{t=o},r=De(()=>{t==null||t(),t=void 0,e(n)});return()=>{t==null||t(),r.effect.stop()}}function $n(e,t=new Set){if(!Ft(e)||t.has(e))return e;if(t.add(e),on(e))$n(e.value,t);else if(Array.isArray(e))for(let n of e)$n(n,t);else if(e instanceof Set||e instanceof Map)e.forEach(n=>$n(n,t));else for(let n of Object.keys(e))$n(e[n],t);return e}var Hs,Rn,Ho,No,Ar,Oo,Rm,Rs,Fe,sn,Is,Dm,Dn,Ot,rt,rn,$s,Bc,js,qs,jc,Hc,Nc,Hm,Om,Fm,Fo,Ps,ue=As(()=>{"use strict";Hs=Promise.resolve(),Rn=[],Ho=[],No=!1,Ar=!1,Oo=null,Rm=100;Rs=null;sn=!0,Is=[];Dm=0,Dn=class{constructor(t,n){var o;this.fn=t,this.id=Dm++,this.active=!0,this.queued=!1,this.deps=[],this.parent=void 0,this.scheduler=n==null?void 0:n.scheduler,this.onStop=n==null?void 0:n.onStop,this.cleanups=[];let r=(o=n==null?void 0:n.scope)!=null?o:Ot;r&&r.effects.push(this)}run(){if(!this.active)return this.fn();let t=Fe;for(;t;){if(t===this)return;t=t.parent}this.runCleanups();try{return this.parent=Fe,Fe=this,zc(),Pc(this),this.fn()}finally{zs(),Fe=this.parent,this.parent=void 0}}onInvalidate(t){this.cleanups.push(t)}runCleanups(){if(!this.cleanups.length)return;let t=this.cleanups;this.cleanups=[];for(let n of t)try{n()}catch(r){W(r,"effect cleanup")}}stop(){var t;this.active&&(Pc(this),this.runCleanups(),this.active=!1,(t=this.onStop)==null||t.call(this))}};rt=class{constructor(t=!1){this.effects=[],this.cleanups=[],this.children=[],this.active=!0,this.parent=void 0,!t&&Ot&&(this.parent=Ot,Ot.children.push(this))}run(t){if(!this.active)return;let n=Ot;try{return Ot=this,t()}finally{Ot=n}}onDispose(t){this.cleanups.push(t)}stop(){if(this.active){this.active=!1;for(let t of this.effects)t.stop();for(let t of this.children)t.stop();for(let t of this.cleanups)try{t()}catch(n){W(n,"scope cleanup")}if(this.effects.length=0,this.children.length=0,this.cleanups.length=0,this.parent){let t=this.parent.children.indexOf(this);t>-1&&this.parent.children.splice(t,1)}}}};rn=Symbol("voodoo:iterate"),$s=new WeakMap;Bc=(o=>(o.SET="set",o.ADD="add",o.DELETE="delete",o.CLEAR="clear",o))(Bc||{});js=Symbol("voodoo:raw"),qs=Symbol("voodoo:isReactive"),jc=Symbol("voodoo:skip"),Hc=new WeakMap,Nc=(()=>{let e={};for(let t of["includes","indexOf","lastIndexOf"])e[t]=function(...n){let r=Me(this);for(let i=0;i<r.length;i++)dt(r,String(i));let o=r[t].apply(r,n);return o===-1||o===!1?r[t].apply(r,n.map(Me)):o};for(let t of["push","pop","shift","unshift","splice"])e[t]=function(...n){Ic();try{return Me(this)[t].apply(this,n)}finally{zs()}};return e})();Hm=new Set(["Date","RegExp","Promise","Error","File","FileList","Blob","FormData","URL","URLSearchParams","ArrayBuffer","DataView"]);Om={get(e,t,n){if(t===js)return e;if(t===qs)return!0;let r=Array.isArray(e);if(r&&Object.prototype.hasOwnProperty.call(Nc,t))return Reflect.get(Nc,t,n);let o=Reflect.get(e,t,n);return typeof t=="symbol"?o:(dt(e,t),on(o)?r&&Ds(t)?o:o.value:Ft(o)?Y(o):o)},set(e,t,n,r){let o=e[t];if(n=Me(n),!Array.isArray(e)&&on(o)&&!on(n))return o.value=n,!0;let i=Array.isArray(e)&&Ds(t)?Number(t)<e.length:Object.prototype.hasOwnProperty.call(e,t),s=Reflect.set(e,t,n,r);return e===Me(r)&&(i?$r(n,o)&&Et(e,"set",t,n):Et(e,"add",t,n)),s},deleteProperty(e,t){let n=Object.prototype.hasOwnProperty.call(e,t),r=Reflect.deleteProperty(e,t);return r&&n&&Et(e,"delete",t),r},has(e,t){let n=Reflect.has(e,t);return typeof t!="symbol"&&dt(e,t),n},ownKeys(e){return dt(e,Array.isArray(e)?"length":rn),Reflect.ownKeys(e)}},Fm={get(e,t,n){if(t===js)return e;if(t===qs)return!0;let r=e;if(t==="size")return dt(r,rn),Reflect.get(r,"size",r);let o={get(s){dt(r,s);let a=r.get(s);return Ft(a)?Y(a):a},has(s){return dt(r,s),r.has(s)},add(s){s=Me(s);let a=r.has(s);return r.add(s),a||Et(r,"add",s,s),n},set(s,a){let l=r.has(s),c=r.get(s);return r.set(s,Me(a)),l?$r(a,c)&&Et(r,"set",s,a):Et(r,"add",s,a),n},delete(s){let a=r.has(s),l=r.delete(s);return a&&Et(r,"delete",s),l},clear(){let s=r.size!==0,a=r.clear();return s&&Et(r,"clear"),a},forEach(s,a){return dt(r,rn),r.forEach((l,c)=>{s.call(a,Ft(l)?Y(l):l,Ft(c)?Y(c):c,n)})}};if(t in o)return o[t];if(t===Symbol.iterator||t==="keys"||t==="values"||t==="entries"){dt(r,rn);let s=r[t];return typeof s=="function"?s.bind(r):s}let i=Reflect.get(r,t,r);return typeof i=="function"?i.bind(r):i}};Fo=class{constructor(t,n=!1){H(this,"shallow",n);H(this,"__v_isRef",!0);H(this,"_value");H(this,"_rawValue");H(this,"dep",new Set);this._rawValue=Me(t),this._value=n?t:Oc(t)}get value(){return qc(this),this._value}set value(t){let n=Me(t);$r(n,this._rawValue)&&(this._rawValue=n,this._value=this.shallow?t:Oc(t),Vc(this))}};Ps=class{constructor(t,n){H(this,"setter",n);H(this,"__v_isRef",!0);H(this,"_value");H(this,"_dirty",!0);H(this,"effect");H(this,"dep",new Set);this.effect=new Dn(t,{scheduler:()=>{this._dirty||(this._dirty=!0,Vc(this))}})}get value(){return qc(this),this._dirty&&(this._dirty=!1,this._value=this.effect.run()),this._value}set value(t){this.setter?this.setter(t):X("computed is read-only when there is no setter.")}stop(){this.effect.stop()}}});function y(e,t,n={}){var r,o;Mt.set(e,{name:e,setup:t,priority:(r=n.priority)!=null?r:j.DEFAULT,terminal:(o=n.terminal)!=null?o:!1})}function ln(e){return e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").replace(/[_\s]+/g,"-").toLowerCase()}function qo(e,t,n){rd.has(t)||(rd.add(t),typeof t=="function"?t(e,n):t.install(e,n))}var w,Mt,j,Pe,rd,ce=As(()=>{"use strict";w={prefix:"v-",autoStart:!0,autoDiscover:!0,root:null,devtools:!1,xrayShortcut:"ctrl+shift+f2",baseURL:"",globals:{},locale:typeof navigator!="undefined"&&navigator.language||"pt-BR",currency:"BRL",injectStyles:!0,cleanAttributes:!0,sanitizeUrls:!0},Mt=new Map,j={IGNORE:100,FOR:90,IF:80,DATA:70,COMPONENT:65,REF:60,BIND:45,MODEL:40,DEFAULT:0,INIT:-10,TRANSITION:-20};Pe=new Map;rd=new Set});var Gd={};Po(Gd,{BASE_TOKENS:()=>Xd,ensureTokens:()=>ge,injectStyle:()=>oe});function oe(e,t){if(typeof document=="undefined"||!w.injectStyles||Yd.has(e))return;Yd.add(e);let n=document.createElement("style");n.setAttribute("data-voodoo",e),n.textContent=t,document.head.appendChild(n)}function ge(){oe("tokens",Xd)}var Yd,Xd,Ne=As(()=>{"use strict";ce();Yd=new Set;Xd=`
:root{
  --v-primary:#6D3BF5;
...
`});var Zx={};Po(Zx,{default:()=>Jx});ue();var ee=class extends Error{constructor(n,r,o){let i=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${i}`);H(this,"source",r);H(this,"position",o);this.name="VoodooSyntaxError"}},Im=[">>>=","===","!==","**=","...",">>>","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","&=","|=","^=","<<",">>","+","-","*","/","%","!","<",">","=","&","|","^","~","(",")","[","]","{","}",",",".","?",":",";"],zm=/[A-Za-z_$À-￿]/,Bm=/[A-Za-z0-9_$À-￿]/;function jm(e){return zm.test(e)}function qm(e){return Bm.test(e)}function zo(e){return e>="0"&&e<="9"}var _c={n:`
...
`;function eo(){ge(),oe("dnd",cg)}var sr=new Map,ar=new Map;function Ja(e,t){if(t&&t.trim())return t.trim();let n=e.closest("[data-v-dnd-group]");return(n==null?void 0:n.getAttribute("data-v-dnd-group"))||null}function bt(e){return Array.from(e.children).filter(t=>!t.classList.contains("v-drag-ghost"))}function dg(e,t){var n;return(n=e.getAttribute("data-id"))!=null?n:e.id||String(t)}function Qu(e){return bt(e).map((t,n)=>dg(t,n))}function Ju(e){let t=getComputedStyle(e);return t.display.includes("flex")?t.flexDirection.startsWith("row"):t.display.includes("grid")?t.gridAutoFlow.startsWith("column"):!1}var $=null,Zr=0;function ug(e,t){let n=e.cloneNode(!0);n.classList.add("v-drag-ghost"),n.classList.remove("v-dragging","v-grabbed"),n.removeAttribute("id");for(let r of Array.from(n.querySelectorAll("[id]")))r.removeAttribute("id");return n.style.width=`${t.width}px`,n.style.height=`${t.height}px`,n.setAttribute("aria-hidden","true"),document.body.appendChild(n),n}function Zu(e,t){if(!($!=null&&$.ghost))return;let n=$.axis==="y"?$.lastX:e,r=$.axis==="x"?$.lastY:t;$.ghost.style.transform=`translate3d(${Math.round(n-$.grabX)}px, ${Math.round(r-$.grabY)}px, 0)`}function fg(e){let t=e;for(;t&&t!==document.body&&t!==document.documentElement;){let n=getComputedStyle(t),r=(n.overflowY==="auto"||n.overflowY==="scroll")&&t.scrollHeight>t.clientHeight+2,o=(n.overflowX==="auto"||n.overflowX==="scroll")&&t.scrollWidth>t.clientWidth+2;if(r||o)return t;t=t.parentElement}return null}function pg(){if(!$)return;let e=56,t=16,n=$.lastX,r=$.lastY,o=document.elementFromPoint(n,r),i=fg(o!=null?o:$.overList);if(i){let s=i.getBoundingClientRect();r-s.top<e?i.scrollTop-=t:s.bottom-r<e&&(i.scrollTop+=t),n-s.left<e?i.scrollLeft-=t:s.right-n<e&&(i.scrollLeft+=t);return}r<e?window.scrollBy(0,-t):window.innerHeight-r<e&&window.scrollBy(0,t),n<e?window.scrollBy(-t,0):window.innerWidth-n<e&&window.scrollBy(t,0)}function mg(){let e=()=>{!$||$.keyboard||(pg(),Zr=requestAnimationFrame(e))};Zr=requestAnimationFrame(e)}function vg(){Zr&&cancelAnimationFrame(Zr),Zr=0}function ef(e,t){let n=sr.get(e);return n?e===t.startList?!0:!n.group||!t.group?!1:n.group===t.group:!1}function Za(e,t){return!(e.accept&&!t.item.matches(e.accept)||e.group&&e.group!==t.group)}function tf(e,t){for(let n of ar.values())n.el.classList.toggle("v-drop-active",t&&Za(n,e));for(let n of sr.values())n.el.classList.toggle("v-drop-active",t&&ef(n.el,e))}function hg(e,t,n,r){let o=Ju(e),i=null;for(let s of bt(e)){if(s===t)continue;let a=s.getBoundingClientRect(),l=o?a.left+a.width/2:a.top+a.height/2;if((o?n:r)<l){i=s;break}}if(i){(t.nextElementSibling!==i||t.parentElement!==e)&&e.insertBefore(t,i);return}e.lastElementChild!==t&&e.appendChild(t)}function el(e,t){eo();let n=e.getBoundingClientRect(),r=t.mode==="sort"?e.parentElement:null;$={item:e,mode:t.mode,data:t.data,group:t.group,axis:t.axis,ghost:null,pointerId:t.pointerId,grabX:t.keyboard?n.width/2:t.x-n.left,grabY:t.keyboard?n.height/2:t.y-n.top,startParent:e.parentElement,startNext:e.nextSibling,startList:r,startIndex:r?bt(r).indexOf(e):-1,overDrop:null,overList:r,keyboard:!!t.keyboard,lastX:t.x,lastY:t.y},e.classList.add("v-dragging"),e.setAttribute("aria-grabbed","true"),t.keyboard?e.classList.add("v-grabbed"):($.ghost=ug(e,n),Zu(t.x,t.y),mg()),tf($,!0),document.addEventListener("keydown",rf,!0),pe(e,"voodoo:drag-start",{item:e,data:t.data,group:t.group})}function gg(e,t){var a,l,c;if(!$)return;$.lastX=e,$.lastY=t,Zu(e,t);let n=document.elementFromPoint(e,t),r=(a=n==null?void 0:n.closest(".v-sortable"))!=null?a:null,o=(l=n==null?void 0:n.closest(".v-droppable"))!=null?l:null;$.mode==="sort"&&r&&ef(r,$)?($.overList&&$.overList!==r&&$.overList.classList.remove("v-drop-over"),$.overList=r,r.classList.add("v-drop-over"),hg(r,$.item,e,t)):$.overList&&!r&&$.overList.classList.remove("v-drop-over");let i=o?ar.get(o):void 0,s=i?Za(i,$):!1;$.overDrop&&$.overDrop!==o&&($.overDrop.classList.remove("v-drop-over"),$.overDrop=null),o&&s&&(o.classList.add("v-drop-over"),$.overDrop=o),(c=$.ghost)==null||c.classList.toggle("v-drag-invalid",!!o&&!s)}function bg(e){e.startParent&&(e.startNext&&e.startNext.parentNode===e.startParent?e.startParent.insertBefore(e.item,e.startNext):e.startParent.appendChild(e.item))}function nf(e){var t,n,r;(t=e.ghost)==null||t.remove(),e.item.classList.remove("v-dragging","v-grabbed"),e.item.setAttribute("aria-grabbed","false"),(n=e.overDrop)==null||n.classList.remove("v-drop-over"),(r=e.overList)==null||r.classList.remove("v-drop-over"),tf(e,!1),vg(),document.removeEventListener("keydown",rf,!0),$=null}function tl(){var i;let e=$;if(!e)return;let t=e.item.parentElement,n=t?bt(t).indexOf(e.item):-1,r=e.overDrop,o=r?ar.get(r):void 0;if(e.mode==="sort"&&t&&sr.has(t)&&(t!==e.startList||n!==e.startIndex)){let a={item:e.item,oldIndex:e.startIndex,newIndex:n,from:e.startList,to:t,order:Qu(t)};pe(t,"voodoo:sorted",a),e.startList&&e.startList!==t&&pe(e.startList,"voodoo:sorted",{...a,order:Qu(e.startList)}),Qe(`Item moved to position ${n+1} of ${bt(t).length}`)}if(r&&o){let s={item:e.item,data:e.data,from:(i=e.startList)!=null?i:e.startParent,to:r,index:n},a=new CustomEvent("voodoo:drop",{detail:s,bubbles:!0});r.dispatchEvent(a),gt(o.expression,o.scope,r,a,s),Qe("Item dropped in drop zone")}pe(e.item,"voodoo:drag-end",{item:e.item,data:e.data}),nf(e)}function Qa(){let e=$;e&&(bg(e),pe(e.item,"voodoo:drag-cancel",{item:e.item}),Qe("Drag canceled"),nf(e))}function rf(e){!$||e.key!=="Escape"||(e.preventDefault(),Qa())}function of(e,t,n){let r=null,o=-1,i=0,s=0,a=!1,l=p=>{if(p.pointerId===o){if(!a){if(Math.hypot(p.clientX-i,p.clientY-s)<4||!r)return;a=!0,el(r,{mode:t.mode,data:t.data(),group:t.group(),axis:t.axis(),pointerId:o,x:i,y:s})}p.preventDefault(),gg(p.clientX,p.clientY)}},c=()=>{window.removeEventListener("pointermove",l),window.removeEventListener("pointerup",d),window.removeEventListener("pointercancel",u),r=null,o=-1,a=!1},d=p=>{p.pointerId===o&&(a&&tl(),c())},u=()=>{a&&Qa(),c()},f=p=>{if(p.button!==0||$)return;let m=p.target;if(!m||m.closest('input,textarea,select,option,[contenteditable="true"]')||t.handle&&!m.closest(t.handle))return;let h=t.itemFrom(m);h&&(r=h,o=p.pointerId,i=p.clientX,s=p.clientY,a=!1,window.addEventListener("pointermove",l,{passive:!1}),window.addEventListener("pointerup",d),window.addEventListener("pointercancel",u))};e.addEventListener("pointerdown",f),n(()=>{e.removeEventListener("pointerdown",f),a&&Qa(),c()})}function yg(e){return e?Array.from(sr.values()).filter(t=>t.group===e).map(t=>t.el).sort((t,n)=>t.compareDocumentPosition(n)&Node.DOCUMENT_POSITION_FOLLOWING?-1:1):[]}function xg(e,t){if(!$)return!1;let n=e.parentElement;if(!n)return!1;let r=Ju(n),o=t==="ArrowDown"||r&&t==="ArrowRight",i=t==="ArrowUp"||r&&t==="ArrowLeft",s=bt(n),a=s.indexOf(e);if(o||i){let l=a+(o?1:-1);return l<0||l>=s.length?!1:(o?n.insertBefore(e,s[l].nextSibling):n.insertBefore(e,s[l]),Qe(`Position ${l+1} of ${s.length}`),e.focus(),!0)}if(!r&&(t==="ArrowLeft"||t==="ArrowRight")){let l=yg($.group),c=l.indexOf(n);if(c===-1)return!1;let d=l[c+(t==="ArrowRight"?1:-1)];return d?(d.appendChild(e),Qe(`Moved to list ${l.indexOf(d)+1} of ${l.length}`),e.focus(),!0):!1}return!1}function wg(e){return Array.from(ar.values()).filter(t=>Za(t,e)).map(t=>t.el)}y("dnd-group",({el:e,expression:t})=>{eo();let n=t.trim()||"default";e.setAttribute("data-v-dnd-group",n),e.classList.add("v-dnd-group")});y("sortable",({el:e,expression:t,cleanup:n})=>{eo(),e.classList.add("v-sortable");let r=Z(e,"sortable-handle")||t.trim()||null,o={el:e,group:Ja(e,Z(e,"sortable-group")),handle:r};sr.set(e,o),e.hasAttribute("aria-label")||e.setAttribute("aria-label","Sortable list");let i=l=>{var c;l.hasAttribute("tabindex")||l.setAttribute("tabindex","0"),l.hasAttribute("aria-grabbed")||l.setAttribute("aria-grabbed","false"),r?(c=l.querySelector(r))==null||c.classList.add("v-drag-handle"):l.classList.add("v-drag-handle")};for(let l of bt(e))i(l);let s=typeof MutationObserver=="undefined"?null:new MutationObserver(()=>{for(let l of bt(e))i(l)});s==null||s.observe(e,{childList:!0}),of(e,{mode:"sort",handle:r,group:()=>o.group,data:()=>null,axis:()=>null,itemFrom:l=>{let c=bt(e).find(d=>d===l||d.contains(l));return c!=null?c:null}},n);let a=l=>{let c=l.target;if(!c)return;let d=bt(e).find(u=>u===c||u.contains(c));if(d){if(l.key===" "||l.key==="Spacebar"){if(l.preventDefault(),$&&$.item===d){tl(),Qe("Item dropped");return}if($)return;el(d,{mode:"sort",data:null,group:o.group,axis:null,pointerId:-1,x:0,y:0,keyboard:!0}),Qe("Item grabbed. Use arrow keys to move and space to drop.");return}!$||$.item!==d||l.key.startsWith("Arrow")&&xg(d,l.key)&&l.preventDefault()}};e.addEventListener("keydown",a),n(()=>{e.removeEventListener("keydown",a),s==null||s.disconnect(),sr.delete(e)})});K("sortable-group");K("sortable-handle");y("draggable",({el:e,expression:t,scope:n,cleanup:r})=>{var m;eo(),e.classList.add("v-draggable");let o=Z(e,"draggable-handle")||null,i=(Z(e,"draggable-axis")||"").trim().toLowerCase(),s=i==="x"||i==="y"?i:null,a=Z(e,"draggable-data")||t.trim(),l=Ja(e,Z(e,"draggable-group"));o?(m=e.querySelector(o))==null||m.classList.add("v-drag-handle"):e.classList.add("v-drag-handle"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("aria-grabbed","false"),e.hasAttribute("aria-roledescription")||e.setAttribute("aria-roledescription","draggable item");let c=()=>a?q(a,n,"v-draggable-data"):null;of(e,{mode:"free",handle:o,group:()=>l,data:c,axis:()=>s,itemFrom:()=>e},r);let d=[],u=0,f=()=>{d.forEach((v,g)=>v.classList.toggle("v-drop-over",g===u));let h=d[u];!h||!$||($.overDrop=h,ve.reducedMotion?h.scrollIntoView({block:"nearest"}):h.scrollIntoView({block:"nearest",behavior:"smooth"}),Qe(h.getAttribute("aria-label")||`Target ${u+1} of ${d.length}`))},p=h=>{if(h.key===" "||h.key==="Spacebar"){if(h.preventDefault(),$&&$.item===e){tl(),d=[];return}if($)return;el(e,{mode:"free",data:c(),group:l,axis:s,pointerId:-1,x:0,y:0,keyboard:!0}),d=$?wg($):[],u=0,d.length?f():Qe("No targets available");return}if(!(!$||$.item!==e||!d.length)){if(h.key==="ArrowDown"||h.key==="ArrowRight"){h.preventDefault(),u=(u+1)%d.length,f();return}(h.key==="ArrowUp"||h.key==="ArrowLeft")&&(h.preventDefault(),u=(u-1+d.length)%d.length,f())}};e.addEventListener("keydown",p),r(()=>{e.removeEventListener("keydown",p);for(let h of d)h.classList.remove("v-drop-over")})});K("draggable-handle");K("draggable-axis");K("draggable-data");K("draggable-group");y("droppable",({el:e,expression:t,scope:n,cleanup:r})=>{eo(),e.classList.add("v-droppable");let o={el:e,group:Ja(e,Z(e,"droppable-group")),accept:Z(e,"droppable-accept"),expression:t,scope:n};ar.set(e,o),e.hasAttribute("aria-dropeffect")||e.setAttribute("aria-dropeffect","move"),r(()=>{ar.delete(e),e.classList.remove("v-drop-over","v-drop-active")})});K("droppable-accept");K("droppable-group");var kg=`
.v-visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;
  clip:rect(0 0 0 0);white-space:nowrap;border:0}
...
`;function Vi(){ge(),oe("forms-validate",Xg)}function Sf(e){var r,o,i;let t=Pt(e,"error-target");if(t&&typeof document!="undefined"){let s=(i=(o=(r=e.form)!=null?r:e.closest("form"))==null?void 0:o.querySelector(t))!=null?i:document.querySelector(t);if(s)return{parent:s,anchor:null};X(`Target for ${w.prefix}error-target not found: ${t}`)}let n=e.parentElement;return n?{parent:n,anchor:e}:null}function Cf(e){let t=Sf(e);if(!t)return null;if(t.anchor){let n=t.anchor.nextElementSibling;return n&&n.classList.contains("v-field-error")?n:null}return t.parent.querySelector(".v-field-error")}function Ui(e,t){Vi(),e.classList.add("v-invalid"),e.classList.remove("v-valid"),e.setAttribute("aria-invalid","true");let n=Cf(e);if(!n){let o=Sf(e);if(!o)return;n=document.createElement("span"),n.className="v-field-error",n.id=e.id?`${e.id}-error`:le("v-error-"),n.setAttribute("role","alert"),n.setAttribute("aria-live","polite"),o.anchor?o.anchor.insertAdjacentElement("afterend",n):o.parent.appendChild(n)}n.textContent=t;let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.push(n.id),e.setAttribute("aria-describedby",r.join(" "))}function dl(e,t=!1){e.classList.remove("v-invalid"),e.classList.toggle("v-valid",t),e.removeAttribute("aria-invalid");let n=Cf(e);if(n){let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.length?e.setAttribute("aria-describedby",r.join(" ")):e.removeAttribute("aria-describedby"),n.remove()}}function ao(e){for(let n of Wi(e,!1))dl(n);for(let n of Array.from(e.querySelectorAll(".v-field-error")))n.remove();let t=e.querySelector(".v-form-error");t&&t.remove();for(let n of Array.from(e.querySelectorAll(".v-invalid, .v-valid")))n.classList.remove("v-invalid","v-valid"),n.removeAttribute("aria-invalid")}function ml(e){let t={};if(!e||typeof e!="object")return t;let n=e,r=n.errors&&typeof n.errors=="object"?n.errors:n;for(let[o,i]of Object.entries(r))o==="message"||o==="mensagem"||o==="errors"||(typeof i=="string"?t[o]=i:Array.isArray(i)&&typeof i[0]=="string"&&(t[o]=i[0]));return t}function Gg(e,t){let n=t.replace(/\.(\w+)/g,"[$1]"),r=[t,n,`${t}[]`,`${n}[]`];for(let i of r){let s=e.querySelector(`[name="${Fi(i)}"]`);if(Je(s))return s}let o=e.querySelector(`#${Fi(t)}`);return Je(o)?o:null}function _i(e,t){let n=ml(t),r=[];for(let[o,i]of Object.entries(n)){let s=Gg(e,o);s?Ui(s,i):r.push(i)}return r.length&&Qg(e,r),n}function Qg(e,t){Vi();let n=e.querySelector(".v-form-error");if(n||(n=document.createElement("div"),n.className="v-form-error",n.setAttribute("role","alert"),e.prepend(n)),n.textContent="",t.length===1){n.textContent=t[0];return}let r=document.createElement("ul");for(let o of t){let i=document.createElement("li");i.textContent=o,r.appendChild(i)}n.appendChild(r)}function vl(e){let t=e.querySelector(".v-invalid");if(!t)return!1;try{t.focus({preventScroll:!0})}catch(r){t.focus()}let n=typeof window!="undefined"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;return typeof t.scrollIntoView=="function"&&t.scrollIntoView({block:"center",behavior:n?"auto":"smooth"}),!0}function Wi(e,t=!0){let n=e.tagName==="FORM"?Array.from(e.elements):Array.from(e.querySelectorAll("input, select, textarea")),r=[];for(let o of n)Je(o)&&(o.disabled||Ng.has(yt(o))||t&&pl(o).length===0||r.push(o));return r}async function hl(e,t={}){var s,a;if(!Je(e))return{valid:!0};let n=pl(e);if(!n.length)return t.silent||dl(e),{valid:!0};let r=io(e),o=Pt(e,"error-message"),i=r.trim()==="";for(let l of n){if(i&&!Kg.has(l.name))continue;let c=zi.get(l.name);if(!c)continue;let d;try{d=await c.fn(r,l.param||void 0,e)}catch(p){X(`Rule "${l.name}" failed to execute`,p);continue}if(d===!0)continue;let u=o!=null?o:typeof d=="string"?d:(a=(s=at[l.name])!=null?s:c.message)!=null?a:at.invalid,f=Mf(u,{field:Og(e),param:l.param,value:r});return t.silent||(Ui(e,f),Lf(e,{valid:!1,message:f,rule:l.name})),{valid:!1,message:f,rule:l.name}}return t.silent||(dl(e,!i),Lf(e,{valid:!0})),{valid:!0}}function gl(e){return Je(e)?hl(e):bl(e)}async function bl(e){let t=Wi(e),n=await Promise.all(t.map(o=>hl(o))),r={};return t.forEach((o,i)=>{var a;let s=n[i];s.valid||(r[fl(o)]=(a=s.message)!=null?a:at.invalid)}),{valid:Object.keys(r).length===0,errors:r}}function Lf(e,t){e.dispatchEvent(new CustomEvent("voodoo:field-validated",{bubbles:!0,detail:{field:fl(e),...t}}))}function Jg(e){let t=e.indexOf("[");if(t===-1)return[e];let n=[e.slice(0,t)],r=/\[([^\]]*)\]/g,o;for(;(o=r.exec(e))!==null;)n.push(o[1]);return n}function Zg(e,t,n){let r=e;for(let o=0;o<t.length;o++){let i=t[o],s=o===t.length-1,a=t[o+1];if(i===""){if(!Array.isArray(r))return;if(s){r.push(n);return}let c=a===""?[]:{};r.push(c),r=c;continue}if(Array.isArray(r)){let c=Number(i);if(!Number.isInteger(c))return;if(s){r[c]=n;return}let d=r[c];(d==null||typeof d!="object")&&(d=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[c]=d),r=d;continue}if(s){r[i]=n;return}let l=r[i];(l==null||typeof l!="object")&&(l=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[i]=l),r=l}}function eb(e,t){var a,l,c,d;let n=Wi(e,!1),r=[],o=new Map;for(let u of n)yt(u)==="checkbox"&&u.name&&o.set(u.name,((a=o.get(u.name))!=null?a:0)+1);let i=t.trim!==!1,s=t.numbers!==!1;for(let u of n){if(!u.name||u.disabled&&!t.includeDisabled)continue;let f=yt(u);if(f==="file"){let m=Array.from((l=u.files)!=null?l:[]);if(!m.length)continue;let h=u.multiple||u.name.endsWith("[]");r.push({name:u.name,value:h?m:m[0]});continue}if(f==="checkbox"){if(((c=o.get(u.name))!=null?c:1)>1||u.name.endsWith("[]")){if(!u.checked)continue;let h=u.name.endsWith("[]")?u.name:`${u.name}[]`;r.push({name:h,value:u.value||"on"})}else r.push({name:u.name,value:u.checked});continue}if(f==="radio"){if(!u.checked)continue;r.push({name:u.name,value:u.value});continue}if(u.tagName==="SELECT"&&u.multiple){let m=Array.from(u.selectedOptions).map(v=>v.value),h=u.name.endsWith("[]")?u.name:`${u.name}[]`;for(let v of m)r.push({name:h,value:v});continue}let p=(d=u.value)!=null?d:"";if(i&&typeof p=="string"&&(p=p.trim()),s&&(f==="number"||f==="range")&&p!==""){let m=Number(p);Number.isFinite(m)&&(p=m)}r.push({name:u.name,value:p})}return r}function tb(e){for(let t of Wi(e,!1)){if(yt(t)!=="file")continue;let n=t.files;if(n&&n.length)return!0}return!1}function Af(e,t,n){if(n instanceof File||typeof Blob!="undefined"&&n instanceof Blob){e.append(t,n);return}if(Array.isArray(n)){let r=t.endsWith("[]")?t:`${t}[]`;for(let o of n)Af(e,r,o);return}if(typeof n=="boolean"){e.append(t,n?"1":"0");return}e.append(t,n==null?"":String(n))}function cr(e,t={}){let n=eb(e,t);if(t.formData||tb(e)){let o=new FormData;for(let i of n)Af(o,i.name,i.value);return o}let r={};for(let o of n)Zg(r,Jg(o.name),o.value);return r}var ro=new WeakSet,oo=new WeakSet;async function Ii(e){(await hl(e)).valid?oo.delete(e):oo.add(e)}function Ki(e,t){if(!Je(e)){X(`${w.prefix}validate only works on input, select, or textarea.`);return}if(ro.has(e))return;ro.add(e),Vi();let n=()=>{Ii(e)},r=()=>{oo.has(e)&&Ii(e)};e.addEventListener("blur",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{ro.delete(e),oo.delete(e),e.removeEventListener("blur",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}var ul=new WeakSet;function Rf(e){return ul.has(e)||Pg(e,"validate")}function nb(e,t){ul.add(e),Vi(),e.tagName==="FORM"&&(e.noValidate=!0);let n=o=>{let i=o.target;!Je(i)||ro.has(i)||pl(i).length!==0&&Ii(i)},r=o=>{let i=o.target;!Je(i)||ro.has(i)||oo.has(i)&&Ii(i)};e.addEventListener("focusout",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{ul.delete(e),e.removeEventListener("focusout",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}y("validate",({el:e,cleanup:t})=>{if(e.tagName==="FORM"||e.hasAttribute(`${w.prefix}submit`)){nb(e,t);return}Ki(e,t)});var rb=["required","email","url","number","integer","minlength","maxlength","min","max","match","regex","cpf","cnpj","cep","phone","date","accepted","strong-password"];for(let e of rb)y(e,({el:t,cleanup:n})=>{Ki(t,n)});for(let e of["error-message","error-target","regex-flags","unique-url"])y(e,({el:t,cleanup:n})=>{Je(t)&&Ki(t,n)});function Df(){return Y({loading:!1,saving:!1,success:!1,errors:{},message:"",data:null,status:0,dirty:!1,progress:0})}var dr=new WeakMap,wl=new WeakMap,ob=Df();function lo(e){let t=dr.get(e);return t||(t=Df(),dr.set(e,t)),t}function ib(e){let t=e;for(;t;){let n=wl.get(t);if(n)return n;let r=t.el;if(r){let o=r.closest("form"),i=o?dr.get(o):void 0;if(i)return i;let s=r.querySelector("form"),a=s?dr.get(s):void 0;if(a)return a}t=t.parent}if(typeof document!="undefined")for(let n of Array.from(document.forms)){let r=dr.get(n);if(r)return r}return ob}N("$form",e=>ib(e));var ur=new WeakMap,sb=["submit","upload","dropzone","autosave","get","post","put","patch","delete","load","load-visible","search","resource"];function $f(e){return sb.some(t=>zt(e,`${w.prefix}${t}`)||zt(e,`data-v-${t}`))}function Ae(e,t){var i,s,a;let n=Pt(e,t);if(n!==null)return n;let r=e.closest("form");if(r&&r!==e){let l=Pt(r,t);if(l!==null)return l}let o=(a=(i=ur.get(e))==null?void 0:i[t])!=null?a:r?(s=ur.get(r))==null?void 0:s[t]:void 0;return o!=null?o:null}function Gi(e,t){return Ae(e,t)!==null}function Ze(e,t){y(e,({el:n,expression:r})=>{var a,l;let o=(a=n.closest("form"))!=null?a:n,i=(l=ur.get(o))!=null?l:{};if(i[e]=r,ur.set(o,i),!$f(o)&&!$f(n)){X(`${w.prefix}${e} needs an element with ${w.prefix}submit, ${w.prefix}upload, ${w.prefix}dropzone, or ${w.prefix}autosave.`);return}let s=t==null?void 0:t(r);s&&X(s)})}var ab=["GET","POST","PUT","PATCH","DELETE","HEAD","OPTIONS"];Ze("method",e=>e&&!ab.includes(e.trim().toUpperCase())?`${w.prefix}method received an unknown verb: ${e}`:null);Ze("redirect");Ze("reset-success");Ze("disable-loading");Ze("loading-class");Ze("on-success");Ze("on-error");Ze("on-complete");Ze("toast-success");Ze("toast-error");Ze("confirm");Ze("form-data");y("loading",({el:e,expression:t})=>{var i,s;let n=(i=e.closest("form"))!=null?i:e,r=(s=ur.get(n))!=null?s:{};r.loading=t,ur.set(n,r);let o=Pf(t);if(!o){X(`${w.prefix}loading element not found: ${t}`);return}Hf(o,!1)});var lb=`
...
`;function co(){ge(),oe("forms-ajax",lb)}function Gt(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function Qi(e,t){let n=e.trim();n.includes("{")&&(n=n.replace(/\{([^{}]+)\}/g,(o,i)=>{let s=q(i.trim(),t,`${w.prefix}submit`);return s==null?o:String(s)}));let r=w.baseURL;return r&&!/^[a-z][a-z0-9+.-]*:\/\//i.test(n)&&!n.startsWith("//")&&(n=`${r.replace(/\/$/,"")}/${n.replace(/^\//,"")}`),n}function kl(e){var r;if(!e||typeof e!="object")return"";let t=e,n=(r=t.message)!=null?r:t.mensagem;return typeof n=="string"?n:""}function El(e,t="",n={}){if(e==null)return n;if(Array.isArray(e))return e.forEach((r,o)=>El(r,`${t}[${o}]`,n)),n;if(typeof e=="object"&&!(e instanceof File)){for(let[r,o]of Object.entries(e))El(o,t?`${t}[${r}]`:r,n);return n}return t&&(n[t]=String(e)),n}function cb(e){return Array.from(e.querySelectorAll('button[type="submit"], button:not([type]), input[type="submit"], input[type="image"]'))}function Pf(e){return!e||typeof document=="undefined"?null:document.querySelector(e)}var yl=new WeakMap;function Hf(e,t){var n;if(t){e.hidden=!1,e.style.display=(n=yl.get(e))!=null?n:"",e.removeAttribute("aria-hidden");return}yl.has(e)||yl.set(e,e.style.display==="none"?"":e.style.display),e.style.display="none",e.setAttribute("aria-hidden","true")}function Xi(e,t){let{host:n,form:r,state:o}=e;o.loading=t,r.classList.toggle("v-loading",t),r.setAttribute("aria-busy",t?"true":"false");let i=Ae(n,"loading-class");if(i)for(let a of i.split(/\s+/).filter(Boolean))r.classList.toggle(a,t);if(Gi(n,"disable-loading"))for(let a of cb(r))a.disabled=t;let s=Ae(n,"loading");if(s){let a=Pf(s);a&&Hf(a,t)}}function Ji(e,t,n,r){let o=Ae(e.host,t);if(!o)return;let i=e.scope.child({$data:n,$response:r,$form:e.state,$el:e.host}),s=q(o,i,`${w.prefix}${t}`);typeof s=="function"&&s.call(e.scope.data,n,r)}function db(e,t){let n=Ae(e.host,"target");if(!n||typeof t!="string")return;let r=document.querySelector(n);if(!r){X(`${w.prefix}target destination not found: ${n}`);return}let o=(Ae(e.host,"swap")||"innerHTML").trim().toLowerCase();if(o==="none")return;if(o==="text"){r.textContent=t;return}let i=document.createElement("template");i.innerHTML=t;let s=Array.from(i.content.childNodes),a=Ce(r);switch(o){case"inner":case"innerhtml":for(let l of Array.from(r.children))G(l);r.textContent="",r.append(...s);break;case"afterbegin":case"prepend":r.prepend(...s);break;case"beforeend":case"append":r.append(...s);break;case"beforebegin":r.before(...s);break;case"afterend":r.after(...s);break;case"outer":case"outerhtml":case"replace":G(r),r.replaceWith(...s);break;default:X(`Unknown mode in ${w.prefix}swap: ${o}`);return}for(let l of s)l.nodeType===1&&te(l,a)}function Nf(e,t,n){var l;let{state:r,form:o,host:i}=e;r.success=!0,r.errors={},r.data=t,r.status=n,r.dirty=!1,r.message=kl(t),db(e,t),Gi(i,"reset-success")&&o.tagName==="FORM"&&(o.reset(),ao(o));let s=Ae(i,"toast-success");s!==null&&it.success(s||r.message||"All set!"),Ji(e,"on-success",t,{status:n}),Gt(o,"voodoo:success",{data:t,status:n,form:o,state:r});let a=Ae(i,"redirect");if(a!==null&&typeof window!="undefined"){let c=t&&typeof t=="object"?(l=t.redirect)!=null?l:t.url:null,d=e.scope.child({$data:t,$form:r}),u=a?Qi(a,d):String(c!=null?c:"");u&&window.location.assign(u)}}function Tl(e,t){var c,d;let{state:n,form:r,host:o}=e,i=t instanceof Ee?t:new Ee(t instanceof Error?t.message:String(t)),s=(d=(c=i.response)==null?void 0:c.data)!=null?d:null;n.success=!1,n.data=s,n.status=i.status,n.message=kl(s)||i.message;let a=ml(s);(i.status===422||Object.keys(a).length>0)&&(n.errors=_i(r,s),vl(r));let l=Ae(o,"toast-error");l!==null&&it.error(l||kl(s)||"Could not submit the form."),Ji(e,"on-error",s,i),Gt(r,"voodoo:error",{error:i,data:s,status:i.status,form:r,state:n})}function Of(e,t){Ji(e,"on-complete",e.state.data,{ok:t,status:e.state.status}),Gt(e.form,"voodoo:complete",{ok:t,status:e.state.status,data:e.state.data,form:e.form,state:e.state})}async function ub(e,t){let{host:n,form:r,state:o,scope:i}=e;if(o.loading)return;let s=Ae(n,"confirm");if(s!==null&&typeof window!="undefined"&&!window.confirm(s||"Confirm this action?"))return;if(Rf(r)){ao(r);let f=await bl(r);if(o.errors=f.errors,!f.valid){vl(r),Gt(r,"voodoo:invalid",{errors:f.errors,form:r,state:o});return}}let a=(Ae(n,"method")||r.getAttribute("method")||"POST").trim().toUpperCase(),l=Qi(t,i)||(r.tagName==="FORM"?r.action:"")||(typeof location!="undefined"?location.href:""),c=cr(r,{formData:Gi(n,"form-data")}),d=a==="GET"||a==="HEAD";Xi(e,!0),o.success=!1,o.progress=0,Gt(r,"voodoo:submit",{url:l,method:a,form:r,state:o});let u=!1;try{let f=await Vt({url:l,method:a,body:d?void 0:c,params:d&&!(c instanceof FormData)?El(c):void 0});u=!0,Nf(e,f.data,f.status)}catch(f){Tl(e,f)}finally{Xi(e,!1),Of(e,u)}}y("submit",({el:e,scope:t,expression:n,cleanup:r})=>{co();let o=e,i=lo(o),s=t.child({$form:i},o);wl.set(s,i),wl.set(t,i),Bt(o,s);for(let d of Array.from(o.childNodes))d.nodeType===1&&Bt(d,s);let a={host:o,form:o,scope:s,state:i},l=d=>{d.preventDefault(),ub(a,n)},c=d=>{var p;let u=d.detail;if(!u||!u.field)return;let f={...i.errors};u.valid?delete f[u.field]:f[u.field]=(p=u.message)!=null?p:"",i.errors=f};o.addEventListener("submit",l),o.addEventListener("voodoo:field-validated",c),r(()=>{dr.delete(o),o.removeEventListener("submit",l),o.removeEventListener("voodoo:field-validated",c)})},{priority:j.DATA-1});function fb(e){let t=Ae(e,"progress");if(t){let o=document.querySelector(t);return o||(X(`${w.prefix}progress bar not found: ${t}`),null)}let n=e.nextElementSibling;if(n&&n.classList.contains("v-progress"))return n;co();let r=document.createElement("div");return r.className="v-progress",r.setAttribute("role","progressbar"),r.setAttribute("aria-valuemin","0"),r.setAttribute("aria-valuemax","100"),r.innerHTML='<span class="v-progress-bar"></span>',e.insertAdjacentElement("afterend",r),r}function Yi(e,t,n){if(!e)return;let r=Math.max(0,Math.min(100,Math.round(t)));if(e.tagName==="PROGRESS")e.value=r,e.max=100;else{let o=e.classList.contains("v-progress-bar")?e:e.querySelector(".v-progress-bar, [data-progress-bar]");o?o.style.width=`${r}%`:e.style.width=`${r}%`}e.setAttribute("aria-valuenow",String(r)),n?e.setAttribute("data-state",n):e.removeAttribute("data-state")}function pb(e,t,n){let r=new FormData,i=t.length>1||n.endsWith("[]")?n.endsWith("[]")?n:`${n}[]`:n;for(let a of t)r.append(i,a);let s=e.closest("form");if(s){let a=cr(s,{formData:!0});if(a instanceof FormData)for(let[l,c]of a.entries())c instanceof File||r.append(l,c)}return r}async function Ff(e,t,n,r){if(!n.length||e.state.loading)return;let{state:o,form:i,host:s}=e,a=Qi(t,e.scope);if(!a){X(`${w.prefix}upload needs a destination URL.`);return}let l=fb(s),c=pb(s,n,r);Xi(e,!0),o.success=!1,o.progress=0,Yi(l,0,"loading"),Gt(i,"voodoo:upload",{url:a,files:n,form:i,state:o});let d=!1;try{let u=(Ae(s,"method")||"POST").trim().toUpperCase(),f=await he.upload(a,c,{method:u==="PUT"||u==="PATCH"?u:"POST",onProgress:p=>{o.progress=p,Yi(l,p,"loading"),Gt(i,"voodoo:progress",{percent:p,form:i,state:o})}});d=!0,o.progress=100,Yi(l,100,"done"),Nf(e,f,200)}catch(u){Yi(l,o.progress,"error"),Tl(e,u)}finally{Xi(e,!1),Of(e,d)}}y("upload",({el:e,scope:t,expression:n,cleanup:r})=>{var c;let o=e;if(o.tagName!=="INPUT"||(o.getAttribute("type")||"").toLowerCase()!=="file"){X(`${w.prefix}upload needs an <input type="file">.`);return}co();let i=(c=o.closest("form"))!=null?c:o,s=lo(i),a={host:o,form:i,scope:t,state:s},l=()=>{var u;let d=Array.from((u=o.files)!=null?u:[]);d.length&&Ff(a,n,d,o.name||"file")};o.addEventListener("change",l),r(()=>o.removeEventListener("change",l))});y("dropzone",({el:e,scope:t,expression:n,cleanup:r})=>{var b,x,T;co(),e.classList.add("v-dropzone"),e.hasAttribute("tabindex")||(e.tabIndex=0),e.hasAttribute("role")||e.setAttribute("role","button"),(b=e.textContent)!=null&&b.trim()||(e.textContent="Drag files here or click to choose");let o=(x=e.closest("form"))!=null?x:e,i=lo(o),s={host:e,form:o,scope:t,state:i},a=Ae(e,"field")||"file",l=document.createElement("input");l.type="file",l.hidden=!0,l.tabIndex=-1,e.hasAttribute("accept")&&(l.accept=(T=e.getAttribute("accept"))!=null?T:""),e.hasAttribute("multiple")&&(l.multiple=!0),e.appendChild(l);let c=E=>{E.length&&(e.classList.add("v-dropzone-busy"),e.classList.remove("v-dropzone-error"),Ff(s,n,E,a).finally(()=>{e.classList.remove("v-dropzone-busy"),i.success||e.classList.add("v-dropzone-error")}))},d=0,u=E=>{E.preventDefault(),d++,e.classList.add("v-dropzone-over")},f=E=>{E.preventDefault(),E.dataTransfer&&(E.dataTransfer.dropEffect="copy")},p=()=>{d=Math.max(0,d-1),d===0&&e.classList.remove("v-dropzone-over")},m=E=>{var D,A;E.preventDefault(),d=0,e.classList.remove("v-dropzone-over");let C=Array.from((A=(D=E.dataTransfer)==null?void 0:D.files)!=null?A:[]);c(l.multiple?C:C.slice(0,1))},h=E=>{E.target!==l&&l.click()},v=E=>{E.key!=="Enter"&&E.key!==" "||(E.preventDefault(),l.click())},g=()=>{var C;let E=Array.from((C=l.files)!=null?C:[]);c(E),l.value=""};e.addEventListener("dragenter",u),e.addEventListener("dragover",f),e.addEventListener("dragleave",p),e.addEventListener("drop",m),e.addEventListener("click",h),e.addEventListener("keydown",v),l.addEventListener("change",g),r(()=>{e.removeEventListener("dragenter",u),e.removeEventListener("dragover",f),e.removeEventListener("dragleave",p),e.removeEventListener("drop",m),e.removeEventListener("click",h),e.removeEventListener("keydown",v),l.removeEventListener("change",g),l.remove()})});var mb={idle:"",saving:"Saving...",saved:"Changes saved",error:"Could not save"};function vb(e){let t=Ae(e,"autosave-status");if(t){let o=document.querySelector(t);if(o)return o;X(`${w.prefix}autosave-status element not found: ${t}`)}let n=e.querySelector(".v-autosave-status");if(n)return n;let r=document.createElement("span");return r.className="v-autosave-status",r.setAttribute("aria-live","polite"),e.appendChild(r),r}function xl(e,t){e.setAttribute("data-state",t),e.textContent=mb[t]}y("autosave",({el:e,scope:t,expression:n,modifiers:r,cleanup:o})=>{var m,h,v;co();let i=e,s=lo(i),a={host:i,form:i,scope:t,state:s},l=vb(i),c=(v=(h=(m=typeof r.delay=="string"?r.delay:null)!=null?m:Object.keys(r).find(g=>/^[\d.]+(ms|s|m)?$/.test(g)))!=null?h:Ae(i,"autosave-delay"))!=null?v:1e3,d=Q(c,1e3),u=async()=>{let g=Qi(n,t);if(!g){X(`${w.prefix}autosave needs a destination URL.`);return}if(s.loading)return;s.saving=!0,xl(l,"saving");let b=(Ae(i,"method")||"POST").trim().toUpperCase();try{let x=await Vt({url:g,method:b,body:cr(i,{formData:Gi(i,"form-data")})});s.data=x.data,s.status=x.status,s.dirty=!1,s.success=!0,xl(l,"saved"),Ji(a,"on-success",x.data,{status:x.status}),Gt(i,"voodoo:autosave",{data:x.data,status:x.status,form:i,state:s})}catch(x){xl(l,"error"),Tl(a,x)}finally{s.saving=!1}},f=Ye(()=>{u()},d),p=()=>{s.dirty=!0,f()};i.addEventListener("input",p),i.addEventListener("change",p),o(()=>{f.cancel(),i.removeEventListener("input",p),i.removeEventListener("change",p)})});y("guard",({el:e,expression:t,cleanup:n})=>{var c;let r=(c=e.tagName==="FORM"?e:e.closest("form"))!=null?c:e,o=lo(r),i=t.trim()||"There are unsaved changes.",s=()=>{o.dirty=!0},a=()=>{o.dirty=!1},l=d=>{!o.dirty||o.loading||(d.preventDefault(),d.returnValue=i)};r.addEventListener("input",s),r.addEventListener("change",s),r.addEventListener("reset",a),r.addEventListener("voodoo:success",a),window.addEventListener("beforeunload",l),n(()=>{r.removeEventListener("input",s),r.removeEventListener("change",s),r.removeEventListener("reset",a),r.removeEventListener("voodoo:success",a),window.removeEventListener("beforeunload",l)})});ue();ce();function uo(e){let t={};for(let[n,r]of Object.entries(e))if(typeof r!="function"&&!n.startsWith("$"))try{JSON.stringify(r),t[n]=Me(r)}catch(o){}return t}function If(e,t){if(e.id)return`${t}:${location.pathname}:#${e.id}`;let n=[],r=e;for(;r&&r!==document.body;){let o=r.parentElement,i=o?Array.from(o.children).indexOf(r):0;n.unshift(`${r.tagName.toLowerCase()}${i}`),r=o}return`${t}:${location.pathname}:${n.join(">")}`}y("persist",({el:e,scope:t,expression:n,cleanup:r})=>{let o=n.trim()?`voodoo:persist:${n.trim()}`:If(e,"voodoo:persist"),i=fe.get(o);if(i&&typeof i=="object")for(let[l,c]of Object.entries(i))l in t.data&&(t.data[l]=c);let s=Ye(()=>{fe.set(o,uo(t.data))},120),a=Ie(t.data,()=>s(),{deep:!0});s(),r(()=>{s.flush(),a()})},{priority:j.DATA-1});y("sync",({el:e,scope:t,expression:n,cleanup:r})=>{if(typeof BroadcastChannel=="undefined")return;let o=n.trim()||If(e,"voodoo:sync"),i=new BroadcastChannel(o),s=Math.random().toString(36).slice(2),a=!1,l=Ye(()=>{if(!a)try{i.postMessage({from:s,state:uo(t.data)})}catch(d){W(d,"v-sync")}},60);i.addEventListener("message",d=>{let u=d.data;if(!(!u||u.from===s)){a=!0;for(let[f,p]of Object.entries(u.state))f in t.data&&t.data[f]!==p&&(t.data[f]=p);queueMicrotask(()=>{a=!1})}});let c=Ie(t.data,()=>l(),{deep:!0});r(()=>{c(),i.close()})},{priority:j.DATA-1});var Ll=new WeakMap;function Ml(e){let t=e;for(;t;){let n=Ll.get(t);if(n)return n;t=t.parentElement}return null}y("history",({el:e,scope:t,expression:n,cleanup:r})=>{var p;let o=Number(n)||50,i=[JSON.parse(JSON.stringify(uo(t.data)))],s=0,a=!1,l=Y({canUndo:!1,canRedo:!1,size:1,undo(){s<=0||(s--,d())},redo(){s>=i.length-1||(s++,d())},clear(){i.length=0,i.push(JSON.parse(JSON.stringify(uo(t.data)))),s=0,c()}});function c(){l.canUndo=s>0,l.canRedo=s<i.length-1,l.size=i.length}function d(){a=!0;let m=i[s];for(let[h,v]of Object.entries(m))t.data[h]=JSON.parse(JSON.stringify(v));c(),queueMicrotask(()=>{a=!1})}let u=Ye(()=>{if(a)return;let m=JSON.stringify(uo(t.data));m!==JSON.stringify(i[s])&&(i.splice(s+1),i.push(JSON.parse(m)),i.length>o&&i.shift(),s=i.length-1,c())},Q((p=e.getAttribute("v-history-debounce"))!=null?p:void 0,300)),f=Ie(t.data,()=>u(),{deep:!0});Ll.set(e,l),t.set("$history",l),r(()=>{f(),u.cancel(),Ll.delete(e)})},{priority:j.DATA-1});y("undo",({el:e,cleanup:t})=>{let n=()=>{var r;return(r=Ml(e))==null?void 0:r.undo()};e.addEventListener("click",n),t(()=>e.removeEventListener("click",n))});y("redo",({el:e,cleanup:t})=>{let n=()=>{var r;return(r=Ml(e))==null?void 0:r.redo()};e.addEventListener("click",n),t(()=>e.removeEventListener("click",n))});y("storage",({el:e,expression:t,cleanup:n,scope:r})=>{let o=t.trim();if(!o)return;let i=e,s=fe.get(`voodoo:field:${o}`);s!=null&&"value"in i&&(i.value=String(s));let a=()=>{fe.set(`voodoo:field:${o}`,i.value)};i.addEventListener("input",a),n(()=>i.removeEventListener("input",a))});N("$history",e=>e.el?Ml(e.el):null);ce();var fr=null,Qt=.35,Ht=!1,zf=!1,Sl="voodoo:sound:volume",qf="voodoo:sound:muted";function yn(){if(zf)return;zf=!0;let e=fe.get(Sl);typeof e=="number"&&e>=0&&e<=1&&(Qt=e);let t=fe.get(qf);typeof t=="boolean"&&(Ht=t),typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches&&fe.get(Sl)===void 0&&(Qt=.18)}function Bf(){var t;if(typeof window=="undefined")return null;if(fr)return fr.state==="suspended"&&fr.resume(),fr;let e=(t=window.AudioContext)!=null?t:window.webkitAudioContext;if(!e)return null;try{return fr=new e,fr}catch(n){return null}}function jf(e,t,n){var c,d,u,f;let r=e.currentTime+((c=t.atraso)!=null?c:0),o=r+t.duracao,i=e.createOscillator();i.type=(d=t.forma)!=null?d:"sine",i.frequency.setValueAtTime(t.frequencia,r),t.ate!==void 0&&t.ate!==t.frequencia&&i.frequency.exponentialRampToValueAtTime(Math.max(1,t.ate),o);let s=e.createGain(),a=Qt*n*((u=t.volume)!=null?u:1),l=(f=t.ataque)!=null?f:.008;s.gain.setValueAtTime(1e-4,r),s.gain.exponentialRampToValueAtTime(Math.max(1e-4,a),r+l),s.gain.exponentialRampToValueAtTime(1e-4,o),i.connect(s),s.connect(e.destination),i.start(r),i.stop(o+.02)}var Zi={click:{volume:.5,camadas:[{frequencia:660,ate:440,duracao:.06,forma:"triangle"}]},pop:{volume:.5,camadas:[{frequencia:880,ate:1320,duracao:.07,forma:"sine"}]},hover:{volume:.22,camadas:[{frequencia:1200,duracao:.035,forma:"sine"}]},success:{volume:.6,camadas:[{frequencia:523.25,duracao:.1,forma:"sine"},{frequencia:783.99,duracao:.18,forma:"sine",atraso:.09}]},complete:{volume:.6,camadas:[{frequencia:523.25,duracao:.1,forma:"sine"},{frequencia:659.25,duracao:.1,forma:"sine",atraso:.09},{frequencia:1046.5,duracao:.22,forma:"sine",atraso:.18}]},error:{volume:.6,camadas:[{frequencia:392,duracao:.12,forma:"square",volume:.5},{frequencia:261.63,duracao:.24,forma:"square",volume:.5,atraso:.1}]},warning:{volume:.55,camadas:[{frequencia:587.33,duracao:.1,forma:"triangle"},{frequencia:587.33,duracao:.14,forma:"triangle",atraso:.14}]},notify:{volume:.5,camadas:[{frequencia:987.77,duracao:.14,forma:"sine"},{frequencia:1318.51,duracao:.3,forma:"sine",atraso:.08,volume:.6}]},type:{volume:.18,camadas:[{frequencia:2200,duracao:.018,forma:"square"}]},open:{volume:.4,camadas:[{frequencia:330,ate:660,duracao:.14,forma:"sine"}]},close:{volume:.4,camadas:[{frequencia:660,ate:330,duracao:.14,forma:"sine"}]},deny:{volume:.5,camadas:[{frequencia:220,duracao:.08,forma:"square",volume:.5},{frequencia:180,duracao:.12,forma:"square",volume:.5,atraso:.07}]},coin:{volume:.45,camadas:[{frequencia:987.77,duracao:.06,forma:"square"},{frequencia:1318.51,duracao:.16,forma:"square",atraso:.05}]},levelup:{volume:.55,camadas:[{frequencia:523.25,duracao:.08,forma:"square"},{frequencia:659.25,duracao:.08,forma:"square",atraso:.07},{frequencia:783.99,duracao:.08,forma:"square",atraso:.14},{frequencia:1046.5,duracao:.26,forma:"square",atraso:.21}]},drop:{volume:.5,camadas:[{frequencia:180,ate:90,duracao:.12,forma:"triangle"}]}},hb={do:261.63,"do#":277.18,re:293.66,"re#":311.13,mi:329.63,fa:349.23,"fa#":369.99,sol:392,"sol#":415.3,la:440,"la#":466.16,si:493.88,c:261.63,d:293.66,e:329.63,f:349.23,g:392,a:440,b:493.88};function es(e){let t=String(e).trim().toLowerCase(),n=/^([a-z]+#?)(\d)?$/.exec(t);if(!n)return null;let r=hb[n[1]];if(r===void 0)return null;let o=n[2]?Number(n[2]):4;return r*2**(o-4)}var ts=new Map;function gb(e,t){let n=ts.get(e);n||(n=new Audio(e),n.preload="auto",ts.set(e,n)),n.volume=Math.max(0,Math.min(1,Qt*t)),n.currentTime=0,n.play().catch(()=>{})}function Vf(e){return/^(https?:)?\/\//.test(e)||/^[./]/.test(e)||/\.(mp3|wav|ogg|m4a|aac)$/i.test(e)}var Jt={play(e,t={}){var l,c,d;if(yn(),Ht||!e)return;let n=String(e).trim(),r=(l=t.volume)!=null?l:1;if(Vf(n)){gb(n,r);return}let o=Zi[n];if(!o){let u=es(n);u!==null&&this.tone(u,200,{volume:r});return}let i=Bf();if(!i)return;let s=(c=t.tom)!=null?c:1,a=((d=o.volume)!=null?d:1)*r;for(let u of o.camadas)jf(i,s===1?u:{...u,frequencia:u.frequencia*s,ate:u.ate===void 0?void 0:u.ate*s},a)},tone(e,t=200,n={}){var o,i;if(yn(),Ht)return;let r=Bf();r&&jf(r,{frequencia:e,duracao:t/1e3,forma:(o=n.forma)!=null?o:"sine"},(i=n.volume)!=null?i:.5)},note(e,t=250,n={}){let r=es(e);r!==null&&this.tone(r,t,n)},melody(e,t=150,n={}){yn(),!Ht&&e.forEach((r,o)=>{let i=typeof r=="number"?r:es(r);i!==null&&setTimeout(()=>this.tone(i,t*1.6,n),o*t)})},volume(e){return yn(),e===void 0||(Qt=Math.max(0,Math.min(1,e)),fe.set(Sl,Qt)),Qt},mute(e=!0){yn(),Ht=e,fe.set(qf,Ht)},unmute(){this.mute(!1)},toggle(){return yn(),this.mute(!Ht),Ht},get muted(){return yn(),Ht},get names(){return Object.keys(Zi)},define(e,t){Zi[e]=t},preload(...e){for(let t of e){if(ts.has(t))continue;let n=new Audio(t);n.preload="auto",ts.set(t,n)}}};y("sound",({el:e,arg:t,expression:n,modifiers:r,scope:o,cleanup:i,evaluate:s})=>{let a=t||"click",l=()=>{let u=n.trim();if(!u)return"click";if(Zi[u]||Vf(u)||es(u)!==null)return u;let f=s();return typeof f=="string"?f:u},c=r.volume!==void 0?Number(r.volume):void 0,d=()=>{Jt.play(l(),c===void 0?{}:{volume:c})};e.addEventListener(a,d),i(()=>e.removeEventListener(a,d))});y("mute",({el:e,cleanup:t})=>{let n=()=>{let o=Jt.muted;e.setAttribute("aria-pressed",String(o)),e.classList.toggle("v-muted",o)},r=()=>{Jt.toggle(),n(),Jt.muted||Jt.play("pop")};e.addEventListener("click",r),n(),t(()=>e.removeEventListener("click",r))});N("$sound",()=>Jt);ue();ce();function fo(){return typeof window=="undefined"||typeof window.matchMedia!="function"?!1:ve.reducedMotion}var mr=new Set,wn=0;function Xf(e){wn=0;let t=Array.from(mr);for(let n of t)mr.has(n)&&n(e);mr.size>0&&(wn=requestAnimationFrame(Xf))}function Gf(e){typeof requestAnimationFrame=="function"&&(mr.add(e),wn||(wn=requestAnimationFrame(Xf)))}function os(e){mr.delete(e),mr.size===0&&wn&&(cancelAnimationFrame(wn),wn=0)}var Qf=12e3;function bb(e){return e*e*(2.70158*e-1.70158)}var po={linear(e){return e},easeIn(e){return e*e*e},easeOut(e){return 1-Math.pow(1-e,3)},easeInOut(e){return e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2},easeOutBack(e){return 1+2.70158*Math.pow(e-1,3)+1.70158*Math.pow(e-1,2)},easeOutExpo(e){return e>=1?1:1-Math.pow(2,-10*e)},anticipate(e){let t=e*2;return t<1?.5*bb(t):.5*(2-Math.pow(2,-10*(t-1)))},bounce(e){let r=e;return r<1/2.75?7.5625*r*r:r<2/2.75?(r-=1.5/2.75,7.5625*r*r+.75):r<2.5/2.75?(r-=2.25/2.75,7.5625*r*r+.9375):(r-=2.625/2.75,7.5625*r*r+.984375)}};function yb(e){if(typeof e=="function")return e;if(typeof e=="string"){let t=po[e];if(t)return t}return po.easeOut}var Nl={x:0,y:0,z:0,parallax:0,rotate:0,rotateX:0,rotateY:0,skewX:0,skewY:0,scale:1,scaleX:1,scaleY:1},xb={x:"px",y:"px",z:"px",parallax:"px",rotate:"deg",rotateX:"deg",rotateY:"deg",skewX:"deg",skewY:"deg",scale:"",scaleX:"",scaleY:""},Jf={translateX:"x",translateY:"y",translateZ:"z",rotateZ:"rotate"},Ol={blur:0,brightness:1,saturate:1,grayscale:0,contrast:1},wb={blur:"px",brightness:"",saturate:"",grayscale:"",contrast:""},kb=new Set(["opacity","z-index","font-weight","line-height","flex-grow","flex-shrink","order","zoom","fill-opacity","stroke-opacity","stroke-width","stroke-dashoffset","stroke-dasharray"]),Rl=new WeakMap,$l=new WeakMap;function is(e){let t=Rl.get(e);return t||(t={...Nl},Rl.set(e,t)),t}function Zf(e){let t=$l.get(e);return t||(t={...Ol},$l.set(e,t)),t}function Re(e){return Math.round(e*1e3)/1e3}function Dl(e){let t=Rl.get(e);if(!t)return;let n=[],r=t.y+t.parallax;(t.x||r||t.z)&&n.push(`translate3d(${Re(t.x)}px, ${Re(r)}px, ${Re(t.z)}px)`),t.rotateX&&n.push(`rotateX(${Re(t.rotateX)}deg)`),t.rotateY&&n.push(`rotateY(${Re(t.rotateY)}deg)`),t.rotate&&n.push(`rotate(${Re(t.rotate)}deg)`),(t.skewX||t.skewY)&&n.push(`skew(${Re(t.skewX)}deg, ${Re(t.skewY)}deg)`);let o=t.scale*t.scaleX,i=t.scale*t.scaleY;(o!==1||i!==1)&&n.push(`scale(${Re(o)}, ${Re(i)})`),n.length>0?e.style.transform=n.join(" "):e.style.removeProperty("transform")}function Eb(e){let t=$l.get(e);if(!t)return;let n=[];t.blur&&n.push(`blur(${Re(t.blur)}px)`),t.brightness!==1&&n.push(`brightness(${Re(t.brightness)})`),t.saturate!==1&&n.push(`saturate(${Re(t.saturate)})`),t.grayscale&&n.push(`grayscale(${Re(t.grayscale)})`),t.contrast!==1&&n.push(`contrast(${Re(t.contrast)})`),n.length>0?e.style.filter=n.join(" "):e.style.removeProperty("filter")}var Tb=/^([+-]?(?:\d+\.?\d*|\.\d+))([a-z%]*)$/i,ep=/^#([0-9a-f]{3,8})$/i;function ns(e){if(typeof e!="string")return!1;let t=e.trim().toLowerCase();return t==="transparent"||ep.test(t)||t.startsWith("rgb")||t.startsWith("hsl")}function Lb(e,t,n){let r=(e%360+360)%360,o=(1-Math.abs(2*n-1))*t,i=o*(1-Math.abs(r/60%2-1)),s=n-o/2,a;return r<60?a=[o,i,0]:r<120?a=[i,o,0]:r<180?a=[0,o,i]:r<240?a=[0,i,o]:r<300?a=[i,0,o]:a=[o,0,i],[Math.round((a[0]+s)*255),Math.round((a[1]+s)*255),Math.round((a[2]+s)*255)]}function Uf(e){var i,s;let t=e.trim().toLowerCase();if(t==="transparent")return[0,0,0,0];let n=ep.exec(t);if(n){let a=n[1];(a.length===3||a.length===4)&&(a=a.split("").map(d=>d+d).join(""));let l=parseInt(a.slice(0,6),16),c=a.length===8?parseInt(a.slice(6,8),16)/255:1;return[l>>16&255,l>>8&255,l&255,c]}let r=(i=t.match(/-?(?:\d+\.?\d*|\.\d+)%?/g))!=null?i:[],o=(a,l)=>{var u;let c=(u=r[a])!=null?u:"0",d=parseFloat(c);return c.endsWith("%")?d/100*l:d};if(t.startsWith("hsl")){let a=c=>{var f;let d=(f=r[c])!=null?f:"0",u=parseFloat(d);return d.endsWith("%")||u>1?u/100:u},l=Lb(parseFloat((s=r[0])!=null?s:"0"),a(1),a(2));return[l[0],l[1],l[2],r.length>3?o(3,1):1]}return[o(0,255),o(1,255),o(2,255),r.length>3?o(3,1):1]}function Mb(e){let t=Math.max(0,Math.min(1,e[3]));return`rgba(${Math.round(e[0])}, ${Math.round(e[1])}, ${Math.round(e[2])}, ${Re(t)})`}function tp(e){return e.startsWith("--")?e:e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}function np(e,t,n,r){if(t==="transform")return is(e)[n];if(t==="filter")return Zf(e)[n];if(typeof getComputedStyle!="function")return e.style.getPropertyValue(r).trim();let o=getComputedStyle(e).getPropertyValue(r);return o?o.trim():""}function Sb(e,t,n){var u;let r=(u=Jf[t])!=null?u:t,o=r in Nl?"transform":r in Ol?"filter":"style",i=o==="style"?tp(r):r,s=o==="transform"?xb[r]:o==="filter"?wb[r]:kb.has(i)?"":"px",a=Array.isArray(n)?[n[0],n[1]]:[np(e,o,r,i),n],l={kind:o,prop:r,cssName:i,mode:"number",unit:s,from:0,to:0,fromColor:[0,0,0,1],toColor:[0,0,0,1],fromText:String(a[0]),toText:String(a[1])};if(ns(a[0])||ns(a[1]))return o!=="style"?null:(l.mode="color",l.fromColor=ns(a[0])?Uf(String(a[0])):[0,0,0,0],l.toColor=ns(a[1])?Uf(String(a[1])):[0,0,0,0],l);let c=_f(a[0],s),d=_f(a[1],s);return!c||!d?o!=="style"?null:(l.mode="discrete",l):(l.from=c.value,l.to=d.value,l.unit=d.unit||c.unit||s,l)}function _f(e,t){if(typeof e=="number")return Number.isFinite(e)?{value:e,unit:t}:null;let n=Tb.exec(e.trim());return n?{value:parseFloat(n[1]),unit:n[2]||t}:null}function pr(e,t,n){let r=!1,o=!1;for(let i of t){if(i.kind==="transform"){is(e)[i.prop]=i.from+(i.to-i.from)*n,r=!0;continue}if(i.kind==="filter"){Zf(e)[i.prop]=i.from+(i.to-i.from)*n,o=!0;continue}if(i.mode==="color"){let a=[i.fromColor[0]+(i.toColor[0]-i.fromColor[0])*n,i.fromColor[1]+(i.toColor[1]-i.fromColor[1])*n,i.fromColor[2]+(i.toColor[2]-i.fromColor[2])*n,i.fromColor[3]+(i.toColor[3]-i.fromColor[3])*n];e.style.setProperty(i.cssName,Mb(a));continue}if(i.mode==="discrete"){e.style.setProperty(i.cssName,n>=1?i.toText:i.fromText);continue}let s=i.from+(i.to-i.from)*n;e.style.setProperty(i.cssName,`${Re(s)}${i.unit}`)}r&&Dl(e),o&&Eb(e)}function rp(e,t){let n=[];for(let[r,o]of Object.entries(t)){if(o==null)continue;let i=Sb(e,r,o);i&&n.push(i)}return n}function Wf(e,t){for(let n of Fl(e))pr(n,rp(n,t),0)}function Cb(e,t){var r;let n={};for(let o of Object.keys(t)){let i=(r=Jf[o])!=null?r:o,s=i in Nl?"transform":i in Ol?"filter":"style";n[o]=np(e,s,i,s==="style"?tp(i):i)}return n}function Cl(e){return typeof HTMLElement!="undefined"&&e instanceof HTMLElement?!0:typeof SVGElement!="undefined"&&e instanceof SVGElement}function Fl(e){if(!e)return[];if(typeof e=="string")return typeof document=="undefined"?[]:Array.from(document.querySelectorAll(e)).filter(Cl);if(Cl(e))return[e];let t=e;if(typeof t.length!="number")return[];let n=[];for(let r=0;r<t.length;r++){let o=t[r];Cl(o)&&n.push(o)}return n}function ss(e){return{finished:Promise.resolve(),stop(){e==null||e()}}}function Pl(e,t,n){var x,T,E,C,D,A,se;let r=rp(e,t);if(fo()&&!n.force)return pr(e,r,1),(x=n.onUpdate)==null||x.call(n,1),(T=n.onComplete)==null||T.call(n),ss();let o=Math.max(0,(E=n.duration)!=null?E:400),i=Math.max(0,(C=n.delay)!=null?C:0),s=yb(n.easing),a=Math.max(0,Math.floor((D=n.repeat)!=null?D:0)),l=(A=n.repeatType)!=null?A:"loop",c=n.spring===!0?{}:n.spring?n.spring:null,d,u=new Promise(O=>{d=O}),f=!0,p=-1,m=-1,h=0,v=(se=c==null?void 0:c.velocity)!=null?se:0;function g(O){var nn,An,Lc,Mc,Sc,Cc,Ac;if(!f)return;p<0&&(p=O,m=O);let me=O-p-i;if(me<0)return;let ae=Math.min(64,Math.max(0,O-m));if(m=O,me>Qf){b(1);return}if(c){let bm=(nn=c.stiffness)!=null?nn:170,ym=(An=c.damping)!=null?An:26,xm=(Lc=c.mass)!=null?Lc:1,Rc=Math.max(1,Math.round(ae)),$c=ae/Rc/1e3;for(let Dc=0;Dc<Rc;Dc++){let Em=(-bm*(h-1)-ym*v)/xm;v+=Em*$c,h+=v*$c}let wm=(Mc=c.restDelta)!=null?Mc:.001,km=(Sc=c.restSpeed)!=null?Sc:.01;if(Math.abs(1-h)<wm&&Math.abs(v)<km){b(1);return}pr(e,r,h),(Cc=n.onUpdate)==null||Cc.call(n,h);return}if(o===0){b(1);return}let R=a+1,S=Math.floor(me/o),B=(me-S*o)/o,_e=!1;S>=R&&(S=R-1,B=1,_e=!0);let We;if(S%2===1&&l==="reverse"?We=s(1-B):S%2===1&&l==="mirror"?We=1-s(B):We=s(B),_e){b(We);return}pr(e,r,We),(Ac=n.onUpdate)==null||Ac.call(n,We)}function b(O){var me,ae;f&&(f=!1,os(g),pr(e,r,O),(me=n.onUpdate)==null||me.call(n,O),d(),(ae=n.onComplete)==null||ae.call(n))}return pr(e,r,c?h:s(0)),Gf(g),{finished:u,stop(){f&&(f=!1,os(g),d())}}}function Nt(e,t,n={}){let r=Fl(e);if(r.length===0)return ss();if(r.length===1)return Pl(r[0],t,n);let o=r.map(i=>Pl(i,t,n));return{finished:Promise.all(o.map(i=>i.finished)).then(()=>{}),stop(){for(let i of o)i.stop()}}}function Il(e,t,n={}){var g,b,x,T,E,C,D,A;if(fo())return(g=n.onUpdate)==null||g.call(n,t),(b=n.onComplete)==null||b.call(n),ss();let r=(x=n.stiffness)!=null?x:170,o=(T=n.damping)!=null?T:26,i=(E=n.mass)!=null?E:1,s=Math.abs(t-e)||1,a=(C=n.restDelta)!=null?C:s*.001,l=(D=n.restSpeed)!=null?D:s*.01,c=e,d=(A=n.velocity)!=null?A:0,u=!0,f=-1,p=0,m,h=new Promise(se=>{m=se});function v(se){var S,B,_e,We;if(!u)return;if(f<0){f=se,(S=n.onUpdate)==null||S.call(n,c);return}let O=Math.min(64,Math.max(0,se-f));f=se,p+=O;let me=Math.max(1,Math.round(O)),ae=O/me/1e3;for(let nn=0;nn<me;nn++){let An=(-r*(c-t)-o*d)/i;d+=An*ae,c+=d*ae}if(Math.abs(t-c)<a&&Math.abs(d)<l||p>Qf){u=!1,os(v),c=t,(B=n.onUpdate)==null||B.call(n,t),m(),(_e=n.onComplete)==null||_e.call(n);return}(We=n.onUpdate)==null||We.call(n,c)}return Gf(v),{finished:h,stop(){u&&(u=!1,os(v),m())}}}function op(e,t,n,r){return r==="last"?(t-1-e)*n:r==="center"?Math.abs(e-(t-1)/2)*n:e*n}function zl(e,t,n={}){var l,c,d;let r=Fl(e);if(r.length===0)return ss();let o=(l=n.delay)!=null?l:60,i=(c=n.start)!=null?c:0,s=(d=n.from)!=null?d:"first",a=r.map((u,f)=>Pl(u,t,{...n,delay:i+op(f,r.length,o,s)}));return{finished:Promise.all(a.map(u=>u.finished)).then(()=>{}),stop(){for(let u of a)u.stop()}}}function Ab(e){return e==="all"?.99:e==="any"?0:typeof e=="number"?Math.max(0,Math.min(1,e)):.25}function as(e,t,n={}){var s,a,l;let r=(s=n.once)!=null?s:!0,o;if(typeof IntersectionObserver=="undefined")return o=t({target:e,isIntersecting:!0,intersectionRatio:1}),()=>{typeof o=="function"&&o()};let i=new IntersectionObserver(c=>{for(let d of c)d.isIntersecting?(o=t(d),r&&i.disconnect()):typeof o=="function"&&(o(),o=void 0)},{root:(a=n.root)!=null?a:null,rootMargin:(l=n.margin)!=null?l:"0px",threshold:Ab(n.amount)});return i.observe(e),()=>{i.disconnect(),typeof o=="function"&&o()}}function Bl(e,t){let n=!1,r=!1;if(typeof window=="undefined")return t(0),()=>{n=!0};let o=()=>{if(r=!1,n)return;let s=e.getBoundingClientRect(),a=window.innerHeight||document.documentElement.clientHeight||1,l=a+s.height||1,c=(a-s.top)/l;t(Math.max(0,Math.min(1,c)))},i=()=>{r||n||(r=!0,requestAnimationFrame(o))};return window.addEventListener("scroll",i,{passive:!0}),window.addEventListener("resize",i),o(),()=>{n=!0,window.removeEventListener("scroll",i),window.removeEventListener("resize",i)}}var Rb={opacity:[0,1],duration:420,easing:"easeOut"},$b={opacity:[0,1],y:[24,0],duration:520,easing:"easeOutExpo"},Db={opacity:[0,1],y:[-24,0],duration:520,easing:"easeOutExpo"},Pb={opacity:[0,1],scale:[.92,1],duration:460,easing:"easeOutBack"},Hb={opacity:[0,1],x:[36,0],duration:500,easing:"easeOutExpo"},Nb={opacity:[0,1],x:[-36,0],duration:500,easing:"easeOutExpo"},Ob={opacity:[0,1],scale:[.6,1],spring:{stiffness:420,damping:18}},Fb={opacity:[0,1],blur:[10,0],duration:560,easing:"easeOut"},Ib={opacity:[0,1],rotateX:[-80,0],duration:620,easing:"easeOutBack"},xn={fadeIn:Rb,fadeUp:$b,fadeDown:Db,scaleIn:Pb,slideLeft:Hb,slideRight:Nb,pop:Ob,blurIn:Fb,flip:Ib},zb=new Set(["duration","delay","easing","spring","repeat","repeatType","force","from","start","onUpdate","onComplete"]);function ls(e){let t={},n={};for(let[r,o]of Object.entries(e))o!=null&&(zb.has(r)?n[r]=o:t[r]=o);return{keyframes:t,options:n}}function ip(e){let t=e.trim();return t?/^['"`]/.test(t)||/^[[{(]/.test(t)?!0:/^[$A-Za-z_][\w$]*(?:\.[$A-Za-z_][\w$]*|\[[^\]]*\])*$/.test(t):!1}function mo(e,t){let n=e.trim();if(!n)return null;if(xn[n])return xn[n];if(!ip(n))return null;let r=t();return typeof r=="string"&&xn[r]?xn[r]:r&&typeof r=="object"?r:null}function xt(e,t){var n;return(n=e.getAttribute(`${w.prefix}${t}`))!=null?n:e.getAttribute(`data-v-${t}`)}function Kf(e,t){return e.hasAttribute(`${w.prefix}${t}`)||e.hasAttribute(`data-v-${t}`)}var sp=new WeakMap;function ap(e){let t=xt(e,"motion-stagger-from");return t==="last"||t==="center"?t:"first"}function Bb(e){return Kf(e,"motion")||Kf(e,"motion-scroll")}function lp(e){let t=e.parentElement;if(!t)return 0;let n=sp.get(t);if(!n){let i=xt(t,"motion-stagger");if(i===null)return 0;n={step:Q(i,60),from:ap(t)}}let r=Array.from(t.children).filter(Bb),o=r.indexOf(e);return o<0?0:op(o,r.length,n.step,n.from)}y("motion",({el:e,expression:t,evaluate:n,cleanup:r})=>{var c;let o=mo(t,n);if(!o){X(`v-motion did not recognize the variant "${t}".`);return}let{keyframes:i,options:s}=ls(o),a=lp(e);a>0&&(s.delay=((c=s.delay)!=null?c:0)+a);let l=Nt(e,i,s);r(()=>l.stop())});y("motion-scroll",({el:e,expression:t,evaluate:n,modifiers:r,cleanup:o})=>{var m,h;let i=mo(t,n);if(!i){X(`v-motion-scroll did not recognize the variant "${t}".`);return}let{keyframes:s,options:a}=ls(i),l=lp(e);l>0&&(a.delay=((m=a.delay)!=null?m:0)+l);let c=!r.repeat,d=xt(e,"motion-scroll-amount"),u=d===null?.25:parseFloat(d)||0;fo()||Wf(e,s);let f=null,p=as(e,()=>{if(f==null||f.stop(),f=Nt(e,s,a),!c)return()=>{f==null||f.stop(),fo()||Wf(e,s)}},{once:c,amount:u,margin:(h=xt(e,"motion-scroll-margin"))!=null?h:"0px"});o(()=>{p(),f==null||f.stop()})});y("motion-stagger",({el:e,expression:t,evaluate:n})=>{let r=n(),o=typeof r=="number"&&Number.isFinite(r)?r:Q(t,60);sp.set(e,{step:o,from:ap(e)})},{priority:j.BIND});function cp(e,t,n,r,o,i){let{keyframes:s,options:a}=ls(t),l={...o,...a},c=null,d=null,u=m=>{d==null||d.stop(),d=Nt(e,m,l)},f=()=>{c||(c=Cb(e,s)),u(s)},p=()=>{c&&u(c)};for(let m of n)e.addEventListener(m,f);for(let m of r)e.addEventListener(m,p);i(()=>{for(let m of n)e.removeEventListener(m,f);for(let m of r)e.removeEventListener(m,p);d==null||d.stop()})}y("motion-hover",({el:e,expression:t,evaluate:n,cleanup:r})=>{let o=mo(t,n);if(!o){X(`v-motion-hover did not recognize the variant "${t}".`);return}cp(e,o,["mouseenter","focusin"],["mouseleave","focusout"],{duration:220,easing:"easeOut"},r)});y("motion-tap",({el:e,expression:t,evaluate:n,cleanup:r})=>{let o=mo(t,n);if(!o){X(`v-motion-tap did not recognize the variant "${t}".`);return}cp(e,o,["pointerdown"],["pointerup","pointercancel","pointerleave","blur"],{duration:140,easing:"easeOut"},r)});y("parallax",({el:e,expression:t,evaluate:n,cleanup:r})=>{if(fo()||typeof window=="undefined")return;let o=n(),i=typeof o=="number"&&Number.isFinite(o)?o:parseFloat(t)||.3;e.style.willChange="transform";let s=!1,a=()=>{s=!1;let c=e.getBoundingClientRect(),d=window.innerHeight||document.documentElement.clientHeight||1,u=c.top+c.height/2;is(e).parallax=(d/2-u)*i,Dl(e)},l=()=>{s||(s=!0,requestAnimationFrame(a))};window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),a(),r(()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l),is(e).parallax=0,Dl(e),e.style.removeProperty("will-change")})});var rs=new Map,Al=null,Hl=!1;function Yf(){Hl||typeof requestAnimationFrame!="function"||(Hl=!0,requestAnimationFrame(jb))}function jb(){var e;Hl=!1;for(let t of rs.values()){if(!t.el.isConnected||t.animating)continue;let n=t.el.getBoundingClientRect(),r=t.rect;t.rect=n;let o=r.left-n.left,i=r.top-n.top,s=n.width>0?r.width/n.width:1,a=n.height>0?r.height/n.height:1,l=Math.abs(o)>=1||Math.abs(i)>=1,c=Math.abs(s-1)>=.01||Math.abs(a-1)>=.01;!l&&!c||(t.animating=!0,(e=t.control)==null||e.stop(),t.control=Nt(t.el,{x:[o,0],y:[i,0],scaleX:[s,1],scaleY:[a,1]},t.options),t.control.finished.then(()=>{t.animating=!1,t.el.isConnected&&(t.rect=t.el.getBoundingClientRect())}))}}function qb(){var t;if(Al||typeof MutationObserver=="undefined")return;let e=(t=w.root)!=null?t:document.body;e&&(Al=new MutationObserver(Yf),Al.observe(e,{childList:!0,subtree:!0}),window.addEventListener("resize",Yf))}y("flip",({el:e,expression:t,evaluate:n,cleanup:r})=>{if(typeof document=="undefined")return;let o=mo(t,n),i=o?ls(o).options:{};i.duration===void 0&&i.spring===void 0&&(i.spring={stiffness:340,damping:34}),qb(),rs.set(e,{el:e,rect:e.getBoundingClientRect(),options:i,control:null,animating:!1}),r(()=>{var s,a;(a=(s=rs.get(e))==null?void 0:s.control)==null||a.stop(),rs.delete(e)})});function Vb(e,t){let n={minimumFractionDigits:t,maximumFractionDigits:t};e==="currency"&&(n.style="currency",n.currency=w.currency);let r=new Intl.NumberFormat(w.locale,n);return e==="percent"?o=>`${r.format(o)}%`:o=>r.format(o)}y("count",({el:e,evaluate:t,effect:n,cleanup:r})=>{var f,p,m,h,v;let o=Q((f=xt(e,"count-duration"))!=null?f:void 0,1400),i=Math.max(0,Math.min(6,parseInt((p=xt(e,"count-decimals"))!=null?p:"0",10)||0)),s=(m=xt(e,"count-format"))!=null?m:"number",a=(h=xt(e,"count-prefix"))!=null?h:"",l=(v=xt(e,"count-suffix"))!=null?v:"",c=Vb(s,i),d=0,u=null;n(()=>{let g=Number(t()),b=Number.isFinite(g)?g:0,x=d;u==null||u.stop(),u=Nt(e,{},{duration:o,easing:"easeOutExpo",onUpdate(T){d=x+(b-x)*T,e.textContent=`${a}${c(d)}${l}`}})}),r(()=>u==null?void 0:u.stop())});y("typewriter",({el:e,expression:t,evaluate:n,effect:r,cleanup:o})=>{var l;let i=Q((l=xt(e,"typewriter-speed"))!=null?l:void 0,45),s=ip(t),a=null;r(()=>{var u;let c=s?String((u=n())!=null?u:""):t;if(a==null||a.stop(),e.textContent="",!c)return;let d=-1;a=Nt(e,{},{duration:Math.max(1,c.length*i),easing:"linear",onUpdate(f){let p=Math.round(f*c.length);p!==d&&(d=p,e.textContent=c.slice(0,p))}})}),o(()=>a==null?void 0:a.stop())});Ne();ce();function Ub(){return typeof window=="undefined"||typeof window.matchMedia!="function"?!1:ve.reducedMotion}var vo=["#6D3BF5","#FF3D8B","#2ED9A5","#FFB35C","#9B7BFF","#FF4D4D","#14111F","#3BB6F5"],_b=`
...
`;function k(e){return Math.round(e*100)/100}function ye(e){let t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:0}function kn(e,t,n){return e<t?t:e>n?n:e}var dp=new Map;function up(e,t){let n=`${w.locale}|${w.currency}|${e}`,r=dp.get(n);return r||(r=new Intl.NumberFormat(w.locale,t),dp.set(n,r)),r}function $e(e,t="number"){if(!Number.isFinite(e))return"";if(t==="currency")return up("currency",{style:"currency",currency:w.currency,maximumFractionDigits:2}).format(e);let n=up("number",{maximumFractionDigits:2}).format(e);return t==="percent"?`${n}%`:n}function Wb(e){return!!e&&typeof e=="object"&&Array.isArray(e.data)}function Ve(e,t){let n=e[t];return n===void 0||n===""?`#${t+1}`:n}function Kb(e,t){var c,d,u;let n=e.colors&&e.colors.length>0?e.colors:vo,r=Array.isArray(e.labels),o=r?e.labels.map(f=>String(f)):[],i=[],s=e.data,a=(c=e.name)!=null?c:"Value";if(typeof s=="number")i.push({name:a,values:[s],xs:null,color:n[0]});else if(Array.isArray(s)&&s.length>0){let f=s[0];if(typeof f=="number")i.push({name:a,values:s.map(ye),xs:null,color:n[0]});else if(Wb(f))s.forEach((p,m)=>{i.push({name:p.name||`Serie ${m+1}`,values:(p.data||[]).map(ye),xs:null,color:p.color||n[m%n.length]})});else{let p=s,m=[],h=[],v=!1;p.forEach((g,b)=>{m.push(ye(g.value!==void 0?g.value:g.y)),typeof g.x=="number"?(v=!0,h.push(g.x)):h.push(b),!r&&g.label!==void 0&&(o[b]=String(g.label))}),i.push({name:a,values:m,xs:v?h:null,color:n[0]})}}let l=t==="pie"||t==="donut";if(l)for(let f=0;f<((u=(d=i[0])==null?void 0:d.values.length)!=null?u:0);f++)o[f]===void 0&&(o[f]=Ve(o,f));return{series:i,labels:o,categorical:l}}function Yb(e,t){if(e.categorical){let n=e.series[0];return n?n.values.map((r,o)=>({key:Ve(e.labels,o),name:Ve(e.labels,o),color:t[o%t.length]})):[]}return e.series.map(n=>({key:n.name,name:n.name,color:n.color}))}function Xb(e,t,n){var r;if(t.size===0)return e;if(e.categorical){let o=e.series[0];if(!o)return e;let i=[],s=[],a=[];return o.values.forEach((l,c)=>{let d=Ve(e.labels,c);t.has(d)||(i.push(l),s.push(d),a.push(n[c%n.length]))}),{series:[{...o,values:i,xs:null,color:(r=a[0])!=null?r:o.color}],labels:s,categorical:!0}}return{series:e.series.filter(o=>!t.has(o.name)),labels:e.labels,categorical:!1}}function fp(e,t){let n=Math.abs(e)||1,r=Math.floor(Math.log10(n)),o=n/Math.pow(10,r),i;return t?o<1.5?i=1:o<3?i=2:o<7?i=5:i=10:o<=1?i=1:o<=2?i=2:o<=5?i=5:i=10,i*Math.pow(10,r)}function ql(e,t,n=5){if(e===t){let c=Math.abs(e)||1;return ql(e-c*.5,t+c*.5,n)}let r=fp(t-e,!1),o=fp(r/Math.max(1,n-1),!0),i=Math.max(0,Math.min(10,-Math.floor(Math.log10(o))+2)),s=Math.floor(e/o)*o,a=Math.ceil(t/o)*o,l=[];for(let c=s;c<=a+o*.5;c+=o)l.push(Number(c.toFixed(i)));return{min:s,max:a,ticks:l}}function Vl(e,t,n,r){let o=1/0,i=-1/0;if(n){let s=0;for(let a of e.series)s=Math.max(s,a.values.length);for(let a=0;a<s;a++){let l=0,c=0;for(let d of e.series){let u=ye(d.values[a]);u>=0?l+=u:c+=u}o=Math.min(o,c),i=Math.max(i,l)}}else for(let s of e.series)for(let a of s.values)Number.isFinite(a)&&(o=Math.min(o,a),i=Math.max(i,a));return(!Number.isFinite(o)||!Number.isFinite(i))&&(o=0,i=1),r&&(o=Math.min(o,0),i=Math.max(i,0)),t.min!==void 0&&(o=t.min),t.max!==void 0&&(i=t.max),o===i&&(i=o+(Math.abs(o)||1)),{min:o,max:i}}function pp(e){if(e.length===0)return"";let t=[`M ${k(e[0][0])} ${k(e[0][1])}`];for(let n=1;n<e.length;n++)t.push(`L ${k(e[n][0])} ${k(e[n][1])}`);return t.join(" ")}function Gb(e){if(e.length<3)return pp(e);let t=[`M ${k(e[0][0])} ${k(e[0][1])}`];for(let n=0;n<e.length-1;n++){let r=n>0?e[n-1]:e[n],o=e[n],i=e[n+1],s=n+2<e.length?e[n+2]:i,a=o[0]+(i[0]-r[0])/6,l=o[1]+(i[1]-r[1])/6,c=i[0]-(s[0]-o[0])/6,d=i[1]-(s[1]-o[1])/6;t.push(`C ${k(a)} ${k(l)}, ${k(c)} ${k(d)}, ${k(i[0])} ${k(i[1])}`)}return t.join(" ")}function Qb(e,t){return t?Gb(e):pp(e)}function lt(e,t,n,r){return[e+Math.cos(r)*n,t+Math.sin(r)*n]}function Jb(e,t,n,r,o,i){let s=i-o>Math.PI?1:0,[a,l]=lt(e,t,n,o),[c,d]=lt(e,t,n,i);if(r<=0)return`M ${k(e)} ${k(t)} L ${k(a)} ${k(l)} A ${k(n)} ${k(n)} 0 ${s} 1 ${k(c)} ${k(d)} Z`;let[u,f]=lt(e,t,r,o),[p,m]=lt(e,t,r,i);return`M ${k(a)} ${k(l)} A ${k(n)} ${k(n)} 0 ${s} 1 ${k(c)} ${k(d)} L ${k(p)} ${k(m)} A ${k(r)} ${k(r)} 0 ${s} 0 ${k(u)} ${k(f)} Z`}var Zb=7;function mp(e){let t=0;for(let n of e)t=Math.max(t,n.length);return t*Zb+12}function Ul(e,t){let{options:n,dataset:r,width:o,height:i}=e,s=Vl(r,n,t.stacked,t.baselineZero),a=n.min!==void 0&&n.max!==void 0?{min:s.min,max:s.max,ticks:vp(s.min,s.max,5)}:ql(s.min,s.max,5),l=a.ticks.map(T=>$e(T,e.format)),c=n.showGrid!==!1&&!t.bare,d=r.labels.length>0&&!t.bare,u=t.bare?3:16,f=t.bare?3:16,p=t.bare?3:c?kn(mp(l),32,140):8,m=t.bare?3:d?26:10,h=Math.max(1,o-p-f),v=Math.max(1,i-u-m),g=a.max-a.min||1,b=T=>u+v*(1-(T-a.min)/g),x="";if(c){let T=[];a.ticks.forEach((E,C)=>{let D=k(b(E));T.push(`<line class="v-chart-grid" x1="${k(p)}" y1="${D}" x2="${k(p+h)}" y2="${D}"/>`),T.push(`<text class="v-chart-axis" x="${k(p-8)}" y="${D+4}" text-anchor="end">${I(l[C])}</text>`)}),x=`<g>${T.join("")}</g>`}return{left:p,top:u,innerW:h,innerH:v,min:a.min,max:a.max,ticks:a.ticks,y:b,grid:x}}function vp(e,t,n){let r=(t-e)/Math.max(1,n-1),o=[];for(let i=0;i<n;i++)o.push(Number((e+r*i).toFixed(6)));return o}function _l(e,t,n,r,o){if(e.length===0||t===0)return"";let i=Math.max(1,Math.floor(o/56)),s=Math.max(1,Math.ceil(t/i)),a=[];for(let l=0;l<t;l+=s){let c=e[l];c===void 0||c===""||a.push(`<text class="v-chart-axis" x="${k(n(l))}" y="${k(r)}" text-anchor="middle">${I(c)}</text>`)}return a.join("")}function ho(e){let t=e.labels.length;for(let n of e.series)t=Math.max(t,n.values.length);return t}function En(e){return`<text class="v-chart-empty" x="${k(e.width/2)}" y="${k(e.height/2)}" text-anchor="middle">No data</text>`}function Tn(e,t,n){return`<title>${I(e)}: ${I($e(t,n))}</title>`}function ey(e,t){if(e.values.length===0)return e.name;let n=1/0,r=-1/0;for(let s of e.values)n=Math.min(n,s),r=Math.max(r,s);let o=e.values[0],i=e.values[e.values.length-1];return`${e.name}: from ${$e(o,t)} to ${$e(i,t)}, minimum ${$e(n,t)}, maximum ${$e(r,t)}`}function ty(e){let t=e.type==="sparkline",n=e.type==="area",r=ho(e.dataset);if(r===0)return En(e);let o=Ul(e,{stacked:!1,baselineZero:n,bare:t}),i=c=>r<=1?o.left+o.innerW/2:o.left+o.innerW*c/(r-1),s=e.options.smooth===!0,a=[o.grid],l=o.y(kn(0,o.min,o.max));for(let c of e.dataset.series){let d=[];for(let p=0;p<r;p++)d.push([i(p),o.y(ye(c.values[p]))]);if(d.length===0)continue;let u=Qb(d,s);if(n){let p=`${u} L ${k(d[d.length-1][0])} ${k(l)} L ${k(d[0][0])} ${k(l)} Z`;a.push(`<path class="v-chart-area" d="${p}" fill="${I(c.color)}" fill-opacity="0.16"/>`)}let f=e.animated?' pathLength="1" stroke-dasharray="1"':"";a.push(`<path class="v-chart-line" d="${u}" stroke="${I(c.color)}"${f}><title>${I(ey(c,e.format))}</title></path>`),!t&&r<=40&&d.forEach((p,m)=>{a.push(`<circle class="v-chart-point" cx="${k(p[0])}" cy="${k(p[1])}" r="3.5" fill="${I(c.color)}">`+Tn(`${c.name} ${Ve(e.dataset.labels,m)}`,ye(c.values[m]),e.format)+"</circle>")}),e.options.showValues&&!t&&d.forEach((p,m)=>{a.push(`<text class="v-chart-value" x="${k(p[0])}" y="${k(p[1]-10)}" text-anchor="middle">${I($e(ye(c.values[m]),e.format))}</text>`)})}return t||a.push(_l(e.dataset.labels,r,i,o.top+o.innerH+18,o.innerW)),hp(e,r,i,c=>{let d=1/0;for(let u of e.dataset.series)d=Math.min(d,o.y(ye(u.values[c])));return Number.isFinite(d)?d:o.top}),a.join("")}function hp(e,t,n,r){for(let o=0;o<t;o++)e.hits.push({x:n(o),y:r(o),title:Ve(e.dataset.labels,o),rows:e.dataset.series.map(i=>({name:i.name,color:i.color,value:ye(i.values[o])}))})}function ny(e){let t=e.type==="stacked",n=ho(e.dataset);if(n===0)return En(e);let r=Ul(e,{stacked:t,baselineZero:!0,bare:!1}),o=r.innerW/n,i=t?1:Math.max(1,e.dataset.series.length),s=Math.min(o*.3,18),a=Math.max(2,(o-s)/i),l=r.y(kn(0,r.min,r.max)),c=Math.min(4,a/2),d=[r.grid],u=f=>r.left+o*f+o/2;for(let f=0;f<n;f++){let p=0,m=0;e.dataset.series.forEach((h,v)=>{let g=ye(h.values[f]),b,x,T;if(t){let D=g>=0?p:m,A=D+g;g>=0?p=A:m=A,b=Math.min(r.y(D),r.y(A)),x=Math.max(r.y(D),r.y(A)),T=r.left+o*f+s/2}else b=Math.min(r.y(g),l),x=Math.max(r.y(g),l),T=r.left+o*f+s/2+v*a;let E=t?Math.max(2,o-s):a*.86,C=Math.max(g===0?0:1,x-b);d.push(`<rect class="v-chart-bar" x="${k(T)}" y="${k(b)}" width="${k(E)}" height="${k(C)}" rx="${k(c)}" fill="${I(h.color)}" style="transform-origin:${k(T+E/2)}px ${k(l)}px;transition-delay:${f*30}ms">`+Tn(`${h.name} ${Ve(e.dataset.labels,f)}`,g,e.format)+"</rect>"),e.options.showValues&&!t&&d.push(`<text class="v-chart-value" x="${k(T+E/2)}" y="${k(b-6)}" text-anchor="middle">${I($e(g,e.format))}</text>`)})}return d.push(_l(e.dataset.labels,n,u,r.top+r.innerH+18,r.innerW)),hp(e,n,u,f=>{if(t){let m=0;for(let h of e.dataset.series)m+=Math.max(0,ye(h.values[f]));return r.y(m)}let p=l;for(let m of e.dataset.series)p=Math.min(p,r.y(ye(m.values[f])));return p}),d.join("")}function ry(e){let t=ho(e.dataset);if(t===0)return En(e);let n=Vl(e.dataset,e.options,!1,!0),r=e.options.min!==void 0&&e.options.max!==void 0?{min:n.min,max:n.max,ticks:vp(n.min,n.max,5)}:ql(n.min,n.max,5),o=kn(mp(e.dataset.labels.length>0?e.dataset.labels:[""]),24,e.width*.4),i=e.dataset.labels.length>0?o:12,s=12,a=e.options.showGrid===!1?12:26,l=Math.max(1,e.width-i-20),c=Math.max(1,e.height-s-a),d=r.max-r.min||1,u=b=>i+l*(b-r.min)/d,f=u(kn(0,r.min,r.max)),p=c/t,m=Math.max(1,e.dataset.series.length),h=Math.min(p*.3,16),v=Math.max(2,(p-h)/m),g=[];if(e.options.showGrid!==!1)for(let b of r.ticks){let x=k(u(b));g.push(`<line class="v-chart-grid" x1="${x}" y1="${k(s)}" x2="${x}" y2="${k(s+c)}"/>`),g.push(`<text class="v-chart-axis" x="${x}" y="${k(s+c+16)}" text-anchor="middle">${I($e(b,e.format))}</text>`)}for(let b=0;b<t;b++){let x=e.dataset.labels[b];x&&g.push(`<text class="v-chart-axis" x="${k(i-8)}" y="${k(s+p*b+p/2+4)}" text-anchor="end">${I(x)}</text>`);let T=f;e.dataset.series.forEach((E,C)=>{let D=ye(E.values[b]),A=Math.min(u(D),f);T=Math.max(T,u(D));let se=Math.max(D===0?0:1,Math.abs(u(D)-f)),O=s+p*b+h/2+C*v;g.push(`<rect class="v-chart-barh" x="${k(A)}" y="${k(O)}" width="${k(se)}" height="${k(v*.86)}" rx="${k(Math.min(4,v/2))}" fill="${I(E.color)}" style="transform-origin:${k(f)}px ${k(O+v/2)}px;transition-delay:${b*30}ms">`+Tn(`${E.name} ${Ve(e.dataset.labels,b)}`,D,e.format)+"</rect>"),e.options.showValues&&g.push(`<text class="v-chart-value" x="${k(A+se+6)}" y="${k(O+v*.6)}">${I($e(D,e.format))}</text>`)}),e.hits.push({x:T,y:s+p*b+p/2,title:Ve(e.dataset.labels,b),rows:e.dataset.series.map(E=>({name:E.name,color:E.color,value:ye(E.values[b])}))})}return g.join("")}function oy(e){let t=e.dataset.series[0];if(!t||t.values.length===0)return En(e);let n=e.type==="donut",r=t.values.map(f=>Math.max(0,ye(f))),o=r.reduce((f,p)=>f+p,0);if(o<=0)return En(e);let i=e.width/2,s=e.height/2,a=Math.max(12,Math.min(e.width,e.height)/2-14),l=n?a*.62:0,c=`transform-origin:${k(i)}px ${k(s)}px`,d=[],u=-Math.PI/2;return r.forEach((f,p)=>{let m=f/o*Math.PI*2,h=e.palette[p%e.palette.length],v=Ve(e.dataset.labels,p),g=m>=Math.PI*2-1e-6,b=g?n?`<circle class="v-chart-slice" data-hit="${p}" cx="${k(i)}" cy="${k(s)}" r="${k((a+l)/2)}" fill="none" stroke="${I(h)}" stroke-width="${k(a-l)}" style="${c}">`:`<circle class="v-chart-slice" data-hit="${p}" cx="${k(i)}" cy="${k(s)}" r="${k(a)}" fill="${I(h)}" style="${c}">`:`<path class="v-chart-slice" data-hit="${p}" d="${Jb(i,s,a,l,u,u+m)}" fill="${I(h)}" style="${c};transition-delay:${p*45}ms">`;d.push(`${b}${Tn(v,f,e.format)}${g?"</circle>":"</path>"}`);let x=u+m/2,[T,E]=lt(i,s,(a+l)/2,x);if(e.hits.push({x:T,y:E,title:v,rows:[{name:v,color:h,value:f}]}),e.options.showValues&&m>.3){let[C,D]=lt(i,s,n?(a+l)/2:a*.68,x),A=Math.round(f/o*100);d.push(`<text class="v-chart-value" x="${k(C)}" y="${k(D+4)}" text-anchor="middle">${A}%</text>`)}u+=m}),n&&d.push(`<text class="v-chart-center" x="${k(i)}" y="${k(s+2)}" text-anchor="middle">${I($e(o,e.format))}</text>`,`<text class="v-chart-center-sub" x="${k(i)}" y="${k(s+20)}" text-anchor="middle">Total</text>`),d.join("")}function iy(e){let t=ho(e.dataset);if(t<3)return En(e);let r=Vl(e.dataset,e.options,!1,!0).max||1,o=e.width/2,i=e.height/2,s=Math.max(20,Math.min(e.width,e.height)/2-28),a=c=>-Math.PI/2+Math.PI*2*c/t,l=[];for(let c=1;c<=4;c++){let d=[];for(let u=0;u<t;u++)d.push(lt(o,i,s*c/4,a(u)));l.push(`<polygon class="v-chart-radar-web" points="${d.map(u=>`${k(u[0])},${k(u[1])}`).join(" ")}"/>`)}for(let c=0;c<t;c++){let[d,u]=lt(o,i,s,a(c));l.push(`<line class="v-chart-grid" x1="${k(o)}" y1="${k(i)}" x2="${k(d)}" y2="${k(u)}"/>`);let f=e.dataset.labels[c];if(f){let[p,m]=lt(o,i,s+14,a(c)),h=Math.abs(p-o)<4?"middle":p>o?"start":"end";l.push(`<text class="v-chart-axis" x="${k(p)}" y="${k(m+4)}" text-anchor="${h}">${I(f)}</text>`)}}for(let c of e.dataset.series){let d=[];for(let u=0;u<t;u++){let f=kn(ye(c.values[u])/r,0,1);d.push(lt(o,i,s*f,a(u)))}l.push(`<polygon class="v-chart-radar-area v-chart-slice" points="${d.map(u=>`${k(u[0])},${k(u[1])}`).join(" ")}" fill="${I(c.color)}" fill-opacity="0.22" stroke="${I(c.color)}" style="transform-origin:${k(o)}px ${k(i)}px"/>`),d.forEach((u,f)=>{l.push(`<circle class="v-chart-point" data-hit="${f}" cx="${k(u[0])}" cy="${k(u[1])}" r="3.5" fill="${I(c.color)}">`+Tn(`${c.name} ${Ve(e.dataset.labels,f)}`,ye(c.values[f]),e.format)+"</circle>")})}for(let c=0;c<t;c++){let[d,u]=lt(o,i,s*.7,a(c));e.hits.push({x:d,y:u,title:Ve(e.dataset.labels,c),rows:e.dataset.series.map(f=>({name:f.name,color:f.color,value:ye(f.values[c])}))})}return l.join("")}function sy(e){let t=ho(e.dataset);if(t===0)return En(e);let n=Ul(e,{stacked:!1,baselineZero:!1,bare:!1}),r=1/0,o=-1/0;for(let c of e.dataset.series){let d=c.xs;if(d)for(let u of d)r=Math.min(r,u),o=Math.max(o,u)}let i=Number.isFinite(r)&&Number.isFinite(o)&&o>r,s=(c,d)=>i&&c.xs?n.left+n.innerW*(c.xs[d]-r)/(o-r):t<=1?n.left+n.innerW/2:n.left+n.innerW*d/(t-1),a=[n.grid],l=0;for(let c of e.dataset.series)c.values.forEach((d,u)=>{let f=s(c,u),p=n.y(ye(d));a.push(`<circle class="v-chart-point v-chart-slice" data-hit="${l}" cx="${k(f)}" cy="${k(p)}" r="4.5" fill="${I(c.color)}" style="transform-origin:${k(f)}px ${k(p)}px">`+Tn(`${c.name} ${Ve(e.dataset.labels,u)}`,ye(d),e.format)+"</circle>"),e.hits.push({x:f,y:p,title:Ve(e.dataset.labels,u),rows:[{name:c.name,color:c.color,value:ye(d)}]}),l++});return i||a.push(_l(e.dataset.labels,t,c=>t<=1?n.left+n.innerW/2:n.left+n.innerW*c/(t-1),n.top+n.innerH+18,n.innerW)),a.join("")}function ay(e){var m,h,v,g,b;let t=e.dataset.series[0],n=t?ye(t.values[0]):0,r=(m=e.options.max)!=null?m:100,o=(h=e.options.min)!=null?h:0,i=kn((n-o)/(r-o||1),0,1),s=e.width/2,a=e.height/2,l=Math.max(16,Math.min(e.width,e.height)/2-16),c=Math.max(8,l*.2),d=l-c/2,u=2*Math.PI*d,f=u*(1-i),p=e.palette[0];return e.hits.push({x:s,y:a-d,title:(v=t==null?void 0:t.name)!=null?v:"Progresso",rows:[{name:(g=t==null?void 0:t.name)!=null?g:"Progresso",color:p,value:n}]}),`<circle class="v-chart-track" cx="${k(s)}" cy="${k(a)}" r="${k(d)}" stroke-width="${k(c)}"/><circle class="v-chart-ring" data-hit="0" cx="${k(s)}" cy="${k(a)}" r="${k(d)}" fill="none" stroke="${I(p)}" stroke-width="${k(c)}" stroke-linecap="round" stroke-dasharray="${k(u)}" style="--v-ring-full:${k(u)};--v-ring-offset:${k(f)};transform:rotate(-90deg);transform-origin:${k(s)}px ${k(a)}px">`+Tn((b=t==null?void 0:t.name)!=null?b:"Progresso",n,e.format)+`</circle><text class="v-chart-center" x="${k(s)}" y="${k(a+4)}" text-anchor="middle">${Math.round(i*100)}%</text>`+(t?`<text class="v-chart-center-sub" x="${k(s)}" y="${k(a+22)}" text-anchor="middle">${I($e(n,e.format))}</text>`:"")}var ly=new Set(["pie","donut","scatter","progress","radar"]);function cy(e){return e==="sparkline"?56:260}function dy(e,t){return e.showLegend===!1?!1:e.showLegend===!0?!0:t.categorical||t.series.length>1}var uy={line:"line",area:"area",bar:"bar",column:"horizontal bar",stacked:"stacked bar",pie:"pie",donut:"donut",sparkline:"trend",radar:"radar",scatter:"scatter",progress:"progress"};function fy(e,t,n){if(t.series.length===0)return"Chart with no data.";let r=(t.series.length===1,"series"),o=[`${uy[e]} chart with ${t.series.length} ${r}.`];for(let i of t.series){if(i.values.length===0)continue;let s=1/0,a=-1/0,l=0;for(let d of i.values)s=Math.min(s,d),a=Math.max(a,d),l+=d;let c=l/i.values.length;o.push(`${i.name}: ${i.values.length} points, minimum ${$e(s,n)}, maximum ${$e(a,n)}, average ${$e(c,n)}.`)}return o.join(" ")}function py(e){switch(e.type){case"bar":case"stacked":return ny(e);case"column":return ry(e);case"pie":case"donut":return oy(e);case"radar":return iy(e);case"scatter":return sy(e);case"progress":return ay(e);default:return ty(e)}}function my(e,t){return e.length===0?"":`<div class="v-chart-legend">${e.map(r=>{let o=t.has(r.key);return`<button type="button" class="v-chart-key" data-key="${I(r.key)}" aria-pressed="${o?"false":"true"}"><span class="v-chart-dot" style="background:${I(r.color)}"></span>${I(r.name)}</button>`}).join("")}</div>`}function cs(e){var v,g,b;let t=e.el,n=e.options,r=(v=n.type)!=null?v:"line",o=n.colors&&n.colors.length>0?n.colors:vo,i=(g=n.format)!=null?g:"number",s=Math.max(160,Math.round(t.clientWidth||n.width||640)),a=Math.max(48,Math.round((b=n.height)!=null?b:t.clientHeight||cy(r)));e.lastWidth=s,e.viewWidth=s,e.viewHeight=a;let l=Kb(n,r),c=Yb(l,o),d=Xb(l,e.hidden,o),u=n.animate!==!1&&!Ub();e.hits=[],e.shapeHits=ly.has(r),e.hitAxis=r==="column"?"y":"x";let f={type:r,options:n,dataset:d,palette:o,width:s,height:a,animated:u,format:i,hits:e.hits},p=py(f),m=fy(r,d,i);t.classList.add("v-chart"),t.classList.toggle("v-chart-animate",u),t.classList.remove("v-chart-in");let h=[`<svg class="v-chart-svg" viewBox="0 0 ${s} ${a}" preserveAspectRatio="xMidYMid meet" `,`style="height:${a}px" role="img" aria-label="${I(m)}">`,p,"</svg>"];dy(n,l)&&h.push(my(c,e.hidden)),n.tooltip!==!1&&h.push('<div class="v-chart-tip" hidden></div>'),t.innerHTML=h.join(""),u&&typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{requestAnimationFrame(()=>t.classList.add("v-chart-in"))})}function vy(e,t){let n=e.rows.map(r=>`<div class="v-chart-tip-row"><span class="v-chart-dot" style="background:${I(r.color)}"></span>${I(r.name)}<b>${I($e(r.value,t))}</b></div>`);return`<div class="v-chart-tip-title">${I(e.title)}</div>${n.join("")}`}function gp(e){let t=e.el.querySelector(".v-chart-tip");t&&(t.hidden=!0)}function hy(e,t){var a;if(e.options.tooltip===!1||e.hits.length===0)return;let n=e.el.querySelector(".v-chart-tip"),r=e.el.querySelector("svg");if(!n||!r)return;let o=r.getBoundingClientRect();if(o.width===0||o.height===0)return;let i;if(e.shapeHits){let l=t.target,c=l&&typeof l.closest=="function"?l.closest("[data-hit]"):null,d=c?Number(c.getAttribute("data-hit")):-1;d>=0&&(i=e.hits[d])}else if(e.hitAxis==="y"){let l=(t.clientY-o.top)/o.height*e.viewHeight,c=1/0;for(let d of e.hits){let u=Math.abs(d.y-l);u<c&&(c=u,i=d)}}else{let l=(t.clientX-o.left)/o.width*e.viewWidth,c=1/0;for(let d of e.hits){let u=Math.abs(d.x-l);u<c&&(c=u,i=d)}}if(!i){gp(e);return}let s=e.el.getBoundingClientRect();n.innerHTML=vy(i,(a=e.options.format)!=null?a:"number"),n.style.left=`${o.left-s.left+i.x/e.viewWidth*o.width}px`,n.style.top=`${o.top-s.top+i.y/e.viewHeight*o.height}px`,n.hidden=!1}function gy(e){let t=e.el,n=i=>{var l;let s=i.target;if(!s||typeof s.closest!="function")return;let a=(l=s.closest("[data-key]"))==null?void 0:l.getAttribute("data-key");a!=null&&(e.hidden.has(a)?e.hidden.delete(a):e.hidden.add(a),cs(e))},r=i=>hy(e,i),o=()=>gp(e);t.addEventListener("click",n),t.addEventListener("pointermove",r),t.addEventListener("pointerleave",o),e.teardown.push(()=>{t.removeEventListener("click",n),t.removeEventListener("pointermove",r),t.removeEventListener("pointerleave",o)})}function by(e){if(typeof ResizeObserver=="undefined")return;let t=new ResizeObserver(()=>{let n=Math.round(e.el.clientWidth);n===0||n===e.lastWidth||(e.frame&&cancelAnimationFrame(e.frame),e.frame=requestAnimationFrame(()=>{e.frame=0,cs(e)}))});t.observe(e.el),e.observer=t}function hr(e,t){ge(),oe("charts",_b);let n={el:e,options:{...t},hidden:new Set,hits:[],shapeHits:!1,hitAxis:"x",viewWidth:1,viewHeight:1,lastWidth:0,observer:null,frame:0,teardown:[]};return gy(n),cs(n),by(n),{el:e,get options(){return n.options},update(r){Object.assign(n.options,r),cs(n)},destroy(){var r;n.frame&&cancelAnimationFrame(n.frame),n.frame=0,(r=n.observer)==null||r.disconnect(),n.observer=null;for(let o of n.teardown)o();n.teardown.length=0,e.classList.remove("v-chart","v-chart-animate","v-chart-in"),e.innerHTML=""}}}function et(e,t){var n;return(n=Te(e,`${w.prefix}${t}`))!=null?n:Te(e,`data-v-${t}`)}function vr(e,t){return e===null?t:e===""||e==="true"||e==="1"?!0:e==="false"||e==="0"?!1:t}function yy(e,t){let r=!!t&&typeof t=="object"&&!Array.isArray(t)&&"data"in t?{...t}:{data:t!=null?t:[]},o=et(e,"chart-type");o&&(r.type=o),r.type||(r.type="line");let i=et(e,"chart-height");i&&(r.height=parseFloat(i)||r.height);let s=et(e,"chart-format");s&&(r.format=s);let a=et(e,"chart-colors");a&&(r.colors=a.split(",").map(v=>v.trim()).filter(Boolean));let l=et(e,"chart-max");l!==null&&l!==""&&(r.max=parseFloat(l));let c=et(e,"chart-min");c!==null&&c!==""&&(r.min=parseFloat(c));let d=et(e,"chart-smooth");d!==null&&(r.smooth=vr(d,!0));let u=et(e,"chart-grid");u!==null&&(r.showGrid=vr(u,!0));let f=et(e,"chart-legend");f!==null&&(r.showLegend=vr(f,!0));let p=et(e,"chart-values");p!==null&&(r.showValues=vr(p,!0));let m=et(e,"chart-tooltip");m!==null&&(r.tooltip=vr(m,!0));let h=et(e,"chart-animate");return h!==null&&(r.animate=vr(h,!0)),r}function jl(e,t=0){if(!e||typeof e!="object"||t>3)return 1;let n=0;if(Array.isArray(e)){for(let r of e)n+=jl(r,t+1);return n}for(let r of Object.values(e))n+=jl(r,t+1);return n}y("chart",({el:e,evaluate:t,effect:n,cleanup:r})=>{let o=null;n(()=>{let i=t();jl(i);let s=yy(e,i);o?o.update(s):o=hr(e,s)}),r(()=>{o==null||o.destroy(),o=null})});var Wl={render:hr,format:$e,colors:vo};ue();ce();Ne();Ne();ce();var xy=/^#([0-9a-f])([0-9a-f])([0-9a-f])[0-9a-f]?$/i,wy=/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})(?:[0-9a-f]{2})?$/i,ky=/^rgba?\(([^)]+)\)$/i,Ey=/^hsla?\(([^)]+)\)$/i;function bp(e){return e.split(/[\s,/]+/).map(t=>parseFloat(t)).filter(t=>!Number.isNaN(t))}function Ty(e,t,n){let r=(e%360+360)%360,o=Ue(t/100,0,1),i=Ue(n/100,0,1),s=(1-Math.abs(2*i-1))*o,a=s*(1-Math.abs(r/60%2-1)),l=i-s/2,c=Math.floor(r/60)%6,d=[[s,a,0],[a,s,0],[0,s,a],[0,a,s],[a,0,s],[s,0,a]],[u,f,p]=d[c];return{r:Math.round((u+l)*255),g:Math.round((f+l)*255),b:Math.round((p+l)*255)}}function wt(e){let t=String(e!=null?e:"").trim();if(!t)return null;let n=xy.exec(t);if(n)return{r:parseInt(n[1]+n[1],16),g:parseInt(n[2]+n[2],16),b:parseInt(n[3]+n[3],16)};let r=wy.exec(t);if(r)return{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)};let o=ky.exec(t);if(o){let[s,a,l]=bp(o[1]);return s===void 0||a===void 0||l===void 0?null:{r:Ue(s,0,255),g:Ue(a,0,255),b:Ue(l,0,255)}}let i=Ey.exec(t);if(i){let[s,a,l]=bp(i[1]);return s===void 0||a===void 0||l===void 0?null:Ty(s,a,l)}return null}function Ue(e,t,n){return e<t?t:e>n?n:e}function yr(e){let t=e/255;return t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function Kl(e){return e<=.0031308?e*12.92:1.055*Math.pow(e,.4166666666666667)-.055}function Ly(e){let t=yr(e.r),n=yr(e.g),r=yr(e.b),o=.4122214708*t+.5363325363*n+.0514459929*r,i=.2119034982*t+.6806995451*n+.1073969566*r,s=.0883024619*t+.2817188376*n+.6299787005*r,a=Math.cbrt(o),l=Math.cbrt(i),c=Math.cbrt(s);return{l:.2104542553*a+.793617785*l-.0040720468*c,a:1.9779984951*a-2.428592205*l+.4505937099*c,b:.0259040371*a+.7827717662*l-.808675766*c}}function My(e){let t=e.l+.3963377774*e.a+.2158037573*e.b,n=e.l-.1055613458*e.a-.0638541728*e.b,r=e.l-.0894841775*e.a-1.291485548*e.b,o=t*t*t,i=n*n*n,s=r*r*r;return{r:Kl(4.0767416621*o-3.3077115913*i+.2309699292*s),g:Kl(-1.2684380046*o+2.6097574011*i-.3413193965*s),b:Kl(-.0041960863*o-.7034186147*i+1.707614701*s)}}function us(e){let t=Ly(e),n=Math.sqrt(t.a*t.a+t.b*t.b),r=Math.atan2(t.b,t.a)*180/Math.PI;return r<0&&(r+=360),{l:t.l,c:n,h:n<1e-5?0:r}}function yp(e){let t=e.h*Math.PI/180;return My({l:e.l,a:Math.cos(t)*e.c,b:Math.sin(t)*e.c})}function br(e){let t=Math.max(0,e.c);for(let r=0;r<32;r++){let o=yp({l:Ue(e.l,0,1),c:t,h:e.h});if(o.r>=-.001&&o.r<=1.001&&o.g>=-.001&&o.g<=1.001&&o.b>=-.001&&o.b<=1.001)return{r:Math.round(Ue(o.r,0,1)*255),g:Math.round(Ue(o.g,0,1)*255),b:Math.round(Ue(o.b,0,1)*255)};t*=.92}let n=yp({l:Ue(e.l,0,1),c:0,h:e.h});return{r:Math.round(Ue(n.r,0,1)*255),g:Math.round(Ue(n.g,0,1)*255),b:Math.round(Ue(n.b,0,1)*255)}}function Yl(e){return Ue(Math.round(e),0,255).toString(16).padStart(2,"0")}function Ln(e){return`#${Yl(e.r)}${Yl(e.g)}${Yl(e.b)}`}function gr(e,t){return`rgba(${Math.round(e.r)}, ${Math.round(e.g)}, ${Math.round(e.b)}, ${Number(t.toFixed(3))})`}function Tp(e){return Ln(br(e))}function Gl(e){return .2126*yr(e.r)+.7152*yr(e.g)+.0722*yr(e.b)}function Ql(e,t){let n=typeof e=="string"?wt(e):e,r=typeof t=="string"?wt(t):t;if(!n||!r)return 1;let o=Gl(n),i=Gl(r),s=Math.max(o,i),a=Math.min(o,i);return(s+.05)/(a+.05)}var Lp={r:255,g:255,b:255},fs={r:0,g:0,b:0};function go(e){let t=typeof e=="string"?wt(e):e;return t?Ql(t,Lp)>=Ql(t,fs)?"#ffffff":"#000000":"#ffffff"}var Jl=[50,100,200,300,400,500,600,700,800,900],Mp=[.973,.941,.889,.819,.732,.638,.558,.478,.399,.327],Sy=[.14,.26,.46,.68,.88,1,.97,.89,.78,.65],Sp=[.244,.286,.343,.408,.484,.588,.668,.748,.836,.928],Cy=[.3,.42,.6,.78,.92,1,.92,.78,.57,.33];function Cp(e,t=!1){var a;let n=typeof e=="string"?(a=wt(e))!=null?a:fs:e,r=us(n),o=t?Sp:Mp,i=t?Cy:Sy,s={};return Jl.forEach((l,c)=>{s[String(l)]=Tp({l:o[c],c:r.c*i[c],h:r.h})}),s}var ps={violeta:{primary:"#6D3BF5",accent:"#FF3D8B",success:"#16A34A",warning:"#D97706",danger:"#E11D48",info:"#7C6BFF"},oceano:{primary:"#0E7BC4",accent:"#0FB5C9",success:"#0F9D6E",warning:"#D08700",danger:"#DC2F3E",info:"#3B82F6"},floresta:{primary:"#1F8A4C",accent:"#7FA80E",success:"#18A05A",warning:"#C97A0A",danger:"#C93A2E",info:"#2C8FA8"},poente:{primary:"#E4632A",accent:"#D62F63",success:"#3E9B52",warning:"#D99000",danger:"#D32F2F",info:"#B45FC0"},grafite:{primary:"#4C5A70",accent:"#2E7FD1",success:"#2F8F60",warning:"#B57A12",danger:"#C2453F",info:"#5B7A99"}},Ap=["primary","accent","success","warning","danger","info"],Zl="voodoo:palette",xp="voodoo-palette",Ay="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif",Ry="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace";function wp(e,t){let n=(e!=null?e:"").trim();return n?n.includes(",")?n:`${/^['"]/.test(n)?n:`'${n}'`}, ${t}`:t}var $y=/^([\d.]+)(px|rem|em)$/;function Dy(e){let t=(e||"12px").trim(),n=$y.exec(t);if(!n)return{"--v-radius":t,"--v-radius-sm":`calc(${t} * 0.6)`,"--v-radius-lg":`calc(${t} * 1.5)`,"--v-radius-xl":`calc(${t} * 2)`,"--v-radius-full":"999px"};let r=parseFloat(n[1]),o=n[2],i=s=>`${Math.round(s*1e3)/1e3}${o}`;return{"--v-radius":i(r),"--v-radius-sm":i(Math.max(r*.55,0)),"--v-radius-lg":i(r*1.5),"--v-radius-xl":i(r*2),"--v-radius-full":"999px"}}function kp(e,t){var c,d,u,f;let n={},r={},o={};for(let p of Ap){let m=(c=wt(e[p]))!=null?c:fs,h=us(m),v=Cp(m,t);r[p]=v;for(let O of Jl)n[`--v-${p}-${O}`]=v[String(O)];let g=t?{l:Math.max(h.l,.62),c:h.c*.95,h:h.h}:h,b=t?{l:Math.min(g.l+.07,.94),c:g.c*.95,h:g.h}:{l:Math.max(g.l-.055,.12),c:g.c,h:g.h},x=t?{l:Math.min(g.l+.13,.97),c:g.c*.88,h:g.h}:{l:Math.max(g.l-.105,.1),c:g.c,h:g.h},T=br(g),E=br(b),C=br(x);n[`--v-${p}`]=Ln(t?T:m),n[`--v-${p}-hover`]=Ln(E),n[`--v-${p}-active`]=Ln(C),n[`--v-${p}-contrast`]=go(t?T:m),n[`--v-${p}-contrast-hover`]=go(E),n[`--v-${p}-contrast-active`]=go(C);let D=v[50],A=v[100],se=t?v[800]:v[700];n[`--v-${p}-soft`]=D,n[`--v-${p}-soft-hover`]=A,n[`--v-${p}-soft-text`]=se,n[`--v-${p}-ring`]=gr(T,t?.45:.32),n[`--v-${p}-border`]=t?v[300]:v[200],o[p]=n[`--v-${p}-contrast`]}let i=(u=wt((d=e.neutral)!=null?d:e.primary))!=null?u:fs,s=us(i).h,a=(p,m)=>Tp({l:p,c:m,h:s}),l={};if(Jl.forEach((p,m)=>{let h=t?Sp:Mp;l[String(p)]=a(h[m],.012),n[`--v-neutral-${p}`]=l[String(p)]}),r.neutral=l,t)n["--v-surface"]=a(.248,.021),n["--v-surface-2"]=a(.196,.021),n["--v-surface-3"]=a(.305,.024),n["--v-surface-inset"]=a(.17,.02),n["--v-text"]=a(.965,.008),n["--v-text-muted"]=a(.748,.017),n["--v-text-soft"]=a(.63,.017),n["--v-border"]=a(.355,.023),n["--v-border-strong"]=a(.46,.026),n["--v-overlay"]="rgba(0, 0, 0, 0.62)",n["--v-shadow-sm"]="0 1px 2px rgba(0, 0, 0, 0.5)",n["--v-shadow"]="0 10px 30px rgba(0, 0, 0, 0.5)",n["--v-shadow-lg"]="0 24px 60px rgba(0, 0, 0, 0.62)";else{let p=br({l:.24,c:.028,h:s});n["--v-surface"]=a(1,0),n["--v-surface-2"]=a(.981,.006),n["--v-surface-3"]=a(.955,.009),n["--v-surface-inset"]=a(.968,.008),n["--v-text"]=Ln(p),n["--v-text-muted"]=a(.53,.023),n["--v-text-soft"]=a(.655,.018),n["--v-border"]=a(.906,.012),n["--v-border-strong"]=a(.828,.016),n["--v-overlay"]=gr(p,.45),n["--v-shadow-sm"]=`0 1px 2px ${gr(p,.08)}`,n["--v-shadow"]=`0 10px 30px ${gr(p,.14)}`,n["--v-shadow-lg"]=`0 24px 60px ${gr(p,.2)}`}return n["--v-focus-ring"]=n["--v-primary-ring"],o.surface=go((f=wt(n["--v-surface"]))!=null?f:Lp),{vars:n,scales:r,contrast:o}}function Xl(e,t){let n=Object.entries(t).map(([r,o])=>`  ${r}: ${o};`).join(`
`);return`${e} {
${n}
}`}var yo=null,bo=null;function Py(e){var r,o,i,s,a,l,c,d,u;let t=(r=ps[e.preset])!=null?r:ps.violeta,n={primary:(o=e.primary)!=null?o:t.primary,accent:(i=e.accent)!=null?i:t.accent,success:(s=e.success)!=null?s:t.success,warning:(a=e.warning)!=null?a:t.warning,danger:(l=e.danger)!=null?l:t.danger,info:(c=e.info)!=null?c:t.info,neutral:(d=e.neutral)!=null?d:t.neutral};for(let f of Ap)wt(n[f])||(console.warn(`[Voodoo] invalid color in palette.${f}: "${n[f]}". Using preset.`),n[f]=t[f]);return{colors:n,radius:(u=e.radius)!=null?u:"12px",font:wp(e.font,Ay),mono:wp(e.monoFont,Ry)}}function Hy(e){if(typeof document=="undefined"||!w.injectStyles)return;ge();let t=document.getElementById(xp);t||(t=document.createElement("style"),t.id=xp,t.setAttribute("data-voodoo","palette"),document.head.appendChild(t)),t.textContent=e}function ds(e={}){let{colors:t,radius:n,font:r,mono:o}=Py(e),i=kp(t,!1),s=kp(t,!0),a={...Dy(n),"--v-font-sans":r,"--v-font-mono":o},l=["/* Palette generated by V.palette(). Do not edit manually. */",Xl(":root",{...a,...i.vars}),`@media (prefers-color-scheme: dark) {
${Xl(':root:not([data-theme="light"])',s.vars)}
}`,Xl(':root[data-theme="dark"]',s.vars)].join(`
`);Hy(l);let c={colors:t,radius:n,font:r,monoFont:o,light:i.scales,dark:s.scales,contrast:i.contrast,css:l};if(yo=c,bo={...e},e.persist!==!1&&typeof document!="undefined"){let d={...e};delete d.persist,fe.set(Zl,d)}return typeof document!="undefined"&&document.dispatchEvent(new CustomEvent("voodoo:palette",{detail:c})),c}var Ep=!1;function ec(){if(yo&&Ep)return yo;Ep=!0;let e=fe.get(Zl),t=e&&typeof e=="object"?{...e,persist:!1}:{persist:!1};return ds(t)}function xo(){yo||ec()}function Rp(){return ec()}var $p=Object.assign(ds,{presets:ps,get names(){return Object.keys(ps)},get current(){return yo},get options(){return bo},init:ec,ensure:xo,reset(){return fe.remove(Zl),ds({persist:!1})},use(e){return ds({...bo!=null?bo:{},preset:e,primary:void 0,accent:void 0})},scale:Cp,contrastText:go,contrastRatio:Ql,luminance(e){let t=typeof e=="string"?wt(e):e;return t?Gl(t):0},convert:{parseColor:wt,rgbToOklch:us,oklchToRgb:br,toHex:Ln,toRgba:gr}});function ne(e){if(e===!0)return!0;if(e===!1||e===null||e===void 0)return!1;if(typeof e=="number")return e!==0;let t=String(e).trim().toLowerCase();return t===""||t==="true"||t==="1"||t==="yes"}function be(...e){let t={};for(let n of e){let r=`is${n.charAt(0).toUpperCase()}${n.slice(1)}`;t[r]=function(){return ne(this[n])}}return t}var F={type:"any",default:!1},L={type:"string",default:""};function xr(e,t){var i;if(t==null||typeof t!="string")return t;let n=t.trim();if(!n)return null;if(n.startsWith("[")||n.startsWith("{"))try{return JSON.parse(n)}catch(s){return null}let r=n.split(/[.[(]/)[0].trim();if(!/^[A-Za-z_$][\w$]*$/.test(r))return null;let o=(i=e.$scope)==null?void 0:i.parent;return!o||!o.has(r)?null:q(n,o,"list attribute")}function ko(e){return String(e).split(",").map(t=>t.trim()).filter(Boolean)}function Zt(e,t){let n=e.$el;Object.defineProperty(n,"value",{configurable:!0,enumerable:!1,get:t.get,set:t.set})}function wo(e){e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))}var Hp={check:'<path d="m5 12.5 4.4 4.4L19 7.6"/>',x:'<path d="M6 6l12 12M18 6 6 18"/>',plus:'<path d="M12 5v14M5 12h14"/>',minus:'<path d="M5 12h14"/>',search:'<circle cx="11" cy="11" r="6.5"/><path d="m16 16 4 4"/>',"chevron-down":'<path d="m6 9.5 6 6 6-6"/>',"chevron-up":'<path d="m6 14.5 6-6 6 6"/>',"chevron-left":'<path d="m14.5 6-6 6 6 6"/>',"chevron-right":'<path d="m9.5 6 6 6-6 6"/>',"arrow-up":'<path d="M12 19V5M6 11l6-6 6 6"/>',"arrow-down":'<path d="M12 5v14M6 13l6 6 6-6"/>',"arrow-right":'<path d="M5 12h14M13 6l6 6-6 6"/>',"arrow-left":'<path d="M19 12H5M11 6l-6 6 6 6"/>',user:'<circle cx="12" cy="8.5" r="3.6"/><path d="M4.8 20a7.4 7.4 0 0 1 14.4 0"/>',users:'<circle cx="9.5" cy="8.5" r="3.2"/><path d="M3.4 19.5a6.4 6.4 0 0 1 12.2 0M16 5.6a3.2 3.2 0 0 1 0 5.9M17.4 14.4a6.4 6.4 0 0 1 3.2 5.1"/>',mail:'<rect x="3" y="5" width="18" height="14" rx="2.5"/><path d="m3.8 7 8.2 6 8.2-6"/>',lock:'<rect x="4.5" y="10.5" width="15" height="9.5" rx="2.4"/><path d="M8 10.5V8a4 4 0 0 1 8 0v2.5"/>',eye:'<path d="M2.6 12S6.4 5.8 12 5.8 21.4 12 21.4 12 17.6 18.2 12 18.2 2.6 12 2.6 12Z"/><circle cx="12" cy="12" r="2.8"/>',"eye-off":'<path d="M4 4l16 16M9.9 6.2A9.3 9.3 0 0 1 12 6c5.6 0 9.4 6 9.4 6a17 17 0 0 1-3.3 3.9M6.3 8.2A17 17 0 0 0 2.6 12S6.4 18 12 18c1 0 1.9-.2 2.7-.5"/>',calendar:'<rect x="3.5" y="5" width="17" height="15" rx="2.4"/><path d="M8 3v4M16 3v4M3.5 10h17"/>',clock:'<circle cx="12" cy="12" r="8.6"/><path d="M12 7.4V12l3 1.8"/>',star:'<path d="m12 4 2.5 5.2 5.5.8-4 3.9 1 5.6-5-2.7-5 2.7 1-5.6-4-3.9 5.5-.8z"/>',info:'<circle cx="12" cy="12" r="8.6"/><path d="M12 11v5.2M12 7.6v.2"/>',alert:'<circle cx="12" cy="12" r="8.6"/><path d="M12 7.5v5M12 16.4v.2"/>',warning:'<path d="M12 4.4 2.8 19.6h18.4z"/><path d="M12 10v3.8M12 16.9v.2"/>',trash:'<path d="M4.5 7h15M9.5 7V5.2A1.2 1.2 0 0 1 10.7 4h2.6a1.2 1.2 0 0 1 1.2 1.2V7M6.6 7l.8 12a1.6 1.6 0 0 0 1.6 1.5h6a1.6 1.6 0 0 0 1.6-1.5l.8-12"/>',edit:'<path d="M4.5 19.5h4l10-10a2.1 2.1 0 0 0-3-3l-10 10z"/><path d="M14 6.5 17.5 10"/>',copy:'<rect x="8.5" y="8.5" width="11.5" height="11.5" rx="2.2"/><path d="M15.5 5.5A1.5 1.5 0 0 0 14 4H6a2 2 0 0 0-2 2v8a1.5 1.5 0 0 0 1.5 1.5"/>',download:'<path d="M12 4v11M7.5 11 12 15.5 16.5 11M4.5 19.5h15"/>',upload:'<path d="M12 20V8.5M7.5 12.5 12 8l4.5 4.5M4.5 4.5h15"/>',settings:'<circle cx="12" cy="12" r="3.1"/><path d="M19.6 14.4a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.03 1.56V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.56 1.7 1.7 0 0 0-1.87.34l-.06.06A2 2 0 1 1 4.15 16.9l.06-.06a1.7 1.7 0 0 0 .34-1.87A1.7 1.7 0 0 0 3 13.94H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.55-1.1 1.7 1.7 0 0 0-.34-1.87l-.06-.06A2 2 0 1 1 7.08 4.08l.06.06a1.7 1.7 0 0 0 1.87.34H9a1.7 1.7 0 0 0 1-1.56V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.56 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87V10a1.7 1.7 0 0 0 1.56 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.3 1z"/>',home:'<path d="M4 10.5 12 4l8 6.5V19a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 19z"/><path d="M9.6 20.5v-6h4.8v6"/>',heart:'<path d="M12 20s-7.5-4.6-7.5-9.4A4.1 4.1 0 0 1 12 8.2a4.1 4.1 0 0 1 7.5 2.4C19.5 15.4 12 20 12 20Z"/>',bell:'<path d="M18 9a6 6 0 1 0-12 0c0 5.2-2 6.5-2 6.5h16S18 14.2 18 9"/><path d="M13.7 19.5a2 2 0 0 1-3.4 0"/>',filter:'<path d="M4 5.5h16l-6.2 7.3v5.3l-3.6 2v-7.3z"/>',external:'<path d="M14 4.5h5.5V10M19 5l-8 8"/><path d="M18 13.5V18a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 18V7.5A1.5 1.5 0 0 1 6 6h4.5"/>',refresh:'<path d="M20 11a8 8 0 0 0-13.7-4.8L4 8.4"/><path d="M4 4.5v4h4M4 13a8 8 0 0 0 13.7 4.8L20 15.6"/><path d="M20 19.5v-4h-4"/>',folder:'<path d="M4 7.5A1.5 1.5 0 0 1 5.5 6h3.7l2 2.4h7.3A1.5 1.5 0 0 1 20 9.9v7.6a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5z"/>',file:'<path d="M13.5 4H7a1.5 1.5 0 0 0-1.5 1.5v13A1.5 1.5 0 0 0 7 20h10a1.5 1.5 0 0 0 1.5-1.5V9z"/><path d="M13.5 4v5h5"/>',image:'<rect x="4" y="5" width="16" height="14" rx="2.2"/><circle cx="9" cy="10" r="1.7"/><path d="m5 17 4.6-4.3 3.4 3 2.6-2.3L19 17"/>',link:'<path d="M10.6 13.4a3.6 3.6 0 0 0 5.1 0l2.4-2.4a3.6 3.6 0 0 0-5.1-5.1l-1.3 1.3"/><path d="M13.4 10.6a3.6 3.6 0 0 0-5.1 0l-2.4 2.4a3.6 3.6 0 0 0 5.1 5.1l1.3-1.3"/>',menu:'<path d="M4 7h16M4 12h16M4 17h16"/>',more:'<circle cx="6" cy="12" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="18" cy="12" r="1.4"/>',logout:'<path d="M14.5 8V6a1.5 1.5 0 0 0-1.5-1.5H6A1.5 1.5 0 0 0 4.5 6v12A1.5 1.5 0 0 0 6 19.5h7a1.5 1.5 0 0 0 1.5-1.5v-2"/><path d="M9.5 12h10.5M16.5 8.5 20 12l-3.5 3.5"/>',card:'<rect x="3" y="6" width="18" height="12" rx="2.4"/><path d="M3 10h18"/>',chart:'<path d="M4.5 19.5h15"/><path d="M7.5 19.5V11M12 19.5V5.5M16.5 19.5v-6"/>',box:'<path d="M20 8.6 12 4 4 8.6v6.8L12 20l8-4.6z"/><path d="m4 8.6 8 4.6 8-4.6M12 13.2V20"/>',inbox:'<path d="M4 13.5h4l1.4 2.4h5.2l1.4-2.4h4"/><path d="M4.6 13.5 7 5.6A1.5 1.5 0 0 1 8.5 4.5h7A1.5 1.5 0 0 1 17 5.6l2.4 7.9V18a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 18z"/>'};function Ny(e){let t=String(e!=null?e:"").trim();if(!t)return"";let n=Hp[t];return n?`<svg class="v-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${n}</svg>`:""}var Oy=`
...
`,Dp=!1;function Fy(){Dp||(Dp=!0,ge(),xo(),oe("components",Oy))}function ie(e,t){var r;let n=t.beforeMount;t.methods={svgIcon:o=>Ny(o),hasFlag:o=>ne(o),...(r=t.methods)!=null?r:{}},t.beforeMount=function(){Fy(),n==null||n.call(this)},jt(e,t)}ie("v-button",{props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},icon:L,iconRight:L,type:{type:"string",default:"button"},loading:F,disabled:F,block:F,rounded:F,ariaLabel:L},computed:{...be("loading","disabled","block","rounded"),blocked(){return ne(this.disabled)||ne(this.loading)}},template:`
  ...
  `});ie("v-checkbox",{props:{label:L,description:L,error:L,name:L,id:L,value:{type:"string",default:"on"},checked:F,disabled:F,required:F},state(e){return{fieldId:e.id||le("v-check-")}},computed:{...be("checked","disabled","required")},methods:{onToggle(e){let t=e.target;this.checked=t.checked,this.emit("change",t.checked)}},beforeMount(){Zt(this,{get:()=>ne(this.checked),set:e=>{this.checked=ne(e)}})},template:`
  ...
  `});ie("v-radio",{props:{label:L,description:L,error:L,name:L,id:L,value:{type:"string",default:""},checked:F,disabled:F,required:F},state(e){var t;return{fieldId:e.id||le("v-radio-"),selected:ne(e.checked)?String((t=e.value)!=null?t:""):""}},computed:{...be("disabled","required"),isChecked(){var e;return this.selected!==""&&this.selected===String((e=this.value)!=null?e:"")}},methods:{onPick(){var e;this.selected=String((e=this.value)!=null?e:""),this.emit("change",this.selected)}},beforeMount(){Zt(this,{get:()=>this.selected,set:e=>{this.selected=e==null?"":String(e)}})},template:`
  ...
  `});ie("v-switch",{props:{label:L,description:L,name:L,id:L,size:{type:"string",default:"md"},checked:F,disabled:F},state(e){return{fieldId:e.id||le("v-switch-")}},computed:{...be("checked","disabled")},methods:{onToggle(e){let t=e.target;this.checked=t.checked,this.emit("change",t.checked)}},beforeMount(){Zt(this,{get:()=>ne(this.checked),set:e=>{this.checked=ne(e)}})},template:`
  ...
  `});var zy={info:"info",primary:"info",success:"check",warning:"warning",danger:"alert",neutral:"info"};ie("v-alert",{props:{tone:{type:"string",default:"info"},title:L,icon:L,closable:F,closeLabel:{type:"string",default:"Close alert"}},state(){return{visible:!0}},computed:{...be("closable"),resolvedIcon(){return this.icon==="none"?"":this.icon||zy[this.tone]||"info"},liveRole(){return this.tone==="danger"?"alert":"status"}},methods:{dismiss(){this.visible=!1,this.emit("close")}},template:`
  ...
  `});function jy(e){return Array.isArray(e)?e.map(t=>{var n,r,o,i,s,a;if(t!=null&&typeof t=="object"){let l=t;return{label:String((o=(r=(n=l.label)!=null?n:l.text)!=null?r:l.title)!=null?o:""),href:String((a=(s=(i=l.href)!=null?i:l.url)!=null?s:l.to)!=null?a:"")}}return{label:String(t),href:""}}):typeof e!="string"?[]:ko(e).map(t=>{let n=t.indexOf(":");return n===-1?{label:t,href:""}:{label:t.slice(0,n).trim(),href:t.slice(n+1).trim()}})}ie("v-breadcrumb",{inheritScope:!0,props:{items:{type:"any",default:""},separator:{type:"string",default:"/"},ariaLabel:{type:"string",default:"Breadcrumb"}},computed:{crumbs(){var e;return jy((e=xr(this,this.items))!=null?e:this.items)}},methods:{isLast(e){return e===this.crumbs.length-1}},template:`
  ...
  `});async function Vy(e){try{if(typeof navigator!="undefined"&&navigator.clipboard)return await navigator.clipboard.writeText(e),!0}catch(t){}try{let t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();let n=document.execCommand("copy");return t.remove(),n}catch(t){return!1}}ie("v-code-block",{props:{code:L,language:L,filename:L,copyLabel:{type:"string",default:"Copy"},copiedLabel:{type:"string",default:"Copied"},wrap:F},state(){return{copied:!1}},computed:{...be("wrap"),header(){return this.filename||this.language||""},buttonLabel(){return this.copied?this.copiedLabel:this.copyLabel},buttonIcon(){return this.copied?"check":"copy"}},methods:{async copy(){let e=this.$refs.code,t=this.code||(e==null?void 0:e.textContent)||"";await Vy(String(t))&&(this.copied=!0,this.emit("copy",t),setTimeout(()=>{this.copied=!1},1800))}},template:`
  ...
  `});var zk=Object.keys(Hp);Ne();ce();var ct={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},rc={duration:220,size:"md"},Uy=`
...
`;function gs(){ge(),xo(),oe("dialog",Uy)}var oc={info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.6v.2"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m8.2 12.3 2.6 2.6 5-5.2"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4.6 2.9 19.4h18.2z"/><path d="M12 10v4M12 17.2v.2"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/></svg>',question:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M9.6 9.4a2.4 2.4 0 1 1 3.2 2.3c-.6.2-.8.7-.8 1.3v.5M12 16.6v.2"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg>'},tt=[],ic=new WeakMap,sc=0,Np="",Op="";function _y(){if(sc++>0)return;let e=document.body;Np=e.style.overflow,Op=e.style.paddingRight;let t=window.innerWidth-document.documentElement.clientWidth;if(e.style.overflow="hidden",t>0){let n=parseFloat(getComputedStyle(e).paddingRight)||0;e.style.paddingRight=`${n+t}px`}}function Wy(){sc!==0&&(--sc>0||(document.body.style.overflow=Np,document.body.style.paddingRight=Op))}var Ky='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function ac(e){return Array.from(e.querySelectorAll(Ky)).filter(t=>t.hasAttribute("disabled")||t.getAttribute("aria-hidden")==="true"?!1:t.offsetWidth>0||t.offsetHeight>0||t.getClientRects().length>0)}function lc(){return tt[tt.length-1]}function Yy(){return typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches}var hs=!1;function Fp(e){let t=lc();if(!t)return;if(e.key==="Escape"){if(t.options.closeOnEscape===!1)return;e.preventDefault(),t.handle.close(void 0);return}if(e.key!=="Tab")return;let n=ac(t.handle.panel);if(!n.length){e.preventDefault(),t.handle.panel.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;e.shiftKey&&(i===r||!t.handle.panel.contains(i))?(e.preventDefault(),o.focus()):!e.shiftKey&&i===o&&(e.preventDefault(),r.focus())}function Ip(e){var o;let t=lc();if(!t)return;let n=e.target;if(n&&t.handle.root.contains(n))return;((o=ac(t.handle.panel)[0])!=null?o:t.handle.panel).focus()}function Xy(){hs||(hs=!0,document.addEventListener("keydown",Fp,!0),document.addEventListener("focusin",Ip,!0))}function Gy(){hs&&(hs=!1,document.removeEventListener("keydown",Fp,!0),document.removeEventListener("focusin",Ip,!0))}function zp(e){var f,p,m,h,v,g,b;gs();let t=le("v-dialog-"),n=Yy()?0:rc.duration,r=document.createElement("div");r.className="v-dialog-root",r.id=t,r.setAttribute("data-size",(f=e.size)!=null?f:rc.size),r.setAttribute("data-position",(p=e.position)!=null?p:"center"),r.style.setProperty("--v-dialog-ms",`${n}ms`),r.style.setProperty("--v-dialog-layer",String(tt.length*2));let o=document.createElement("div");o.className="v-dialog-backdrop",r.appendChild(o);let i=document.createElement("div");i.className="v-dialog-panel",e.plain&&i.classList.add("is-plain"),e.className&&i.classList.add(...e.className.split(/\s+/).filter(Boolean)),i.setAttribute("role",(m=e.role)!=null?m:"dialog"),i.setAttribute("aria-modal","true"),i.tabIndex=-1,e.labelledBy?i.setAttribute("aria-labelledby",e.labelledBy):e.ariaLabel&&i.setAttribute("aria-label",e.ariaLabel),e.describedBy&&i.setAttribute("aria-describedby",e.describedBy),r.appendChild(i);let s=document.createElement("div");if(s.className="v-dialog-body",e.source){let x=document.createComment(" v-modal ");(h=e.source.parentNode)==null||h.insertBefore(x,e.source),tc.set(e.source,x),e.source.classList.add("v-dialog-open"),e.source.removeAttribute("hidden"),s.appendChild(e.source)}else e.content&&s.appendChild(e.content);if(i.appendChild(s),e.closable!==!1){let x=document.createElement("button");x.type="button",x.className="v-dialog-x",x.setAttribute("aria-label",ct.close),x.innerHTML=oc.close,x.addEventListener("click",()=>d.close(void 0)),i.appendChild(x)}let a=!1,l=()=>{},c=new Promise(x=>{l=x}),d={id:t,root:r,panel:i,body:s,key:(v=e.key)!=null?v:null,source:(g=e.source)!=null?g:null,closed:c,close(x){if(a)return;a=!0;let T=tt.findIndex(C=>C.handle===d);T>-1&&tt.splice(T,1),ic.delete(r),u.locked&&Wy(),tt.length||Gy(),r.classList.remove("is-open"),r.classList.add("is-closing");let E=()=>{var D;let C=e.source;if(C){let A=tc.get(C);C.classList.remove("v-dialog-open"),A&&A.parentNode?(A.parentNode.insertBefore(C,A),A.remove()):C.remove(),tc.delete(C),sa(C,"modal-content")&&C.setAttribute("hidden","")}if(r.remove(),(D=e.onClose)==null||D.call(e,x,d),l(x),e.restoreFocus!==!1){let A=u.previousFocus;A&&typeof A.focus=="function"&&A.isConnected&&A.focus()}};n>0?setTimeout(E,n):E()}},u={handle:d,options:e,previousFocus:document.activeElement,locked:e.lockScroll!==!1};return o.addEventListener("click",()=>{e.closeOnBackdrop!==!1&&d.close(void 0)}),u.locked&&_y(),tt.push(u),ic.set(r,u),Xy(),document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add("is-open");let x=Qy(e,i);x==null||x.focus()}),(b=e.onOpen)==null||b.call(e,d),d}var tc=new WeakMap;function Qy(e,t){var i;let n=e.initialFocus;if(n instanceof HTMLElement)return n;if(typeof n=="string"){let s=t.querySelector(n);if(s)return s}let r=t.querySelector("[autofocus],[data-autofocus]");return r||((i=ac(t)[0])!=null?i:t)}function Jy(e){if(e instanceof HTMLElement)return e;let t=String(e!=null?e:"").trim();if(!t)return null;let n=/^[\w-]+$/.test(t)?`#${t}`:t;return document.querySelector(n)}function ms(e){return typeof e=="string"?e.trim()||null:e.id?`#${e.id}`:null}function vs(e){let t=/^[\w-]+$/.test(e)?`#${e}`:e;return tt.find(n=>{var o;if(n.handle.key===e||n.handle.key===t)return!0;let r=n.handle.source;return!!r&&((o=r.matches)==null?void 0:o.call(r,t))})}var Mn={open(e,t={}){var s,a;let n=Jy(e);if(!n)return console.warn(`[Voodoo] modal.open: target not found (${String(e)}).`),null;let r=(s=ms(e))!=null?s:n.id?`#${n.id}`:null,o=r?vs(r):void 0;if(o)return o.handle;let i=n.querySelector("[data-dialog-title],h1,h2,h3");return i&&!i.id&&(i.id=le("v-dialog-title-")),zp({...t,source:n,key:r,labelledBy:(a=i==null?void 0:i.id)!=null?a:null})},close(e,t){var o;if(e===void 0){(o=lc())==null||o.handle.close(t);return}let n=ms(e),r=n?vs(n):void 0;r==null||r.handle.close(t)},closeAll(e){for(let t of[...tt].reverse())t.handle.close(e)},toggle(e,t={}){let n=ms(e),r=n?vs(n):void 0;return r?(r.handle.close(void 0),null):this.open(e,t)},isOpen(e){if(e===void 0)return tt.length>0;let t=ms(e);return!!(t&&vs(t))},get opened(){return tt.map(e=>e.handle)},get count(){return tt.length},configure(e){Object.assign(rc,e)},labels(e){return Object.assign(ct,e),ct}};function wr(e){var a,l;gs();let t=document.createDocumentFragment(),n=e.title?le("v-dialog-title-"):null,r=e.description?le("v-dialog-desc-"):null,o=null;if(e.title||e.description||e.icon){o=document.createElement("div"),o.className="v-dialog-head";let c=e.icon&&e.icon!=="none"?e.icon:null;if(c&&oc[c]){let u=document.createElement("div");u.className="v-dialog-icon",u.setAttribute("aria-hidden","true"),u.setAttribute("data-tone",(a=e.tone)!=null?a:Zy(c)),u.innerHTML=oc[c],o.appendChild(u)}let d=document.createElement("div");if(d.className="v-dialog-heading",e.title){let u=document.createElement("h2");u.className="v-dialog-title",u.id=n,u.textContent=e.title,d.appendChild(u)}if(e.description){let u=document.createElement("p");u.className="v-dialog-desc",u.id=r,u.textContent=e.description,d.appendChild(u)}o.appendChild(d)}let i=document.createDocumentFragment();if(e.text)for(let c of e.text.split(`
`)){let d=document.createElement("p");d.textContent=c,i.appendChild(d)}if(e.html){let c=document.createElement("div");for(c.innerHTML=e.html;c.firstChild;)i.appendChild(c.firstChild)}e.node&&i.appendChild(e.node),t.appendChild(i);let s=(l=e.buttons)!=null?l:[{label:ct.ok,value:!0,variant:"primary",autofocus:!0}];return new Promise(c=>{var u;let d=zp({...e,content:t,role:e.tone==="danger"?"alertdialog":"dialog",labelledBy:n,describedBy:r,key:null,onClose(f){var p;(p=e.onClose)==null||p.call(e,f,d),c(f===void 0?null:f)}});if(o&&d.panel.insertBefore(o,d.body),s.length){let f=document.createElement("div");f.className="v-dialog-foot";for(let p of s){let m=document.createElement("button");m.type="button",m.className="v-dlg-btn",m.setAttribute("data-variant",(u=p.variant)!=null?u:"secondary"),m.textContent=p.label,p.autofocus&&m.setAttribute("data-autofocus",""),m.addEventListener("click",()=>{var v,g;((v=p.onClick)==null?void 0:v.call(p,d))!==!1&&p.close!==!1&&d.close((g=p.value)!=null?g:null)}),f.appendChild(m)}d.panel.appendChild(f)}d.body.childNodes.length||d.body.remove()})}function Zy(e){return e==="success"||e==="warning"||e==="danger"?e:"default"}function cc(e,t={}){var n;return wr({icon:"info",size:"sm",...t,text:e,buttons:[{label:(n=t.confirmLabel)!=null?n:ct.ok,value:!0,variant:t.tone==="danger"?"danger":"primary",autofocus:!0}]}).then(()=>{})}function bs(e,t={}){var r,o,i;let n=t.danger?"danger":(r=t.tone)!=null?r:"default";return wr({icon:n==="danger"?"warning":"question",size:"sm",...t,tone:n,text:e,buttons:[{label:(o=t.cancelLabel)!=null?o:ct.cancel,value:!1,variant:"secondary"},{label:(i=t.confirmLabel)!=null?i:ct.confirm,value:!0,variant:n==="danger"?"danger":"primary",autofocus:!0}]}).then(s=>s===!0)}function dc(e,t={}){var m,h,v,g;gs();let n=(m=t.type)!=null?m:"text",r=le("v-prompt-"),o=`${r}-hint`,i=`${r}-error`,s=document.createElement("div");s.className="v-dialog-field";let a=document.createElement("label");a.className="v-dialog-label",a.htmlFor=r,a.textContent=e,s.appendChild(a);let l=n==="textarea"?document.createElement("textarea"):document.createElement("input");if(l.className="v-dialog-input",l.id=r,l instanceof HTMLInputElement&&(l.type=n==="textarea"?"text":n),l.value=(h=t.value)!=null?h:"",t.placeholder&&(l.placeholder=t.placeholder),t.required&&(l.required=!0),l.setAttribute("data-autofocus",""),s.appendChild(l),t.hint){let b=document.createElement("p");b.className="v-dialog-hint",b.id=o,b.textContent=t.hint,s.appendChild(b),l.setAttribute("aria-describedby",o)}let c=document.createElement("p");c.className="v-dialog-error",c.id=i,c.hidden=!0,c.setAttribute("role","alert"),s.appendChild(c);let d=()=>n==="number"?l.value.trim():l.value,u=b=>{var E,C;let x=d(),T=null;return t.required&&!x.trim()?T=ct.required:T=(C=(E=t.validate)==null?void 0:E.call(t,x))!=null?C:null,T?(c.textContent=T,c.hidden=!1,l.setAttribute("aria-invalid","true"),l.setAttribute("aria-describedby",i),l.focus(),!1):(c.hidden=!0,l.removeAttribute("aria-invalid"),b.close(x),!0)},f=null;return l.addEventListener("keydown",b=>{let x=b;x.key==="Enter"&&(n==="textarea"&&!x.ctrlKey&&!x.metaKey||(b.preventDefault(),f&&u(f)))}),wr({icon:"question",size:"sm",...t,node:s,text:void 0,buttons:[{label:(v=t.cancelLabel)!=null?v:ct.cancel,value:null,variant:"secondary"},{label:(g=t.confirmLabel)!=null?g:ct.confirm,variant:"primary",close:!1,onClick(b){return f=b,u(b),!1}}],onOpen(b){var x;f=b,(x=t.onOpen)==null||x.call(t,b)}}).then(b=>typeof b=="string"?b:null)}y("modal",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim();e.setAttribute("aria-haspopup","dialog");let i=s=>{if(s.preventDefault(),n.close){Mn.close(o||void 0);return}if(n.toggle){o&&Mn.toggle(o);return}o&&Mn.open(o)};e.addEventListener("click",i),r(()=>e.removeEventListener("click",i))});y("modal-content",({el:e})=>{gs(),e.id||(e.id=le("v-modal-")),e.classList.contains("v-dialog-open")||e.setAttribute("hidden","")},{priority:j.REF});y("modal-close",({el:e,expression:t,cleanup:n})=>{let r=o=>{o.preventDefault();let i=e.closest(".v-dialog-root"),s=i?ic.get(i):void 0;s?s.handle.close(t.trim()||void 0):Mn.close(void 0,t.trim()||void 0)};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});var nc=!1;y("confirm",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim()||ct.confirmQuestion,i=s=>{var u,f,p;if(nc)return;s.preventDefault(),s.stopImmediatePropagation();let a=s.target instanceof HTMLElement?s.target:e,l=(u=Te(e,`${w.prefix}confirm-title`))!=null?u:void 0,c=(f=Te(e,`${w.prefix}confirm-label`))!=null?f:void 0,d=(p=Te(e,`${w.prefix}confirm-cancel`))!=null?p:void 0;bs(o,{title:l,confirmLabel:c,cancelLabel:d,danger:!!n.danger,size:"sm"}).then(m=>{if(m){nc=!0;try{a.click()}finally{nc=!1}}})};e.addEventListener("click",i,!0),r(()=>e.removeEventListener("click",i,!0))},{priority:j.REF});N("$modal",()=>Mn);N("$dialog",()=>wr);N("$alert",()=>cc);N("$confirm",()=>bs);N("$prompt",()=>dc);ue();ce();var To=new Map;function Le(e,t){To.set(e.trim().toLowerCase(),t)}var ex={9:/\d/,A:/[A-Za-zÀ-ÖØ-öø-ÿ]/,S:/[0-9A-Za-zÀ-ÖØ-öø-ÿ]/,"*":/[\s\S]/},tx=/[0-9A-Za-zÀ-ÖØ-öø-ÿ]/,qp=new Set(["currency","percent"]);function Sn(e,t){let n="",r=0;for(let o=0;o<t.length;o++){let i=t[o];if(i==="\\"){let a=t[++o];if(a===void 0||r>=e.length)break;n+=a;continue}let s=ex[i];if(s){for(;r<e.length&&!s.test(e[r]);)r++;if(r>=e.length)break;n+=e[r++];continue}if(r>=e.length)break;e[r]===i&&r++,n+=i}return n}function xs(e,t={}){var h,v,g,b,x;let n=Math.max(0,Math.trunc((h=t.decimals)!=null?h:2)),r=(v=t.decimal)!=null?v:",",o=(g=t.thousands)!=null?g:".",i=(b=t.prefix)!=null?b:"R$ ",s=(x=t.suffix)!=null?x:"",a=String(e!=null?e:""),l=a.trim().startsWith("-"),c=a.replace(/\D/g,"").slice(0,15);if(!c)return"";let d=c.padStart(n+1,"0"),u=n?d.slice(0,d.length-n):d,f=n?d.slice(d.length-n):"",m=u.replace(/^0+(?=\d)/,"").replace(/\B(?=(\d{3})+(?!\d))/g,o);return`${l?"-":""}${i}${m}${n?r+f:""}${s}`}function Vp(e,t=2){return xs(e,{prefix:"",suffix:"%",decimals:t})}Le("cpf","999.999.999-99");Le("cnpj","99.999.999/9999-99");Le("cep","99999-999");Le("date","99/99/9999");Le("time","99:99");Le("datetime","99/99/9999 99:99");Le("cvv","9999");Le("cpfcnpj",e=>{let t=e.replace(/\D/g,"");return Sn(t,t.length<=11?"999.999.999-99":"99.999.999/9999-99")});Le("phone",e=>{let t=e.replace(/\D/g,"").slice(0,11);return Sn(t,t.length<=10?"(99) 9999-9999":"(99) 99999-9999")});Le("currency",e=>xs(e));Le("percent",e=>Vp(e));Le("card",e=>{let t=e.replace(/\D/g,"").slice(0,19);return/^3[47]/.test(t)?Sn(t,"9999 999999 99999"):t.length>16?Sn(t,"9999 9999 9999 9999 999"):Sn(t,"9999 9999 9999 9999")});Le("plate",e=>{let t=e.replace(/[^0-9A-Za-z]/g,"").toUpperCase().slice(0,7),n=t.length>=5&&/\d/.test(t[4]);return Sn(t,n?"AAA-9999":"AAA9A99")});Le("hex",e=>{let t=e.replace(/[^0-9a-fA-F]/g,"").toUpperCase().slice(0,6);return t?`#${t}`:""});Le("ip",e=>{let t=e.replace(/[^\d.]/g,"").split(".").slice(0,4),n=[];for(let r of t){if(r===""){n.push("");continue}let o=Math.min(255,Number(r.slice(0,3)));n.push(String(o))}return n.join(".")});function Eo(e,t){let n=e==null?"":String(e);if(!t)return n;let r=To.get(t.trim().toLowerCase());return typeof r=="function"?r(n):Sn(n,typeof r=="string"?r:t)}function ws(e,t){let n=e==null?"":String(e),r=t?t.trim().toLowerCase():"";if(r&&qp.has(r)){let o=n.trim().startsWith("-"),i=n.replace(/\D/g,"").replace(/^0+(?=\d)/,"");if(!i)return"";let s=i.padStart(3,"0"),a=`${s.slice(0,s.length-2)}.${s.slice(s.length-2)}`;return o?`-${a}`:a}return n.replace(/[^0-9A-Za-zÀ-ÖØ-öø-ÿ]/g,"")}var Up=Object.assign((e,t)=>Eo(e,t),{apply:Eo,unmask:ws,register:Le,currency:xs,percent:Vp,presets:To});function ys(e){return e!==void 0&&tx.test(e)}function Bp(e,t){let n=0,r=Math.min(t,e.length);for(let o=0;o<r;o++)ys(e[o])&&n++;return n}function jp(e,t){if(t<=0)return 0;let n=0;for(let r=0;r<e.length;r++)if(ys(e[r])&&(n++,n===t))return r+1;return e.length}var uc=new WeakSet;function _p(e,t,n){var m;if(uc.has(e))return;uc.add(e);let r=Object.getPrototypeOf(e),o=(m=Object.getOwnPropertyDescriptor(r,"value"))!=null?m:Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value"),i=o==null?void 0:o.get,s=o==null?void 0:o.set,a=()=>{var h;return String(i?i.call(e):(h=e.getAttribute("value"))!=null?h:"")},l=h=>{s?s.call(e,h):e.setAttribute("value",h)},c=h=>{try{e.setSelectionRange(h,h)}catch(v){}};i&&s&&(Object.defineProperty(e,"value",{configurable:!0,enumerable:!0,get(){let h=String(i.call(e));return t.clean?t.clean(h):h},set(h){s.call(e,t.format(h==null?"":String(h)))}}),n(()=>{let h=a();Reflect.deleteProperty(e,"value"),l(h)}));let d=()=>{var x,T;let h=a(),v=(x=e.selectionStart)!=null?x:h.length,g=Bp(h,v),b=t.format(h);b!==h&&l(b),t.rightToLeft?c(Math.max(0,b.length-((T=t.suffixLength)!=null?T:0))):c(jp(b,g))},u=()=>d(),f=h=>{var C,D;if(h.key!=="Backspace")return;let v=(C=e.selectionStart)!=null?C:0,g=(D=e.selectionEnd)!=null?D:0;if(v!==g||v===0)return;let b=a();if(ys(b[v-1]))return;let x=v-1;for(;x>=0&&!ys(b[x]);)x--;if(h.preventDefault(),x<0)return;let T=b.slice(0,x)+b.slice(v),E=Bp(T,x);l(t.format(T)),c(jp(a(),E)),e.dispatchEvent(new Event("input",{bubbles:!0}))};e.addEventListener("input",u),e.addEventListener("keydown",f),n(()=>{uc.delete(e),e.removeEventListener("input",u),e.removeEventListener("keydown",f)});let p=a();p&&l(t.format(p))}function Wp(e,t){if(e.tagName!=="INPUT"&&e.tagName!=="TEXTAREA")return X(`${w.prefix}${t} only works on input or textarea.`),null;let n=e,r=(n.getAttribute("type")||"text").toLowerCase();return r==="number"||r==="range"||r==="date"||r==="color"?(X(`${w.prefix}${t} doesn't work with input type="${r}". Use type="text".`),null):n}y("mask",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=Wp(e,"mask");if(!o)return;let i=t.trim();if(!i){X(`${w.prefix}mask needs a pattern or mask name.`);return}let s=i.toLowerCase(),a=!!n.unmask||!!n.raw;_p(o,{format:l=>Eo(l,i),clean:a?l=>ws(l,s):void 0,rightToLeft:qp.has(s),suffixLength:s==="percent"?1:0},r)},{priority:j.MODEL+5});y("mask-currency",({el:e,expression:t,modifiers:n,cleanup:r})=>{var f,p,m,h;let o=Wp(e,"mask-currency");if(!o)return;let i=v=>{var g;return(g=e.getAttribute(`${w.prefix}${v}`))!=null?g:e.getAttribute(`data-v-${v}`)},s=(f=typeof n.decimals=="string"?n.decimals:null)!=null?f:i("mask-decimals"),a=s!==null&&s!==""?Number(s):2,l=t.trim()?t:"",c={prefix:n.plain?"":l||i("mask-prefix")||"R$ ",suffix:(p=i("mask-suffix"))!=null?p:"",decimals:Number.isFinite(a)?a:2,decimal:n.dot?".":",",thousands:n.dot?",":"."},d=!!n.unmask||!!n.raw,u=(m=c.decimals)!=null?m:2;_p(o,{format:v=>xs(v,c),clean:d?v=>{let g=v.replace(/\D/g,"").replace(/^0+(?=\d)/,"");if(!g)return"";if(u===0)return g;let b=g.padStart(u+1,"0"),x=`${b.slice(0,b.length-u)}.${b.slice(b.length-u)}`;return v.trim().startsWith("-")?`-${x}`:x}:void 0,rightToLeft:!0,suffixLength:((h=c.suffix)!=null?h:"").length},r)},{priority:j.MODEL+5});ce();Ne();var So="v-xray-flash",Qp=200,nx=400,Xe=!1,Kp=!1,_=null,nt="estado",Cn="auto",Er=[],Tr=[],en=new Map,Ts=new Set,Mo=new Map,Co=[],fc=new WeakMap,we={effects:0,mutations:0,effectsPerSecond:0,updatesPerSecond:0,history:[]},kt=[],ks=0,Es=0,Lr=0,Mr=0,Lo=null,rx=`
.v-xray-root{
  all: initial;
  --vx-accent:#6D3BF5;
  --vx-accent-2:#FF3D8B;
...
`;function M(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n!==void 0&&(r.textContent=n),r}function Ms(e){if(!e||!_)return!1;let t=e.nodeType===1?e:e.parentElement;return!!t&&_.root.contains(t)}function Sr(e){if(!e)return"(no element)";let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:"",r=typeof e.className=="string"&&e.className?`.${e.className.trim().split(/\s+/).slice(0,2).join(".")}`:"";return`${t}${n}${r}`}function Jp(e,t=64){var r;if(e===null)return"null";if(e===void 0)return"undefined";let n=typeof e;if(n==="function")return"function()";if(n==="string")return`"${oi(e,t)}"`;if(n==="number"||n==="boolean"||n==="symbol")return String(e);if(typeof Element!="undefined"&&e instanceof Element)return`<${e.tagName.toLowerCase()}>`;try{return oi((r=JSON.stringify(e))!=null?r:String(e),t)}catch(o){return String(e)}}function ox(e){var t;if(typeof e=="string")return e;try{return(t=JSON.stringify(e))!=null?t:""}catch(n){return String(e)}}function ix(e,t){if(typeof t=="string")return e;try{return JSON.parse(e)}catch(n){return e}}function Zp(e){let t=new Date(e),n=r=>String(r).padStart(2,"0");return`${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`}function em(e,t){for(let n of e.effects)t.push(n);for(let n of e.children)em(n,t)}function mc(e){let t=[];for(let n of vd(e))em(n,t);return t}function tm(e){let t=mc(e).length;for(let n of Array.from(e.childNodes))n.nodeType===3&&(t+=mc(n).length);return t}function nm(e){if(!e||!Xe||Ms(e))return;let t=Mo.get(e);t&&window.clearTimeout(t),Ts.add(e),e.classList.add(So);let n=window.setTimeout(()=>{e.classList.remove(So),Mo.delete(e),window.setTimeout(()=>Ts.delete(e),0)},460);Mo.set(e,n)}function Yp(e,t){for(let n of mc(e)){if(en.has(n))continue;let r=n.fn;en.set(n,r),n.fn=()=>(we.effects++,nm(t),r())}}function sx(){for(let[e,t]of en)e.fn=t;en.clear()}function rm(){if(!Xe||typeof document=="undefined")return;for(let[n]of en)n.active||en.delete(n);let e=document.createTreeWalker(document.body,NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_TEXT),t=e.currentNode;for(;t;){if(t.nodeType===1){let n=t;if(_&&_.root.contains(n)){t=ax(e);continue}Yp(n,n)}else t.nodeType===3&&t.parentElement&&Yp(t,t.parentElement);t=e.nextNode()}dx()}function ax(e){let t=e.currentNode,n=e.nextSibling();if(n)return n;let r=e.parentNode();for(;r;){if(n=e.nextSibling(),n)return n;r=e.parentNode()}return e.currentNode=t,null}function lx(){let e=[],t=document.body.querySelectorAll("*");for(let n=0;n<t.length&&e.length<nx;n++){let r=t[n];_&&_.root.contains(r)||la(r)&&e.push(r)}return e}function cx(e){return In(e).map(t=>t.arg?`${t.name}:${t.arg}`:t.name)}function dx(){var t;if(!Xe||!_)return;let e=_.overlay;e.textContent="",Co.length=0;for(let n of lx()){let r=M("div","v-xray-box"),o=!!((t=ot(n))!=null&&t.component);r.dataset.kind=o?"component":"directive";let i=M("span","v-xray-tag",cx(n).join(" "));r.appendChild(i),e.appendChild(r),Co.push({el:n,box:r})}gc()}function gc(){if(Xe)for(let e of Co){if(!e.el.isConnected){e.box.style.display="none";continue}let t=e.el.getBoundingClientRect();if(t.width===0&&t.height===0){e.box.style.display="none";continue}e.box.style.display="block",e.box.style.left=`${t.left}px`,e.box.style.top=`${t.top}px`,e.box.style.width=`${t.width}px`,e.box.style.height=`${t.height}px`}}function ux(){Mr||(Mr=requestAnimationFrame(()=>{Mr=0,gc()}))}function fx(e,t=40){let n=new Set,r=[],o=e;for(;o&&r.length<t;){let i=[];try{i=Object.keys(o.data)}catch(s){i=[]}for(let s of i){if(n.has(s))continue;n.add(s);let a;try{a=o.data[s]}catch(l){a="(read error)"}if(r.push([s,a]),r.length>=t)break}o=o.parent}return r}function px(e){var s;if(!_)return;let t=_.card;t.textContent="";let n=Ce(e),r=(s=n.owner)==null?void 0:s.component;t.appendChild(M("strong","v-xray-card-title",Sr(e))),t.appendChild(M("span","v-xray-section","Directives"));let o=In(e);if(!o.length)t.appendChild(M("div","v-xray-val","none"));else for(let a of o){let l=M("div","v-xray-row");l.appendChild(M("span","v-xray-key",a.raw)),l.appendChild(M("span","v-xray-val",a.expression||"(no value)")),t.appendChild(l)}t.appendChild(M("span","v-xray-section","Component")),t.appendChild(M("div","v-xray-val",r?`${r.$name} in ${Sr(r.$el)}`:"none")),t.appendChild(M("span","v-xray-section","Scope"));let i=fx(n);if(!i.length)t.appendChild(M("div","v-xray-val","root scope empty"));else for(let[a,l]of i){let c=M("div","v-xray-row");c.appendChild(M("span","v-xray-key",a)),c.appendChild(M("span","v-xray-val",Jp(l))),t.appendChild(c)}t.appendChild(M("span","v-xray-section","Reactivity")),t.appendChild(M("div","v-xray-val",`${tm(e)} effect(s) depend on this element`))}function mx(e,t){if(!_)return;let n=_.card,r=320,o=Math.min(n.scrollHeight||200,window.innerHeight*.6),i=e+16+r>window.innerWidth?Math.max(8,e-r-16):e+16,s=t+16+o>window.innerHeight?Math.max(8,t-o-16):t+16;n.style.left=`${i}px`,n.style.top=`${s}px`}function Xp(e){if(!Xe||!_)return;let t=e.target;if(!t||Ms(t)){_.card.dataset.open="0",Lo=null;return}let n=t;for(;n&&n!==document.body&&!la(n);)n=n.parentElement;if(!n||n===document.body){_.card.dataset.open="0",Lo=null;return}n!==Lo&&(Lo=n,px(n)),_.card.dataset.open="1",mx(e.clientX,e.clientY)}function vx(){let e=new Map,t=document.body.querySelectorAll("*");for(let r=0;r<t.length;r++){let o=t[r];if(_&&_.root.contains(o))continue;let i=ot(o);i&&e.set(o,i)}let n=[];for(let[r,o]of e){let i=0,s=r.parentElement;for(;s;)e.has(s)&&i++,s=s.parentElement;n.push({el:r,scope:o,depth:i})}return n}function Ls(e,t,n){let r=M("div","v-xray-row");if(r.appendChild(M("span","v-xray-key",e)),typeof t=="function")return r.appendChild(M("span","v-xray-val","function()")),r;let o=M("input","v-xray-input");return o.type="text",o.value=ox(t),o.spellcheck=!1,o.addEventListener("change",()=>{try{n(ix(o.value,t)),o.dataset.error="0"}catch(i){o.dataset.error="1"}}),o.addEventListener("keydown",i=>{i.key==="Enter"&&o.blur()}),r.appendChild(o),r}function hx(){let e=document.createDocumentFragment(),t=vx();if(!t.length)return e.appendChild(M("span","v-xray-empty","No scopes on the page. Use v-data or a component.")),e;for(let n of t){let r=M("div","v-xray-group");r.style.marginLeft=`${Math.min(n.depth,4)*8}px`;let o=M("div","v-xray-group-head");o.appendChild(M("span","v-xray-badge",n.scope.component?"component":"scope")),o.appendChild(M("span",void 0,Sr(n.el))),o.addEventListener("click",()=>im(n.el)),r.appendChild(o);let i=M("div","v-xray-rows"),s=[];try{s=Object.keys(n.scope.data)}catch(a){s=[]}if(!s.length)i.appendChild(M("span","v-xray-empty","no variables"));else for(let a of s){let l;try{l=n.scope.data[a]}catch(c){l=void 0}i.appendChild(Ls(a,l,c=>{n.scope.set(a,c)}))}r.appendChild(i),e.appendChild(r)}return e}function gx(){var n;let e=document.createDocumentFragment(),t=[...Rt];if(!t.length)return e.appendChild(M("span","v-xray-empty","No components mounted.")),e;for(let r of t){let o=M("div","v-xray-group"),i=M("div","v-xray-group-head");i.appendChild(M("span","v-xray-badge",r.$name)),i.appendChild(M("span",void 0,Sr(r.$el))),i.appendChild(M("span","v-xray-badge",`${tm(r.$el)} effects`)),i.lastChild.dataset.tone="mute",i.addEventListener("click",()=>im(r.$el)),o.appendChild(i);let s=M("div","v-xray-rows"),a=(n=r.$props)!=null?n:{},l=Object.keys(a);if(l.length){s.appendChild(M("span","v-xray-section","Props"));for(let u of l)s.appendChild(Ls(u,a[u],f=>{a[u]=f}))}let c=r.$scope,d=[];try{d=Object.keys(c.data).filter(u=>!l.includes(u))}catch(u){d=[]}if(d.length){s.appendChild(M("span","v-xray-section","State"));for(let u of d){let f;try{f=c.data[u]}catch(p){f=void 0}s.appendChild(Ls(u,f,p=>{c.set(u,p)}))}}o.appendChild(s),e.appendChild(o)}return e}function bx(){let e=document.createDocumentFragment(),t=ti();if(!t.length)return e.appendChild(M("span","v-xray-empty","No global stores. Create one with V.store().")),e;for(let n of t){let r=$t[n],o=M("div","v-xray-group"),i=M("div","v-xray-group-head");i.appendChild(M("span","v-xray-badge","store")),i.firstChild.dataset.tone="alt",i.appendChild(M("span",void 0,n)),o.appendChild(i);let s=M("div","v-xray-rows"),a=r?Object.keys(r):[];if(!a.length)s.appendChild(M("span","v-xray-empty","empty store"));else for(let l of a)s.appendChild(Ls(l,r[l],c=>{r[l]=c}));o.appendChild(s),e.appendChild(o)}return e}function om(e,t,n,r){let o=M("div","v-xray-log");if(o.appendChild(M("span","v-xray-log-time",e)),o.appendChild(M("span","v-xray-log-main",t)),n!==void 0){let i=M("span",r==="fail"?"v-xray-fail":r==="ok"?"v-xray-ok":void 0,n);o.appendChild(i)}return o}function yx(){let e=document.createDocumentFragment(),t=M("button","v-xray-btn","clear log");if(t.addEventListener("click",()=>{Er.length=0,tn()}),e.appendChild(t),!Er.length)return e.appendChild(M("span","v-xray-empty","No events yet. Interact with the page.")),e;for(let n of[...Er].reverse())e.appendChild(om(Zp(n.at),`${n.type} on ${n.target}`,n.detail||n.source));return e}function xx(){let e=document.createDocumentFragment(),t=M("button","v-xray-btn","clear log");if(t.addEventListener("click",()=>{Tr.length=0,tn()}),e.appendChild(t),!Tr.length)return e.appendChild(M("span","v-xray-empty","No requests yet. v-get, v-post and V.http show up here.")),e;for(let n of[...Tr].reverse())e.appendChild(om(Zp(n.at),`${n.method} ${n.url}`,`${n.status||"---"} ${Math.round(n.duration)}ms`,n.ok?"ok":"fail"));return e}function wx(){let e=document.createDocumentFragment(),t=M("div","v-xray-metric");t.appendChild(M("span","v-xray-metric-value",String(we.updatesPerSecond))),t.appendChild(M("span",void 0,"DOM updates per second")),e.appendChild(t);let n=M("div","v-xray-metric");n.appendChild(M("span","v-xray-metric-value",String(we.effectsPerSecond))),n.appendChild(M("span",void 0,"reactive effects triggered per second")),e.appendChild(n);let r=M("div","v-xray-metric");r.appendChild(M("span","v-xray-metric-value",String(we.effects))),r.appendChild(M("span",void 0,"effects triggered since x-ray was enabled")),e.appendChild(r);let o=M("div","v-xray-chart"),i=Math.max(1,...we.history.map(s=>Math.max(s.effects,s.updates)));for(let s of we.history){let a=M("div","v-xray-bar"),l=Math.max(s.effects,s.updates);a.style.height=`${Math.max(2,Math.round(l/i*46))}px`,a.title=`${s.effects} effects, ${s.updates} updates`,o.appendChild(a)}return e.appendChild(o),e.appendChild(M("span","v-xray-hint",`${en.size} effects instrumented, peak of ${i} per second`)),e}var kx=[{id:"estado",label:"Estado"},{id:"componentes",label:"Componentes"},{id:"stores",label:"Stores"},{id:"eventos",label:"Eventos"},{id:"rede",label:"Rede"},{id:"desempenho",label:"Desempenho"}];function tn(){if(!_)return;let e=document.activeElement;if(!(e instanceof HTMLInputElement&&_.body.contains(e))){switch(_.body.textContent="",nt){case"estado":_.body.appendChild(hx());break;case"componentes":_.body.appendChild(gx());break;case"stores":_.body.appendChild(bx());break;case"eventos":_.body.appendChild(yx());break;case"rede":_.body.appendChild(xx());break;case"desempenho":_.body.appendChild(wx());break}for(let t of Array.from(_.tabs.children)){let n=t;n.dataset.active=n.dataset.id===nt?"1":"0"}_.status.textContent=`${Co.length} elements with directives, ${Rt.size} components, ${en.size} effects observed`}}function im(e){e.scrollIntoView({behavior:"smooth",block:"center"}),nm(e)}function Ex(){let e=M("div","v-xray-root");e.setAttribute(`${w.prefix}ignore`,""),e.setAttribute("role","complementary"),e.setAttribute("aria-label","Voodoo x-ray inspector"),Cn!=="auto"&&(e.dataset.vXrayTheme=Cn);let t=M("div","v-xray-overlay");e.appendChild(t);let n=M("div","v-xray-card");n.dataset.open="0",e.appendChild(n);let r=M("div","v-xray-panel"),o=M("div","v-xray-header"),i=M("div","v-xray-brand");i.appendChild(M("span","v-xray-dot")),i.appendChild(document.createTextNode("Voodoo x-ray")),o.appendChild(i);let s=M("button","v-xray-btn","theme");s.addEventListener("click",()=>{Cn=Cn==="auto"?"dark":Cn==="dark"?"light":"auto",Cn==="auto"?delete e.dataset.vXrayTheme:e.dataset.vXrayTheme=Cn}),o.appendChild(s);let a=M("button","v-xray-btn","close");a.addEventListener("click",()=>sm()),o.appendChild(a),r.appendChild(o);let l=M("div","v-xray-tabs");for(let u of kx){let f=M("button","v-xray-tab",u.label);f.dataset.id=u.id,f.dataset.active=u.id===nt?"1":"0",f.addEventListener("click",()=>{nt=u.id,tn()}),l.appendChild(f)}r.appendChild(l);let c=M("div","v-xray-body");r.appendChild(c);let d=M("div","v-xray-status","starting");return r.appendChild(d),e.appendChild(r),document.body.appendChild(e),{root:e,overlay:t,card:n,panel:r,tabs:l,body:c,status:d}}var Tx=["click","dblclick","submit","input","change","keydown","keyup","focus","blur","contextmenu","drop","paste"];function Gp(e){Er.push(e),Er.length>Qp&&Er.shift(),nt==="eventos"&&tn()}function pc(e){Tr.push(e),Tr.length>Qp&&Tr.shift(),nt==="rede"&&tn()}function Lx(e,t){let n=e;for(let r=0;n&&r<6;r++){for(let o of In(n))if(o.name===t||o.name==="on"&&o.arg===t)return n;n=n.parentElement}return null}function Mx(){let e=new Set(Tx),t=document.body.querySelectorAll("*");for(let n=0;n<t.length;n++){let r=t[n];if(!(_&&_.root.contains(r)))for(let o of In(r))o.name==="on"&&o.arg&&e.add(o.arg)}return[...e]}function Sx(){let e=t=>{if(!Xe)return;let n=t.target;if(!n||n.nodeType!==1||Ms(n))return;let r=Lx(n,t.type),o=t.__voodoo===!0;!r&&!o||Gp({at:Date.now(),type:t.type,target:Sr(r!=null?r:n),detail:o?"component emit":"",source:o?"component":"v-on"})};for(let t of Mx())document.addEventListener(t,e,!0),kt.push(()=>document.removeEventListener(t,e,!0));kt.push(je.on("event",t=>{var n,r;Gp({at:Date.now(),type:t.type,target:Sr((n=t.el)!=null?n:null),detail:Jp(t.detail),source:(r=t.source)!=null?r:"bus"})}))}function Cx(){kt.push(he.interceptors.request.use(e=>(fc.set(e,performance.now()),e))),kt.push(he.interceptors.response.use(e=>{var n,r;let t=(n=fc.get(e.config))!=null?n:performance.now();return pc({at:Date.now(),method:((r=e.config.method)!=null?r:"GET").toUpperCase(),url:e.config.url,status:e.status,ok:e.ok,duration:performance.now()-t,source:"http"}),e})),kt.push(he.interceptors.error.use(e=>{var r,o,i;let t=e.config,n=t&&(r=fc.get(t))!=null?r:performance.now();return pc({at:Date.now(),method:((o=t==null?void 0:t.method)!=null?o:"GET").toUpperCase(),url:(i=t==null?void 0:t.url)!=null?i:"(unknown)",status:e.status,ok:!1,duration:performance.now()-n,source:"http"}),e})),kt.push(je.on("network",e=>{var t,n,r,o,i;pc({at:Date.now(),method:((t=e.method)!=null?t:"GET").toUpperCase(),url:e.url,status:(n=e.status)!=null?n:0,ok:(r=e.ok)!=null?r:!e.error,duration:(o=e.duration)!=null?o:0,source:(i=e.source)!=null?i:"bus"})}))}var kr=null;function Ax(){kr=new MutationObserver(e=>{let t=!1;for(let n of e){let r=n.target;Ms(r)||n.type==="attributes"&&n.attributeName==="class"&&r.nodeType===1&&Ts.has(r)||(we.mutations++,n.type==="childList"&&n.addedNodes.length&&(t=!0))}t&&!Lr&&(Lr=window.setTimeout(()=>{Lr=0,rm()},250))}),kr.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0})}function Rx(){Es=window.setInterval(()=>{we.effectsPerSecond=we.effects-vc,we.updatesPerSecond=we.mutations-hc,vc=we.effects,hc=we.mutations,we.history.push({effects:we.effectsPerSecond,updates:we.updatesPerSecond}),we.history.length>40&&we.history.shift(),nt==="desempenho"&&tn()},1e3),ks=window.setInterval(()=>{gc(),(nt==="estado"||nt==="componentes"||nt==="stores")&&tn()},700)}var vc=0,hc=0;function $x(){if(Xe||typeof document=="undefined"||!document.body)return;Xe=!0,ge(),oe("xray",rx),_=Ex(),nt=nt||"estado",we.effects=0,we.mutations=0,vc=0,hc=0,we.history.length=0,rm(),Sx(),Cx(),Ax(),Rx();let e=()=>ux();window.addEventListener("scroll",e,!0),window.addEventListener("resize",e),document.addEventListener("mousemove",Xp,!0),kt.push(()=>window.removeEventListener("scroll",e,!0)),kt.push(()=>window.removeEventListener("resize",e)),kt.push(()=>document.removeEventListener("mousemove",Xp,!0)),tn()}function sm(){if(Xe){Xe=!1;for(let e of kt.splice(0))try{e()}catch(t){}kr==null||kr.disconnect(),kr=null,Es&&window.clearInterval(Es),ks&&window.clearInterval(ks),Lr&&window.clearTimeout(Lr),Mr&&cancelAnimationFrame(Mr),Es=ks=Lr=Mr=0;for(let[e,t]of Mo)window.clearTimeout(t),e.classList.remove(So);Mo.clear(),Ts.clear(),sx(),Co.length=0,Lo=null,_==null||_.root.remove(),_=null}}function am(){return Xe}function Dx(e){let t=e.toLowerCase().split("+").map(o=>o.trim()).filter(Boolean);if(!t.length)return null;let n=t.pop(),r={ctrl:!1,alt:!1,shift:!1,meta:!1,code:/^f\d{1,2}$/.test(n)?n.toUpperCase():n.length===1&&n>="a"&&n<="z"?`Key${n.toUpperCase()}`:n.length===1&&n>="0"&&n<="9"?`Digit${n}`:n.charAt(0).toUpperCase()+n.slice(1)};for(let o of t)if(o==="ctrl"||o==="control")r.ctrl=!0;else if(o==="alt"||o==="option")r.alt=!0;else if(o==="shift")r.shift=!0;else if(o==="meta"||o==="cmd"||o==="command"||o==="win")r.meta=!0;else return null;return r}function bc(){Kp||typeof document=="undefined"||(Kp=!0,document.addEventListener("keydown",e=>{let t=w.xrayShortcut;if(t===!1)return;let n=Dx(typeof t=="string"?t:"ctrl+shift+f2");n&&(e.ctrlKey!==n.ctrl||e.altKey!==n.alt||e.shiftKey!==n.shift||e.metaKey!==n.meta||e.code!==n.code&&e.key.toUpperCase()!==n.code.replace(/^Key/,"")||(e.preventDefault(),Ao()))}))}function Ao(e){return bc(),(e!=null?e:!Xe)?$x():sm(),Xe}ue();ce();var Px=new Set(["SCRIPT","STYLE","PRE","CODE","SAMP","KBD","TEXTAREA","TEMPLATE","NOSCRIPT"]);N("$__jsx",e=>e);Td((e,t)=>{t?Ro():Ss(e)});var lm=Symbol("voodoo.jsx.template");function Hx(e){return typeof e=="object"&&e!==null&&lm in e}function Nx(e,t){var f;let n=[],r=[],o="",i=0,s=null,a=!1,l=e,c=t,d=!1,u=null;for(;l;){if(l.nodeType===Node.TEXT_NODE){let p=(f=l.textContent)!=null?f:"";for(;c<p.length;c++){let m=p[c];if(a){a=!1,o+=m;continue}if(s){m==="\\"?a=!0:m===s&&(s=null),o+=m;continue}if(m==='"'||m==="'"||m==="`"){s=m,o+=m;continue}if(m==="{"){i++,i>1&&(o+=m);continue}if(m==="}"){if(i--,i===0){c++,d=!0;break}o+=m;continue}o+=m}if(r.push(l),d){u={node:l,offset:c};break}}else if(l.nodeType===Node.ELEMENT_NODE){if(i===0)return null;o+=`$t(${n.length}, $__jsx)`,n.push(l),r.push(l)}else r.push(l);c=0,l=l.nextSibling}return d?{source:o,templates:n,nodes:r,tail:u}:null}function Ox(e){let t=e.source.match(/\(\s*\)/g);if(!t)return!1;let n=e.nodes[0],r=e.nodes[e.nodes.length-1],o=[r==null?void 0:r.nextSibling,n==null?void 0:n.previousSibling].map(l=>{var d;let c=l!=null?l:null;for(;c&&c.nodeType===Node.TEXT_NODE&&!((d=c.textContent)!=null?d:"").trim();)c=c===(r==null?void 0:r.nextSibling)?c.nextSibling:c.previousSibling;return c&&c.nodeType===Node.ELEMENT_NODE?c:null}).find(l=>(l==null?void 0:l.tagName)==="TABLE");if(!o)return!1;let i=o.querySelector("tbody");if(!i)return!1;let s=Array.from(i.children).filter(l=>l.tagName==="TR");if(s.length!==t.length)return!1;let a=0;return e.source=e.source.replace(/\(\s*\)/g,()=>`($t(${a++}, $__jsx))`),e.templates=s,e.host=i,e.nodes.push(...s),!0}function cm(e,t,n,r){var o;if(!(e==null||e===!1||e===!0)){if(Array.isArray(e)){for(let i of e)cm(i,t,n,r);return}if(Hx(e)){let i=e,a=t[i.index].cloneNode(!0),l=(o=i.scope)!=null?o:n;xc(a,l),Ro(),te(a,l),r.push(a);return}r.push(document.createTextNode(String(e)))}}function xc(e,t){var o,i,s;if(Px.has(e.tagName))return;let n=t!=null?t:Ce(e),r=e.firstChild;for(;r;){let a=r.nextSibling;if(r.nodeType===Node.ELEMENT_NODE){xc(r,(o=ot(r))!=null?o:n),r=a;continue}if(r.nodeType!==Node.TEXT_NODE){r=a;continue}let c=((i=r.textContent)!=null?i:"").indexOf("{");if(c<0){r=a;continue}let d=Nx(r,c);if(!d){r=a;continue}if(d.templates.length===0&&!Ox(d)){r=a;continue}Fx(e,d,n),r=(s=d.nodes[d.nodes.length-1])==null?void 0:s.nextSibling}}var yc=[];function Fx(e,t,n){var f,p;let{source:r,templates:o,nodes:i,tail:s}=t,a;try{a=ze(r)}catch(m){w.devtools&&console.warn(`[Voodoo] could not parse the inline expression: ${r}`,m);return}s&&s.offset<((f=s.node.textContent)!=null?f:"").length&&s.node.splitText(s.offset);let l=(p=t.host)!=null?p:e,c=document.createComment("v-jsx");l.insertBefore(c,t.host?t.host.firstChild:i[0]);for(let m of i)m.remove();let d=[];yc.push(()=>u());function u(){let m=Ce(c),v=(m===Ke&&n?n:m).child({$t:(b,x)=>({[lm]:!0,index:b,scope:x})}),g=De(()=>{let b=jo(P(a,v)),x=[];cm(b,o,v,x);for(let T of d)T.remove();d=x;for(let T of x)l.insertBefore(T,c)});Be(c,()=>{g.effect.stop();for(let b of d)b.remove()})}}function Ix(e=document.body){var t;for(let n of Array.from(e.childNodes)){if(n.nodeType!==Node.TEXT_NODE)continue;let r=(t=n.textContent)!=null?t:"",o=r.indexOf("{");if(o<0)continue;let i=zx(r,o);if(i<0)continue;let s=r.slice(o,i+1);if(!/\b(?:const|let|var)\s/.test(s))continue;let a=s.slice(1,-1).replace(/\b(?:const|let|var)\s+/g,""),l=Y({});try{P(ze(a),new St(l))}catch(c){return w.devtools&&console.warn("[Voodoo] could not read the declaration block",c),null}return n.textContent=r.slice(0,o)+r.slice(i+1),l}return null}function zx(e,t){let n=0,r=null,o=!1;for(let i=t;i<e.length;i++){let s=e[i];if(o){o=!1;continue}if(r){s==="\\"?o=!0:s===r&&(r=null);continue}if(s==='"'||s==="'"||s==="`")r=s;else if(s==="{")n++;else if(s==="}"&&--n===0)return i}return-1}function Ro(){let e=yc.splice(0,yc.length);for(let t of e)try{t()}catch(n){console.error("[Voodoo] a JSX region failed to render",n)}}function Ss(e=document.body){let t=Ix(e);t&&Object.assign(Ke.data,t),xc(e,Ce(e))}function dm(e=document.body){Ss(e),Ro()}Ne();var fm="voodoo:devtools:widget-position",wc="voodoo:devtools:widget-hidden",Bx=4,re=null,Cr=!1,kc=0,Cs=0,$o=[],jx=`
.v-devtools-widget{
  all: initial;
  --vw-accent:#6D3BF5;
  --vw-accent-2:#FF3D8B;
...
`,qx=`<svg class="v-devtools-mark" viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
</svg>`;function Vx(){try{let e=localStorage.getItem(fm);if(!e)return null;let t=JSON.parse(e);return typeof(t==null?void 0:t.x)!="number"||typeof(t==null?void 0:t.y)!="number"?null:t}catch(e){return null}}function Ux(e){try{localStorage.setItem(fm,JSON.stringify(e))}catch(t){}}function Ec(e,t){let n=e.offsetWidth||120,r=e.offsetHeight||38,o=Math.min(Math.max(8,t.x),Math.max(8,window.innerWidth-n-8)),i=Math.min(Math.max(8,t.y),Math.max(8,window.innerHeight-r-8));e.style.left=`${o}px`,e.style.top=`${i}px`,e.style.right="auto",e.style.bottom="auto"}function _x(){let e=document.createElement("div");e.className="v-devtools-widget",e.setAttribute("data-voodoo-devtools","widget");let t=document.createElement("button");t.type="button",t.className="v-devtools-btn",t.setAttribute("aria-label","Open Voodoo devtools (Ctrl+Shift+F2)"),t.setAttribute("aria-pressed","false"),t.title="Voodoo devtools \u2014 click to inspect, drag to move (Ctrl+Shift+F2)",t.innerHTML=qx;let n=document.createElement("span");n.className="v-devtools-label",n.textContent="Voodoo";let r=document.createElement("span");r.className="v-devtools-count",r.textContent="0";let o=document.createElement("span");o.className="v-devtools-pulse",o.setAttribute("data-on","false"),t.append(n,r,o);let i=document.createElement("button");i.type="button",i.className="v-devtools-close",i.setAttribute("aria-label","Hide the devtools widget in this tab"),i.title="Hide in this tab",i.textContent="\xD7",e.append(t,i),document.body.appendChild(e);let s=Vx();return s?Ec(e,s):(e.style.right="16px",e.style.bottom="16px"),{root:e,button:t,pulse:o,counter:r,close:i}}function Wx(e,t){let n=!1,r=!1,o=0,i=0,s=0,a=0,l=p=>{var h,v;if(p.button!==0)return;let m=e.root.getBoundingClientRect();n=!0,r=!1,s=p.clientX,a=p.clientY,o=p.clientX-m.left,i=p.clientY-m.top,(v=(h=e.button).setPointerCapture)==null||v.call(h,p.pointerId)},c=p=>{if(!n)return;let m=Math.hypot(p.clientX-s,p.clientY-a);!r&&m<Bx||(r=!0,p.preventDefault(),Ec(e.root,{x:p.clientX-o,y:p.clientY-i}))},d=p=>{var h,v;if(!n)return;if(n=!1,(v=(h=e.button).releasePointerCapture)==null||v.call(h,p.pointerId),!r){t();return}let m=e.root.getBoundingClientRect();Ux({x:m.left,y:m.top})},u=p=>{p.key!=="Enter"&&p.key!==" "||(p.preventDefault(),t())},f=()=>{let p=e.root.getBoundingClientRect();e.root.style.left&&Ec(e.root,{x:p.left,y:p.top})};return e.button.addEventListener("pointerdown",l),e.button.addEventListener("pointermove",c),e.button.addEventListener("pointerup",d),e.button.addEventListener("pointercancel",d),e.button.addEventListener("keydown",u),window.addEventListener("resize",f),()=>{e.button.removeEventListener("pointerdown",l),e.button.removeEventListener("pointermove",c),e.button.removeEventListener("pointerup",d),e.button.removeEventListener("pointercancel",d),e.button.removeEventListener("keydown",u),window.removeEventListener("resize",f)}}function Kx(){re&&(re.pulse.setAttribute("data-on","true"),window.clearTimeout(Cs),Cs=window.setTimeout(()=>{re==null||re.pulse.setAttribute("data-on","false")},320))}function um(){if(!re)return;let e=Rt.size,t=e===1?"1 component":`${e} components`;re.counter.textContent!==t&&(re.counter.textContent=t)}function Yx(){if(Cr||typeof document=="undefined"||!document.body)return;try{if(sessionStorage.getItem(wc)==="1")return}catch(r){}Cr=!0,oe("devtools-widget",jx),re=_x();let e=()=>{let r=Ao();re==null||re.root.setAttribute("data-active",String(r)),re==null||re.button.setAttribute("aria-pressed",String(r))};$o.push(Wx(re,e));let t=r=>{r.stopPropagation();try{sessionStorage.setItem(wc,"1")}catch(o){}pm(),console.info("[Voodoo] devtools widget hidden. Use V.devtoolsWidget(true) to bring back.")};re.close.addEventListener("click",t),$o.push(()=>re==null?void 0:re.close.removeEventListener("click",t));let n=()=>{let r=am();re==null||re.root.setAttribute("data-active",String(r)),re==null||re.button.setAttribute("aria-pressed",String(r))};document.addEventListener("keyup",n),$o.push(()=>document.removeEventListener("keyup",n));for(let r of["network","event","navigation","update"])$o.push(je.on(r,Kx));um(),kc=window.setInterval(um,1e3)}function pm(){if(Cr){Cr=!1;for(let e of $o.splice(0))try{e()}catch(t){}window.clearInterval(kc),window.clearTimeout(Cs),kc=0,Cs=0,re==null||re.root.remove(),re=null}}function mm(e){if(e!=null?e:!Cr){try{sessionStorage.removeItem(wc)}catch(n){}Yx()}else pm();return Cr}var hm=((e,t)=>Na(e,t));function vm(e,t,n){return((...r)=>(Nr(e,t),n(...r)))}Object.assign(hm,bi,{query:Na,ready:Oa,fromHtml:Hu,jsx:dm,extractJsx:Ss,activateJsx:Ro,Collection:vt,router:Gr,route:de,navigate:Kt,resolveRoute:tr,i18n:Jr,t:ir,setLocale:Qr,getLocale:Ri,modal:Mn,alert:cc,confirm:bs,prompt:dc,dialog:wr,validator:J,validate:gl,validateForm:vm("V.validateForm","V.validate",gl),serializeForm:cr,messages:at,showFormErrors:_i,showFieldError:Ui,clearErrors:ao,mask:Up,masks:To,applyMask:Eo,unmask:ws,registerMask:Le,animate:Nt,spring:Il,stagger:zl,inView:as,scrollProgress:Bl,motion:xn,easings:po,chart:vm("V.chart","V.renderChart",hr),renderChart:hr,charts:Wl,chartColors:vo,palette:$p,hotkey:no,sound:Jt,xray:Ao,enableXrayShortcut:bc,devtoolsWidget:mm,devtools:je,magic:N});var Tc=hm;ce();function Xx(e){if(window.VOODOO_DEVTOOLS===!0)return!0;for(let t of["devtools","data-devtools"]){if(!e.hasAttribute(t))continue;let n=e.getAttribute(t);return n===null||n===""||n.toLowerCase()!=="false"}return!1}function Gx(){var s;if(typeof document=="undefined")return{manual:!1};let e=(s=document.currentScript)!=null?s:document.querySelector('script[src*="voodoo"]');if(!e)return{manual:!1};let t=e.hasAttribute("data-manual")||e.hasAttribute("data-defer-init"),n=e.getAttribute("data-prefix");n&&(w.prefix=n);let r=e.getAttribute("data-base-url");r&&(w.baseURL=r);let o=e.getAttribute("data-locale");o&&(w.locale=o),Xx(e)&&(w.devtools=!0);let i=e.getAttribute("data-xray-shortcut");return i!==null&&(w.xrayShortcut=i==="false"||i===""?!1:i),e.hasAttribute("data-no-styles")&&(w.injectStyles=!1),e.hasAttribute("data-no-observer")&&(w.autoDiscover=!1),e.hasAttribute("data-keep-attributes")&&(w.cleanAttributes=!1),{manual:t}}function Qx(e){if(typeof e.devtoolsWidget=="function"){e.devtoolsWidget(!0);return}console.info("[Voodoo] devtools requested, but this build does not include the inspector. Use voodoo.full.min.js to get the widget and full devtools panel.")}function gm(e){var o;if(typeof window=="undefined")return;let t=Gx(),n=window;if(n.V=e,n.Voodoo=e,Oe.V=e,Oe.Voodoo=e,w.baseURL&&((o=e.http)!=null&&o.setBaseURL)&&e.http.setBaseURL(w.baseURL),t.manual||!w.autoStart)return;Qo(()=>{mt.init(),Rp(),e.start(),typeof e.enableXrayShortcut=="function"&&e.enableXrayShortcut(),w.devtools&&Qx(e)})}gm(Tc);var Jx=Tc;return Am(Zx);})();
