...
`});var dx={};So(dx,{default:()=>cx});be();var de=class extends Error{constructor(n,r,o){let i=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${i}`);H(this,"source",r);H(this,"position",o);this.name="VoodooSyntaxError"}},dm=[">>>=","===","!==","**=","...","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","+","-","*","/","%","!","<",">","=","(",")","[","]","{","}",",",".","?",":",";"],um=/[A-Za-z_$À-￿]/,fm=/[A-Za-z0-9_$À-￿]/;function pm(e){return um.test(e)}function mm(e){return fm.test(e)}function Ho(e){return e>="0"&&e<="9"}var Sc={n:`
...
`,ap=!1;function ny(){ap||(ap=!0,he(),vo(),ne("components",ty))}function re(e,t){var r;let n=t.beforeMount;t.methods={svgIcon:o=>ey(o),hasFlag:o=>ee(o),...(r=t.methods)!=null?r:{}},t.beforeMount=function(){ny(),n==null||n.call(this)},Ft(e,t)}re("v-button",{props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},icon:L,iconRight:L,type:{type:"string",default:"button"},loading:N,disabled:N,block:N,rounded:N,ariaLabel:L},computed:{...ge("loading","disabled","block","rounded"),blocked(){return ee(this.disabled)||ee(this.loading)}},template:`
  ...
  `});var oy={info:"info",primary:"info",success:"check",warning:"warning",danger:"alert",neutral:"info"};re("v-alert",{props:{tone:{type:"string",default:"info"},title:L,icon:L,closable:N,closeLabel:{type:"string",default:"Close alert"}},state(){return{visible:!0}},computed:{...ge("closable"),resolvedIcon(){return this.icon==="none"?"":this.icon||oy[this.tone]||"info"},liveRole(){return this.tone==="danger"?"alert":"status"}},methods:{dismiss(){this.visible=!1,this.emit("close")}},template:`
  ...
  `});function sy(e){return Array.isArray(e)?e.map(t=>{var n,r,o,i,s,a;if(t!=null&&typeof t=="object"){let l=t;return{label:String((o=(r=(n=l.label)!=null?n:l.text)!=null?r:l.title)!=null?o:""),href:String((a=(s=(i=l.href)!=null?i:l.url)!=null?s:l.to)!=null?a:"")}}return{label:String(t),href:""}}):typeof e!="string"?[]:go(e).map(t=>{let n=t.indexOf(":");return n===-1?{label:t,href:""}:{label:t.slice(0,n).trim(),href:t.slice(n+1).trim()}})}re("v-breadcrumb",{inheritScope:!0,props:{items:{type:"any",default:""},separator:{type:"string",default:"/"},ariaLabel:{type:"string",default:"Trilha de navega\xE7\xE3o"}},computed:{crumbs(){var e;return sy((e=vr(this,this.items))!=null?e:this.items)}},methods:{isLast(e){return e===this.crumbs.length-1}},template:`
  ...
  `});async function ly(e){try{if(typeof navigator!="undefined"&&navigator.clipboard)return await navigator.clipboard.writeText(e),!0}catch(t){}try{let t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();let n=document.execCommand("copy");return t.remove(),n}catch(t){return!1}}re("v-code-block",{props:{code:L,language:L,filename:L,copyLabel:{type:"string",default:"Copiar"},copiedLabel:{type:"string",default:"Copiado"},wrap:N},state(){return{copied:!1}},computed:{...ge("wrap"),header(){return this.filename||this.language||""},buttonLabel(){return this.copied?this.copiedLabel:this.copyLabel},buttonIcon(){return this.copied?"check":"copy"}},methods:{async copy(){let e=this.$refs.code,t=this.code||(e==null?void 0:e.textContent)||"";await ly(String(t))&&(this.copied=!0,this.emit("copy",t),setTimeout(()=>{this.copied=!1},1800))}},template:`
  ...
  `});var V1=Object.keys(cp);He();le();var it={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},jl={duration:220,size:"md"},cy=`
...
`;function ss(){he(),vo(),ne("dialog",cy)}var ql={info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.6v.2"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m8.2 12.3 2.6 2.6 5-5.2"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4.6 2.9 19.4h18.2z"/><path d="M12 10v4M12 17.2v.2"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/></svg>',question:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M9.6 9.4a2.4 2.4 0 1 1 3.2 2.3c-.6.2-.8.7-.8 1.3v.5M12 16.6v.2"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg>'},Je=[],Vl=new WeakMap,Ul=0,dp="",up="";function dy(){if(Ul++>0)return;let e=document.body;dp=e.style.overflow,up=e.style.paddingRight;let t=window.innerWidth-document.documentElement.clientWidth;if(e.style.overflow="hidden",t>0){let n=parseFloat(getComputedStyle(e).paddingRight)||0;e.style.paddingRight=`${n+t}px`}}function uy(){Ul!==0&&(--Ul>0||(document.body.style.overflow=dp,document.body.style.paddingRight=up))}var fy='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function Wl(e){return Array.from(e.querySelectorAll(fy)).filter(t=>t.hasAttribute("disabled")||t.getAttribute("aria-hidden")==="true"?!1:t.offsetWidth>0||t.offsetHeight>0||t.getClientRects().length>0)}function _l(){return Je[Je.length-1]}function py(){return typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches}var is=!1;function fp(e){let t=_l();if(!t)return;if(e.key==="Escape"){if(t.options.closeOnEscape===!1)return;e.preventDefault(),t.handle.close(void 0);return}if(e.key!=="Tab")return;let n=Wl(t.handle.panel);if(!n.length){e.preventDefault(),t.handle.panel.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;e.shiftKey&&(i===r||!t.handle.panel.contains(i))?(e.preventDefault(),o.focus()):!e.shiftKey&&i===o&&(e.preventDefault(),r.focus())}function pp(e){var o;let t=_l();if(!t)return;let n=e.target;if(n&&t.handle.root.contains(n))return;((o=Wl(t.handle.panel)[0])!=null?o:t.handle.panel).focus()}function my(){is||(is=!0,document.addEventListener("keydown",fp,!0),document.addEventListener("focusin",pp,!0))}function vy(){is&&(is=!1,document.removeEventListener("keydown",fp,!0),document.removeEventListener("focusin",pp,!0))}function mp(e){var p,f,m,h,v,g,b;ss();let t=ae("v-dialog-"),n=py()?0:jl.duration,r=document.createElement("div");r.className="v-dialog-root",r.id=t,r.setAttribute("data-size",(p=e.size)!=null?p:jl.size),r.setAttribute("data-position",(f=e.position)!=null?f:"center"),r.style.setProperty("--v-dialog-ms",`${n}ms`),r.style.setProperty("--v-dialog-layer",String(Je.length*2));let o=document.createElement("div");o.className="v-dialog-backdrop",r.appendChild(o);let i=document.createElement("div");i.className="v-dialog-panel",e.plain&&i.classList.add("is-plain"),e.className&&i.classList.add(...e.className.split(/\s+/).filter(Boolean)),i.setAttribute("role",(m=e.role)!=null?m:"dialog"),i.setAttribute("aria-modal","true"),i.tabIndex=-1,e.labelledBy?i.setAttribute("aria-labelledby",e.labelledBy):e.ariaLabel&&i.setAttribute("aria-label",e.ariaLabel),e.describedBy&&i.setAttribute("aria-describedby",e.describedBy),r.appendChild(i);let s=document.createElement("div");if(s.className="v-dialog-body",e.source){let x=document.createComment(" v-modal ");(h=e.source.parentNode)==null||h.insertBefore(x,e.source),zl.set(e.source,x),e.source.classList.add("v-dialog-open"),e.source.removeAttribute("hidden"),s.appendChild(e.source)}else e.content&&s.appendChild(e.content);if(i.appendChild(s),e.closable!==!1){let x=document.createElement("button");x.type="button",x.className="v-dialog-x",x.setAttribute("aria-label",it.close),x.innerHTML=ql.close,x.addEventListener("click",()=>d.close(void 0)),i.appendChild(x)}let a=!1,l=()=>{},c=new Promise(x=>{l=x}),d={id:t,root:r,panel:i,body:s,key:(v=e.key)!=null?v:null,source:(g=e.source)!=null?g:null,closed:c,close(x){if(a)return;a=!0;let T=Je.findIndex(A=>A.handle===d);T>-1&&Je.splice(T,1),Vl.delete(r),u.locked&&uy(),Je.length||vy(),r.classList.remove("is-open"),r.classList.add("is-closing");let k=()=>{var D;let A=e.source;if(A){let C=zl.get(A);A.classList.remove("v-dialog-open"),C&&C.parentNode?(C.parentNode.insertBefore(A,C),C.remove()):A.remove(),zl.delete(A),Ks(A,"modal-content")&&A.setAttribute("hidden","")}if(r.remove(),(D=e.onClose)==null||D.call(e,x,d),l(x),e.restoreFocus!==!1){let C=u.previousFocus;C&&typeof C.focus=="function"&&C.isConnected&&C.focus()}};n>0?setTimeout(k,n):k()}},u={handle:d,options:e,previousFocus:document.activeElement,locked:e.lockScroll!==!1};return o.addEventListener("click",()=>{e.closeOnBackdrop!==!1&&d.close(void 0)}),u.locked&&dy(),Je.push(u),Vl.set(r,u),my(),document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add("is-open");let x=hy(e,i);x==null||x.focus()}),(b=e.onOpen)==null||b.call(e,d),d}var zl=new WeakMap;function hy(e,t){var i;let n=e.initialFocus;if(n instanceof HTMLElement)return n;if(typeof n=="string"){let s=t.querySelector(n);if(s)return s}let r=t.querySelector("[autofocus],[data-autofocus]");return r||((i=Wl(t)[0])!=null?i:t)}function gy(e){if(e instanceof HTMLElement)return e;let t=String(e!=null?e:"").trim();if(!t)return null;let n=/^[\w-]+$/.test(t)?`#${t}`:t;return document.querySelector(n)}function rs(e){return typeof e=="string"?e.trim()||null:e.id?`#${e.id}`:null}function os(e){let t=/^[\w-]+$/.test(e)?`#${e}`:e;return Je.find(n=>{var o;if(n.handle.key===e||n.handle.key===t)return!0;let r=n.handle.source;return!!r&&((o=r.matches)==null?void 0:o.call(r,t))})}var En={open(e,t={}){var s,a;let n=gy(e);if(!n)return console.warn(`[Voodoo] modal.open: target not found (${String(e)}).`),null;let r=(s=rs(e))!=null?s:n.id?`#${n.id}`:null,o=r?os(r):void 0;if(o)return o.handle;let i=n.querySelector("[data-dialog-title],h1,h2,h3");return i&&!i.id&&(i.id=ae("v-dialog-title-")),mp({...t,source:n,key:r,labelledBy:(a=i==null?void 0:i.id)!=null?a:null})},close(e,t){var o;if(e===void 0){(o=_l())==null||o.handle.close(t);return}let n=rs(e),r=n?os(n):void 0;r==null||r.handle.close(t)},closeAll(e){for(let t of[...Je].reverse())t.handle.close(e)},toggle(e,t={}){let n=rs(e),r=n?os(n):void 0;return r?(r.handle.close(void 0),null):this.open(e,t)},isOpen(e){if(e===void 0)return Je.length>0;let t=rs(e);return!!(t&&os(t))},get opened(){return Je.map(e=>e.handle)},get count(){return Je.length},configure(e){Object.assign(jl,e)},labels(e){return Object.assign(it,e),it}};function hr(e){var a,l;ss();let t=document.createDocumentFragment(),n=e.title?ae("v-dialog-title-"):null,r=e.description?ae("v-dialog-desc-"):null,o=null;if(e.title||e.description||e.icon){o=document.createElement("div"),o.className="v-dialog-head";let c=e.icon&&e.icon!=="none"?e.icon:null;if(c&&ql[c]){let u=document.createElement("div");u.className="v-dialog-icon",u.setAttribute("aria-hidden","true"),u.setAttribute("data-tone",(a=e.tone)!=null?a:by(c)),u.innerHTML=ql[c],o.appendChild(u)}let d=document.createElement("div");if(d.className="v-dialog-heading",e.title){let u=document.createElement("h2");u.className="v-dialog-title",u.id=n,u.textContent=e.title,d.appendChild(u)}if(e.description){let u=document.createElement("p");u.className="v-dialog-desc",u.id=r,u.textContent=e.description,d.appendChild(u)}o.appendChild(d)}let i=document.createDocumentFragment();if(e.text)for(let c of e.text.split(`
...
`,Zy=`<svg class="v-devtools-mark" viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
</svg>`;function ex(){try{let e=localStorage.getItem(Ip);if(!e)return null;let t=JSON.parse(e);return typeof(t==null?void 0:t.x)!="number"||typeof(t==null?void 0:t.y)!="number"?null:t}catch(e){return null}}function tx(e){try{localStorage.setItem(Ip,JSON.stringify(e))}catch(t){}}function ic(e,t){let n=e.offsetWidth||120,r=e.offsetHeight||38,o=Math.min(Math.max(8,t.x),Math.max(8,window.innerWidth-n-8)),i=Math.min(Math.max(8,t.y),Math.max(8,window.innerHeight-r-8));e.style.left=`${o}px`,e.style.top=`${i}px`,e.style.right="auto",e.style.bottom="auto"}function nx(){let e=document.createElement("div");e.className="v-devtools-widget",e.setAttribute("data-voodoo-devtools","widget");let t=document.createElement("button");t.type="button",t.className="v-devtools-btn",t.setAttribute("aria-label","Open Voodoo devtools (Ctrl+Shift+X)"),t.setAttribute("aria-pressed","false"),t.title="Voodoo devtools \u2014 click to inspect, drag to move (Ctrl+Shift+X)",t.innerHTML=Zy;let n=document.createElement("span");n.className="v-devtools-label",n.textContent="Voodoo";let r=document.createElement("span");r.className="v-devtools-count",r.textContent="0";let o=document.createElement("span");o.className="v-devtools-pulse",o.setAttribute("data-on","false"),t.append(n,r,o);let i=document.createElement("button");i.type="button",i.className="v-devtools-close",i.setAttribute("aria-label","Hide the devtools widget in this tab"),i.title="Hide in this tab",i.textContent="\xD7",e.append(t,i),document.body.appendChild(e);let s=ex();return s?ic(e,s):(e.style.right="16px",e.style.bottom="16px"),{raiz:e,botao:t,pulso:o,contador:r,fechar:i}}function rx(e,t){let n=!1,r=!1,o=0,i=0,s=0,a=0,l=f=>{var h,v;if(f.button!==0)return;let m=e.raiz.getBoundingClientRect();n=!0,r=!1,s=f.clientX,a=f.clientY,o=f.clientX-m.left,i=f.clientY-m.top,(v=(h=e.botao).setPointerCapture)==null||v.call(h,f.pointerId)},c=f=>{if(!n)return;let m=Math.hypot(f.clientX-s,f.clientY-a);!r&&m<Qy||(r=!0,f.preventDefault(),ic(e.raiz,{x:f.clientX-o,y:f.clientY-i}))},d=f=>{var h,v;if(!n)return;if(n=!1,(v=(h=e.botao).releasePointerCapture)==null||v.call(h,f.pointerId),!r){t();return}let m=e.raiz.getBoundingClientRect();tx({x:m.left,y:m.top})},u=f=>{f.key!=="Enter"&&f.key!==" "||(f.preventDefault(),t())},p=()=>{let f=e.raiz.getBoundingClientRect();e.raiz.style.left&&ic(e.raiz,{x:f.left,y:f.top})};return e.botao.addEventListener("pointerdown",l),e.botao.addEventListener("pointermove",c),e.botao.addEventListener("pointerup",d),e.botao.addEventListener("pointercancel",d),e.botao.addEventListener("keydown",u),window.addEventListener("resize",p),()=>{e.botao.removeEventListener("pointerdown",l),e.botao.removeEventListener("pointermove",c),e.botao.removeEventListener("pointerup",d),e.botao.removeEventListener("pointercancel",d),e.botao.removeEventListener("keydown",u),window.removeEventListener("resize",p)}}function ox(){te&&(te.pulso.setAttribute("data-on","true"),window.clearTimeout(hs),hs=window.setTimeout(()=>{te==null||te.pulso.setAttribute("data-on","false")},320))}function Fp(){if(!te)return;let e=Mt.size,t=e===1?"1 component":`${e} components`;te.contador.textContent!==t&&(te.contador.textContent=t)}function ix(){if(kr||typeof document=="undefined"||!document.body)return;try{if(sessionStorage.getItem(rc)==="1")return}catch(r){}kr=!0,ne("devtools-widget",Jy),te=nx();let e=()=>{let r=To();te==null||te.raiz.setAttribute("data-active",String(r)),te==null||te.botao.setAttribute("aria-pressed",String(r))};Lo.push(rx(te,e));let t=r=>{r.stopPropagation();try{sessionStorage.setItem(rc,"1")}catch(o){}zp(),console.info("[Voodoo] devtools widget hidden. Use V.devtoolsWidget(true) to bring back.")};te.fechar.addEventListener("click",t),Lo.push(()=>te==null?void 0:te.fechar.removeEventListener("click",t));let n=()=>{let r=Np();te==null||te.raiz.setAttribute("data-active",String(r)),te==null||te.botao.setAttribute("aria-pressed",String(r))};document.addEventListener("keyup",n),Lo.push(()=>document.removeEventListener("keyup",n));for(let r of["network","event","navigation","update"])Lo.push(Fe.on(r,ox));Fp(),oc=window.setInterval(Fp,1e3)}function zp(){if(kr){kr=!1;for(let e of Lo.splice(0))try{e()}catch(t){}window.clearInterval(oc),window.clearTimeout(hs),oc=0,hs=0,te==null||te.raiz.remove(),te=null}}function Bp(e){if(e!=null?e:!kr){try{sessionStorage.removeItem(rc)}catch(n){}ix()}else zp();return kr}var qp=((e,t)=>wa(e,t));function jp(e,t,n){return((...r)=>(Rr(e,t),n(...r)))}Object.assign(qp,li,{query:wa,ready:Ea,fromHtml:cu,Collection:ft,router:Wr,route:ce,navigate:Vt,resolveRoute:Gn,i18n:Kr,t:er,setLocale:_r,getLocale:yi,modal:En,alert:Kl,confirm:as,prompt:Yl,dialog:hr,validator:Q,validate:tl,validateForm:jp("V.validateForm","V.validate",tl),serializeForm:or,messages:rt,showFormErrors:Pi,showFieldError:Hi,clearErrors:no,mask:yp,masks:yo,applyMask:bo,unmask:ds,registerMask:Te,animate:Rt,spring:El,stagger:kl,inView:Gi,scrollProgress:Tl,motion:hn,easings:ao,chart:jp("V.chart","V.renderChart",ur),renderChart:ur,charts:Rl,chartColors:co,palette:sp,hotkey:Qr,sound:Yt,xray:To,enableXrayShortcut:nc,devtoolsWidget:Bp,devtools:Fe,magic:P});var sc=qp;le();function sx(e){if(window.VOODOO_DEVTOOLS===!0)return!0;for(let t of["devtools","data-devtools"]){if(!e.hasAttribute(t))continue;let n=e.getAttribute(t);return n===null||n===""||n.toLowerCase()!=="false"}return!1}function ax(){var i;if(typeof document=="undefined")return{manual:!1};let e=(i=document.currentScript)!=null?i:document.querySelector('script[src*="voodoo"]');if(!e)return{manual:!1};let t=e.hasAttribute("data-manual")||e.hasAttribute("data-defer-init"),n=e.getAttribute("data-prefix");n&&(w.prefix=n);let r=e.getAttribute("data-base-url");r&&(w.baseURL=r);let o=e.getAttribute("data-locale");return o&&(w.locale=o),sx(e)&&(w.devtools=!0),e.hasAttribute("data-no-styles")&&(w.injectStyles=!1),e.hasAttribute("data-no-observer")&&(w.autoDiscover=!1),e.hasAttribute("data-keep-attributes")&&(w.cleanAttributes=!1),{manual:t}}function lx(e){if(typeof e.devtoolsWidget=="function"){e.devtoolsWidget(!0);return}console.info("[Voodoo] devtools requested, but this build does not include the inspector. Use voodoo.full.min.js to get the widget and full devtools panel.")}function Vp(e){var o;if(typeof window=="undefined")return;let t=ax(),n=window;if(n.V=e,n.Voodoo=e,Pe.V=e,Pe.Voodoo=e,w.baseURL&&((o=e.http)!=null&&o.setBaseURL)&&e.http.setBaseURL(w.baseURL),t.manual||!w.autoStart)return;Uo(()=>{ut.init(),ip(),e.start(),w.devtools&&lx(e)})}Vp(sc);var cx=sc;return tm(dx);})();
