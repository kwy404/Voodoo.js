...
`;
  ...
  var browser_essential_exports = {};
  __export(browser_essential_exports, {
    default: () => browser_essential_default
  });
  ...
  async function runRequest(options) {
    ...
    try {
      ...
      if (settings3.scrollTo) {
        (_c = document.querySelector(settings3.scrollTo)) == null ? void 0 : _c.scrollIntoView({ behavior: "smooth" });
      }
...
`;
  ...
  // src/browser-essential.ts
  bootstrap(essential_default);
  var browser_essential_default = essential_default;
  return __toCommonJS(browser_essential_exports);
})();
if(typeof window!=="undefined"){window.V=Voodoo.default||Voodoo;window.Voodoo=window.V;}
//# sourceMappingURL=voodoo.js.map