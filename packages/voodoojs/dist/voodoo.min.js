...
`;function $n(){se(),G("dnd",ef)}var sn=new Map,an=new Map;function xi(e,t){if(t&&t.trim())return t.trim();let n=e.closest("[data-v-dnd-group]");return(n==null?void 0:n.getAttribute("data-v-dnd-group"))||null}function ze(e){return Array.from(e.children).filter(t=>!t.classList.contains("v-drag-ghost"))}function tf(e,t){var n;return(n=e.getAttribute("data-id"))!=null?n:e.id||String(t)}function xc(e){return ze(e).map((t,n)=>tf(t,n))}function Tc(e){let t=getComputedStyle(e);return t.display.includes("flex")?t.flexDirection.startsWith("row"):t.display.includes("grid")?t.gridAutoFlow.startsWith("column"):!1}var k=null,On=0;function nf(e,t){let n=e.cloneNode(!0);n.classList.add("v-drag-ghost"),n.classList.remove("v-dragging","v-grabbed"),n.removeAttribute("id");for(let r of Array.from(n.querySelectorAll("[id]")))r.removeAttribute("id");return n.style.width=`${t.width}px`,n.style.height=`${t.height}px`,n.setAttribute("aria-hidden","true"),document.body.appendChild(n),n}function kc(e,t){if(!(k!=null&&k.ghost))return;let n=k.axis==="y"?k.lastX:e,r=k.axis==="x"?k.lastY:t;k.ghost.style.transform=`translate3d(${Math.round(n-k.grabX)}px, ${Math.round(r-k.grabY)}px, 0)`}function rf(e){let t=e;for(;t&&t!==document.body&&t!==document.documentElement;){let n=getComputedStyle(t),r=(n.overflowY==="auto"||n.overflowY==="scroll")&&t.scrollHeight>t.clientHeight+2,o=(n.overflowX==="auto"||n.overflowX==="scroll")&&t.scrollWidth>t.clientWidth+2;if(r||o)return t;t=t.parentElement}return null}function of(){if(!k)return;let e=56,t=16,n=k.lastX,r=k.lastY,o=document.elementFromPoint(n,r),i=rf(o!=null?o:k.overList);if(i){let s=i.getBoundingClientRect();r-s.top<e?i.scrollTop-=t:s.bottom-r<e&&(i.scrollTop+=t),n-s.left<e?i.scrollLeft-=t:s.right-n<e&&(i.scrollLeft+=t);return}r<e?window.scrollBy(0,-t):window.innerHeight-r<e&&window.scrollBy(0,t),n<e?window.scrollBy(-t,0):window.innerWidth-n<e&&window.scrollBy(t,0)}function sf(){let e=()=>{!k||k.keyboard||(of(),On=requestAnimationFrame(e))};On=requestAnimationFrame(e)}function af(){On&&cancelAnimationFrame(On),On=0}function Lc(e,t){let n=sn.get(e);return n?e===t.startList?!0:!n.group||!t.group?!1:n.group===t.group:!1}function Ti(e,t){return!(e.accept&&!t.item.matches(e.accept)||e.group&&e.group!==t.group)}function Ac(e,t){for(let n of an.values())n.el.classList.toggle("v-drop-active",t&&Ti(n,e));for(let n of sn.values())n.el.classList.toggle("v-drop-active",t&&Lc(n.el,e))}function cf(e,t,n,r){let o=Tc(e),i=null;for(let s of ze(e)){if(s===t)continue;let a=s.getBoundingClientRect(),c=o?a.left+a.width/2:a.top+a.height/2;if((o?n:r)<c){i=s;break}}if(i){(t.nextElementSibling!==i||t.parentElement!==e)&&e.insertBefore(t,i);return}e.lastElementChild!==t&&e.appendChild(t)}function ki(e,t){$n();let n=e.getBoundingClientRect(),r=t.mode==="sort"?e.parentElement:null;k={item:e,mode:t.mode,data:t.data,group:t.group,axis:t.axis,ghost:null,pointerId:t.pointerId,grabX:t.keyboard?n.width/2:t.x-n.left,grabY:t.keyboard?n.height/2:t.y-n.top,startParent:e.parentElement,startNext:e.nextSibling,startList:r,startIndex:r?ze(r).indexOf(e):-1,overDrop:null,overList:r,keyboard:!!t.keyboard,lastX:t.x,lastY:t.y},e.classList.add("v-dragging"),e.setAttribute("aria-grabbed","true"),t.keyboard?e.classList.add("v-grabbed"):(k.ghost=nf(e,n),kc(t.x,t.y),sf()),Ac(k,!0),document.addEventListener("keydown",Mc,!0),K(e,"voodoo:drag-start",{item:e,data:t.data,group:t.group})}function lf(e,t){var a,c,l;if(!k)return;k.lastX=e,k.lastY=t,kc(e,t);let n=document.elementFromPoint(e,t),r=(a=n==null?void 0:n.closest(".v-sortable"))!=null?a:null,o=(c=n==null?void 0:n.closest(".v-droppable"))!=null?c:null;k.mode==="sort"&&r&&Lc(r,k)?(k.overList&&k.overList!==r&&k.overList.classList.remove("v-drop-over"),k.overList=r,r.classList.add("v-drop-over"),cf(r,k.item,e,t)):k.overList&&!r&&k.overList.classList.remove("v-drop-over");let i=o?an.get(o):void 0,s=i?Ti(i,k):!1;k.overDrop&&k.overDrop!==o&&(k.overDrop.classList.remove("v-drop-over"),k.overDrop=null),o&&s&&(o.classList.add("v-drop-over"),k.overDrop=o),(l=k.ghost)==null||l.classList.toggle("v-drag-invalid",!!o&&!s)}function uf(e){e.startParent&&(e.startNext&&e.startNext.parentNode===e.startParent?e.startParent.insertBefore(e.item,e.startNext):e.startParent.appendChild(e.item))}function Sc(e){var t,n,r;(t=e.ghost)==null||t.remove(),e.item.classList.remove("v-dragging","v-grabbed"),e.item.setAttribute("aria-grabbed","false"),(n=e.overDrop)==null||n.classList.remove("v-drop-over"),(r=e.overList)==null||r.classList.remove("v-drop-over"),Ac(e,!1),af(),document.removeEventListener("keydown",Mc,!0),k=null}function Li(){var i;let e=k;if(!e)return;let t=e.item.parentElement,n=t?ze(t).indexOf(e.item):-1,r=e.overDrop,o=r?an.get(r):void 0;if(e.mode==="sort"&&t&&sn.has(t)&&(t!==e.startList||n!==e.startIndex)){let a={item:e.item,oldIndex:e.startIndex,newIndex:n,from:e.startList,to:t,order:xc(t)};K(t,"voodoo:sorted",a),e.startList&&e.startList!==t&&K(e.startList,"voodoo:sorted",{...a,order:xc(e.startList)}),ke(`Item moved to position ${n+1} of ${ze(t).length}`)}if(r&&o){let s={item:e.item,data:e.data,from:(i=e.startList)!=null?i:e.startParent,to:r,index:n},a=new CustomEvent("voodoo:drop",{detail:s,bubbles:!0});r.dispatchEvent(a),qe(o.expression,o.scope,r,a,s),ke("Item dropped in drop zone")}K(e.item,"voodoo:drag-end",{item:e.item,data:e.data}),Sc(e)}function Ei(){let e=k;e&&(uf(e),K(e.item,"voodoo:drag-cancel",{item:e.item}),ke("Drag canceled"),Sc(e))}function Mc(e){!k||e.key!=="Escape"||(e.preventDefault(),Ei())}function Cc(e,t,n){let r=null,o=-1,i=0,s=0,a=!1,c=f=>{if(f.pointerId===o){if(!a){if(Math.hypot(f.clientX-i,f.clientY-s)<4||!r)return;a=!0,ki(r,{mode:t.mode,data:t.data(),group:t.group(),axis:t.axis(),pointerId:o,x:i,y:s})}f.preventDefault(),lf(f.clientX,f.clientY)}},l=()=>{window.removeEventListener("pointermove",c),window.removeEventListener("pointerup",u),window.removeEventListener("pointercancel",d),r=null,o=-1,a=!1},u=f=>{f.pointerId===o&&(a&&Li(),l())},d=()=>{a&&Ei(),l()},p=f=>{if(f.button!==0||k)return;let m=f.target;if(!m||m.closest('input,textarea,select,option,[contenteditable="true"]')||t.handle&&!m.closest(t.handle))return;let v=t.itemFrom(m);v&&(r=v,o=f.pointerId,i=f.clientX,s=f.clientY,a=!1,window.addEventListener("pointermove",c,{passive:!1}),window.addEventListener("pointerup",u),window.addEventListener("pointercancel",d))};e.addEventListener("pointerdown",p),n(()=>{e.removeEventListener("pointerdown",p),a&&Ei(),l()})}function df(e){return e?Array.from(sn.values()).filter(t=>t.group===e).map(t=>t.el).sort((t,n)=>t.compareDocumentPosition(n)&Node.DOCUMENT_POSITION_FOLLOWING?-1:1):[]}function ff(e,t){if(!k)return!1;let n=e.parentElement;if(!n)return!1;let r=Tc(n),o=t==="ArrowDown"||r&&t==="ArrowRight",i=t==="ArrowUp"||r&&t==="ArrowLeft",s=ze(n),a=s.indexOf(e);if(o||i){let c=a+(o?1:-1);return c<0||c>=s.length?!1:(o?n.insertBefore(e,s[c].nextSibling):n.insertBefore(e,s[c]),ke(`Position ${c+1} of ${s.length}`),e.focus(),!0)}if(!r&&(t==="ArrowLeft"||t==="ArrowRight")){let c=df(k.group),l=c.indexOf(n);if(l===-1)return!1;let u=c[l+(t==="ArrowRight"?1:-1)];return u?(u.appendChild(e),ke(`Moved to list ${c.indexOf(u)+1} of ${c.length}`),e.focus(),!0):!1}return!1}function pf(e){return Array.from(an.values()).filter(t=>Ti(t,e)).map(t=>t.el)}b("dnd-group",({el:e,expression:t})=>{$n();let n=t.trim()||"default";e.setAttribute("data-v-dnd-group",n),e.classList.add("v-dnd-group")});b("sortable",({el:e,expression:t,cleanup:n})=>{$n(),e.classList.add("v-sortable");let r=j(e,"sortable-handle")||t.trim()||null,o={el:e,group:xi(e,j(e,"sortable-group")),handle:r};sn.set(e,o),e.hasAttribute("aria-label")||e.setAttribute("aria-label","Sortable list");let i=c=>{var l;c.hasAttribute("tabindex")||c.setAttribute("tabindex","0"),c.hasAttribute("aria-grabbed")||c.setAttribute("aria-grabbed","false"),r?(l=c.querySelector(r))==null||l.classList.add("v-drag-handle"):c.classList.add("v-drag-handle")};for(let c of ze(e))i(c);let s=typeof MutationObserver=="undefined"?null:new MutationObserver(()=>{for(let c of ze(e))i(c)});s==null||s.observe(e,{childList:!0}),Cc(e,{mode:"sort",handle:r,group:()=>o.group,data:()=>null,axis:()=>null,itemFrom:c=>{let l=ze(e).find(u=>u===c||u.contains(c));return l!=null?l:null}},n);let a=c=>{let l=c.target;if(!l)return;let u=ze(e).find(d=>d===l||d.contains(l));if(u){if(c.key===" "||c.key==="Spacebar"){if(c.preventDefault(),k&&k.item===u){Li(),ke("Item dropped");return}if(k)return;ki(u,{mode:"sort",data:null,group:o.group,axis:null,pointerId:-1,x:0,y:0,keyboard:!0}),ke("Item grabbed. Use arrow keys to move and space to drop.");return}!k||k.item!==u||c.key.startsWith("Arrow")&&ff(u,c.key)&&c.preventDefault()}};e.addEventListener("keydown",a),n(()=>{e.removeEventListener("keydown",a),s==null||s.disconnect(),sn.delete(e)})});$("sortable-group");$("sortable-handle");b("draggable",({el:e,expression:t,scope:n,cleanup:r})=>{var m;$n(),e.classList.add("v-draggable");let o=j(e,"draggable-handle")||null,i=(j(e,"draggable-axis")||"").trim().toLowerCase(),s=i==="x"||i==="y"?i:null,a=j(e,"draggable-data")||t.trim(),c=xi(e,j(e,"draggable-group"));o?(m=e.querySelector(o))==null||m.classList.add("v-drag-handle"):e.classList.add("v-drag-handle"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("aria-grabbed","false"),e.hasAttribute("aria-roledescription")||e.setAttribute("aria-roledescription","draggable item");let l=()=>a?O(a,n,"v-draggable-data"):null;Cc(e,{mode:"free",handle:o,group:()=>c,data:l,axis:()=>s,itemFrom:()=>e},r);let u=[],d=0,p=()=>{u.forEach((g,h)=>g.classList.toggle("v-drop-over",h===d));let v=u[d];!v||!k||(k.overDrop=v,te.reducedMotion?v.scrollIntoView({block:"nearest"}):v.scrollIntoView({block:"nearest",behavior:"smooth"}),ke(v.getAttribute("aria-label")||`Target ${d+1} of ${u.length}`))},f=v=>{if(v.key===" "||v.key==="Spacebar"){if(v.preventDefault(),k&&k.item===e){Li(),u=[];return}if(k)return;ki(e,{mode:"free",data:l(),group:c,axis:s,pointerId:-1,x:0,y:0,keyboard:!0}),u=k?pf(k):[],d=0,u.length?p():ke("No targets available");return}if(!(!k||k.item!==e||!u.length)){if(v.key==="ArrowDown"||v.key==="ArrowRight"){v.preventDefault(),d=(d+1)%u.length,p();return}(v.key==="ArrowUp"||v.key==="ArrowLeft")&&(v.preventDefault(),d=(d-1+u.length)%u.length,p())}};e.addEventListener("keydown",f),r(()=>{e.removeEventListener("keydown",f);for(let v of u)v.classList.remove("v-drop-over")})});$("draggable-handle");$("draggable-axis");$("draggable-data");$("draggable-group");b("droppable",({el:e,expression:t,scope:n,cleanup:r})=>{$n(),e.classList.add("v-droppable");let o={el:e,group:xi(e,j(e,"droppable-group")),accept:j(e,"droppable-accept"),expression:t,scope:n};an.set(e,o),e.hasAttribute("aria-dropeffect")||e.setAttribute("aria-dropeffect","move"),r(()=>{an.delete(e),e.classList.remove("v-drop-over","v-drop-active")})});$("droppable-accept");$("droppable-group");var mf=`
.v-visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;
  clip:rect(0 0 0 0);white-space:nowrap;border:0}
...
`;function Ur(){se(),G("forms-validate",qf)}function Xc(e){var r,o,i;let t=Ze(e,"error-target");if(t&&typeof document!="undefined"){let s=(i=(o=(r=e.form)!=null?r:e.closest("form"))==null?void 0:o.querySelector(t))!=null?i:document.querySelector(t);if(s)return{parent:s,anchor:null};Y(`Target for ${E.prefix}error-target not found: ${t}`)}let n=e.parentElement;return n?{parent:n,anchor:e}:null}function Jc(e){let t=Xc(e);if(!t)return null;if(t.anchor){let n=t.anchor.nextElementSibling;return n&&n.classList.contains("v-field-error")?n:null}return t.parent.querySelector(".v-field-error")}function _r(e,t){Ur(),e.classList.add("v-invalid"),e.classList.remove("v-valid"),e.setAttribute("aria-invalid","true");let n=Jc(e);if(!n){let o=Xc(e);if(!o)return;n=document.createElement("span"),n.className="v-field-error",n.id=e.id?`${e.id}-error`:ue("v-error-"),n.setAttribute("role","alert"),n.setAttribute("aria-live","polite"),o.anchor?o.anchor.insertAdjacentElement("afterend",n):o.parent.appendChild(n)}n.textContent=t;let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.push(n.id),e.setAttribute("aria-describedby",r.join(" "))}function Ni(e,t=!1){e.classList.remove("v-invalid"),e.classList.toggle("v-valid",t),e.removeAttribute("aria-invalid");let n=Jc(e);if(n){let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.length?e.setAttribute("aria-describedby",r.join(" ")):e.removeAttribute("aria-describedby"),n.remove()}}function zn(e){for(let n of Wr(e,!1))Ni(n);for(let n of Array.from(e.querySelectorAll(".v-field-error")))n.remove();let t=e.querySelector(".v-form-error");t&&t.remove();for(let n of Array.from(e.querySelectorAll(".v-invalid, .v-valid")))n.classList.remove("v-invalid","v-valid"),n.removeAttribute("aria-invalid")}function Ii(e){let t={};if(!e||typeof e!="object")return t;let n=e,r=n.errors&&typeof n.errors=="object"?n.errors:n;for(let[o,i]of Object.entries(r))o==="message"||o==="mensagem"||o==="errors"||(typeof i=="string"?t[o]=i:Array.isArray(i)&&typeof i[0]=="string"&&(t[o]=i[0]));return t}function zf(e,t){let n=t.replace(/\.(\w+)/g,"[$1]"),r=[t,n,`${t}[]`,`${n}[]`];for(let i of r){let s=e.querySelector(`[name="${Fr(i)}"]`);if(Le(s))return s}let o=e.querySelector(`#${Fr(t)}`);return Le(o)?o:null}function Vr(e,t){let n=Ii(t),r=[];for(let[o,i]of Object.entries(n)){let s=zf(e,o);s?_r(s,i):r.push(i)}return r.length&&Uf(e,r),n}function Uf(e,t){Ur();let n=e.querySelector(".v-form-error");if(n||(n=document.createElement("div"),n.className="v-form-error",n.setAttribute("role","alert"),e.prepend(n)),n.textContent="",t.length===1){n.textContent=t[0];return}let r=document.createElement("ul");for(let o of t){let i=document.createElement("li");i.textContent=o,r.appendChild(i)}n.appendChild(r)}function ji(e){let t=e.querySelector(".v-invalid");if(!t)return!1;try{t.focus({preventScroll:!0})}catch(r){t.focus()}let n=typeof window!="undefined"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;return typeof t.scrollIntoView=="function"&&t.scrollIntoView({block:"center",behavior:n?"auto":"smooth"}),!0}function Wr(e,t=!0){let n=e.tagName==="FORM"?Array.from(e.elements):Array.from(e.querySelectorAll("input, select, textarea")),r=[];for(let o of n)Le(o)&&(o.disabled||Sf.has(Ue(o))||t&&Fi(o).length===0||r.push(o));return r}async function Bi(e,t={}){var s,a;if(!Le(e))return{valid:!0};let n=Fi(e);if(!n.length)return t.silent||Ni(e),{valid:!0};let r=Bn(e),o=Ze(e,"error-message"),i=r.trim()==="";for(let c of n){if(i&&!jf.has(c.name))continue;let l=jr.get(c.name);if(!l)continue;let u;try{u=await l.fn(r,c.param||void 0,e)}catch(f){Y(`Rule "${c.name}" failed to execute`,f);continue}if(u===!0)continue;let d=o!=null?o:typeof u=="string"?u:(a=(s=Pe[c.name])!=null?s:l.message)!=null?a:Pe.invalid,p=Gc(d,{field:Mf(e),param:c.param,value:r});return t.silent||(_r(e,p),Qc(e,{valid:!1,message:p,rule:c.name})),{valid:!1,message:p,rule:c.name}}return t.silent||(Ni(e,!i),Qc(e,{valid:!0})),{valid:!0}}function qi(e){return Le(e)?Bi(e):zi(e)}async function zi(e){let t=Wr(e),n=await Promise.all(t.map(o=>Bi(o))),r={};return t.forEach((o,i)=>{var a;let s=n[i];s.valid||(r[$i(o)]=(a=s.message)!=null?a:Pe.invalid)}),{valid:Object.keys(r).length===0,errors:r}}function Qc(e,t){e.dispatchEvent(new CustomEvent("voodoo:field-validated",{bubbles:!0,detail:{field:$i(e),...t}}))}function _f(e){let t=e.indexOf("[");if(t===-1)return[e];let n=[e.slice(0,t)],r=/\[([^\]]*)\]/g,o;for(;(o=r.exec(e))!==null;)n.push(o[1]);return n}function Vf(e,t,n){let r=e;for(let o=0;o<t.length;o++){let i=t[o],s=o===t.length-1,a=t[o+1];if(i===""){if(!Array.isArray(r))return;if(s){r.push(n);return}let l=a===""?[]:{};r.push(l),r=l;continue}if(Array.isArray(r)){let l=Number(i);if(!Number.isInteger(l))return;if(s){r[l]=n;return}let u=r[l];(u==null||typeof u!="object")&&(u=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[l]=u),r=u;continue}if(s){r[i]=n;return}let c=r[i];(c==null||typeof c!="object")&&(c=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[i]=c),r=c}}function Wf(e,t){var a,c,l,u;let n=Wr(e,!1),r=[],o=new Map;for(let d of n)Ue(d)==="checkbox"&&d.name&&o.set(d.name,((a=o.get(d.name))!=null?a:0)+1);let i=t.trim!==!1,s=t.numbers!==!1;for(let d of n){if(!d.name||d.disabled&&!t.includeDisabled)continue;let p=Ue(d);if(p==="file"){let m=Array.from((c=d.files)!=null?c:[]);if(!m.length)continue;let v=d.multiple||d.name.endsWith("[]");r.push({name:d.name,value:v?m:m[0]});continue}if(p==="checkbox"){if(((l=o.get(d.name))!=null?l:1)>1||d.name.endsWith("[]")){if(!d.checked)continue;let v=d.name.endsWith("[]")?d.name:`${d.name}[]`;r.push({name:v,value:d.value||"on"})}else r.push({name:d.name,value:d.checked});continue}if(p==="radio"){if(!d.checked)continue;r.push({name:d.name,value:d.value});continue}if(d.tagName==="SELECT"&&d.multiple){let m=Array.from(d.selectedOptions).map(g=>g.value),v=d.name.endsWith("[]")?d.name:`${d.name}[]`;for(let g of m)r.push({name:v,value:g});continue}let f=(u=d.value)!=null?u:"";if(i&&typeof f=="string"&&(f=f.trim()),s&&(p==="number"||p==="range")&&f!==""){let m=Number(f);Number.isFinite(m)&&(f=m)}r.push({name:d.name,value:f})}return r}function Kf(e){for(let t of Wr(e,!1)){if(Ue(t)!=="file")continue;let n=t.files;if(n&&n.length)return!0}return!1}function Zc(e,t,n){if(n instanceof File||typeof Blob!="undefined"&&n instanceof Blob){e.append(t,n);return}if(Array.isArray(n)){let r=t.endsWith("[]")?t:`${t}[]`;for(let o of n)Zc(e,r,o);return}if(typeof n=="boolean"){e.append(t,n?"1":"0");return}e.append(t,n==null?"":String(n))}function ln(e,t={}){let n=Wf(e,t);if(t.formData||Kf(e)){let o=new FormData;for(let i of n)Zc(o,i.name,i.value);return o}let r={};for(let o of n)Vf(r,_f(o.name),o.value);return r}var In=new WeakSet,jn=new WeakSet;async function Ir(e){(await Bi(e)).valid?jn.delete(e):jn.add(e)}function Kr(e,t){if(!Le(e)){Y(`${E.prefix}validate only works on input, select, or textarea.`);return}if(In.has(e))return;In.add(e),Ur();let n=()=>{Ir(e)},r=()=>{jn.has(e)&&Ir(e)};e.addEventListener("blur",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{In.delete(e),jn.delete(e),e.removeEventListener("blur",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}var Oi=new WeakSet;function el(e){return Oi.has(e)||Lf(e,"validate")}function Yf(e,t){Oi.add(e),Ur(),e.tagName==="FORM"&&(e.noValidate=!0);let n=o=>{let i=o.target;!Le(i)||In.has(i)||Fi(i).length!==0&&Ir(i)},r=o=>{let i=o.target;!Le(i)||In.has(i)||jn.has(i)&&Ir(i)};e.addEventListener("focusout",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{Oi.delete(e),e.removeEventListener("focusout",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}b("validate",({el:e,cleanup:t})=>{if(e.tagName==="FORM"||e.hasAttribute(`${E.prefix}submit`)){Yf(e,t);return}Kr(e,t)});var Qf=["required","email","url","number","integer","minlength","maxlength","min","max","match","regex","cpf","cnpj","cep","phone","date","accepted","strong-password"];for(let e of Qf)b(e,({el:t,cleanup:n})=>{Kr(t,n)});for(let e of["error-message","error-target","regex-flags","unique-url"])b(e,({el:t,cleanup:n})=>{Le(t)&&Kr(t,n)});function nl(){return V({loading:!1,saving:!1,success:!1,errors:{},message:"",data:null,status:0,dirty:!1,progress:0})}var un=new WeakMap,Vi=new WeakMap,Gf=nl();function Un(e){let t=un.get(e);return t||(t=nl(),un.set(e,t)),t}function Xf(e){let t=e;for(;t;){let n=Vi.get(t);if(n)return n;let r=t.el;if(r){let o=r.closest("form"),i=o?un.get(o):void 0;if(i)return i;let s=r.querySelector("form"),a=s?un.get(s):void 0;if(a)return a}t=t.parent}if(typeof document!="undefined")for(let n of Array.from(document.forms)){let r=un.get(n);if(r)return r}return Gf}H("$form",e=>Xf(e));var dn=new WeakMap,Jf=["submit","upload","dropzone","autosave","get","post","put","patch","delete","load","load-visible","search","resource"];function tl(e){return Jf.some(t=>rt(e,`${E.prefix}${t}`)||rt(e,`data-v-${t}`))}function ae(e,t){var i,s,a;let n=Ze(e,t);if(n!==null)return n;let r=e.closest("form");if(r&&r!==e){let c=Ze(r,t);if(c!==null)return c}let o=(a=(i=dn.get(e))==null?void 0:i[t])!=null?a:r?(s=dn.get(r))==null?void 0:s[t]:void 0;return o!=null?o:null}function Gr(e,t){return ae(e,t)!==null}function Ae(e,t){b(e,({el:n,expression:r})=>{var a,c;let o=(a=n.closest("form"))!=null?a:n,i=(c=dn.get(o))!=null?c:{};if(i[e]=r,dn.set(o,i),!tl(o)&&!tl(n)){Y(`${E.prefix}${e} needs an element with ${E.prefix}submit, ${E.prefix}upload, ${E.prefix}dropzone, or ${E.prefix}autosave.`);return}let s=t==null?void 0:t(r);s&&Y(s)})}var Zf=["GET","POST","PUT","PATCH","DELETE","HEAD","OPTIONS"];Ae("method",e=>e&&!Zf.includes(e.trim().toUpperCase())?`${E.prefix}method received an unknown verb: ${e}`:null);Ae("redirect");Ae("reset-success");Ae("disable-loading");Ae("loading-class");Ae("on-success");Ae("on-error");Ae("on-complete");Ae("toast-success");Ae("toast-error");Ae("confirm");Ae("form-data");b("loading",({el:e,expression:t})=>{var i,s;let n=(i=e.closest("form"))!=null?i:e,r=(s=dn.get(n))!=null?s:{};r.loading=t,dn.set(n,r);let o=rl(t);if(!o){Y(`${E.prefix}loading element not found: ${t}`);return}ol(o,!1)});var ep=`
...
`);kp(c);let l={colors:t,radius:n,font:r,monoFont:o,light:i.scales,dark:s.scales,contrast:i.contrast,css:c};if(Yn=l,Kn={...e},e.persist!==!1&&typeof document!="undefined"){let u={...e};delete u.persist,Q.set(os,u)}return typeof document!="undefined"&&document.dispatchEvent(new CustomEvent("voodoo:palette",{detail:l})),l}var bl=!1;function is(){if(Yn&&bl)return Yn;bl=!0;let e=Q.get(os),t=e&&typeof e=="object"?{...e,persist:!1}:{persist:!1};return no(t)}function ss(){Yn||is()}function Al(){return is()}var Sl=Object.assign(no,{presets:io,get names(){return Object.keys(io)},get current(){return Yn},get options(){return Kn},init:is,ensure:ss,reset(){return Q.remove(os),no({persist:!1})},use(e){return no({...Kn!=null?Kn:{},preset:e,primary:void 0,accent:void 0})},scale:kl,contrastText:Wn,contrastRatio:ns,luminance(e){let t=typeof e=="string"?_e(e):e;return t?ts(t):0},convert:{parseColor:_e,rgbToOklch:ro,oklchToRgb:mn,toHex:Pt,toRgba:pn}});var Ne={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},ls={duration:220,size:"md"},Lp=`
