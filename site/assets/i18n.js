  ...
  var messages = {
    en: {
      ...
      cmd: {
        ...
        startHint: 'Install',
        why: 'Why Voodoo.js',
        compare: 'Compare with Vue, jQuery and vanilla',
        bench: 'Benchmarks',
        docs: 'Documentation',
        examples: 'Examples',
        ...
        npm: 'View on npm',
        theme: 'Toggle dark mode',
        source: "View this page's source",
      },
    },
    ...
    'pt-BR': {
      ...
      cmd: {
        start: 'Começar',
        startHint: 'Instalar',
        why: 'Por que Voodoo.js',
        compare: 'Comparar com Vue, jQuery e vanilla',
        bench: 'Benchmarks',
        docs: 'Documentação',
        examples: 'Exemplos',
        ...
        npm: 'Ver no npm',
        theme: 'Alternar modo escuro',
        source: 'Ver o código desta página',
      },
    },
    ...
    es: {
      ...
      cmd: {
        start: 'Empezar',
        startHint: 'Instalar',
        why: 'Por qué Voodoo.js',
        compare: 'Comparar con Vue, jQuery y vanilla',
        bench: 'Benchmarks',
        docs: 'Documentación',
        examples: 'Ejemplos',
        ...
        npm: 'Ver en npm',
        theme: 'Alternar modo oscuro',
        source: 'Ver el código de esta página',
      },
    },
    ...
    ko: {
      ...
      cmd: {
        start: '시작하기',
        startHint: '설치',
        why: 'Voodoo.js를 쓰는 이유',
        compare: 'Vue, jQuery, 바닐라와 비교',
        bench: '벤치마크',
        docs: '문서',
        examples: '예제',
        github: 'GitHub 저장소',
