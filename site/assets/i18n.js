...
(function () {
  ...
  var messages = {
    en: {
      ...
      foot: { mit: 'MIT licensed', builtWith: 'Built with Voodoo.js 0.12.0' },
    },
    ...
    'pt-BR': {
      ...
      foot: { mit: 'Licença MIT', builtWith: 'Feito com Voodoo.js 0.12.0' },
    },
    ...
    es: {
      ...
      foot: { mit: 'Licencia MIT', builtWith: 'Hecho con Voodoo.js 0.12.0' },
    },
    ...
    ko: {
      ...
      foot: { mit: 'MIT 라이선스', builtWith: 'Voodoo.js 0.12.0으로 제작' },
    },
  };
