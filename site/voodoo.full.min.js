 ...
 */
"use strict";var Voodoo=(()=>{var Po=Object.defineProperty;var Cm=Object.getOwnPropertyDescriptor;var Am=Object.getOwnPropertyNames;var Rm=Object.prototype.hasOwnProperty;var $m=(e,t,n)=>t in e?Po(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Rs=(e,t)=>()=>(e&&(t=e(e=0)),t);var Ho=(e,t)=>{for(var n in t)Po(e,n,{get:t[n],enumerable:!0})},Dm=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Am(t))!Rm.call(e,o)&&o!==n&&Po(e,o,{get:()=>t[o],enumerable:!(r=Cm(t,o))||r.enumerable});return e};var Pm=e=>Dm(Po({},"__esModule",{value:!0}),e);var H=(e,t,n)=>$m(e,typeof t!="symbol"?t+"":t,n);var Kc={};Ho(Kc,{EffectScope:()=>ot,ITERATE_KEY:()=>rn,ReactiveEffect:()=>Dn,TriggerType:()=>Vc,computed:()=>an,effect:()=>Pe,effectScope:()=>js,enableTracking:()=>qc,flushSync:()=>Fs,getActiveEffect:()=>Nm,getActiveScope:()=>Fm,handleError:()=>W,hasChanged:()=>$r,isReactive:()=>Us,isRef:()=>on,markRaw:()=>Rr,nextTick:()=>ft,pauseTracking:()=>jc,queueJob:()=>zo,queuePostFlush:()=>Se,reactive:()=>Y,ref:()=>Ge,resetTracking:()=>Bs,setErrorHandler:()=>Is,shallowRef:()=>_s,stop:()=>Pn,toRaw:()=>Me,track:()=>ut,trigger:()=>Et,unref:()=>Ws,warn:()=>X,watch:()=>Ie,watchEffect:()=>Ks});function ft(e){let t=Fo||Ns;return e?t.then(e):t}function zo(e){e.queued||(e.queued=!0,Rn.push(e),Bc())}function Se(e){No.push(e),Bc()}function Bc(){Oo||Ar||(Ar=!0,Fo=Ns.then(Os))}function Os(){Ar=!1,Oo=!0;let e=new Map;try{for(let t=0;t<Rn.length;t++){let n=Rn[t];if(!n.active)continue;let r=(e.get(n)||0)+1;if(e.set(n,r),r>Hm){X("Infinite update loop detected. A reactive effect keeps triggering itself without ever settling. Check whether some expression writes to state that it also reads.");continue}try{n.run()}catch(o){W(o,"effect")}}}finally{for(let n of Rn)n.queued=!1;Rn=[],Oo=!1;let t=No;No=[];for(let n of t)try{n()}catch(r){W(r,"post-flush")}Rn.length||No.length?(Fo=Ns.then(Os),Ar=!0):Fo=null}}function Fs(){Oo||(Ar=!1,Os())}function Is(e){$s=e}function W(e,t){if($s){$s(e,t);return}console.error(`[Voodoo] error in ${t}:`,e)}function X(e,...t){console.warn(`[Voodoo] ${e}`,...t)}function jc(){zs.push(sn),sn=!1}function qc(){zs.push(sn),sn=!0}function Bs(){var e;sn=(e=zs.pop())!=null?e:!0}function Nm(){return Fe}function Oc(e){let{deps:t}=e;for(let n=0;n<t.length;n++)t[n].delete(e);t.length=0}function Pe(e,t){let n=new Dn(e,t);t!=null&&t.lazy||n.run();let r=(()=>n.run());return r.effect=n,r}function Pn(e){e instanceof Dn?e.stop():e.effect.stop()}function js(e=!1){return new ot(e)}function Fm(){return Ot}function ut(e,t){if(!sn||!Fe)return;let n=Ds.get(e);n||Ds.set(e,n=new Map);let r=n.get(t);r||n.set(t,r=new Set),r.has(Fe)||(r.add(Fe),Fe.deps.push(r))}function Et(e,t,n,r){let o=Ds.get(e);if(!o)return;let i=new Set,s=a=>{if(a)for(let l of a)(l!==Fe||t==="clear")&&i.add(l)};if(t==="clear")o.forEach(s);else{n!==void 0&&s(o.get(n));let a=Array.isArray(e);if(t==="add")a?Ps(n)&&s(o.get("length")):s(o.get(rn));else if(t==="delete")a||s(o.get(rn));else if(a&&n==="length"){let l=Number(r);o.forEach((c,d)=>{(d==="length"||typeof d!="symbol"&&Number(d)>=l)&&s(c)})}}for(let a of i)a.scheduler?a.scheduler():zo(a)}function Ps(e){return typeof e=="string"&&e!=="NaN"&&e[0]!=="-"&&String(parseInt(e,10))===e}function Ft(e){return e!==null&&typeof e=="object"}function zm(e){if(!Ft(e)||e[Uc]||Object.isFrozen(e)||typeof Node!="undefined"&&e instanceof Node)return!1;let t=Object.prototype.toString.call(e).slice(8,-1);return Im.has(t)?!1:t==="Object"||t==="Array"||t==="Map"||t==="Set"}function Rr(e){return Object.defineProperty(e,Uc,{value:!0,enumerable:!1,configurable:!0}),e}function Me(e){let t=e&&e[qs];return t?Me(t):e}function Us(e){return!!(e&&e[Vs])}function Y(e){if(!Ft(e)||Us(e)||!zm(e))return e;let t=Fc.get(e);if(t)return t;let n=e instanceof Map||e instanceof Set,r=new Proxy(e,n?jm:Bm);return Fc.set(e,r),r}function $r(e,t){return!Object.is(e,t)}function on(e){return!!(e&&e.__v_isRef===!0)}function zc(e){return Ft(e)?Y(e):e}function _c(e){!sn||!Fe||e.dep.has(Fe)||(e.dep.add(Fe),Fe.deps.push(e.dep))}function Wc(e){for(let t of[...e.dep])t.scheduler?t.scheduler():zo(t)}function Ge(e){return new Io(e)}function _s(e){return new Io(e,!0)}function Ws(e){return on(e)?e.value:e}function an(e){let t=typeof e=="function",n=t?e:e.get,r=t?void 0:e.set;return new Hs(n,r)}function Ie(e,t,n={}){let{immediate:r=!1,deep:o=!1,flush:i="pre"}=n,s;if(on(e)?s=()=>e.value:typeof e=="function"?s=e:Us(e)?s=()=>$n(e):s=()=>e,o){let p=s;s=()=>$n(p())}let a,l,c=p=>{l=p},d=()=>{if(!f.effect.active)return;let p=f();(o||$r(p,a))&&(l==null||l(),l=void 0,t(p,a,c),a=p)},f=i==="pre"?Pe(s,{lazy:!0,scheduler:()=>Se(d)}):Pe(s,{lazy:!0,scheduler:i==="sync"?d:i==="post"?()=>Se(d):()=>zo(f.effect)});return a=f(),r&&t(a,void 0,c),()=>f.effect.stop()}function Ks(e){let t,n=o=>{t=o},r=Pe(()=>{t==null||t(),t=void 0,e(n)});return()=>{t==null||t(),r.effect.stop()}}function $n(e,t=new Set){if(!Ft(e)||t.has(e))return e;if(t.add(e),on(e))$n(e.value,t);else if(Array.isArray(e))for(let n of e)$n(n,t);else if(e instanceof Set||e instanceof Map)e.forEach(n=>$n(n,t));else for(let n of Object.keys(e))$n(e[n],t);return e}var Ns,Rn,No,Oo,Ar,Fo,Hm,$s,Fe,sn,zs,Om,Dn,Ot,ot,rn,Ds,Vc,qs,Vs,Uc,Fc,Ic,Im,Bm,jm,Io,Hs,de=Rs(()=>{"use strict";Ns=Promise.resolve(),Rn=[],No=[],Oo=!1,Ar=!1,Fo=null,Hm=100;$s=null;sn=!0,zs=[];Om=0,Dn=class{constructor(t,n){var o;this.fn=t,this.id=Om++,this.active=!0,this.queued=!1,this.deps=[],this.parent=void 0,this.scheduler=n==null?void 0:n.scheduler,this.onStop=n==null?void 0:n.onStop,this.cleanups=[];let r=(o=n==null?void 0:n.scope)!=null?o:Ot;r&&r.effects.push(this)}run(){if(!this.active)return this.fn();let t=Fe;for(;t;){if(t===this)return;t=t.parent}this.runCleanups();try{return this.parent=Fe,Fe=this,qc(),Oc(this),this.fn()}finally{Bs(),Fe=this.parent,this.parent=void 0}}onInvalidate(t){this.cleanups.push(t)}runCleanups(){if(!this.cleanups.length)return;let t=this.cleanups;this.cleanups=[];for(let n of t)try{n()}catch(r){W(r,"effect cleanup")}}stop(){var t;this.active&&(Oc(this),this.runCleanups(),this.active=!1,(t=this.onStop)==null||t.call(this))}};ot=class{constructor(t=!1){this.effects=[],this.cleanups=[],this.children=[],this.active=!0,this.parent=void 0,!t&&Ot&&(this.parent=Ot,Ot.children.push(this))}run(t){if(!this.active)return;let n=Ot;try{return Ot=this,t()}finally{Ot=n}}onDispose(t){this.cleanups.push(t)}stop(){if(this.active){this.active=!1;for(let t of this.effects)t.stop();for(let t of this.children)t.stop();for(let t of this.cleanups)try{t()}catch(n){W(n,"scope cleanup")}if(this.effects.length=0,this.children.length=0,this.cleanups.length=0,this.parent){let t=this.parent.children.indexOf(this);t>-1&&this.parent.children.splice(t,1)}}}};rn=Symbol("voodoo:iterate"),Ds=new WeakMap;Vc=(o=>(o.SET="set",o.ADD="add",o.DELETE="delete",o.CLEAR="clear",o))(Vc||{});qs=Symbol("voodoo:raw"),Vs=Symbol("voodoo:isReactive"),Uc=Symbol("voodoo:skip"),Fc=new WeakMap,Ic=(()=>{let e={};for(let t of["includes","indexOf","lastIndexOf"])e[t]=function(...n){let r=Me(this);for(let i=0;i<r.length;i++)ut(r,String(i));let o=r[t].apply(r,n);return o===-1||o===!1?r[t].apply(r,n.map(Me)):o};for(let t of["push","pop","shift","unshift","splice"])e[t]=function(...n){jc();try{return Me(this)[t].apply(this,n)}finally{Bs()}};return e})();Im=new Set(["Date","RegExp","Promise","Error","File","FileList","Blob","FormData","URL","URLSearchParams","ArrayBuffer","DataView"]);Bm={get(e,t,n){if(t===qs)return e;if(t===Vs)return!0;let r=Array.isArray(e);if(r&&Object.prototype.hasOwnProperty.call(Ic,t))return Reflect.get(Ic,t,n);let o=Reflect.get(e,t,n);return typeof t=="symbol"?o:(ut(e,t),on(o)?r&&Ps(t)?o:o.value:Ft(o)?Y(o):o)},set(e,t,n,r){let o=e[t];if(n=Me(n),!Array.isArray(e)&&on(o)&&!on(n))return o.value=n,!0;let i=Array.isArray(e)&&Ps(t)?Number(t)<e.length:Object.prototype.hasOwnProperty.call(e,t),s=Reflect.set(e,t,n,r);return e===Me(r)&&(i?$r(n,o)&&Et(e,"set",t,n):Et(e,"add",t,n)),s},deleteProperty(e,t){let n=Object.prototype.hasOwnProperty.call(e,t),r=Reflect.deleteProperty(e,t);return r&&n&&Et(e,"delete",t),r},has(e,t){let n=Reflect.has(e,t);return typeof t!="symbol"&&ut(e,t),n},ownKeys(e){return ut(e,Array.isArray(e)?"length":rn),Reflect.ownKeys(e)}},jm={get(e,t,n){if(t===qs)return e;if(t===Vs)return!0;let r=e;if(t==="size")return ut(r,rn),Reflect.get(r,"size",r);let o={get(s){ut(r,s);let a=r.get(s);return Ft(a)?Y(a):a},has(s){return ut(r,s),r.has(s)},add(s){s=Me(s);let a=r.has(s);return r.add(s),a||Et(r,"add",s,s),n},set(s,a){let l=r.has(s),c=r.get(s);return r.set(s,Me(a)),l?$r(a,c)&&Et(r,"set",s,a):Et(r,"add",s,a),n},delete(s){let a=r.has(s),l=r.delete(s);return a&&Et(r,"delete",s),l},clear(){let s=r.size!==0,a=r.clear();return s&&Et(r,"clear"),a},forEach(s,a){return ut(r,rn),r.forEach((l,c)=>{s.call(a,Ft(l)?Y(l):l,Ft(c)?Y(c):c,n)})}};if(t in o)return o[t];if(t===Symbol.iterator||t==="keys"||t==="values"||t==="entries"){ut(r,rn);let s=r[t];return typeof s=="function"?s.bind(r):s}let i=Reflect.get(r,t,r);return typeof i=="function"?i.bind(r):i}};Io=class{constructor(t,n=!1){H(this,"shallow",n);H(this,"__v_isRef",!0);H(this,"_value");H(this,"_rawValue");H(this,"dep",new Set);this._rawValue=Me(t),this._value=n?t:zc(t)}get value(){return _c(this),this._value}set value(t){let n=Me(t);$r(n,this._rawValue)&&(this._rawValue=n,this._value=this.shallow?t:zc(t),Wc(this))}};Hs=class{constructor(t,n){H(this,"setter",n);H(this,"__v_isRef",!0);H(this,"_value");H(this,"_dirty",!0);H(this,"effect");H(this,"dep",new Set);this.effect=new Dn(t,{scheduler:()=>{this._dirty||(this._dirty=!0,Wc(this))}})}get value(){return _c(this),this._dirty&&(this._dirty=!1,this._value=this.effect.run()),this._value}set value(t){this.setter?this.setter(t):X("computed is read-only when there is no setter.")}stop(){this.effect.stop()}}});function y(e,t,n={}){var r,o;Mt.set(e,{name:e,setup:t,priority:(r=n.priority)!=null?r:j.DEFAULT,terminal:(o=n.terminal)!=null?o:!1})}function ln(e){return e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").replace(/[_\s]+/g,"-").toLowerCase()}function Uo(e,t,n){ad.has(t)||(ad.add(t),typeof t=="function"?t(e,n):t.install(e,n))}var w,Mt,j,He,ad,ce=Rs(()=>{"use strict";w={prefix:"v-",autoStart:!0,autoDiscover:!0,root:null,devtools:!1,xrayShortcut:"ctrl+shift+f2",baseURL:"",globals:{},locale:typeof navigator!="undefined"&&navigator.language||"pt-BR",currency:"BRL",injectStyles:!0,cleanAttributes:!0,sanitizeUrls:!0},Mt=new Map,j={IGNORE:100,FOR:90,IF:80,DATA:70,COMPONENT:65,REF:60,BIND:45,MODEL:40,DEFAULT:0,INIT:-10,TRANSITION:-20};He=new Map;ad=new Set});var eu={};Ho(eu,{BASE_TOKENS:()=>Zd,ensureTokens:()=>ge,injectStyle:()=>Z});function Z(e,t){if(typeof document=="undefined"||!w.injectStyles||Jd.has(e))return;Jd.add(e);let n=document.createElement("style");n.setAttribute("data-voodoo",e),n.textContent=t,document.head.appendChild(n)}function ge(){Z("tokens",Zd)}var Jd,Zd,Ae=Rs(()=>{"use strict";ce();Jd=new Set;Zd=`
:root{
  --v-primary:#6D3BF5;
...
`});var o0={};Ho(o0,{default:()=>r0});de();var te=class extends Error{constructor(n,r,o){let i=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${i}`);H(this,"source",r);H(this,"position",o);this.name="VoodooSyntaxError"}},qm=[">>>=","===","!==","**=","...",">>>","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","&=","|=","^=","<<",">>","+","-","*","/","%","!","<",">","=","&","|","^","~","(",")","[","]","{","}",",",".","?",":",";"],Vm=/[A-Za-z_$À-￿]/,Um=/[A-Za-z0-9_$À-￿]/;function _m(e){return Vm.test(e)}function Wm(e){return Um.test(e)}function Bo(e){return e>="0"&&e<="9"}var Yc={n:`
`,t:"	",r:"\r",b:"\b",f:"\f",v:"\v",0:"\0"};function jo(e){var o,i;let t=[],n=0,r=e.length;for(;n<r;){let s=e[n];if(s===" "||s==="	"||s===`
`||s==="\r"||s==="\f"||s==="\v"){n++;continue}if(s==="/"&&e[n+1]==="/"){for(;n<r&&e[n]!==`
`;)n++;continue}if(s==="/"&&e[n+1]==="*"){let c=e.indexOf("*/",n+2);if(c===-1)throw new te("Unclosed block comment",e,n);n=c+2;continue}let a=n;if(Bo(s)||s==="."&&Bo(e[n+1])){let c="";if(s==="0"&&(e[n+1]==="x"||e[n+1]==="X"))for(c="0x",n+=2;n<r&&/[0-9a-fA-F_]/.test(e[n]);)c+=e[n++];else if(s==="0"&&(e[n+1]==="b"||e[n+1]==="B"))for(c="0b",n+=2;n<r&&/[01_]/.test(e[n]);)c+=e[n++];else if(s==="0"&&(e[n+1]==="o"||e[n+1]==="O"))for(c="0o",n+=2;n<r&&/[0-7_]/.test(e[n]);)c+=e[n++];else{for(;n<r&&/[0-9_]/.test(e[n]);)c+=e[n++];if(e[n]===".")for(c+=e[n++];n<r&&/[0-9_]/.test(e[n]);)c+=e[n++];if(e[n]==="e"||e[n]==="E")for(c+=e[n++],(e[n]==="+"||e[n]==="-")&&(c+=e[n++]);n<r&&Bo(e[n]);)c+=e[n++]}let d=Number(c.replace(/_/g,""));if(Number.isNaN(d))throw new te("Invalid number",e,a);t.push({type:"num",value:c,parsed:d,start:a,end:n});continue}if(s==='"'||s==="'"){n++;let c="";for(;n<r&&e[n]!==s;)if(e[n]==="\\"){n++;let d=e[n];if(d==="u")if(e[n+1]==="{"){let u=e.indexOf("}",n);if(u===-1)throw new te("Unclosed Unicode escape",e,a);let f=e.slice(n+2,u);if(!/^[0-9a-fA-F]+$/.test(f)||parseInt(f,16)>1114111)throw new te(`Invalid Unicode escape "\\u{${f}}"`,e,n-1);c+=String.fromCodePoint(parseInt(f,16)),n=u+1}else{let u=e.slice(n+1,n+5);if(!/^[0-9a-fA-F]{4}$/.test(u))throw new te("Invalid Unicode escape: \\u needs 4 hexadecimal digits",e,n-1);c+=String.fromCharCode(parseInt(u,16)),n+=5}else if(d==="x"){let u=e.slice(n+1,n+3);if(!/^[0-9a-fA-F]{2}$/.test(u))throw new te("Invalid hexadecimal escape: \\x needs 2 hexadecimal digits",e,n-1);c+=String.fromCharCode(parseInt(u,16)),n+=3}else c+=(o=Yc[d])!=null?o:d,n++}else c+=e[n++];if(n>=r)throw new te("Unclosed string",e,a);n++,t.push({type:"str",value:c,parsed:c,start:a,end:n});continue}if(s==="`"){n++;let c=[],d=[],u="";for(;n<r&&e[n]!=="`";){if(e[n]==="\\"){let f=e[n+1];u+=(i=Yc[f])!=null?i:f,n+=2;continue}if(e[n]==="$"&&e[n+1]==="{"){c.push(u),u="",n+=2;let f=1,p="";for(;n<r;){let m=e[n];if(m==="{")f++;else if(m==="}"){if(f--,f===0)break}else if(m==='"'||m==="'"||m==="`"){let h=m;for(p+=e[n++];n<r&&e[n]!==h;)e[n]==="\\"&&(p+=e[n++]),p+=e[n++]}p+=e[n++]}if(f!==0)throw new te("Unclosed template interpolation",e,a);n++,d.push(p);continue}u+=e[n++]}if(n>=r)throw new te("Unclosed template literal",e,a);n++,c.push(u),t.push({type:"tpl",value:e.slice(a,n),tpl:{quasis:c,exprs:d},start:a,end:n});continue}if(_m(s)){let c="";for(;n<r&&Wm(e[n]);)c+=e[n++];t.push({type:"ident",value:c,start:a,end:n});continue}let l;for(let c of qm)if(e.startsWith(c,n)){if(c==="?."&&Bo(e[n+2]))continue;l=c;break}if(l){n+=l.length,t.push({type:"punct",value:l,start:a,end:n});continue}throw new te(`Unexpected character "${s}"`,e,n)}return t.push({type:"eof",value:"",start:r,end:r}),t}var Xc={"??":1,"||":2,"&&":3,"|":4,"^":5,"&":6,"==":7,"!=":7,"===":7,"!==":7,"<":8,">":8,"<=":8,">=":8,in:8,instanceof:8,"<<":9,">>":9,">>>":9,"+":10,"-":10,"*":11,"/":11,"%":11,"**":12},Km=new Set(["=","+=","-=","*=","/=","%=","**=","&&=","||=","??="]),Ym=new Set(["!","-","+","~","typeof","void","delete"]),Gc=Object.assign(Object.create(null),{true:!0,false:!1,null:null,undefined:void 0}),Qc=1200,Jc=32,Ys=0,Xs=class{constructor(t,n){H(this,"tokens",t);H(this,"source",n);H(this,"pos",0);H(this,"depth",0)}peek(t=0){return this.tokens[Math.min(this.pos+t,this.tokens.length-1)]}next(){return this.tokens[this.pos++]}isPunct(t,n=0){let r=this.peek(n);return r.type==="punct"&&r.value===t}isIdent(t,n=0){let r=this.peek(n);return r.type==="ident"&&r.value===t}expect(t){if(!this.isPunct(t)){let n=this.peek();throw new te(`Expected "${t}" but found "${n.value||"end of expression"}"`,this.source,n.start)}return this.next()}parseProgram(){let t=[];for(;this.peek().type!=="eof";)for(t.push(this.parseStatement());this.isPunct(";")||this.isPunct(",");)this.next();return t.length===0?{t:"lit",v:void 0}:t.length===1?t[0]:{t:"seq",body:t}}parseArrowBody(){if(!this.isPunct("{"))return this.parseAssignment();this.next();let t=[];for(;!this.isPunct("}")&&this.peek().type!=="eof";)for(t.push(this.parseStatement());this.isPunct(";")||this.isPunct(",");)this.next();return this.expect("}"),t.length===0?{t:"lit",v:void 0}:t.length===1?t[0]:{t:"seq",body:t}}parseStatement(){if(this.peek().type==="ident"&&this.peek().value==="return")return this.next(),this.isPunct(";")||this.isPunct(",")||this.isPunct("}")||this.peek().type==="eof"?{t:"return",a:null}:{t:"return",a:this.parseExpression()};if(this.peek().type==="ident"&&this.peek().value==="if"&&this.isPunct("(",1)){this.next(),this.expect("(");let t=this.parseExpression();this.expect(")");let n=this.parseBlockOrStatement(),r=null;return this.peek().type==="ident"&&this.peek().value==="else"&&(this.next(),r=this.parseBlockOrStatement()),{t:"if",test:t,cons:n,alt:r}}return this.parseExpression()}parseBlockOrStatement(){if(!this.isPunct("{"))return this.parseStatement();this.next();let t=[];for(;!this.isPunct("}")&&this.peek().type!=="eof";)for(t.push(this.parseStatement());this.isPunct(";")||this.isPunct(",");)this.next();return this.expect("}"),t.length===0?{t:"lit",v:void 0}:t.length===1?t[0]:{t:"seq",body:t}}parseExpression(){return this.parseAssignment()}enterLevel(){if(++this.depth>Qc){let t=this.peek();throw new te(`Expression too deeply nested (limit of ${Qc} levels)`,this.source,t.start)}}parseAssignment(){this.enterLevel();let t=this.parseAssignmentInternal();return this.depth--,t}parseAssignmentInternal(){if(this.peek().type==="ident"&&this.isPunct("=>",1)){let r=this.next().value;return this.next(),{t:"arrow",params:[{kind:"id",name:r}],body:this.parseArrowBody()}}if(this.isPunct("(")){let r=this.tryParseParenArrow();if(r)return r}let t=this.parseConditional(),n=this.peek();if(n.type==="punct"&&Km.has(n.value)){if(t.t!=="id"&&t.t!=="member")throw new te("Invalid assignment target",this.source,n.start);this.next();let r=this.parseAssignment();return{t:"assign",op:n.value,target:t,value:r}}return t}tryParseParenArrow(){let t=this.pos,n=0,r=this.pos;for(;r<this.tokens.length;r++){let s=this.tokens[r];if(s.type==="punct"&&s.value==="(")n++;else if(s.type==="punct"&&s.value===")"){if(n--,n===0)break}else if(s.type==="eof")break}let o=this.tokens[r+1];if(!o||o.type!=="punct"||o.value!=="=>")return null;this.next();let i;try{i=this.parseParamList()}catch(s){return this.pos=t,null}return this.expect("=>"),{t:"arrow",params:i,body:this.parseArrowBody()}}parseParamList(){let t=[];for(;!this.isPunct(")")&&(t.push(this.parseParam()),this.isPunct(","));)this.next();return this.expect(")"),t}parseParam(){if(this.isPunct("...")){this.next();let n=this.next();if(n.type!=="ident")throw new te("Expected a name after ...",this.source,n.start);return{kind:"rest",name:n.value}}let t;if(this.isPunct("{")){this.next();let n=[],r;for(;!this.isPunct("}");){if(this.isPunct("...")){this.next();let o=this.next();if(o.type!=="ident")throw new te("Expected a name after ...",this.source,o.start);r=o.value}else{let o=this.next();if(o.type!=="ident"&&o.type!=="str")throw new te("Expected a property name",this.source,o.start);let i=this.isPunct(":")?(this.next(),this.parseParam()):{kind:"id",name:o.value};this.isPunct("=")&&(this.next(),i.def=this.parseAssignment()),n.push({key:String(o.value),value:i})}if(this.isPunct(","))this.next();else break}this.expect("}"),t={kind:"obj",props:n,rest:r}}else if(this.isPunct("[")){this.next();let n=[],r;for(;!this.isPunct("]");){if(this.isPunct(",")){this.next(),n.push(null);continue}if(this.isPunct("...")){this.next();let o=this.next();if(o.type!=="ident")throw new te("Expected a name after ...",this.source,o.start);r=o.value}else n.push(this.parseParam());if(this.isPunct(","))this.next();else break}this.expect("]"),t={kind:"arr",elements:n,rest:r}}else{let n=this.next();if(n.type!=="ident")throw new te("Expected a parameter name",this.source,n.start);t={kind:"id",name:n.value}}return this.isPunct("=")&&(this.next(),t.def=this.parseAssignment()),t}parseConditional(){let t=this.parseBinary(0);if(this.isPunct("?")){this.next();let n=this.parseAssignment();this.expect(":");let r=this.parseAssignment();return{t:"cond",test:t,cons:n,alt:r}}return t}parseBinary(t){this.enterLevel();let n=this.parseBinaryInternal(t);return this.depth--,n}parseBinaryInternal(t){let n=this.parseUnary();for(;;){let r=this.peek(),o=r.value;if(!(r.type==="punct"&&o in Xc||r.type==="ident"&&(o==="in"||o==="instanceof")))break;let s=Xc[o];if(s===void 0||s<=t)break;this.next();let a=this.parseBinary(o==="**"?s-1:s);n={t:o==="&&"||o==="||"||o==="??"?"logic":"bin",op:o,l:n,r:a}}return n}parseUnary(){this.enterLevel();let t=this.parseUnaryInternal();return this.depth--,t}parseUnaryInternal(){let t=this.peek();if((t.type==="punct"||t.type==="ident")&&Ym.has(t.value))return this.next(),{t:"unary",op:t.value,a:this.parseUnary()};if(t.type==="punct"&&(t.value==="++"||t.value==="--")){this.next();let o=this.parseUnary();return{t:"update",op:t.value,a:o,prefix:!0}}let n=this.parseCallMember(),r=this.peek();return r.type==="punct"&&(r.value==="++"||r.value==="--")&&(this.next(),n={t:"update",op:r.value,a:n,prefix:!1}),n}parseNew(){this.next();let t=this.parseMemberOnly(this.parsePrimary()),n=this.isPunct("(")?this.parseArguments():[];return{t:"new",callee:t,args:n}}parseMemberOnly(t){let n=t;for(;;)if(this.isPunct(".")){this.next();let r=this.next();if(r.type!=="ident")throw new te("Invalid property name",this.source,r.start);n={t:"member",o:n,p:{t:"lit",v:r.value},computed:!1,opt:!1}}else if(this.isPunct("[")){this.next();let r=this.parseExpression();this.expect("]"),n={t:"member",o:n,p:r,computed:!0,opt:!1}}else return n}parseCallMember(){let t=this.isIdent("new")?this.parseNew():this.parsePrimary();for(;;)if(this.isPunct(".")){this.next();let n=this.next();if(n.type!=="ident")throw new te("Invalid property name",this.source,n.start);t={t:"member",o:t,p:{t:"lit",v:n.value},computed:!1,opt:!1}}else if(this.isPunct("?."))if(this.next(),this.isPunct("("))t={t:"call",callee:t,args:this.parseArguments(),opt:!0};else if(this.isPunct("[")){this.next();let n=this.parseExpression();this.expect("]"),t={t:"member",o:t,p:n,computed:!0,opt:!0}}else{let n=this.next();if(n.type!=="ident")throw new te("Invalid property name",this.source,n.start);t={t:"member",o:t,p:{t:"lit",v:n.value},computed:!1,opt:!0}}else if(this.isPunct("[")){this.next();let n=this.parseExpression();this.expect("]"),t={t:"member",o:t,p:n,computed:!0,opt:!1}}else if(this.isPunct("("))t={t:"call",callee:t,args:this.parseArguments(),opt:!1};else return t}parseArguments(){this.expect("(");let t=[];for(;!this.isPunct(")")&&(this.isPunct("...")?(this.next(),t.push({t:"unary",op:"...",a:this.parseAssignment()})):t.push(this.parseAssignment()),this.isPunct(","));)this.next();return this.expect(")"),t}parsePrimary(){let t=this.peek();if(t.type==="ident"&&t.value==="function")return this.next(),this.peek().type==="ident"&&this.next(),this.expect("("),{t:"arrow",params:this.parseParamList(),body:this.parseArrowBody()};if(t.type==="num"||t.type==="str")return this.next(),{t:"lit",v:t.parsed};if(t.type==="tpl"){this.next();let n=t.tpl;if(Ys>=Jc)throw new te(`Template literal too deeply nested (limit of ${Jc} levels)`,this.source,t.start);Ys++;try{return{t:"tpl",quasis:n.quasis,exprs:n.exprs.map(r=>ze(r))}}finally{Ys--}}if(t.type==="ident")return t.value in Gc?(this.next(),{t:"lit",v:Gc[t.value]}):(this.next(),{t:"id",n:t.value});if(t.type==="punct"){if(t.value==="("){this.next();let n=[this.parseExpression()];for(;this.isPunct(",");){if(this.next(),this.isPunct(")")){let r=this.peek();throw new te("Trailing comma in a group",this.source,r.start)}n.push(this.parseExpression())}return this.expect(")"),n.length===1?n[0]:{t:"seq",body:n}}if(t.value==="[")return this.parseArrayLiteral();if(t.value==="{")return this.parseObjectLiteral()}throw new te(`Unexpected token "${t.value||"end of expression"}"`,this.source,t.start)}parseArrayLiteral(){this.expect("[");let t=[];for(;!this.isPunct("]")&&(this.isPunct("...")?(this.next(),t.push({spread:this.parseAssignment()})):t.push(this.parseAssignment()),this.isPunct(","));)this.next();return this.expect("]"),{t:"arr",els:t}}parseObjectLiteral(){var n;this.expect("{");let t=[];for(;!this.isPunct("}");){if(this.isPunct("..."))this.next(),t.push({key:null,spread:this.parseAssignment()});else if(this.isPunct("[")){this.next();let r=this.parseAssignment();this.expect("]"),this.expect(":"),t.push({key:null,keyExpr:r,value:this.parseAssignment()})}else{if(this.peek().type==="ident"&&this.peek().value==="get"&&this.peek(1).type==="ident"&&this.isPunct("(",2)){this.next();let i=this.next();this.expect("("),this.expect(")"),t.push({key:String(i.value),getter:!0,value:{t:"method",params:[],body:this.parseArrowBody()}}),this.isPunct(",")&&this.next();continue}let r=this.next();if(r.type!=="ident"&&r.type!=="str"&&r.type!=="num")throw new te("Invalid object key",this.source,r.start);let o=String((n=r.parsed)!=null?n:r.value);if(this.isPunct(":"))this.next(),t.push({key:o,value:this.parseAssignment()});else if(this.isPunct("(")){this.next();let i=this.parseParamList();t.push({key:o,value:{t:"method",params:i,body:this.parseArrowBody()}})}else t.push({key:o,value:{t:"id",n:o}})}if(this.isPunct(","))this.next();else break}return this.expect("}"),{t:"obj",props:t}}},Hn=new Map,Zc=2e3;function ze(e){let t=Hn.get(e);if(t)return t;let n=new Xs(jo(e),e).parseProgram();return Hn.size>=Zc&&Xm(),Hn.set(e,n),n}function Xm(){let e=Math.floor(Zc/2),t=0;for(let n of Hn.keys())if(Hn.delete(n),++t>=e)break}function ed(){Hn.clear()}var id,Gm=Object.freeze({keys:Object.keys,values:Object.values,entries:Object.entries,fromEntries:Object.fromEntries,assign:Object.assign,is:Object.is,hasOwn:(id=Object.hasOwn)!=null?id:((e,t)=>Object.prototype.hasOwnProperty.call(e,t))}),Qm=new Set(["eval","Function","window","globalThis","self","top","parent","document","fetch","XMLHttpRequest","importScripts","require","process","Reflect","Proxy","WebAssembly","localStorage","sessionStorage","indexedDB","navigator","location","history","crypto","Worker","SharedWorker","ServiceWorker"]);function td(e){return function(t,n,...r){if(typeof t!="function")throw new xe(`${e} needs a function. Passing a string would compile it, which this library never does.`);let o=globalThis[e];return o(t,n,...r)}}function qo(e){return function(...t){let n=globalThis[e];return n(...t)}}var Oe={Math,JSON,Date,Number,String,Boolean,Array,Object:Gm,Intl,RegExp,Promise,parseInt,parseFloat,isNaN,isFinite,encodeURIComponent,decodeURIComponent,console,...typeof setTimeout!="undefined"?{setTimeout:td("setTimeout"),setInterval:td("setInterval"),clearTimeout:qo("clearTimeout"),clearInterval:qo("clearInterval")}:{},...typeof requestAnimationFrame!="undefined"?{requestAnimationFrame:qo("requestAnimationFrame"),cancelAnimationFrame:qo("cancelAnimationFrame")}:{}},xe=class extends Error{constructor(n,r){super(r?`${n}

Expression: ${r}`:n);H(this,"expression",r);this.name="VoodooRuntimeError"}},Qs=Symbol("spread"),Dr=class{constructor(t){H(this,"value",t)}};function Vo(e){return e instanceof Dr?e.value:e}var Jm=new Set(["__proto__","constructor","prototype"]);function sd(e){return typeof e=="string"&&Jm.has(e)}function Tt(e,t){if(sd(e))throw new xe(`Access blocked to "${String(e)}": template expressions cannot reach the prototype chain. Expose a method in state instead.`,t);return e}function P(e,t){var n,r;switch(e.t){case"lit":return e.v;case"tpl":{let o=(n=e.quasis[0])!=null?n:"";for(let i=0;i<e.exprs.length;i++)o+=Lt(P(e.exprs[i],t)),o+=(r=e.quasis[i+1])!=null?r:"";return o}case"id":{Tt(e.n);let o=t.lookup(e.n);return o?o[e.n]:e.n in Oe?Oe[e.n]:void 0}case"member":{let o=P(e.o,t);if(o==null){if(e.opt)return;throw new xe(`Could not read "${Gs(e,t)}" from ${o===null?"null":"undefined"}`)}let i=Tt(e.computed?P(e.p,t):e.p.v);return o[i]}case"new":{let o=P(e.callee,t);if(typeof o!="function")throw new xe(`Cannot construct ${Lt(o)}: it is not a constructor`);if(o===Function)throw new xe("Cannot construct Function: expressions never compile code");let i=rd(e.args,t);return Reflect.construct(o,i)}case"call":{let o,i;if(e.callee.t==="member"){let s=P(e.callee.o,t);if(s==null){if(e.callee.opt||e.opt)return;throw new xe(`Could not call "${Gs(e.callee,t)}" from ${s===null?"null":"undefined"}`)}let a=Tt(e.callee.computed?P(e.callee.p,t):e.callee.p.v);o=s,i=s[a]}else if(e.callee.t==="id"){Tt(e.callee.n);let s=t.lookup(e.callee.n);s?(o=s,i=s[e.callee.n]):i=Oe[e.callee.n]}else i=P(e.callee,t);if(i==null&&e.opt)return;if(typeof i!="function"){let s=e.callee.t==="id"?e.callee.n:Gs(e.callee,t);throw e.callee.t==="id"&&!t.lookup(s)&&!(s in Oe)?Qm.has(s)?new xe(`"${s}" is blocked. Expressions run in a sandbox without access to it.`):new xe(`"${s}" was not found. Expressions cannot reach window: expose it with V.config.globals.${s} = ..., or put it in scope with V.data({ ${s} }).`):new xe(`"${s}" is not a function`)}return i.apply(o,rd(e.args,t))}case"unary":{if(e.op==="...")return{[Qs]:P(e.a,t)};if(e.op==="delete"){if(e.a.t!=="member")throw new xe("delete needs a property, as in `delete user.name` or `delete list[0]`");let i=P(e.a.o,t);if(i==null)return!0;let s=Tt(e.a.computed?P(e.a.p,t):e.a.p.v);return delete i[s]}if(e.op==="typeof"){if(e.a.t==="id"){if(sd(e.a.n))return"undefined";let i=t.lookup(e.a.n);return typeof(i?i[e.a.n]:Oe[e.a.n])}return typeof P(e.a,t)}let o=P(e.a,t);switch(e.op){case"!":return!o;case"-":return-o;case"+":return+o;case"~":return~o;case"void":return}throw new xe(`Unsupported unary operator: ${e.op}`)}case"update":{let o=Number(P(e.a,t)),i=e.op==="++"?o+1:o-1;return od(e.a,i,t),e.prefix?i:o}case"bin":{let o=P(e.l,t),i=P(e.r,t);switch(e.op){case"+":return o+i;case"-":return o-i;case"*":return o*i;case"/":return o/i;case"%":return o%i;case"**":return o**i;case"==":return o==i;case"!=":return o!=i;case"===":return o===i;case"!==":return o!==i;case"<":return o<i;case">":return o>i;case"<=":return o<=i;case">=":return o>=i;case"in":return o in i;case"instanceof":return o instanceof i;case"&":return o&i;case"|":return o|i;case"^":return o^i;case"<<":return o<<i;case">>":return o>>i;case">>>":return o>>>i}throw new xe(`Unsupported operator: ${e.op}`)}case"logic":{let o=P(e.l,t);return e.op==="&&"?o&&P(e.r,t):e.op==="||"?o||P(e.r,t):o!=null?o:P(e.r,t)}case"cond":return P(e.test,t)?P(e.cons,t):P(e.alt,t);case"assign":{let o;if(e.op==="=")o=P(e.value,t);else if(e.op==="&&="||e.op==="||="||e.op==="??="){let i=P(e.target,t);if(!(e.op==="&&="?!!i:e.op==="||="?!i:i==null))return i;o=P(e.value,t)}else{let i=P(e.target,t),s=P(e.value,t);switch(e.op){case"+=":o=i+s;break;case"-=":o=i-s;break;case"*=":o=i*s;break;case"/=":o=i/s;break;case"%=":o=i%s;break;case"**=":o=i**s;break;default:throw new xe(`Unsupported assignment: ${e.op}`)}}return od(e.target,o,t),o}case"if":return P(e.test,t)?P(e.cons,t):e.alt?P(e.alt,t):void 0;case"method":{let o=e.params,i=e.body;return function(...s){let a=nd(o,s,t),l=this,c=l!==null&&typeof l=="object"?t.child(l):t;return Vo(P(i,c.child(a)))}}case"arrow":{let o=e.params,i=e.body;return(...s)=>Vo(P(i,t.child(nd(o,s,t))))}case"obj":{let o={};for(let i of e.props)if(i.spread)Object.assign(o,P(i.spread,t));else{let s=Tt(i.key!==null?i.key:String(P(i.keyExpr,t)));if(i.getter){let a=P(i.value,t);Object.defineProperty(o,s,{enumerable:!0,configurable:!0,get(){return a.call(this)}});continue}o[s]=P(i.value,t)}return o}case"arr":{let o=[];for(let i of e.els)i&&typeof i=="object"&&"spread"in i?o.push(...P(i.spread,t)):o.push(P(i,t));return o}case"return":return new Dr(e.a?P(e.a,t):void 0);case"seq":{let o;for(let i of e.body)if(o=P(i,t),o instanceof Dr)return o;return o}}throw new xe(`Unknown node: ${e.t}`)}function Js(e,t,n,r){if(e.kind==="rest"){n[e.name]=t;return}if(e.def!==void 0&&t===void 0&&(t=P(e.def,r.child(n))),e.kind==="id"){n[e.name]=t;return}if(e.kind==="obj"){if(t==null)throw new xe(`Cannot destructure ${t===null?"null":"undefined"}`);let i=new Set;for(let{key:s,value:a}of e.props)i.add(s),Js(a,t[Tt(s)],n,r);if(e.rest){let s={};for(let a of Object.keys(t))i.has(a)||(s[a]=t[a]);n[e.rest]=s}return}let o=Array.isArray(t)?t:Array.from(t);e.elements.forEach((i,s)=>{i&&Js(i,o[s],n,r)}),e.rest&&(n[e.rest]=o.slice(e.elements.length))}function nd(e,t,n){let r={};for(let o=0;o<e.length;o++){let i=e[o];Js(i,i.kind==="rest"?t.slice(o):t[o],r,n)}return r}function rd(e,t){let n=[];for(let r of e){let o=P(r,t);o&&typeof o=="object"&&Qs in o?n.push(...o[Qs]):n.push(o)}return n}function od(e,t,n){if(e.t==="id"){Tt(e.n),n.set(e.n,t);return}if(e.t==="member"){let r=P(e.o,n);if(r==null)throw new xe("Could not write to null or undefined");let o=Tt(e.computed?P(e.p,n):e.p.v);r[o]=t;return}throw new xe("Invalid assignment target")}function Gs(e,t){return e.t==="member"?e.computed?String(P(e.p,t)):String(e.p.v):e.t==="id"?e.n:"value"}function Lt(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return String(e);if(e instanceof Date)return e.toLocaleString();if(typeof e=="object")try{return JSON.stringify(e)}catch(t){return String(e)}return String(e)}ce();de();var Pr=new Map;function N(e,t){Pr.set(e.startsWith("$")?e:`$${e}`,t)}var Zs=new Map;function Nn(e,t){Zs.set(e,t)}var St=class e{constructor(t={},n=null,r=null){this.refs={},this.component=null,this.provides=null,this.magicCache=null,this.data=t,this.parent=n,this.el=r}get root(){let t=this;for(;t.parent;)t=t.parent;return t}inject(t,n){let r=this;for(;r;){if(r.provides&&t in r.provides)return r.provides[t];r=r.parent}return n}get owner(){let t=this;for(;t;){if(t.component)return t;t=t.parent}return null}get allRefs(){let t=[],n=this;for(;n;)t.unshift(n),n=n.parent;let r={};for(let o of t)Object.assign(r,o.refs);return r}lookup(t){let n=this;for(;n;){if(t in n.data)return n.data;n=n.parent}if(t.charCodeAt(0)===36&&Pr.has(t))return this.magicContainer(t,Pr);if(Zs.has(t))return this.magicContainer(t,Zs)}has(t){return this.lookup(t)!==void 0}get(t){let n=this.lookup(t);return n?n[t]:void 0}set(t,n){let r=this;for(;r;){if(t in r.data){r.data[t]=n;return}r=r.parent}this.data[t]=n}child(t={},n=null){return new e(t,this,n!=null?n:this.el)}reactiveChild(t,n=null){return new e(Y(t),this,n!=null?n:this.el)}magicContainer(t,n){this.magicCache||(this.magicCache=new Map);let r=this.magicCache.get(t);if(r)return r;let o=n.get(t),i=this,s={};return Object.defineProperty(s,t,{get:()=>o(i),set:a=>{let l=o(i);l&&typeof l=="object"&&"set"in l&&l.set(a)},enumerable:!0,configurable:!0}),this.magicCache.set(t,s),s}},Ke=new St(Y({}));de();ce();ce();function pt(){return w.devtools===!0}function Ct(e){if(!e)return"(no element)";let t=e.tagName.toLowerCase();e.id&&(t+=`#${e.id}`);let n=(e.getAttribute("class")||"").trim().split(/\s+/).filter(Boolean);return n.length&&(t+=`.${n.slice(0,2).join(".")}`),`<${t}>`}function cn(e){pt()&&console.warn(`[Voodoo] ${e}`)}var ld=new Set;function Hr(e,t){pt()&&(ld.has(e)||(ld.add(e),console.warn(`[Voodoo] ${t}`)))}var Zm=new Set(["confirm-title","confirm-label","confirm-cancel","hold-duration"]);function cd(e,t,n){pt()&&(Zm.has(n)||Hr(`unknown-directive:${n}`,`unknown directive "${t}" at ${Ct(e)}. No directive named "${n}" was registered. Check the spelling or register with V.directive("${n}", ...).`))}function dd(e,t){Hr(`unknown-component:${t}`,`component "${t}" not registered at ${Ct(e)}. Register with V.component("${t}", { ... }) before using the tag, or remove the attribute to leave the element as plain HTML.`)}function ea(e,t,n,r){if(!pt())return;let o=r instanceof Error?r.message.split(`
`)[0]:String(r);cn(`invalid expression in ${t}="${n}" on element ${Ct(e)}.
Reason: ${o}
Suggestion: attribute expressions accept a single value. If the logic spans more than one line, move it to a component method and call the method here.`)}function ud(e,t,n){pt()&&cn(`duplicate key "${String(t)}" in v-for="${n}" on element ${Ct(e)}. Two rows with the same key cause the list to reuse the wrong block when reordering. Use a unique key, like the item id.`)}function fd(e,t,n){pt()&&cn(`required prop "${n}" missing from component "${t}" at ${Ct(e)}. Pass the value on the tag with ${n}="..." for a fixed value or :${n}="expression" for a state value.`)}function Nr(e,t){Hr(`alias:${e}`,`"${e}" is an alias for "${t}" and still works, but the official name is "${t}". Prefer "${t}" in new code.`)}var un=new WeakMap,Wo=new WeakMap,At=new WeakSet,Ko=new WeakMap;function oa(e){return At.has(e)}function ia(e){At.add(e)}function it(e){return un.get(e)}function Ce(e){let t=e;for(;t;){let n=un.get(t);if(n)return n;t=t.parentNode}return Ke}function bd(e,t){let n=Ko.get(e);n||Ko.set(e,n=[]),n.push(t)}function yd(e){var t;return(t=Ko.get(e))!=null?t:[]}var ta=new WeakSet;function sa(e){ta.add(e),e.remove()}function Be(e,t){let n=Wo.get(e);n||Wo.set(e,n=[]),n.push(t)}function G(e){if(e.nodeType===1){let n=[];for(let r=e.firstChild;r;r=r.nextSibling)(r.nodeType===1||r.nodeType===3)&&n.push(r);for(let r=n.length-1;r>=0;r--)G(n[r])}let t=Wo.get(e);if(t){Wo.delete(e);for(let n=t.length-1;n>=0;n--)try{t[n]()}catch(r){W(r,"cleanup")}}e.nodeType===1&&ov(e),un.delete(e),Ko.delete(e),At.delete(e)}var _o=new Map,ev=4e3;function Fn(e,t){let n=`${e}\0${t}`,r=_o.get(n);if(r!==void 0)return r;let o=tv(e,t);return _o.size>=ev&&_o.clear(),_o.set(n,o),o}function tv(e,t){let n=w.prefix,r;if(e.startsWith("@"))r=`on:${e.slice(1)}`;else if(e.startsWith(":")&&e.length>1)r=`bind:${e.slice(1)}`;else if(e.startsWith(".")&&e.length>1)r=`bind:${e.slice(1)}.prop`;else if(e.startsWith(n))r=e.slice(n.length);else if(e.startsWith("data-v-"))r=e.slice(7);else return null;if(!r)return null;let o=r.split("."),i=o.shift(),s={};for(let d of o){let u=d.indexOf("=");u>-1?s[d.slice(0,u)]=d.slice(u+1):s[d]=!0}let a=i.indexOf(":"),l=a>-1?i.slice(0,a):i,c=a>-1?i.slice(a+1):void 0;return{raw:e,name:l,arg:c,modifiers:s,expression:t}}function In(e){let t=[],n=It.get(e);if(n&&n.size)for(let[r,o]of n){let i=Fn(r,o);i&&(t.push(i),md(e,i.name))}else{let r=xd(e);for(let o=0;o<r.length;o++){let i=r[o];if(!rv(i))continue;let s=Fn(i,e.getAttribute(i));s&&(t.push(s),md(e,s.name))}}return t.length<2?t:t.sort((r,o)=>pd(o)-pd(r))}var nv=typeof Element!="undefined"&&!!Element.prototype.getAttributeNames;function xd(e){return nv?e.getAttributeNames():Array.from(e.attributes,t=>t.name)}function rv(e){return la(e)||e.charCodeAt(0)===46&&e.length>1}function pd(e){var t,n;return(n=(t=Mt.get(e.name))==null?void 0:t.priority)!=null?n:0}var Or=new Map,Yo=new WeakMap;function md(e,t){let n=Or.get(t);n||Or.set(t,n=new Set),n.add(e);let r=Yo.get(e);r||Yo.set(e,r=new Set),r.add(t)}function ov(e){var n;let t=Yo.get(e);if(t){for(let r of t)(n=Or.get(r))==null||n.delete(e);Yo.delete(e)}}function aa(e,t){var n;return(n=Or.get(t))!=null&&n.has(e)?!0:e.hasAttribute(`${w.prefix}${t}`)||e.hasAttribute(`data-v-${t}`)}function Xo(e,t){let n=[],r=Or.get(t),o=e;if(r)for(let s of r)s.isConnected&&o.contains&&o.contains(s)&&s!==o&&n.push(s);let i=new Set(n);for(let s of Array.from(e.querySelectorAll(`[${w.prefix}${t}],[data-v-${t}]`)))i.has(s)||(i.add(s),n.push(s));return n.sort((s,a)=>s.compareDocumentPosition(a)&window.Node.DOCUMENT_POSITION_FOLLOWING?-1:1),n}function zn(e,t){let n=e;for(;n;){if(aa(n,t))return n;n=n.parentElement}return null}var It=new WeakMap;function la(e){return e.startsWith(w.prefix)||e.startsWith("data-v-")||e.charCodeAt(0)===64||e.charCodeAt(0)===58&&e.length>1}function Te(e,t){var r;let n=(r=It.get(e))==null?void 0:r.get(t);return n!==void 0?n:e.getAttribute(t)}function zt(e,t){let n=It.get(e);return n!=null&&n.has(t)?!0:e.hasAttribute(t)}function wd(e){let t=It.get(e);if(t)return new Map(t);let n=new Map;for(let r=0;r<e.attributes.length;r++){let o=e.attributes[r];la(o.name)&&n.set(o.name,o.value)}return n}function iv(e){if(!w.cleanAttributes)return;let t=xd(e),n=It.get(e);n||It.set(e,n=new Map);for(let r=0;r<t.length;r++){let o=t[r];la(o)&&(n.set(o,e.getAttribute(o)),e.removeAttribute(o))}}function kd(e){let t=It.get(e);if(t){for(let[n,r]of t)if(!e.hasAttribute(n))try{e.setAttribute(n,r)}catch(o){}}}function ca(e){let t=It.get(e);return t&&t.size?!0:da(e)}function da(e){let t=e.attributes;for(let n=0;n<t.length;n++){let r=t[n].name;if(r.startsWith(w.prefix)||r.charCodeAt(0)===64||r.charCodeAt(0)===58||r.startsWith("data-v-"))return!0}return!1}function q(e,t,n,r){if(e)try{return P(ze(e),t)}catch(o){pt()&&ea(r!=null?r:t.el,n!=null?n:"expression",e,o),W(o,n?`${n} ("${e}")`:`expression "${e}"`);return}}var Ed=new WeakSet;function Go(e){Ed.add(e)}function vd(e,t,n){let r=Mt.get(t.name);if(!r){pt()&&t.raw.startsWith(w.prefix)&&cd(e,t.raw,t.name);return}let o=null,i=()=>{if(!o){let a=o=new ot(!0);Be(e,()=>a.stop()),bd(e,a)}return o},s={el:e,scope:n,expression:t.expression,arg:t.arg,modifiers:t.modifiers,raw:t.raw,evaluate(a){return q(a!=null?a:t.expression,n,t.raw,e)},effect(a){let l=i(),c=()=>{let d=dn;dn=e;try{a()}finally{dn=d}};l.run(()=>Pe(c,{scope:l}))},cleanup(a){Be(e,a)},walk(a,l){ne(a,l)}};try{r.setup(s)}catch(a){W(a,`directive ${t.raw}`)}}var na=null;function Td(e){na=e}var sv=new Set(["SCRIPT","STYLE","NOSCRIPT"]);function ne(e,t){let n=t!=null?t:Ce(e.parentNode);if(e.nodeType===11){let c=Array.from(e.childNodes);for(let d of c)ne(d,n);return}if(e.nodeType===3){Md(e,n);return}if(e.nodeType!==1)return;let r=e;if(At.has(r))return;let o=r.tagName;if(sv.has(o))return;if(r.hasAttribute(`${w.prefix}ignore`)||r.hasAttribute(`${w.prefix}pre`)){At.add(r);return}let i=n,s=In(r),a=He.size===0&&Bn.size===0||r.hasAttribute(`${w.prefix}component`)?null:vv(o);if(s.length===0&&!a){Ld(r,i);return}At.add(r);let l=dn;dn=r;try{lv(r,s,a,i)}finally{dn=l}}var dn=null;function ua(){return dn}function av(e,t,n){let r=null;try{r=ze(e)}catch(a){r=null}if(!(r&&r.t==="obj"&&r.props.every(a=>!a.spread&&!a.keyExpr))){let a=q(e,t,"v-data");return t.reactiveChild(a&&typeof a=="object"?a:{},n)}let i=t.reactiveChild({},n),s=r.props;for(let a of s)if(a.key!==null)try{if(a.getter){let l=P(a.value,i);Object.defineProperty(i.data,a.key,{enumerable:!0,configurable:!0,get:()=>l.call(i.data)})}else i.data[a.key]=P(a.value,i)}catch(l){pt()?ea(n,e,e,l):W(l,"v-data")}return i}function lv(e,t,n,r){let o=r;for(let d of t){let u=Mt.get(d.name);if(u!=null&&u.terminal){vd(e,d,o);return}}let i=t.find(d=>d.name==="data"),s=t.find(d=>d.name==="component"),a=s?s.expression||"":n||"",l=!1;if(a&&na){let d=na(e,a,o);d&&(o=d,l=!0,un.set(e,o))}else(i||s)&&(o=av(i&&i.expression||"{}",o,e),un.set(e,o));let c=l?r:o;for(let d of t)d.name==="data"||d.name==="component"||vd(e,d,c);iv(e),Ed.has(e)||Ld(e,o)}function Ld(e,t){var r;let n=[];for(let o=e.firstChild;o;o=o.nextSibling)o.nodeType===1?n.push(o):o.nodeType===3&&Md(o,t);for(let o of n)ne(o,(r=un.get(o))!=null?r:t)}var cv=500,hd=new Map;function dv(e){let t=e.trim();if(!t)return!1;let n=hd.get(t);if(n!==void 0)return n;let r=!0;try{r=ze(t).t!=="seq"}catch(o){r=!1}return hd.set(t,r),r}function uv(e,t){let n=0,r=null;for(let o=t;o<e.length;o++){let i=e[o];if(r){i==="\\"?o++:i===r&&(r=null);continue}if(i==='"'||i==="'"||i==="`"){r=i;continue}if(i==="{")n++;else if(i==="}"&&(n--,n===0))return o}return-1}function fv(e){let t=[],n="",r=0,o=()=>{n&&t.push({text:n}),n=""};for(;r<e.length;){let i=e.indexOf("{",r);if(i===-1){n+=e.slice(r);break}n+=e.slice(r,i);let s=e[i+1]==="{",a=s?e.indexOf("}}",i+2):uv(e,i);if(a===-1){n+=e[i],r=i+1;continue}let l=s?e.slice(i+2,a):e.slice(i+1,a),c=s?a+2:a+1;if((s||l.length<=cv)&&dv(l)){o(),t.push({expression:l.trim(),raw:e.slice(i,c),explicit:s}),r=c;continue}n+=e[i],r=i+1}return o(),t}var pv=new Set(["PRE","CODE","SCRIPT","STYLE","TEXTAREA"]);function mv(e,t,n){if(e.explicit||e.raw===void 0)return!1;let r;try{r=ze(e.expression)}catch(o){return!0}return r.t==="lit"?!0:t!==void 0?!1:r.t==="id"?n.lookup(r.n)===void 0&&!(r.n in Oe):!1}function Md(e,t){let n=e.textContent;if(!n||n.indexOf("{")===-1||At.has(e))return;let r=e.parentElement;for(;r;){if(pv.has(r.tagName)||r.hasAttribute(`${w.prefix}ignore`)||r.hasAttribute(`${w.prefix}pre`)||r.hasAttribute("data-v-ignore")||r.hasAttribute("data-v-pre"))return;r=r.parentElement}let o=fv(n);if(!o.some(s=>s.expression))return;At.add(e);let i=new ot(!0);Be(e,()=>i.stop()),bd(e,i),i.run(()=>Pe(()=>{let s="";for(let a of o){if(a.text!==void 0){s+=a.text;continue}let l=q(a.expression,t,"interpolation");s+=mv(a,l,t)?a.raw:Lt(l)}e.textContent!==s&&(e.textContent=s)},{scope:i}))}function Bt(e,t){un.set(e,t)}function vv(e){let t=e.toLowerCase();if(He.has(t))return t;let n=Bn.get(t);return n!=null?n:null}var Bn=new Map;var ra=!1,On=null,Sd=[];function Cd(e){Sd.push(e)}function gd(e,t){for(let n of Sd)try{n(e,t)}catch(r){console.error("[Voodoo] a start hook failed",r)}}function Ad(e){var n;if(typeof document=="undefined")return;let t=(n=e!=null?e:w.root)!=null?n:document.body;t&&(Object.assign(Oe,w.globals),gd(t,!1),ne(t,Ke),gd(t,!0),ra||(ra=!0,w.autoDiscover&&hv(t),document.dispatchEvent(new CustomEvent("voodoo:ready",{detail:{root:t}}))))}function hv(e){typeof MutationObserver!="undefined"&&(On=new MutationObserver(t=>{for(let n of t){for(let r=0;r<n.removedNodes.length;r++){let o=n.removedNodes[r];if(ta.has(o)){ta.delete(o);continue}o.nodeType===1&&!o.isConnected&&G(o)}for(let r=0;r<n.addedNodes.length;r++){let o=n.addedNodes[r];o.nodeType===1&&(At.has(o)||ne(o,Ce(o.parentNode)))}}}),On.observe(e,{childList:!0,subtree:!0}))}function Rd(){On==null||On.disconnect(),On=null,ra=!1}function $d(e){ne(e!=null?e:document.body,e?Ce(e.parentNode):Ke)}de();ce();var Rt=new Set,Dd=new Set;function jt(e,t){let n=ln(e);He.set(n,t),Bn.set(n.replace(/-/g,""),n),gv(n)}function gv(e){var r;if(typeof document=="undefined"||!document.body)return;let t=e.replace(/-/g,""),n=[e,t,`[${w.prefix}component="${e}"]`];for(let o of n){let i;try{i=Array.from(document.querySelectorAll(o))}catch(s){continue}for(let s of i){if((r=it(s))!=null&&r.component||bv(s))continue;let a=Ce(s.parentNode);oa(s)&&(G(s),kd(s)),ne(s,a)}}}function bv(e){let t=e.parentElement;for(;t&&t!==document.body;){if(da(t)&&!oa(t))return!0;t=t.parentElement}return!1}function yv(e,t){var n,r;if(!t||!t.type||t.type==="any")return e;if(e==null||e==="")return(n=t.default)!=null?n:e;switch(t.type){case"number":{let o=Number(e);return Number.isNaN(o)?(r=t.default)!=null?r:e:o}case"boolean":return e===""||e==="true"||e===!0||e==="1";case"string":return String(e);case"array":return Array.isArray(e)?e:[e];default:return e}}function xv(e){let t={};if(Array.isArray(e.props))for(let n of e.props)t[n]={type:"any"};else e.props&&Object.assign(t,e.props);return t}function fa(e){return e.replace(/-(\w)/g,(t,n)=>n.toUpperCase())}function wv(e,t,n,r,o){var c;let i=Y({}),s=Object.keys(t),a=new Map;for(let d of s)a.set(d.toLowerCase(),d),a.set(ln(d),d),a.set(fa(d).toLowerCase(),d);for(let d of s)t[d].default!==void 0&&(i[d]=t[d].default);let l=Array.from(e.attributes);for(let d of l){let u=Fn(d.name,d.value);if(u&&u.name==="bind"&&u.arg){let p=(c=a.get(u.arg.toLowerCase()))!=null?c:fa(u.arg);if(s.length&&!a.has(u.arg.toLowerCase()))continue;r.run(()=>Pe(()=>{i[p]=q(u.expression,n,`:${u.arg}`)}));continue}if(u)continue;let f=a.get(d.name.toLowerCase());f?i[f]=yv(d.value,t[f]):s.length||(i[fa(d.name)]=d.value)}for(let d of s)t[d].required&&i[d]===void 0&&fd(e,o,d);return i}function kv(e,t,n){let r=Array.from(e.querySelectorAll("slot"));if(!r.length)return;let o=new Map,i=[];Array.from(t.childNodes).forEach(s=>{var l,c;let a=s.nodeType===1&&(l=s.getAttribute("slot"))!=null?l:null;if(a){s.removeAttribute("slot");let d=(c=o.get(a))!=null?c:[];d.push(s),o.set(a,d)}else i.push(s)});for(let s of r){let a=s.getAttribute("name"),l=a?o.get(a):i,c=document.createDocumentFragment();if(l&&l.length)for(let d of l)c.appendChild(d);else for(;s.firstChild;)c.appendChild(s.firstChild);Array.from(c.childNodes).forEach(d=>{d.nodeType===1&&Ev(d,n)}),s.replaceWith(c)}}var Qo=null;function Pd(e){Qo=e}function Ev(e,t){Qo==null||Qo(e,t)}function Hd(e,t,n){var E,C,D,A,se,O,me,ae;let r=t?ln(t):"",o=r?(D=(C=He.get(r))!=null?C:He.get((E=Bn.get(r))!=null?E:""))!=null?D:{}:{};r&&!He.has(r)&&!Bn.has(r)&&dd(e,t);let i=new ot(!0),s=xv(o),a=wv(e,s,n,i,r||"inline");!o.state&&o.data&&Nr("data()","state()"),o.destroyed&&Nr("destroyed()","unmounted()");let l=(A=o.state)!=null?A:o.data,c={},d={},u=o.inheritScope?n:n.root,f=new St({},u,e);f.component=d;try{c=l?(se=l.call(d,a))!=null?se:{}:{}}catch(R){W(R,`state() of component "${t}"`)}let p=e.getAttribute(`${w.prefix}data`);if(p){let R=q(p,n,"v-data");R&&typeof R=="object"&&Object.assign(c,R)}if(o.provide)try{let R=typeof o.provide=="function"?o.provide.call(d):o.provide;R&&typeof R=="object"&&(f.provides={...R})}catch(R){W(R,`provide() of component "${t}"`)}if(o.inject){let R=Array.isArray(o.inject)?o.inject.map(S=>[S,{from:S}]):Object.entries(o.inject).map(([S,B])=>[S,B!=null?B:{}]);for(let[S,B]of R){let _e=(O=B.from)!=null?O:S,We=n.inject(_e,B.default);S in c||(c[S]=We)}}let m=Y(c),h={};if(o.computed)for(let[R,S]of Object.entries(o.computed))h[R]=an(()=>S.call(d));let v={};if(o.methods)for(let[R,S]of Object.entries(o.methods))v[R]=(...B)=>S.apply(d,B);for(let[R,S]of Object.entries(o))typeof S=="function"&&(Tv.has(R)||R==="state"||R==="data"||R in v||(v[R]=(...B)=>S.apply(d,B)));let g=(R,S)=>{let B=new CustomEvent(R,{detail:S,bubbles:!0,cancelable:!0});B.__voodoo=!0,e.dispatchEvent(B)},b={$el:e,$props:a,$name:r||"inline",$scope:f,$parent:(ae=(me=n.owner)==null?void 0:me.component)!=null?ae:null,emit:g,$emit:g,$nextTick:R=>Promise.resolve().then(()=>(de(),Kc)).then(S=>S.nextTick(R)),$watch:(R,S)=>Ie(()=>q(R,f),S)},x={get(R,S){if(typeof S!="symbol")return S==="$refs"?f.allRefs:S in b?b[S]:S in h?h[S].value:S in v?v[S]:S in a?a[S]:m[S]},set(R,S,B){return typeof S=="symbol"?!0:S in h?(h[S].value=B,!0):S in a?(a[S]=B,!0):(m[S]=B,!0)},has(R,S){if(typeof S=="symbol")return!1;let B=S;return B==="$refs"||B in b||B in h||B in v||B in a||B in m},ownKeys(){return[...new Set([...Object.keys(m),...Object.keys(a),...Object.keys(v),...Object.keys(h)])]},getOwnPropertyDescriptor(){return{enumerable:!0,configurable:!0}}},T=new Proxy(d,x);if(f.data=T,Object.setPrototypeOf(d,T),o.watch)for(let[R,S]of Object.entries(o.watch))i.run(()=>Ie(()=>T[R],(B,_e)=>S.call(T,B,_e)));if(o.style&&!Dd.has(r)){Dd.add(r);let R=document.createElement("style");R.setAttribute("data-voodoo-component",r),R.textContent=o.style,document.head.appendChild(R)}if(jn(o,T,"beforeMount"),o.template){let R=document.createDocumentFragment();for(;e.firstChild;)R.appendChild(e.firstChild);e.innerHTML=o.template,kv(e,R,n)}return Rt.add(T),Se(()=>{jn(o,T,"mounted"),o.updated&&i.run(()=>Pe(()=>{for(let R of Object.keys(m))m[R];jn(o,T,"updated")}))}),Be(e,()=>{jn(o,T,"beforeUnmount"),i.stop(),Rt.delete(T),jn(o,T,"unmounted"),jn(o,T,"destroyed")}),f}var Tv=new Set(["beforeMount","mounted","updated","beforeUnmount","unmounted","destroyed"]);function jn(e,t,n){let r=e[n];if(typeof r=="function")try{r.call(t)}catch(o){W(o,`hook ${n}`)}}de();ce();var qn=[],pa=null,Jo=0,Nd=-1,va=0,ma=!1;function Od(){return typeof performance!="undefined"&&performance.now?performance.now():Date.now()}function Lv(){if(pa||typeof MutationObserver=="undefined"||typeof document=="undefined")return;let e=document.documentElement;e&&(pa=new MutationObserver(()=>{Jo++}),pa.observe(e,{childList:!0,subtree:!0}))}function Fd(){if(ma)return;ma=!0;let e=()=>{ma=!1,Mv()};if(typeof requestAnimationFrame=="function"){let t=!1,n=()=>{t||(t=!0,e())};requestAnimationFrame(n),setTimeout(n,32);return}setTimeout(e,0)}function Mv(){var t;Jo===Nd?va++:va=0,Nd=Jo;let e=Od();for(let n=qn.length-1;n>=0;n--){let r=qn[n],o=null;try{o=r.ready()}catch(i){o=null}if(o){qn.splice(n,1),r.action(o);continue}e-r.since>1e4&&(qn.splice(n,1),(t=r.onGiveUp)==null||t.call(r))}qn.length&&Fd()}function ha(e){let t=null;try{t=e.ready()}catch(n){t=null}if(t){e.action(t);return}Lv(),qn.push({...e,since:Od()}),Fd()}function Id(){return typeof document=="undefined"||!document.body?!1:va>=2}function Sv(){return typeof document=="undefined"||!document.body?!1:Jo===0}function Fr(e){typeof document!="undefined"&&ha({ready:()=>Id()?document.body:null,action:()=>e(),onGiveUp:()=>{document.body&&e()}})}function zd(e){if(typeof document!="undefined"){if(Sv()){Promise.resolve().then(e);return}ha({ready:()=>Id()?document.body:null,action:()=>e(),onGiveUp:()=>{document.body&&e()}})}}function Zo(e,t,n){if(typeof e!="string"){t(e);return}typeof document!="undefined"&&ha({ready:()=>document.querySelector(e),action:r=>t(r),onGiveUp:n})}var Cv=0,ei=null;function Bd(e){ei=e}function jd(e={}){let t=`voodoo-app-${++Cv}`,{components:n,...r}=e,o={globalProperties:{}},i={},s=[],a=null,l="",c=null,d=[];function u(){if(n)for(let[m,h]of Object.entries(n)){let v=ln(m);He.has(v)||(jt(v,h),s.push(v))}}function f(m){var v,g;if(c)return c;a=m,l=m.innerHTML,Object.assign(Oe,o.globalProperties),u();let h={...r};if(Object.keys(i).length){let b=h.provide;h.provide=()=>({...typeof b=="function"?b():b!=null?b:{},...i})}jt(t,h),m.setAttribute(`${w.prefix}component`,t);try{ne(m,Ke)}catch(b){return W(b,`application mounting "${t}"`),null}if(c=(g=(v=it(m))==null?void 0:v.component)!=null?g:null,c){let b=d;d=[];for(let x of b)x(c)}return c}let p={name:t,config:o,get instance(){return c},get container(){return a},get isMounted(){return c!==null},component(m,h){var g;let v=ln(m);return h===void 0?(g=n&&n[m])!=null?g:He.get(v):(n?n[m]=h:e.components={[m]:h},c&&!He.has(v)&&(jt(v,h),s.push(v)),p)},directive(m,h){return ei==null||ei(m,h),p},use(m,h){return Uo(Av(),m,h),p},provide(m,h){return i[m]=h,p},mount(m){if(c)return c;if(typeof m!="string")return f(m);let h=null;return Zo(m,v=>{h=f(v)},()=>{console.warn(`[Voodoo] createApp().mount("${m}") did not find the element. The application remains unmounted.`)}),h},whenMounted(){return c?Promise.resolve(c):new Promise(m=>d.push(m))},unmount(){if(a){G(a),a.removeAttribute(`${w.prefix}component`),a.innerHTML=l,He.delete(t);for(let m of s)He.delete(m);s.length=0,c=null,a=null}}};return p}var qd=null;function Vd(e){qd=e}function Av(){return qd}de();de();var qt=new Map,ga=Ge(0),ba=new Map;function ti(e,t,n={}){let r=qt.get(e);if(!t){if(!r){let l=Y({});return qt.set(e,l),l}return r}if(r)return Object.assign(r,t),r;let o=typeof n.persist=="string"?n.persist:`voodoo:store:${e}`,i=Object.getOwnPropertyDescriptors(t),s=Object.defineProperties({},i);if(n.persist&&typeof localStorage!="undefined")try{let l=localStorage.getItem(o);if(l){let c=JSON.parse(l);for(let[d,u]of Object.entries(c))i[d]&&!("value"in i[d])||(s[d]=u)}}catch(l){}let a=Y(s);for(let[l,c]of Object.entries(i)){let d=c.value;typeof d=="function"&&(a[l]=(...u)=>d.apply(a,u))}if(qt.set(e,a),ga.value++,n.persist&&typeof localStorage!="undefined"){let l=Ie(a,()=>{try{localStorage.setItem(o,JSON.stringify(Rv(a)))}catch(c){}},{deep:!0});ba.set(e,l)}return a}function Rv(e){let t={},n=Object.getOwnPropertyDescriptors(Me(e));for(let[r,o]of Object.entries(e))typeof o!="function"&&(n[r]&&!("value"in n[r])||(t[r]=o));return t}var $t=new Proxy({},{get:(e,t)=>(ga.value,qt.get(t)),has:(e,t)=>(ga.value,qt.has(t)),ownKeys:()=>[...qt.keys()],getOwnPropertyDescriptor:()=>({enumerable:!0,configurable:!0})});function Ud(e){var t;(t=ba.get(e))==null||t(),ba.delete(e),qt.delete(e)}function ni(){return[...qt.keys()]}var Ea={};Ho(Ea,{capitalize:()=>_d,chunk:()=>Fv,clone:()=>Ir,debounce:()=>Ye,device:()=>ve,escapeHtml:()=>I,formatCurrency:()=>ya,formatDate:()=>wa,formatFileSize:()=>Uv,formatNumber:()=>xa,formatPercent:()=>_v,get:()=>Br,groupBy:()=>Nv,isBrowser:()=>ri,matchesMedia:()=>Vn,memoize:()=>Hv,merge:()=>oi,once:()=>Pv,parseDuration:()=>Q,random:()=>Bv,relativeTime:()=>ka,sample:()=>jv,set:()=>zv,setFormatDefaults:()=>si,sleep:()=>Dv,slugify:()=>qv,sortBy:()=>Iv,stripTags:()=>Vv,throttle:()=>zr,titleCase:()=>jr,truncate:()=>ii,uid:()=>le,unique:()=>Ov,uuid:()=>$v});function $v(){let e=globalThis.crypto;if(e!=null&&e.randomUUID)return e.randomUUID();if(e!=null&&e.getRandomValues){let t=e.getRandomValues(new Uint8Array(16));t[6]=t[6]&15|64,t[8]=t[8]&63|128;let n=Array.from(t,r=>r.toString(16).padStart(2,"0")).join("");return`${n.slice(0,8)}-${n.slice(8,12)}-${n.slice(12,16)}-${n.slice(16,20)}-${n.slice(20)}`}return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,t=>{let n=Math.random()*16|0;return(t==="x"?n:n&3|8).toString(16)})}function le(e="v"){return`${e}${Math.random().toString(36).slice(2,9)}`}function Dv(e){return new Promise(t=>setTimeout(t,e))}function Q(e,t=0){if(e==null||e==="")return t;if(typeof e=="number")return e;let n=/^\s*([\d.]+)\s*(ms|s|m|h)?\s*$/i.exec(String(e));if(!n)return t;let r=parseFloat(n[1]);switch((n[2]||"ms").toLowerCase()){case"s":return r*1e3;case"m":return r*6e4;case"h":return r*36e5;default:return r}}function Ye(e,t=250,n=!1){let r=null,o=null,i,s=function(...a){o=a,i=this;let l=n&&r===null;r&&clearTimeout(r),r=setTimeout(()=>{r=null,!n&&o&&e.apply(i,o)},t),l&&e.apply(this,a)};return s.cancel=()=>{r&&clearTimeout(r),r=null,o=null},s.flush=()=>{r&&o&&(clearTimeout(r),r=null,e.apply(i,o))},s}function zr(e,t=250){let n=0,r=null,o=null,i=function(...s){let a=Date.now();o=s;let l=t-(a-n);l<=0?(r&&(clearTimeout(r),r=null),n=a,e.apply(this,s)):r||(r=setTimeout(()=>{n=Date.now(),r=null,o&&e.apply(this,o)},l))};return i.cancel=()=>{r&&clearTimeout(r),r=null},i.flush=()=>{r&&o&&(clearTimeout(r),r=null,e.apply(null,o))},i}function Pv(e){let t=!1,n;return function(...r){return t||(t=!0,n=e.apply(this,r)),n}}function Hv(e,t=(...n)=>JSON.stringify(n)){let n=new Map,r=function(...o){let i=t(...o);if(n.has(i))return n.get(i);let s=e.apply(this,o);return n.set(i,s),s};return r.cache=n,r}function Ir(e){if(e===null||typeof e!="object")return e;if(typeof structuredClone=="function")try{return structuredClone(e)}catch(n){}if(Array.isArray(e))return e.map(n=>Ir(n));if(e instanceof Date)return new Date(e.getTime());if(e instanceof Map)return new Map([...e].map(([n,r])=>[n,Ir(r)]));if(e instanceof Set)return new Set([...e].map(n=>Ir(n)));let t={};for(let[n,r]of Object.entries(e))t[n]=Ir(r);return t}function oi(e,...t){for(let n of t)if(n)for(let[r,o]of Object.entries(n)){let i=e[r];o&&typeof o=="object"&&!Array.isArray(o)&&i&&typeof i=="object"&&!Array.isArray(i)?e[r]=oi({...i},o):e[r]=o}return e}function Nv(e,t){let n={},r=typeof t=="function"?t:o=>o==null?void 0:o[t];for(let o of e){let i=String(r(o));(n[i]||(n[i]=[])).push(o)}return n}function Ov(e,t){if(!t)return[...new Set(e)];let n=typeof t=="function"?t:i=>i==null?void 0:i[t],r=new Set,o=[];for(let i of e){let s=n(i);r.has(s)||(r.add(s),o.push(i))}return o}function Fv(e,t=10){if(t<1)return[e];let n=[];for(let r=0;r<e.length;r+=t)n.push(e.slice(r,r+t));return n}function Iv(e,t,n="asc"){let r=typeof t=="function"?t:i=>i==null?void 0:i[t],o=n==="desc"?-1:1;return[...e].sort((i,s)=>{let a=r(i),l=r(s);return a==null&&l==null?0:a==null?1:l==null?-1:typeof a=="string"&&typeof l=="string"?a.localeCompare(l,void 0,{numeric:!0})*o:(a>l?1:a<l?-1:0)*o})}function Br(e,t,n){let r=t.split("."),o=e;for(let i of r){if(o==null)return n;o=o[i]}return o!=null?o:n}function zv(e,t,n){let r=t.split("."),o=e;for(let i=0;i<r.length-1;i++){let s=r[i];(typeof o[s]!="object"||o[s]===null)&&(o[s]=/^\d+$/.test(r[i+1])?[]:{}),o=o[s]}o[r[r.length-1]]=n}function Bv(e=0,t=1){return Math.floor(Math.random()*(t-e+1))+e}function jv(e){return e[Math.floor(Math.random()*e.length)]}function qv(e,t="-"){return String(e).normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().trim().replace(/[^a-z0-9]+/g,t).replace(new RegExp(`\\${t}{2,}`,"g"),t).replace(new RegExp(`^\\${t}|\\${t}$`,"g"),"")}function ii(e,t=100,n="..."){let r=String(e!=null?e:"");return r.length<=t?r:r.slice(0,Math.max(0,t-n.length)).trimEnd()+n}function _d(e){let t=String(e!=null?e:"");return t.charAt(0).toUpperCase()+t.slice(1)}function jr(e){return String(e!=null?e:"").replace(/\w\S*/g,t=>_d(t.toLowerCase()))}function I(e){return String(e!=null?e:"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Vv(e){return String(e!=null?e:"").replace(/<\/?[^>]+(>|$)/g,"")}var Un="pt-BR",Wd="BRL";function si(e,t){e&&(Un=e),t&&(Wd=t)}function ya(e,t={}){var r,o;let n=typeof e=="string"?parseFloat(e):e;return n==null||Number.isNaN(n)?"":new Intl.NumberFormat((r=t.locale)!=null?r:Un,{style:"currency",currency:(o=t.currency)!=null?o:Wd}).format(n)}function xa(e,t={}){let n=typeof e=="string"?parseFloat(e):e;if(n==null||Number.isNaN(n))return"";let{locale:r,...o}=t;return new Intl.NumberFormat(r!=null?r:Un,o).format(n)}function wa(e,t="short",n){let r=e instanceof Date?e:new Date(e);if(Number.isNaN(r.getTime()))return"";let o=n!=null?n:Un;if(typeof t=="object")return new Intl.DateTimeFormat(o,t).format(r);let i={short:{day:"2-digit",month:"2-digit",year:"numeric"},long:{day:"2-digit",month:"long",year:"numeric"},full:{dateStyle:"full"},time:{hour:"2-digit",minute:"2-digit"},datetime:{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}};if(i[t])return new Intl.DateTimeFormat(o,i[t]).format(r);let s=a=>String(a).padStart(2,"0");return t.replace(/YYYY/g,String(r.getFullYear())).replace(/YY/g,String(r.getFullYear()).slice(-2)).replace(/MM/g,s(r.getMonth()+1)).replace(/DD/g,s(r.getDate())).replace(/HH/g,s(r.getHours())).replace(/mm/g,s(r.getMinutes())).replace(/ss/g,s(r.getSeconds()))}function ka(e,t){let n=e instanceof Date?e:new Date(e);if(Number.isNaN(n.getTime()))return"";let r=n.getTime()-Date.now(),o=Math.abs(r),i=[["year",31536e6],["month",2592e6],["week",6048e5],["day",864e5],["hour",36e5],["minute",6e4],["second",1e3]],s=new Intl.RelativeTimeFormat(t!=null?t:Un,{numeric:"auto"});for(let[a,l]of i)if(o>=l||a==="second")return s.format(Math.round(r/l),a);return""}function Uv(e,t=1){let n=Number(e);if(!n||Number.isNaN(n))return"0 B";let r=["B","KB","MB","GB","TB","PB"],o=Math.min(Math.floor(Math.log(Math.abs(n))/Math.log(1024)),r.length-1);return`${(n/1024**o).toFixed(o===0?0:t)} ${r[o]}`}function _v(e,t=0,n){return new Intl.NumberFormat(n!=null?n:Un,{style:"percent",minimumFractionDigits:t,maximumFractionDigits:t}).format(e)}var ri=typeof window!="undefined"&&typeof window.document!="undefined";function Vn(e){if(!ri||typeof window.matchMedia!="function")return!1;try{return window.matchMedia(e).matches}catch(t){return!1}}var ve={get touch(){return ri&&("ontouchstart"in window||navigator.maxTouchPoints>0)},get mobile(){return Vn("(max-width: 767px)")},get tablet(){return Vn("(min-width: 768px) and (max-width: 1023px)")},get desktop(){return Vn("(min-width: 1024px)")},get online(){return!ri||navigator.onLine},get reducedMotion(){return Vn("(prefers-reduced-motion: reduce)")},get darkMode(){return Vn("(prefers-color-scheme: dark)")}};var Ee=class extends Error{constructor(n,r,o,i){super(n);H(this,"response",r);H(this,"config",o);H(this,"cause",i);this.name="HttpError"}get status(){var n,r;return(r=(n=this.response)==null?void 0:n.status)!=null?r:0}get isNetworkError(){return!this.response}},Ne={baseURL:"",headers:{Accept:"application/json, text/html, */*"},timeout:3e4,retry:0,retryDelay:500,credentials:"same-origin",csrfMeta:"csrf-token",csrfHeader:"X-CSRF-TOKEN"},ai=[],li=[],qr=[],Vr=new Map;function Kd(e){var t;return`${(t=e.method)!=null?t:"GET"} ${Wn(e)}`}function Wv(e){if(!e){Vr.clear();return}let t=typeof e=="string"?n=>n.includes(e):n=>e.test(n);for(let n of[...Vr.keys()])t(n)&&Vr.delete(n)}var Xd="voodoo:offline-queue";function Ta(){try{return JSON.parse(localStorage.getItem(Xd)||"[]")}catch(e){return[]}}function La(e){try{localStorage.setItem(Xd,JSON.stringify(e))}catch(t){}}function Kv(e){var n,r;if(typeof localStorage=="undefined")return;let t=Ta();t.push({url:Wn(e),method:(n=e.method)!=null?n:"POST",body:e.body,headers:(r=e.headers)!=null?r:{},at:Date.now()}),La(t)}async function Gd(){if(typeof localStorage=="undefined")return 0;let e=Ta();if(!e.length)return 0;La([]);let t=0;for(let n=0;n<e.length;n++){let r=e[n];try{await Vt({url:r.url,method:r.method,body:r.body,headers:r.headers,offlineQueue:!1}),t++}catch(o){let i=Ta();La([...e.slice(n),...i]);break}}return t}typeof window!="undefined"&&window.addEventListener("online",()=>{Gd()});function Wn(e){let t=e.url,n=Ne.baseURL;if(n&&!/^https?:\/\//i.test(t)&&!t.startsWith("//")&&(t=`${n.replace(/\/$/,"")}/${t.replace(/^\//,"")}`),e.params){let r=new URLSearchParams;for(let[i,s]of Object.entries(e.params))s==null||s===""||r.append(i,String(s));let o=r.toString();o&&(t+=(t.includes("?")?"&":"?")+o)}return t}function Qd(){var t;if(typeof document=="undefined")return null;let e=document.querySelector(`meta[name="${Ne.csrfMeta}"]`);return(t=e==null?void 0:e.getAttribute("content"))!=null?t:null}function Yv(e,t){if(e!=null)return typeof FormData!="undefined"&&e instanceof FormData||typeof Blob!="undefined"&&e instanceof Blob||typeof URLSearchParams!="undefined"&&e instanceof URLSearchParams||typeof ArrayBuffer!="undefined"&&e instanceof ArrayBuffer||typeof e=="string"?e:(t["Content-Type"]||(t["Content-Type"]="application/json"),JSON.stringify(e))}async function Xv(e,t){if(e.status===204||e.status===205)return null;let n=e.headers.get("content-type")||"";switch(t){case"json":return e.json();case"text":return e.text();case"blob":return e.blob();case"arrayBuffer":return e.arrayBuffer();case"formData":return e.formData();default:if(n.includes("application/json")||n.includes("+json")){let r=await e.text();return r?JSON.parse(r):null}return e.text()}}var Gv=new Set(["GET","HEAD","OPTIONS"]);function Qv(e){for(let[t,n]of Object.entries(e))if(t.toLowerCase()==="idempotency-key"&&String(n).trim()!=="")return!0;return!1}function Jv(e,t,n,r){var o;return Gv.has(e)||t.retryUnsafe===!0||Qv(n)?!0:(((o=t.retry)!=null?o:0)>0&&Hr(`http:retry-unsafe:${e} ${r}`,`retry ignored on ${e} ${r}: retrying a method that changes state may apply the same operation twice if the response is lost in transit. Allow with retryUnsafe: true or send an Idempotency-Key header.`),!1)}async function Vt(e){var d,u,f,p,m;let t={method:"GET",timeout:Ne.timeout,retry:Ne.retry,retryDelay:Ne.retryDelay,credentials:Ne.credentials,responseType:"auto",...e,headers:{...Ne.headers,...e.headers}};for(let h of ai)t=await h(t);let n=((d=t.method)!=null?d:"GET").toUpperCase();if(t.cache&&n==="GET"){let h=Vr.get(Kd(t));if(h&&h.expires>Date.now())return h.value}if(t.offlineQueue&&typeof navigator!="undefined"&&navigator.onLine===!1&&n!=="GET")return Kv(t),{data:null,status:0,statusText:"offline-queued",headers:new Headers,ok:!0,raw:new Response(null,{status:202}),config:t};let r={...t.headers};if(n!=="GET"&&n!=="HEAD"){let h=Qd();h&&!r[Ne.csrfHeader]&&(r[Ne.csrfHeader]=h)}r["X-Requested-With"]||(r["X-Requested-With"]="XMLHttpRequest");let o=Yv(t.body,r),i=Wn(t),s=Jv(n,t,r,i)?((u=t.retry)!=null?u:0)+1:1,a;for(let h=0;h<s;h++){let v=new AbortController,g=t.signal,b=null;g&&(g.aborted?v.abort(g.reason):(b=()=>v.abort(g.reason),g.addEventListener("abort",b,{once:!0})));let x=()=>{b&&g&&g.removeEventListener("abort",b),b=null},T=t.timeout&&t.timeout>0?setTimeout(()=>v.abort(new DOMException("timeout","TimeoutError")),t.timeout):null;try{let E=await fetch(i,{method:n,headers:r,body:n==="GET"||n==="HEAD"?void 0:o,credentials:t.credentials,signal:v.signal});T&&clearTimeout(T),x();let D={data:await Xv(E,t.responseType),status:E.status,statusText:E.statusText,headers:E.headers,ok:E.ok,raw:E,config:t};if(!E.ok){if(E.status>=500&&h<s-1){await Yd(((f=t.retryDelay)!=null?f:500)*2**h);continue}let A=new Ee(`Request failed with status ${E.status}`,D,t);for(let se of qr)se(A);throw A}for(let A of li)D=await A(D);return t.cache&&n==="GET"&&Vr.set(Kd(t),{expires:Date.now()+t.cache,value:D}),D}catch(E){if(T&&clearTimeout(T),x(),E instanceof Ee)throw E;if(a=E,(E==null?void 0:E.name)==="AbortError"&&((p=t.signal)==null?void 0:p.aborted))break;if(h<s-1){await Yd(((m=t.retryDelay)!=null?m:500)*2**h);continue}}}let l=(a==null?void 0:a.name)==="TimeoutError"?`Timeout after ${t.timeout}ms`:`Network failure accessing ${i}`,c=new Ee(l,void 0,t,a);for(let h of qr)h(c);throw c}function Yd(e){return new Promise(t=>setTimeout(t,e))}async function _n(e){return(await Vt(e)).data}var he={defaults:Ne,get(e,t={}){return _n({...t,url:e,method:"GET"})},post(e,t,n={}){return _n({...n,url:e,method:"POST",body:t})},put(e,t,n={}){return _n({...n,url:e,method:"PUT",body:t})},patch(e,t,n={}){return _n({...n,url:e,method:"PATCH",body:t})},delete(e,t={}){return _n({...t,url:e,method:"DELETE"})},head(e,t={}){return _n({...t,url:e,method:"HEAD"})},request:Vt,upload(e,t,n={}){return new Promise((r,o)=>{var l,c;let i=new XMLHttpRequest,s=Wn({url:e});i.open((l=n.method)!=null?l:"POST",s);for(let[d,u]of Object.entries({...Ne.headers,...n.headers}))d.toLowerCase()!=="content-type"&&i.setRequestHeader(d,u);let a=Qd();a&&i.setRequestHeader(Ne.csrfHeader,a),i.upload.addEventListener("progress",d=>{var u;d.lengthComputable&&((u=n.onProgress)==null||u.call(n,Math.round(d.loaded/d.total*100),d.loaded,d.total))}),i.addEventListener("load",()=>{let d=i.getResponseHeader("content-type")||"",u=i.responseText;if(d.includes("json"))try{u=JSON.parse(i.responseText)}catch(f){}i.status>=200&&i.status<300?r(u):o(new Ee(`Upload failed with status ${i.status}`))}),i.addEventListener("error",()=>o(new Ee("Network failure during upload"))),i.addEventListener("abort",()=>o(new Ee("Upload canceled"))),(c=n.signal)==null||c.addEventListener("abort",()=>i.abort()),i.send(t)})},sse(e,t={}){let n=new EventSource(Wn({url:e}));return n.addEventListener("message",r=>{var i;let o=r.data;try{o=JSON.parse(r.data)}catch(s){}(i=t.message)==null||i.call(t,o,r)}),t.error&&n.addEventListener("error",t.error),n},async stream(e,t,n={}){var a;let r=await fetch(Wn({url:e,params:n.params}),{headers:{...Ne.headers,...n.headers},signal:n.signal});if(!r.body)return;let o=r.body.getReader(),i=new TextDecoder,s="";for(;;){let{done:l,value:c}=await o.read();if(l)break;s+=i.decode(c,{stream:!0});let d=s.split(`
`);s=(a=d.pop())!=null?a:"";for(let u of d)u.trim()&&t(u)}s.trim()&&t(s)},interceptors:{request:{use(e){return ai.push(e),()=>{let t=ai.indexOf(e);t>-1&&ai.splice(t,1)}}},response:{use(e){return li.push(e),()=>{let t=li.indexOf(e);t>-1&&li.splice(t,1)}}},error:{use(e){return qr.push(e),()=>{let t=qr.indexOf(e);t>-1&&qr.splice(t,1)}}}},setHeader(e,t){t===null?delete Ne.headers[e]:Ne.headers[e]=t},setToken(e,t="Bearer"){this.setHeader("Authorization",e?`${t} ${e}`:null)},setBaseURL(e){Ne.baseURL=e},clearCache:Wv,flushOfflineQueue:Gd,parseDuration:Q};Ae();var Zv=`
...
`,eh={success:"ok",error:"!",warning:"!",info:"i",loading:"",default:""},Ur=new Map,Ut={duration:4e3,position:"top-right",max:6};function th(e){ge(),Z("toast",Zv);let t=Ur.get(e);return t&&t.isConnected||(t=document.createElement("div"),t.className="v-toaster",t.setAttribute("data-pos",e),t.setAttribute("role","region"),t.setAttribute("aria-label","Notifications"),document.body.appendChild(t),Ur.set(e,t)),t}function fn(e){var f,p,m,h;let t=(f=e.position)!=null?f:Ut.position,n=(p=e.type)!=null?p:"default",r=(m=e.duration)!=null?m:n==="loading"?0:Ut.duration,o=th(t),i=le("toast-"),s=document.createElement("div");s.className="v-toast",s.id=i,s.setAttribute("data-type",n),s.setAttribute("role",n==="error"?"alert":"status"),s.setAttribute("aria-live",n==="error"?"assertive":"polite"),s.setAttribute("aria-atomic","true");let a=!1,l=null,c=()=>{a||(a=!0,l&&clearTimeout(l),s.classList.add("v-out"),s.classList.remove("v-in"),setTimeout(()=>{var v;s.remove(),(v=e.onClose)==null||v.call(e),o.children.length||(o.remove(),Ur.delete(t))},220))},d=v=>{var x,T,E,C;let g=(x=v.type)!=null?x:n;if(s.setAttribute("data-type",g),v.html)s.innerHTML=v.html;else{s.textContent="";let D=document.createElement("span");D.className="v-toast-icon",D.setAttribute("aria-hidden","true"),D.textContent=(T=eh[g])!=null?T:"",s.appendChild(D);let A=document.createElement("div");A.className="v-toast-body";let se=document.createElement("div");if(se.className="v-toast-title",se.textContent=(E=v.title)!=null?E:"",A.appendChild(se),v.description){let O=document.createElement("div");O.className="v-toast-desc",O.textContent=v.description,A.appendChild(O)}if(s.appendChild(A),v.action){let O=document.createElement("button");O.type="button",O.className="v-toast-action",O.textContent=v.action.label,O.addEventListener("click",()=>{var me;(me=v.action)==null||me.onClick(),c()}),s.appendChild(O)}if(v.closable!==!1&&g!=="loading"){let O=document.createElement("button");O.type="button",O.className="v-toast-close",O.setAttribute("aria-label","Close notification"),O.innerHTML="&times;",O.addEventListener("click",c),s.appendChild(O)}}let b=(C=v.duration)!=null?C:r;if(b>0){let D=document.createElement("div");D.className="v-toast-bar",D.style.animation=`v-toast-bar ${b}ms linear forwards`,s.appendChild(D)}};for(d(e),o.appendChild(s),requestAnimationFrame(()=>s.classList.add("v-in"));o.children.length>Ut.max;)(h=o.firstElementChild)==null||h.remove();let u=v=>{l&&clearTimeout(l),v>0&&(l=setTimeout(c,v))};return u(r),s.addEventListener("mouseenter",()=>{l&&clearTimeout(l)}),s.addEventListener("mouseleave",()=>u(r)),{id:i,close:c,update(v){var g;d({...e,...v}),v.duration!==void 0?u(v.duration):((g=v.type)!=null?g:n)!=="loading"&&u(Ut.duration)}}}function Kn(e,t){return typeof e=="string"?{title:e,type:t}:{type:t,...e}}var st=Object.assign((e,t={})=>fn({...Kn(e,"default"),...t}),{success:(e,t={})=>fn({...Kn(e,"success"),...t}),error:(e,t={})=>fn({...Kn(e,"error"),...t}),warning:(e,t={})=>fn({...Kn(e,"warning"),...t}),info:(e,t={})=>fn({...Kn(e,"info"),...t}),loading:(e,t={})=>fn({...Kn(e,"loading"),duration:0,...t}),async promise(e,t={}){var r,o,i;let n=fn({title:(r=t.loading)!=null?r:"Loading...",type:"loading",duration:0});try{let s=await e;return n.update({title:typeof t.success=="function"?t.success(s):(o=t.success)!=null?o:"Done",type:"success",duration:Ut.duration}),s}catch(s){throw n.update({title:typeof t.error=="function"?t.error(s):(i=t.error)!=null?i:"Something went wrong",type:"error",duration:Ut.duration}),s}},clear(){for(let[e,t]of Ur)t.remove(),Ur.delete(e)},configure(e){Object.assign(Ut,e)},settings:Ut});de();function tu(e,t=""){let n=r=>t+r;return{get(r,o){var i;try{let s=(i=e())==null?void 0:i.getItem(n(r));if(s==null)return o;try{return JSON.parse(s)}catch(a){return s}}catch(s){return o}},set(r,o){var i;try{return(i=e())==null||i.setItem(n(r),typeof o=="string"?o:JSON.stringify(o)),!0}catch(s){return!1}},remove(r){var o;try{(o=e())==null||o.removeItem(n(r))}catch(i){}},clear(){try{let r=e();if(!r)return;if(!t){r.clear();return}for(let o of Object.keys(r))o.startsWith(t)&&r.removeItem(o)}catch(r){}},has(r){var o;try{return((o=e())==null?void 0:o.getItem(n(r)))!==null}catch(i){return!1}},keys(){try{let r=e();return r?Object.keys(r).filter(o=>o.startsWith(t)).map(o=>o.slice(t.length)):[]}catch(r){return[]}}}}var fe=tu(()=>typeof localStorage!="undefined"?localStorage:void 0),di=tu(()=>typeof sessionStorage!="undefined"?sessionStorage:void 0),ui={get(e){if(typeof document=="undefined")return;let t=`${encodeURIComponent(e)}=`;for(let n of document.cookie.split("; "))if(n.startsWith(t))return decodeURIComponent(n.slice(t.length))},set(e,t,n={}){var o,i;if(typeof document=="undefined")return;let r=`${encodeURIComponent(e)}=${encodeURIComponent(t)}`;if(n.expires!==void 0){let s=typeof n.expires=="number"?new Date(Date.now()+n.expires*864e5):n.expires;r+=`; expires=${s.toUTCString()}`}r+=`; path=${(o=n.path)!=null?o:"/"}`,n.domain&&(r+=`; domain=${n.domain}`),n.secure&&(r+="; secure"),r+=`; samesite=${(i=n.sameSite)!=null?i:"Lax"}`,document.cookie=r},remove(e,t={}){this.set(e,"",{...t,expires:-1})},has(e){return this.get(e)!==void 0}},_t={get(e,t){var n;return typeof location=="undefined"?t:(n=new URLSearchParams(location.search).get(e))!=null?n:t},all(){return typeof location=="undefined"?{}:Object.fromEntries(new URLSearchParams(location.search))},set(e,t,n=!0){if(typeof location=="undefined")return;let r=new URL(location.href);t===null||t===""?r.searchParams.delete(e):r.searchParams.set(e,String(t)),history[n?"replaceState":"pushState"]({},"",r.toString())},remove(e,t=!0){this.set(e,null,t)},merge(e,t=!0){if(typeof location=="undefined")return;let n=new URL(location.href);for(let[r,o]of Object.entries(e))o===null||o===""?n.searchParams.delete(r):n.searchParams.set(r,String(o));history[t?"replaceState":"pushState"]({},"",n.toString())}},Yn=new Map,fi={set(e,t,n=0){return Yn.set(e,{value:t,expires:n>0?Date.now()+n:1/0}),t},get(e,t){let n=Yn.get(e);return n?n.expires<Date.now()?(Yn.delete(e),t):n.value:t},has(e){return this.get(e)!==void 0},remove(e){Yn.delete(e)},clear(){Yn.clear()},async remember(e,t,n){let r=this.get(e);if(r!==void 0)return r;let o=await n();return this.set(e,o,t),o},get size(){return Yn.size}},Ma="voodoo:theme",Sa=null,ci=Ge(0),mt={get current(){var e,t;return ci.value,(t=(e=fe.get(Ma))!=null?e:Sa)!=null?t:"system"},get resolved(){let e=this.current;if(e!=="system")return e;if(typeof document!="undefined"){let t=document.documentElement.getAttribute("data-theme");if(t==="light"||t==="dark")return t}return typeof matchMedia=="undefined"?"light":matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"},set(e){Sa=e,fe.set(Ma,e),ci.value++,this.apply()},toggle(){let e=this.resolved==="dark"?"light":"dark";return this.set(e),e},get chosen(){return Sa!==null||fe.get(Ma)!=null},apply(){if(typeof document=="undefined"||!this.chosen)return;let e=this.current,t=document.documentElement;e==="system"?t.removeAttribute("data-theme"):t.setAttribute("data-theme",e),t.style.colorScheme=this.resolved,document.dispatchEvent(new CustomEvent("voodoo:theme",{detail:{theme:e,resolved:this.resolved}}))},init(){typeof document!="undefined"&&(this.apply(),typeof MutationObserver!="undefined"&&new MutationObserver(()=>{ci.value++}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]}),typeof matchMedia!="undefined"&&matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{ci.value++,this.current==="system"&&this.apply()}))}};var Qe=Y({width:0,height:0,mobile:!1,tablet:!1,desktop:!1,portrait:!1,landscape:!1,matches(e){return typeof matchMedia!="undefined"&&matchMedia(e).matches}});function Ca(){typeof window!="undefined"&&(Qe.width=window.innerWidth,Qe.height=window.innerHeight,Qe.mobile=window.innerWidth<768,Qe.tablet=window.innerWidth>=768&&window.innerWidth<1024,Qe.desktop=window.innerWidth>=1024,Qe.portrait=window.innerHeight>=window.innerWidth,Qe.landscape=!Qe.portrait)}var Wt=Y({online:!0,type:"unknown",saveData:!1,slow:!1});function pi(){var t;if(typeof navigator=="undefined")return;Wt.online=navigator.onLine;let e=navigator.connection;e&&(Wt.type=(t=e.effectiveType)!=null?t:"unknown",Wt.saveData=!!e.saveData,Wt.slow=e.effectiveType==="slow-2g"||e.effectiveType==="2g")}var mi={async copy(e){var t;try{if((t=navigator.clipboard)!=null&&t.writeText)return await navigator.clipboard.writeText(e),!0}catch(n){}try{let n=document.createElement("textarea");n.value=e,n.setAttribute("readonly",""),n.style.cssText="position:fixed;top:-1000px;opacity:0",document.body.appendChild(n),n.select();let r=document.execCommand("copy");return n.remove(),r}catch(n){return!1}},async read(){try{return await navigator.clipboard.readText()}catch(e){return""}}},nu=!1;function ru(){var t,n;if(nu||(nu=!0,N("$el",r=>r.el),N("$refs",r=>r.allRefs),N("$data",r=>r.data),N("$root",r=>r.root.data),N("$parent",r=>{var o,i;return(i=(o=r.parent)==null?void 0:o.data)!=null?i:null}),N("$self",r=>{var o,i;return(i=(o=r.owner)==null?void 0:o.component)!=null?i:r.data}),N("$store",()=>$t),N("$http",()=>he),N("$toast",()=>st),N("$clipboard",()=>mi),N("$storage",()=>fe),N("$session",()=>di),N("$cookie",()=>ui),N("$cache",()=>fi),N("$url",()=>_t),N("$theme",()=>mt),N("$device",()=>ve),N("$screen",()=>Qe),N("$network",()=>Wt),N("$nextTick",()=>ft),N("$watch",r=>(o,i)=>Ie(()=>q(o,r,"$watch"),i)),N("$dispatch",r=>(o,i)=>{var a;((a=r.el)!=null?a:document).dispatchEvent(new CustomEvent(o,{detail:i,bubbles:!0}))}),N("$log",()=>(...r)=>{console.log("[Voodoo]",...r)}),typeof window=="undefined"))return;Ca(),pi();let e=0;window.addEventListener("resize",()=>{cancelAnimationFrame(e),e=requestAnimationFrame(Ca)}),window.addEventListener("orientationchange",Ca),window.addEventListener("online",pi),window.addEventListener("offline",pi),(n=(t=navigator.connection)==null?void 0:t.addEventListener)==null||n.call(t,"change",pi)}de();var ou=new WeakMap;function nh(e){var o,i,s;let t=(i=(o=ua())!=null?o:e.el)!=null?i:e,n=ou.get(t);n||(n={slots:[],index:0,scheduled:!1,bound:!1},ou.set(t,n));let r=(s=ua())!=null?s:e.el;if(!n.bound&&r){n.bound=!0;let a=n;Be(r,()=>{for(let l of a.slots)l.dispose&&l.dispose(),l.runner&&Pn(l.runner);a.slots.length=0})}if(!n.scheduled){n.scheduled=!0;let a=n;queueMicrotask(()=>{a.index=0,a.scheduled=!1})}return n}function vi(e,t){let n=nh(e),r=n.index++,o=n.slots[r];return(!o||o.kind!==t)&&(o&&(o.dispose&&o.dispose(),o.runner&&Pn(o.runner)),o={kind:t,deps:null,value:void 0},n.slots[r]=o),o}function iu(e,t){if(!e||!t||e.length!==t.length)return!0;for(let n=0;n<t.length;n++)if(!Object.is(e[n],t[n]))return!0;return!1}function su(e){return Array.isArray(e)?e.slice():null}function rh(e,t){let n=vi(e,"state");return n.value===void 0&&(n.value=Ge(t)),n.value}function oh(e,t,n){let r=vi(e,"effect"),o=su(n),i=()=>{if(r.dispose){let s=r.dispose;r.dispose=void 0,s()}};if(o){if(r.deps===null&&!r.runner||iu(r.deps,o)){r.deps=o,i();let a=t();typeof a=="function"&&(r.dispose=a)}return}r.runner||(r.deps=null,r.runner=Pe(()=>{i();let s=t();typeof s=="function"&&(r.dispose=s)}))}function ih(e,t,n){let r=vi(e,"memo"),o=su(n);return o?(r.value?iu(r.deps,o)&&(r.deps=o,r.value.value=t()):(r.value=Ge(t()),r.deps=o),r.value):(r.value||(r.value=an(t)),r.value)}function sh(e,t){let n=vi(e,"ref");return n.value||(n.value=Rr({current:t})),n.value}function ah(e,t){return t!==void 0&&!(e in $t)&&ti(e,t),$t[e]}function au(){Nn("useState",e=>t=>rh(e,t)),Nn("useEffect",e=>(t,n)=>oh(e,t,n)),Nn("useMemo",e=>(t,n)=>ih(e,t,n)),Nn("useRef",e=>t=>sh(e,t)),Nn("useContext",()=>(e,t)=>ah(e,t))}de();function Aa(e,t){if(!t)return e;let n=e;for(let r of t.split(".")){if(n==null)return;n=n[r]}return n}function Ra(e){var n;let t=(n=e.response)==null?void 0:n.data;if(!t||typeof t!="object")return null;for(let r of["message","error","detail","msg"]){let o=t[r];if(typeof o=="string")return o}return null}function hi(e,t={}){let n=()=>typeof e=="function"?e():e,r=()=>typeof t.params=="function"?t.params():t.params,o=null,i=null,s=Y({data:null,loading:!1,error:null,loaded:!1,async reload(){var c,d,u,f,p;let a=n();if(!a)return;o==null||o.abort();let l=o=new AbortController;s.loading=!0,s.error=null;try{let m=await he.request({url:a,method:(t.method||"GET").toUpperCase(),params:r(),headers:t.headers,cache:t.cache||void 0,retry:(c=t.retry)!=null?c:0,timeout:(d=t.timeout)!=null?d:he.defaults.timeout,signal:l.signal});if(l.signal.aborted)return;s.data=Aa(m.data,t.jsonPath),s.loaded=!0,(u=t.onSuccess)==null||u.call(t,s.data)}catch(m){if(l.signal.aborted)return;let h=m instanceof Ee&&(f=Ra(m))!=null?f:m.message;s.error={name:"ResourceError",message:h},(p=t.onError)==null||p.call(t,m,h)}finally{l.signal.aborted||(s.loading=!1),o===l&&(o=null)}},set(a){s.data=a},stop(){o==null||o.abort(),o=null,s.loading=!1,i!==null&&(clearInterval(i),i=null)}});return t.poll&&t.poll>0&&(i=setInterval(()=>{(typeof document=="undefined"||document.visibilityState==="visible")&&s.reload()},t.poll)),t.manual||s.reload(),s}Ae();Ae();var lu=`
...
`;function cu(e){let t=e.name||"v-fade";return{enterFrom:e.enterFrom||`${t}-enter-from`,enterActive:e.enterActive||`${t}-enter-active`,enterTo:e.enterTo||`${t}-enter-to`,leaveFrom:e.leaveFrom||`${t}-leave-from`,leaveActive:e.leaveActive||`${t}-leave-active`,leaveTo:e.leaveTo||`${t}-leave-to`}}function Xn(e,t){for(let n of t.split(/\s+/).filter(Boolean))e.classList.add(n)}function Gn(e,t){for(let n of t.split(/\s+/).filter(Boolean))e.classList.remove(n)}function du(e){let t=getComputedStyle(e),n=r=>Math.max(0,...r.split(",").map(o=>parseFloat(o)*(o.includes("ms")?1:1e3)||0));return Math.max(n(t.transitionDuration)+n(t.transitionDelay),n(t.animationDuration)+n(t.animationDelay))}function uu(e){requestAnimationFrame(()=>requestAnimationFrame(e))}function _r(e,t={}){Z("transitions",lu);let n=cu(t);return ve.reducedMotion?Promise.resolve():new Promise(r=>{Xn(e,n.enterFrom),Xn(e,n.enterActive),uu(()=>{var s;Gn(e,n.enterFrom),Xn(e,n.enterTo);let o=(s=t.duration)!=null?s:du(e),i=()=>{Gn(e,n.enterActive),Gn(e,n.enterTo),r()};o<=0?i():setTimeout(i,o+20)})})}function Wr(e,t={}){Z("transitions",lu);let n=cu(t);return ve.reducedMotion?Promise.resolve():new Promise(r=>{Xn(e,n.leaveFrom),Xn(e,n.leaveActive),uu(()=>{var s;Gn(e,n.leaveFrom),Xn(e,n.leaveTo);let o=(s=t.duration)!=null?s:du(e),i=()=>{Gn(e,n.leaveActive),Gn(e,n.leaveTo),r()};o<=0?i():setTimeout(i,o+20)})})}function pn(e,t=240){return new Promise(n=>{e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display="block");let r=e.scrollHeight;e.style.overflow="hidden",e.style.height="0px",e.style.paddingTop="0px",e.style.paddingBottom="0px",e.style.transition=`height ${t}ms var(--v-ease, ease), padding ${t}ms var(--v-ease, ease)`,requestAnimationFrame(()=>{e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.height=`${r}px`}),setTimeout(()=>{e.style.removeProperty("height"),e.style.removeProperty("overflow"),e.style.removeProperty("transition"),n()},t+20)})}function mn(e,t=240){return new Promise(n=>{e.style.height=`${e.scrollHeight}px`,e.style.overflow="hidden",e.style.transition=`height ${t}ms var(--v-ease, ease), padding ${t}ms var(--v-ease, ease)`,requestAnimationFrame(()=>{e.style.height="0px",e.style.paddingTop="0px",e.style.paddingBottom="0px"}),setTimeout(()=>{e.style.display="none",e.style.removeProperty("height"),e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("overflow"),e.style.removeProperty("transition"),n()},t+20)})}function Qn(e,t=220){return new Promise(n=>{e.style.opacity="0",e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display=""),e.style.transition=`opacity ${t}ms ease`,requestAnimationFrame(()=>{e.style.opacity="1"}),setTimeout(()=>{e.style.removeProperty("transition"),e.style.removeProperty("opacity"),n()},t+20)})}function Jn(e,t=220){return new Promise(n=>{e.style.transition=`opacity ${t}ms ease`,e.style.opacity="0",setTimeout(()=>{e.style.display="none",e.style.removeProperty("transition"),e.style.removeProperty("opacity"),n()},t+20)})}function gi(e){let t=document;typeof t.startViewTransition=="function"&&!ve.reducedMotion?t.startViewTransition(e):e()}de();ce();function lh(e,t,n){try{let o={t:"assign",op:"=",target:ze(e),value:{t:"lit",v:n}};P(o,t)}catch(r){W(r,`assignment in "${e}"`)}}function hu(e){let t=w.prefix,n=e.hasAttribute(`${t}transition`),r=e.hasAttribute(`${t}enter-class`)||e.hasAttribute(`${t}leave-class`)||e.hasAttribute(`${t}enter-active-class`)||e.hasAttribute(`${t}leave-active-class`);if(!n&&!r)return null;let o=e.getAttribute(`${t}transition`)||"fade";return{name:o.startsWith("v-")?o:`v-${o}`,enterFrom:e.getAttribute(`${t}enter-class`)||void 0,enterActive:e.getAttribute(`${t}enter-active-class`)||void 0,enterTo:e.getAttribute(`${t}enter-to-class`)||void 0,leaveFrom:e.getAttribute(`${t}leave-class`)||void 0,leaveActive:e.getAttribute(`${t}leave-active-class`)||void 0,leaveTo:e.getAttribute(`${t}leave-to-class`)||void 0,duration:e.hasAttribute(`${t}duration`)?Q(e.getAttribute(`${t}duration`)):void 0}}y("text",({el:e,effect:t,evaluate:n})=>{t(()=>{e.textContent=Lt(n());let r=e.firstChild;r&&r.nodeType===3&&ia(r)})});y("html",e=>{let{el:t,effect:n,evaluate:r,scope:o}=e;Go(t),n(()=>{let i=r();for(let s of Array.from(t.children))G(s);t.innerHTML=i==null?"":String(i);for(let s of Array.from(t.children))ne(s,o)})});y("show",({el:e,effect:t,evaluate:n})=>{let r=e.style.display==="none"?"":e.style.display,o=!0,i=hu(e);t(()=>{let s=!!n();if(o){o=!1,e.style.display=s?r:"none";return}if(!i){e.style.display=s?r:"none";return}s?(e.style.display=r,_r(e,i)):Wr(e,i).then(()=>{e.style.display="none"})})});y("if",({el:e,scope:t,expression:n,effect:r})=>{var f;let o=w.prefix,i=[{expression:n,template:e}],s=e.nextElementSibling;for(;s;)if(s.hasAttribute(`${o}else-if`))i.push({expression:s.getAttribute(`${o}else-if`)||"false",template:s}),s=s.nextElementSibling;else if(s.hasAttribute(`${o}else`)){i.push({expression:null,template:s}),s=s.nextElementSibling;break}else break;let a=document.createComment(w.devtools?` v-if: ${n} `:"");(f=e.parentNode)==null||f.insertBefore(a,e);for(let p of i)sa(p.template),p.template.removeAttribute(`${o}if`),p.template.removeAttribute(`${o}else-if`),p.template.removeAttribute(`${o}else`),ia(p.template);let l=hu(e),c=-1,d=[],u=()=>{let p=d;if(d=[],!p.length)return;let m=()=>{for(let h of p)G(h),h.remove()};l&&p[0]instanceof HTMLElement?Wr(p[0],l).then(m):m()};r(()=>{let p=-1;for(let v=0;v<i.length;v++){let g=i[v];if(g.expression===null||q(g.expression,t,"v-if")){p=v;break}}if(p===c||(c=p,u(),p===-1))return;let m=i[p].template,h=gu(m,a,t);d=h,l&&h[0]instanceof HTMLElement&&_r(h[0],l)}),Be(e,u)},{priority:j.IF,terminal:!0});function gu(e,t,n,r){let o=t.parentNode;if(!o)return[];let i=[];if(e.tagName==="TEMPLATE"){let s=e.content.cloneNode(!0),a=Array.from(s.childNodes);o.insertBefore(s,t);for(let l of a)i.push(l),l.nodeType===1&&(Bt(l,n),ne(l,n))}else{let s=e.cloneNode(!0);i.push(s),Bt(s,n),r?(r.fragment.appendChild(s),r.pending.push([s,n])):(o.insertBefore(s,t),ne(s,n))}return i}y("else-if",()=>{},{priority:j.IF,terminal:!0});y("else",()=>{},{priority:j.IF,terminal:!0});var ch=/^\s*\(?\s*([^)]*?)\s*\)?\s+(?:in|of)\s+(.+?)\s*$/;y("for",({el:e,scope:t,expression:n,effect:r})=>{var v;let o=ch.exec(n);if(!o){W(new Error(`Invalid syntax in v-for="${n}". Use "item in items".`),"v-for");return}let i=o[1].split(",").map(g=>g.trim()).filter(Boolean),s=o[2],[a,l,c]=i,d=w.prefix,u=e.getAttribute(":key")||e.getAttribute(`${d}bind:key`)||e.getAttribute(`${d}key`),f=document.createComment(w.devtools?` v-for: ${n} `:"");(v=e.parentNode)==null||v.insertBefore(f,e);let p=e.cloneNode(!0);p.removeAttribute(`${d}for`),p.removeAttribute(":key"),p.removeAttribute(`${d}bind:key`),p.removeAttribute(`${d}key`),sa(e);let m=[];Be(f,()=>{for(let g of m)for(let b of g.nodes)G(b),b.remove();m=[]}),r(()=>{var se,O,me;let g=q(s,t,"v-for"),b=dh(g,a,l,c),x=new Map;for(let ae of m)x.set(ae.key,ae);let T=[],E=new Set,C={fragment:document.createDocumentFragment(),pending:[]};b.forEach((ae,R)=>{let S=u?q(u,t.child(ae),":key"):`__index_${R}`;u&&E.has(S)&&ud(e,S,n);let B=x.get(S);if(B&&!E.has(S)){E.add(S);for(let[nn,An]of Object.entries(ae))B.data[nn]=An;T.push(B);return}let _e=t.reactiveChild(ae),We=gu(p,f,_e,C);E.add(S),T.push({key:S,scope:_e,nodes:We,data:_e.data})}),C.fragment.firstChild&&((se=f.parentNode)==null||se.insertBefore(C.fragment,f));for(let[ae,R]of C.pending)ne(ae,R);let D=new Set(T);for(let ae of m)if(!(E.has(ae.key)&&D.has(ae)))for(let R of ae.nodes)G(R),R.remove();let A=f;for(let ae=T.length-1;ae>=0;ae--){let R=T[ae],S=R.nodes[R.nodes.length-1];if(S&&S.nextSibling!==A)for(let B of R.nodes)(O=f.parentNode)==null||O.insertBefore(B,A);A=(me=R.nodes[0])!=null?me:A}m=T})},{priority:j.FOR,terminal:!0});function dh(e,t,n,r){let o=[];if(Array.isArray(e))return e.forEach((i,s)=>{let a={[t]:i};n&&(a[n]=s),o.push(a)}),o;if(typeof e=="number"){for(let i=1;i<=e;i++){let s={[t]:i};n&&(s[n]=i-1),o.push(s)}return o}return typeof e=="string"?(Array.from(e).forEach((i,s)=>{let a={[t]:i};n&&(a[n]=s),o.push(a)}),o):(e&&typeof e=="object"&&(e instanceof Map?Array.from(e.entries()):e instanceof Set?Array.from(e).map((s,a)=>[a,s]):Object.entries(e)).forEach(([s,a],l)=>{let c={[t]:a};n&&(c[n]=s),r&&(c[r]=l),o.push(c)}),o)}var uh=new Set(["disabled","checked","readonly","required","selected","hidden","open","multiple","autofocus","novalidate","inert"]),fh=new Set(["href","src","action","formaction","xlink:href","ping","poster"]),ph=/[\s\x00-\x1f]/g;function mh(e){let t=e.replace(ph,"").toLowerCase();return t.startsWith("javascript:")||t.startsWith("vbscript:")||t.startsWith("data:text/html")||t.startsWith("data:application/xhtml")}function fu(e,t,n,r=!1,o=!1){if(t==="class")return bu(e,n);if(t==="style")return $a(e,n);if(w.sanitizeUrls&&!o&&t==="srcdoc"){cn(`:srcdoc refused in ${Ct(e)}: the value becomes a document with active script inside the iframe, the same way v-html becomes markup. If the content is trusted, write :srcdoc.dangerous="..."; to turn off this protection on the entire application, set V.config.sanitizeUrls = false.`),e.removeAttribute(t);return}if(w.sanitizeUrls&&!r){if(fh.has(t)&&typeof n=="string"&&mh(n)){cn(`value refused in :${t} of ${Ct(e)}: "${n.slice(0,60)}" uses a scheme that executes code. Use an http(s) or relative address. To turn off this protection, set V.config.sanitizeUrls = false.`),e.removeAttribute(t);return}if(t.length>2&&/^on[a-z]/.test(t)){cn(`attribute "${t}" refused in ${Ct(e)}: linking event by attribute creates an inline handler. Use @${t.slice(2)}="..." instead.`),e.removeAttribute(t);return}}if(r){e[t]=n;return}if(uh.has(t)){n===!1||n==null?e.removeAttribute(t):e.setAttribute(t,""),t in e&&(e[t]=!!n);return}if(t==="value"&&"value"in e){e.value=n==null?"":n;return}n==null||n===!1?e.removeAttribute(t):e.setAttribute(t,n===!0?"":String(n))}var pu=new WeakMap;function bu(e,t){let n=pu.get(e);n||(n=(e.getAttribute("class")||"").split(/\s+/).filter(Boolean),pu.set(e,n));let r=new Set(n);yu(t,r),e.setAttribute("class",Array.from(r).join(" ")),e.getAttribute("class")||e.removeAttribute("class")}function yu(e,t){if(e){if(typeof e=="string"){for(let n of e.split(/\s+/))n&&t.add(n);return}if(Array.isArray(e)){for(let n of e)yu(n,t);return}if(typeof e=="object"){for(let[n,r]of Object.entries(e))if(r)for(let o of n.split(/\s+/))o&&t.add(o)}}}function $a(e,t){if(t){if(typeof t=="string"){e.style.cssText=t;return}if(Array.isArray(t)){for(let n of t)$a(e,n);return}for(let[n,r]of Object.entries(t)){if(r==null||r===!1){e.style.removeProperty(n);continue}let o=n.startsWith("--")?n:n.replace(/[A-Z]/g,s=>`-${s.toLowerCase()}`),i=String(r);o.startsWith("--"),e.style.setProperty(o,i)}}}y("bind",({el:e,arg:t,modifiers:n,effect:r,evaluate:o,expression:i})=>{if(!t){r(()=>{let l=o();if(l&&typeof l=="object")for(let[c,d]of Object.entries(l))fu(e,c,d)});return}if(t==="key")return;let s=!!n.prop,a=!!n.dangerous;r(()=>{fu(e,t,o(),s,a)})},{priority:j.BIND});y("class",({el:e,effect:t,evaluate:n})=>{t(()=>bu(e,n()))});y("style",({el:e,effect:t,evaluate:n})=>{t(()=>$a(e,n()))});var mu={enter:["Enter"],esc:["Escape"],escape:["Escape"],space:[" ","Spacebar"],tab:["Tab"],delete:["Delete","Backspace"],backspace:["Backspace"],up:["ArrowUp"],down:["ArrowDown"],left:["ArrowLeft"],right:["ArrowRight"]},vh=["ctrl","shift","alt","meta"];function vu(e,t,n,r){let o=n.detail,i=n.__voodoo===!0,s=t.child({$event:i?o:n,$rawEvent:n,$el:r,$detail:o});try{let a=ze(e),l=P(a,s);typeof l=="function"&&(a.t==="id"||a.t==="member")&&l.call(t.data,i?o:n)}catch(a){W(a,`event ${n.type} ("${e}")`)}}var hh={hover:"mouseenter",unhover:"mouseleave",tap:"click",press:"pointerdown",release:"pointerup",rightclick:"contextmenu",enterkey:"keydown",type:"input",submitform:"submit"},xu={hold(e,t,n,r){let o=Q(typeof n.duration=="string"&&n.duration||Object.keys(n).find(d=>/^[\d.]+(ms|s)?$/.test(d))||e.getAttribute(`${w.prefix}hold-duration`)||800,800),i=null,s=!1,a=d=>{s=!1,e.classList.add("v-holding"),e.style.setProperty("--v-hold-duration",`${o}ms`),i=setTimeout(()=>{s=!0,e.classList.remove("v-holding"),t(d)},o)},l=()=>{i&&clearTimeout(i),i=null,e.classList.remove("v-holding")},c=d=>{s&&(d.preventDefault(),d.stopPropagation(),s=!1)};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",l),e.addEventListener("pointerleave",l),e.addEventListener("pointercancel",l),e.addEventListener("click",c,!0),r(()=>{l(),e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",l),e.removeEventListener("pointerleave",l),e.removeEventListener("pointercancel",l),e.removeEventListener("click",c,!0)})},outside(e,t,n,r){let o=i=>{e.isConnected&&(e===i.target||e.contains(i.target)||t(i))};document.addEventListener("click",o,!0),r(()=>document.removeEventListener("click",o,!0))},visible(e,t,n,r){var i,s;if(typeof IntersectionObserver=="undefined"){t(new CustomEvent("visible"));return}let o=new IntersectionObserver(a=>{for(let l of a)l.isIntersecting&&(t(new CustomEvent("visible",{detail:l})),n.repeat!==!0&&o.unobserve(e))},{threshold:Number((i=n.threshold)!=null?i:.1),rootMargin:String((s=n.margin)!=null?s:"0px")});o.observe(e),r(()=>o.disconnect())}};for(let e of["left","right","up","down"])xu[`swipe${e}`]=(t,n,r,o)=>{let i=0,s=0,a=!1,l=d=>{a=!0,i=d.clientX,s=d.clientY},c=d=>{if(!a)return;a=!1;let u=d.clientX-i,f=d.clientY-s,p=40;(e==="left"?u<-p&&Math.abs(u)>Math.abs(f):e==="right"?u>p&&Math.abs(u)>Math.abs(f):e==="up"?f<-p&&Math.abs(f)>Math.abs(u):f>p&&Math.abs(f)>Math.abs(u))&&n(new CustomEvent(`swipe${e}`,{detail:{dx:u,dy:f}}))};t.addEventListener("pointerdown",l),window.addEventListener("pointerup",c),o(()=>{t.removeEventListener("pointerdown",l),window.removeEventListener("pointerup",c)})};function wu(e,t,n,r,o,i){var p;let s=(p=hh[t])!=null?p:t,a=xu[t];if(a){a(e,m=>{o.prevent&&m.preventDefault(),o.stop&&m.stopPropagation(),vu(n,r,m,e)},o,i);return}let l=o.window?window:o.document||o.outside?document:e,c=m=>{if(!(o.self&&m.target!==e)&&!(o.outside&&(e===m.target||e.contains(m.target)||!e.isConnected))){if(m instanceof KeyboardEvent){for(let v of vh)if(o[v]&&!m[`${v}Key`])return;let h=Object.keys(o).filter(v=>v in mu||/^[a-z0-9]$/.test(v));if(h.length&&!h.some(g=>{let b=mu[g];return b?b.includes(m.key):m.key.toLowerCase()===g}))return}o.prevent&&m.preventDefault(),o.stop&&m.stopPropagation(),vu(n,r,m,e)}},d=o.debounce;d!==void 0&&(c=Ye(c,Q(d===!0?250:d,250)));let u=o.throttle;u!==void 0&&(c=zr(c,Q(u===!0?250:u,250)));let f={capture:!!o.capture,once:!!o.once,passive:!!o.passive};l.addEventListener(s,c,f),i(()=>l.removeEventListener(s,c,f))}y("on",({el:e,arg:t,expression:n,scope:r,modifiers:o,cleanup:i})=>{t&&wu(e,t,n,r,o,i)});var gh=["click","dblclick","input","change","keyup","keydown","keypress","mouseenter","mouseleave","mouseover","mousedown","mouseup","contextmenu","wheel","paste","dragstart","dragover","dragleave","drop"];for(let e of gh)y(e,({el:t,expression:n,scope:r,modifiers:o,cleanup:i})=>{wu(t,e,n,r,o,i)});y("model",({el:e,expression:t,scope:n,modifiers:r,effect:o,cleanup:i})=>{let s=e,a=s.tagName,l=(s.getAttribute("type")||"text").toLowerCase(),c=a==="INPUT"&&l==="checkbox",d=a==="INPUT"&&l==="radio",u=a==="SELECT",f=u&&s.multiple,p=a==="INPUT"&&l==="file",m=l==="number"||l==="range",h=!!r.lazy,v=!!r.number||m,g=!!r.trim,b=r.debounce?Q(r.debounce===!0?250:r.debounce,250):e.getAttribute(`${w.prefix}debounce`)?Q(e.getAttribute(`${w.prefix}debounce`),250):0,x=h||u||c||d||p?"change":"input",T=()=>{var C,D;let E;if(c){let A=q(t,n,"v-model");if(Array.isArray(A)){let se=s.value,O=[...A],me=O.indexOf(se);s.checked&&me===-1?O.push(se):!s.checked&&me>-1&&O.splice(me,1),E=O}else E=s.checked}else if(d){if(!s.checked)return;E=s.value}else if(f)E=Array.from(s.selectedOptions).map(A=>A.value);else if(p)E=r.single?(D=(C=s.files)==null?void 0:C[0])!=null?D:null:s.files;else if(E=s.value,g&&typeof E=="string"&&(E=E.trim()),v&&typeof E=="string"){let A=E===""?null:Number(E);E=A===null||Number.isNaN(A)?E:A}lh(t,n,E)};b>0&&(T=Ye(T,b)),s.addEventListener(x,T),i(()=>s.removeEventListener(x,T)),o(()=>{let E=q(t,n,"v-model");if(c){s.checked=Array.isArray(E)?E.includes(s.value):!!E;return}if(d){s.checked=String(E)===s.value;return}if(f){let D=Array.isArray(E)?E.map(String):[];for(let A of Array.from(s.options))A.selected=D.includes(A.value);return}if(p)return;let C=E==null?"":String(E);s.value!==C&&(s.value=C),u&&s.value!==C&&ft(()=>{s.value!==C&&(s.value=C)})})},{priority:j.MODEL});y("init",({el:e,expression:t,scope:n})=>{Se(()=>{let r=n.child({$el:e}),o=q(t,r,"v-init");typeof o=="function"&&o.call(n.data)})},{priority:j.INIT});y("ref",({el:e,expression:t,scope:n,cleanup:r})=>{var s;let o=t.trim();if(!o)return;let i=(s=n.owner)!=null?s:n;i.refs[o]=e,r(()=>{i.refs[o]===e&&delete i.refs[o]})},{priority:j.REF});y("effect",({effect:e,evaluate:t})=>{e(()=>{t()})});y("watch",({el:e,expression:t,scope:n,effect:r})=>{let o=e.getAttribute(`${w.prefix}model`),i,s=!0;r(()=>{let a=o?q(o,n,"v-watch"):q(t,n,"v-watch");if(s){s=!1,i=a;return}if(a===i)return;let l=i;if(i=a,o){let c=n.child({$value:a,$old:l,$el:e}),d=q(t,c,"v-watch");typeof d=="function"&&d.call(n.data,a,l)}})});y("cloak",({el:e})=>{e.removeAttribute(`${w.prefix}cloak`)});y("once",({el:e,effect:t,evaluate:n})=>{let r=n();r!==void 0&&(e.textContent=Lt(r))});y("teleport",({el:e,expression:t,cleanup:n})=>{var s;let r=t.trim()||"body",o=r==="body"?document.body:document.querySelector(r);if(!o){W(new Error(`v-teleport destination not found: ${r}`),"v-teleport");return}let i=document.createComment(" v-teleport ");(s=e.parentNode)==null||s.insertBefore(i,e),o.appendChild(e),n(()=>{var a;(a=i.parentNode)==null||a.insertBefore(e,i),i.remove()})},{priority:j.DATA});for(let e of["transition","enter-class","enter-active-class","enter-to-class","leave-class","leave-active-class","leave-to-class","duration","key","slot","ignore","pre"])y(e,()=>{},{priority:j.TRANSITION});y("data",()=>{},{priority:j.DATA});y("component",()=>{},{priority:j.COMPONENT});de();ce();var Tu=()=>w.prefix;function V(e,t){return Te(e,`${Tu()}${t}`)}function Ha(e,t){return zt(e,`${Tu()}${t}`)}function bh(e,t){var s,a,l;let n=V(e,"target"),r=V(e,"loading"),o={},i=V(e,"headers");if(i){let c=q(i,t,"v-headers");c&&typeof c=="object"&&(o=c)}return{target:n?document.querySelector(n):null,swap:V(e,"swap")||"innerHTML",loadingTarget:r?document.querySelector(r):null,loadingClass:V(e,"loading-class")||"v-loading",disableWhileLoading:Ha(e,"disable-loading"),confirmMessage:V(e,"confirm"),toastSuccess:V(e,"toast-success"),toastError:V(e,"toast-error"),onSuccess:V(e,"on-success"),onError:V(e,"on-error"),onComplete:V(e,"on-complete"),cacheMs:Q((s=V(e,"cache"))!=null?s:void 0,0),retry:Number((a=V(e,"retry"))!=null?a:0),timeout:Q((l=V(e,"timeout"))!=null?l:void 0,he.defaults.timeout),storeAs:V(e,"as"),jsonPath:V(e,"json-path"),templateSelector:V(e,"template"),offlineQueue:Ha(e,"offline-queue"),headers:o,redirect:V(e,"redirect"),scrollTo:V(e,"scroll-to")}}function ku(e,t,n,r){var i,s;let o=a=>{for(let l of Array.from(a))l.nodeType===1&&ne(l,r)};switch(n){case"none":return;case"delete":G(e),e.remove();return;case"textContent":e.textContent=t;return;case"outerHTML":case"replace":{let a=document.createElement("template");a.innerHTML=t;let l=Array.from(a.content.childNodes);G(e),e.replaceWith(a.content),o(l);return}case"beforebegin":case"afterbegin":case"beforeend":case"afterend":{let a=new Set(Array.from((s=(i=e.parentElement)==null?void 0:i.childNodes)!=null?s:[]));e.insertAdjacentHTML(n,t);let l=n==="afterbegin"||n==="beforeend"?e:e.parentElement;if(l)for(let c of Array.from(l.childNodes))c.nodeType===1&&!a.has(c)&&ne(c,r);return}case"append":e.insertAdjacentHTML("beforeend",t),o(e.childNodes);return;case"prepend":e.insertAdjacentHTML("afterbegin",t),o(e.childNodes);return;default:{for(let a of Array.from(e.children))G(a);e.innerHTML=t,o(e.childNodes)}}}function bi(e,t=0){if(e==null)return"";if(typeof e!="object")return I(String(e));if(Array.isArray(e)){if(!e.length)return'<p class="v-json-empty">No results.</p>';if(e.every(o=>o&&typeof o=="object"&&!Array.isArray(o))&&t===0){let o=Array.from(e.reduce((a,l)=>{for(let c of Object.keys(l))a.add(c);return a},new Set)),i=o.map(a=>`<th>${I(a)}</th>`).join(""),s=e.map(a=>`<tr>${o.map(l=>`<td>${bi(a[l],t+1)}</td>`).join("")}</tr>`).join("");return`<table class="v-json-table"><thead><tr>${i}</tr></thead><tbody>${s}</tbody></table>`}return`<ul class="v-json-list">${e.map(o=>`<li>${bi(o,t+1)}</li>`).join("")}</ul>`}let n=Object.entries(e);return n.length?`<dl class="v-json-object">${n.map(([r,o])=>`<dt>${I(r)}</dt><dd>${bi(o,t+1)}</dd>`).join("")}</dl>`:""}function yh(e,t,n,r){let o=document.querySelector(e);if(!o){W(new Error(`Template not found: ${e}`),"v-template");return}for(let s of Array.from(r.children))G(s);r.innerHTML="";let i=Array.isArray(t)?t:[t];for(let[s,a]of i.entries()){let l=o.content.cloneNode(!0),c=Array.from(l.childNodes);r.appendChild(l);let d=n.reactiveChild({item:a,index:s,...a&&typeof a=="object"?a:{}});for(let u of c)u.nodeType===1&&ne(u,d)}}var Da=new WeakMap;async function Kr(e){var u,f,p,m,h;let{el:t,scope:n,method:r}=e,o=bh(t,n),i=Mt.has("confirm");if(o.confirmMessage&&!i&&!await xh(o.confirmMessage))return;(u=Da.get(t))==null||u.abort();let s=new AbortController;Da.set(t,s);let a=(f=o.target)!=null?f:t,l=t instanceof HTMLFormElement?t.querySelector('[type="submit"], button:not([type])'):null,c=()=>{if(t.classList.add(o.loadingClass),t.setAttribute("aria-busy","true"),o.loadingTarget&&o.loadingTarget.style.removeProperty("display"),o.disableWhileLoading){let v=l!=null?l:t;"disabled"in v&&(v.disabled=!0)}},d=()=>{if(t.classList.remove(o.loadingClass),t.removeAttribute("aria-busy"),o.loadingTarget&&(o.loadingTarget.style.display="none"),o.disableWhileLoading){let v=l!=null?l:t;"disabled"in v&&(v.disabled=!1)}};c(),Zn(t,"voodoo:before-request",{method:r,url:e.url});try{let v=await he.request({url:e.url,method:r,body:e.body,params:e.params,headers:o.headers,timeout:o.timeout,retry:o.retry,cache:o.cacheMs||void 0,signal:s.signal,offlineQueue:o.offlineQueue}),g=Aa(v.data,o.jsonPath);o.storeAs?n.set(o.storeAs,g):o.templateSelector?yh(o.templateSelector,g,n,a):typeof g=="string"?ku(a,g,o.swap,n):g!=null&&(wh(),ku(a,bi(g),o.swap,n)),o.toastSuccess&&st.success(o.toastSuccess),o.onSuccess&&Pa(o.onSuccess,n,t,{data:g,response:v}),Zn(t,"voodoo:success",{data:g,response:v}),o.scrollTo&&((p=document.querySelector(o.scrollTo))==null||p.scrollIntoView({behavior:"smooth"})),o.redirect&&location.assign(o.redirect)}catch(v){if((v==null?void 0:v.name)==="AbortError")return;let g=v instanceof Ee?(m=Ra(v))!=null?m:v.message:(h=v==null?void 0:v.message)!=null?h:"Unknown error";o.toastError?st.error(o.toastError):o.onError||st.error(g),o.onError&&Pa(o.onError,n,t,{error:v,message:g}),Zn(t,"voodoo:error",{error:v,message:g}),W(v,`request ${r} ${e.url}`)}finally{d(),Da.delete(t),o.onComplete&&Pa(o.onComplete,n,t,{}),Zn(t,"voodoo:complete",{})}}function Zn(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function Pa(e,t,n,r){var s;let o=t.child({$el:n,...r}),i=q(e,o,"HTTP callback");typeof i=="function"&&i.call(t.data,(s=r.data)!=null?s:r.error)}async function xh(e){let t=globalThis.V;return t&&typeof t.confirm=="function"&&t.confirm!==globalThis.confirm?!!await t.confirm(e):globalThis.confirm(e)}var Eu=!1;function wh(){Eu||(Eu=!0,Promise.resolve().then(()=>(Ae(),eu)).then(({injectStyle:e})=>{e("json-render",`
...
`;function to(){ge(),Z("dnd",pg)}var sr=new Map,ar=new Map;function Za(e,t){if(t&&t.trim())return t.trim();let n=e.closest("[data-v-dnd-group]");return(n==null?void 0:n.getAttribute("data-v-dnd-group"))||null}function bt(e){return Array.from(e.children).filter(t=>!t.classList.contains("v-drag-ghost"))}function mg(e,t){var n;return(n=e.getAttribute("data-id"))!=null?n:e.id||String(t)}function tf(e){return bt(e).map((t,n)=>mg(t,n))}function nf(e){let t=getComputedStyle(e);return t.display.includes("flex")?t.flexDirection.startsWith("row"):t.display.includes("grid")?t.gridAutoFlow.startsWith("column"):!1}var $=null,eo=0;function vg(e,t){let n=e.cloneNode(!0);n.classList.add("v-drag-ghost"),n.classList.remove("v-dragging","v-grabbed"),n.removeAttribute("id");for(let r of Array.from(n.querySelectorAll("[id]")))r.removeAttribute("id");return n.style.width=`${t.width}px`,n.style.height=`${t.height}px`,n.setAttribute("aria-hidden","true"),document.body.appendChild(n),n}function rf(e,t){if(!($!=null&&$.ghost))return;let n=$.axis==="y"?$.lastX:e,r=$.axis==="x"?$.lastY:t;$.ghost.style.transform=`translate3d(${Math.round(n-$.grabX)}px, ${Math.round(r-$.grabY)}px, 0)`}function hg(e){let t=e;for(;t&&t!==document.body&&t!==document.documentElement;){let n=getComputedStyle(t),r=(n.overflowY==="auto"||n.overflowY==="scroll")&&t.scrollHeight>t.clientHeight+2,o=(n.overflowX==="auto"||n.overflowX==="scroll")&&t.scrollWidth>t.clientWidth+2;if(r||o)return t;t=t.parentElement}return null}function gg(){if(!$)return;let e=56,t=16,n=$.lastX,r=$.lastY,o=document.elementFromPoint(n,r),i=hg(o!=null?o:$.overList);if(i){let s=i.getBoundingClientRect();r-s.top<e?i.scrollTop-=t:s.bottom-r<e&&(i.scrollTop+=t),n-s.left<e?i.scrollLeft-=t:s.right-n<e&&(i.scrollLeft+=t);return}r<e?window.scrollBy(0,-t):window.innerHeight-r<e&&window.scrollBy(0,t),n<e?window.scrollBy(-t,0):window.innerWidth-n<e&&window.scrollBy(t,0)}function bg(){let e=()=>{!$||$.keyboard||(gg(),eo=requestAnimationFrame(e))};eo=requestAnimationFrame(e)}function yg(){eo&&cancelAnimationFrame(eo),eo=0}function of(e,t){let n=sr.get(e);return n?e===t.startList?!0:!n.group||!t.group?!1:n.group===t.group:!1}function el(e,t){return!(e.accept&&!t.item.matches(e.accept)||e.group&&e.group!==t.group)}function sf(e,t){for(let n of ar.values())n.el.classList.toggle("v-drop-active",t&&el(n,e));for(let n of sr.values())n.el.classList.toggle("v-drop-active",t&&of(n.el,e))}function xg(e,t,n,r){let o=nf(e),i=null;for(let s of bt(e)){if(s===t)continue;let a=s.getBoundingClientRect(),l=o?a.left+a.width/2:a.top+a.height/2;if((o?n:r)<l){i=s;break}}if(i){(t.nextElementSibling!==i||t.parentElement!==e)&&e.insertBefore(t,i);return}e.lastElementChild!==t&&e.appendChild(t)}function tl(e,t){to();let n=e.getBoundingClientRect(),r=t.mode==="sort"?e.parentElement:null;$={item:e,mode:t.mode,data:t.data,group:t.group,axis:t.axis,ghost:null,pointerId:t.pointerId,grabX:t.keyboard?n.width/2:t.x-n.left,grabY:t.keyboard?n.height/2:t.y-n.top,startParent:e.parentElement,startNext:e.nextSibling,startList:r,startIndex:r?bt(r).indexOf(e):-1,overDrop:null,overList:r,keyboard:!!t.keyboard,lastX:t.x,lastY:t.y},e.classList.add("v-dragging"),e.setAttribute("aria-grabbed","true"),t.keyboard?e.classList.add("v-grabbed"):($.ghost=vg(e,n),rf(t.x,t.y),bg()),sf($,!0),document.addEventListener("keydown",lf,!0),pe(e,"voodoo:drag-start",{item:e,data:t.data,group:t.group})}function wg(e,t){var a,l,c;if(!$)return;$.lastX=e,$.lastY=t,rf(e,t);let n=document.elementFromPoint(e,t),r=(a=n==null?void 0:n.closest(".v-sortable"))!=null?a:null,o=(l=n==null?void 0:n.closest(".v-droppable"))!=null?l:null;$.mode==="sort"&&r&&of(r,$)?($.overList&&$.overList!==r&&$.overList.classList.remove("v-drop-over"),$.overList=r,r.classList.add("v-drop-over"),xg(r,$.item,e,t)):$.overList&&!r&&$.overList.classList.remove("v-drop-over");let i=o?ar.get(o):void 0,s=i?el(i,$):!1;$.overDrop&&$.overDrop!==o&&($.overDrop.classList.remove("v-drop-over"),$.overDrop=null),o&&s&&(o.classList.add("v-drop-over"),$.overDrop=o),(c=$.ghost)==null||c.classList.toggle("v-drag-invalid",!!o&&!s)}function kg(e){e.startParent&&(e.startNext&&e.startNext.parentNode===e.startParent?e.startParent.insertBefore(e.item,e.startNext):e.startParent.appendChild(e.item))}function af(e){var t,n,r;(t=e.ghost)==null||t.remove(),e.item.classList.remove("v-dragging","v-grabbed"),e.item.setAttribute("aria-grabbed","false"),(n=e.overDrop)==null||n.classList.remove("v-drop-over"),(r=e.overList)==null||r.classList.remove("v-drop-over"),sf(e,!1),yg(),document.removeEventListener("keydown",lf,!0),$=null}function nl(){var i;let e=$;if(!e)return;let t=e.item.parentElement,n=t?bt(t).indexOf(e.item):-1,r=e.overDrop,o=r?ar.get(r):void 0;if(e.mode==="sort"&&t&&sr.has(t)&&(t!==e.startList||n!==e.startIndex)){let a={item:e.item,oldIndex:e.startIndex,newIndex:n,from:e.startList,to:t,order:tf(t)};pe(t,"voodoo:sorted",a),e.startList&&e.startList!==t&&pe(e.startList,"voodoo:sorted",{...a,order:tf(e.startList)}),Je(`Item moved to position ${n+1} of ${bt(t).length}`)}if(r&&o){let s={item:e.item,data:e.data,from:(i=e.startList)!=null?i:e.startParent,to:r,index:n},a=new CustomEvent("voodoo:drop",{detail:s,bubbles:!0});r.dispatchEvent(a),gt(o.expression,o.scope,r,a,s),Je("Item dropped in drop zone")}pe(e.item,"voodoo:drag-end",{item:e.item,data:e.data}),af(e)}function Ja(){let e=$;e&&(kg(e),pe(e.item,"voodoo:drag-cancel",{item:e.item}),Je("Drag canceled"),af(e))}function lf(e){!$||e.key!=="Escape"||(e.preventDefault(),Ja())}function cf(e,t,n){let r=null,o=-1,i=0,s=0,a=!1,l=p=>{if(p.pointerId===o){if(!a){if(Math.hypot(p.clientX-i,p.clientY-s)<4||!r)return;a=!0,tl(r,{mode:t.mode,data:t.data(),group:t.group(),axis:t.axis(),pointerId:o,x:i,y:s})}p.preventDefault(),wg(p.clientX,p.clientY)}},c=()=>{window.removeEventListener("pointermove",l),window.removeEventListener("pointerup",d),window.removeEventListener("pointercancel",u),r=null,o=-1,a=!1},d=p=>{p.pointerId===o&&(a&&nl(),c())},u=()=>{a&&Ja(),c()},f=p=>{if(p.button!==0||$)return;let m=p.target;if(!m||m.closest('input,textarea,select,option,[contenteditable="true"]')||t.handle&&!m.closest(t.handle))return;let h=t.itemFrom(m);h&&(r=h,o=p.pointerId,i=p.clientX,s=p.clientY,a=!1,window.addEventListener("pointermove",l,{passive:!1}),window.addEventListener("pointerup",d),window.addEventListener("pointercancel",u))};e.addEventListener("pointerdown",f),n(()=>{e.removeEventListener("pointerdown",f),a&&Ja(),c()})}function Eg(e){return e?Array.from(sr.values()).filter(t=>t.group===e).map(t=>t.el).sort((t,n)=>t.compareDocumentPosition(n)&Node.DOCUMENT_POSITION_FOLLOWING?-1:1):[]}function Tg(e,t){if(!$)return!1;let n=e.parentElement;if(!n)return!1;let r=nf(n),o=t==="ArrowDown"||r&&t==="ArrowRight",i=t==="ArrowUp"||r&&t==="ArrowLeft",s=bt(n),a=s.indexOf(e);if(o||i){let l=a+(o?1:-1);return l<0||l>=s.length?!1:(o?n.insertBefore(e,s[l].nextSibling):n.insertBefore(e,s[l]),Je(`Position ${l+1} of ${s.length}`),e.focus(),!0)}if(!r&&(t==="ArrowLeft"||t==="ArrowRight")){let l=Eg($.group),c=l.indexOf(n);if(c===-1)return!1;let d=l[c+(t==="ArrowRight"?1:-1)];return d?(d.appendChild(e),Je(`Moved to list ${l.indexOf(d)+1} of ${l.length}`),e.focus(),!0):!1}return!1}function Lg(e){return Array.from(ar.values()).filter(t=>el(t,e)).map(t=>t.el)}y("dnd-group",({el:e,expression:t})=>{to();let n=t.trim()||"default";e.setAttribute("data-v-dnd-group",n),e.classList.add("v-dnd-group")});y("sortable",({el:e,expression:t,cleanup:n})=>{to(),e.classList.add("v-sortable");let r=ee(e,"sortable-handle")||t.trim()||null,o={el:e,group:Za(e,ee(e,"sortable-group")),handle:r};sr.set(e,o),e.hasAttribute("aria-label")||e.setAttribute("aria-label","Sortable list");let i=l=>{var c;l.hasAttribute("tabindex")||l.setAttribute("tabindex","0"),l.hasAttribute("aria-grabbed")||l.setAttribute("aria-grabbed","false"),r?(c=l.querySelector(r))==null||c.classList.add("v-drag-handle"):l.classList.add("v-drag-handle")};for(let l of bt(e))i(l);let s=typeof MutationObserver=="undefined"?null:new MutationObserver(()=>{for(let l of bt(e))i(l)});s==null||s.observe(e,{childList:!0}),cf(e,{mode:"sort",handle:r,group:()=>o.group,data:()=>null,axis:()=>null,itemFrom:l=>{let c=bt(e).find(d=>d===l||d.contains(l));return c!=null?c:null}},n);let a=l=>{let c=l.target;if(!c)return;let d=bt(e).find(u=>u===c||u.contains(c));if(d){if(l.key===" "||l.key==="Spacebar"){if(l.preventDefault(),$&&$.item===d){nl(),Je("Item dropped");return}if($)return;tl(d,{mode:"sort",data:null,group:o.group,axis:null,pointerId:-1,x:0,y:0,keyboard:!0}),Je("Item grabbed. Use arrow keys to move and space to drop.");return}!$||$.item!==d||l.key.startsWith("Arrow")&&Tg(d,l.key)&&l.preventDefault()}};e.addEventListener("keydown",a),n(()=>{e.removeEventListener("keydown",a),s==null||s.disconnect(),sr.delete(e)})});K("sortable-group");K("sortable-handle");y("draggable",({el:e,expression:t,scope:n,cleanup:r})=>{var m;to(),e.classList.add("v-draggable");let o=ee(e,"draggable-handle")||null,i=(ee(e,"draggable-axis")||"").trim().toLowerCase(),s=i==="x"||i==="y"?i:null,a=ee(e,"draggable-data")||t.trim(),l=Za(e,ee(e,"draggable-group"));o?(m=e.querySelector(o))==null||m.classList.add("v-drag-handle"):e.classList.add("v-drag-handle"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("aria-grabbed","false"),e.hasAttribute("aria-roledescription")||e.setAttribute("aria-roledescription","draggable item");let c=()=>a?q(a,n,"v-draggable-data"):null;cf(e,{mode:"free",handle:o,group:()=>l,data:c,axis:()=>s,itemFrom:()=>e},r);let d=[],u=0,f=()=>{d.forEach((v,g)=>v.classList.toggle("v-drop-over",g===u));let h=d[u];!h||!$||($.overDrop=h,ve.reducedMotion?h.scrollIntoView({block:"nearest"}):h.scrollIntoView({block:"nearest",behavior:"smooth"}),Je(h.getAttribute("aria-label")||`Target ${u+1} of ${d.length}`))},p=h=>{if(h.key===" "||h.key==="Spacebar"){if(h.preventDefault(),$&&$.item===e){nl(),d=[];return}if($)return;tl(e,{mode:"free",data:c(),group:l,axis:s,pointerId:-1,x:0,y:0,keyboard:!0}),d=$?Lg($):[],u=0,d.length?f():Je("No targets available");return}if(!(!$||$.item!==e||!d.length)){if(h.key==="ArrowDown"||h.key==="ArrowRight"){h.preventDefault(),u=(u+1)%d.length,f();return}(h.key==="ArrowUp"||h.key==="ArrowLeft")&&(h.preventDefault(),u=(u-1+d.length)%d.length,f())}};e.addEventListener("keydown",p),r(()=>{e.removeEventListener("keydown",p);for(let h of d)h.classList.remove("v-drop-over")})});K("draggable-handle");K("draggable-axis");K("draggable-data");K("draggable-group");y("droppable",({el:e,expression:t,scope:n,cleanup:r})=>{to(),e.classList.add("v-droppable");let o={el:e,group:Za(e,ee(e,"droppable-group")),accept:ee(e,"droppable-accept"),expression:t,scope:n};ar.set(e,o),e.hasAttribute("aria-dropeffect")||e.setAttribute("aria-dropeffect","move"),r(()=>{ar.delete(e),e.classList.remove("v-drop-over","v-drop-active")})});K("droppable-accept");K("droppable-group");var Mg=`
.v-visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;
  clip:rect(0 0 0 0);white-space:nowrap;border:0}
...
`;function we(){ge(),Z("ui",Mg)}function lr(e,t){var r;let n=t.trim();if(n)try{let o=document.querySelector(n);if(o)return o}catch(o){}return(r=e.nextElementSibling)!=null?r:null}function Dt(e,t){return e.id||(e.id=le(`${t}-`)),e.id}var hf='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,summary,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function no(e){return Array.from(e.querySelectorAll(hf)).filter(t=>!t.hasAttribute("disabled")&&t.getClientRects().length>0)}function Fi(e,t){let n=no(e);if(!n.length){t.preventDefault(),e.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;if(t.shiftKey&&(i===r||!e.contains(i))){t.preventDefault(),o.focus();return}!t.shiftKey&&i===o&&(t.preventDefault(),r.focus())}function qe(e,t){let n=e.tagName;if(n==="BUTTON"||n==="A"||n==="INPUT"||n==="SUMMARY"){e.classList.add("v-focus-ring");return}e.hasAttribute("role")||e.setAttribute("role","button"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.classList.add("v-focus-ring");let r=o=>{o.key!=="Enter"&&o.key!==" "||(o.preventDefault(),e.click())};e.addEventListener("keydown",r),t(()=>e.removeEventListener("keydown",r))}var rl=0,gf="";function bf(){if(rl++>0)return;let e=window.innerWidth-document.documentElement.clientWidth;gf=document.body.style.paddingRight,e>0&&(document.body.style.paddingRight=`${e}px`),document.body.classList.add("v-scroll-lock")}function yf(){rl!==0&&(--rl>0||(document.body.classList.remove("v-scroll-lock"),document.body.style.paddingRight=gf))}function xf(e){return e.hasAttribute("hidden")||e.style.display==="none"?!0:e.isConnected?getComputedStyle(e).display==="none":!1}function Sg(e,t=!0){if(e.removeAttribute("hidden"),t&&!ve.reducedMotion){Qn(e);return}e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display="block")}function Cg(e,t=!0){if(t&&!ve.reducedMotion){Jn(e);return}e.style.display="none"}var Ag={top:"bottom",bottom:"top",left:"right",right:"left"};function wf(e,t){let n=(e||"").trim().toLowerCase();return n==="top"||n==="bottom"||n==="left"||n==="right"?n:t}function kf(e,t,n,r="center",o=8){t.style.position="fixed",t.style.left="0px",t.style.top="0px";let i=e.getBoundingClientRect(),s=t.getBoundingClientRect(),a=document.documentElement.clientWidth,l=document.documentElement.clientHeight,c={top:i.top,bottom:l-i.bottom,left:i.left,right:a-i.right},d={top:s.height+o,bottom:s.height+o,left:s.width+o,right:s.width+o},u=n;if(c[u]<d[u]){let m=Ag[u];if(c[m]>=d[m])u=m;else for(let h of Object.keys(c))c[h]-d[h]>c[u]-d[u]&&(u=h)}let f=0,p=0;return u==="top"||u==="bottom"?(f=u==="top"?i.top-s.height-o:i.bottom+o,p=r==="start"?i.left:i.left+i.width/2-s.width/2,r==="start"&&p+s.width>a-o&&(p=i.right-s.width)):(p=u==="left"?i.left-s.width-o:i.right+o,f=r==="start"?i.top:i.top+i.height/2-s.height/2),p=Math.min(Math.max(o,p),Math.max(o,a-s.width-o)),f=Math.min(Math.max(o,f),Math.max(o,l-s.height-o)),t.style.left=`${Math.round(p)}px`,t.style.top=`${Math.round(f)}px`,t.setAttribute("data-placement",u),u}var Ni=[],df=!1,Rg={esc:"escape",space:" ",spacebar:" ",enter:"enter",ret:"enter",del:"delete",ins:"insert",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright",plus:"+",minus:"-",comma:",",period:".",slash:"/",question:"?"},$g=typeof navigator!="undefined"&&/Mac|iPhone|iPad|iPod/i.test(navigator.userAgent||"");function al(e){var r;let t=e.trim().toLowerCase().split("+").map(o=>o.trim()).filter(Boolean);if(!t.length)return null;let n={ctrl:!1,shift:!1,alt:!1,meta:!1,key:"",hasModifier:!1};for(let o of t)o==="ctrl"||o==="control"?n.ctrl=!0:o==="shift"?n.shift=!0:o==="alt"||o==="option"?n.alt=!0:o==="meta"||o==="cmd"||o==="command"||o==="super"?n.meta=!0:o==="mod"?$g?n.meta=!0:n.ctrl=!0:n.key=(r=Rg[o])!=null?r:o;return n.key?(n.hasModifier=n.ctrl||n.alt||n.meta,n):null}function Dg(e,t){return e.ctrl!==t.ctrlKey||e.alt!==t.altKey||e.meta!==t.metaKey||t.key.toLowerCase()!==e.key?!1:e.key.length===1&&!/^[a-z0-9 ]$/.test(e.key)?e.shift?t.shiftKey:!0:e.shift===t.shiftKey}function Pg(e){let t=e;return!t||typeof t.tagName!="string"?!1:t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"?!0:t.isContentEditable===!0}function Ef(e){let t=[];return e.ctrl&&t.push("Control"),e.alt&&t.push("Alt"),e.shift&&t.push("Shift"),e.meta&&t.push("Meta"),t.push(e.key===" "?"Space":e.key.length===1?e.key.toUpperCase():e.key),t.join("+")}function Hg(e){if(e.defaultPrevented)return;let t=Pg(e.target);for(let n of[...Ni])for(let r of n.combos)if(Dg(r,e)&&!(t&&!n.options.allowInInput&&!r.hasModifier)){n.options.preventDefault!==!1&&e.preventDefault(),n.handler(e);break}}function ro(e,t,n={}){let r=e.split(",").map(i=>al(i)).filter(i=>i!==null);if(!r.length||typeof document=="undefined")return()=>{};let o={combos:r,handler:t,options:n};return Ni.push(o),df||(df=!0,document.addEventListener("keydown",Hg)),()=>{let i=Ni.indexOf(o);i>-1&&Ni.splice(i,1)}}y("toggle",({el:e,expression:t,modifiers:n,cleanup:r})=>{we();let o=lr(e,t);if(!o)return;let i=typeof n.class=="string"?n.class:null,s=!n.instant;e.setAttribute("aria-controls",Dt(o,"v-toggle")),qe(e,r);let a=i?o.classList.contains(i):!xf(o),l=()=>{e.setAttribute("aria-expanded",String(a))},c=d=>{d.preventDefault(),i?(o.classList.toggle(i),a=o.classList.contains(i)):a?(Cg(o,s),a=!1):(Sg(o,s),a=!0),l(),pe(e,"voodoo:toggle",{target:o,open:a})};l(),e.addEventListener("click",c),r(()=>e.removeEventListener("click",c))});var ol=class{constructor(t){H(this,"panel");H(this,"triggers",new Set);H(this,"listeners",new Set);H(this,"open");H(this,"duration");this.panel=t,this.duration=Q(ee(t,"collapse-duration"),240);let n=(ee(t,"collapse")||"").trim().toLowerCase();this.open=n==="open"||n==="true"||!xf(t),t.classList.add("v-collapse-panel"),Dt(t,"v-collapse"),this.open||(t.style.display="none"),this.sync()}sync(){for(let t of this.triggers)t.setAttribute("aria-expanded",String(this.open)),t.setAttribute("aria-controls",this.panel.id);for(let t of this.listeners)t(this.open)}show(){this.open||(this.open=!0,this.panel.removeAttribute("hidden"),ve.reducedMotion?this.panel.style.removeProperty("display"):pn(this.panel,this.duration),this.sync(),pe(this.panel,"voodoo:collapse",{open:!0}))}hide(){this.open&&(this.open=!1,ve.reducedMotion?this.panel.style.display="none":mn(this.panel,this.duration),this.sync(),pe(this.panel,"voodoo:collapse",{open:!1}))}toggle(){this.open?this.hide():this.show()}},uf=new WeakMap;function ll(e){let t=uf.get(e);return t||uf.set(e,t=new ol(e)),t}y("collapse",({el:e})=>{we(),ll(e)});var il=new WeakSet;y("collapse-toggle",({el:e,expression:t,cleanup:n})=>{we();let r=lr(e,t);if(!r)return;let o=ll(r);o.triggers.add(e),o.sync(),qe(e,n),il.add(e),n(()=>il.delete(e));let i=s=>{s.preventDefault(),o.toggle()};e.addEventListener("click",i),n(()=>{e.removeEventListener("click",i),o.triggers.delete(e)})});K("collapse-duration");var Oi=class{constructor(t,n,r){H(this,"trigger");H(this,"panel");H(this,"kind");H(this,"placement");H(this,"open",!1);H(this,"lastFocus",null);H(this,"homeParent");H(this,"homeNext");H(this,"reposition",()=>{this.open&&kf(this.trigger,this.panel,this.placement,this.kind==="menu"?"start":"center")});H(this,"onDocumentPointerDown",t=>{let n=t.target;n&&(this.panel.contains(n)||this.trigger.contains(n)||this.hide())});H(this,"onKeyDown",t=>{if(!this.open)return;if(t.key==="Escape"){t.preventDefault(),this.hide(!0);return}if(this.kind!=="menu"){t.key==="Tab"&&Fi(this.panel,t);return}let n=this.items();if(!n.length)return;let r=n.indexOf(document.activeElement);if(t.key==="Enter"||t.key===" "){let o=n[r];if(!o)return;t.preventDefault(),this.hide(!0),o.click();return}if(t.key==="ArrowDown"||t.key==="ArrowUp"){t.preventDefault();let o=t.key==="ArrowDown"?1:-1,i=(r+o+n.length)%n.length;n[r===-1&&o===-1?n.length-1:i].focus();return}if(t.key==="Home"){t.preventDefault(),n[0].focus();return}if(t.key==="End"){t.preventDefault(),n[n.length-1].focus();return}t.key==="Tab"&&this.hide()});this.trigger=t,this.panel=n,this.kind=r,this.homeParent=n.parentElement,this.homeNext=n.nextSibling,this.placement=wf(ee(t,r==="menu"?"dropdown-position":"popover-position"),"bottom"),Dt(n,r==="menu"?"v-menu":"v-popover"),n.classList.add(r==="menu"?"v-dropdown-menu":"v-popover"),n.hidden=!0,r==="menu"?Tf(n):n.setAttribute("role","dialog"),t.setAttribute("aria-haspopup",r==="menu"?"menu":"dialog"),t.setAttribute("aria-controls",n.id),t.setAttribute("aria-expanded","false")}items(){return Array.from(this.panel.querySelectorAll('[role="menuitem"]'))}show(){var t;this.open||(this.open=!0,this.lastFocus=document.activeElement,this.panel.parentElement!==document.body&&document.body.appendChild(this.panel),this.panel.hidden=!1,this.reposition(),requestAnimationFrame(()=>this.panel.classList.add("v-in")),this.trigger.setAttribute("aria-expanded","true"),document.addEventListener("pointerdown",this.onDocumentPointerDown,!0),document.addEventListener("keydown",this.onKeyDown,!0),window.addEventListener("resize",this.reposition),window.addEventListener("scroll",this.reposition,!0),this.kind==="dialog"&&((t=no(this.panel)[0])==null||t.focus()),pe(this.trigger,"voodoo:popup",{open:!0,panel:this.panel}))}hide(t=!1){var r;if(!this.open)return;this.open=!1,this.panel.classList.remove("v-in"),this.trigger.setAttribute("aria-expanded","false"),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!0),document.removeEventListener("keydown",this.onKeyDown,!0),window.removeEventListener("resize",this.reposition),window.removeEventListener("scroll",this.reposition,!0);let n=()=>{this.open||(this.panel.hidden=!0)};ve.reducedMotion?n():setTimeout(n,160),t&&((r=this.lastFocus)!=null?r:this.trigger).focus(),pe(this.trigger,"voodoo:popup",{open:!1,panel:this.panel})}toggle(){this.open?this.hide(!0):this.show()}dispose(){this.hide(),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!0),document.removeEventListener("keydown",this.onKeyDown,!0),window.removeEventListener("resize",this.reposition),window.removeEventListener("scroll",this.reposition,!0),!(!this.homeParent||this.panel.parentElement===this.homeParent)&&(this.homeNext&&this.homeNext.parentNode===this.homeParent?this.homeParent.insertBefore(this.panel,this.homeNext):this.homeParent.appendChild(this.panel))}};function Tf(e){we(),e.classList.add("v-dropdown-menu"),e.hasAttribute("role")||e.setAttribute("role","menu");for(let t of Array.from(e.children)){let n=t;n.hasAttribute("role")||n.matches("a,button,[tabindex]")&&(n.setAttribute("role","menuitem"),n.setAttribute("tabindex","-1"))}}y("dropdown-menu",({el:e})=>{Tf(e)});y("dropdown",({el:e,expression:t,cleanup:n})=>{we();let r=lr(e,t);if(!r)return;let o=new Oi(e,r,"menu");qe(e,n);let i=a=>{a.preventDefault(),o.toggle()},s=a=>{var c;if(a.key==="ArrowDown"||a.key==="ArrowUp"){a.preventDefault(),o.open||o.show();let d=o.items();d.length&&d[a.key==="ArrowDown"?0:d.length-1].focus();return}if(a.key!=="Enter"&&a.key!==" ")return;let l=a.defaultPrevented;a.preventDefault(),l||o.toggle(),o.open&&((c=o.items()[0])==null||c.focus())};e.addEventListener("click",i),e.addEventListener("keydown",s),n(()=>{e.removeEventListener("click",i),e.removeEventListener("keydown",s),o.dispose()})});y("popover",({el:e,expression:t,cleanup:n})=>{we();let r=lr(e,t);if(!r)return;let o=new Oi(e,r,"dialog");qe(e,n);let i=s=>{s.preventDefault(),o.toggle()};e.addEventListener("click",i),n(()=>{e.removeEventListener("click",i),o.dispose()})});K("dropdown-position");K("popover-position");y("tooltip",({el:e,expression:t,cleanup:n})=>{we();let r=t.trim();if(!r)return;let o=wf(ee(e,"tooltip-position"),"top"),i=Q(ee(e,"tooltip-delay"),200),s=!e.hasAttribute("tabindex")&&!e.hasAttribute("disabled")&&!e.matches(hf);s&&e.setAttribute("tabindex","0");let a=null,l=null,c=()=>{let v=document.createElement("div");return v.className="v-tooltip",v.setAttribute("role","tooltip"),v.id=le("v-tip-"),v.textContent=r,document.body.appendChild(v),v},d=()=>{a&&kf(e,a,o)},u=()=>{a||(a=c(),e.setAttribute("aria-describedby",a.id),d(),requestAnimationFrame(()=>a==null?void 0:a.classList.add("v-in")),window.addEventListener("resize",d),window.addEventListener("scroll",d,!0))},f=()=>{if(l&&(clearTimeout(l),l=null),!a)return;let v=a;a=null,e.removeAttribute("aria-describedby"),window.removeEventListener("resize",d),window.removeEventListener("scroll",d,!0),v.classList.remove("v-in"),ve.reducedMotion?v.remove():setTimeout(()=>v.remove(),160)},p=()=>{l||a||(l=setTimeout(()=>{l=null,u()},i))},m=v=>{v.key==="Escape"&&f()},h=()=>{s&&e.focus()};e.addEventListener("mouseenter",p),e.addEventListener("focusin",u),e.addEventListener("pointerdown",h),e.addEventListener("mouseleave",f),e.addEventListener("focusout",f),e.addEventListener("keydown",m),n(()=>{f(),s&&e.removeAttribute("tabindex"),e.removeEventListener("mouseenter",p),e.removeEventListener("focusin",u),e.removeEventListener("pointerdown",h),e.removeEventListener("mouseleave",f),e.removeEventListener("focusout",f),e.removeEventListener("keydown",m)})});K("tooltip-position");K("tooltip-delay");y("tabs",({el:e,expression:t,cleanup:n})=>{we();let r=Hi(e,"tab","tabs"),o=Hi(e,"tab-panel","tabs");if(!r.length)return;let i=(v,g)=>Xt(v,"tab")||String(g),s=r[0].parentElement;s&&!s.hasAttribute("role")&&s.setAttribute("role","tablist");let a=((s==null?void 0:s.getAttribute("aria-orientation"))||"").trim().toLowerCase()==="vertical";s==null||s.setAttribute("aria-orientation",a?"vertical":"horizontal");let l=Di(e,"tabs-url")?Xt(e,"tabs-url")||"tab":null;r.forEach((v,g)=>{let b=i(v,g),x=o.find(T=>Xt(T,"tab-panel")===b);v.classList.add("v-tab","v-focus-ring"),v.setAttribute("role","tab"),Dt(v,"v-tab"),x&&(Dt(x,"v-panel"),x.setAttribute("role","tabpanel"),x.setAttribute("aria-labelledby",v.id),v.setAttribute("aria-controls",x.id))});let c="",d=(v,g=!1)=>{if(r.some((b,x)=>i(b,x)===v)){c=v,r.forEach((b,x)=>{let T=i(b,x)===v;b.setAttribute("aria-selected",String(T)),b.setAttribute("tabindex",T?"0":"-1"),b.classList.toggle("v-active",T),T&&g&&b.focus()});for(let b of o)b.hidden=Xt(b,"tab-panel")!==v;l&&_t.set(l,v),pe(e,"voodoo:tab",{id:v})}},u=v=>{let g=zn(v.target,"tab");!g||!r.includes(g)||(v.preventDefault(),d(i(g,r.indexOf(g))))},f=v=>{let g=zn(v.target,"tab");if(!g||!r.includes(g))return;let b=r.indexOf(g),x=a?"ArrowDown":"ArrowRight",T=a?"ArrowUp":"ArrowLeft",E=-1;v.key===x?E=(b+1)%r.length:v.key===T?E=(b-1+r.length)%r.length:v.key==="Home"?E=0:v.key==="End"&&(E=r.length-1),E!==-1&&(v.preventDefault(),d(i(r[E],E),!0))},p=()=>{if(!l)return;let v=_t.get(l);v&&v!==c&&d(v)};e.addEventListener("click",u),e.addEventListener("keydown",f),window.addEventListener("popstate",p),n(()=>{e.removeEventListener("click",u),e.removeEventListener("keydown",f),window.removeEventListener("popstate",p)});let h=(l?_t.get(l):void 0)||t.trim()||i(r[0],0);d(h),c||d(i(r[0],0))});K("tab");K("tab-panel");K("tabs-url");y("accordion",({el:e,cleanup:t})=>{we();let n=Hi(e,"accordion-item","accordion");if(!n.length)return;let r=Di(e,"accordion-single"),o=[],i=[];for(let l of n){let c=l.firstElementChild,d=l.lastElementChild;if(!c||!d||c===d)continue;let u=(Xt(l,"accordion-item")||"").trim().toLowerCase();u!=="open"&&u!=="true"&&(d.style.display="none");let f=ll(d);f.triggers.add(c),f.sync(),c.classList.add("v-accordion-header","v-focus-ring"),c.hasAttribute("role")||c.setAttribute("role","button"),c.hasAttribute("tabindex")||c.setAttribute("tabindex","0"),Dt(d,"v-accordion-panel"),c.setAttribute("aria-controls",d.id),c.setAttribute("aria-expanded",String(f.open)),n.length<=6&&!d.hasAttribute("role")&&(d.setAttribute("role","region"),d.setAttribute("aria-labelledby",Dt(c,"v-accordion-header"))),o.push(c),i.push(f)}let s=l=>{var p;let c=(p=l.target)==null?void 0:p.closest(".v-accordion-header");if(!c)return;let d=o.indexOf(c);if(d===-1)return;l.preventDefault();let u=i[d],f=il.has(c);if(r&&(f?u.open:!u.open))for(let m of i)m!==u&&m.hide();f||u.toggle()},a=l=>{var f;let c=(f=l.target)==null?void 0:f.closest(".v-accordion-header");if(!c)return;let d=o.indexOf(c);if(d===-1)return;if(l.key==="Enter"||l.key===" "){l.preventDefault(),c.click();return}let u=-1;l.key==="ArrowDown"?u=(d+1)%o.length:l.key==="ArrowUp"?u=(d-1+o.length)%o.length:l.key==="Home"?u=0:l.key==="End"&&(u=o.length-1),u!==-1&&(l.preventDefault(),o[u].focus())};e.addEventListener("click",s),e.addEventListener("keydown",a),t(()=>{e.removeEventListener("click",s),e.removeEventListener("keydown",a)})});K("accordion-item");K("accordion-single");var sl=class{constructor(t){H(this,"origem",null);H(this,"panel");H(this,"triggers",new Set);H(this,"open",!1);H(this,"backdrop",null);H(this,"lastFocus",null);H(this,"onKeyDown",t=>{if(this.open){if(t.key==="Escape"){t.preventDefault(),this.hide();return}t.key==="Tab"&&Fi(this.panel,t)}});H(this,"onPointerDown",t=>{let n=t.target;if(!(!n||this.panel.contains(n))){for(let r of this.triggers)if(r.contains(n))return;this.hide()}});this.panel=t;let n=(ee(t,"drawer-side")||"right").trim().toLowerCase();t.classList.add("v-drawer-panel"),t.setAttribute("data-side",["left","right","top","bottom"].includes(n)?n:"right"),t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.hasAttribute("tabindex")||t.setAttribute("tabindex","-1"),Dt(t,"v-drawer"),t.hidden=!0,this.label()}label(){let t=this.panel;if(t.hasAttribute("aria-labelledby")||t.hasAttribute("aria-label"))return;let n=t.querySelector("[data-drawer-title],h1,h2,h3,h4");n&&t.setAttribute("aria-labelledby",Dt(n,"v-drawer-title"))}sync(){for(let t of this.triggers)t.setAttribute("aria-expanded",String(this.open)),t.setAttribute("aria-controls",this.panel.id),t.setAttribute("aria-haspopup","dialog")}show(){var n,r;if(this.open)return;this.open=!0,this.lastFocus=document.activeElement,this.backdrop=document.createElement("div"),this.backdrop.className="v-drawer-backdrop",this.backdrop.addEventListener("click",()=>this.hide()),document.body.appendChild(this.backdrop),this.panel.parentElement!==document.body&&(this.origem=document.createComment(" v-drawer "),(n=this.panel.parentNode)==null||n.insertBefore(this.origem,this.panel),document.body.appendChild(this.panel)),this.panel.hidden=!1,this.label(),bf();let t=()=>{var o;(o=this.backdrop)==null||o.classList.add("v-in"),this.panel.classList.add("v-open")};ve.reducedMotion?t():requestAnimationFrame(t),document.addEventListener("keydown",this.onKeyDown,!0),document.addEventListener("pointerdown",this.onPointerDown,!0),((r=no(this.panel)[0])!=null?r:this.panel).focus(),this.sync(),pe(this.panel,"voodoo:drawer",{open:!0})}hide(){var n,r;if(!this.open)return;this.open=!1,this.panel.classList.remove("v-open"),(n=this.backdrop)==null||n.classList.remove("v-in"),document.removeEventListener("keydown",this.onKeyDown,!0),document.removeEventListener("pointerdown",this.onPointerDown,!0);let t=()=>{var o;this.open||(this.panel.hidden=!0,(o=this.backdrop)==null||o.remove(),this.backdrop=null,this.origem&&this.origem.parentNode&&(this.origem.parentNode.insertBefore(this.panel,this.origem),this.origem.remove(),this.origem=null))};ve.reducedMotion?t():setTimeout(t,300),yf(),(r=this.lastFocus)==null||r.focus(),this.sync(),pe(this.panel,"voodoo:drawer",{open:!1})}toggle(){this.open?this.hide():this.show()}},ff=new WeakMap;function cl(e){let t=ff.get(e);return t||ff.set(e,t=new sl(e)),t}y("drawer-content",({el:e})=>{we(),cl(e)});function Lf(e,t,n){we();let r=lr(e,t);if(!r)return;let o=cl(r);o.triggers.add(e),o.sync(),qe(e,n);let i=s=>{s.preventDefault(),o.toggle()};e.addEventListener("click",i),n(()=>{e.removeEventListener("click",i),o.triggers.delete(e)})}y("drawer",({el:e,expression:t,cleanup:n})=>{Lf(e,t,n)});y("offcanvas",({el:e,expression:t,cleanup:n})=>{Lf(e,t,n)});y("drawer-close",({el:e,expression:t,cleanup:n})=>{var i,s;let r=t.trim()?lr(e,t):(i=e.closest(".v-drawer-panel"))!=null?i:zn(e,"drawer-content");if(!r)return;qe(e,n),!e.hasAttribute("aria-label")&&!((s=e.textContent)!=null&&s.trim())&&e.setAttribute("aria-label","Close");let o=a=>{a.preventDefault(),cl(r).hide()};e.addEventListener("click",o),n(()=>e.removeEventListener("click",o))});K("drawer-side");y("theme-toggle",({el:e,cleanup:t})=>{qe(e,t);let n=()=>{let i=mt.resolved==="dark";e.setAttribute("aria-pressed",String(i)),e.dataset.vTheme=mt.resolved,e.hasAttribute("aria-label")||e.setAttribute("aria-label",i?"Switch to light theme":"Switch to dark theme")},r=i=>{i.preventDefault(),mt.toggle(),n()},o=()=>n();n(),e.addEventListener("click",r),document.addEventListener("voodoo:theme",o),t(()=>{e.removeEventListener("click",r),document.removeEventListener("voodoo:theme",o)})});y("focus",({el:e,expression:t,modifiers:n,effect:r,evaluate:o})=>{let i=()=>{e.focus({preventScroll:!!n.quiet});let s=e;n.select&&typeof s.select=="function"&&s.select()};if(!t.trim()){Se(i);return}r(()=>{o()&&Se(i)})},{priority:j.INIT});y("focus-trap",({el:e,expression:t,effect:n,evaluate:r,cleanup:o})=>{let i=!t.trim(),s=a=>{!i||a.key!=="Tab"||e.isConnected&&Fi(e,a)};t.trim()?n(()=>{let a=!!r();a&&!i&&Se(()=>{var l;return((l=no(e)[0])!=null?l:e).focus()}),i=a}):Se(()=>{var a;return((a=no(e)[0])!=null?a:e).focus()}),e.hasAttribute("tabindex")||e.setAttribute("tabindex","-1"),document.addEventListener("keydown",s,!0),o(()=>document.removeEventListener("keydown",s,!0))});y("click-outside",({el:e,expression:t,scope:n,cleanup:r})=>{let o=i=>{if(!e.isConnected)return;let s=i.target;!s||e===s||e.contains(s)||gt(t,n,e,i)};document.addEventListener("pointerdown",o,!0),r(()=>document.removeEventListener("pointerdown",o,!0))});y("escape",({el:e,expression:t,scope:n,cleanup:r})=>{let o=i=>{i.key!=="Escape"||!e.isConnected||gt(t,n,e,i)};document.addEventListener("keydown",o),r(()=>document.removeEventListener("keydown",o))});y("hotkey",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim();if(!o)return;let i=ro(o,()=>e.click(),{allowInInput:!!n.force,preventDefault:n.default!==!0}),s=al(o.split(",")[0]);s&&!e.hasAttribute("aria-keyshortcuts")&&e.setAttribute("aria-keyshortcuts",Ef(s)),r(i)});y("scroll-to",({el:e,expression:t,cleanup:n})=>{let r=o=>{let i=t.trim()||e.getAttribute("href")||"";if(!i)return;o.preventDefault();let s=parseFloat(ee(e,"scroll-offset")||"0")||0,a=ve.reducedMotion?"auto":"smooth";if(i==="top"||i==="#top"){window.scrollTo({top:0,behavior:a});return}if(i==="bottom"){window.scrollTo({top:document.body.scrollHeight,behavior:a});return}let l=null;try{l=document.querySelector(i)}catch(u){l=null}if(!l)return;let c=l.getBoundingClientRect().top+window.scrollY-s;window.scrollTo({top:c,behavior:a});let d=l;d.hasAttribute("tabindex")||d.setAttribute("tabindex","-1"),d.focus({preventScroll:!0})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});y("scrollspy",({el:e,cleanup:t})=>{let n=Array.from(e.querySelectorAll('a[href^="#"]'));if(!n.length)return;let r=ee(e,"scrollspy-class")||"v-active",o=parseFloat(ee(e,"scroll-offset")||"0")||0,i=n.map(c=>{let d=c.getAttribute("href")||"",u=d.length>1?document.querySelector(d):null;return u?{link:c,section:u}:null}).filter(c=>c!==null);if(!i.length)return;let s=null,a=()=>{let c=i[0];for(let d of i)d.section.getBoundingClientRect().top-o<=8&&(c=d);if(c.link!==s){s=c.link;for(let d of i){let u=d.link===s;d.link.classList.toggle(r,u),u?d.link.setAttribute("aria-current","true"):d.link.removeAttribute("aria-current")}pe(e,"voodoo:scrollspy",{id:c.section.id,link:c.link})}},l=zr(a,100);window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),Se(a),t(()=>{l.cancel(),window.removeEventListener("scroll",l),window.removeEventListener("resize",l)})});K("scroll-offset");K("scrollspy-class");y("sticky",({el:e,expression:t,cleanup:n})=>{we();let r=parseFloat(t.trim()||ee(e,"sticky-offset")||"0")||0;if(e.classList.add("v-sticky"),e.style.setProperty("--v-sticky-offset",`${r}px`),typeof IntersectionObserver=="undefined")return;let o=new IntersectionObserver(i=>{for(let s of i){let a=s.intersectionRatio<1&&s.boundingClientRect.top<=r+1;e.classList.toggle("v-stuck",a)}},{threshold:[1],rootMargin:`-${r+1}px 0px 0px 0px`});o.observe(e),n(()=>o.disconnect())});K("sticky-offset");y("visible",({el:e,expression:t,scope:n,modifiers:r,cleanup:o})=>{var c;let i=!!r.repeat,s=Number((c=r.threshold)!=null?c:.1)||.1,a=typeof r.margin=="string"?r.margin:"0px";if(typeof IntersectionObserver=="undefined"){gt(t,n,e,void 0,{visible:!0});return}let l=new IntersectionObserver(d=>{for(let u of d)u.isIntersecting&&(gt(t,n,e,void 0,u),i||l.unobserve(e))},{threshold:s,rootMargin:a});l.observe(e),o(()=>l.disconnect())});y("infinite-scroll",({el:e,expression:t,scope:n,cleanup:r})=>{let o=ee(e,"infinite-distance")||"200px",i=!1,s=()=>{i=!1},a=()=>{if(i)return;i=!0,e.setAttribute("aria-busy","true");let d=gt(t,n,e,void 0,{page:"next"}),u=()=>{e.removeAttribute("aria-busy"),setTimeout(s,120)};d&&typeof d.then=="function"?d.then(u,u):setTimeout(u,300)};if(typeof IntersectionObserver=="undefined")return;let l=document.createElement("div");l.className="v-infinite-sentinel",l.setAttribute("aria-hidden","true"),l.style.cssText="width:100%;height:1px;pointer-events:none",e.appendChild(l);let c=new IntersectionObserver(d=>{for(let u of d)u.isIntersecting&&a()},{rootMargin:`0px 0px ${o} 0px`});c.observe(l),r(()=>{c.disconnect(),l.remove()})});K("infinite-distance");function Mf(e,t,n,r){if(we(),!t)return;e.classList.add("v-lazy");let o=a=>{r?e.style.backgroundImage=`url("${a}")`:e.src=a,e.classList.add("v-lazy-loaded")},i=()=>{let a=new Image;a.onload=()=>o(t),a.onerror=()=>{let l=ee(e,"lazy-error");e.classList.add("v-lazy-failed"),l?o(l):e.classList.add("v-lazy-loaded")},a.src=t};if(!r&&e.tagName==="IMG"){let a=e;a.hasAttribute("loading")||(a.loading="lazy"),a.hasAttribute("decoding")||(a.decoding="async")}if(typeof IntersectionObserver=="undefined"){i();return}let s=new IntersectionObserver(a=>{for(let l of a)l.isIntersecting&&(s.disconnect(),i())},{rootMargin:"200px"});s.observe(e),n(()=>s.disconnect())}y("lazy-src",({el:e,expression:t,cleanup:n})=>{Mf(e,t.trim(),n,!1)});y("lazy-bg",({el:e,expression:t,cleanup:n})=>{Mf(e,t.trim(),n,!0)});K("lazy-error");y("skeleton",({el:e,expression:t,effect:n,evaluate:r,cleanup:o})=>{we();let i=l=>{e.classList.toggle("v-skeleton",l),l?e.setAttribute("aria-busy","true"):e.removeAttribute("aria-busy")};if(t.trim()){n(()=>i(!!r()));return}let s=()=>{var l;return((l=e.textContent)!=null?l:"").trim().length>0||e.querySelector("img,svg,video,canvas")!==null};if(s()){i(!1);return}if(i(!0),typeof MutationObserver=="undefined")return;let a=new MutationObserver(()=>{s()&&(i(!1),a.disconnect())});a.observe(e,{childList:!0,subtree:!0,characterData:!0}),o(()=>a.disconnect())});async function dl(e){var t;try{if((t=navigator.clipboard)!=null&&t.writeText)return await navigator.clipboard.writeText(e),!0}catch(n){}try{let n=document.createElement("textarea");n.value=e,n.setAttribute("readonly",""),n.style.cssText="position:fixed;top:-1000px;left:-1000px;opacity:0",document.body.appendChild(n),n.select();let r=document.execCommand("copy");return n.remove(),r}catch(n){return!1}}function ul(e,t){we();let n=ee(e,"copy-label")||(t?"Copied!":"Could not copy");e.dataset.vCopyLabel=n,e.classList.add(t?"v-copied":"v-copy-failed"),Je(n),setTimeout(()=>e.classList.remove("v-copied","v-copy-failed"),1600)}function Sf(e,t){var r;let n=ee(e,"copy-from");if(n){let o=document.querySelector(n);if(o){let i=o;return typeof i.value=="string"&&i.value?i.value:((r=o.textContent)!=null?r:"").trim()}}return t.trim()}y("copy",({el:e,expression:t,cleanup:n})=>{we(),qe(e,n);let r=o=>{o.preventDefault();let i=Sf(e,t);i&&dl(i).then(s=>{ul(e,s),pe(e,"voodoo:copy",{text:i,ok:s})})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});y("copy-from",({el:e,expression:t,cleanup:n})=>{if(we(),Pi(e,"copy-from",t),Di(e,"copy"))return;qe(e,n);let r=o=>{o.preventDefault();let i=Sf(e,"");i&&dl(i).then(s=>{ul(e,s),pe(e,"voodoo:copy",{text:i,ok:s})})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});K("copy-label");function Ng(e,t){let n=document.createElement("iframe");n.setAttribute("aria-hidden","true"),n.setAttribute("title","Print"),n.style.cssText="position:fixed;right:0;bottom:0;width:0;height:0;border:0;visibility:hidden";let r=Array.from(document.querySelectorAll('link[rel="stylesheet"],style')).map(o=>o.outerHTML).join(`
`);n.srcdoc=`<!doctype html><html><head><meta charset="utf-8"><title>${I(t)}</title>${r}</head><body>${e.outerHTML}</body></html>`,n.addEventListener("load",()=>{let o=n.contentWindow;if(!o){n.remove();return}o.focus(),o.print(),setTimeout(()=>n.remove(),1e3)}),document.body.appendChild(n)}y("print",({el:e,expression:t,cleanup:n})=>{qe(e,n);let r=o=>{o.preventDefault();let i=t.trim(),s=i?document.querySelector(i):null;if(!i){window.print();return}s&&Ng(s,document.title)};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});y("share",({el:e,expression:t,cleanup:n})=>{we(),qe(e,n);let r=o=>{o.preventDefault();let i=t.trim()||ee(e,"share-url")||location.href,s={title:ee(e,"share-title")||document.title,url:i},a=ee(e,"share-text");a&&(s.text=a);let l=navigator;if(typeof l.share=="function"){l.share(s).then(()=>pe(e,"voodoo:share",{data:s,method:"native"}),()=>{});return}dl(i).then(c=>{ul(e,c),pe(e,"voodoo:share",{data:s,method:"clipboard",ok:c})})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});K("share-title");K("share-url");K("share-text");y("fullscreen",({el:e,expression:t,cleanup:n})=>{var s;qe(e,n);let r=t.trim()&&(s=document.querySelector(t.trim()))!=null?s:e,o=()=>{e.setAttribute("aria-pressed",String(document.fullscreenElement===r))},i=a=>{var c;if(a.preventDefault(),document.fullscreenElement){document.exitFullscreen().catch(()=>{});return}let l=r;typeof r.requestFullscreen=="function"?r.requestFullscreen().catch(()=>{}):(c=l.webkitRequestFullscreen)==null||c.call(l)};o(),e.addEventListener("click",i),document.addEventListener("fullscreenchange",o),n(()=>{e.removeEventListener("click",i),document.removeEventListener("fullscreenchange",o)})});y("download",({el:e,expression:t,cleanup:n})=>{qe(e,n);let r=o=>{let i=t.trim()||e.getAttribute("href")||"";if(!i)return;o.preventDefault();let s=document.createElement("a");s.href=i,s.rel="noopener",s.download=ee(e,"download-name")||"",s.style.display="none",document.body.appendChild(s),s.click(),s.remove(),pe(e,"voodoo:download",{href:i,name:s.download})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});K("download-name");y("resizable",({el:e,expression:t,cleanup:n})=>{we();let r=(t.trim()||"both").toLowerCase(),o=r==="both"||r==="horizontal",i=r==="both"||r==="vertical";e.classList.add("v-resizable"),getComputedStyle(e).position==="static"&&(e.style.position="relative");let s=[],a=[];o&&a.push("right"),i&&a.push("bottom"),o&&i&&a.push("corner");let l=(c,d)=>{let u=0,f=0,p=0,m=0,h=g=>{d!=="bottom"&&(e.style.width=`${Math.max(32,p+g.clientX-u)}px`),d!=="right"&&(e.style.height=`${Math.max(32,m+g.clientY-f)}px`)},v=g=>{var b;(b=c.releasePointerCapture)==null||b.call(c,g.pointerId),c.removeEventListener("pointermove",h),c.removeEventListener("pointerup",v),c.removeEventListener("pointercancel",v),pe(e,"voodoo:resized",{width:e.getBoundingClientRect().width,height:e.getBoundingClientRect().height})};c.addEventListener("pointerdown",g=>{var x;if(g.button!==0)return;g.preventDefault();let b=e.getBoundingClientRect();u=g.clientX,f=g.clientY,p=b.width,m=b.height,(x=c.setPointerCapture)==null||x.call(c,g.pointerId),c.addEventListener("pointermove",h),c.addEventListener("pointerup",v),c.addEventListener("pointercancel",v)}),c.addEventListener("keydown",g=>{let b=g.shiftKey?4:16,x=e.getBoundingClientRect(),T=!0;g.key==="ArrowRight"&&d!=="bottom"?e.style.width=`${x.width+b}px`:g.key==="ArrowLeft"&&d!=="bottom"?e.style.width=`${Math.max(32,x.width-b)}px`:g.key==="ArrowDown"&&d!=="right"?e.style.height=`${x.height+b}px`:g.key==="ArrowUp"&&d!=="right"?e.style.height=`${Math.max(32,x.height-b)}px`:T=!1,T&&(g.preventDefault(),pe(e,"voodoo:resized",{width:e.getBoundingClientRect().width,height:e.getBoundingClientRect().height}))})};for(let c of a){let d=document.createElement("div");d.className="v-resize-handle",d.setAttribute("data-dir",c),d.setAttribute("role","separator"),d.setAttribute("tabindex","0"),d.setAttribute("aria-orientation",c==="bottom"?"horizontal":"vertical"),d.setAttribute("aria-label","Resize"),l(d,c),e.appendChild(d),s.push(d)}n(()=>{for(let c of s)c.remove()})});function pf(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function Og(){let e=[];for(let t of Xo(document,"command-item")){let n=(Xt(t,"command-item")||t.textContent||"").trim();n&&(t.closest("[hidden]")||e.push({label:n,hint:ee(t,"command-hint")||"",el:t}))}return e}function mf(){if(we(),document.querySelector(".v-command"))return;let e=Og(),t=document.activeElement,n=document.createElement("div");n.className="v-command",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Command palette"),n.tabIndex=-1;let r=document.createElement("div");r.className="v-command-box";let o=document.createElement("input");o.className="v-command-input",o.type="search",o.placeholder="Search command...",o.setAttribute("aria-label","Search command"),o.setAttribute("role","combobox"),o.setAttribute("aria-expanded","true"),o.setAttribute("autocomplete","off");let i=document.createElement("ul");i.className="v-command-list",i.id=le("v-cmd-list-"),i.setAttribute("role","listbox"),o.setAttribute("aria-controls",i.id),r.append(o,i),n.appendChild(r),document.body.appendChild(n),bf();let s=e,a=0,l=m=>{let h=m.target;!h||n.contains(h)||o.focus()},c=()=>{document.removeEventListener("focusin",l,!0),document.removeEventListener("keydown",p,!0),n.remove(),yf(),t==null||t.focus()},d=()=>{let m=s[a];m&&(c(),m.el.click())},u=()=>{var h;if(i.replaceChildren(),!s.length){let v=document.createElement("li");v.className="v-command-empty",v.textContent="No command found",i.appendChild(v);return}s.forEach((v,g)=>{let b=document.createElement("li");b.className="v-command-option",b.id=`${i.id}-${g}`,b.setAttribute("role","option"),b.setAttribute("aria-selected",String(g===a));let x=document.createElement("span");if(x.textContent=v.label,b.appendChild(x),v.hint){let T=document.createElement("span");T.className="v-command-hint",T.textContent=v.hint,b.appendChild(T)}b.addEventListener("click",()=>{a=g,d()}),b.addEventListener("pointermove",()=>{a!==g&&(a=g,u())}),i.appendChild(b)});let m=i.children[a];m&&(o.setAttribute("aria-activedescendant",m.id),(h=m.scrollIntoView)==null||h.call(m,{block:"nearest"}))},f=()=>{let m=pf(o.value.trim());s=m?e.filter(h=>pf(`${h.label} ${h.hint}`).includes(m)):e,a=0,u()},p=m=>{if(m.key==="Escape"){m.preventDefault(),c();return}if(m.key==="ArrowDown"){m.preventDefault(),a=s.length?(a+1)%s.length:0,u();return}if(m.key==="ArrowUp"){m.preventDefault(),a=s.length?(a-1+s.length)%s.length:0,u();return}if(m.key==="Enter"){m.preventDefault(),d();return}m.key==="Tab"&&Fi(n,m)};n.addEventListener("pointerdown",m=>{m.target===n&&c()}),o.addEventListener("input",f),document.addEventListener("keydown",p,!0),u(),o.focus(),document.addEventListener("focusin",l,!0)}y("command",({el:e,expression:t,cleanup:n})=>{we();let r=t.trim()||ee(e,"command-key")||"mod+k",o=a=>{a.preventDefault(),mf()},i=ro(r,()=>mf(),{allowInInput:!0}),s=al(r.split(",")[0]);s&&!e.hasAttribute("aria-keyshortcuts")&&e.setAttribute("aria-keyshortcuts",Ef(s)),qe(e,n),e.addEventListener("click",o),n(()=>{i(),e.removeEventListener("click",o)})});y("command-item",({el:e,expression:t})=>{Pi(e,"command-item",t),!e.hasAttribute("data-v-command-label")&&t.trim()&&e.setAttribute("data-v-command-label",t.trim())});K("command-key");K("command-hint");var vf=["pointerdown","pointermove","keydown","wheel","touchstart","scroll"];y("idle",({el:e,expression:t,scope:n,cleanup:r})=>{let o=Q(ee(e,"idle-after"),6e4),i=null,s=!1,a=()=>{s=!0,gt(t,n,e,void 0,{idle:!0,after:o}),pe(e,"voodoo:idle",{after:o})},l=()=>{i&&clearTimeout(i),s=!1,i=setTimeout(a,o)},c=()=>{if(s){l();return}l()};for(let d of vf)window.addEventListener(d,c,{passive:!0});l(),r(()=>{i&&clearTimeout(i);for(let d of vf)window.removeEventListener(d,c)})});K("idle-after");function Cf(e,t,n,r,o,i){let s=a=>{gt(t,n,e,a,{online:navigator.onLine}),pe(e,`voodoo:${o}`,{online:navigator.onLine})};window.addEventListener(o,s),r(()=>window.removeEventListener(o,s)),i&&navigator.onLine===(o==="online")&&Se(()=>s())}y("online",({el:e,expression:t,scope:n,modifiers:r,cleanup:o})=>{Cf(e,t,n,o,"online",!!r.immediate)});y("offline",({el:e,expression:t,scope:n,modifiers:r,cleanup:o})=>{Cf(e,t,n,o,"offline",r["no-immediate"]!==!0)});de();ce();Ae();de();ce();Ae();var lt={required:"Please fill in this field.",email:"Enter a valid email address.",url:"Enter a valid URL.",number:"Enter a valid number.",integer:"Enter a whole number.",decimal:"Enter a valid decimal number.",alpha:"Use letters only.",alphanumeric:"Use letters and numbers only.",minlength:"Use at least {param} characters.",maxlength:"Use at most {param} characters.",min:"The smallest allowed value is {param}.",max:"The largest allowed value is {param}.",between:"Enter a value between {min} and {max}.",match:"The fields do not match.",regex:"That format is not valid.",date:"Enter a valid date.",after:"The date has to be later than {param}.",before:"The date has to be earlier than {param}.",accepted:"You have to tick this to continue.",same:"The values have to be the same.",different:"The values have to be different.",in:"Choose one of the allowed options.",notin:"That value is not allowed.",phone:"Enter a valid phone number, including the area code.",cpf:"Invalid CPF.",cnpj:"Invalid CNPJ.",cep:"Invalid postcode.",creditcard:"Invalid card number.",strongpassword:"Use {param} characters or more, with an upper case letter, a lower case letter, a number and a symbol.",unique:"That value is already taken.",invalid:"Invalid value."};function Rf(e,t){var i,s,a,l,c,d;let n=(i=t.param)!=null?i:"",r=n.split(","),o={param:n,field:(s=t.field)!=null?s:"field",value:(a=t.value)!=null?a:"",min:((l=r[0])!=null?l:"").trim(),max:((d=(c=r[1])!=null?c:r[0])!=null?d:"").trim()};return e.replace(/\{(\w+)\}/g,(u,f)=>f in o?o[f]:u)}var Bi=new Map;function J(e,t,n){let r=e.toLowerCase();Bi.set(r,{name:r,fn:t,message:n}),n&&!lt[r]&&(lt[r]=n),y(`validate-${r}`,({el:o,cleanup:i})=>{Yi(o,i)})}function Pt(e,t){var n;return(n=Te(e,`${w.prefix}${t}`))!=null?n:Te(e,`data-v-${t}`)}function Fg(e,t){return Pt(e,t)!==null}var Ig=new Set(["INPUT","SELECT","TEXTAREA"]),zg=new Set(["submit","button","reset","image"]);function Ze(e){var t;return!!e&&typeof e=="object"&&Ig.has((t=e.tagName)!=null?t:"")}function yt(e){return e.tagName==="SELECT"?"select":e.tagName==="TEXTAREA"?"textarea":(e.getAttribute("type")||"text").toLowerCase()}function so(e){var n;let t=yt(e);if(t==="checkbox"||t==="radio")return e.checked?e.value||"on":"";if(t==="file"){let r=e.files;return r&&r.length?String(r.length):""}return(n=e.value)!=null?n:""}function ml(e){return e.name||e.id||`field-${e.tagName.toLowerCase()}`}function Bg(e){var o,i;let t=Pt(e,"label");if(t)return t;if(e.id&&typeof document!="undefined"){let s=document.querySelector(`label[for="${Ii(e.id)}"]`),a=(o=s==null?void 0:s.textContent)==null?void 0:o.trim();if(a)return a.replace(/\s*\*$/,"")}let n=e.closest("label"),r=(i=n==null?void 0:n.textContent)==null?void 0:i.trim();return r?r.replace(/\s*\*$/,""):e.getAttribute("aria-label")||e.getAttribute("placeholder")||e.name||"field"}function Ii(e){let t=globalThis.CSS;return t&&typeof t.escape=="function"?t.escape(e):e.replace(/["'\\\]\[]/g,"\\$&")}function ji(e,t){var s,a,l;let n=t.trim();if(!n||typeof document=="undefined")return null;let r=(a=(s=e.form)!=null?s:e.closest("form"))!=null?a:document;if(/^[#.[]/.test(n)){let c=(l=r.querySelector(n))!=null?l:document.querySelector(n);return Ze(c)?c:null}let o=r.querySelector(`[name="${Ii(n)}"]`);if(Ze(o))return o;let i=document.getElementById(n);return Ze(i)?i:null}var jg=/^[^\s@]+@[^\s@.]+(?:\.[^\s@.]+)+$/,qg=/^-?\d+$/,Vg=/^-?\d+(?:[.,]\d+)?$/,Ug=/^[A-Za-zÀ-ÖØ-öø-ɏ]+$/,_g=/^[A-Za-z0-9À-ÖØ-öø-ɏ]+$/;function ao(e){return e.replace(/\D/g,"")}function qi(e){return Number(String(e).replace(/\s/g,"").replace(/\.(?=\d{3}\b)/g,"").replace(",","."))}function Wg(e){let t=ao(e);if(t.length!==11||/^(\d)\1{10}$/.test(t))return!1;let n=0;for(let i=0;i<9;i++)n+=Number(t[i])*(10-i);let r=n*10%11;if(r===10&&(r=0),r!==Number(t[9]))return!1;n=0;for(let i=0;i<10;i++)n+=Number(t[i])*(11-i);let o=n*10%11;return o===10&&(o=0),o===Number(t[10])}function Kg(e){let t=ao(e);if(t.length!==14||/^(\d)\1{13}$/.test(t))return!1;let n=r=>{let o=r-7,i=0;for(let a=0;a<r;a++)i+=Number(t[a])*o--,o<2&&(o=9);let s=i%11;return s<2?0:11-s};return n(12)===Number(t[12])&&n(13)===Number(t[13])}function Yg(e){let t=ao(e);if(t.length<13||t.length>19)return!1;let n=0,r=!1;for(let o=t.length-1;o>=0;o--){let i=Number(t[o]);r&&(i*=2,i>9&&(i-=9)),n+=i,r=!r}return n%10===0}function Xg(e){let t=ao(e);return!(t.length!==10&&t.length!==11||Number(t.slice(0,2))<11||t.length===11&&t[2]!=="9"||t.length===10&&Number(t[2])<2)}function bn(e){let t=e.trim();if(!t)return null;let n=/^(\d{2})\/(\d{2})\/(\d{4})$/.exec(t);if(n){let i=new Date(Number(n[3]),Number(n[2])-1,Number(n[1]));return i.getFullYear()===Number(n[3])&&i.getMonth()===Number(n[2])-1&&i.getDate()===Number(n[1])?i:null}let r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(r){let i=new Date(Number(r[1]),Number(r[2])-1,Number(r[3]));return i.getFullYear()===Number(r[1])&&i.getMonth()===Number(r[2])-1&&i.getDate()===Number(r[3])?i:null}let o=Date.parse(t);return Number.isNaN(o)?null:new Date(o)}function Vi(e,t){if(!e)return null;let n=e.trim().toLowerCase();if(n==="hoje"||n==="today"||n==="now"||n==="agora")return new Date;let r=bn(e);if(r)return r;let o=ji(t,e);return o?bn(so(o)):null}J("required",(e,t,n)=>{let r=yt(n);if(r==="checkbox"||r==="radio")return n.checked;if(r==="file"){let o=n.files;return!!o&&o.length>0}return e.trim().length>0});J("email",e=>jg.test(e.trim()));J("url",e=>{let t=e.trim();if(!t)return!1;try{let n=new URL(/^[a-z][a-z0-9+.-]*:\/\//i.test(t)?t:`https://${t}`);return n.hostname.includes(".")&&!n.hostname.endsWith(".")}catch(n){return!1}});J("number",e=>e.trim()!==""&&Number.isFinite(qi(e)));J("integer",e=>qg.test(e.trim()));J("decimal",(e,t)=>{var i;let n=e.trim();if(!Vg.test(n))return!1;if(!t)return!0;let r=Number(t);return Number.isFinite(r)?((i=n.split(/[.,]/)[1])!=null?i:"").length<=r:!0});J("alpha",e=>Ug.test(e.trim().replace(/\s+/g,"")));J("alphanumeric",e=>_g.test(e.trim().replace(/\s+/g,"")));J("minlength",(e,t)=>e.trim().length>=Number(t!=null?t:0));J("maxlength",(e,t)=>e.trim().length<=Number(t!=null?t:1/0));J("min",(e,t,n)=>{let r=Vi(t,n);if(r&&yt(n).startsWith("date")){let o=bn(e);return!o||o.getTime()>=r.getTime()}return qi(e)>=Number(t!=null?t:0)});J("max",(e,t,n)=>{let r=Vi(t,n);if(r&&yt(n).startsWith("date")){let o=bn(e);return!o||o.getTime()<=r.getTime()}return qi(e)<=Number(t!=null?t:1/0)});J("between",(e,t)=>{let[n,r]=(t!=null?t:"").split(",").map(i=>Number(i.trim())),o=qi(e);return Number.isFinite(o)&&o>=n&&o<=r});J("match",(e,t,n)=>{if(!t)return!0;let r=ji(n,t);return r?so(r)===e:!0});J("same",(e,t,n)=>{if(!t)return!0;let r=ji(n,t);return!r||so(r)===e});J("different",(e,t,n)=>{if(!t)return!0;let r=ji(n,t);return!r||so(r)!==e});J("regex",(e,t,n)=>{var o;if(!t)return!0;let r=(o=Pt(n,"regex-flags"))!=null?o:"";try{return new RegExp(t,r).test(e)}catch(i){return X(`Invalid regular expression in ${w.prefix}regex: ${t}`),!0}});J("date",e=>bn(e)!==null);J("after",(e,t,n)=>{let r=Vi(t,n),o=bn(e);return!r||!o?!0:o.getTime()>r.getTime()});J("before",(e,t,n)=>{let r=Vi(t,n),o=bn(e);return!r||!o?!0:o.getTime()<r.getTime()});J("accepted",(e,t,n)=>{let r=yt(n);return r==="checkbox"||r==="radio"?n.checked:["1","true","on","yes","sim"].includes(e.trim().toLowerCase())});J("in",(e,t)=>(t!=null?t:"").split(",").map(n=>n.trim()).includes(e.trim()));J("notin",(e,t)=>!(t!=null?t:"").split(",").map(n=>n.trim()).includes(e.trim()));J("phone",e=>Xg(e));J("cpf",e=>Wg(e));J("cnpj",e=>Kg(e));J("cep",e=>ao(e).length===8);J("creditcard",e=>Yg(e));J("strongpassword",(e,t)=>{let n=Number(t)>0?Number(t):8;return e.length>=n&&/[a-zà-ÿ]/.test(e)&&/[A-ZÀ-ß]/.test(e)&&/\d/.test(e)&&/[^\w\s]/.test(e)?!0:Rf(lt.strongpassword,{param:String(n)})});J("unique",async(e,t,n)=>{let r=t||Pt(n,"unique-url")||"";if(!r||!e.trim())return!0;try{let o=await he.get(r,{params:{value:e,field:ml(n)},timeout:8e3});return o&&typeof o=="object"&&"available"in o?o.available===!0?!0:lt.unique:o?lt.unique:!0}catch(o){if(o instanceof Ee){if(o.status===404)return!0;if(o.status>=400&&o.status<500)return lt.unique}return!0}});var Gg={"strong-password":"strongpassword","credit-card":"creditcard","min-length":"minlength","max-length":"maxlength","not-in":"notin","nao-vazio":"required",obrigatorio:"required"},Qg=new Set(["required","accepted"]);function Jg(e){var o;let t=null;if(e.startsWith(w.prefix)?t=e.slice(w.prefix.length):e.startsWith("data-v-")&&(t=e.slice(7)),!t)return null;let n=t.indexOf(".");if(n>-1&&(t=t.slice(0,n)),t==="validate")return null;t.startsWith("validate-")&&(t=t.slice(9));let r=(o=Gg[t])!=null?o:t;return Bi.has(r)?r:null}function vl(e){let t=[],n=new Set,r=(d,u)=>{n.has(d)||!Bi.has(d)||(n.add(d),t.push({name:d,param:u}))};for(let[d,u]of wd(e)){let f=Jg(d);if(f){if(u.trim()==="false"){n.add(f);continue}r(f,u)}}let o=yt(e);e.hasAttribute("required")&&r("required",""),o==="email"&&r("email",""),o==="url"&&r("url",""),(o==="number"||o==="range")&&r("number","");let i=e.getAttribute("minlength");i&&r("minlength",i);let s=e.getAttribute("maxlength");s&&r("maxlength",s);let a=e.getAttribute("min");a&&r("min",a);let l=e.getAttribute("max");l&&r("max",l);let c=e.getAttribute("pattern");return c&&r("regex",c),t.sort((d,u)=>d.name==="required"?-1:u.name==="required"?1:0),t}var Zg=`
...
`;function Ui(){ge(),Z("forms-validate",Zg)}function $f(e){var r,o,i;let t=Pt(e,"error-target");if(t&&typeof document!="undefined"){let s=(i=(o=(r=e.form)!=null?r:e.closest("form"))==null?void 0:o.querySelector(t))!=null?i:document.querySelector(t);if(s)return{parent:s,anchor:null};X(`Target for ${w.prefix}error-target not found: ${t}`)}let n=e.parentElement;return n?{parent:n,anchor:e}:null}function Df(e){let t=$f(e);if(!t)return null;if(t.anchor){let n=t.anchor.nextElementSibling;return n&&n.classList.contains("v-field-error")?n:null}return t.parent.querySelector(".v-field-error")}function _i(e,t){Ui(),e.classList.add("v-invalid"),e.classList.remove("v-valid"),e.setAttribute("aria-invalid","true");let n=Df(e);if(!n){let o=$f(e);if(!o)return;n=document.createElement("span"),n.className="v-field-error",n.id=e.id?`${e.id}-error`:le("v-error-"),n.setAttribute("role","alert"),n.setAttribute("aria-live","polite"),o.anchor?o.anchor.insertAdjacentElement("afterend",n):o.parent.appendChild(n)}n.textContent=t;let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.push(n.id),e.setAttribute("aria-describedby",r.join(" "))}function fl(e,t=!1){e.classList.remove("v-invalid"),e.classList.toggle("v-valid",t),e.removeAttribute("aria-invalid");let n=Df(e);if(n){let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.length?e.setAttribute("aria-describedby",r.join(" ")):e.removeAttribute("aria-describedby"),n.remove()}}function lo(e){for(let n of Ki(e,!1))fl(n);for(let n of Array.from(e.querySelectorAll(".v-field-error")))n.remove();let t=e.querySelector(".v-form-error");t&&t.remove();for(let n of Array.from(e.querySelectorAll(".v-invalid, .v-valid")))n.classList.remove("v-invalid","v-valid"),n.removeAttribute("aria-invalid")}function hl(e){let t={};if(!e||typeof e!="object")return t;let n=e,r=n.errors&&typeof n.errors=="object"?n.errors:n;for(let[o,i]of Object.entries(r))o==="message"||o==="mensagem"||o==="errors"||(typeof i=="string"?t[o]=i:Array.isArray(i)&&typeof i[0]=="string"&&(t[o]=i[0]));return t}function eb(e,t){let n=t.replace(/\.(\w+)/g,"[$1]"),r=[t,n,`${t}[]`,`${n}[]`];for(let i of r){let s=e.querySelector(`[name="${Ii(i)}"]`);if(Ze(s))return s}let o=e.querySelector(`#${Ii(t)}`);return Ze(o)?o:null}function Wi(e,t){let n=hl(t),r=[];for(let[o,i]of Object.entries(n)){let s=eb(e,o);s?_i(s,i):r.push(i)}return r.length&&tb(e,r),n}function tb(e,t){Ui();let n=e.querySelector(".v-form-error");if(n||(n=document.createElement("div"),n.className="v-form-error",n.setAttribute("role","alert"),e.prepend(n)),n.textContent="",t.length===1){n.textContent=t[0];return}let r=document.createElement("ul");for(let o of t){let i=document.createElement("li");i.textContent=o,r.appendChild(i)}n.appendChild(r)}function gl(e){let t=e.querySelector(".v-invalid");if(!t)return!1;try{t.focus({preventScroll:!0})}catch(r){t.focus()}let n=typeof window!="undefined"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;return typeof t.scrollIntoView=="function"&&t.scrollIntoView({block:"center",behavior:n?"auto":"smooth"}),!0}function Ki(e,t=!0){let n=e.tagName==="FORM"?Array.from(e.elements):Array.from(e.querySelectorAll("input, select, textarea")),r=[];for(let o of n)Ze(o)&&(o.disabled||zg.has(yt(o))||t&&vl(o).length===0||r.push(o));return r}async function bl(e,t={}){var s,a;if(!Ze(e))return{valid:!0};let n=vl(e);if(!n.length)return t.silent||fl(e),{valid:!0};let r=so(e),o=Pt(e,"error-message"),i=r.trim()==="";for(let l of n){if(i&&!Qg.has(l.name))continue;let c=Bi.get(l.name);if(!c)continue;let d;try{d=await c.fn(r,l.param||void 0,e)}catch(p){X(`Rule "${l.name}" failed to execute`,p);continue}if(d===!0)continue;let u=o!=null?o:typeof d=="string"?d:(a=(s=lt[l.name])!=null?s:c.message)!=null?a:lt.invalid,f=Rf(u,{field:Bg(e),param:l.param,value:r});return t.silent||(_i(e,f),Af(e,{valid:!1,message:f,rule:l.name})),{valid:!1,message:f,rule:l.name}}return t.silent||(fl(e,!i),Af(e,{valid:!0})),{valid:!0}}function yl(e){return Ze(e)?bl(e):xl(e)}async function xl(e){let t=Ki(e),n=await Promise.all(t.map(o=>bl(o))),r={};return t.forEach((o,i)=>{var a;let s=n[i];s.valid||(r[ml(o)]=(a=s.message)!=null?a:lt.invalid)}),{valid:Object.keys(r).length===0,errors:r}}function Af(e,t){e.dispatchEvent(new CustomEvent("voodoo:field-validated",{bubbles:!0,detail:{field:ml(e),...t}}))}function nb(e){let t=e.indexOf("[");if(t===-1)return[e];let n=[e.slice(0,t)],r=/\[([^\]]*)\]/g,o;for(;(o=r.exec(e))!==null;)n.push(o[1]);return n}function rb(e,t,n){let r=e;for(let o=0;o<t.length;o++){let i=t[o],s=o===t.length-1,a=t[o+1];if(i===""){if(!Array.isArray(r))return;if(s){r.push(n);return}let c=a===""?[]:{};r.push(c),r=c;continue}if(Array.isArray(r)){let c=Number(i);if(!Number.isInteger(c))return;if(s){r[c]=n;return}let d=r[c];(d==null||typeof d!="object")&&(d=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[c]=d),r=d;continue}if(s){r[i]=n;return}let l=r[i];(l==null||typeof l!="object")&&(l=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[i]=l),r=l}}function ob(e,t){var a,l,c,d;let n=Ki(e,!1),r=[],o=new Map;for(let u of n)yt(u)==="checkbox"&&u.name&&o.set(u.name,((a=o.get(u.name))!=null?a:0)+1);let i=t.trim!==!1,s=t.numbers!==!1;for(let u of n){if(!u.name||u.disabled&&!t.includeDisabled)continue;let f=yt(u);if(f==="file"){let m=Array.from((l=u.files)!=null?l:[]);if(!m.length)continue;let h=u.multiple||u.name.endsWith("[]");r.push({name:u.name,value:h?m:m[0]});continue}if(f==="checkbox"){if(((c=o.get(u.name))!=null?c:1)>1||u.name.endsWith("[]")){if(!u.checked)continue;let h=u.name.endsWith("[]")?u.name:`${u.name}[]`;r.push({name:h,value:u.value||"on"})}else r.push({name:u.name,value:u.checked});continue}if(f==="radio"){if(!u.checked)continue;r.push({name:u.name,value:u.value});continue}if(u.tagName==="SELECT"&&u.multiple){let m=Array.from(u.selectedOptions).map(v=>v.value),h=u.name.endsWith("[]")?u.name:`${u.name}[]`;for(let v of m)r.push({name:h,value:v});continue}let p=(d=u.value)!=null?d:"";if(i&&typeof p=="string"&&(p=p.trim()),s&&(f==="number"||f==="range")&&p!==""){let m=Number(p);Number.isFinite(m)&&(p=m)}r.push({name:u.name,value:p})}return r}function ib(e){for(let t of Ki(e,!1)){if(yt(t)!=="file")continue;let n=t.files;if(n&&n.length)return!0}return!1}function Pf(e,t,n){if(n instanceof File||typeof Blob!="undefined"&&n instanceof Blob){e.append(t,n);return}if(Array.isArray(n)){let r=t.endsWith("[]")?t:`${t}[]`;for(let o of n)Pf(e,r,o);return}if(typeof n=="boolean"){e.append(t,n?"1":"0");return}e.append(t,n==null?"":String(n))}function cr(e,t={}){let n=ob(e,t);if(t.formData||ib(e)){let o=new FormData;for(let i of n)Pf(o,i.name,i.value);return o}let r={};for(let o of n)rb(r,nb(o.name),o.value);return r}var oo=new WeakSet,io=new WeakSet;async function zi(e){(await bl(e)).valid?io.delete(e):io.add(e)}function Yi(e,t){if(!Ze(e)){X(`${w.prefix}validate only works on input, select, or textarea.`);return}if(oo.has(e))return;oo.add(e),Ui();let n=()=>{zi(e)},r=()=>{io.has(e)&&zi(e)};e.addEventListener("blur",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{oo.delete(e),io.delete(e),e.removeEventListener("blur",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}var pl=new WeakSet;function Hf(e){return pl.has(e)||Fg(e,"validate")}function sb(e,t){pl.add(e),Ui(),e.tagName==="FORM"&&(e.noValidate=!0);let n=o=>{let i=o.target;!Ze(i)||oo.has(i)||vl(i).length!==0&&zi(i)},r=o=>{let i=o.target;!Ze(i)||oo.has(i)||io.has(i)&&zi(i)};e.addEventListener("focusout",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{pl.delete(e),e.removeEventListener("focusout",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}y("validate",({el:e,cleanup:t})=>{if(e.tagName==="FORM"||e.hasAttribute(`${w.prefix}submit`)){sb(e,t);return}Yi(e,t)});var ab=["required","email","url","number","integer","minlength","maxlength","min","max","match","regex","cpf","cnpj","cep","phone","date","accepted","strong-password"];for(let e of ab)y(e,({el:t,cleanup:n})=>{Yi(t,n)});for(let e of["error-message","error-target","regex-flags","unique-url"])y(e,({el:t,cleanup:n})=>{Ze(t)&&Yi(t,n)});function Of(){return Y({loading:!1,saving:!1,success:!1,errors:{},message:"",data:null,status:0,dirty:!1,progress:0})}var dr=new WeakMap,El=new WeakMap,lb=Of();function co(e){let t=dr.get(e);return t||(t=Of(),dr.set(e,t)),t}function cb(e){let t=e;for(;t;){let n=El.get(t);if(n)return n;let r=t.el;if(r){let o=r.closest("form"),i=o?dr.get(o):void 0;if(i)return i;let s=r.querySelector("form"),a=s?dr.get(s):void 0;if(a)return a}t=t.parent}if(typeof document!="undefined")for(let n of Array.from(document.forms)){let r=dr.get(n);if(r)return r}return lb}N("$form",e=>cb(e));var ur=new WeakMap,db=["submit","upload","dropzone","autosave","get","post","put","patch","delete","load","load-visible","search","resource"];function Nf(e){return db.some(t=>zt(e,`${w.prefix}${t}`)||zt(e,`data-v-${t}`))}function Re(e,t){var i,s,a;let n=Pt(e,t);if(n!==null)return n;let r=e.closest("form");if(r&&r!==e){let l=Pt(r,t);if(l!==null)return l}let o=(a=(i=ur.get(e))==null?void 0:i[t])!=null?a:r?(s=ur.get(r))==null?void 0:s[t]:void 0;return o!=null?o:null}function Qi(e,t){return Re(e,t)!==null}function et(e,t){y(e,({el:n,expression:r})=>{var a,l;let o=(a=n.closest("form"))!=null?a:n,i=(l=ur.get(o))!=null?l:{};if(i[e]=r,ur.set(o,i),!Nf(o)&&!Nf(n)){X(`${w.prefix}${e} needs an element with ${w.prefix}submit, ${w.prefix}upload, ${w.prefix}dropzone, or ${w.prefix}autosave.`);return}let s=t==null?void 0:t(r);s&&X(s)})}var ub=["GET","POST","PUT","PATCH","DELETE","HEAD","OPTIONS"];et("method",e=>e&&!ub.includes(e.trim().toUpperCase())?`${w.prefix}method received an unknown verb: ${e}`:null);et("redirect");et("reset-success");et("disable-loading");et("loading-class");et("on-success");et("on-error");et("on-complete");et("toast-success");et("toast-error");et("confirm");et("form-data");y("loading",({el:e,expression:t})=>{var i,s;let n=(i=e.closest("form"))!=null?i:e,r=(s=ur.get(n))!=null?s:{};r.loading=t,ur.set(n,r);let o=Ff(t);if(!o){X(`${w.prefix}loading element not found: ${t}`);return}If(o,!1)});var fb=`
...
`;function uo(){ge(),Z("forms-ajax",fb)}function Gt(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function Ji(e,t){let n=e.trim();n.includes("{")&&(n=n.replace(/\{([^{}]+)\}/g,(o,i)=>{let s=q(i.trim(),t,`${w.prefix}submit`);return s==null?o:String(s)}));let r=w.baseURL;return r&&!/^[a-z][a-z0-9+.-]*:\/\//i.test(n)&&!n.startsWith("//")&&(n=`${r.replace(/\/$/,"")}/${n.replace(/^\//,"")}`),n}function Tl(e){var r;if(!e||typeof e!="object")return"";let t=e,n=(r=t.message)!=null?r:t.mensagem;return typeof n=="string"?n:""}function Ll(e,t="",n={}){if(e==null)return n;if(Array.isArray(e))return e.forEach((r,o)=>Ll(r,`${t}[${o}]`,n)),n;if(typeof e=="object"&&!(e instanceof File)){for(let[r,o]of Object.entries(e))Ll(o,t?`${t}[${r}]`:r,n);return n}return t&&(n[t]=String(e)),n}function pb(e){return Array.from(e.querySelectorAll('button[type="submit"], button:not([type]), input[type="submit"], input[type="image"]'))}function Ff(e){return!e||typeof document=="undefined"?null:document.querySelector(e)}var wl=new WeakMap;function If(e,t){var n;if(t){e.hidden=!1,e.style.display=(n=wl.get(e))!=null?n:"",e.removeAttribute("aria-hidden");return}wl.has(e)||wl.set(e,e.style.display==="none"?"":e.style.display),e.style.display="none",e.setAttribute("aria-hidden","true")}function Gi(e,t){let{host:n,form:r,state:o}=e;o.loading=t,r.classList.toggle("v-loading",t),r.setAttribute("aria-busy",t?"true":"false");let i=Re(n,"loading-class");if(i)for(let a of i.split(/\s+/).filter(Boolean))r.classList.toggle(a,t);if(Qi(n,"disable-loading"))for(let a of pb(r))a.disabled=t;let s=Re(n,"loading");if(s){let a=Ff(s);a&&If(a,t)}}function Zi(e,t,n,r){let o=Re(e.host,t);if(!o)return;let i=e.scope.child({$data:n,$response:r,$form:e.state,$el:e.host}),s=q(o,i,`${w.prefix}${t}`);typeof s=="function"&&s.call(e.scope.data,n,r)}function mb(e,t){let n=Re(e.host,"target");if(!n||typeof t!="string")return;let r=document.querySelector(n);if(!r){X(`${w.prefix}target destination not found: ${n}`);return}let o=(Re(e.host,"swap")||"innerHTML").trim().toLowerCase();if(o==="none")return;if(o==="text"){r.textContent=t;return}let i=document.createElement("template");i.innerHTML=t;let s=Array.from(i.content.childNodes),a=Ce(r);switch(o){case"inner":case"innerhtml":for(let l of Array.from(r.children))G(l);r.textContent="",r.append(...s);break;case"afterbegin":case"prepend":r.prepend(...s);break;case"beforeend":case"append":r.append(...s);break;case"beforebegin":r.before(...s);break;case"afterend":r.after(...s);break;case"outer":case"outerhtml":case"replace":G(r),r.replaceWith(...s);break;default:X(`Unknown mode in ${w.prefix}swap: ${o}`);return}for(let l of s)l.nodeType===1&&ne(l,a)}function zf(e,t,n){var l;let{state:r,form:o,host:i}=e;r.success=!0,r.errors={},r.data=t,r.status=n,r.dirty=!1,r.message=Tl(t),mb(e,t),Qi(i,"reset-success")&&o.tagName==="FORM"&&(o.reset(),lo(o));let s=Re(i,"toast-success");s!==null&&st.success(s||r.message||"All set!"),Zi(e,"on-success",t,{status:n}),Gt(o,"voodoo:success",{data:t,status:n,form:o,state:r});let a=Re(i,"redirect");if(a!==null&&typeof window!="undefined"){let c=t&&typeof t=="object"?(l=t.redirect)!=null?l:t.url:null,d=e.scope.child({$data:t,$form:r}),u=a?Ji(a,d):String(c!=null?c:"");u&&window.location.assign(u)}}function Ml(e,t){var c,d;let{state:n,form:r,host:o}=e,i=t instanceof Ee?t:new Ee(t instanceof Error?t.message:String(t)),s=(d=(c=i.response)==null?void 0:c.data)!=null?d:null;n.success=!1,n.data=s,n.status=i.status,n.message=Tl(s)||i.message;let a=hl(s);(i.status===422||Object.keys(a).length>0)&&(n.errors=Wi(r,s),gl(r));let l=Re(o,"toast-error");l!==null&&st.error(l||Tl(s)||"Could not submit the form."),Zi(e,"on-error",s,i),Gt(r,"voodoo:error",{error:i,data:s,status:i.status,form:r,state:n})}function Bf(e,t){Zi(e,"on-complete",e.state.data,{ok:t,status:e.state.status}),Gt(e.form,"voodoo:complete",{ok:t,status:e.state.status,data:e.state.data,form:e.form,state:e.state})}async function vb(e,t){let{host:n,form:r,state:o,scope:i}=e;if(o.loading)return;let s=Re(n,"confirm");if(s!==null&&typeof window!="undefined"&&!window.confirm(s||"Confirm this action?"))return;if(Hf(r)){lo(r);let f=await xl(r);if(o.errors=f.errors,!f.valid){gl(r),Gt(r,"voodoo:invalid",{errors:f.errors,form:r,state:o});return}}let a=(Re(n,"method")||r.getAttribute("method")||"POST").trim().toUpperCase(),l=Ji(t,i)||(r.tagName==="FORM"?r.action:"")||(typeof location!="undefined"?location.href:""),c=cr(r,{formData:Qi(n,"form-data")}),d=a==="GET"||a==="HEAD";Gi(e,!0),o.success=!1,o.progress=0,Gt(r,"voodoo:submit",{url:l,method:a,form:r,state:o});let u=!1;try{let f=await Vt({url:l,method:a,body:d?void 0:c,params:d&&!(c instanceof FormData)?Ll(c):void 0});u=!0,zf(e,f.data,f.status)}catch(f){Ml(e,f)}finally{Gi(e,!1),Bf(e,u)}}y("submit",({el:e,scope:t,expression:n,cleanup:r})=>{uo();let o=e,i=co(o),s=t.child({$form:i},o);El.set(s,i),El.set(t,i),Bt(o,s);for(let d of Array.from(o.childNodes))d.nodeType===1&&Bt(d,s);let a={host:o,form:o,scope:s,state:i},l=d=>{d.preventDefault(),vb(a,n)},c=d=>{var p;let u=d.detail;if(!u||!u.field)return;let f={...i.errors};u.valid?delete f[u.field]:f[u.field]=(p=u.message)!=null?p:"",i.errors=f};o.addEventListener("submit",l),o.addEventListener("voodoo:field-validated",c),r(()=>{dr.delete(o),o.removeEventListener("submit",l),o.removeEventListener("voodoo:field-validated",c)})},{priority:j.DATA-1});function hb(e){let t=Re(e,"progress");if(t){let o=document.querySelector(t);return o||(X(`${w.prefix}progress bar not found: ${t}`),null)}let n=e.nextElementSibling;if(n&&n.classList.contains("v-progress"))return n;uo();let r=document.createElement("div");return r.className="v-progress",r.setAttribute("role","progressbar"),r.setAttribute("aria-valuemin","0"),r.setAttribute("aria-valuemax","100"),r.innerHTML='<span class="v-progress-bar"></span>',e.insertAdjacentElement("afterend",r),r}function Xi(e,t,n){if(!e)return;let r=Math.max(0,Math.min(100,Math.round(t)));if(e.tagName==="PROGRESS")e.value=r,e.max=100;else{let o=e.classList.contains("v-progress-bar")?e:e.querySelector(".v-progress-bar, [data-progress-bar]");o?o.style.width=`${r}%`:e.style.width=`${r}%`}e.setAttribute("aria-valuenow",String(r)),n?e.setAttribute("data-state",n):e.removeAttribute("data-state")}function gb(e,t,n){let r=new FormData,i=t.length>1||n.endsWith("[]")?n.endsWith("[]")?n:`${n}[]`:n;for(let a of t)r.append(i,a);let s=e.closest("form");if(s){let a=cr(s,{formData:!0});if(a instanceof FormData)for(let[l,c]of a.entries())c instanceof File||r.append(l,c)}return r}async function jf(e,t,n,r){if(!n.length||e.state.loading)return;let{state:o,form:i,host:s}=e,a=Ji(t,e.scope);if(!a){X(`${w.prefix}upload needs a destination URL.`);return}let l=hb(s),c=gb(s,n,r);Gi(e,!0),o.success=!1,o.progress=0,Xi(l,0,"loading"),Gt(i,"voodoo:upload",{url:a,files:n,form:i,state:o});let d=!1;try{let u=(Re(s,"method")||"POST").trim().toUpperCase(),f=await he.upload(a,c,{method:u==="PUT"||u==="PATCH"?u:"POST",onProgress:p=>{o.progress=p,Xi(l,p,"loading"),Gt(i,"voodoo:progress",{percent:p,form:i,state:o})}});d=!0,o.progress=100,Xi(l,100,"done"),zf(e,f,200)}catch(u){Xi(l,o.progress,"error"),Ml(e,u)}finally{Gi(e,!1),Bf(e,d)}}y("upload",({el:e,scope:t,expression:n,cleanup:r})=>{var c;let o=e;if(o.tagName!=="INPUT"||(o.getAttribute("type")||"").toLowerCase()!=="file"){X(`${w.prefix}upload needs an <input type="file">.`);return}uo();let i=(c=o.closest("form"))!=null?c:o,s=co(i),a={host:o,form:i,scope:t,state:s},l=()=>{var u;let d=Array.from((u=o.files)!=null?u:[]);d.length&&jf(a,n,d,o.name||"file")};o.addEventListener("change",l),r(()=>o.removeEventListener("change",l))});y("dropzone",({el:e,scope:t,expression:n,cleanup:r})=>{var b,x,T;uo(),e.classList.add("v-dropzone"),e.hasAttribute("tabindex")||(e.tabIndex=0),e.hasAttribute("role")||e.setAttribute("role","button"),(b=e.textContent)!=null&&b.trim()||(e.textContent="Drag files here or click to choose");let o=(x=e.closest("form"))!=null?x:e,i=co(o),s={host:e,form:o,scope:t,state:i},a=Re(e,"field")||"file",l=document.createElement("input");l.type="file",l.hidden=!0,l.tabIndex=-1,e.hasAttribute("accept")&&(l.accept=(T=e.getAttribute("accept"))!=null?T:""),e.hasAttribute("multiple")&&(l.multiple=!0),e.appendChild(l);let c=E=>{E.length&&(e.classList.add("v-dropzone-busy"),e.classList.remove("v-dropzone-error"),jf(s,n,E,a).finally(()=>{e.classList.remove("v-dropzone-busy"),i.success||e.classList.add("v-dropzone-error")}))},d=0,u=E=>{E.preventDefault(),d++,e.classList.add("v-dropzone-over")},f=E=>{E.preventDefault(),E.dataTransfer&&(E.dataTransfer.dropEffect="copy")},p=()=>{d=Math.max(0,d-1),d===0&&e.classList.remove("v-dropzone-over")},m=E=>{var D,A;E.preventDefault(),d=0,e.classList.remove("v-dropzone-over");let C=Array.from((A=(D=E.dataTransfer)==null?void 0:D.files)!=null?A:[]);c(l.multiple?C:C.slice(0,1))},h=E=>{E.target!==l&&l.click()},v=E=>{E.key!=="Enter"&&E.key!==" "||(E.preventDefault(),l.click())},g=()=>{var C;let E=Array.from((C=l.files)!=null?C:[]);c(E),l.value=""};e.addEventListener("dragenter",u),e.addEventListener("dragover",f),e.addEventListener("dragleave",p),e.addEventListener("drop",m),e.addEventListener("click",h),e.addEventListener("keydown",v),l.addEventListener("change",g),r(()=>{e.removeEventListener("dragenter",u),e.removeEventListener("dragover",f),e.removeEventListener("dragleave",p),e.removeEventListener("drop",m),e.removeEventListener("click",h),e.removeEventListener("keydown",v),l.removeEventListener("change",g),l.remove()})});var bb={idle:"",saving:"Saving...",saved:"Changes saved",error:"Could not save"};function yb(e){let t=Re(e,"autosave-status");if(t){let o=document.querySelector(t);if(o)return o;X(`${w.prefix}autosave-status element not found: ${t}`)}let n=e.querySelector(".v-autosave-status");if(n)return n;let r=document.createElement("span");return r.className="v-autosave-status",r.setAttribute("aria-live","polite"),e.appendChild(r),r}function kl(e,t){e.setAttribute("data-state",t),e.textContent=bb[t]}y("autosave",({el:e,scope:t,expression:n,modifiers:r,cleanup:o})=>{var m,h,v;uo();let i=e,s=co(i),a={host:i,form:i,scope:t,state:s},l=yb(i),c=(v=(h=(m=typeof r.delay=="string"?r.delay:null)!=null?m:Object.keys(r).find(g=>/^[\d.]+(ms|s|m)?$/.test(g)))!=null?h:Re(i,"autosave-delay"))!=null?v:1e3,d=Q(c,1e3),u=async()=>{let g=Ji(n,t);if(!g){X(`${w.prefix}autosave needs a destination URL.`);return}if(s.loading)return;s.saving=!0,kl(l,"saving");let b=(Re(i,"method")||"POST").trim().toUpperCase();try{let x=await Vt({url:g,method:b,body:cr(i,{formData:Qi(i,"form-data")})});s.data=x.data,s.status=x.status,s.dirty=!1,s.success=!0,kl(l,"saved"),Zi(a,"on-success",x.data,{status:x.status}),Gt(i,"voodoo:autosave",{data:x.data,status:x.status,form:i,state:s})}catch(x){kl(l,"error"),Ml(a,x)}finally{s.saving=!1}},f=Ye(()=>{u()},d),p=()=>{s.dirty=!0,f()};i.addEventListener("input",p),i.addEventListener("change",p),o(()=>{f.cancel(),i.removeEventListener("input",p),i.removeEventListener("change",p)})});y("guard",({el:e,expression:t,cleanup:n})=>{var c;let r=(c=e.tagName==="FORM"?e:e.closest("form"))!=null?c:e,o=co(r),i=t.trim()||"There are unsaved changes.",s=()=>{o.dirty=!0},a=()=>{o.dirty=!1},l=d=>{!o.dirty||o.loading||(d.preventDefault(),d.returnValue=i)};r.addEventListener("input",s),r.addEventListener("change",s),r.addEventListener("reset",a),r.addEventListener("voodoo:success",a),window.addEventListener("beforeunload",l),n(()=>{r.removeEventListener("input",s),r.removeEventListener("change",s),r.removeEventListener("reset",a),r.removeEventListener("voodoo:success",a),window.removeEventListener("beforeunload",l)})});de();ce();function fo(e){let t={};for(let[n,r]of Object.entries(e))if(typeof r!="function"&&!n.startsWith("$"))try{JSON.stringify(r),t[n]=Me(r)}catch(o){}return t}function qf(e,t){if(e.id)return`${t}:${location.pathname}:#${e.id}`;let n=[],r=e;for(;r&&r!==document.body;){let o=r.parentElement,i=o?Array.from(o.children).indexOf(r):0;n.unshift(`${r.tagName.toLowerCase()}${i}`),r=o}return`${t}:${location.pathname}:${n.join(">")}`}y("persist",({el:e,scope:t,expression:n,cleanup:r})=>{let o=n.trim()?`voodoo:persist:${n.trim()}`:qf(e,"voodoo:persist"),i=fe.get(o);if(i&&typeof i=="object")for(let[l,c]of Object.entries(i))l in t.data&&(t.data[l]=c);let s=Ye(()=>{fe.set(o,fo(t.data))},120),a=Ie(t.data,()=>s(),{deep:!0});s(),r(()=>{s.flush(),a()})},{priority:j.DATA-1});y("sync",({el:e,scope:t,expression:n,cleanup:r})=>{if(typeof BroadcastChannel=="undefined")return;let o=n.trim()||qf(e,"voodoo:sync"),i=new BroadcastChannel(o),s=Math.random().toString(36).slice(2),a=!1,l=Ye(()=>{if(!a)try{i.postMessage({from:s,state:fo(t.data)})}catch(d){W(d,"v-sync")}},60);i.addEventListener("message",d=>{let u=d.data;if(!(!u||u.from===s)){a=!0;for(let[f,p]of Object.entries(u.state))f in t.data&&t.data[f]!==p&&(t.data[f]=p);queueMicrotask(()=>{a=!1})}});let c=Ie(t.data,()=>l(),{deep:!0});r(()=>{c(),i.close()})},{priority:j.DATA-1});var Sl=new WeakMap;function Cl(e){let t=e;for(;t;){let n=Sl.get(t);if(n)return n;t=t.parentElement}return null}y("history",({el:e,scope:t,expression:n,cleanup:r})=>{var p;let o=Number(n)||50,i=[JSON.parse(JSON.stringify(fo(t.data)))],s=0,a=!1,l=Y({canUndo:!1,canRedo:!1,size:1,undo(){s<=0||(s--,d())},redo(){s>=i.length-1||(s++,d())},clear(){i.length=0,i.push(JSON.parse(JSON.stringify(fo(t.data)))),s=0,c()}});function c(){l.canUndo=s>0,l.canRedo=s<i.length-1,l.size=i.length}function d(){a=!0;let m=i[s];for(let[h,v]of Object.entries(m))t.data[h]=JSON.parse(JSON.stringify(v));c(),queueMicrotask(()=>{a=!1})}let u=Ye(()=>{if(a)return;let m=JSON.stringify(fo(t.data));m!==JSON.stringify(i[s])&&(i.splice(s+1),i.push(JSON.parse(m)),i.length>o&&i.shift(),s=i.length-1,c())},Q((p=e.getAttribute("v-history-debounce"))!=null?p:void 0,300)),f=Ie(t.data,()=>u(),{deep:!0});Sl.set(e,l),t.set("$history",l),r(()=>{f(),u.cancel(),Sl.delete(e)})},{priority:j.DATA-1});y("undo",({el:e,cleanup:t})=>{let n=()=>{var r;return(r=Cl(e))==null?void 0:r.undo()};e.addEventListener("click",n),t(()=>e.removeEventListener("click",n))});y("redo",({el:e,cleanup:t})=>{let n=()=>{var r;return(r=Cl(e))==null?void 0:r.redo()};e.addEventListener("click",n),t(()=>e.removeEventListener("click",n))});y("storage",({el:e,expression:t,cleanup:n,scope:r})=>{let o=t.trim();if(!o)return;let i=e,s=fe.get(`voodoo:field:${o}`);s!=null&&"value"in i&&(i.value=String(s));let a=()=>{fe.set(`voodoo:field:${o}`,i.value)};i.addEventListener("input",a),n(()=>i.removeEventListener("input",a))});N("$history",e=>e.el?Cl(e.el):null);ce();de();Ae();var fr=null,Qt=.35,Ht=!1,Vf=!1,Al="voodoo:sound:volume",Kf="voodoo:sound:muted",Uf=Ge(0);function yn(){if(Vf)return;Vf=!0;let e=fe.get(Al);typeof e=="number"&&e>=0&&e<=1&&(Qt=e);let t=fe.get(Kf);typeof t=="boolean"&&(Ht=t),typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches&&fe.get(Al)===void 0&&(Qt=.18)}function _f(){var t;if(typeof window=="undefined")return null;if(fr)return fr.state==="suspended"&&fr.resume(),fr;let e=(t=window.AudioContext)!=null?t:window.webkitAudioContext;if(!e)return null;try{return fr=new e,fr}catch(n){return null}}function Wf(e,t,n){var c,d,u,f;let r=e.currentTime+((c=t.atraso)!=null?c:0),o=r+t.duracao,i=e.createOscillator();i.type=(d=t.forma)!=null?d:"sine",i.frequency.setValueAtTime(t.frequencia,r),t.ate!==void 0&&t.ate!==t.frequencia&&i.frequency.exponentialRampToValueAtTime(Math.max(1,t.ate),o);let s=e.createGain(),a=Qt*n*((u=t.volume)!=null?u:1),l=(f=t.ataque)!=null?f:.008;s.gain.setValueAtTime(1e-4,r),s.gain.exponentialRampToValueAtTime(Math.max(1e-4,a),r+l),s.gain.exponentialRampToValueAtTime(1e-4,o),i.connect(s),s.connect(e.destination),i.start(r),i.stop(o+.02)}var es={click:{volume:.5,camadas:[{frequencia:660,ate:440,duracao:.06,forma:"triangle"}]},pop:{volume:.5,camadas:[{frequencia:880,ate:1320,duracao:.07,forma:"sine"}]},hover:{volume:.22,camadas:[{frequencia:1200,duracao:.035,forma:"sine"}]},success:{volume:.6,camadas:[{frequencia:523.25,duracao:.1,forma:"sine"},{frequencia:783.99,duracao:.18,forma:"sine",atraso:.09}]},complete:{volume:.6,camadas:[{frequencia:523.25,duracao:.1,forma:"sine"},{frequencia:659.25,duracao:.1,forma:"sine",atraso:.09},{frequencia:1046.5,duracao:.22,forma:"sine",atraso:.18}]},error:{volume:.6,camadas:[{frequencia:392,duracao:.12,forma:"square",volume:.5},{frequencia:261.63,duracao:.24,forma:"square",volume:.5,atraso:.1}]},warning:{volume:.55,camadas:[{frequencia:587.33,duracao:.1,forma:"triangle"},{frequencia:587.33,duracao:.14,forma:"triangle",atraso:.14}]},notify:{volume:.5,camadas:[{frequencia:987.77,duracao:.14,forma:"sine"},{frequencia:1318.51,duracao:.3,forma:"sine",atraso:.08,volume:.6}]},type:{volume:.18,camadas:[{frequencia:2200,duracao:.018,forma:"square"}]},open:{volume:.4,camadas:[{frequencia:330,ate:660,duracao:.14,forma:"sine"}]},close:{volume:.4,camadas:[{frequencia:660,ate:330,duracao:.14,forma:"sine"}]},deny:{volume:.5,camadas:[{frequencia:220,duracao:.08,forma:"square",volume:.5},{frequencia:180,duracao:.12,forma:"square",volume:.5,atraso:.07}]},coin:{volume:.45,camadas:[{frequencia:987.77,duracao:.06,forma:"square"},{frequencia:1318.51,duracao:.16,forma:"square",atraso:.05}]},levelup:{volume:.55,camadas:[{frequencia:523.25,duracao:.08,forma:"square"},{frequencia:659.25,duracao:.08,forma:"square",atraso:.07},{frequencia:783.99,duracao:.08,forma:"square",atraso:.14},{frequencia:1046.5,duracao:.26,forma:"square",atraso:.21}]},drop:{volume:.5,camadas:[{frequencia:180,ate:90,duracao:.12,forma:"triangle"}]}},xb={do:261.63,"do#":277.18,re:293.66,"re#":311.13,mi:329.63,fa:349.23,"fa#":369.99,sol:392,"sol#":415.3,la:440,"la#":466.16,si:493.88,c:261.63,d:293.66,e:329.63,f:349.23,g:392,a:440,b:493.88};function ts(e){let t=String(e).trim().toLowerCase(),n=/^([a-z]+#?)(\d)?$/.exec(t);if(!n)return null;let r=xb[n[1]];if(r===void 0)return null;let o=n[2]?Number(n[2]):4;return r*2**(o-4)}var ns=new Map;function wb(e,t){let n=ns.get(e);n||(n=new Audio(e),n.preload="auto",ns.set(e,n)),n.volume=Math.max(0,Math.min(1,Qt*t)),n.currentTime=0,n.play().catch(()=>{})}function Yf(e){return/^(https?:)?\/\//.test(e)||/^[./]/.test(e)||/\.(mp3|wav|ogg|m4a|aac)$/i.test(e)}var Jt={play(e,t={}){var l,c,d;if(yn(),Ht||!e)return;let n=String(e).trim(),r=(l=t.volume)!=null?l:1;if(Yf(n)){wb(n,r);return}let o=es[n];if(!o){let u=ts(n);u!==null&&this.tone(u,200,{volume:r});return}let i=_f();if(!i)return;let s=(c=t.tom)!=null?c:1,a=((d=o.volume)!=null?d:1)*r;for(let u of o.camadas)Wf(i,s===1?u:{...u,frequencia:u.frequencia*s,ate:u.ate===void 0?void 0:u.ate*s},a)},tone(e,t=200,n={}){var o,i;if(yn(),Ht)return;let r=_f();r&&Wf(r,{frequencia:e,duracao:t/1e3,forma:(o=n.forma)!=null?o:"sine"},(i=n.volume)!=null?i:.5)},note(e,t=250,n={}){let r=ts(e);r!==null&&this.tone(r,t,n)},melody(e,t=150,n={}){yn(),!Ht&&e.forEach((r,o)=>{let i=typeof r=="number"?r:ts(r);i!==null&&setTimeout(()=>this.tone(i,t*1.6,n),o*t)})},volume(e){return yn(),e===void 0||(Qt=Math.max(0,Math.min(1,e)),fe.set(Al,Qt)),Qt},mute(e=!0){yn(),Ht=e,fe.set(Kf,Ht),Uf.value++},unmute(){this.mute(!1)},toggle(){return yn(),this.mute(!Ht),Ht},get muted(){return Uf.value,yn(),Ht},get names(){return Object.keys(es)},define(e,t){es[e]=t},preload(...e){for(let t of e){if(ns.has(t))continue;let n=new Audio(t);n.preload="auto",ns.set(t,n)}}};y("sound",({el:e,arg:t,expression:n,modifiers:r,scope:o,cleanup:i,evaluate:s})=>{let a=t||"click",l=()=>{let u=n.trim();if(!u)return"click";if(es[u]||Yf(u)||ts(u)!==null)return u;let f=s();return typeof f=="string"?f:u},c=r.volume!==void 0?Number(r.volume):void 0,d=()=>{Jt.play(l(),c===void 0?{}:{volume:c})};e.addEventListener(a,d),i(()=>e.removeEventListener(a,d))});var kb=`
.v-muted{opacity:.55}
.v-muted::after{content:" \\1F507";font-size:.9em}
.v-mute-on::after{content:" \\1F50A";font-size:.9em}
`;y("mute",({el:e,cleanup:t})=>{Z("mute",kb);let n=()=>{let o=Jt.muted;e.setAttribute("aria-pressed",String(o)),e.classList.toggle("v-muted",o),e.classList.toggle("v-mute-on",!o)},r=()=>{Jt.toggle(),n(),Jt.muted||Jt.play("pop")};e.addEventListener("click",r),n(),t(()=>e.removeEventListener("click",r))});N("$sound",()=>Jt);de();ce();function po(){return typeof window=="undefined"||typeof window.matchMedia!="function"?!1:ve.reducedMotion}var mr=new Set,wn=0;function ep(e){wn=0;let t=Array.from(mr);for(let n of t)mr.has(n)&&n(e);mr.size>0&&(wn=requestAnimationFrame(ep))}function tp(e){typeof requestAnimationFrame=="function"&&(mr.add(e),wn||(wn=requestAnimationFrame(ep)))}function is(e){mr.delete(e),mr.size===0&&wn&&(cancelAnimationFrame(wn),wn=0)}var np=12e3;function Eb(e){return e*e*(2.70158*e-1.70158)}var mo={linear(e){return e},easeIn(e){return e*e*e},easeOut(e){return 1-Math.pow(1-e,3)},easeInOut(e){return e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2},easeOutBack(e){return 1+2.70158*Math.pow(e-1,3)+1.70158*Math.pow(e-1,2)},easeOutExpo(e){return e>=1?1:1-Math.pow(2,-10*e)},anticipate(e){let t=e*2;return t<1?.5*Eb(t):.5*(2-Math.pow(2,-10*(t-1)))},bounce(e){let r=e;return r<1/2.75?7.5625*r*r:r<2/2.75?(r-=1.5/2.75,7.5625*r*r+.75):r<2.5/2.75?(r-=2.25/2.75,7.5625*r*r+.9375):(r-=2.625/2.75,7.5625*r*r+.984375)}};function Tb(e){if(typeof e=="function")return e;if(typeof e=="string"){let t=mo[e];if(t)return t}return mo.easeOut}var Fl={x:0,y:0,z:0,parallax:0,rotate:0,rotateX:0,rotateY:0,skewX:0,skewY:0,scale:1,scaleX:1,scaleY:1},Lb={x:"px",y:"px",z:"px",parallax:"px",rotate:"deg",rotateX:"deg",rotateY:"deg",skewX:"deg",skewY:"deg",scale:"",scaleX:"",scaleY:""},rp={translateX:"x",translateY:"y",translateZ:"z",rotateZ:"rotate"},Il={blur:0,brightness:1,saturate:1,grayscale:0,contrast:1},Mb={blur:"px",brightness:"",saturate:"",grayscale:"",contrast:""},Sb=new Set(["opacity","z-index","font-weight","line-height","flex-grow","flex-shrink","order","zoom","fill-opacity","stroke-opacity","stroke-width","stroke-dashoffset","stroke-dasharray"]),Dl=new WeakMap,Pl=new WeakMap;function ss(e){let t=Dl.get(e);return t||(t={...Fl},Dl.set(e,t)),t}function op(e){let t=Pl.get(e);return t||(t={...Il},Pl.set(e,t)),t}function $e(e){return Math.round(e*1e3)/1e3}function Hl(e){let t=Dl.get(e);if(!t)return;let n=[],r=t.y+t.parallax;(t.x||r||t.z)&&n.push(`translate3d(${$e(t.x)}px, ${$e(r)}px, ${$e(t.z)}px)`),t.rotateX&&n.push(`rotateX(${$e(t.rotateX)}deg)`),t.rotateY&&n.push(`rotateY(${$e(t.rotateY)}deg)`),t.rotate&&n.push(`rotate(${$e(t.rotate)}deg)`),(t.skewX||t.skewY)&&n.push(`skew(${$e(t.skewX)}deg, ${$e(t.skewY)}deg)`);let o=t.scale*t.scaleX,i=t.scale*t.scaleY;(o!==1||i!==1)&&n.push(`scale(${$e(o)}, ${$e(i)})`),n.length>0?e.style.transform=n.join(" "):e.style.removeProperty("transform")}function Cb(e){let t=Pl.get(e);if(!t)return;let n=[];t.blur&&n.push(`blur(${$e(t.blur)}px)`),t.brightness!==1&&n.push(`brightness(${$e(t.brightness)})`),t.saturate!==1&&n.push(`saturate(${$e(t.saturate)})`),t.grayscale&&n.push(`grayscale(${$e(t.grayscale)})`),t.contrast!==1&&n.push(`contrast(${$e(t.contrast)})`),n.length>0?e.style.filter=n.join(" "):e.style.removeProperty("filter")}var Ab=/^([+-]?(?:\d+\.?\d*|\.\d+))([a-z%]*)$/i,ip=/^#([0-9a-f]{3,8})$/i;function rs(e){if(typeof e!="string")return!1;let t=e.trim().toLowerCase();return t==="transparent"||ip.test(t)||t.startsWith("rgb")||t.startsWith("hsl")}function Rb(e,t,n){let r=(e%360+360)%360,o=(1-Math.abs(2*n-1))*t,i=o*(1-Math.abs(r/60%2-1)),s=n-o/2,a;return r<60?a=[o,i,0]:r<120?a=[i,o,0]:r<180?a=[0,o,i]:r<240?a=[0,i,o]:r<300?a=[i,0,o]:a=[o,0,i],[Math.round((a[0]+s)*255),Math.round((a[1]+s)*255),Math.round((a[2]+s)*255)]}function Xf(e){var i,s;let t=e.trim().toLowerCase();if(t==="transparent")return[0,0,0,0];let n=ip.exec(t);if(n){let a=n[1];(a.length===3||a.length===4)&&(a=a.split("").map(d=>d+d).join(""));let l=parseInt(a.slice(0,6),16),c=a.length===8?parseInt(a.slice(6,8),16)/255:1;return[l>>16&255,l>>8&255,l&255,c]}let r=(i=t.match(/-?(?:\d+\.?\d*|\.\d+)%?/g))!=null?i:[],o=(a,l)=>{var u;let c=(u=r[a])!=null?u:"0",d=parseFloat(c);return c.endsWith("%")?d/100*l:d};if(t.startsWith("hsl")){let a=c=>{var f;let d=(f=r[c])!=null?f:"0",u=parseFloat(d);return d.endsWith("%")||u>1?u/100:u},l=Rb(parseFloat((s=r[0])!=null?s:"0"),a(1),a(2));return[l[0],l[1],l[2],r.length>3?o(3,1):1]}return[o(0,255),o(1,255),o(2,255),r.length>3?o(3,1):1]}function $b(e){let t=Math.max(0,Math.min(1,e[3]));return`rgba(${Math.round(e[0])}, ${Math.round(e[1])}, ${Math.round(e[2])}, ${$e(t)})`}function sp(e){return e.startsWith("--")?e:e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}function ap(e,t,n,r){if(t==="transform")return ss(e)[n];if(t==="filter")return op(e)[n];if(typeof getComputedStyle!="function")return e.style.getPropertyValue(r).trim();let o=getComputedStyle(e).getPropertyValue(r);return o?o.trim():""}function Db(e,t,n){var u;let r=(u=rp[t])!=null?u:t,o=r in Fl?"transform":r in Il?"filter":"style",i=o==="style"?sp(r):r,s=o==="transform"?Lb[r]:o==="filter"?Mb[r]:Sb.has(i)?"":"px",a=Array.isArray(n)?[n[0],n[1]]:[ap(e,o,r,i),n],l={kind:o,prop:r,cssName:i,mode:"number",unit:s,from:0,to:0,fromColor:[0,0,0,1],toColor:[0,0,0,1],fromText:String(a[0]),toText:String(a[1])};if(rs(a[0])||rs(a[1]))return o!=="style"?null:(l.mode="color",l.fromColor=rs(a[0])?Xf(String(a[0])):[0,0,0,0],l.toColor=rs(a[1])?Xf(String(a[1])):[0,0,0,0],l);let c=Gf(a[0],s),d=Gf(a[1],s);return!c||!d?o!=="style"?null:(l.mode="discrete",l):(l.from=c.value,l.to=d.value,l.unit=d.unit||c.unit||s,l)}function Gf(e,t){if(typeof e=="number")return Number.isFinite(e)?{value:e,unit:t}:null;let n=Ab.exec(e.trim());return n?{value:parseFloat(n[1]),unit:n[2]||t}:null}function pr(e,t,n){let r=!1,o=!1;for(let i of t){if(i.kind==="transform"){ss(e)[i.prop]=i.from+(i.to-i.from)*n,r=!0;continue}if(i.kind==="filter"){op(e)[i.prop]=i.from+(i.to-i.from)*n,o=!0;continue}if(i.mode==="color"){let a=[i.fromColor[0]+(i.toColor[0]-i.fromColor[0])*n,i.fromColor[1]+(i.toColor[1]-i.fromColor[1])*n,i.fromColor[2]+(i.toColor[2]-i.fromColor[2])*n,i.fromColor[3]+(i.toColor[3]-i.fromColor[3])*n];e.style.setProperty(i.cssName,$b(a));continue}if(i.mode==="discrete"){e.style.setProperty(i.cssName,n>=1?i.toText:i.fromText);continue}let s=i.from+(i.to-i.from)*n;e.style.setProperty(i.cssName,`${$e(s)}${i.unit}`)}r&&Hl(e),o&&Cb(e)}function lp(e,t){let n=[];for(let[r,o]of Object.entries(t)){if(o==null)continue;let i=Db(e,r,o);i&&n.push(i)}return n}function Qf(e,t){for(let n of zl(e))pr(n,lp(n,t),0)}function Pb(e,t){var r;let n={};for(let o of Object.keys(t)){let i=(r=rp[o])!=null?r:o,s=i in Fl?"transform":i in Il?"filter":"style";n[o]=ap(e,s,i,s==="style"?sp(i):i)}return n}function Rl(e){return typeof HTMLElement!="undefined"&&e instanceof HTMLElement?!0:typeof SVGElement!="undefined"&&e instanceof SVGElement}function zl(e){if(!e)return[];if(typeof e=="string")return typeof document=="undefined"?[]:Array.from(document.querySelectorAll(e)).filter(Rl);if(Rl(e))return[e];let t=e;if(typeof t.length!="number")return[];let n=[];for(let r=0;r<t.length;r++){let o=t[r];Rl(o)&&n.push(o)}return n}function as(e){return{finished:Promise.resolve(),stop(){e==null||e()}}}function Nl(e,t,n){var x,T,E,C,D,A,se;let r=lp(e,t);if(po()&&!n.force)return pr(e,r,1),(x=n.onUpdate)==null||x.call(n,1),(T=n.onComplete)==null||T.call(n),as();let o=Math.max(0,(E=n.duration)!=null?E:400),i=Math.max(0,(C=n.delay)!=null?C:0),s=Tb(n.easing),a=Math.max(0,Math.floor((D=n.repeat)!=null?D:0)),l=(A=n.repeatType)!=null?A:"loop",c=n.spring===!0?{}:n.spring?n.spring:null,d,u=new Promise(O=>{d=O}),f=!0,p=-1,m=-1,h=0,v=(se=c==null?void 0:c.velocity)!=null?se:0;function g(O){var nn,An,Cc,Ac,Rc,$c,Dc;if(!f)return;p<0&&(p=O,m=O);let me=O-p-i;if(me<0)return;let ae=Math.min(64,Math.max(0,O-m));if(m=O,me>np){b(1);return}if(c){let km=(nn=c.stiffness)!=null?nn:170,Em=(An=c.damping)!=null?An:26,Tm=(Cc=c.mass)!=null?Cc:1,Pc=Math.max(1,Math.round(ae)),Hc=ae/Pc/1e3;for(let Nc=0;Nc<Pc;Nc++){let Sm=(-km*(h-1)-Em*v)/Tm;v+=Sm*Hc,h+=v*Hc}let Lm=(Ac=c.restDelta)!=null?Ac:.001,Mm=(Rc=c.restSpeed)!=null?Rc:.01;if(Math.abs(1-h)<Lm&&Math.abs(v)<Mm){b(1);return}pr(e,r,h),($c=n.onUpdate)==null||$c.call(n,h);return}if(o===0){b(1);return}let R=a+1,S=Math.floor(me/o),B=(me-S*o)/o,_e=!1;S>=R&&(S=R-1,B=1,_e=!0);let We;if(S%2===1&&l==="reverse"?We=s(1-B):S%2===1&&l==="mirror"?We=1-s(B):We=s(B),_e){b(We);return}pr(e,r,We),(Dc=n.onUpdate)==null||Dc.call(n,We)}function b(O){var me,ae;f&&(f=!1,is(g),pr(e,r,O),(me=n.onUpdate)==null||me.call(n,O),d(),(ae=n.onComplete)==null||ae.call(n))}return pr(e,r,c?h:s(0)),tp(g),{finished:u,stop(){f&&(f=!1,is(g),d())}}}function Nt(e,t,n={}){let r=zl(e);if(r.length===0)return as();if(r.length===1)return Nl(r[0],t,n);let o=r.map(i=>Nl(i,t,n));return{finished:Promise.all(o.map(i=>i.finished)).then(()=>{}),stop(){for(let i of o)i.stop()}}}function Bl(e,t,n={}){var g,b,x,T,E,C,D,A;if(po())return(g=n.onUpdate)==null||g.call(n,t),(b=n.onComplete)==null||b.call(n),as();let r=(x=n.stiffness)!=null?x:170,o=(T=n.damping)!=null?T:26,i=(E=n.mass)!=null?E:1,s=Math.abs(t-e)||1,a=(C=n.restDelta)!=null?C:s*.001,l=(D=n.restSpeed)!=null?D:s*.01,c=e,d=(A=n.velocity)!=null?A:0,u=!0,f=-1,p=0,m,h=new Promise(se=>{m=se});function v(se){var S,B,_e,We;if(!u)return;if(f<0){f=se,(S=n.onUpdate)==null||S.call(n,c);return}let O=Math.min(64,Math.max(0,se-f));f=se,p+=O;let me=Math.max(1,Math.round(O)),ae=O/me/1e3;for(let nn=0;nn<me;nn++){let An=(-r*(c-t)-o*d)/i;d+=An*ae,c+=d*ae}if(Math.abs(t-c)<a&&Math.abs(d)<l||p>np){u=!1,is(v),c=t,(B=n.onUpdate)==null||B.call(n,t),m(),(_e=n.onComplete)==null||_e.call(n);return}(We=n.onUpdate)==null||We.call(n,c)}return tp(v),{finished:h,stop(){u&&(u=!1,is(v),m())}}}function cp(e,t,n,r){return r==="last"?(t-1-e)*n:r==="center"?Math.abs(e-(t-1)/2)*n:e*n}function jl(e,t,n={}){var l,c,d;let r=zl(e);if(r.length===0)return as();let o=(l=n.delay)!=null?l:60,i=(c=n.start)!=null?c:0,s=(d=n.from)!=null?d:"first",a=r.map((u,f)=>Nl(u,t,{...n,delay:i+cp(f,r.length,o,s)}));return{finished:Promise.all(a.map(u=>u.finished)).then(()=>{}),stop(){for(let u of a)u.stop()}}}function Hb(e){return e==="all"?.99:e==="any"?0:typeof e=="number"?Math.max(0,Math.min(1,e)):.25}function ls(e,t,n={}){var s,a,l;let r=(s=n.once)!=null?s:!0,o;if(typeof IntersectionObserver=="undefined")return o=t({target:e,isIntersecting:!0,intersectionRatio:1}),()=>{typeof o=="function"&&o()};let i=new IntersectionObserver(c=>{for(let d of c)d.isIntersecting?(o=t(d),r&&i.disconnect()):typeof o=="function"&&(o(),o=void 0)},{root:(a=n.root)!=null?a:null,rootMargin:(l=n.margin)!=null?l:"0px",threshold:Hb(n.amount)});return i.observe(e),()=>{i.disconnect(),typeof o=="function"&&o()}}function ql(e,t){let n=!1,r=!1;if(typeof window=="undefined")return t(0),()=>{n=!0};let o=()=>{if(r=!1,n)return;let s=e.getBoundingClientRect(),a=window.innerHeight||document.documentElement.clientHeight||1,l=a+s.height||1,c=(a-s.top)/l;t(Math.max(0,Math.min(1,c)))},i=()=>{r||n||(r=!0,requestAnimationFrame(o))};return window.addEventListener("scroll",i,{passive:!0}),window.addEventListener("resize",i),o(),()=>{n=!0,window.removeEventListener("scroll",i),window.removeEventListener("resize",i)}}var Nb={opacity:[0,1],duration:420,easing:"easeOut"},Ob={opacity:[0,1],y:[24,0],duration:520,easing:"easeOutExpo"},Fb={opacity:[0,1],y:[-24,0],duration:520,easing:"easeOutExpo"},Ib={opacity:[0,1],scale:[.92,1],duration:460,easing:"easeOutBack"},zb={opacity:[0,1],x:[36,0],duration:500,easing:"easeOutExpo"},Bb={opacity:[0,1],x:[-36,0],duration:500,easing:"easeOutExpo"},jb={opacity:[0,1],scale:[.6,1],spring:{stiffness:420,damping:18}},qb={opacity:[0,1],blur:[10,0],duration:560,easing:"easeOut"},Vb={opacity:[0,1],rotateX:[-80,0],duration:620,easing:"easeOutBack"},xn={fadeIn:Nb,fadeUp:Ob,fadeDown:Fb,scaleIn:Ib,slideLeft:zb,slideRight:Bb,pop:jb,blurIn:qb,flip:Vb},Ub=new Set(["duration","delay","easing","spring","repeat","repeatType","force","from","start","onUpdate","onComplete"]);function cs(e){let t={},n={};for(let[r,o]of Object.entries(e))o!=null&&(Ub.has(r)?n[r]=o:t[r]=o);return{keyframes:t,options:n}}function dp(e){let t=e.trim();return t?/^['"`]/.test(t)||/^[[{(]/.test(t)?!0:/^[$A-Za-z_][\w$]*(?:\.[$A-Za-z_][\w$]*|\[[^\]]*\])*$/.test(t):!1}function vo(e,t){let n=e.trim();if(!n)return null;if(xn[n])return xn[n];if(!dp(n))return null;let r=t();return typeof r=="string"&&xn[r]?xn[r]:r&&typeof r=="object"?r:null}function xt(e,t){var n;return(n=e.getAttribute(`${w.prefix}${t}`))!=null?n:e.getAttribute(`data-v-${t}`)}function Jf(e,t){return e.hasAttribute(`${w.prefix}${t}`)||e.hasAttribute(`data-v-${t}`)}var up=new WeakMap;function fp(e){let t=xt(e,"motion-stagger-from");return t==="last"||t==="center"?t:"first"}function _b(e){return Jf(e,"motion")||Jf(e,"motion-scroll")}function pp(e){let t=e.parentElement;if(!t)return 0;let n=up.get(t);if(!n){let i=xt(t,"motion-stagger");if(i===null)return 0;n={step:Q(i,60),from:fp(t)}}let r=Array.from(t.children).filter(_b),o=r.indexOf(e);return o<0?0:cp(o,r.length,n.step,n.from)}y("motion",({el:e,expression:t,evaluate:n,cleanup:r})=>{var c;let o=vo(t,n);if(!o){X(`v-motion did not recognize the variant "${t}".`);return}let{keyframes:i,options:s}=cs(o),a=pp(e);a>0&&(s.delay=((c=s.delay)!=null?c:0)+a);let l=Nt(e,i,s);r(()=>l.stop())});y("motion-scroll",({el:e,expression:t,evaluate:n,modifiers:r,cleanup:o})=>{var m,h;let i=vo(t,n);if(!i){X(`v-motion-scroll did not recognize the variant "${t}".`);return}let{keyframes:s,options:a}=cs(i),l=pp(e);l>0&&(a.delay=((m=a.delay)!=null?m:0)+l);let c=!r.repeat,d=xt(e,"motion-scroll-amount"),u=d===null?.25:parseFloat(d)||0;po()||Qf(e,s);let f=null,p=ls(e,()=>{if(f==null||f.stop(),f=Nt(e,s,a),!c)return()=>{f==null||f.stop(),po()||Qf(e,s)}},{once:c,amount:u,margin:(h=xt(e,"motion-scroll-margin"))!=null?h:"0px"});o(()=>{p(),f==null||f.stop()})});y("motion-stagger",({el:e,expression:t,evaluate:n})=>{let r=n(),o=typeof r=="number"&&Number.isFinite(r)?r:Q(t,60);up.set(e,{step:o,from:fp(e)})},{priority:j.BIND});function mp(e,t,n,r,o,i){let{keyframes:s,options:a}=cs(t),l={...o,...a},c=null,d=null,u=m=>{d==null||d.stop(),d=Nt(e,m,l)},f=()=>{c||(c=Pb(e,s)),u(s)},p=()=>{c&&u(c)};for(let m of n)e.addEventListener(m,f);for(let m of r)e.addEventListener(m,p);i(()=>{for(let m of n)e.removeEventListener(m,f);for(let m of r)e.removeEventListener(m,p);d==null||d.stop()})}y("motion-hover",({el:e,expression:t,evaluate:n,cleanup:r})=>{let o=vo(t,n);if(!o){X(`v-motion-hover did not recognize the variant "${t}".`);return}mp(e,o,["mouseenter","focusin"],["mouseleave","focusout"],{duration:220,easing:"easeOut"},r)});y("motion-tap",({el:e,expression:t,evaluate:n,cleanup:r})=>{let o=vo(t,n);if(!o){X(`v-motion-tap did not recognize the variant "${t}".`);return}mp(e,o,["pointerdown"],["pointerup","pointercancel","pointerleave","blur"],{duration:140,easing:"easeOut"},r)});y("parallax",({el:e,expression:t,evaluate:n,cleanup:r})=>{if(po()||typeof window=="undefined")return;let o=n(),i=typeof o=="number"&&Number.isFinite(o)?o:parseFloat(t)||.3;e.style.willChange="transform";let s=!1,a=()=>{s=!1;let c=e.getBoundingClientRect(),d=window.innerHeight||document.documentElement.clientHeight||1,u=c.top+c.height/2;ss(e).parallax=(d/2-u)*i,Hl(e)},l=()=>{s||(s=!0,requestAnimationFrame(a))};window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),a(),r(()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l),ss(e).parallax=0,Hl(e),e.style.removeProperty("will-change")})});var os=new Map,$l=null,Ol=!1;function Zf(){Ol||typeof requestAnimationFrame!="function"||(Ol=!0,requestAnimationFrame(Wb))}function Wb(){var e;Ol=!1;for(let t of os.values()){if(!t.el.isConnected||t.animating)continue;let n=t.el.getBoundingClientRect(),r=t.rect;t.rect=n;let o=r.left-n.left,i=r.top-n.top,s=n.width>0?r.width/n.width:1,a=n.height>0?r.height/n.height:1,l=Math.abs(o)>=1||Math.abs(i)>=1,c=Math.abs(s-1)>=.01||Math.abs(a-1)>=.01;!l&&!c||(t.animating=!0,(e=t.control)==null||e.stop(),t.control=Nt(t.el,{x:[o,0],y:[i,0],scaleX:[s,1],scaleY:[a,1]},t.options),t.control.finished.then(()=>{t.animating=!1,t.el.isConnected&&(t.rect=t.el.getBoundingClientRect())}))}}function Kb(){var t;if($l||typeof MutationObserver=="undefined")return;let e=(t=w.root)!=null?t:document.body;e&&($l=new MutationObserver(Zf),$l.observe(e,{childList:!0,subtree:!0}),window.addEventListener("resize",Zf))}y("flip",({el:e,expression:t,evaluate:n,cleanup:r})=>{if(typeof document=="undefined")return;let o=vo(t,n),i=o?cs(o).options:{};i.duration===void 0&&i.spring===void 0&&(i.spring={stiffness:340,damping:34}),Kb(),os.set(e,{el:e,rect:e.getBoundingClientRect(),options:i,control:null,animating:!1}),r(()=>{var s,a;(a=(s=os.get(e))==null?void 0:s.control)==null||a.stop(),os.delete(e)})});function Yb(e,t){let n={minimumFractionDigits:t,maximumFractionDigits:t};e==="currency"&&(n.style="currency",n.currency=w.currency);let r=new Intl.NumberFormat(w.locale,n);return e==="percent"?o=>`${r.format(o)}%`:o=>r.format(o)}y("count",({el:e,evaluate:t,effect:n,cleanup:r})=>{var f,p,m,h,v;let o=Q((f=xt(e,"count-duration"))!=null?f:void 0,1400),i=Math.max(0,Math.min(6,parseInt((p=xt(e,"count-decimals"))!=null?p:"0",10)||0)),s=(m=xt(e,"count-format"))!=null?m:"number",a=(h=xt(e,"count-prefix"))!=null?h:"",l=(v=xt(e,"count-suffix"))!=null?v:"",c=Yb(s,i),d=0,u=null;n(()=>{let g=Number(t()),b=Number.isFinite(g)?g:0,x=d;u==null||u.stop(),u=Nt(e,{},{duration:o,easing:"easeOutExpo",onUpdate(T){d=x+(b-x)*T,e.textContent=`${a}${c(d)}${l}`}})}),r(()=>u==null?void 0:u.stop())});y("typewriter",({el:e,expression:t,evaluate:n,effect:r,cleanup:o})=>{var l;let i=Q((l=xt(e,"typewriter-speed"))!=null?l:void 0,45),s=dp(t),a=null;r(()=>{var u;let c=s?String((u=n())!=null?u:""):t;if(a==null||a.stop(),e.textContent="",!c)return;let d=-1;a=Nt(e,{},{duration:Math.max(1,c.length*i),easing:"linear",onUpdate(f){let p=Math.round(f*c.length);p!==d&&(d=p,e.textContent=c.slice(0,p))}})}),o(()=>a==null?void 0:a.stop())});Ae();ce();function Xb(){return typeof window=="undefined"||typeof window.matchMedia!="function"?!1:ve.reducedMotion}var ho=["#6D3BF5","#FF3D8B","#2ED9A5","#FFB35C","#9B7BFF","#FF4D4D","#14111F","#3BB6F5"],Gb=`
...
`;function k(e){return Math.round(e*100)/100}function ye(e){let t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:0}function kn(e,t,n){return e<t?t:e>n?n:e}var vp=new Map;function hp(e,t){let n=`${w.locale}|${w.currency}|${e}`,r=vp.get(n);return r||(r=new Intl.NumberFormat(w.locale,t),vp.set(n,r)),r}function De(e,t="number"){if(!Number.isFinite(e))return"";if(t==="currency")return hp("currency",{style:"currency",currency:w.currency,maximumFractionDigits:2}).format(e);let n=hp("number",{maximumFractionDigits:2}).format(e);return t==="percent"?`${n}%`:n}function Qb(e){return!!e&&typeof e=="object"&&Array.isArray(e.data)}function Ve(e,t){let n=e[t];return n===void 0||n===""?`#${t+1}`:n}function Jb(e,t){var c,d,u;let n=e.colors&&e.colors.length>0?e.colors:ho,r=Array.isArray(e.labels),o=r?e.labels.map(f=>String(f)):[],i=[],s=e.data,a=(c=e.name)!=null?c:"Value";if(typeof s=="number")i.push({name:a,values:[s],xs:null,color:n[0]});else if(Array.isArray(s)&&s.length>0){let f=s[0];if(typeof f=="number")i.push({name:a,values:s.map(ye),xs:null,color:n[0]});else if(Qb(f))s.forEach((p,m)=>{i.push({name:p.name||`Serie ${m+1}`,values:(p.data||[]).map(ye),xs:null,color:p.color||n[m%n.length]})});else{let p=s,m=[],h=[],v=!1;p.forEach((g,b)=>{m.push(ye(g.value!==void 0?g.value:g.y)),typeof g.x=="number"?(v=!0,h.push(g.x)):h.push(b),!r&&g.label!==void 0&&(o[b]=String(g.label))}),i.push({name:a,values:m,xs:v?h:null,color:n[0]})}}let l=t==="pie"||t==="donut";if(l)for(let f=0;f<((u=(d=i[0])==null?void 0:d.values.length)!=null?u:0);f++)o[f]===void 0&&(o[f]=Ve(o,f));return{series:i,labels:o,categorical:l}}function Zb(e,t){if(e.categorical){let n=e.series[0];return n?n.values.map((r,o)=>({key:Ve(e.labels,o),name:Ve(e.labels,o),color:t[o%t.length]})):[]}return e.series.map(n=>({key:n.name,name:n.name,color:n.color}))}function ey(e,t,n){var r;if(t.size===0)return e;if(e.categorical){let o=e.series[0];if(!o)return e;let i=[],s=[],a=[];return o.values.forEach((l,c)=>{let d=Ve(e.labels,c);t.has(d)||(i.push(l),s.push(d),a.push(n[c%n.length]))}),{series:[{...o,values:i,xs:null,color:(r=a[0])!=null?r:o.color}],labels:s,categorical:!0}}return{series:e.series.filter(o=>!t.has(o.name)),labels:e.labels,categorical:!1}}function gp(e,t){let n=Math.abs(e)||1,r=Math.floor(Math.log10(n)),o=n/Math.pow(10,r),i;return t?o<1.5?i=1:o<3?i=2:o<7?i=5:i=10:o<=1?i=1:o<=2?i=2:o<=5?i=5:i=10,i*Math.pow(10,r)}function Ul(e,t,n=5){if(e===t){let c=Math.abs(e)||1;return Ul(e-c*.5,t+c*.5,n)}let r=gp(t-e,!1),o=gp(r/Math.max(1,n-1),!0),i=Math.max(0,Math.min(10,-Math.floor(Math.log10(o))+2)),s=Math.floor(e/o)*o,a=Math.ceil(t/o)*o,l=[];for(let c=s;c<=a+o*.5;c+=o)l.push(Number(c.toFixed(i)));return{min:s,max:a,ticks:l}}function _l(e,t,n,r){let o=1/0,i=-1/0;if(n){let s=0;for(let a of e.series)s=Math.max(s,a.values.length);for(let a=0;a<s;a++){let l=0,c=0;for(let d of e.series){let u=ye(d.values[a]);u>=0?l+=u:c+=u}o=Math.min(o,c),i=Math.max(i,l)}}else for(let s of e.series)for(let a of s.values)Number.isFinite(a)&&(o=Math.min(o,a),i=Math.max(i,a));return(!Number.isFinite(o)||!Number.isFinite(i))&&(o=0,i=1),r&&(o=Math.min(o,0),i=Math.max(i,0)),t.min!==void 0&&(o=t.min),t.max!==void 0&&(i=t.max),o===i&&(i=o+(Math.abs(o)||1)),{min:o,max:i}}function bp(e){if(e.length===0)return"";let t=[`M ${k(e[0][0])} ${k(e[0][1])}`];for(let n=1;n<e.length;n++)t.push(`L ${k(e[n][0])} ${k(e[n][1])}`);return t.join(" ")}function ty(e){if(e.length<3)return bp(e);let t=[`M ${k(e[0][0])} ${k(e[0][1])}`];for(let n=0;n<e.length-1;n++){let r=n>0?e[n-1]:e[n],o=e[n],i=e[n+1],s=n+2<e.length?e[n+2]:i,a=o[0]+(i[0]-r[0])/6,l=o[1]+(i[1]-r[1])/6,c=i[0]-(s[0]-o[0])/6,d=i[1]-(s[1]-o[1])/6;t.push(`C ${k(a)} ${k(l)}, ${k(c)} ${k(d)}, ${k(i[0])} ${k(i[1])}`)}return t.join(" ")}function ny(e,t){return t?ty(e):bp(e)}function ct(e,t,n,r){return[e+Math.cos(r)*n,t+Math.sin(r)*n]}function ry(e,t,n,r,o,i){let s=i-o>Math.PI?1:0,[a,l]=ct(e,t,n,o),[c,d]=ct(e,t,n,i);if(r<=0)return`M ${k(e)} ${k(t)} L ${k(a)} ${k(l)} A ${k(n)} ${k(n)} 0 ${s} 1 ${k(c)} ${k(d)} Z`;let[u,f]=ct(e,t,r,o),[p,m]=ct(e,t,r,i);return`M ${k(a)} ${k(l)} A ${k(n)} ${k(n)} 0 ${s} 1 ${k(c)} ${k(d)} L ${k(p)} ${k(m)} A ${k(r)} ${k(r)} 0 ${s} 0 ${k(u)} ${k(f)} Z`}var oy=7;function yp(e){let t=0;for(let n of e)t=Math.max(t,n.length);return t*oy+12}function Wl(e,t){let{options:n,dataset:r,width:o,height:i}=e,s=_l(r,n,t.stacked,t.baselineZero),a=n.min!==void 0&&n.max!==void 0?{min:s.min,max:s.max,ticks:xp(s.min,s.max,5)}:Ul(s.min,s.max,5),l=a.ticks.map(T=>De(T,e.format)),c=n.showGrid!==!1&&!t.bare,d=r.labels.length>0&&!t.bare,u=t.bare?3:16,f=t.bare?3:16,p=t.bare?3:c?kn(yp(l),32,140):8,m=t.bare?3:d?26:10,h=Math.max(1,o-p-f),v=Math.max(1,i-u-m),g=a.max-a.min||1,b=T=>u+v*(1-(T-a.min)/g),x="";if(c){let T=[];a.ticks.forEach((E,C)=>{let D=k(b(E));T.push(`<line class="v-chart-grid" x1="${k(p)}" y1="${D}" x2="${k(p+h)}" y2="${D}"/>`),T.push(`<text class="v-chart-axis" x="${k(p-8)}" y="${D+4}" text-anchor="end">${I(l[C])}</text>`)}),x=`<g>${T.join("")}</g>`}return{left:p,top:u,innerW:h,innerH:v,min:a.min,max:a.max,ticks:a.ticks,y:b,grid:x}}function xp(e,t,n){let r=(t-e)/Math.max(1,n-1),o=[];for(let i=0;i<n;i++)o.push(Number((e+r*i).toFixed(6)));return o}function Kl(e,t,n,r,o){if(e.length===0||t===0)return"";let i=Math.max(1,Math.floor(o/56)),s=Math.max(1,Math.ceil(t/i)),a=[];for(let l=0;l<t;l+=s){let c=e[l];c===void 0||c===""||a.push(`<text class="v-chart-axis" x="${k(n(l))}" y="${k(r)}" text-anchor="middle">${I(c)}</text>`)}return a.join("")}function go(e){let t=e.labels.length;for(let n of e.series)t=Math.max(t,n.values.length);return t}function En(e){return`<text class="v-chart-empty" x="${k(e.width/2)}" y="${k(e.height/2)}" text-anchor="middle">No data</text>`}function Tn(e,t,n){return`<title>${I(e)}: ${I(De(t,n))}</title>`}function iy(e,t){if(e.values.length===0)return e.name;let n=1/0,r=-1/0;for(let s of e.values)n=Math.min(n,s),r=Math.max(r,s);let o=e.values[0],i=e.values[e.values.length-1];return`${e.name}: from ${De(o,t)} to ${De(i,t)}, minimum ${De(n,t)}, maximum ${De(r,t)}`}function sy(e){let t=e.type==="sparkline",n=e.type==="area",r=go(e.dataset);if(r===0)return En(e);let o=Wl(e,{stacked:!1,baselineZero:n,bare:t}),i=c=>r<=1?o.left+o.innerW/2:o.left+o.innerW*c/(r-1),s=e.options.smooth===!0,a=[o.grid],l=o.y(kn(0,o.min,o.max));for(let c of e.dataset.series){let d=[];for(let p=0;p<r;p++)d.push([i(p),o.y(ye(c.values[p]))]);if(d.length===0)continue;let u=ny(d,s);if(n){let p=`${u} L ${k(d[d.length-1][0])} ${k(l)} L ${k(d[0][0])} ${k(l)} Z`;a.push(`<path class="v-chart-area" d="${p}" fill="${I(c.color)}" fill-opacity="0.16"/>`)}let f=e.animated?' pathLength="1" stroke-dasharray="1"':"";a.push(`<path class="v-chart-line" d="${u}" stroke="${I(c.color)}"${f}><title>${I(iy(c,e.format))}</title></path>`),!t&&r<=40&&d.forEach((p,m)=>{a.push(`<circle class="v-chart-point" cx="${k(p[0])}" cy="${k(p[1])}" r="3.5" fill="${I(c.color)}">`+Tn(`${c.name} ${Ve(e.dataset.labels,m)}`,ye(c.values[m]),e.format)+"</circle>")}),e.options.showValues&&!t&&d.forEach((p,m)=>{a.push(`<text class="v-chart-value" x="${k(p[0])}" y="${k(p[1]-10)}" text-anchor="middle">${I(De(ye(c.values[m]),e.format))}</text>`)})}return t||a.push(Kl(e.dataset.labels,r,i,o.top+o.innerH+18,o.innerW)),wp(e,r,i,c=>{let d=1/0;for(let u of e.dataset.series)d=Math.min(d,o.y(ye(u.values[c])));return Number.isFinite(d)?d:o.top}),a.join("")}function wp(e,t,n,r){for(let o=0;o<t;o++)e.hits.push({x:n(o),y:r(o),title:Ve(e.dataset.labels,o),rows:e.dataset.series.map(i=>({name:i.name,color:i.color,value:ye(i.values[o])}))})}function ay(e){let t=e.type==="stacked",n=go(e.dataset);if(n===0)return En(e);let r=Wl(e,{stacked:t,baselineZero:!0,bare:!1}),o=r.innerW/n,i=t?1:Math.max(1,e.dataset.series.length),s=Math.min(o*.3,18),a=Math.max(2,(o-s)/i),l=r.y(kn(0,r.min,r.max)),c=Math.min(4,a/2),d=[r.grid],u=f=>r.left+o*f+o/2;for(let f=0;f<n;f++){let p=0,m=0;e.dataset.series.forEach((h,v)=>{let g=ye(h.values[f]),b,x,T;if(t){let D=g>=0?p:m,A=D+g;g>=0?p=A:m=A,b=Math.min(r.y(D),r.y(A)),x=Math.max(r.y(D),r.y(A)),T=r.left+o*f+s/2}else b=Math.min(r.y(g),l),x=Math.max(r.y(g),l),T=r.left+o*f+s/2+v*a;let E=t?Math.max(2,o-s):a*.86,C=Math.max(g===0?0:1,x-b);d.push(`<rect class="v-chart-bar" x="${k(T)}" y="${k(b)}" width="${k(E)}" height="${k(C)}" rx="${k(c)}" fill="${I(h.color)}" style="transform-origin:${k(T+E/2)}px ${k(l)}px;transition-delay:${f*30}ms">`+Tn(`${h.name} ${Ve(e.dataset.labels,f)}`,g,e.format)+"</rect>"),e.options.showValues&&!t&&d.push(`<text class="v-chart-value" x="${k(T+E/2)}" y="${k(b-6)}" text-anchor="middle">${I(De(g,e.format))}</text>`)})}return d.push(Kl(e.dataset.labels,n,u,r.top+r.innerH+18,r.innerW)),wp(e,n,u,f=>{if(t){let m=0;for(let h of e.dataset.series)m+=Math.max(0,ye(h.values[f]));return r.y(m)}let p=l;for(let m of e.dataset.series)p=Math.min(p,r.y(ye(m.values[f])));return p}),d.join("")}function ly(e){let t=go(e.dataset);if(t===0)return En(e);let n=_l(e.dataset,e.options,!1,!0),r=e.options.min!==void 0&&e.options.max!==void 0?{min:n.min,max:n.max,ticks:xp(n.min,n.max,5)}:Ul(n.min,n.max,5),o=kn(yp(e.dataset.labels.length>0?e.dataset.labels:[""]),24,e.width*.4),i=e.dataset.labels.length>0?o:12,s=12,a=e.options.showGrid===!1?12:26,l=Math.max(1,e.width-i-20),c=Math.max(1,e.height-s-a),d=r.max-r.min||1,u=b=>i+l*(b-r.min)/d,f=u(kn(0,r.min,r.max)),p=c/t,m=Math.max(1,e.dataset.series.length),h=Math.min(p*.3,16),v=Math.max(2,(p-h)/m),g=[];if(e.options.showGrid!==!1)for(let b of r.ticks){let x=k(u(b));g.push(`<line class="v-chart-grid" x1="${x}" y1="${k(s)}" x2="${x}" y2="${k(s+c)}"/>`),g.push(`<text class="v-chart-axis" x="${x}" y="${k(s+c+16)}" text-anchor="middle">${I(De(b,e.format))}</text>`)}for(let b=0;b<t;b++){let x=e.dataset.labels[b];x&&g.push(`<text class="v-chart-axis" x="${k(i-8)}" y="${k(s+p*b+p/2+4)}" text-anchor="end">${I(x)}</text>`);let T=f;e.dataset.series.forEach((E,C)=>{let D=ye(E.values[b]),A=Math.min(u(D),f);T=Math.max(T,u(D));let se=Math.max(D===0?0:1,Math.abs(u(D)-f)),O=s+p*b+h/2+C*v;g.push(`<rect class="v-chart-barh" x="${k(A)}" y="${k(O)}" width="${k(se)}" height="${k(v*.86)}" rx="${k(Math.min(4,v/2))}" fill="${I(E.color)}" style="transform-origin:${k(f)}px ${k(O+v/2)}px;transition-delay:${b*30}ms">`+Tn(`${E.name} ${Ve(e.dataset.labels,b)}`,D,e.format)+"</rect>"),e.options.showValues&&g.push(`<text class="v-chart-value" x="${k(A+se+6)}" y="${k(O+v*.6)}">${I(De(D,e.format))}</text>`)}),e.hits.push({x:T,y:s+p*b+p/2,title:Ve(e.dataset.labels,b),rows:e.dataset.series.map(E=>({name:E.name,color:E.color,value:ye(E.values[b])}))})}return g.join("")}function cy(e){let t=e.dataset.series[0];if(!t||t.values.length===0)return En(e);let n=e.type==="donut",r=t.values.map(f=>Math.max(0,ye(f))),o=r.reduce((f,p)=>f+p,0);if(o<=0)return En(e);let i=e.width/2,s=e.height/2,a=Math.max(12,Math.min(e.width,e.height)/2-14),l=n?a*.62:0,c=`transform-origin:${k(i)}px ${k(s)}px`,d=[],u=-Math.PI/2;return r.forEach((f,p)=>{let m=f/o*Math.PI*2,h=e.palette[p%e.palette.length],v=Ve(e.dataset.labels,p),g=m>=Math.PI*2-1e-6,b=g?n?`<circle class="v-chart-slice" data-hit="${p}" cx="${k(i)}" cy="${k(s)}" r="${k((a+l)/2)}" fill="none" stroke="${I(h)}" stroke-width="${k(a-l)}" style="${c}">`:`<circle class="v-chart-slice" data-hit="${p}" cx="${k(i)}" cy="${k(s)}" r="${k(a)}" fill="${I(h)}" style="${c}">`:`<path class="v-chart-slice" data-hit="${p}" d="${ry(i,s,a,l,u,u+m)}" fill="${I(h)}" style="${c};transition-delay:${p*45}ms">`;d.push(`${b}${Tn(v,f,e.format)}${g?"</circle>":"</path>"}`);let x=u+m/2,[T,E]=ct(i,s,(a+l)/2,x);if(e.hits.push({x:T,y:E,title:v,rows:[{name:v,color:h,value:f}]}),e.options.showValues&&m>.3){let[C,D]=ct(i,s,n?(a+l)/2:a*.68,x),A=Math.round(f/o*100);d.push(`<text class="v-chart-value" x="${k(C)}" y="${k(D+4)}" text-anchor="middle">${A}%</text>`)}u+=m}),n&&d.push(`<text class="v-chart-center" x="${k(i)}" y="${k(s+2)}" text-anchor="middle">${I(De(o,e.format))}</text>`,`<text class="v-chart-center-sub" x="${k(i)}" y="${k(s+20)}" text-anchor="middle">Total</text>`),d.join("")}function dy(e){let t=go(e.dataset);if(t<3)return En(e);let r=_l(e.dataset,e.options,!1,!0).max||1,o=e.width/2,i=e.height/2,s=Math.max(20,Math.min(e.width,e.height)/2-28),a=c=>-Math.PI/2+Math.PI*2*c/t,l=[];for(let c=1;c<=4;c++){let d=[];for(let u=0;u<t;u++)d.push(ct(o,i,s*c/4,a(u)));l.push(`<polygon class="v-chart-radar-web" points="${d.map(u=>`${k(u[0])},${k(u[1])}`).join(" ")}"/>`)}for(let c=0;c<t;c++){let[d,u]=ct(o,i,s,a(c));l.push(`<line class="v-chart-grid" x1="${k(o)}" y1="${k(i)}" x2="${k(d)}" y2="${k(u)}"/>`);let f=e.dataset.labels[c];if(f){let[p,m]=ct(o,i,s+14,a(c)),h=Math.abs(p-o)<4?"middle":p>o?"start":"end";l.push(`<text class="v-chart-axis" x="${k(p)}" y="${k(m+4)}" text-anchor="${h}">${I(f)}</text>`)}}for(let c of e.dataset.series){let d=[];for(let u=0;u<t;u++){let f=kn(ye(c.values[u])/r,0,1);d.push(ct(o,i,s*f,a(u)))}l.push(`<polygon class="v-chart-radar-area v-chart-slice" points="${d.map(u=>`${k(u[0])},${k(u[1])}`).join(" ")}" fill="${I(c.color)}" fill-opacity="0.22" stroke="${I(c.color)}" style="transform-origin:${k(o)}px ${k(i)}px"/>`),d.forEach((u,f)=>{l.push(`<circle class="v-chart-point" data-hit="${f}" cx="${k(u[0])}" cy="${k(u[1])}" r="3.5" fill="${I(c.color)}">`+Tn(`${c.name} ${Ve(e.dataset.labels,f)}`,ye(c.values[f]),e.format)+"</circle>")})}for(let c=0;c<t;c++){let[d,u]=ct(o,i,s*.7,a(c));e.hits.push({x:d,y:u,title:Ve(e.dataset.labels,c),rows:e.dataset.series.map(f=>({name:f.name,color:f.color,value:ye(f.values[c])}))})}return l.join("")}function uy(e){let t=go(e.dataset);if(t===0)return En(e);let n=Wl(e,{stacked:!1,baselineZero:!1,bare:!1}),r=1/0,o=-1/0;for(let c of e.dataset.series){let d=c.xs;if(d)for(let u of d)r=Math.min(r,u),o=Math.max(o,u)}let i=Number.isFinite(r)&&Number.isFinite(o)&&o>r,s=(c,d)=>i&&c.xs?n.left+n.innerW*(c.xs[d]-r)/(o-r):t<=1?n.left+n.innerW/2:n.left+n.innerW*d/(t-1),a=[n.grid],l=0;for(let c of e.dataset.series)c.values.forEach((d,u)=>{let f=s(c,u),p=n.y(ye(d));a.push(`<circle class="v-chart-point v-chart-slice" data-hit="${l}" cx="${k(f)}" cy="${k(p)}" r="4.5" fill="${I(c.color)}" style="transform-origin:${k(f)}px ${k(p)}px">`+Tn(`${c.name} ${Ve(e.dataset.labels,u)}`,ye(d),e.format)+"</circle>"),e.hits.push({x:f,y:p,title:Ve(e.dataset.labels,u),rows:[{name:c.name,color:c.color,value:ye(d)}]}),l++});return i||a.push(Kl(e.dataset.labels,t,c=>t<=1?n.left+n.innerW/2:n.left+n.innerW*c/(t-1),n.top+n.innerH+18,n.innerW)),a.join("")}function fy(e){var m,h,v,g,b;let t=e.dataset.series[0],n=t?ye(t.values[0]):0,r=(m=e.options.max)!=null?m:100,o=(h=e.options.min)!=null?h:0,i=kn((n-o)/(r-o||1),0,1),s=e.width/2,a=e.height/2,l=Math.max(16,Math.min(e.width,e.height)/2-16),c=Math.max(8,l*.2),d=l-c/2,u=2*Math.PI*d,f=u*(1-i),p=e.palette[0];return e.hits.push({x:s,y:a-d,title:(v=t==null?void 0:t.name)!=null?v:"Progresso",rows:[{name:(g=t==null?void 0:t.name)!=null?g:"Progresso",color:p,value:n}]}),`<circle class="v-chart-track" cx="${k(s)}" cy="${k(a)}" r="${k(d)}" stroke-width="${k(c)}"/><circle class="v-chart-ring" data-hit="0" cx="${k(s)}" cy="${k(a)}" r="${k(d)}" fill="none" stroke="${I(p)}" stroke-width="${k(c)}" stroke-linecap="round" stroke-dasharray="${k(u)}" style="--v-ring-full:${k(u)};--v-ring-offset:${k(f)};transform:rotate(-90deg);transform-origin:${k(s)}px ${k(a)}px">`+Tn((b=t==null?void 0:t.name)!=null?b:"Progresso",n,e.format)+`</circle><text class="v-chart-center" x="${k(s)}" y="${k(a+4)}" text-anchor="middle">${Math.round(i*100)}%</text>`+(t?`<text class="v-chart-center-sub" x="${k(s)}" y="${k(a+22)}" text-anchor="middle">${I(De(n,e.format))}</text>`:"")}var py=new Set(["pie","donut","scatter","progress","radar"]);function my(e){return e==="sparkline"?56:260}function vy(e,t){return e.showLegend===!1?!1:e.showLegend===!0?!0:t.categorical||t.series.length>1}var hy={line:"line",area:"area",bar:"bar",column:"horizontal bar",stacked:"stacked bar",pie:"pie",donut:"donut",sparkline:"trend",radar:"radar",scatter:"scatter",progress:"progress"};function gy(e,t,n){if(t.series.length===0)return"Chart with no data.";let r=(t.series.length===1,"series"),o=[`${hy[e]} chart with ${t.series.length} ${r}.`];for(let i of t.series){if(i.values.length===0)continue;let s=1/0,a=-1/0,l=0;for(let d of i.values)s=Math.min(s,d),a=Math.max(a,d),l+=d;let c=l/i.values.length;o.push(`${i.name}: ${i.values.length} points, minimum ${De(s,n)}, maximum ${De(a,n)}, average ${De(c,n)}.`)}return o.join(" ")}function by(e){switch(e.type){case"bar":case"stacked":return ay(e);case"column":return ly(e);case"pie":case"donut":return cy(e);case"radar":return dy(e);case"scatter":return uy(e);case"progress":return fy(e);default:return sy(e)}}function yy(e,t){return e.length===0?"":`<div class="v-chart-legend">${e.map(r=>{let o=t.has(r.key);return`<button type="button" class="v-chart-key" data-key="${I(r.key)}" aria-pressed="${o?"false":"true"}"><span class="v-chart-dot" style="background:${I(r.color)}"></span>${I(r.name)}</button>`}).join("")}</div>`}function ds(e){var v,g,b;let t=e.el,n=e.options,r=(v=n.type)!=null?v:"line",o=n.colors&&n.colors.length>0?n.colors:ho,i=(g=n.format)!=null?g:"number",s=Math.max(160,Math.round(t.clientWidth||n.width||640)),a=Math.max(48,Math.round((b=n.height)!=null?b:t.clientHeight||my(r)));e.lastWidth=s,e.viewWidth=s,e.viewHeight=a;let l=Jb(n,r),c=Zb(l,o),d=ey(l,e.hidden,o),u=n.animate!==!1&&!Xb();e.hits=[],e.shapeHits=py.has(r),e.hitAxis=r==="column"?"y":"x";let f={type:r,options:n,dataset:d,palette:o,width:s,height:a,animated:u,format:i,hits:e.hits},p=by(f),m=gy(r,d,i);t.classList.add("v-chart"),t.classList.toggle("v-chart-animate",u),t.classList.remove("v-chart-in");let h=[`<svg class="v-chart-svg" viewBox="0 0 ${s} ${a}" preserveAspectRatio="xMidYMid meet" `,`style="height:${a}px" role="img" aria-label="${I(m)}">`,p,"</svg>"];vy(n,l)&&h.push(yy(c,e.hidden)),n.tooltip!==!1&&h.push('<div class="v-chart-tip" hidden></div>'),t.innerHTML=h.join(""),u&&typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{requestAnimationFrame(()=>t.classList.add("v-chart-in"))})}function xy(e,t){let n=e.rows.map(r=>`<div class="v-chart-tip-row"><span class="v-chart-dot" style="background:${I(r.color)}"></span>${I(r.name)}<b>${I(De(r.value,t))}</b></div>`);return`<div class="v-chart-tip-title">${I(e.title)}</div>${n.join("")}`}function kp(e){let t=e.el.querySelector(".v-chart-tip");t&&(t.hidden=!0)}function wy(e,t){var a;if(e.options.tooltip===!1||e.hits.length===0)return;let n=e.el.querySelector(".v-chart-tip"),r=e.el.querySelector("svg");if(!n||!r)return;let o=r.getBoundingClientRect();if(o.width===0||o.height===0)return;let i;if(e.shapeHits){let l=t.target,c=l&&typeof l.closest=="function"?l.closest("[data-hit]"):null,d=c?Number(c.getAttribute("data-hit")):-1;d>=0&&(i=e.hits[d])}else if(e.hitAxis==="y"){let l=(t.clientY-o.top)/o.height*e.viewHeight,c=1/0;for(let d of e.hits){let u=Math.abs(d.y-l);u<c&&(c=u,i=d)}}else{let l=(t.clientX-o.left)/o.width*e.viewWidth,c=1/0;for(let d of e.hits){let u=Math.abs(d.x-l);u<c&&(c=u,i=d)}}if(!i){kp(e);return}let s=e.el.getBoundingClientRect();n.innerHTML=xy(i,(a=e.options.format)!=null?a:"number"),n.style.left=`${o.left-s.left+i.x/e.viewWidth*o.width}px`,n.style.top=`${o.top-s.top+i.y/e.viewHeight*o.height}px`,n.hidden=!1}function ky(e){let t=e.el,n=i=>{var l;let s=i.target;if(!s||typeof s.closest!="function")return;let a=(l=s.closest("[data-key]"))==null?void 0:l.getAttribute("data-key");a!=null&&(e.hidden.has(a)?e.hidden.delete(a):e.hidden.add(a),ds(e))},r=i=>wy(e,i),o=()=>kp(e);t.addEventListener("click",n),t.addEventListener("pointermove",r),t.addEventListener("pointerleave",o),e.teardown.push(()=>{t.removeEventListener("click",n),t.removeEventListener("pointermove",r),t.removeEventListener("pointerleave",o)})}function Ey(e){if(typeof ResizeObserver=="undefined")return;let t=new ResizeObserver(()=>{let n=Math.round(e.el.clientWidth);n===0||n===e.lastWidth||(e.frame&&cancelAnimationFrame(e.frame),e.frame=requestAnimationFrame(()=>{e.frame=0,ds(e)}))});t.observe(e.el),e.observer=t}function hr(e,t){ge(),Z("charts",Gb);let n={el:e,options:{...t},hidden:new Set,hits:[],shapeHits:!1,hitAxis:"x",viewWidth:1,viewHeight:1,lastWidth:0,observer:null,frame:0,teardown:[]};return ky(n),ds(n),Ey(n),{el:e,get options(){return n.options},update(r){Object.assign(n.options,r),ds(n)},destroy(){var r;n.frame&&cancelAnimationFrame(n.frame),n.frame=0,(r=n.observer)==null||r.disconnect(),n.observer=null;for(let o of n.teardown)o();n.teardown.length=0,e.classList.remove("v-chart","v-chart-animate","v-chart-in"),e.innerHTML=""}}}function tt(e,t){var n;return(n=Te(e,`${w.prefix}${t}`))!=null?n:Te(e,`data-v-${t}`)}function vr(e,t){return e===null?t:e===""||e==="true"||e==="1"?!0:e==="false"||e==="0"?!1:t}function Ty(e,t){let r=!!t&&typeof t=="object"&&!Array.isArray(t)&&"data"in t?{...t}:{data:t!=null?t:[]},o=tt(e,"chart-type");o&&(r.type=o),r.type||(r.type="line");let i=tt(e,"chart-height");i&&(r.height=parseFloat(i)||r.height);let s=tt(e,"chart-format");s&&(r.format=s);let a=tt(e,"chart-colors");a&&(r.colors=a.split(",").map(v=>v.trim()).filter(Boolean));let l=tt(e,"chart-max");l!==null&&l!==""&&(r.max=parseFloat(l));let c=tt(e,"chart-min");c!==null&&c!==""&&(r.min=parseFloat(c));let d=tt(e,"chart-smooth");d!==null&&(r.smooth=vr(d,!0));let u=tt(e,"chart-grid");u!==null&&(r.showGrid=vr(u,!0));let f=tt(e,"chart-legend");f!==null&&(r.showLegend=vr(f,!0));let p=tt(e,"chart-values");p!==null&&(r.showValues=vr(p,!0));let m=tt(e,"chart-tooltip");m!==null&&(r.tooltip=vr(m,!0));let h=tt(e,"chart-animate");return h!==null&&(r.animate=vr(h,!0)),r}function Vl(e,t=0){if(!e||typeof e!="object"||t>3)return 1;let n=0;if(Array.isArray(e)){for(let r of e)n+=Vl(r,t+1);return n}for(let r of Object.values(e))n+=Vl(r,t+1);return n}y("chart",({el:e,evaluate:t,effect:n,cleanup:r})=>{let o=null;n(()=>{let i=t();Vl(i);let s=Ty(e,i);o?o.update(s):o=hr(e,s)}),r(()=>{o==null||o.destroy(),o=null})});var Yl={render:hr,format:De,colors:ho};de();ce();Ae();Ae();ce();var Ly=/^#([0-9a-f])([0-9a-f])([0-9a-f])[0-9a-f]?$/i,My=/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})(?:[0-9a-f]{2})?$/i,Sy=/^rgba?\(([^)]+)\)$/i,Cy=/^hsla?\(([^)]+)\)$/i;function Ep(e){return e.split(/[\s,/]+/).map(t=>parseFloat(t)).filter(t=>!Number.isNaN(t))}function Ay(e,t,n){let r=(e%360+360)%360,o=Ue(t/100,0,1),i=Ue(n/100,0,1),s=(1-Math.abs(2*i-1))*o,a=s*(1-Math.abs(r/60%2-1)),l=i-s/2,c=Math.floor(r/60)%6,d=[[s,a,0],[a,s,0],[0,s,a],[0,a,s],[a,0,s],[s,0,a]],[u,f,p]=d[c];return{r:Math.round((u+l)*255),g:Math.round((f+l)*255),b:Math.round((p+l)*255)}}function wt(e){let t=String(e!=null?e:"").trim();if(!t)return null;let n=Ly.exec(t);if(n)return{r:parseInt(n[1]+n[1],16),g:parseInt(n[2]+n[2],16),b:parseInt(n[3]+n[3],16)};let r=My.exec(t);if(r)return{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)};let o=Sy.exec(t);if(o){let[s,a,l]=Ep(o[1]);return s===void 0||a===void 0||l===void 0?null:{r:Ue(s,0,255),g:Ue(a,0,255),b:Ue(l,0,255)}}let i=Cy.exec(t);if(i){let[s,a,l]=Ep(i[1]);return s===void 0||a===void 0||l===void 0?null:Ay(s,a,l)}return null}function Ue(e,t,n){return e<t?t:e>n?n:e}function yr(e){let t=e/255;return t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function Xl(e){return e<=.0031308?e*12.92:1.055*Math.pow(e,.4166666666666667)-.055}function Ry(e){let t=yr(e.r),n=yr(e.g),r=yr(e.b),o=.4122214708*t+.5363325363*n+.0514459929*r,i=.2119034982*t+.6806995451*n+.1073969566*r,s=.0883024619*t+.2817188376*n+.6299787005*r,a=Math.cbrt(o),l=Math.cbrt(i),c=Math.cbrt(s);return{l:.2104542553*a+.793617785*l-.0040720468*c,a:1.9779984951*a-2.428592205*l+.4505937099*c,b:.0259040371*a+.7827717662*l-.808675766*c}}function $y(e){let t=e.l+.3963377774*e.a+.2158037573*e.b,n=e.l-.1055613458*e.a-.0638541728*e.b,r=e.l-.0894841775*e.a-1.291485548*e.b,o=t*t*t,i=n*n*n,s=r*r*r;return{r:Xl(4.0767416621*o-3.3077115913*i+.2309699292*s),g:Xl(-1.2684380046*o+2.6097574011*i-.3413193965*s),b:Xl(-.0041960863*o-.7034186147*i+1.707614701*s)}}function fs(e){let t=Ry(e),n=Math.sqrt(t.a*t.a+t.b*t.b),r=Math.atan2(t.b,t.a)*180/Math.PI;return r<0&&(r+=360),{l:t.l,c:n,h:n<1e-5?0:r}}function Tp(e){let t=e.h*Math.PI/180;return $y({l:e.l,a:Math.cos(t)*e.c,b:Math.sin(t)*e.c})}function br(e){let t=Math.max(0,e.c);for(let r=0;r<32;r++){let o=Tp({l:Ue(e.l,0,1),c:t,h:e.h});if(o.r>=-.001&&o.r<=1.001&&o.g>=-.001&&o.g<=1.001&&o.b>=-.001&&o.b<=1.001)return{r:Math.round(Ue(o.r,0,1)*255),g:Math.round(Ue(o.g,0,1)*255),b:Math.round(Ue(o.b,0,1)*255)};t*=.92}let n=Tp({l:Ue(e.l,0,1),c:0,h:e.h});return{r:Math.round(Ue(n.r,0,1)*255),g:Math.round(Ue(n.g,0,1)*255),b:Math.round(Ue(n.b,0,1)*255)}}function Gl(e){return Ue(Math.round(e),0,255).toString(16).padStart(2,"0")}function Ln(e){return`#${Gl(e.r)}${Gl(e.g)}${Gl(e.b)}`}function gr(e,t){return`rgba(${Math.round(e.r)}, ${Math.round(e.g)}, ${Math.round(e.b)}, ${Number(t.toFixed(3))})`}function Ap(e){return Ln(br(e))}function Jl(e){return .2126*yr(e.r)+.7152*yr(e.g)+.0722*yr(e.b)}function Zl(e,t){let n=typeof e=="string"?wt(e):e,r=typeof t=="string"?wt(t):t;if(!n||!r)return 1;let o=Jl(n),i=Jl(r),s=Math.max(o,i),a=Math.min(o,i);return(s+.05)/(a+.05)}var Rp={r:255,g:255,b:255},ps={r:0,g:0,b:0};function bo(e){let t=typeof e=="string"?wt(e):e;return t?Zl(t,Rp)>=Zl(t,ps)?"#ffffff":"#000000":"#ffffff"}var ec=[50,100,200,300,400,500,600,700,800,900],$p=[.973,.941,.889,.819,.732,.638,.558,.478,.399,.327],Dy=[.14,.26,.46,.68,.88,1,.97,.89,.78,.65],Dp=[.244,.286,.343,.408,.484,.588,.668,.748,.836,.928],Py=[.3,.42,.6,.78,.92,1,.92,.78,.57,.33];function Pp(e,t=!1){var a;let n=typeof e=="string"?(a=wt(e))!=null?a:ps:e,r=fs(n),o=t?Dp:$p,i=t?Py:Dy,s={};return ec.forEach((l,c)=>{s[String(l)]=Ap({l:o[c],c:r.c*i[c],h:r.h})}),s}var ms={violeta:{primary:"#6D3BF5",accent:"#FF3D8B",success:"#16A34A",warning:"#D97706",danger:"#E11D48",info:"#7C6BFF"},oceano:{primary:"#0E7BC4",accent:"#0FB5C9",success:"#0F9D6E",warning:"#D08700",danger:"#DC2F3E",info:"#3B82F6"},floresta:{primary:"#1F8A4C",accent:"#7FA80E",success:"#18A05A",warning:"#C97A0A",danger:"#C93A2E",info:"#2C8FA8"},poente:{primary:"#E4632A",accent:"#D62F63",success:"#3E9B52",warning:"#D99000",danger:"#D32F2F",info:"#B45FC0"},grafite:{primary:"#4C5A70",accent:"#2E7FD1",success:"#2F8F60",warning:"#B57A12",danger:"#C2453F",info:"#5B7A99"}},Hp=["primary","accent","success","warning","danger","info"],tc="voodoo:palette",Lp="voodoo-palette",Hy="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif",Ny="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace";function Mp(e,t){let n=(e!=null?e:"").trim();return n?n.includes(",")?n:`${/^['"]/.test(n)?n:`'${n}'`}, ${t}`:t}var Oy=/^([\d.]+)(px|rem|em)$/;function Fy(e){let t=(e||"12px").trim(),n=Oy.exec(t);if(!n)return{"--v-radius":t,"--v-radius-sm":`calc(${t} * 0.6)`,"--v-radius-lg":`calc(${t} * 1.5)`,"--v-radius-xl":`calc(${t} * 2)`,"--v-radius-full":"999px"};let r=parseFloat(n[1]),o=n[2],i=s=>`${Math.round(s*1e3)/1e3}${o}`;return{"--v-radius":i(r),"--v-radius-sm":i(Math.max(r*.55,0)),"--v-radius-lg":i(r*1.5),"--v-radius-xl":i(r*2),"--v-radius-full":"999px"}}function Sp(e,t){var c,d,u,f;let n={},r={},o={};for(let p of Hp){let m=(c=wt(e[p]))!=null?c:ps,h=fs(m),v=Pp(m,t);r[p]=v;for(let O of ec)n[`--v-${p}-${O}`]=v[String(O)];let g=t?{l:Math.max(h.l,.62),c:h.c*.95,h:h.h}:h,b=t?{l:Math.min(g.l+.07,.94),c:g.c*.95,h:g.h}:{l:Math.max(g.l-.055,.12),c:g.c,h:g.h},x=t?{l:Math.min(g.l+.13,.97),c:g.c*.88,h:g.h}:{l:Math.max(g.l-.105,.1),c:g.c,h:g.h},T=br(g),E=br(b),C=br(x);n[`--v-${p}`]=Ln(t?T:m),n[`--v-${p}-hover`]=Ln(E),n[`--v-${p}-active`]=Ln(C),n[`--v-${p}-contrast`]=bo(t?T:m),n[`--v-${p}-contrast-hover`]=bo(E),n[`--v-${p}-contrast-active`]=bo(C);let D=v[50],A=v[100],se=t?v[800]:v[700];n[`--v-${p}-soft`]=D,n[`--v-${p}-soft-hover`]=A,n[`--v-${p}-soft-text`]=se,n[`--v-${p}-ring`]=gr(T,t?.45:.32),n[`--v-${p}-border`]=t?v[300]:v[200],o[p]=n[`--v-${p}-contrast`]}let i=(u=wt((d=e.neutral)!=null?d:e.primary))!=null?u:ps,s=fs(i).h,a=(p,m)=>Ap({l:p,c:m,h:s}),l={};if(ec.forEach((p,m)=>{let h=t?Dp:$p;l[String(p)]=a(h[m],.012),n[`--v-neutral-${p}`]=l[String(p)]}),r.neutral=l,t)n["--v-surface"]=a(.248,.021),n["--v-surface-2"]=a(.196,.021),n["--v-surface-3"]=a(.305,.024),n["--v-surface-inset"]=a(.17,.02),n["--v-text"]=a(.965,.008),n["--v-text-muted"]=a(.748,.017),n["--v-text-soft"]=a(.63,.017),n["--v-border"]=a(.355,.023),n["--v-border-strong"]=a(.46,.026),n["--v-overlay"]="rgba(0, 0, 0, 0.62)",n["--v-shadow-sm"]="0 1px 2px rgba(0, 0, 0, 0.5)",n["--v-shadow"]="0 10px 30px rgba(0, 0, 0, 0.5)",n["--v-shadow-lg"]="0 24px 60px rgba(0, 0, 0, 0.62)";else{let p=br({l:.24,c:.028,h:s});n["--v-surface"]=a(1,0),n["--v-surface-2"]=a(.981,.006),n["--v-surface-3"]=a(.955,.009),n["--v-surface-inset"]=a(.968,.008),n["--v-text"]=Ln(p),n["--v-text-muted"]=a(.53,.023),n["--v-text-soft"]=a(.655,.018),n["--v-border"]=a(.906,.012),n["--v-border-strong"]=a(.828,.016),n["--v-overlay"]=gr(p,.45),n["--v-shadow-sm"]=`0 1px 2px ${gr(p,.08)}`,n["--v-shadow"]=`0 10px 30px ${gr(p,.14)}`,n["--v-shadow-lg"]=`0 24px 60px ${gr(p,.2)}`}return n["--v-focus-ring"]=n["--v-primary-ring"],o.surface=bo((f=wt(n["--v-surface"]))!=null?f:Rp),{vars:n,scales:r,contrast:o}}function Ql(e,t){let n=Object.entries(t).map(([r,o])=>`  ${r}: ${o};`).join(`
`);return`${e} {
${n}
}`}var xo=null,yo=null;function Iy(e){var r,o,i,s,a,l,c,d,u;let t=(r=ms[e.preset])!=null?r:ms.violeta,n={primary:(o=e.primary)!=null?o:t.primary,accent:(i=e.accent)!=null?i:t.accent,success:(s=e.success)!=null?s:t.success,warning:(a=e.warning)!=null?a:t.warning,danger:(l=e.danger)!=null?l:t.danger,info:(c=e.info)!=null?c:t.info,neutral:(d=e.neutral)!=null?d:t.neutral};for(let f of Hp)wt(n[f])||(console.warn(`[Voodoo] invalid color in palette.${f}: "${n[f]}". Using preset.`),n[f]=t[f]);return{colors:n,radius:(u=e.radius)!=null?u:"12px",font:Mp(e.font,Hy),mono:Mp(e.monoFont,Ny)}}function zy(e){if(typeof document=="undefined"||!w.injectStyles)return;ge();let t=document.getElementById(Lp);t||(t=document.createElement("style"),t.id=Lp,t.setAttribute("data-voodoo","palette"),document.head.appendChild(t)),t.textContent=e}function us(e={}){let{colors:t,radius:n,font:r,mono:o}=Iy(e),i=Sp(t,!1),s=Sp(t,!0),a={...Fy(n),"--v-font-sans":r,"--v-font-mono":o},l=["/* Palette generated by V.palette(). Do not edit manually. */",Ql(":root",{...a,...i.vars}),`@media (prefers-color-scheme: dark) {
${Ql(':root:not([data-theme="light"])',s.vars)}
}`,Ql(':root[data-theme="dark"]',s.vars)].join(`
`);zy(l);let c={colors:t,radius:n,font:r,monoFont:o,light:i.scales,dark:s.scales,contrast:i.contrast,css:l};if(xo=c,yo={...e},e.persist!==!1&&typeof document!="undefined"){let d={...e};delete d.persist,fe.set(tc,d)}return typeof document!="undefined"&&document.dispatchEvent(new CustomEvent("voodoo:palette",{detail:c})),c}var Cp=!1;function nc(){if(xo&&Cp)return xo;Cp=!0;let e=fe.get(tc),t=e&&typeof e=="object"?{...e,persist:!1}:{persist:!1};return us(t)}function wo(){xo||nc()}function rc(){return nc()}var Np=Object.assign(us,{presets:ms,get names(){return Object.keys(ms)},get current(){return xo},get options(){return yo},init:nc,ensure:wo,reset(){return fe.remove(tc),us({persist:!1})},use(e){return us({...yo!=null?yo:{},preset:e,primary:void 0,accent:void 0})},scale:Pp,contrastText:bo,contrastRatio:Zl,luminance(e){let t=typeof e=="string"?wt(e):e;return t?Jl(t):0},convert:{parseColor:wt,rgbToOklch:fs,oklchToRgb:br,toHex:Ln,toRgba:gr}});function re(e){if(e===!0)return!0;if(e===!1||e===null||e===void 0)return!1;if(typeof e=="number")return e!==0;let t=String(e).trim().toLowerCase();return t===""||t==="true"||t==="1"||t==="yes"}function be(...e){let t={};for(let n of e){let r=`is${n.charAt(0).toUpperCase()}${n.slice(1)}`;t[r]=function(){return re(this[n])}}return t}var F={type:"any",default:!1},L={type:"string",default:""};function xr(e,t){var i;if(t==null||typeof t!="string")return t;let n=t.trim();if(!n)return null;if(n.startsWith("[")||n.startsWith("{"))try{return JSON.parse(n)}catch(s){return null}let r=n.split(/[.[(]/)[0].trim();if(!/^[A-Za-z_$][\w$]*$/.test(r))return null;let o=(i=e.$scope)==null?void 0:i.parent;return!o||!o.has(r)?null:q(n,o,"list attribute")}function Eo(e){return String(e).split(",").map(t=>t.trim()).filter(Boolean)}function Zt(e,t){let n=e.$el;Object.defineProperty(n,"value",{configurable:!0,enumerable:!1,get:t.get,set:t.set})}function ko(e){e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))}var Ip={check:'<path d="m5 12.5 4.4 4.4L19 7.6"/>',x:'<path d="M6 6l12 12M18 6 6 18"/>',plus:'<path d="M12 5v14M5 12h14"/>',minus:'<path d="M5 12h14"/>',search:'<circle cx="11" cy="11" r="6.5"/><path d="m16 16 4 4"/>',"chevron-down":'<path d="m6 9.5 6 6 6-6"/>',"chevron-up":'<path d="m6 14.5 6-6 6 6"/>',"chevron-left":'<path d="m14.5 6-6 6 6 6"/>',"chevron-right":'<path d="m9.5 6 6 6-6 6"/>',"arrow-up":'<path d="M12 19V5M6 11l6-6 6 6"/>',"arrow-down":'<path d="M12 5v14M6 13l6 6 6-6"/>',"arrow-right":'<path d="M5 12h14M13 6l6 6-6 6"/>',"arrow-left":'<path d="M19 12H5M11 6l-6 6 6 6"/>',user:'<circle cx="12" cy="8.5" r="3.6"/><path d="M4.8 20a7.4 7.4 0 0 1 14.4 0"/>',users:'<circle cx="9.5" cy="8.5" r="3.2"/><path d="M3.4 19.5a6.4 6.4 0 0 1 12.2 0M16 5.6a3.2 3.2 0 0 1 0 5.9M17.4 14.4a6.4 6.4 0 0 1 3.2 5.1"/>',mail:'<rect x="3" y="5" width="18" height="14" rx="2.5"/><path d="m3.8 7 8.2 6 8.2-6"/>',lock:'<rect x="4.5" y="10.5" width="15" height="9.5" rx="2.4"/><path d="M8 10.5V8a4 4 0 0 1 8 0v2.5"/>',eye:'<path d="M2.6 12S6.4 5.8 12 5.8 21.4 12 21.4 12 17.6 18.2 12 18.2 2.6 12 2.6 12Z"/><circle cx="12" cy="12" r="2.8"/>',"eye-off":'<path d="M4 4l16 16M9.9 6.2A9.3 9.3 0 0 1 12 6c5.6 0 9.4 6 9.4 6a17 17 0 0 1-3.3 3.9M6.3 8.2A17 17 0 0 0 2.6 12S6.4 18 12 18c1 0 1.9-.2 2.7-.5"/>',calendar:'<rect x="3.5" y="5" width="17" height="15" rx="2.4"/><path d="M8 3v4M16 3v4M3.5 10h17"/>',clock:'<circle cx="12" cy="12" r="8.6"/><path d="M12 7.4V12l3 1.8"/>',star:'<path d="m12 4 2.5 5.2 5.5.8-4 3.9 1 5.6-5-2.7-5 2.7 1-5.6-4-3.9 5.5-.8z"/>',info:'<circle cx="12" cy="12" r="8.6"/><path d="M12 11v5.2M12 7.6v.2"/>',alert:'<circle cx="12" cy="12" r="8.6"/><path d="M12 7.5v5M12 16.4v.2"/>',warning:'<path d="M12 4.4 2.8 19.6h18.4z"/><path d="M12 10v3.8M12 16.9v.2"/>',trash:'<path d="M4.5 7h15M9.5 7V5.2A1.2 1.2 0 0 1 10.7 4h2.6a1.2 1.2 0 0 1 1.2 1.2V7M6.6 7l.8 12a1.6 1.6 0 0 0 1.6 1.5h6a1.6 1.6 0 0 0 1.6-1.5l.8-12"/>',edit:'<path d="M4.5 19.5h4l10-10a2.1 2.1 0 0 0-3-3l-10 10z"/><path d="M14 6.5 17.5 10"/>',copy:'<rect x="8.5" y="8.5" width="11.5" height="11.5" rx="2.2"/><path d="M15.5 5.5A1.5 1.5 0 0 0 14 4H6a2 2 0 0 0-2 2v8a1.5 1.5 0 0 0 1.5 1.5"/>',download:'<path d="M12 4v11M7.5 11 12 15.5 16.5 11M4.5 19.5h15"/>',upload:'<path d="M12 20V8.5M7.5 12.5 12 8l4.5 4.5M4.5 4.5h15"/>',settings:'<circle cx="12" cy="12" r="3.1"/><path d="M19.6 14.4a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.03 1.56V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.56 1.7 1.7 0 0 0-1.87.34l-.06.06A2 2 0 1 1 4.15 16.9l.06-.06a1.7 1.7 0 0 0 .34-1.87A1.7 1.7 0 0 0 3 13.94H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.55-1.1 1.7 1.7 0 0 0-.34-1.87l-.06-.06A2 2 0 1 1 7.08 4.08l.06.06a1.7 1.7 0 0 0 1.87.34H9a1.7 1.7 0 0 0 1-1.56V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.56 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87V10a1.7 1.7 0 0 0 1.56 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.3 1z"/>',home:'<path d="M4 10.5 12 4l8 6.5V19a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 19z"/><path d="M9.6 20.5v-6h4.8v6"/>',heart:'<path d="M12 20s-7.5-4.6-7.5-9.4A4.1 4.1 0 0 1 12 8.2a4.1 4.1 0 0 1 7.5 2.4C19.5 15.4 12 20 12 20Z"/>',bell:'<path d="M18 9a6 6 0 1 0-12 0c0 5.2-2 6.5-2 6.5h16S18 14.2 18 9"/><path d="M13.7 19.5a2 2 0 0 1-3.4 0"/>',filter:'<path d="M4 5.5h16l-6.2 7.3v5.3l-3.6 2v-7.3z"/>',external:'<path d="M14 4.5h5.5V10M19 5l-8 8"/><path d="M18 13.5V18a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 18V7.5A1.5 1.5 0 0 1 6 6h4.5"/>',refresh:'<path d="M20 11a8 8 0 0 0-13.7-4.8L4 8.4"/><path d="M4 4.5v4h4M4 13a8 8 0 0 0 13.7 4.8L20 15.6"/><path d="M20 19.5v-4h-4"/>',folder:'<path d="M4 7.5A1.5 1.5 0 0 1 5.5 6h3.7l2 2.4h7.3A1.5 1.5 0 0 1 20 9.9v7.6a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5z"/>',file:'<path d="M13.5 4H7a1.5 1.5 0 0 0-1.5 1.5v13A1.5 1.5 0 0 0 7 20h10a1.5 1.5 0 0 0 1.5-1.5V9z"/><path d="M13.5 4v5h5"/>',image:'<rect x="4" y="5" width="16" height="14" rx="2.2"/><circle cx="9" cy="10" r="1.7"/><path d="m5 17 4.6-4.3 3.4 3 2.6-2.3L19 17"/>',link:'<path d="M10.6 13.4a3.6 3.6 0 0 0 5.1 0l2.4-2.4a3.6 3.6 0 0 0-5.1-5.1l-1.3 1.3"/><path d="M13.4 10.6a3.6 3.6 0 0 0-5.1 0l-2.4 2.4a3.6 3.6 0 0 0 5.1 5.1l1.3-1.3"/>',menu:'<path d="M4 7h16M4 12h16M4 17h16"/>',more:'<circle cx="6" cy="12" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="18" cy="12" r="1.4"/>',logout:'<path d="M14.5 8V6a1.5 1.5 0 0 0-1.5-1.5H6A1.5 1.5 0 0 0 4.5 6v12A1.5 1.5 0 0 0 6 19.5h7a1.5 1.5 0 0 0 1.5-1.5v-2"/><path d="M9.5 12h10.5M16.5 8.5 20 12l-3.5 3.5"/>',card:'<rect x="3" y="6" width="18" height="12" rx="2.4"/><path d="M3 10h18"/>',chart:'<path d="M4.5 19.5h15"/><path d="M7.5 19.5V11M12 19.5V5.5M16.5 19.5v-6"/>',box:'<path d="M20 8.6 12 4 4 8.6v6.8L12 20l8-4.6z"/><path d="m4 8.6 8 4.6 8-4.6M12 13.2V20"/>',inbox:'<path d="M4 13.5h4l1.4 2.4h5.2l1.4-2.4h4"/><path d="M4.6 13.5 7 5.6A1.5 1.5 0 0 1 8.5 4.5h7A1.5 1.5 0 0 1 17 5.6l2.4 7.9V18a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 18z"/>'};function By(e){let t=String(e!=null?e:"").trim();if(!t)return"";let n=Ip[t];return n?`<svg class="v-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${n}</svg>`:""}var jy=`
...
`,Op=!1;function qy(){Op||(Op=!0,ge(),wo(),Z("components",jy))}function ie(e,t){var r;let n=t.beforeMount;t.methods={svgIcon:o=>By(o),hasFlag:o=>re(o),...(r=t.methods)!=null?r:{}},t.beforeMount=function(){qy(),n==null||n.call(this)},jt(e,t)}ie("v-button",{props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},icon:L,iconRight:L,type:{type:"string",default:"button"},loading:F,disabled:F,block:F,rounded:F,ariaLabel:L},computed:{...be("loading","disabled","block","rounded"),blocked(){return re(this.disabled)||re(this.loading)}},template:`
  ...
  `});var Uy={info:"info",primary:"info",success:"check",warning:"warning",danger:"alert",neutral:"info"};ie("v-alert",{props:{tone:{type:"string",default:"info"},title:L,icon:L,closable:F,closeLabel:{type:"string",default:"Close alert"}},state(){return{visible:!0}},computed:{...be("closable"),resolvedIcon(){return this.icon==="none"?"":this.icon||Uy[this.tone]||"info"},liveRole(){return this.tone==="danger"?"alert":"status"}},methods:{dismiss(){this.visible=!1,this.emit("close")}},template:`
  ...
  `});function _y(e){return Array.isArray(e)?e.map(t=>{var r,o,i,s,a,l;if(t!=null&&typeof t=="object"){let c=t,d=String((i=(o=(r=c.key)!=null?r:c.field)!=null?o:c.name)!=null?i:"");return{key:d,label:String((a=(s=c.label)!=null?s:c.title)!=null?a:jr(d)),align:String((l=c.align)!=null?l:"left"),sortable:c.sortable===void 0?!0:re(c.sortable)}}let n=String(t);return{key:n,label:jr(n),align:"left",sortable:!0}}):typeof e!="string"?[]:Eo(e).map(t=>{let n=t.split(":").map(o=>o.trim()),r=n[0];return{key:r,label:n[1]||jr(r),align:n[2]||"left",sortable:n[3]!=="fixed"}})}ie("v-table",{inheritScope:!0,props:{columns:{type:"any",default:""},rows:{type:"any",default:""},empty:{type:"string",default:"No records found"},sortable:{type:"any",default:!0},dense:F,striped:F,hover:{type:"any",default:!0},caption:L},state(){return{sortKey:"",sortDir:"asc"}},computed:{...be("dense","striped"),isSortable(){return this.sortable===!0||re(this.sortable)},isHover(){return this.hover===!0||re(this.hover)},cols(){var e;return _y((e=xr(this,this.columns))!=null?e:this.columns)},allRows(){var t;let e=(t=xr(this,this.rows))!=null?t:this.rows;return Array.isArray(e)?e:[]},sorted(){let e=this.sortKey;if(!e||!this.isSortable)return this.allRows;let t=this.sortDir==="desc"?-1:1;return[...this.allRows].sort((n,r)=>{let o=Br(n,e),i=Br(r,e);return o==null&&i==null?0:o==null?-t:i==null?t:typeof o=="number"&&typeof i=="number"?(o-i)*t:String(o).localeCompare(String(i),w.locale,{numeric:!0})*t})}},methods:{cell(e,t,n){let r=Array.isArray(e)&&typeof n=="number"?e[n]:Br(e,t.key);return r==null?"":String(r)},ariaSort(e){return!this.isSortable||!e.sortable?null:this.sortKey!==e.key?"none":this.sortDir==="asc"?"ascending":"descending"},canSort(e){return this.isSortable&&e.sortable},arrowFor(e){return this.sortKey!==e.key?"chevron-down":this.sortDir==="asc"?"chevron-up":"chevron-down"},toggleSort(e){this.canSort(e)&&(this.sortKey===e.key?this.sortDir=this.sortDir==="asc"?"desc":"asc":(this.sortKey=e.key,this.sortDir="asc"),this.emit("sort",{key:this.sortKey,direction:this.sortDir}))},alignStyle(e){return{textAlign:e.align}}},template:`
  ...
  `});function Wy(e){return Array.isArray(e)?e.map(t=>{var n,r,o,i,s,a;if(t!=null&&typeof t=="object"){let l=t;return{label:String((o=(r=(n=l.label)!=null?n:l.text)!=null?r:l.title)!=null?o:""),href:String((a=(s=(i=l.href)!=null?i:l.url)!=null?s:l.to)!=null?a:"")}}return{label:String(t),href:""}}):typeof e!="string"?[]:Eo(e).map(t=>{let n=t.indexOf(":");return n===-1?{label:t,href:""}:{label:t.slice(0,n).trim(),href:t.slice(n+1).trim()}})}ie("v-breadcrumb",{inheritScope:!0,props:{items:{type:"any",default:""},separator:{type:"string",default:"/"},ariaLabel:{type:"string",default:"Breadcrumb"}},computed:{crumbs(){var e;return Wy((e=xr(this,this.items))!=null?e:this.items)}},methods:{isLast(e){return e===this.crumbs.length-1}},template:`
  ...
  `});ie("v-steps",{inheritScope:!0,props:{steps:{type:"any",default:""},current:{type:"number",default:0},vertical:F,ariaLabel:{type:"string",default:"Steps"}},computed:{...be("vertical"),list(){var t;let e=(t=xr(this,this.steps))!=null?t:this.steps;return Array.isArray(e)?e.map(n=>{var r,o;return n!=null&&typeof n=="object"?String((o=(r=n.label)!=null?r:n.title)!=null?o:""):String(n)}):typeof e=="string"?Eo(e):[]},currentIndex(){let e=Number(this.current);return Number.isFinite(e)?Math.max(0,Math.round(e)):0}},methods:{stateOf(e){return e<this.currentIndex?"done":e===this.currentIndex?"current":"todo"}},template:`
  ...
  `});async function Yy(e){try{if(typeof navigator!="undefined"&&navigator.clipboard)return await navigator.clipboard.writeText(e),!0}catch(t){}try{let t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();let n=document.execCommand("copy");return t.remove(),n}catch(t){return!1}}ie("v-code-block",{props:{code:L,language:L,filename:L,copyLabel:{type:"string",default:"Copy"},copiedLabel:{type:"string",default:"Copied"},wrap:F},state(){return{copied:!1}},computed:{...be("wrap"),header(){return this.filename||this.language||""},buttonLabel(){return this.copied?this.copiedLabel:this.copyLabel},buttonIcon(){return this.copied?"check":"copy"}},methods:{async copy(){let e=this.$refs.code,t=this.code||(e==null?void 0:e.textContent)||"";await Yy(String(t))&&(this.copied=!0,this.emit("copy",t),setTimeout(()=>{this.copied=!1},1800))}},template:`
  ...
  `});var Wk=Object.keys(Ip);Ae();ce();var dt={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},sc={duration:220,size:"md"},Xy=`
...
`;function bs(){ge(),wo(),Z("dialog",Xy)}var ac={info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.6v.2"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m8.2 12.3 2.6 2.6 5-5.2"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4.6 2.9 19.4h18.2z"/><path d="M12 10v4M12 17.2v.2"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/></svg>',question:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M9.6 9.4a2.4 2.4 0 1 1 3.2 2.3c-.6.2-.8.7-.8 1.3v.5M12 16.6v.2"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg>'},nt=[],lc=new WeakMap,cc=0,zp="",Bp="";function Gy(){if(cc++>0)return;let e=document.body;zp=e.style.overflow,Bp=e.style.paddingRight;let t=window.innerWidth-document.documentElement.clientWidth;if(e.style.overflow="hidden",t>0){let n=parseFloat(getComputedStyle(e).paddingRight)||0;e.style.paddingRight=`${n+t}px`}}function Qy(){cc!==0&&(--cc>0||(document.body.style.overflow=zp,document.body.style.paddingRight=Bp))}var Jy='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function dc(e){return Array.from(e.querySelectorAll(Jy)).filter(t=>t.hasAttribute("disabled")||t.getAttribute("aria-hidden")==="true"?!1:t.offsetWidth>0||t.offsetHeight>0||t.getClientRects().length>0)}function uc(){return nt[nt.length-1]}function Zy(){return typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches}var gs=!1;function jp(e){let t=uc();if(!t)return;if(e.key==="Escape"){if(t.options.closeOnEscape===!1)return;e.preventDefault(),t.handle.close(void 0);return}if(e.key!=="Tab")return;let n=dc(t.handle.panel);if(!n.length){e.preventDefault(),t.handle.panel.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;e.shiftKey&&(i===r||!t.handle.panel.contains(i))?(e.preventDefault(),o.focus()):!e.shiftKey&&i===o&&(e.preventDefault(),r.focus())}function qp(e){var o;let t=uc();if(!t)return;let n=e.target;if(n&&t.handle.root.contains(n))return;((o=dc(t.handle.panel)[0])!=null?o:t.handle.panel).focus()}function ex(){gs||(gs=!0,document.addEventListener("keydown",jp,!0),document.addEventListener("focusin",qp,!0))}function tx(){gs&&(gs=!1,document.removeEventListener("keydown",jp,!0),document.removeEventListener("focusin",qp,!0))}function Vp(e){var f,p,m,h,v,g,b;bs();let t=le("v-dialog-"),n=Zy()?0:sc.duration,r=document.createElement("div");r.className="v-dialog-root",r.id=t,r.setAttribute("data-size",(f=e.size)!=null?f:sc.size),r.setAttribute("data-position",(p=e.position)!=null?p:"center"),r.style.setProperty("--v-dialog-ms",`${n}ms`),r.style.setProperty("--v-dialog-layer",String(nt.length*2));let o=document.createElement("div");o.className="v-dialog-backdrop",r.appendChild(o);let i=document.createElement("div");i.className="v-dialog-panel",e.plain&&i.classList.add("is-plain"),e.className&&i.classList.add(...e.className.split(/\s+/).filter(Boolean)),i.setAttribute("role",(m=e.role)!=null?m:"dialog"),i.setAttribute("aria-modal","true"),i.tabIndex=-1,e.labelledBy?i.setAttribute("aria-labelledby",e.labelledBy):e.ariaLabel&&i.setAttribute("aria-label",e.ariaLabel),e.describedBy&&i.setAttribute("aria-describedby",e.describedBy),r.appendChild(i);let s=document.createElement("div");if(s.className="v-dialog-body",e.source){let x=document.createComment(" v-modal ");(h=e.source.parentNode)==null||h.insertBefore(x,e.source),oc.set(e.source,x),e.source.classList.add("v-dialog-open"),e.source.removeAttribute("hidden"),s.appendChild(e.source)}else e.content&&s.appendChild(e.content);if(i.appendChild(s),e.closable!==!1){let x=document.createElement("button");x.type="button",x.className="v-dialog-x",x.setAttribute("aria-label",dt.close),x.innerHTML=ac.close,x.addEventListener("click",()=>d.close(void 0)),i.appendChild(x)}let a=!1,l=()=>{},c=new Promise(x=>{l=x}),d={id:t,root:r,panel:i,body:s,key:(v=e.key)!=null?v:null,source:(g=e.source)!=null?g:null,closed:c,close(x){if(a)return;a=!0;let T=nt.findIndex(C=>C.handle===d);T>-1&&nt.splice(T,1),lc.delete(r),u.locked&&Qy(),nt.length||tx(),r.classList.remove("is-open"),r.classList.add("is-closing");let E=()=>{var D;let C=e.source;if(C){let A=oc.get(C);C.classList.remove("v-dialog-open"),A&&A.parentNode?(A.parentNode.insertBefore(C,A),A.remove()):C.remove(),oc.delete(C),aa(C,"modal-content")&&C.setAttribute("hidden","")}if(r.remove(),(D=e.onClose)==null||D.call(e,x,d),l(x),e.restoreFocus!==!1){let A=u.previousFocus;A&&typeof A.focus=="function"&&A.isConnected&&A.focus()}};n>0?setTimeout(E,n):E()}},u={handle:d,options:e,previousFocus:document.activeElement,locked:e.lockScroll!==!1};return o.addEventListener("click",()=>{e.closeOnBackdrop!==!1&&d.close(void 0)}),u.locked&&Gy(),nt.push(u),lc.set(r,u),ex(),document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add("is-open");let x=nx(e,i);x==null||x.focus()}),(b=e.onOpen)==null||b.call(e,d),d}var oc=new WeakMap;function nx(e,t){var i;let n=e.initialFocus;if(n instanceof HTMLElement)return n;if(typeof n=="string"){let s=t.querySelector(n);if(s)return s}let r=t.querySelector("[autofocus],[data-autofocus]");return r||((i=dc(t)[0])!=null?i:t)}function rx(e){if(e instanceof HTMLElement)return e;let t=String(e!=null?e:"").trim();if(!t)return null;let n=/^[\w-]+$/.test(t)?`#${t}`:t;return document.querySelector(n)}function vs(e){return typeof e=="string"?e.trim()||null:e.id?`#${e.id}`:null}function hs(e){let t=/^[\w-]+$/.test(e)?`#${e}`:e;return nt.find(n=>{var o;if(n.handle.key===e||n.handle.key===t)return!0;let r=n.handle.source;return!!r&&((o=r.matches)==null?void 0:o.call(r,t))})}var Mn={open(e,t={}){var s,a;let n=rx(e);if(!n)return console.warn(`[Voodoo] modal.open: target not found (${String(e)}).`),null;let r=(s=vs(e))!=null?s:n.id?`#${n.id}`:null,o=r?hs(r):void 0;if(o)return o.handle;let i=n.querySelector("[data-dialog-title],h1,h2,h3");return i&&!i.id&&(i.id=le("v-dialog-title-")),Vp({...t,source:n,key:r,labelledBy:(a=i==null?void 0:i.id)!=null?a:null})},close(e,t){var o;if(e===void 0){(o=uc())==null||o.handle.close(t);return}let n=vs(e),r=n?hs(n):void 0;r==null||r.handle.close(t)},closeAll(e){for(let t of[...nt].reverse())t.handle.close(e)},toggle(e,t={}){let n=vs(e),r=n?hs(n):void 0;return r?(r.handle.close(void 0),null):this.open(e,t)},isOpen(e){if(e===void 0)return nt.length>0;let t=vs(e);return!!(t&&hs(t))},get opened(){return nt.map(e=>e.handle)},get count(){return nt.length},configure(e){Object.assign(sc,e)},labels(e){return Object.assign(dt,e),dt}};function wr(e){var a,l;bs();let t=document.createDocumentFragment(),n=e.title?le("v-dialog-title-"):null,r=e.description?le("v-dialog-desc-"):null,o=null;if(e.title||e.description||e.icon){o=document.createElement("div"),o.className="v-dialog-head";let c=e.icon&&e.icon!=="none"?e.icon:null;if(c&&ac[c]){let u=document.createElement("div");u.className="v-dialog-icon",u.setAttribute("aria-hidden","true"),u.setAttribute("data-tone",(a=e.tone)!=null?a:ox(c)),u.innerHTML=ac[c],o.appendChild(u)}let d=document.createElement("div");if(d.className="v-dialog-heading",e.title){let u=document.createElement("h2");u.className="v-dialog-title",u.id=n,u.textContent=e.title,d.appendChild(u)}if(e.description){let u=document.createElement("p");u.className="v-dialog-desc",u.id=r,u.textContent=e.description,d.appendChild(u)}o.appendChild(d)}let i=document.createDocumentFragment();if(e.text)for(let c of e.text.split(`
`)){let d=document.createElement("p");d.textContent=c,i.appendChild(d)}if(e.html){let c=document.createElement("div");for(c.innerHTML=e.html;c.firstChild;)i.appendChild(c.firstChild)}e.node&&i.appendChild(e.node),t.appendChild(i);let s=(l=e.buttons)!=null?l:[{label:dt.ok,value:!0,variant:"primary",autofocus:!0}];return new Promise(c=>{var u;let d=Vp({...e,content:t,role:e.tone==="danger"?"alertdialog":"dialog",labelledBy:n,describedBy:r,key:null,onClose(f){var p;(p=e.onClose)==null||p.call(e,f,d),c(f===void 0?null:f)}});if(o&&d.panel.insertBefore(o,d.body),s.length){let f=document.createElement("div");f.className="v-dialog-foot";for(let p of s){let m=document.createElement("button");m.type="button",m.className="v-dlg-btn",m.setAttribute("data-variant",(u=p.variant)!=null?u:"secondary"),m.textContent=p.label,p.autofocus&&m.setAttribute("data-autofocus",""),m.addEventListener("click",()=>{var v,g;((v=p.onClick)==null?void 0:v.call(p,d))!==!1&&p.close!==!1&&d.close((g=p.value)!=null?g:null)}),f.appendChild(m)}d.panel.appendChild(f)}d.body.childNodes.length||d.body.remove()})}function ox(e){return e==="success"||e==="warning"||e==="danger"?e:"default"}function fc(e,t={}){var n;return wr({icon:"info",size:"sm",...t,text:e,buttons:[{label:(n=t.confirmLabel)!=null?n:dt.ok,value:!0,variant:t.tone==="danger"?"danger":"primary",autofocus:!0}]}).then(()=>{})}function ys(e,t={}){var r,o,i;let n=t.danger?"danger":(r=t.tone)!=null?r:"default";return wr({icon:n==="danger"?"warning":"question",size:"sm",...t,tone:n,text:e,buttons:[{label:(o=t.cancelLabel)!=null?o:dt.cancel,value:!1,variant:"secondary"},{label:(i=t.confirmLabel)!=null?i:dt.confirm,value:!0,variant:n==="danger"?"danger":"primary",autofocus:!0}]}).then(s=>s===!0)}function pc(e,t={}){var m,h,v,g;bs();let n=(m=t.type)!=null?m:"text",r=le("v-prompt-"),o=`${r}-hint`,i=`${r}-error`,s=document.createElement("div");s.className="v-dialog-field";let a=document.createElement("label");a.className="v-dialog-label",a.htmlFor=r,a.textContent=e,s.appendChild(a);let l=n==="textarea"?document.createElement("textarea"):document.createElement("input");if(l.className="v-dialog-input",l.id=r,l instanceof HTMLInputElement&&(l.type=n==="textarea"?"text":n),l.value=(h=t.value)!=null?h:"",t.placeholder&&(l.placeholder=t.placeholder),t.required&&(l.required=!0),l.setAttribute("data-autofocus",""),s.appendChild(l),t.hint){let b=document.createElement("p");b.className="v-dialog-hint",b.id=o,b.textContent=t.hint,s.appendChild(b),l.setAttribute("aria-describedby",o)}let c=document.createElement("p");c.className="v-dialog-error",c.id=i,c.hidden=!0,c.setAttribute("role","alert"),s.appendChild(c);let d=()=>n==="number"?l.value.trim():l.value,u=b=>{var E,C;let x=d(),T=null;return t.required&&!x.trim()?T=dt.required:T=(C=(E=t.validate)==null?void 0:E.call(t,x))!=null?C:null,T?(c.textContent=T,c.hidden=!1,l.setAttribute("aria-invalid","true"),l.setAttribute("aria-describedby",i),l.focus(),!1):(c.hidden=!0,l.removeAttribute("aria-invalid"),b.close(x),!0)},f=null;return l.addEventListener("keydown",b=>{let x=b;x.key==="Enter"&&(n==="textarea"&&!x.ctrlKey&&!x.metaKey||(b.preventDefault(),f&&u(f)))}),wr({icon:"question",size:"sm",...t,node:s,text:void 0,buttons:[{label:(v=t.cancelLabel)!=null?v:dt.cancel,value:null,variant:"secondary"},{label:(g=t.confirmLabel)!=null?g:dt.confirm,variant:"primary",close:!1,onClick(b){return f=b,u(b),!1}}],onOpen(b){var x;f=b,(x=t.onOpen)==null||x.call(t,b)}}).then(b=>typeof b=="string"?b:null)}y("modal",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim();e.setAttribute("aria-haspopup","dialog");let i=s=>{if(s.preventDefault(),n.close){Mn.close(o||void 0);return}if(n.toggle){o&&Mn.toggle(o);return}o&&Mn.open(o)};e.addEventListener("click",i),r(()=>e.removeEventListener("click",i))});y("modal-content",({el:e})=>{bs(),e.id||(e.id=le("v-modal-")),e.classList.contains("v-dialog-open")||e.setAttribute("hidden","")},{priority:j.REF});y("modal-close",({el:e,expression:t,cleanup:n})=>{let r=o=>{o.preventDefault();let i=e.closest(".v-dialog-root"),s=i?lc.get(i):void 0;s?s.handle.close(t.trim()||void 0):Mn.close(void 0,t.trim()||void 0)};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});var ic=!1;y("confirm",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim()||dt.confirmQuestion,i=s=>{var u,f,p;if(ic)return;s.preventDefault(),s.stopImmediatePropagation();let a=s.target instanceof HTMLElement?s.target:e,l=(u=Te(e,`${w.prefix}confirm-title`))!=null?u:void 0,c=(f=Te(e,`${w.prefix}confirm-label`))!=null?f:void 0,d=(p=Te(e,`${w.prefix}confirm-cancel`))!=null?p:void 0;ys(o,{title:l,confirmLabel:c,cancelLabel:d,danger:!!n.danger,size:"sm"}).then(m=>{if(m){ic=!0;try{a.click()}finally{ic=!1}}})};e.addEventListener("click",i,!0),r(()=>e.removeEventListener("click",i,!0))},{priority:j.REF});N("$modal",()=>Mn);N("$dialog",()=>wr);N("$alert",()=>fc);N("$confirm",()=>ys);N("$prompt",()=>pc);de();ce();var Lo=new Map;function Le(e,t){Lo.set(e.trim().toLowerCase(),t)}var ix={9:/\d/,A:/[A-Za-zÀ-ÖØ-öø-ÿ]/,S:/[0-9A-Za-zÀ-ÖØ-öø-ÿ]/,"*":/[\s\S]/},sx=/[0-9A-Za-zÀ-ÖØ-öø-ÿ]/,Wp=new Set(["currency","percent"]);function Sn(e,t){let n="",r=0;for(let o=0;o<t.length;o++){let i=t[o];if(i==="\\"){let a=t[++o];if(a===void 0||r>=e.length)break;n+=a;continue}let s=ix[i];if(s){for(;r<e.length&&!s.test(e[r]);)r++;if(r>=e.length)break;n+=e[r++];continue}if(r>=e.length)break;e[r]===i&&r++,n+=i}return n}function ws(e,t={}){var h,v,g,b,x;let n=Math.max(0,Math.trunc((h=t.decimals)!=null?h:2)),r=(v=t.decimal)!=null?v:",",o=(g=t.thousands)!=null?g:".",i=(b=t.prefix)!=null?b:"R$ ",s=(x=t.suffix)!=null?x:"",a=String(e!=null?e:""),l=a.trim().startsWith("-"),c=a.replace(/\D/g,"").slice(0,15);if(!c)return"";let d=c.padStart(n+1,"0"),u=n?d.slice(0,d.length-n):d,f=n?d.slice(d.length-n):"",m=u.replace(/^0+(?=\d)/,"").replace(/\B(?=(\d{3})+(?!\d))/g,o);return`${l?"-":""}${i}${m}${n?r+f:""}${s}`}function Kp(e,t=2){return ws(e,{prefix:"",suffix:"%",decimals:t})}Le("cpf","999.999.999-99");Le("cnpj","99.999.999/9999-99");Le("cep","99999-999");Le("date","99/99/9999");Le("time","99:99");Le("datetime","99/99/9999 99:99");Le("cvv","9999");Le("cpfcnpj",e=>{let t=e.replace(/\D/g,"");return Sn(t,t.length<=11?"999.999.999-99":"99.999.999/9999-99")});Le("phone",e=>{let t=e.replace(/\D/g,"").slice(0,11);return Sn(t,t.length<=10?"(99) 9999-9999":"(99) 99999-9999")});Le("currency",e=>ws(e));Le("percent",e=>Kp(e));Le("card",e=>{let t=e.replace(/\D/g,"").slice(0,19);return/^3[47]/.test(t)?Sn(t,"9999 999999 99999"):t.length>16?Sn(t,"9999 9999 9999 9999 999"):Sn(t,"9999 9999 9999 9999")});Le("plate",e=>{let t=e.replace(/[^0-9A-Za-z]/g,"").toUpperCase().slice(0,7),n=t.length>=5&&/\d/.test(t[4]);return Sn(t,n?"AAA-9999":"AAA9A99")});Le("hex",e=>{let t=e.replace(/[^0-9a-fA-F]/g,"").toUpperCase().slice(0,6);return t?`#${t}`:""});Le("ip",e=>{let t=e.replace(/[^\d.]/g,"").split(".").slice(0,4),n=[];for(let r of t){if(r===""){n.push("");continue}let o=Math.min(255,Number(r.slice(0,3)));n.push(String(o))}return n.join(".")});function To(e,t){let n=e==null?"":String(e);if(!t)return n;let r=Lo.get(t.trim().toLowerCase());return typeof r=="function"?r(n):Sn(n,typeof r=="string"?r:t)}function ks(e,t){let n=e==null?"":String(e),r=t?t.trim().toLowerCase():"";if(r&&Wp.has(r)){let o=n.trim().startsWith("-"),i=n.replace(/\D/g,"").replace(/^0+(?=\d)/,"");if(!i)return"";let s=i.padStart(3,"0"),a=`${s.slice(0,s.length-2)}.${s.slice(s.length-2)}`;return o?`-${a}`:a}return n.replace(/[^0-9A-Za-zÀ-ÖØ-öø-ÿ]/g,"")}var Yp=Object.assign((e,t)=>To(e,t),{apply:To,unmask:ks,register:Le,currency:ws,percent:Kp,presets:Lo});function xs(e){return e!==void 0&&sx.test(e)}function Up(e,t){let n=0,r=Math.min(t,e.length);for(let o=0;o<r;o++)xs(e[o])&&n++;return n}function _p(e,t){if(t<=0)return 0;let n=0;for(let r=0;r<e.length;r++)if(xs(e[r])&&(n++,n===t))return r+1;return e.length}var mc=new WeakSet;function Xp(e,t,n){var m;if(mc.has(e))return;mc.add(e);let r=Object.getPrototypeOf(e),o=(m=Object.getOwnPropertyDescriptor(r,"value"))!=null?m:Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value"),i=o==null?void 0:o.get,s=o==null?void 0:o.set,a=()=>{var h;return String(i?i.call(e):(h=e.getAttribute("value"))!=null?h:"")},l=h=>{s?s.call(e,h):e.setAttribute("value",h)},c=h=>{try{e.setSelectionRange(h,h)}catch(v){}};i&&s&&(Object.defineProperty(e,"value",{configurable:!0,enumerable:!0,get(){let h=String(i.call(e));return t.clean?t.clean(h):h},set(h){s.call(e,t.format(h==null?"":String(h)))}}),n(()=>{let h=a();Reflect.deleteProperty(e,"value"),l(h)}));let d=()=>{var x,T;let h=a(),v=(x=e.selectionStart)!=null?x:h.length,g=Up(h,v),b=t.format(h);b!==h&&l(b),t.rightToLeft?c(Math.max(0,b.length-((T=t.suffixLength)!=null?T:0))):c(_p(b,g))},u=()=>d(),f=h=>{var C,D;if(h.key!=="Backspace")return;let v=(C=e.selectionStart)!=null?C:0,g=(D=e.selectionEnd)!=null?D:0;if(v!==g||v===0)return;let b=a();if(xs(b[v-1]))return;let x=v-1;for(;x>=0&&!xs(b[x]);)x--;if(h.preventDefault(),x<0)return;let T=b.slice(0,x)+b.slice(v),E=Up(T,x);l(t.format(T)),c(_p(a(),E)),e.dispatchEvent(new Event("input",{bubbles:!0}))};e.addEventListener("input",u),e.addEventListener("keydown",f),n(()=>{mc.delete(e),e.removeEventListener("input",u),e.removeEventListener("keydown",f)});let p=a();p&&l(t.format(p))}function Gp(e,t){if(e.tagName!=="INPUT"&&e.tagName!=="TEXTAREA")return X(`${w.prefix}${t} only works on input or textarea.`),null;let n=e,r=(n.getAttribute("type")||"text").toLowerCase();return r==="number"||r==="range"||r==="date"||r==="color"?(X(`${w.prefix}${t} doesn't work with input type="${r}". Use type="text".`),null):n}y("mask",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=Gp(e,"mask");if(!o)return;let i=t.trim();if(!i){X(`${w.prefix}mask needs a pattern or mask name.`);return}let s=i.toLowerCase(),a=!!n.unmask||!!n.raw;Xp(o,{format:l=>To(l,i),clean:a?l=>ks(l,s):void 0,rightToLeft:Wp.has(s),suffixLength:s==="percent"?1:0},r)},{priority:j.MODEL+5});y("mask-currency",({el:e,expression:t,modifiers:n,cleanup:r})=>{var f,p,m,h;let o=Gp(e,"mask-currency");if(!o)return;let i=v=>{var g;return(g=e.getAttribute(`${w.prefix}${v}`))!=null?g:e.getAttribute(`data-v-${v}`)},s=(f=typeof n.decimals=="string"?n.decimals:null)!=null?f:i("mask-decimals"),a=s!==null&&s!==""?Number(s):2,l=t.trim()?t:"",c={prefix:n.plain?"":l||i("mask-prefix")||"R$ ",suffix:(p=i("mask-suffix"))!=null?p:"",decimals:Number.isFinite(a)?a:2,decimal:n.dot?".":",",thousands:n.dot?",":"."},d=!!n.unmask||!!n.raw,u=(m=c.decimals)!=null?m:2;Xp(o,{format:v=>ws(v,c),clean:d?v=>{let g=v.replace(/\D/g,"").replace(/^0+(?=\d)/,"");if(!g)return"";if(u===0)return g;let b=g.padStart(u+1,"0"),x=`${b.slice(0,b.length-u)}.${b.slice(b.length-u)}`;return v.trim().startsWith("-")?`-${x}`:x}:void 0,rightToLeft:!0,suffixLength:((h=c.suffix)!=null?h:"").length},r)},{priority:j.MODEL+5});ce();Ae();var Co="v-xray-flash",tm=200,ax=400,Xe=!1,Qp=!1,_=null,rt="estado",Cn="auto",Er=[],Tr=[],en=new Map,Ls=new Set,So=new Map,Ao=[],vc=new WeakMap,ke={effects:0,mutations:0,effectsPerSecond:0,updatesPerSecond:0,history:[]},kt=[],Es=0,Ts=0,Lr=0,Mr=0,Mo=null,lx=`
.v-xray-root{
  all: initial;
  --vx-accent:#6D3BF5;
  --vx-accent-2:#FF3D8B;
...
.${Co}{animation:v-xray-pulse .45s ease-out}
@media (prefers-reduced-motion: reduce){
  .${Co}{animation:none;outline:2px solid rgba(255,61,139,.9)}
}
@media (max-width: 640px){
  .v-xray-panel{right:8px;left:8px;width:auto;max-height:60vh}
}
`;function M(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n!==void 0&&(r.textContent=n),r}function Ss(e){if(!e||!_)return!1;let t=e.nodeType===1?e:e.parentElement;return!!t&&_.root.contains(t)}function Sr(e){if(!e)return"(no element)";let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:"",r=typeof e.className=="string"&&e.className?`.${e.className.trim().split(/\s+/).slice(0,2).join(".")}`:"";return`${t}${n}${r}`}function nm(e,t=64){var r;if(e===null)return"null";if(e===void 0)return"undefined";let n=typeof e;if(n==="function")return"function()";if(n==="string")return`"${ii(e,t)}"`;if(n==="number"||n==="boolean"||n==="symbol")return String(e);if(typeof Element!="undefined"&&e instanceof Element)return`<${e.tagName.toLowerCase()}>`;try{return ii((r=JSON.stringify(e))!=null?r:String(e),t)}catch(o){return String(e)}}function cx(e){var t;if(typeof e=="string")return e;try{return(t=JSON.stringify(e))!=null?t:""}catch(n){return String(e)}}function dx(e,t){if(typeof t=="string")return e;try{return JSON.parse(e)}catch(n){return e}}function rm(e){let t=new Date(e),n=r=>String(r).padStart(2,"0");return`${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`}function om(e,t){for(let n of e.effects)t.push(n);for(let n of e.children)om(n,t)}function gc(e){let t=[];for(let n of yd(e))om(n,t);return t}function im(e){let t=gc(e).length;for(let n of Array.from(e.childNodes))n.nodeType===3&&(t+=gc(n).length);return t}function sm(e){if(!e||!Xe||Ss(e))return;let t=So.get(e);t&&window.clearTimeout(t),Ls.add(e),e.classList.add(Co);let n=window.setTimeout(()=>{e.classList.remove(Co),So.delete(e),window.setTimeout(()=>Ls.delete(e),0)},460);So.set(e,n)}function Jp(e,t){for(let n of gc(e)){if(en.has(n))continue;let r=n.fn;en.set(n,r),n.fn=()=>(ke.effects++,sm(t),r())}}function ux(){for(let[e,t]of en)e.fn=t;en.clear()}function am(){if(!Xe||typeof document=="undefined")return;for(let[n]of en)n.active||en.delete(n);let e=document.createTreeWalker(document.body,NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_TEXT),t=e.currentNode;for(;t;){if(t.nodeType===1){let n=t;if(_&&_.root.contains(n)){t=fx(e);continue}Jp(n,n)}else t.nodeType===3&&t.parentElement&&Jp(t,t.parentElement);t=e.nextNode()}vx()}function fx(e){let t=e.currentNode,n=e.nextSibling();if(n)return n;let r=e.parentNode();for(;r;){if(n=e.nextSibling(),n)return n;r=e.parentNode()}return e.currentNode=t,null}function px(){let e=[],t=document.body.querySelectorAll("*");for(let n=0;n<t.length&&e.length<ax;n++){let r=t[n];_&&_.root.contains(r)||ca(r)&&e.push(r)}return e}function mx(e){return In(e).map(t=>t.arg?`${t.name}:${t.arg}`:t.name)}function vx(){var t;if(!Xe||!_)return;let e=_.overlay;e.textContent="",Ao.length=0;for(let n of px()){let r=M("div","v-xray-box"),o=!!((t=it(n))!=null&&t.component);r.dataset.kind=o?"component":"directive";let i=M("span","v-xray-tag",mx(n).join(" "));r.appendChild(i),e.appendChild(r),Ao.push({el:n,box:r})}xc()}function xc(){if(Xe)for(let e of Ao){if(!e.el.isConnected){e.box.style.display="none";continue}let t=e.el.getBoundingClientRect();if(t.width===0&&t.height===0){e.box.style.display="none";continue}e.box.style.display="block",e.box.style.left=`${t.left}px`,e.box.style.top=`${t.top}px`,e.box.style.width=`${t.width}px`,e.box.style.height=`${t.height}px`}}function hx(){Mr||(Mr=requestAnimationFrame(()=>{Mr=0,xc()}))}function gx(e,t=40){let n=new Set,r=[],o=e;for(;o&&r.length<t;){let i=[];try{i=Object.keys(o.data)}catch(s){i=[]}for(let s of i){if(n.has(s))continue;n.add(s);let a;try{a=o.data[s]}catch(l){a="(read error)"}if(r.push([s,a]),r.length>=t)break}o=o.parent}return r}function bx(e){var s;if(!_)return;let t=_.card;t.textContent="";let n=Ce(e),r=(s=n.owner)==null?void 0:s.component;t.appendChild(M("strong","v-xray-card-title",Sr(e))),t.appendChild(M("span","v-xray-section","Directives"));let o=In(e);if(!o.length)t.appendChild(M("div","v-xray-val","none"));else for(let a of o){let l=M("div","v-xray-row");l.appendChild(M("span","v-xray-key",a.raw)),l.appendChild(M("span","v-xray-val",a.expression||"(no value)")),t.appendChild(l)}t.appendChild(M("span","v-xray-section","Component")),t.appendChild(M("div","v-xray-val",r?`${r.$name} in ${Sr(r.$el)}`:"none")),t.appendChild(M("span","v-xray-section","Scope"));let i=gx(n);if(!i.length)t.appendChild(M("div","v-xray-val","root scope empty"));else for(let[a,l]of i){let c=M("div","v-xray-row");c.appendChild(M("span","v-xray-key",a)),c.appendChild(M("span","v-xray-val",nm(l))),t.appendChild(c)}t.appendChild(M("span","v-xray-section","Reactivity")),t.appendChild(M("div","v-xray-val",`${im(e)} effect(s) depend on this element`))}function yx(e,t){if(!_)return;let n=_.card,r=320,o=Math.min(n.scrollHeight||200,window.innerHeight*.6),i=e+16+r>window.innerWidth?Math.max(8,e-r-16):e+16,s=t+16+o>window.innerHeight?Math.max(8,t-o-16):t+16;n.style.left=`${i}px`,n.style.top=`${s}px`}function Zp(e){if(!Xe||!_)return;let t=e.target;if(!t||Ss(t)){_.card.dataset.open="0",Mo=null;return}let n=t;for(;n&&n!==document.body&&!ca(n);)n=n.parentElement;if(!n||n===document.body){_.card.dataset.open="0",Mo=null;return}n!==Mo&&(Mo=n,bx(n)),_.card.dataset.open="1",yx(e.clientX,e.clientY)}function xx(){let e=new Map,t=document.body.querySelectorAll("*");for(let r=0;r<t.length;r++){let o=t[r];if(_&&_.root.contains(o))continue;let i=it(o);i&&e.set(o,i)}let n=[];for(let[r,o]of e){let i=0,s=r.parentElement;for(;s;)e.has(s)&&i++,s=s.parentElement;n.push({el:r,scope:o,depth:i})}return n}function Ms(e,t,n){let r=M("div","v-xray-row");if(r.appendChild(M("span","v-xray-key",e)),typeof t=="function")return r.appendChild(M("span","v-xray-val","function()")),r;let o=M("input","v-xray-input");return o.type="text",o.value=cx(t),o.spellcheck=!1,o.addEventListener("change",()=>{try{n(dx(o.value,t)),o.dataset.error="0"}catch(i){o.dataset.error="1"}}),o.addEventListener("keydown",i=>{i.key==="Enter"&&o.blur()}),r.appendChild(o),r}function wx(){let e=document.createDocumentFragment(),t=xx();if(!t.length)return e.appendChild(M("span","v-xray-empty","No scopes on the page. Use v-data or a component.")),e;for(let n of t){let r=M("div","v-xray-group");r.style.marginLeft=`${Math.min(n.depth,4)*8}px`;let o=M("div","v-xray-group-head");o.appendChild(M("span","v-xray-badge",n.scope.component?"component":"scope")),o.appendChild(M("span",void 0,Sr(n.el))),o.addEventListener("click",()=>cm(n.el)),r.appendChild(o);let i=M("div","v-xray-rows"),s=[];try{s=Object.keys(n.scope.data)}catch(a){s=[]}if(!s.length)i.appendChild(M("span","v-xray-empty","no variables"));else for(let a of s){let l;try{l=n.scope.data[a]}catch(c){l=void 0}i.appendChild(Ms(a,l,c=>{n.scope.set(a,c)}))}r.appendChild(i),e.appendChild(r)}return e}function kx(){var n;let e=document.createDocumentFragment(),t=[...Rt];if(!t.length)return e.appendChild(M("span","v-xray-empty","No components mounted.")),e;for(let r of t){let o=M("div","v-xray-group"),i=M("div","v-xray-group-head");i.appendChild(M("span","v-xray-badge",r.$name)),i.appendChild(M("span",void 0,Sr(r.$el))),i.appendChild(M("span","v-xray-badge",`${im(r.$el)} effects`)),i.lastChild.dataset.tone="mute",i.addEventListener("click",()=>cm(r.$el)),o.appendChild(i);let s=M("div","v-xray-rows"),a=(n=r.$props)!=null?n:{},l=Object.keys(a);if(l.length){s.appendChild(M("span","v-xray-section","Props"));for(let u of l)s.appendChild(Ms(u,a[u],f=>{a[u]=f}))}let c=r.$scope,d=[];try{d=Object.keys(c.data).filter(u=>!l.includes(u))}catch(u){d=[]}if(d.length){s.appendChild(M("span","v-xray-section","State"));for(let u of d){let f;try{f=c.data[u]}catch(p){f=void 0}s.appendChild(Ms(u,f,p=>{c.set(u,p)}))}}o.appendChild(s),e.appendChild(o)}return e}function Ex(){let e=document.createDocumentFragment(),t=ni();if(!t.length)return e.appendChild(M("span","v-xray-empty","No global stores. Create one with V.store().")),e;for(let n of t){let r=$t[n],o=M("div","v-xray-group"),i=M("div","v-xray-group-head");i.appendChild(M("span","v-xray-badge","store")),i.firstChild.dataset.tone="alt",i.appendChild(M("span",void 0,n)),o.appendChild(i);let s=M("div","v-xray-rows"),a=r?Object.keys(r):[];if(!a.length)s.appendChild(M("span","v-xray-empty","empty store"));else for(let l of a)s.appendChild(Ms(l,r[l],c=>{r[l]=c}));o.appendChild(s),e.appendChild(o)}return e}function lm(e,t,n,r){let o=M("div","v-xray-log");if(o.appendChild(M("span","v-xray-log-time",e)),o.appendChild(M("span","v-xray-log-main",t)),n!==void 0){let i=M("span",r==="fail"?"v-xray-fail":r==="ok"?"v-xray-ok":void 0,n);o.appendChild(i)}return o}function Tx(){let e=document.createDocumentFragment(),t=M("button","v-xray-btn","clear log");if(t.addEventListener("click",()=>{Er.length=0,tn()}),e.appendChild(t),!Er.length)return e.appendChild(M("span","v-xray-empty","No events yet. Interact with the page.")),e;for(let n of[...Er].reverse())e.appendChild(lm(rm(n.at),`${n.type} on ${n.target}`,n.detail||n.source));return e}function Lx(){let e=document.createDocumentFragment(),t=M("button","v-xray-btn","clear log");if(t.addEventListener("click",()=>{Tr.length=0,tn()}),e.appendChild(t),!Tr.length)return e.appendChild(M("span","v-xray-empty","No requests yet. v-get, v-post and V.http show up here.")),e;for(let n of[...Tr].reverse())e.appendChild(lm(rm(n.at),`${n.method} ${n.url}`,`${n.status||"---"} ${Math.round(n.duration)}ms`,n.ok?"ok":"fail"));return e}function Mx(){let e=document.createDocumentFragment(),t=M("div","v-xray-metric");t.appendChild(M("span","v-xray-metric-value",String(ke.updatesPerSecond))),t.appendChild(M("span",void 0,"DOM updates per second")),e.appendChild(t);let n=M("div","v-xray-metric");n.appendChild(M("span","v-xray-metric-value",String(ke.effectsPerSecond))),n.appendChild(M("span",void 0,"reactive effects triggered per second")),e.appendChild(n);let r=M("div","v-xray-metric");r.appendChild(M("span","v-xray-metric-value",String(ke.effects))),r.appendChild(M("span",void 0,"effects triggered since x-ray was enabled")),e.appendChild(r);let o=M("div","v-xray-chart"),i=Math.max(1,...ke.history.map(s=>Math.max(s.effects,s.updates)));for(let s of ke.history){let a=M("div","v-xray-bar"),l=Math.max(s.effects,s.updates);a.style.height=`${Math.max(2,Math.round(l/i*46))}px`,a.title=`${s.effects} effects, ${s.updates} updates`,o.appendChild(a)}return e.appendChild(o),e.appendChild(M("span","v-xray-hint",`${en.size} effects instrumented, peak of ${i} per second`)),e}var Sx=[{id:"estado",label:"Estado"},{id:"componentes",label:"Componentes"},{id:"stores",label:"Stores"},{id:"eventos",label:"Eventos"},{id:"rede",label:"Rede"},{id:"desempenho",label:"Desempenho"}];function tn(){if(!_)return;let e=document.activeElement;if(!(e instanceof HTMLInputElement&&_.body.contains(e))){switch(_.body.textContent="",rt){case"estado":_.body.appendChild(wx());break;case"componentes":_.body.appendChild(kx());break;case"stores":_.body.appendChild(Ex());break;case"eventos":_.body.appendChild(Tx());break;case"rede":_.body.appendChild(Lx());break;case"desempenho":_.body.appendChild(Mx());break}for(let t of Array.from(_.tabs.children)){let n=t;n.dataset.active=n.dataset.id===rt?"1":"0"}_.status.textContent=`${Ao.length} elements with directives, ${Rt.size} components, ${en.size} effects observed`}}function cm(e){e.scrollIntoView({behavior:"smooth",block:"center"}),sm(e)}function Cx(){let e=M("div","v-xray-root");e.setAttribute(`${w.prefix}ignore`,""),e.setAttribute("role","complementary"),e.setAttribute("aria-label","Voodoo x-ray inspector"),Cn!=="auto"&&(e.dataset.vXrayTheme=Cn);let t=M("div","v-xray-overlay");e.appendChild(t);let n=M("div","v-xray-card");n.dataset.open="0",e.appendChild(n);let r=M("div","v-xray-panel"),o=M("div","v-xray-header"),i=M("div","v-xray-brand");i.appendChild(M("span","v-xray-dot")),i.appendChild(document.createTextNode("Voodoo x-ray")),o.appendChild(i);let s=M("button","v-xray-btn","theme");s.addEventListener("click",()=>{Cn=Cn==="auto"?"dark":Cn==="dark"?"light":"auto",Cn==="auto"?delete e.dataset.vXrayTheme:e.dataset.vXrayTheme=Cn}),o.appendChild(s);let a=M("button","v-xray-btn","close");a.addEventListener("click",()=>dm()),o.appendChild(a),r.appendChild(o);let l=M("div","v-xray-tabs");for(let u of Sx){let f=M("button","v-xray-tab",u.label);f.dataset.id=u.id,f.dataset.active=u.id===rt?"1":"0",f.addEventListener("click",()=>{rt=u.id,tn()}),l.appendChild(f)}r.appendChild(l);let c=M("div","v-xray-body");r.appendChild(c);let d=M("div","v-xray-status","starting");return r.appendChild(d),e.appendChild(r),document.body.appendChild(e),{root:e,overlay:t,card:n,panel:r,tabs:l,body:c,status:d}}var Ax=["click","dblclick","submit","input","change","keydown","keyup","focus","blur","contextmenu","drop","paste"];function em(e){Er.push(e),Er.length>tm&&Er.shift(),rt==="eventos"&&tn()}function hc(e){Tr.push(e),Tr.length>tm&&Tr.shift(),rt==="rede"&&tn()}function Rx(e,t){let n=e;for(let r=0;n&&r<6;r++){for(let o of In(n))if(o.name===t||o.name==="on"&&o.arg===t)return n;n=n.parentElement}return null}function $x(){let e=new Set(Ax),t=document.body.querySelectorAll("*");for(let n=0;n<t.length;n++){let r=t[n];if(!(_&&_.root.contains(r)))for(let o of In(r))o.name==="on"&&o.arg&&e.add(o.arg)}return[...e]}function Dx(){let e=t=>{if(!Xe)return;let n=t.target;if(!n||n.nodeType!==1||Ss(n))return;let r=Rx(n,t.type),o=t.__voodoo===!0;!r&&!o||em({at:Date.now(),type:t.type,target:Sr(r!=null?r:n),detail:o?"component emit":"",source:o?"component":"v-on"})};for(let t of $x())document.addEventListener(t,e,!0),kt.push(()=>document.removeEventListener(t,e,!0));kt.push(je.on("event",t=>{var n,r;em({at:Date.now(),type:t.type,target:Sr((n=t.el)!=null?n:null),detail:nm(t.detail),source:(r=t.source)!=null?r:"bus"})}))}function Px(){kt.push(he.interceptors.request.use(e=>(vc.set(e,performance.now()),e))),kt.push(he.interceptors.response.use(e=>{var n,r;let t=(n=vc.get(e.config))!=null?n:performance.now();return hc({at:Date.now(),method:((r=e.config.method)!=null?r:"GET").toUpperCase(),url:e.config.url,status:e.status,ok:e.ok,duration:performance.now()-t,source:"http"}),e})),kt.push(he.interceptors.error.use(e=>{var r,o,i;let t=e.config,n=t&&(r=vc.get(t))!=null?r:performance.now();return hc({at:Date.now(),method:((o=t==null?void 0:t.method)!=null?o:"GET").toUpperCase(),url:(i=t==null?void 0:t.url)!=null?i:"(unknown)",status:e.status,ok:!1,duration:performance.now()-n,source:"http"}),e})),kt.push(je.on("network",e=>{var t,n,r,o,i;hc({at:Date.now(),method:((t=e.method)!=null?t:"GET").toUpperCase(),url:e.url,status:(n=e.status)!=null?n:0,ok:(r=e.ok)!=null?r:!e.error,duration:(o=e.duration)!=null?o:0,source:(i=e.source)!=null?i:"bus"})}))}var kr=null;function Hx(){kr=new MutationObserver(e=>{let t=!1;for(let n of e){let r=n.target;Ss(r)||n.type==="attributes"&&n.attributeName==="class"&&r.nodeType===1&&Ls.has(r)||(ke.mutations++,n.type==="childList"&&n.addedNodes.length&&(t=!0))}t&&!Lr&&(Lr=window.setTimeout(()=>{Lr=0,am()},250))}),kr.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0})}function Nx(){Ts=window.setInterval(()=>{ke.effectsPerSecond=ke.effects-bc,ke.updatesPerSecond=ke.mutations-yc,bc=ke.effects,yc=ke.mutations,ke.history.push({effects:ke.effectsPerSecond,updates:ke.updatesPerSecond}),ke.history.length>40&&ke.history.shift(),rt==="desempenho"&&tn()},1e3),Es=window.setInterval(()=>{xc(),(rt==="estado"||rt==="componentes"||rt==="stores")&&tn()},700)}var bc=0,yc=0;function Ox(){if(Xe||typeof document=="undefined"||!document.body)return;Xe=!0,ge(),Z("xray",lx),_=Cx(),rt=rt||"estado",ke.effects=0,ke.mutations=0,bc=0,yc=0,ke.history.length=0,am(),Dx(),Px(),Hx(),Nx();let e=()=>hx();window.addEventListener("scroll",e,!0),window.addEventListener("resize",e),document.addEventListener("mousemove",Zp,!0),kt.push(()=>window.removeEventListener("scroll",e,!0)),kt.push(()=>window.removeEventListener("resize",e)),kt.push(()=>document.removeEventListener("mousemove",Zp,!0)),tn()}function dm(){if(Xe){Xe=!1;for(let e of kt.splice(0))try{e()}catch(t){}kr==null||kr.disconnect(),kr=null,Ts&&window.clearInterval(Ts),Es&&window.clearInterval(Es),Lr&&window.clearTimeout(Lr),Mr&&cancelAnimationFrame(Mr),Ts=Es=Lr=Mr=0;for(let[e,t]of So)window.clearTimeout(t),e.classList.remove(Co);So.clear(),Ls.clear(),ux(),Ao.length=0,Mo=null,_==null||_.root.remove(),_=null}}function um(){return Xe}function Fx(e){let t=e.toLowerCase().split("+").map(o=>o.trim()).filter(Boolean);if(!t.length)return null;let n=t.pop(),r={ctrl:!1,alt:!1,shift:!1,meta:!1,code:/^f\d{1,2}$/.test(n)?n.toUpperCase():n.length===1&&n>="a"&&n<="z"?`Key${n.toUpperCase()}`:n.length===1&&n>="0"&&n<="9"?`Digit${n}`:n.charAt(0).toUpperCase()+n.slice(1)};for(let o of t)if(o==="ctrl"||o==="control")r.ctrl=!0;else if(o==="alt"||o==="option")r.alt=!0;else if(o==="shift")r.shift=!0;else if(o==="meta"||o==="cmd"||o==="command"||o==="win")r.meta=!0;else return null;return r}function wc(){Qp||typeof document=="undefined"||(Qp=!0,document.addEventListener("keydown",e=>{let t=w.xrayShortcut;if(t===!1)return;let n=Fx(typeof t=="string"?t:"ctrl+shift+f2");n&&(e.ctrlKey!==n.ctrl||e.altKey!==n.alt||e.shiftKey!==n.shift||e.metaKey!==n.meta||e.code!==n.code&&e.key.toUpperCase()!==n.code.replace(/^Key/,"")||(e.preventDefault(),Ro()))}))}function Ro(e){return wc(),(e!=null?e:!Xe)?Ox():dm(),Xe}de();ce();var Ix=new Set(["SCRIPT","STYLE","PRE","CODE","SAMP","KBD","TEXTAREA","TEMPLATE","NOSCRIPT"]);N("$__jsx",e=>e);Cd((e,t)=>{t?$o():Cs(e)});var fm=Symbol("voodoo.jsx.template");function zx(e){return typeof e=="object"&&e!==null&&fm in e}function Bx(e,t){var f;let n=[],r=[],o="",i=0,s=null,a=!1,l=e,c=t,d=!1,u=null;for(;l;){if(l.nodeType===Node.TEXT_NODE){let p=(f=l.textContent)!=null?f:"";for(;c<p.length;c++){let m=p[c];if(a){a=!1,o+=m;continue}if(s){m==="\\"?a=!0:m===s&&(s=null),o+=m;continue}if(m==='"'||m==="'"||m==="`"){s=m,o+=m;continue}if(m==="{"){i++,i>1&&(o+=m);continue}if(m==="}"){if(i--,i===0){c++,d=!0;break}o+=m;continue}o+=m}if(r.push(l),d){u={node:l,offset:c};break}}else if(l.nodeType===Node.ELEMENT_NODE){if(i===0)return null;o+=`$t(${n.length}, $__jsx)`,n.push(l),r.push(l)}else r.push(l);c=0,l=l.nextSibling}return d?{source:o,templates:n,nodes:r,tail:u}:null}function jx(e){let t=e.source.match(/\(\s*\)/g);if(!t)return!1;let n=e.nodes[0],r=e.nodes[e.nodes.length-1],o=[r==null?void 0:r.nextSibling,n==null?void 0:n.previousSibling].map(l=>{var d;let c=l!=null?l:null;for(;c&&c.nodeType===Node.TEXT_NODE&&!((d=c.textContent)!=null?d:"").trim();)c=c===(r==null?void 0:r.nextSibling)?c.nextSibling:c.previousSibling;return c&&c.nodeType===Node.ELEMENT_NODE?c:null}).find(l=>(l==null?void 0:l.tagName)==="TABLE");if(!o)return!1;let i=o.querySelector("tbody");if(!i)return!1;let s=Array.from(i.children).filter(l=>l.tagName==="TR");if(s.length!==t.length)return!1;let a=0;return e.source=e.source.replace(/\(\s*\)/g,()=>`($t(${a++}, $__jsx))`),e.templates=s,e.host=i,e.nodes.push(...s),!0}function pm(e,t,n,r){var o;if(!(e==null||e===!1||e===!0)){if(Array.isArray(e)){for(let i of e)pm(i,t,n,r);return}if(zx(e)){let i=e,a=t[i.index].cloneNode(!0),l=(o=i.scope)!=null?o:n;Ec(a,l),$o(),ne(a,l),r.push(a);return}r.push(document.createTextNode(String(e)))}}function Ec(e,t){var o,i,s;if(Ix.has(e.tagName))return;let n=t!=null?t:Ce(e),r=e.firstChild;for(;r;){let a=r.nextSibling;if(r.nodeType===Node.ELEMENT_NODE){Ec(r,(o=it(r))!=null?o:n),r=a;continue}if(r.nodeType!==Node.TEXT_NODE){r=a;continue}let c=((i=r.textContent)!=null?i:"").indexOf("{");if(c<0){r=a;continue}let d=Bx(r,c);if(!d){r=a;continue}if(d.templates.length===0&&!jx(d)){r=a;continue}qx(e,d,n),r=(s=d.nodes[d.nodes.length-1])==null?void 0:s.nextSibling}}var kc=[];function qx(e,t,n){var f,p;let{source:r,templates:o,nodes:i,tail:s}=t,a;try{a=ze(r)}catch(m){w.devtools&&console.warn(`[Voodoo] could not parse the inline expression: ${r}`,m);return}s&&s.offset<((f=s.node.textContent)!=null?f:"").length&&s.node.splitText(s.offset);let l=(p=t.host)!=null?p:e,c=document.createComment("v-jsx");l.insertBefore(c,t.host?t.host.firstChild:i[0]);for(let m of i)m.remove();let d=[];kc.push(()=>u());function u(){let m=Ce(c),v=(m===Ke&&n?n:m).child({$t:(b,x)=>({[fm]:!0,index:b,scope:x})}),g=Pe(()=>{let b=Vo(P(a,v)),x=[];pm(b,o,v,x);for(let T of d)T.remove();d=x;for(let T of x)l.insertBefore(T,c)});Be(c,()=>{g.effect.stop();for(let b of d)b.remove()})}}function Vx(e=document.body){var t;for(let n of Array.from(e.childNodes)){if(n.nodeType!==Node.TEXT_NODE)continue;let r=(t=n.textContent)!=null?t:"",o=r.indexOf("{");if(o<0)continue;let i=Ux(r,o);if(i<0)continue;let s=r.slice(o,i+1);if(!/\b(?:const|let|var)\s/.test(s))continue;let a=s.slice(1,-1).replace(/\b(?:const|let|var)\s+/g,""),l=Y({});try{P(ze(a),new St(l))}catch(c){return w.devtools&&console.warn("[Voodoo] could not read the declaration block",c),null}return n.textContent=r.slice(0,o)+r.slice(i+1),l}return null}function Ux(e,t){let n=0,r=null,o=!1;for(let i=t;i<e.length;i++){let s=e[i];if(o){o=!1;continue}if(r){s==="\\"?o=!0:s===r&&(r=null);continue}if(s==='"'||s==="'"||s==="`")r=s;else if(s==="{")n++;else if(s==="}"&&--n===0)return i}return-1}function $o(){let e=kc.splice(0,kc.length);for(let t of e)try{t()}catch(n){console.error("[Voodoo] a JSX region failed to render",n)}}function Cs(e=document.body){let t=Vx(e);t&&Object.assign(Ke.data,t),Ec(e,Ce(e))}function mm(e=document.body){Cs(e),$o()}Ae();var hm="voodoo:devtools:widget-position",Tc="voodoo:devtools:widget-hidden",_x=4,oe=null,Cr=!1,Lc=0,As=0,Do=[],Wx=`
.v-devtools-widget{
  all: initial;
  --vw-accent:#6D3BF5;
  --vw-accent-2:#FF3D8B;
...
</svg>`;function Yx(){try{let e=localStorage.getItem(hm);if(!e)return null;let t=JSON.parse(e);return typeof(t==null?void 0:t.x)!="number"||typeof(t==null?void 0:t.y)!="number"?null:t}catch(e){return null}}function Xx(e){try{localStorage.setItem(hm,JSON.stringify(e))}catch(t){}}function Mc(e,t){let n=e.offsetWidth||120,r=e.offsetHeight||38,o=Math.min(Math.max(8,t.x),Math.max(8,window.innerWidth-n-8)),i=Math.min(Math.max(8,t.y),Math.max(8,window.innerHeight-r-8));e.style.left=`${o}px`,e.style.top=`${i}px`,e.style.right="auto",e.style.bottom="auto"}function Gx(){let e=document.createElement("div");e.className="v-devtools-widget",e.setAttribute("data-voodoo-devtools","widget");let t=document.createElement("button");t.type="button",t.className="v-devtools-btn",t.setAttribute("aria-label","Open Voodoo devtools (Ctrl+Shift+F2)"),t.setAttribute("aria-pressed","false"),t.title="Voodoo devtools \u2014 click to inspect, drag to move (Ctrl+Shift+F2)",t.innerHTML=Kx;let n=document.createElement("span");n.className="v-devtools-label",n.textContent="Voodoo";let r=document.createElement("span");r.className="v-devtools-count",r.textContent="0";let o=document.createElement("span");o.className="v-devtools-pulse",o.setAttribute("data-on","false"),t.append(n,r,o);let i=document.createElement("button");i.type="button",i.className="v-devtools-close",i.setAttribute("aria-label","Hide the devtools widget in this tab"),i.title="Hide in this tab",i.textContent="\xD7",e.append(t,i),document.body.appendChild(e);let s=Yx();return s?Mc(e,s):(e.style.right="16px",e.style.bottom="16px"),{root:e,button:t,pulse:o,counter:r,close:i}}function Qx(e,t){let n=!1,r=!1,o=0,i=0,s=0,a=0,l=p=>{var h,v;if(p.button!==0)return;let m=e.root.getBoundingClientRect();n=!0,r=!1,s=p.clientX,a=p.clientY,o=p.clientX-m.left,i=p.clientY-m.top,(v=(h=e.button).setPointerCapture)==null||v.call(h,p.pointerId)},c=p=>{if(!n)return;let m=Math.hypot(p.clientX-s,p.clientY-a);!r&&m<_x||(r=!0,p.preventDefault(),Mc(e.root,{x:p.clientX-o,y:p.clientY-i}))},d=p=>{var h,v;if(!n)return;if(n=!1,(v=(h=e.button).releasePointerCapture)==null||v.call(h,p.pointerId),!r){t();return}let m=e.root.getBoundingClientRect();Xx({x:m.left,y:m.top})},u=p=>{p.key!=="Enter"&&p.key!==" "||(p.preventDefault(),t())},f=()=>{let p=e.root.getBoundingClientRect();e.root.style.left&&Mc(e.root,{x:p.left,y:p.top})};return e.button.addEventListener("pointerdown",l),e.button.addEventListener("pointermove",c),e.button.addEventListener("pointerup",d),e.button.addEventListener("pointercancel",d),e.button.addEventListener("keydown",u),window.addEventListener("resize",f),()=>{e.button.removeEventListener("pointerdown",l),e.button.removeEventListener("pointermove",c),e.button.removeEventListener("pointerup",d),e.button.removeEventListener("pointercancel",d),e.button.removeEventListener("keydown",u),window.removeEventListener("resize",f)}}function Jx(){oe&&(oe.pulse.setAttribute("data-on","true"),window.clearTimeout(As),As=window.setTimeout(()=>{oe==null||oe.pulse.setAttribute("data-on","false")},320))}function vm(){if(!oe)return;let e=Rt.size,t=e===1?"1 component":`${e} components`;oe.counter.textContent!==t&&(oe.counter.textContent=t)}function Zx(){if(Cr||typeof document=="undefined"||!document.body)return;try{if(sessionStorage.getItem(Tc)==="1")return}catch(r){}Cr=!0,Z("devtools-widget",Wx),oe=Gx();let e=()=>{let r=Ro();oe==null||oe.root.setAttribute("data-active",String(r)),oe==null||oe.button.setAttribute("aria-pressed",String(r))};Do.push(Qx(oe,e));let t=r=>{r.stopPropagation();try{sessionStorage.setItem(Tc,"1")}catch(o){}gm(),console.info("[Voodoo] devtools widget hidden. Use V.devtoolsWidget(true) to bring back.")};oe.close.addEventListener("click",t),Do.push(()=>oe==null?void 0:oe.close.removeEventListener("click",t));let n=()=>{let r=um();oe==null||oe.root.setAttribute("data-active",String(r)),oe==null||oe.button.setAttribute("aria-pressed",String(r))};document.addEventListener("keyup",n),Do.push(()=>document.removeEventListener("keyup",n));for(let r of["network","event","navigation","update"])Do.push(je.on(r,Jx));vm(),Lc=window.setInterval(vm,1e3)}function gm(){if(Cr){Cr=!1;for(let e of Do.splice(0))try{e()}catch(t){}window.clearInterval(Lc),window.clearTimeout(As),Lc=0,As=0,oe==null||oe.root.remove(),oe=null}}function bm(e){if(e!=null?e:!Cr){try{sessionStorage.removeItem(Tc)}catch(n){}Zx()}else gm();return Cr}var xm=((e,t)=>Oa(e,t));function ym(e,t,n){return((...r)=>(Nr(e,t),n(...r)))}Object.assign(xm,yi,{query:Oa,ready:Fa,fromHtml:Iu,jsx:mm,extractJsx:Cs,activateJsx:$o,Collection:vt,router:Qr,route:ue,navigate:Kt,resolveRoute:tr,i18n:Zr,t:ir,setLocale:Jr,getLocale:$i,modal:Mn,alert:fc,confirm:ys,prompt:pc,dialog:wr,validator:J,validate:yl,validateForm:ym("V.validateForm","V.validate",yl),serializeForm:cr,messages:lt,showFormErrors:Wi,showFieldError:_i,clearErrors:lo,mask:Yp,masks:Lo,applyMask:To,unmask:ks,registerMask:Le,animate:Nt,spring:Bl,stagger:jl,inView:ls,scrollProgress:ql,motion:xn,easings:mo,chart:ym("V.chart","V.renderChart",hr),renderChart:hr,charts:Yl,chartColors:ho,palette:Np,hotkey:ro,sound:Jt,xray:Ro,enableXrayShortcut:wc,devtoolsWidget:bm,devtools:je,magic:N});var Sc=xm;ce();function e0(e){if(window.VOODOO_DEVTOOLS===!0)return!0;for(let t of["devtools","data-devtools"]){if(!e.hasAttribute(t))continue;let n=e.getAttribute(t);return n===null||n===""||n.toLowerCase()!=="false"}return!1}function t0(){var s;if(typeof document=="undefined")return{manual:!1};let e=(s=document.currentScript)!=null?s:document.querySelector('script[src*="voodoo"]');if(!e)return{manual:!1};let t=e.hasAttribute("data-manual")||e.hasAttribute("data-defer-init"),n=e.getAttribute("data-prefix");n&&(w.prefix=n);let r=e.getAttribute("data-base-url");r&&(w.baseURL=r);let o=e.getAttribute("data-locale");o&&(w.locale=o),e0(e)&&(w.devtools=!0);let i=e.getAttribute("data-xray-shortcut");return i!==null&&(w.xrayShortcut=i==="false"||i===""?!1:i),e.hasAttribute("data-no-styles")&&(w.injectStyles=!1),e.hasAttribute("data-no-observer")&&(w.autoDiscover=!1),e.hasAttribute("data-keep-attributes")&&(w.cleanAttributes=!1),{manual:t}}function n0(e){if(typeof e.devtoolsWidget=="function"){e.devtoolsWidget(!0);return}console.info("[Voodoo] devtools requested, but this build does not include the inspector. Use voodoo.full.min.js to get the widget and full devtools panel.")}function wm(e){var o;if(typeof window=="undefined")return;let t=t0(),n=window;if(n.V=e,n.Voodoo=e,Oe.V=e,Oe.Voodoo=e,w.baseURL&&((o=e.http)!=null&&o.setBaseURL)&&e.http.setBaseURL(w.baseURL),mt.init(),t.manual||!w.autoStart){Fr(()=>{rc()});return}Fr(()=>{rc(),e.start(),typeof e.enableXrayShortcut=="function"&&e.enableXrayShortcut(),w.devtools&&n0(e)})}wm(Sc);var r0=Sc;return Pm(o0);})();
