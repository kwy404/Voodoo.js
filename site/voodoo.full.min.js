 ...
 */
"use strict";var Voodoo=(()=>{var Ao=Object.defineProperty;var vm=Object.getOwnPropertyDescriptor;var hm=Object.getOwnPropertyNames;var gm=Object.prototype.hasOwnProperty;var bm=(e,t,n)=>t in e?Ao(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Es=(e,t)=>()=>(e&&(t=e(e=0)),t);var Co=(e,t)=>{for(var n in t)Ao(e,n,{get:t[n],enumerable:!0})},ym=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of hm(t))!gm.call(e,o)&&o!==n&&Ao(e,o,{get:()=>t[o],enumerable:!(r=vm(t,o))||r.enumerable});return e};var xm=e=>ym(Ao({},"__esModule",{value:!0}),e);var P=(e,t,n)=>bm(e,typeof t!="symbol"?t+"":t,n);var Oc={};Co(Oc,{EffectScope:()=>rt,ITERATE_KEY:()=>tn,ReactiveEffect:()=>An,TriggerType:()=>Dc,computed:()=>Sr,effect:()=>Fe,effectScope:()=>Hs,enableTracking:()=>$c,flushSync:()=>Cs,getActiveEffect:()=>Em,getActiveScope:()=>Tm,handleError:()=>K,hasChanged:()=>Lr,isReactive:()=>Is,isRef:()=>nn,markRaw:()=>Fs,nextTick:()=>ut,pauseTracking:()=>Rc,queueJob:()=>Ho,queuePostFlush:()=>Se,reactive:()=>Y,ref:()=>Mr,resetTracking:()=>Ds,setErrorHandler:()=>Rs,shallowRef:()=>zs,stop:()=>Ps,toRaw:()=>Me,track:()=>dt,trigger:()=>wt,unref:()=>Bs,warn:()=>X,watch:()=>Ie,watchEffect:()=>js});function ut(e){let t=Do||Ss;return e?t.then(e):t}function Ho(e){e.queued||(e.queued=!0,Mn.push(e),Cc())}function Se(e){Ro.push(e),Cc()}function Cc(){$o||Tr||(Tr=!0,Do=Ss.then(As))}function As(){Tr=!1,$o=!0;let e=new Map;try{for(let t=0;t<Mn.length;t++){let n=Mn[t];if(!n.active)continue;let r=(e.get(n)||0)+1;if(e.set(n,r),r>wm){X("Infinite update loop detected. A reactive effect keeps triggering itself without ever settling. Check whether some expression writes to state that it also reads.");continue}try{n.run()}catch(o){K(o,"effect")}}}finally{for(let n of Mn)n.queued=!1;Mn=[],$o=!1;let t=Ro;Ro=[];for(let n of t)try{n()}catch(r){K(r,"post-flush")}Mn.length||Ro.length?(Do=Ss.then(As),Tr=!0):Do=null}}function Cs(){$o||(Tr=!1,As())}function Rs(e){ks=e}function K(e,t){if(ks){ks(e,t);return}console.error(`[Voodoo] error in ${t}:`,e)}function X(e,...t){console.warn(`[Voodoo] ${e}`,...t)}function Rc(){$s.push(rn),rn=!1}function $c(){$s.push(rn),rn=!0}function Ds(){var e;rn=(e=$s.pop())!=null?e:!0}function Em(){return Oe}function Lc(e){let{deps:t}=e;for(let n=0;n<t.length;n++)t[n].delete(e);t.length=0}function Fe(e,t){let n=new An(e,t);t!=null&&t.lazy||n.run();let r=(()=>n.run());return r.effect=n,r}function Ps(e){e instanceof An?e.stop():e.effect.stop()}function Hs(e=!1){return new rt(e)}function Tm(){return Ht}function dt(e,t){if(!rn||!Oe)return;let n=Ts.get(e);n||Ts.set(e,n=new Map);let r=n.get(t);r||n.set(t,r=new Set),r.has(Oe)||(r.add(Oe),Oe.deps.push(r))}function wt(e,t,n,r){let o=Ts.get(e);if(!o)return;let i=new Set,s=a=>{if(a)for(let l of a)(l!==Oe||t==="clear")&&i.add(l)};if(t==="clear")o.forEach(s);else{n!==void 0&&s(o.get(n));let a=Array.isArray(e);if(t==="add")a?Ls(n)&&s(o.get("length")):s(o.get(tn));else if(t==="delete")a||s(o.get(tn));else if(a&&n==="length"){let l=Number(r);o.forEach((c,d)=>{(d==="length"||typeof d!="symbol"&&Number(d)>=l)&&s(c)})}}for(let a of i)a.scheduler?a.scheduler():Ho(a)}function Ls(e){return typeof e=="string"&&e!=="NaN"&&e[0]!=="-"&&String(parseInt(e,10))===e}function Nt(e){return e!==null&&typeof e=="object"}function Mm(e){if(!Nt(e)||e[Pc]||Object.isFrozen(e)||typeof Node!="undefined"&&e instanceof Node)return!1;let t=Object.prototype.toString.call(e).slice(8,-1);return Lm.has(t)?!1:t==="Object"||t==="Array"||t==="Map"||t==="Set"}function Fs(e){return Object.defineProperty(e,Pc,{value:!0,enumerable:!1,configurable:!0}),e}function Me(e){let t=e&&e[Ns];return t?Me(t):e}function Is(e){return!!(e&&e[Os])}function Y(e){if(!Nt(e)||Is(e)||!Mm(e))return e;let t=Mc.get(e);if(t)return t;let n=e instanceof Map||e instanceof Set,r=new Proxy(e,n?Am:Sm);return Mc.set(e,r),r}function Lr(e,t){return!Object.is(e,t)}function nn(e){return!!(e&&e.__v_isRef===!0)}function Ac(e){return Nt(e)?Y(e):e}function Hc(e){!rn||!Oe||e.dep.has(Oe)||(e.dep.add(Oe),Oe.deps.push(e.dep))}function Nc(e){for(let t of[...e.dep])t.scheduler?t.scheduler():Ho(t)}function Mr(e){return new Po(e)}function zs(e){return new Po(e,!0)}function Bs(e){return nn(e)?e.value:e}function Sr(e){let t=typeof e=="function",n=t?e:e.get,r=t?void 0:e.set;return new Ms(n,r)}function Ie(e,t,n={}){let{immediate:r=!1,deep:o=!1,flush:i="pre"}=n,s;if(nn(e)?s=()=>e.value:typeof e=="function"?s=e:Is(e)?s=()=>Sn(e):s=()=>e,o){let f=s;s=()=>Sn(f())}let a,l,c=f=>{l=f},d=()=>{if(!p.effect.active)return;let f=p();(o||Lr(f,a))&&(l==null||l(),l=void 0,t(f,a,c),a=f)},p=i==="pre"?Fe(s,{lazy:!0,scheduler:()=>Se(d)}):Fe(s,{lazy:!0,scheduler:i==="sync"?d:i==="post"?()=>Se(d):()=>Ho(p.effect)});return a=p(),r&&t(a,void 0,c),()=>p.effect.stop()}function js(e){let t,n=o=>{t=o},r=Fe(()=>{t==null||t(),t=void 0,e(n)});return()=>{t==null||t(),r.effect.stop()}}function Sn(e,t=new Set){if(!Nt(e)||t.has(e))return e;if(t.add(e),nn(e))Sn(e.value,t);else if(Array.isArray(e))for(let n of e)Sn(n,t);else if(e instanceof Set||e instanceof Map)e.forEach(n=>Sn(n,t));else for(let n of Object.keys(e))Sn(e[n],t);return e}var Ss,Mn,Ro,$o,Tr,Do,wm,ks,Oe,rn,$s,km,An,Ht,rt,tn,Ts,Dc,Ns,Os,Pc,Mc,Sc,Lm,Sm,Am,Po,Ms,me=Es(()=>{"use strict";Ss=Promise.resolve(),Mn=[],Ro=[],$o=!1,Tr=!1,Do=null,wm=100;ks=null;rn=!0,$s=[];km=0,An=class{constructor(t,n){var o;this.fn=t,this.id=km++,this.active=!0,this.queued=!1,this.deps=[],this.parent=void 0,this.scheduler=n==null?void 0:n.scheduler,this.onStop=n==null?void 0:n.onStop,this.cleanups=[];let r=(o=n==null?void 0:n.scope)!=null?o:Ht;r&&r.effects.push(this)}run(){if(!this.active)return this.fn();let t=Oe;for(;t;){if(t===this)return;t=t.parent}this.runCleanups();try{return this.parent=Oe,Oe=this,$c(),Lc(this),this.fn()}finally{Ds(),Oe=this.parent,this.parent=void 0}}onInvalidate(t){this.cleanups.push(t)}runCleanups(){if(!this.cleanups.length)return;let t=this.cleanups;this.cleanups=[];for(let n of t)try{n()}catch(r){K(r,"effect cleanup")}}stop(){var t;this.active&&(Lc(this),this.runCleanups(),this.active=!1,(t=this.onStop)==null||t.call(this))}};rt=class{constructor(t=!1){this.effects=[],this.cleanups=[],this.children=[],this.active=!0,this.parent=void 0,!t&&Ht&&(this.parent=Ht,Ht.children.push(this))}run(t){if(!this.active)return;let n=Ht;try{return Ht=this,t()}finally{Ht=n}}onDispose(t){this.cleanups.push(t)}stop(){if(this.active){this.active=!1;for(let t of this.effects)t.stop();for(let t of this.children)t.stop();for(let t of this.cleanups)try{t()}catch(n){K(n,"scope cleanup")}if(this.effects.length=0,this.children.length=0,this.cleanups.length=0,this.parent){let t=this.parent.children.indexOf(this);t>-1&&this.parent.children.splice(t,1)}}}};tn=Symbol("voodoo:iterate"),Ts=new WeakMap;Dc=(o=>(o.SET="set",o.ADD="add",o.DELETE="delete",o.CLEAR="clear",o))(Dc||{});Ns=Symbol("voodoo:raw"),Os=Symbol("voodoo:isReactive"),Pc=Symbol("voodoo:skip"),Mc=new WeakMap,Sc=(()=>{let e={};for(let t of["includes","indexOf","lastIndexOf"])e[t]=function(...n){let r=Me(this);for(let i=0;i<r.length;i++)dt(r,String(i));let o=r[t].apply(r,n);return o===-1||o===!1?r[t].apply(r,n.map(Me)):o};for(let t of["push","pop","shift","unshift","splice"])e[t]=function(...n){Rc();try{return Me(this)[t].apply(this,n)}finally{Ds()}};return e})();Lm=new Set(["Date","RegExp","Promise","Error","File","FileList","Blob","FormData","URL","URLSearchParams","ArrayBuffer","DataView"]);Sm={get(e,t,n){if(t===Ns)return e;if(t===Os)return!0;let r=Array.isArray(e);if(r&&Object.prototype.hasOwnProperty.call(Sc,t))return Reflect.get(Sc,t,n);let o=Reflect.get(e,t,n);return typeof t=="symbol"?o:(dt(e,t),nn(o)?r&&Ls(t)?o:o.value:Nt(o)?Y(o):o)},set(e,t,n,r){let o=e[t];if(n=Me(n),!Array.isArray(e)&&nn(o)&&!nn(n))return o.value=n,!0;let i=Array.isArray(e)&&Ls(t)?Number(t)<e.length:Object.prototype.hasOwnProperty.call(e,t),s=Reflect.set(e,t,n,r);return e===Me(r)&&(i?Lr(n,o)&&wt(e,"set",t,n):wt(e,"add",t,n)),s},deleteProperty(e,t){let n=Object.prototype.hasOwnProperty.call(e,t),r=Reflect.deleteProperty(e,t);return r&&n&&wt(e,"delete",t),r},has(e,t){let n=Reflect.has(e,t);return typeof t!="symbol"&&dt(e,t),n},ownKeys(e){return dt(e,Array.isArray(e)?"length":tn),Reflect.ownKeys(e)}},Am={get(e,t,n){if(t===Ns)return e;if(t===Os)return!0;let r=e;if(t==="size")return dt(r,tn),Reflect.get(r,"size",r);let o={get(s){dt(r,s);let a=r.get(s);return Nt(a)?Y(a):a},has(s){return dt(r,s),r.has(s)},add(s){s=Me(s);let a=r.has(s);return r.add(s),a||wt(r,"add",s,s),n},set(s,a){let l=r.has(s),c=r.get(s);return r.set(s,Me(a)),l?Lr(a,c)&&wt(r,"set",s,a):wt(r,"add",s,a),n},delete(s){let a=r.has(s),l=r.delete(s);return a&&wt(r,"delete",s),l},clear(){let s=r.size!==0,a=r.clear();return s&&wt(r,"clear"),a},forEach(s,a){return dt(r,tn),r.forEach((l,c)=>{s.call(a,Nt(l)?Y(l):l,Nt(c)?Y(c):c,n)})}};if(t in o)return o[t];if(t===Symbol.iterator||t==="keys"||t==="values"||t==="entries"){dt(r,tn);let s=r[t];return typeof s=="function"?s.bind(r):s}let i=Reflect.get(r,t,r);return typeof i=="function"?i.bind(r):i}};Po=class{constructor(t,n=!1){P(this,"shallow",n);P(this,"__v_isRef",!0);P(this,"_value");P(this,"_rawValue");P(this,"dep",new Set);this._rawValue=Me(t),this._value=n?t:Ac(t)}get value(){return Hc(this),this._value}set value(t){let n=Me(t);Lr(n,this._rawValue)&&(this._rawValue=n,this._value=this.shallow?t:Ac(t),Nc(this))}};Ms=class{constructor(t,n){P(this,"setter",n);P(this,"__v_isRef",!0);P(this,"_value");P(this,"_dirty",!0);P(this,"effect");P(this,"dep",new Set);this.effect=new An(t,{scheduler:()=>{this._dirty||(this._dirty=!0,Nc(this))}})}get value(){return Hc(this),this._dirty&&(this._dirty=!1,this._value=this.effect.run()),this._value}set value(t){this.setter?this.setter(t):X("computed is read-only when there is no setter.")}stop(){this.effect.stop()}}});function y(e,t,n={}){var r,o;Tt.set(e,{name:e,setup:t,priority:(r=n.priority)!=null?r:j.DEFAULT,terminal:(o=n.terminal)!=null?o:!1})}function on(e){return e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").replace(/[_\s]+/g,"-").toLowerCase()}function Io(e,t,n){Xc.has(t)||(Xc.add(t),typeof t=="function"?t(e,n):t.install(e,n))}var x,Tt,j,De,Xc,ce=Es(()=>{"use strict";x={prefix:"v-",autoStart:!0,autoDiscover:!0,root:null,devtools:!1,xrayShortcut:"ctrl+shift+f2",baseURL:"",globals:{},locale:typeof navigator!="undefined"&&navigator.language||"pt-BR",currency:"BRL",injectStyles:!0,cleanAttributes:!0,sanitizeUrls:!0},Tt=new Map,j={IGNORE:100,FOR:90,IF:80,DATA:70,COMPONENT:65,REF:60,BIND:45,MODEL:40,DEFAULT:0,INIT:-10,TRANSITION:-20};De=new Map;Xc=new Set});var Wd={};Co(Wd,{BASE_TOKENS:()=>Ud,ensureTokens:()=>ge,injectStyle:()=>oe});function oe(e,t){if(typeof document=="undefined"||!x.injectStyles||Vd.has(e))return;Vd.add(e);let n=document.createElement("style");n.setAttribute("data-voodoo",e),n.textContent=t,document.head.appendChild(n)}function ge(){oe("tokens",Ud)}var Vd,Ud,He=Es(()=>{"use strict";ce();Vd=new Set;Ud=`
:root{
  --v-primary:#6D3BF5;
...
`});var Hx={};Co(Hx,{default:()=>Px});me();var re=class extends Error{constructor(n,r,o){let i=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${i}`);P(this,"source",r);P(this,"position",o);this.name="VoodooSyntaxError"}},Cm=[">>>=","===","!==","**=","...",">>>","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","&=","|=","^=","<<",">>","+","-","*","/","%","!","<",">","=","&","|","^","~","(",")","[","]","{","}",",",".","?",":",";"],Rm=/[A-Za-z_$À-￿]/,$m=/[A-Za-z0-9_$À-￿]/;function Dm(e){return Rm.test(e)}function Pm(e){return $m.test(e)}function No(e){return e>="0"&&e<="9"}var Fc={n:`
...
`;function Gd(e){let t=e.name||"v-fade";return{enterFrom:e.enterFrom||`${t}-enter-from`,enterActive:e.enterActive||`${t}-enter-active`,enterTo:e.enterTo||`${t}-enter-to`,leaveFrom:e.leaveFrom||`${t}-leave-from`,leaveActive:e.leaveActive||`${t}-leave-active`,leaveTo:e.leaveTo||`${t}-leave-to`}}function Un(e,t){for(let n of t.split(/\s+/).filter(Boolean))e.classList.add(n)}function Wn(e,t){for(let n of t.split(/\s+/).filter(Boolean))e.classList.remove(n)}function Qd(e){let t=getComputedStyle(e),n=r=>Math.max(0,...r.split(",").map(o=>parseFloat(o)*(o.includes("ms")?1:1e3)||0));return Math.max(n(t.transitionDuration)+n(t.transitionDelay),n(t.animationDuration)+n(t.animationDelay))}function Jd(e){requestAnimationFrame(()=>requestAnimationFrame(e))}function Br(e,t={}){oe("transitions",Xd);let n=Gd(t);return ve.reducedMotion?Promise.resolve():new Promise(r=>{Un(e,n.enterFrom),Un(e,n.enterActive),Jd(()=>{var s;Wn(e,n.enterFrom),Un(e,n.enterTo);let o=(s=t.duration)!=null?s:Qd(e),i=()=>{Wn(e,n.enterActive),Wn(e,n.enterTo),r()};o<=0?i():setTimeout(i,o+20)})})}function jr(e,t={}){oe("transitions",Xd);let n=Gd(t);return ve.reducedMotion?Promise.resolve():new Promise(r=>{Un(e,n.leaveFrom),Un(e,n.leaveActive),Jd(()=>{var s;Wn(e,n.leaveFrom),Un(e,n.leaveTo);let o=(s=t.duration)!=null?s:Qd(e),i=()=>{Wn(e,n.leaveActive),Wn(e,n.leaveTo),r()};o<=0?i():setTimeout(i,o+20)})})}function cn(e,t=240){return new Promise(n=>{e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display="block");let r=e.scrollHeight;e.style.overflow="hidden",e.style.height="0px",e.style.paddingTop="0px",e.style.paddingBottom="0px",e.style.transition=`height ${t}ms var(--v-ease, ease), padding ${t}ms var(--v-ease, ease)`,requestAnimationFrame(()=>{e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.height=`${r}px`}),setTimeout(()=>{e.style.removeProperty("height"),e.style.removeProperty("overflow"),e.style.removeProperty("transition"),n()},t+20)})}function dn(e,t=240){return new Promise(n=>{e.style.height=`${e.scrollHeight}px`,e.style.overflow="hidden",e.style.transition=`height ${t}ms var(--v-ease, ease), padding ${t}ms var(--v-ease, ease)`,requestAnimationFrame(()=>{e.style.height="0px",e.style.paddingTop="0px",e.style.paddingBottom="0px"}),setTimeout(()=>{e.style.display="none",e.style.removeProperty("height"),e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("overflow"),e.style.removeProperty("transition"),n()},t+20)})}function _n(e,t=220){return new Promise(n=>{e.style.opacity="0",e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display=""),e.style.transition=`opacity ${t}ms ease`,requestAnimationFrame(()=>{e.style.opacity="1"}),setTimeout(()=>{e.style.removeProperty("transition"),e.style.removeProperty("opacity"),n()},t+20)})}function Kn(e,t=220){return new Promise(n=>{e.style.transition=`opacity ${t}ms ease`,e.style.opacity="0",setTimeout(()=>{e.style.display="none",e.style.removeProperty("transition"),e.style.removeProperty("opacity"),n()},t+20)})}function ci(e){let t=document;typeof t.startViewTransition=="function"&&!ve.reducedMotion?t.startViewTransition(e):e()}me();ce();function jv(e,t,n){try{let o={t:"assign",op:"=",target:We(e),value:{t:"lit",v:n}};H(o,t)}catch(r){K(r,`assignment in "${e}"`)}}function ru(e){let t=x.prefix,n=e.hasAttribute(`${t}transition`),r=e.hasAttribute(`${t}enter-class`)||e.hasAttribute(`${t}leave-class`)||e.hasAttribute(`${t}enter-active-class`)||e.hasAttribute(`${t}leave-active-class`);if(!n&&!r)return null;let o=e.getAttribute(`${t}transition`)||"fade";return{name:o.startsWith("v-")?o:`v-${o}`,enterFrom:e.getAttribute(`${t}enter-class`)||void 0,enterActive:e.getAttribute(`${t}enter-active-class`)||void 0,enterTo:e.getAttribute(`${t}enter-to-class`)||void 0,leaveFrom:e.getAttribute(`${t}leave-class`)||void 0,leaveActive:e.getAttribute(`${t}leave-active-class`)||void 0,leaveTo:e.getAttribute(`${t}leave-to-class`)||void 0,duration:e.hasAttribute(`${t}duration`)?Q(e.getAttribute(`${t}duration`)):void 0}}y("text",({el:e,effect:t,evaluate:n})=>{t(()=>{e.textContent=kt(n());let r=e.firstChild;r&&r.nodeType===3&&Qs(r)})});y("html",e=>{let{el:t,effect:n,evaluate:r,scope:o}=e;Uo(t),n(()=>{let i=r();for(let s of Array.from(t.children))G(s);t.innerHTML=i==null?"":String(i);for(let s of Array.from(t.children))ee(s,o)})});y("show",({el:e,effect:t,evaluate:n})=>{let r=e.style.display==="none"?"":e.style.display,o=!0,i=ru(e);t(()=>{let s=!!n();if(o){o=!1,e.style.display=s?r:"none";return}if(!i){e.style.display=s?r:"none";return}s?(e.style.display=r,Br(e,i)):jr(e,i).then(()=>{e.style.display="none"})})});y("if",({el:e,scope:t,expression:n,effect:r})=>{var p;let o=x.prefix,i=[{expression:n,template:e}],s=e.nextElementSibling;for(;s;)if(s.hasAttribute(`${o}else-if`))i.push({expression:s.getAttribute(`${o}else-if`)||"false",template:s}),s=s.nextElementSibling;else if(s.hasAttribute(`${o}else`)){i.push({expression:null,template:s}),s=s.nextElementSibling;break}else break;let a=document.createComment(x.devtools?` v-if: ${n} `:"");(p=e.parentNode)==null||p.insertBefore(a,e);for(let f of i)Js(f.template),f.template.removeAttribute(`${o}if`),f.template.removeAttribute(`${o}else-if`),f.template.removeAttribute(`${o}else`),Qs(f.template);let l=ru(e),c=-1,d=[],u=()=>{let f=d;if(d=[],!f.length)return;let m=()=>{for(let h of f)G(h),h.remove()};l&&f[0]instanceof HTMLElement?jr(f[0],l).then(m):m()};r(()=>{let f=-1;for(let v=0;v<i.length;v++){let g=i[v];if(g.expression===null||q(g.expression,t,"v-if")){f=v;break}}if(f===c||(c=f,u(),f===-1))return;let m=i[f].template,h=ou(m,a,t);d=h,l&&h[0]instanceof HTMLElement&&Br(h[0],l)}),Xe(e,u)},{priority:j.IF,terminal:!0});function ou(e,t,n,r){let o=t.parentNode;if(!o)return[];let i=[];if(e.tagName==="TEMPLATE"){let s=e.content.cloneNode(!0),a=Array.from(s.childNodes);o.insertBefore(s,t);for(let l of a)i.push(l),l.nodeType===1&&(It(l,n),ee(l,n))}else{let s=e.cloneNode(!0);i.push(s),It(s,n),r?(r.fragment.appendChild(s),r.pending.push([s,n])):(o.insertBefore(s,t),ee(s,n))}return i}y("else-if",()=>{},{priority:j.IF,terminal:!0});y("else",()=>{},{priority:j.IF,terminal:!0});var qv=/^\s*\(?\s*([^)]*?)\s*\)?\s+(?:in|of)\s+(.+?)\s*$/;y("for",({el:e,scope:t,expression:n,effect:r})=>{var v;let o=qv.exec(n);if(!o){K(new Error(`Invalid syntax in v-for="${n}". Use "item in items".`),"v-for");return}let i=o[1].split(",").map(g=>g.trim()).filter(Boolean),s=o[2],[a,l,c]=i,d=x.prefix,u=e.getAttribute(":key")||e.getAttribute(`${d}bind:key`)||e.getAttribute(`${d}key`),p=document.createComment(x.devtools?` v-for: ${n} `:"");(v=e.parentNode)==null||v.insertBefore(p,e);let f=e.cloneNode(!0);f.removeAttribute(`${d}for`),f.removeAttribute(":key"),f.removeAttribute(`${d}bind:key`),f.removeAttribute(`${d}key`),Js(e);let m=[];Xe(p,()=>{for(let g of m)for(let b of g.nodes)G(b),b.remove();m=[]}),r(()=>{var se,O,pe;let g=q(s,t,"v-for"),b=Vv(g,a,l,c),w=new Map;for(let ae of m)w.set(ae.key,ae);let T=[],k=new Set,A={fragment:document.createDocumentFragment(),pending:[]};b.forEach((ae,R)=>{let S=u?q(u,t.child(ae),":key"):`__index_${R}`;u&&k.has(S)&&ed(e,S,n);let B=w.get(S);if(B&&!k.has(S)){k.add(S);for(let[en,Ln]of Object.entries(ae))B.data[en]=Ln;T.push(B);return}let Ve=t.reactiveChild(ae),Ue=ou(f,p,Ve,A);k.add(S),T.push({key:S,scope:Ve,nodes:Ue,data:Ve.data})}),A.fragment.firstChild&&((se=p.parentNode)==null||se.insertBefore(A.fragment,p));for(let[ae,R]of A.pending)ee(ae,R);let D=new Set(T);for(let ae of m)if(!(k.has(ae.key)&&D.has(ae)))for(let R of ae.nodes)G(R),R.remove();let C=p;for(let ae=T.length-1;ae>=0;ae--){let R=T[ae],S=R.nodes[R.nodes.length-1];if(S&&S.nextSibling!==C)for(let B of R.nodes)(O=p.parentNode)==null||O.insertBefore(B,C);C=(pe=R.nodes[0])!=null?pe:C}m=T})},{priority:j.FOR,terminal:!0});function Vv(e,t,n,r){let o=[];if(Array.isArray(e))return e.forEach((i,s)=>{let a={[t]:i};n&&(a[n]=s),o.push(a)}),o;if(typeof e=="number"){for(let i=1;i<=e;i++){let s={[t]:i};n&&(s[n]=i-1),o.push(s)}return o}return typeof e=="string"?(Array.from(e).forEach((i,s)=>{let a={[t]:i};n&&(a[n]=s),o.push(a)}),o):(e&&typeof e=="object"&&(e instanceof Map?Array.from(e.entries()):e instanceof Set?Array.from(e).map((s,a)=>[a,s]):Object.entries(e)).forEach(([s,a],l)=>{let c={[t]:a};n&&(c[n]=s),r&&(c[r]=l),o.push(c)}),o)}var Uv=new Set(["disabled","checked","readonly","required","selected","hidden","open","multiple","autofocus","novalidate","inert"]),Wv=new Set(["href","src","action","formaction","xlink:href","ping","poster"]),_v=/[\s\x00-\x1f]/g;function Kv(e){let t=e.replace(_v,"").toLowerCase();return t.startsWith("javascript:")||t.startsWith("vbscript:")||t.startsWith("data:text/html")||t.startsWith("data:application/xhtml")}function Zd(e,t,n,r=!1,o=!1){if(t==="class")return iu(e,n);if(t==="style")return Ea(e,n);if(x.sanitizeUrls&&!o&&t==="srcdoc"){sn(`:srcdoc refused in ${St(e)}: the value becomes a document with active script inside the iframe, the same way v-html becomes markup. If the content is trusted, write :srcdoc.dangerous="..."; to turn off this protection on the entire application, set V.config.sanitizeUrls = false.`),e.removeAttribute(t);return}if(x.sanitizeUrls&&!r){if(Wv.has(t)&&typeof n=="string"&&Kv(n)){sn(`value refused in :${t} of ${St(e)}: "${n.slice(0,60)}" uses a scheme that executes code. Use an http(s) or relative address. To turn off this protection, set V.config.sanitizeUrls = false.`),e.removeAttribute(t);return}if(t.length>2&&/^on[a-z]/.test(t)){sn(`attribute "${t}" refused in ${St(e)}: linking event by attribute creates an inline handler. Use @${t.slice(2)}="..." instead.`),e.removeAttribute(t);return}}if(r){e[t]=n;return}if(Uv.has(t)){n===!1||n==null?e.removeAttribute(t):e.setAttribute(t,""),t in e&&(e[t]=!!n);return}if(t==="value"&&"value"in e){e.value=n==null?"":n;return}n==null||n===!1?e.removeAttribute(t):e.setAttribute(t,n===!0?"":String(n))}var eu=new WeakMap;function iu(e,t){let n=eu.get(e);n||(n=(e.getAttribute("class")||"").split(/\s+/).filter(Boolean),eu.set(e,n));let r=new Set(n);su(t,r),e.setAttribute("class",Array.from(r).join(" ")),e.getAttribute("class")||e.removeAttribute("class")}function su(e,t){if(e){if(typeof e=="string"){for(let n of e.split(/\s+/))n&&t.add(n);return}if(Array.isArray(e)){for(let n of e)su(n,t);return}if(typeof e=="object"){for(let[n,r]of Object.entries(e))if(r)for(let o of n.split(/\s+/))o&&t.add(o)}}}function Ea(e,t){if(t){if(typeof t=="string"){e.style.cssText=t;return}if(Array.isArray(t)){for(let n of t)Ea(e,n);return}for(let[n,r]of Object.entries(t)){if(r==null||r===!1){e.style.removeProperty(n);continue}let o=n.startsWith("--")?n:n.replace(/[A-Z]/g,s=>`-${s.toLowerCase()}`),i=String(r);o.startsWith("--"),e.style.setProperty(o,i)}}}y("bind",({el:e,arg:t,modifiers:n,effect:r,evaluate:o,expression:i})=>{if(!t){r(()=>{let l=o();if(l&&typeof l=="object")for(let[c,d]of Object.entries(l))Zd(e,c,d)});return}if(t==="key")return;let s=!!n.prop,a=!!n.dangerous;r(()=>{Zd(e,t,o(),s,a)})},{priority:j.BIND});y("class",({el:e,effect:t,evaluate:n})=>{t(()=>iu(e,n()))});y("style",({el:e,effect:t,evaluate:n})=>{t(()=>Ea(e,n()))});var tu={enter:["Enter"],esc:["Escape"],escape:["Escape"],space:[" ","Spacebar"],tab:["Tab"],delete:["Delete","Backspace"],backspace:["Backspace"],up:["ArrowUp"],down:["ArrowDown"],left:["ArrowLeft"],right:["ArrowRight"]},Yv=["ctrl","shift","alt","meta"];function nu(e,t,n,r){let o=n.detail,i=n.__voodoo===!0,s=t.child({$event:i?o:n,$rawEvent:n,$el:r,$detail:o});try{let a=We(e),l=H(a,s);typeof l=="function"&&(a.t==="id"||a.t==="member")&&l.call(t.data,i?o:n)}catch(a){K(a,`event ${n.type} ("${e}")`)}}var Xv={hover:"mouseenter",unhover:"mouseleave",tap:"click",press:"pointerdown",release:"pointerup",rightclick:"contextmenu",enterkey:"keydown",type:"input",submitform:"submit"},au={hold(e,t,n,r){let o=Q(typeof n.duration=="string"&&n.duration||Object.keys(n).find(d=>/^[\d.]+(ms|s)?$/.test(d))||e.getAttribute(`${x.prefix}hold-duration`)||800,800),i=null,s=!1,a=d=>{s=!1,e.classList.add("v-holding"),e.style.setProperty("--v-hold-duration",`${o}ms`),i=setTimeout(()=>{s=!0,e.classList.remove("v-holding"),t(d)},o)},l=()=>{i&&clearTimeout(i),i=null,e.classList.remove("v-holding")},c=d=>{s&&(d.preventDefault(),d.stopPropagation(),s=!1)};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",l),e.addEventListener("pointerleave",l),e.addEventListener("pointercancel",l),e.addEventListener("click",c,!0),r(()=>{l(),e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",l),e.removeEventListener("pointerleave",l),e.removeEventListener("pointercancel",l),e.removeEventListener("click",c,!0)})},outside(e,t,n,r){let o=i=>{e.isConnected&&(e===i.target||e.contains(i.target)||t(i))};document.addEventListener("click",o,!0),r(()=>document.removeEventListener("click",o,!0))},visible(e,t,n,r){var i,s;if(typeof IntersectionObserver=="undefined"){t(new CustomEvent("visible"));return}let o=new IntersectionObserver(a=>{for(let l of a)l.isIntersecting&&(t(new CustomEvent("visible",{detail:l})),n.repeat!==!0&&o.unobserve(e))},{threshold:Number((i=n.threshold)!=null?i:.1),rootMargin:String((s=n.margin)!=null?s:"0px")});o.observe(e),r(()=>o.disconnect())}};for(let e of["left","right","up","down"])au[`swipe${e}`]=(t,n,r,o)=>{let i=0,s=0,a=!1,l=d=>{a=!0,i=d.clientX,s=d.clientY},c=d=>{if(!a)return;a=!1;let u=d.clientX-i,p=d.clientY-s,f=40;(e==="left"?u<-f&&Math.abs(u)>Math.abs(p):e==="right"?u>f&&Math.abs(u)>Math.abs(p):e==="up"?p<-f&&Math.abs(p)>Math.abs(u):p>f&&Math.abs(p)>Math.abs(u))&&n(new CustomEvent(`swipe${e}`,{detail:{dx:u,dy:p}}))};t.addEventListener("pointerdown",l),window.addEventListener("pointerup",c),o(()=>{t.removeEventListener("pointerdown",l),window.removeEventListener("pointerup",c)})};function lu(e,t,n,r,o,i){var f;let s=(f=Xv[t])!=null?f:t,a=au[t];if(a){a(e,m=>{o.prevent&&m.preventDefault(),o.stop&&m.stopPropagation(),nu(n,r,m,e)},o,i);return}let l=o.window?window:o.document||o.outside?document:e,c=m=>{if(!(o.self&&m.target!==e)&&!(o.outside&&(e===m.target||e.contains(m.target)||!e.isConnected))){if(m instanceof KeyboardEvent){for(let v of Yv)if(o[v]&&!m[`${v}Key`])return;let h=Object.keys(o).filter(v=>v in tu||/^[a-z0-9]$/.test(v));if(h.length&&!h.some(g=>{let b=tu[g];return b?b.includes(m.key):m.key.toLowerCase()===g}))return}o.prevent&&m.preventDefault(),o.stop&&m.stopPropagation(),nu(n,r,m,e)}},d=o.debounce;d!==void 0&&(c=Ke(c,Q(d===!0?250:d,250)));let u=o.throttle;u!==void 0&&(c=Hr(c,Q(u===!0?250:u,250)));let p={capture:!!o.capture,once:!!o.once,passive:!!o.passive};l.addEventListener(s,c,p),i(()=>l.removeEventListener(s,c,p))}y("on",({el:e,arg:t,expression:n,scope:r,modifiers:o,cleanup:i})=>{t&&lu(e,t,n,r,o,i)});var Gv=["click","dblclick","input","change","keyup","keydown","keypress","mouseenter","mouseleave","mouseover","mousedown","mouseup","contextmenu","wheel","paste","dragstart","dragover","dragleave","drop"];for(let e of Gv)y(e,({el:t,expression:n,scope:r,modifiers:o,cleanup:i})=>{lu(t,e,n,r,o,i)});y("model",({el:e,expression:t,scope:n,modifiers:r,effect:o,cleanup:i})=>{let s=e,a=s.tagName,l=(s.getAttribute("type")||"text").toLowerCase(),c=a==="INPUT"&&l==="checkbox",d=a==="INPUT"&&l==="radio",u=a==="SELECT",p=u&&s.multiple,f=a==="INPUT"&&l==="file",m=l==="number"||l==="range",h=!!r.lazy,v=!!r.number||m,g=!!r.trim,b=r.debounce?Q(r.debounce===!0?250:r.debounce,250):e.getAttribute(`${x.prefix}debounce`)?Q(e.getAttribute(`${x.prefix}debounce`),250):0,w=h||u||c||d||f?"change":"input",T=()=>{var A,D;let k;if(c){let C=q(t,n,"v-model");if(Array.isArray(C)){let se=s.value,O=[...C],pe=O.indexOf(se);s.checked&&pe===-1?O.push(se):!s.checked&&pe>-1&&O.splice(pe,1),k=O}else k=s.checked}else if(d){if(!s.checked)return;k=s.value}else if(p)k=Array.from(s.selectedOptions).map(C=>C.value);else if(f)k=r.single?(D=(A=s.files)==null?void 0:A[0])!=null?D:null:s.files;else if(k=s.value,g&&typeof k=="string"&&(k=k.trim()),v&&typeof k=="string"){let C=k===""?null:Number(k);k=C===null||Number.isNaN(C)?k:C}jv(t,n,k)};b>0&&(T=Ke(T,b)),s.addEventListener(w,T),i(()=>s.removeEventListener(w,T)),o(()=>{let k=q(t,n,"v-model");if(c){s.checked=Array.isArray(k)?k.includes(s.value):!!k;return}if(d){s.checked=String(k)===s.value;return}if(p){let D=Array.isArray(k)?k.map(String):[];for(let C of Array.from(s.options))C.selected=D.includes(C.value);return}if(f)return;let A=k==null?"":String(k);s.value!==A&&(s.value=A),u&&s.value!==A&&ut(()=>{s.value!==A&&(s.value=A)})})},{priority:j.MODEL});y("init",({el:e,expression:t,scope:n})=>{Se(()=>{let r=n.child({$el:e}),o=q(t,r,"v-init");typeof o=="function"&&o.call(n.data)})},{priority:j.INIT});y("ref",({el:e,expression:t,scope:n,cleanup:r})=>{var s;let o=t.trim();if(!o)return;let i=(s=n.owner)!=null?s:n;i.refs[o]=e,r(()=>{i.refs[o]===e&&delete i.refs[o]})},{priority:j.REF});y("effect",({effect:e,evaluate:t})=>{e(()=>{t()})});y("watch",({el:e,expression:t,scope:n,effect:r})=>{let o=e.getAttribute(`${x.prefix}model`),i,s=!0;r(()=>{let a=o?q(o,n,"v-watch"):q(t,n,"v-watch");if(s){s=!1,i=a;return}if(a===i)return;let l=i;if(i=a,o){let c=n.child({$value:a,$old:l,$el:e}),d=q(t,c,"v-watch");typeof d=="function"&&d.call(n.data,a,l)}})});y("cloak",({el:e})=>{e.removeAttribute(`${x.prefix}cloak`)});y("once",({el:e,effect:t,evaluate:n})=>{let r=n();r!==void 0&&(e.textContent=kt(r))});y("teleport",({el:e,expression:t,cleanup:n})=>{var s;let r=t.trim()||"body",o=r==="body"?document.body:document.querySelector(r);if(!o){K(new Error(`v-teleport destination not found: ${r}`),"v-teleport");return}let i=document.createComment(" v-teleport ");(s=e.parentNode)==null||s.insertBefore(i,e),o.appendChild(e),n(()=>{var a;(a=i.parentNode)==null||a.insertBefore(e,i),i.remove()})},{priority:j.DATA});for(let e of["transition","enter-class","enter-active-class","enter-to-class","leave-class","leave-active-class","leave-to-class","duration","key","slot","ignore","pre"])y(e,()=>{},{priority:j.TRANSITION});y("data",()=>{},{priority:j.DATA});y("component",()=>{},{priority:j.COMPONENT});me();ce();var uu=()=>x.prefix;function V(e,t){return Te(e,`${uu()}${t}`)}function La(e,t){return Ft(e,`${uu()}${t}`)}function Qv(e,t){var s,a,l;let n=V(e,"target"),r=V(e,"loading"),o={},i=V(e,"headers");if(i){let c=q(i,t,"v-headers");c&&typeof c=="object"&&(o=c)}return{target:n?document.querySelector(n):null,swap:V(e,"swap")||"innerHTML",loadingTarget:r?document.querySelector(r):null,loadingClass:V(e,"loading-class")||"v-loading",disableWhileLoading:La(e,"disable-loading"),confirmMessage:V(e,"confirm"),toastSuccess:V(e,"toast-success"),toastError:V(e,"toast-error"),onSuccess:V(e,"on-success"),onError:V(e,"on-error"),onComplete:V(e,"on-complete"),cacheMs:Q((s=V(e,"cache"))!=null?s:void 0,0),retry:Number((a=V(e,"retry"))!=null?a:0),timeout:Q((l=V(e,"timeout"))!=null?l:void 0,he.defaults.timeout),storeAs:V(e,"as"),jsonPath:V(e,"json-path"),templateSelector:V(e,"template"),offlineQueue:La(e,"offline-queue"),headers:o,redirect:V(e,"redirect"),scrollTo:V(e,"scroll-to")}}function cu(e,t,n,r){var i,s;let o=a=>{for(let l of Array.from(a))l.nodeType===1&&ee(l,r)};switch(n){case"none":return;case"delete":G(e),e.remove();return;case"textContent":e.textContent=t;return;case"outerHTML":case"replace":{let a=document.createElement("template");a.innerHTML=t;let l=Array.from(a.content.childNodes);G(e),e.replaceWith(a.content),o(l);return}case"beforebegin":case"afterbegin":case"beforeend":case"afterend":{let a=new Set(Array.from((s=(i=e.parentElement)==null?void 0:i.childNodes)!=null?s:[]));e.insertAdjacentHTML(n,t);let l=n==="afterbegin"||n==="beforeend"?e:e.parentElement;if(l)for(let c of Array.from(l.childNodes))c.nodeType===1&&!a.has(c)&&ee(c,r);return}case"append":e.insertAdjacentHTML("beforeend",t),o(e.childNodes);return;case"prepend":e.insertAdjacentHTML("afterbegin",t),o(e.childNodes);return;default:{for(let a of Array.from(e.children))G(a);e.innerHTML=t,o(e.childNodes)}}}function di(e,t=0){if(e==null)return"";if(typeof e!="object")return I(String(e));if(Array.isArray(e)){if(!e.length)return'<p class="v-json-empty">No results.</p>';if(e.every(o=>o&&typeof o=="object"&&!Array.isArray(o))&&t===0){let o=Array.from(e.reduce((a,l)=>{for(let c of Object.keys(l))a.add(c);return a},new Set)),i=o.map(a=>`<th>${I(a)}</th>`).join(""),s=e.map(a=>`<tr>${o.map(l=>`<td>${di(a[l],t+1)}</td>`).join("")}</tr>`).join("");return`<table class="v-json-table"><thead><tr>${i}</tr></thead><tbody>${s}</tbody></table>`}return`<ul class="v-json-list">${e.map(o=>`<li>${di(o,t+1)}</li>`).join("")}</ul>`}let n=Object.entries(e);return n.length?`<dl class="v-json-object">${n.map(([r,o])=>`<dt>${I(r)}</dt><dd>${di(o,t+1)}</dd>`).join("")}</dl>`:""}function Jv(e,t,n,r){let o=document.querySelector(e);if(!o){K(new Error(`Template not found: ${e}`),"v-template");return}for(let s of Array.from(r.children))G(s);r.innerHTML="";let i=Array.isArray(t)?t:[t];for(let[s,a]of i.entries()){let l=o.content.cloneNode(!0),c=Array.from(l.childNodes);r.appendChild(l);let d=n.reactiveChild({item:a,index:s,...a&&typeof a=="object"?a:{}});for(let u of c)u.nodeType===1&&ee(u,d)}}var ka=new WeakMap;async function qr(e){var u,p,f,m,h;let{el:t,scope:n,method:r}=e,o=Qv(t,n),i=Tt.has("confirm");if(o.confirmMessage&&!i&&!await Zv(o.confirmMessage))return;(u=ka.get(t))==null||u.abort();let s=new AbortController;ka.set(t,s);let a=(p=o.target)!=null?p:t,l=t instanceof HTMLFormElement?t.querySelector('[type="submit"], button:not([type])'):null,c=()=>{if(t.classList.add(o.loadingClass),t.setAttribute("aria-busy","true"),o.loadingTarget&&o.loadingTarget.style.removeProperty("display"),o.disableWhileLoading){let v=l!=null?l:t;"disabled"in v&&(v.disabled=!0)}},d=()=>{if(t.classList.remove(o.loadingClass),t.removeAttribute("aria-busy"),o.loadingTarget&&(o.loadingTarget.style.display="none"),o.disableWhileLoading){let v=l!=null?l:t;"disabled"in v&&(v.disabled=!1)}};c(),Yn(t,"voodoo:before-request",{method:r,url:e.url});try{let v=await he.request({url:e.url,method:r,body:e.body,params:e.params,headers:o.headers,timeout:o.timeout,retry:o.retry,cache:o.cacheMs||void 0,signal:s.signal,offlineQueue:o.offlineQueue}),g=xa(v.data,o.jsonPath);o.storeAs?n.set(o.storeAs,g):o.templateSelector?Jv(o.templateSelector,g,n,a):typeof g=="string"?cu(a,g,o.swap,n):g!=null&&(eh(),cu(a,di(g),o.swap,n)),o.toastSuccess&&it.success(o.toastSuccess),o.onSuccess&&Ta(o.onSuccess,n,t,{data:g,response:v}),Yn(t,"voodoo:success",{data:g,response:v}),o.scrollTo&&((f=document.querySelector(o.scrollTo))==null||f.scrollIntoView({behavior:"smooth"})),o.redirect&&location.assign(o.redirect)}catch(v){if((v==null?void 0:v.name)==="AbortError")return;let g=v instanceof ke?(m=wa(v))!=null?m:v.message:(h=v==null?void 0:v.message)!=null?h:"Unknown error";o.toastError?it.error(o.toastError):o.onError||it.error(g),o.onError&&Ta(o.onError,n,t,{error:v,message:g}),Yn(t,"voodoo:error",{error:v,message:g}),K(v,`request ${r} ${e.url}`)}finally{d(),ka.delete(t),o.onComplete&&Ta(o.onComplete,n,t,{}),Yn(t,"voodoo:complete",{})}}function Yn(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function Ta(e,t,n,r){var s;let o=t.child({$el:n,...r}),i=q(e,o,"HTTP callback");typeof i=="function"&&i.call(t.data,(s=r.data)!=null?s:r.error)}async function Zv(e){let t=globalThis.V;return t&&typeof t.confirm=="function"&&t.confirm!==globalThis.confirm?!!await t.confirm(e):globalThis.confirm(e)}var du=!1;function eh(){du||(du=!0,Promise.resolve().then(()=>(He(),Wd)).then(({injectStyle:e})=>{e("json-render",`
...
`)}))}function th(e){let t=e.tagName;if(t==="FORM")return"submit";if(t==="INPUT"||t==="SELECT"||t==="TEXTAREA"){let n=e.type;return n==="button"||n==="submit"?"click":"change"}return"click"}function nh({el:e,cleanup:t,run:n}){var d,u;let r=V(e,"trigger")||th(e),[o,...i]=r.split(/[.\s]+/),s=Q((d=V(e,"poll"))!=null?d:void 0,0);if(s>0){n();let p=setInterval(()=>{document.visibilityState==="visible"&&n()},s);t(()=>clearInterval(p));return}if(o==="load"||o==="ready"){n();return}if(o==="visible"||o==="revealed"){if(typeof IntersectionObserver=="undefined"){n();return}let p=new IntersectionObserver(f=>{for(let m of f)m.isIntersecting&&(n(),i.includes("repeat")||p.unobserve(e))},{rootMargin:"80px"});p.observe(e),t(()=>p.disconnect());return}let a=i.includes("once"),l=Q((u=V(e,"debounce"))!=null?u:void 0,0),c=p=>{(e.tagName==="FORM"||e.href)&&p.preventDefault(),n(p)};l>0&&(c=Ke(c,l)),e.addEventListener(o,c,{once:a}),t(()=>e.removeEventListener(o,c))}var rh=[["get","GET"],["post","POST"],["put","PUT"],["patch","PATCH"],["delete","DELETE"]];for(let[e,t]of rh)y(e,({el:n,scope:r,expression:o,cleanup:i})=>{nh({el:n,scope:r,cleanup:i,run:a=>{let l=Vr(o,r);if(!l)return;let c=V(n,"body")||V(n,"data-body"),d=c?q(c,r.child({$event:a}),"v-body"):void 0,u=V(n,"params"),p=u?q(u,r,"v-params"):void 0;qr({el:n,scope:r,method:t,url:l,body:d,params:p,event:a})}})});function Vr(e,t){let n=e.trim();if(!n)return"";if((/^[./#?]/.test(n)||/^https?:\/\//i.test(n)||/^[\w-]+\/[\w\-/.]*$/.test(n))&&!/[+`'"]|\$\{/.test(n))return n;let o=q(n,t,"URL");return typeof o=="string"?o:n}y("load",({el:e,scope:t,expression:n})=>{let r=Vr(n,t);r&&qr({el:e,scope:t,method:"GET",url:r})});y("load-visible",({el:e,scope:t,cleanup:n,expression:r})=>{let o=Vr(r,t);if(!o)return;if(typeof IntersectionObserver=="undefined"){qr({el:e,scope:t,method:"GET",url:o});return}let i=new IntersectionObserver(s=>{for(let a of s)a.isIntersecting&&(i.unobserve(e),qr({el:e,scope:t,method:"GET",url:o}))},{rootMargin:"120px"});i.observe(e),n(()=>i.disconnect())});y("search",({el:e,scope:t,expression:n,cleanup:r})=>{var u,p;let o=e,i=Vr(n,t),s=V(e,"param")||o.getAttribute("name")||"q",a=Q((u=V(e,"debounce"))!=null?u:void 0,300),l=Number((p=V(e,"min-length"))!=null?p:0),c=Ke(()=>{let f=o.value.trim();f.length<l||qr({el:e,scope:t,method:"GET",url:i,params:{[s]:f}})},a),d=()=>c();o.addEventListener("input",d),r(()=>{o.removeEventListener("input",d),c.cancel()})});y("resource",({el:e,scope:t,expression:n,cleanup:r})=>{var l,c,d,u;let o=n.indexOf(":"),i=V(e,"as")||"resource",s=n.trim();if(o>-1){let p=n.slice(0,o).trim();/^[A-Za-z_$][\w$]*$/.test(p)&&(i=p,s=n.slice(o+1).trim())}let a=li(()=>Vr(s,t),{method:(V(e,"method")||"GET").toUpperCase(),params:()=>V(e,"params")?q(V(e,"params"),t,"v-params"):void 0,cache:Q((l=V(e,"cache"))!=null?l:void 0,0)||void 0,retry:Number((c=V(e,"retry"))!=null?c:0),timeout:Q((d=V(e,"timeout"))!=null?d:void 0,he.defaults.timeout),jsonPath:V(e,"json-path"),poll:Q((u=V(e,"poll"))!=null?u:void 0,0),manual:La(e,"manual"),onSuccess:p=>Yn(e,"voodoo:success",{data:p}),onError:(p,f)=>Yn(e,"voodoo:error",{error:p,message:f})});t.set(i,a),r(()=>a.stop())},{priority:j.DATA});for(let e of["target","swap","trigger","poll","param","params","body","data-body","headers","cache","retry","timeout","as","json-path","template","offline-queue","min-length","scroll-to","manual","debounce","throttle","indicator"])y(e,()=>{},{priority:j.TRANSITION});md(Td);kd(It);Rd(pu);Yd();var Ur=new Map;function fu(e,t){let n=Ur.get(e);return n||Ur.set(e,n=new Set),n.add(t),()=>n.delete(t)}function oh(e,t){let n=fu(e,r=>{n(),t(r)});return n}function ih(e,t){let n=Ur.get(e);if(n)for(let r of[...n])try{r(t)}catch(o){K(o,`event "${e}"`)}}function sh(e,t){var n;if(!t){Ur.delete(e);return}(n=Ur.get(e))==null||n.delete(t)}function pu(e,t){var r,o;let n=typeof t=="function"?{mounted:t,updated:t}:t;y(e,i=>{var d,u;let s,a=!1,l=p=>{var f,m;return{el:i.el,value:p,oldValue:s,arg:i.arg,modifiers:i.modifiers,expression:i.expression,scope:i.scope,instance:(m=(f=i.scope.owner)==null?void 0:f.component)!=null?m:null}},c=n.raw?i.expression:i.evaluate();(d=n.created)==null||d.call(n,i.el,l(c)),(u=n.beforeMount)==null||u.call(n,i.el,l(c)),i.effect(()=>{var m,h;let p=n.raw?i.expression:i.evaluate();if(!a){a=!0,s=p,(m=n.mounted)==null||m.call(n,i.el,l(p));return}if(p===s)return;let f=l(p);(h=n.updated)==null||h.call(n,i.el,f),s=p}),i.cleanup(()=>{var f,m;let p=l(s);(f=n.beforeUnmount)==null||f.call(n,i.el,p),(m=n.unmounted)==null||m.call(n,i.el,p)})},{priority:(r=n.priority)!=null?r:j.DEFAULT,terminal:(o=n.terminal)!=null?o:!1})}function ah(e){return Object.defineProperties(_e.data,Object.getOwnPropertyDescriptors(e)),_e.data}var lh="0.10.0",ui={...ma,version:lh,config:x,reactive:Y,ref:Mr,shallowRef:zs,computed:Sr,effect:Fe,watch:Ie,watchEffect:js,nextTick:ut,toRaw:Me,markRaw:Fs,unref:Bs,stop:Ps,effectScope:Hs,EffectScope:rt,flushSync:Cs,data:ah,store:Hd,stores:Fn,removeStore:Nd,storeNames:Go,scope:_e,component:zt,components:De,directive:pu,directives:Tt,magic:N,magics:Cr,createApp:$d,start:yd,whenReady:Ko,whenElement:Yo,walk:ee,refresh:wd,destroy:G,stopObserving:xd,getScope:ot,findScope:Ae,addCleanup:Xe,parseAttribute:$n,parse:We,tokenize:Oo,evaluate:H,evaluateIn:q,stringify:kt,clearParseCache:Vc,globals:Ne,http:he,request:jt,HttpError:ke,resource:li,toast:it,storage:ue,session:ri,cookie:oi,cache:ii,url:Vt,theme:ft,clipboard:ai,screen:Ge,network:Ut,enter:Br,leave:jr,fadeIn:_n,fadeOut:Kn,slideUp:dn,slideDown:cn,viewTransition:ci,injectStyle:oe,ensureTokens:ge,on:fu,once:oh,off:sh,emit:ih,use(e,t){Io(ui,e,t)},onError(e){Rs(e)},instances:Ct,Scope:Lt,PRIORITY:j,VoodooSyntaxError:re,VoodooRuntimeError:Ee};Pd(ui);me();var ch=new Set(["animation-iteration-count","aspect-ratio","border-image-slice","column-count","flex","flex-grow","flex-shrink","font-weight","grid-area","grid-column","grid-row","line-height","opacity","order","orphans","scale","tab-size","widows","z-index","zoom"]);function Eu(e){return e.startsWith("--")?e:e.replace(/[A-Z]/g,t=>`-${t.toLowerCase()}`)}function st(e){return e.length<2?e:Array.from(new Set(e))}function un(e){return String(e!=null?e:"").split(/\s+/).filter(Boolean)}function Ma(e){if(typeof document=="undefined")return[];let t=document.createElement("template");t.innerHTML=e.trim();let n=[];for(let r of Array.from(t.content.children))n.push(r);return n}function ku(e){return e.length>2&&e.charCodeAt(0)===60&&e.endsWith(">")}function dh(e){if(e==null)return typeof document=="undefined"?[]:[document];if(e instanceof pt)return e.toArray();if(typeof e=="string")return fn(e);if(typeof e=="function")return typeof document=="undefined"?[]:[document];let t=fn(e);return t.length?t:typeof document=="undefined"?[]:[document]}function fn(e,t){if(e==null)return[];if(typeof e=="string"){let o=e.trim();if(!o)return[];if(ku(o))return Ma(o);let i=[];for(let s of dh(t))try{for(let a of Array.from(s.querySelectorAll(o)))i.push(a)}catch(a){}return st(i)}if(e instanceof pt)return e.toArray();if(typeof e=="function")return[];let n=e;if(typeof n.nodeType=="number"){if(n.nodeType===1)return[n];if(n.nodeType===9){let o=n;return o.documentElement?[o.documentElement]:[]}return n.nodeType===11?Array.from(n.children):[]}let r=e;if(typeof r.length=="number"){let o=[];for(let i=0;i<r.length;i++){let s=r[i];s&&s.nodeType===1&&o.push(s)}return st(o)}return[]}function mu(e){if(e==null)return[];if(typeof e=="string"){let r=e;return ku(r.trim())?Ma(r):[document.createTextNode(r)]}if(e instanceof pt)return e.toArray();if(typeof e=="function")return[];let t=e;if(typeof t.nodeType=="number")return[t];let n=e;if(typeof n.length=="number"){let r=[];for(let o=0;o<n.length;o++)n[o]&&r.push(n[o]);return r}return[]}function fi(e,t,n){let r=Eu(t);if(n===null||n===""){e.style.removeProperty(r);return}let o=typeof n=="number"&&!ch.has(r)&&!r.startsWith("--")?`${n}px`:String(n);e.style.setProperty(r,o)}function uh(e,t){for(let[n,r]of Object.entries(t))fi(e,n,r)}function vu(e){if(e===void 0)return;if(e==="")return"";if(e==="true")return!0;if(e==="false")return!1;if(e==="null")return null;if(/^-?\d+(\.\d+)?$/.test(e))return Number(e);let t=e.charCodeAt(0);if(t===123||t===91||t===34)try{return JSON.parse(e)}catch(n){return e}return e}function hu(e){return e.replace(/-([a-z0-9])/g,(t,n)=>n.toUpperCase())}var Tu=new WeakMap;function gu(e){return e.hasAttribute("hidden")||e.style.display==="none"?!0:e.isConnected?getComputedStyle(e).display==="none":!1}function bu(e){e.removeAttribute("hidden");let t=Tu.get(e);t!==void 0&&t!=="none"?e.style.display=t:e.style.removeProperty("display"),e.isConnected&&getComputedStyle(e).display==="none"&&(e.style.display="block")}function yu(e){let t=e.style.display;t&&t!=="none"&&Tu.set(e,t),e.style.display="none"}var xu="input,select,textarea";function wu(e){return e.matches(xu)?[e]:Array.from(e.querySelectorAll(xu))}function fh(e){let t=e;if(!t.name||t.disabled)return!1;let n=(t.getAttribute("type")||"").toLowerCase();return!(n==="file"||n==="submit"||n==="reset"||n==="button"||(n==="checkbox"||n==="radio")&&!t.checked)}var pi=new WeakMap;function ph(e){let t=pi.get(e);return t||pi.set(e,t=[]),t}var pt=class e{constructor(t=[]){P(this,"length");P(this,"elements");this.elements=t,this.length=t.length;let n=this;for(let r=0;r<t.length;r++)n[r]=t[r]}[Symbol.iterator](){return this.elements[Symbol.iterator]()}find(t){let n=[];for(let r of this.elements)try{for(let o of Array.from(r.querySelectorAll(t)))n.push(o)}catch(o){}return new e(st(n))}closest(t){let n=[];for(let r of this.elements){let o=r.closest(t);o&&n.push(o)}return new e(st(n))}parent(t){let n=[];for(let r of this.elements){let o=r.parentElement;o&&(!t||o.matches(t))&&n.push(o)}return new e(st(n))}parents(t){let n=[];for(let r of this.elements){let o=r.parentElement;for(;o;)(!t||o.matches(t))&&n.push(o),o=o.parentElement}return new e(st(n))}children(t){let n=[];for(let r of this.elements)for(let o of Array.from(r.children))(!t||o.matches(t))&&n.push(o);return new e(st(n))}siblings(t){let n=[];for(let r of this.elements){let o=r.parentElement;if(o)for(let i of Array.from(o.children))i!==r&&(!t||i.matches(t))&&n.push(i)}return new e(st(n))}next(t){let n=[];for(let r of this.elements){let o=r.nextElementSibling;o&&(!t||o.matches(t))&&n.push(o)}return new e(st(n))}prev(t){let n=[];for(let r of this.elements){let o=r.previousElementSibling;o&&(!t||o.matches(t))&&n.push(o)}return new e(st(n))}first(){return this.eq(0)}last(){return this.eq(-1)}eq(t){let n=t<0?this.elements.length+t:t,r=this.elements[n];return new e(r?[r]:[])}filter(t){let n=this.elements.filter((r,o)=>typeof t=="function"?t(r,o):r.matches(t));return new e(n)}not(t){let n=this.elements.filter((r,o)=>typeof t=="function"?!t(r,o):!r.matches(t));return new e(n)}has(t){let n=this.elements.filter(r=>typeof t=="string"?r.querySelector(t)!==null:r.contains(t));return new e(n)}is(t){return this.elements.some((n,r)=>typeof t=="function"?t(n,r):n.matches(t))}map(t){return this.elements.map((n,r)=>t(n,r))}each(t){for(let n=0;n<this.elements.length;n++){let r=this.elements[n];if(t.call(r,r,n)===!1)break}return this}get(...t){if(!t.length)return this.toArray();let n=Number(t[0]);return this.elements[n<0?this.elements.length+n:n]}toArray(){return this.elements.slice()}add(t,n){return new e(st([...this.elements,...fn(t,n)]))}slice(t,n){return new e(this.elements.slice(t,n))}text(...t){var o,i;if(!t.length)return(i=(o=this.elements[0])==null?void 0:o.textContent)!=null?i:"";let n=t[0],r=n==null?"":String(n);for(let s of this.elements){for(let a of Array.from(s.childNodes))G(a);s.textContent=r}return this}html(...t){var o,i;if(!t.length)return(i=(o=this.elements[0])==null?void 0:o.innerHTML)!=null?i:"";let n=t[0],r=n==null?"":String(n);for(let s of this.elements){for(let a of Array.from(s.childNodes))G(a);s.innerHTML=r}return this}val(...t){var r;if(!t.length){let o=this.elements[0];if(!o)return"";let i=o;return o.tagName==="SELECT"&&i.multiple?Array.from(i.selectedOptions).map(s=>s.value):o.type==="checkbox"?o.checked?o.value||"on":"":(r=o.value)!=null?r:""}let n=t[0];for(let o of this.elements){let i=o,s=o;if(i.tagName==="SELECT"&&s.multiple){let a=(Array.isArray(n)?n:[n]).map(String);for(let l of Array.from(s.options))l.selected=a.includes(l.value);continue}if(i.type==="checkbox"||i.type==="radio"){i.checked=Array.isArray(n)?n.map(String).includes(i.value):n===!0||String(n)===i.value;continue}i.value=n==null?"":String(n)}return this}attr(...t){var i,s;let n=t[0];if(n!==null&&typeof n=="object"){for(let a of this.elements)for(let[l,c]of Object.entries(n))c===null||c===!1?a.removeAttribute(l):a.setAttribute(l,c===!0?"":String(c));return this}let r=String(n);if(t.length<2)return(s=(i=this.elements[0])==null?void 0:i.getAttribute(r))!=null?s:void 0;let o=t[1];for(let a of this.elements)o===null||o===!1?a.removeAttribute(r):a.setAttribute(r,o===!0?"":String(o));return this}removeAttr(t){let n=un(t);for(let r of this.elements)for(let o of n)r.removeAttribute(o);return this}prop(...t){let n=String(t[0]);if(t.length<2){let r=this.elements[0];return r?r[n]:void 0}for(let r of this.elements)r[n]=t[1];return this}data(...t){let n=t[0];if(!t.length){let i=this.elements[0];if(!i)return{};let s={};for(let[a,l]of Object.entries(i.dataset))s[a]=vu(l);return s}if(n!==null&&typeof n=="object"){for(let i of this.elements)for(let[s,a]of Object.entries(n))i.dataset[hu(s)]=typeof a=="string"?a:JSON.stringify(a!=null?a:null);return this}let r=hu(String(n));if(t.length<2){let i=this.elements[0];return i?vu(i.dataset[r]):void 0}let o=t[1];for(let i of this.elements)i.dataset[r]=typeof o=="string"?o:JSON.stringify(o!=null?o:null);return this}css(...t){let n=t[0];if(n!==null&&typeof n=="object"){for(let o of this.elements)uh(o,n);return this}let r=String(n);if(t.length<2){let o=this.elements[0];if(!o)return"";let i=Eu(r);return((o.isConnected?getComputedStyle(o).getPropertyValue(i):"")||o.style.getPropertyValue(i)).trim()}for(let o of this.elements)fi(o,r,t[1]);return this}width(...t){if(!t.length){let n=this.elements[0];return n?n.getBoundingClientRect().width:0}for(let n of this.elements)fi(n,"width",t[0]);return this}height(...t){if(!t.length){let n=this.elements[0];return n?n.getBoundingClientRect().height:0}for(let n of this.elements)fi(n,"height",t[0]);return this}offset(){let t=this.elements[0];if(!t)return{top:0,left:0};let n=t.getBoundingClientRect();return{top:n.top+window.scrollY,left:n.left+window.scrollX}}position(){let t=this.elements[0];return t?{top:t.offsetTop,left:t.offsetLeft}:{top:0,left:0}}scrollTop(...t){var r,o;if(!t.length)return(o=(r=this.elements[0])==null?void 0:r.scrollTop)!=null?o:0;let n=Number(t[0])||0;for(let i of this.elements)i.scrollTop=n;return this}addClass(t){let n=un(t);if(n.length)for(let r of this.elements)r.classList.add(...n);return this}removeClass(t){let n=un(t);if(n.length)for(let r of this.elements)r.classList.remove(...n);return this}toggleClass(t,n){let r=un(t);for(let o of this.elements)for(let i of r)n===void 0?o.classList.toggle(i):o.classList.toggle(i,n);return this}hasClass(t){let n=un(t);return n.length?this.elements.some(r=>n.every(o=>r.classList.contains(o))):!1}insert(t,n){let r=this.elements.length;for(let o=0;o<r;o++){let i=this.elements[o];for(let s of mu(t))n(i,o===r-1?s:s.cloneNode(!0))}return this}append(t){return this.insert(t,(n,r)=>n.appendChild(r))}prepend(t){return this.insert(t,(n,r)=>n.insertBefore(r,n.firstChild))}before(t){return this.insert(t,(n,r)=>{var o;return(o=n.parentNode)==null?void 0:o.insertBefore(r,n)})}after(t){return this.insert(t,(n,r)=>{var o;return(o=n.parentNode)==null?void 0:o.insertBefore(r,n.nextSibling)})}appendTo(t){let n=fn(t);for(let r=0;r<n.length;r++)for(let o of this.elements)n[r].appendChild(r===n.length-1?o:o.cloneNode(!0));return this}prependTo(t){let n=fn(t);for(let r=0;r<n.length;r++){let o=n[r],i=this.elements.map(s=>r===n.length-1?s:s.cloneNode(!0));for(let s=i.length-1;s>=0;s--)o.insertBefore(i[s],o.firstChild)}return this}replaceWith(t){for(let n of this.elements){let r=n.parentNode;if(r){for(let o of mu(t))r.insertBefore(o,n);G(n),n.remove()}}return this}wrap(t){var n;for(let r of this.elements){let o=fn(t)[0];if(!o)continue;let i=o.cloneNode(!0);(n=r.parentNode)==null||n.insertBefore(i,r);let s=i;for(;s.firstElementChild;)s=s.firstElementChild;s.appendChild(r)}return this}unwrap(){let t=new Set;for(let n of this.elements){let r=n.parentElement;r&&r!==document.body&&t.add(r)}for(let n of t){let r=n.parentNode;if(r){for(;n.firstChild;)r.insertBefore(n.firstChild,n);G(n),n.remove()}}return this}remove(){for(let t of this.elements)G(t),t.remove();return this}empty(){for(let t of this.elements){for(let n of Array.from(t.childNodes))G(n);t.replaceChildren()}return this}clone(t=!0){return new e(this.elements.map(n=>n.cloneNode(t)))}on(t,...n){var a;let r=typeof n[0]=="string",o=r?n[0]:null,i=r?n[1]:n[0],s=(a=r?n[2]:n[1])!=null?a:{};if(typeof i!="function")return this;for(let l of this.elements)for(let c of un(t)){let d=u=>{if(!o){i.call(l,u);return}let p=u.target,f=p==null?void 0:p.closest(o);!f||!l.contains(f)||i.call(f,u)};l.addEventListener(c,d,s),ph(l).push({type:c,selector:o,handler:i,wrapped:d,options:s})}return this}off(t,n,r){let o=typeof n=="string"?n:null,i=typeof n=="function"?n:r!=null?r:null,s=t?un(t):null;for(let a of this.elements){let l=pi.get(a);if(!l)continue;let c=[];for(let d of l){let u=!s||s.includes(d.type),p=o===null||d.selector===o,f=i===null||d.handler===i;u&&p&&f?a.removeEventListener(d.type,d.wrapped,d.options):c.push(d)}pi.set(a,c)}return this}once(t,...n){let r=typeof n[0]=="string",o=r?n[0]:null,i=r?n[1]:n[0];if(typeof i!="function")return this;let s=this,a=function(l){return o?s.off(t,o,a):s.off(t,a),i.call(this,l)};return o?this.on(t,o,a):this.on(t,a)}trigger(t,n){for(let r of this.elements){if(n===void 0&&typeof r[t]=="function"){r[t]();continue}let o=new CustomEvent(t,{detail:n,bubbles:!0,cancelable:!0});o.__voodoo=!0,r.dispatchEvent(o)}return this}emit(t,n){for(let r of this.elements){let o=new CustomEvent(t,{detail:n,bubbles:!0,cancelable:!0});o.__voodoo=!0,r.dispatchEvent(o)}return this}show(){for(let t of this.elements)bu(t);return this}hide(){for(let t of this.elements)yu(t);return this}toggle(t){for(let n of this.elements)(t===void 0?gu(n):t)?bu(n):yu(n);return this}fadeIn(t=220){for(let n of this.elements)n.removeAttribute("hidden"),_n(n,t);return this}fadeOut(t=220){for(let n of this.elements)Kn(n,t);return this}slideUp(t=240){for(let n of this.elements)dn(n,t);return this}slideDown(t=240){for(let n of this.elements)n.removeAttribute("hidden"),cn(n,t);return this}slideToggle(t=240){for(let n of this.elements)gu(n)?(n.removeAttribute("hidden"),cn(n,t)):dn(n,t);return this}animate(t,n=300){for(let r of this.elements)typeof r.animate=="function"&&r.animate(t,n);return this}scrollIntoView(t={behavior:"smooth",block:"start"}){var n;return(n=this.elements[0])==null||n.scrollIntoView(t),this}serialize(){let t=this.elements[0];if(!t)return"";let n=new URLSearchParams;for(let r of wu(t)){if(!fh(r))continue;let o=r,i=r;if(o.tagName==="SELECT"&&i.multiple){for(let s of Array.from(i.selectedOptions))n.append(o.name,s.value);continue}n.append(o.name,o.value)}return n.toString()}serializeObject(){var r,o,i,s;let t=this.elements[0],n={};if(!t)return n;for(let a of wu(t)){let l=a;if(!l.name||l.disabled)continue;let c=(l.getAttribute("type")||"").toLowerCase();if(c==="submit"||c==="reset"||c==="button")continue;let d=l.name.endsWith("[]"),u=d?l.name.slice(0,-2):l.name,p=a,f;if(c==="checkbox"){if(!l.checked&&!d){n[u]=(r=n[u])!=null?r:!1;continue}if(!l.checked)continue;f=l.value==="on"?!0:l.value}else if(c==="radio"){if(!l.checked)continue;f=l.value}else c==="file"?f=l.multiple?Array.from((o=l.files)!=null?o:[]):(s=(i=l.files)==null?void 0:i[0])!=null?s:null:l.tagName==="SELECT"&&p.multiple?f=Array.from(p.selectedOptions).map(m=>m.value):c==="number"||c==="range"?f=l.value===""?null:Number(l.value):f=l.value;if(d){let m=n[u];Array.isArray(m)?m.push(f):n[u]=[f];continue}if(Object.prototype.hasOwnProperty.call(n,u)){let m=n[u];Array.isArray(m)?m.push(f):m===void 0||m===!1?n[u]=f:n[u]=[m,f];continue}n[u]=f}return n}focus(t){var n;return(n=this.elements[0])==null||n.focus(t),this}blur(){for(let t of this.elements)t.blur();return this}select(){for(let t of this.elements){let n=t;typeof n.select=="function"&&n.select()}return this}walk(t=!1){for(let n of this.elements)t&&G(n),ee(n,Ae(n.parentNode));return this}destroy(){for(let t of this.elements)G(t);return this}};function Sa(e,t){if(typeof e=="function"){Aa(e);let n=typeof document!="undefined"?document.documentElement:null;return new pt(n?[n]:[])}return new pt(fn(e,t))}function Aa(e){return typeof document=="undefined"?Promise.resolve():new Promise(t=>{Cd(()=>{try{e==null||e()}catch(n){K(n,"V.ready")}t()})})}function Lu(e){return new pt(Ma(e))}me();ce();var pn=new Map,ze={emit(e,t){let n=pn.get(e);if(!(!n||n.size===0))for(let r of[...n])try{r(t)}catch(o){console.error("[Voodoo] error in devtools listener:",o)}},on(e,t){let n=pn.get(e);return n||pn.set(e,n=new Set),n.add(t),()=>{n==null||n.delete(t)}},off(e,t){var n;(n=pn.get(e))==null||n.delete(t)},clear(e){e?pn.delete(e):pn.clear()},count(e){var t,n;return(n=(t=pn.get(e))==null?void 0:t.size)!=null?n:0}};var U={mode:"history",base:"/",beforeEach:null,afterEach:null,linkActiveClass:"v-link-active",linkExactActiveClass:"v-link-exact-active",transition:!0,titleTemplate:"%s",scrollBehavior:null},mi="__voodooRoute",Au=10,mt=[],Cu=new Map,vi=new Map,Xn="inicial",hi=!1,Ru=!1;function mh(){return{path:"/",fullPath:"/",params:{},query:{},hash:"",name:"",meta:{},matched:null}}var de=Y(mh());function Wr(e){let t=e||"/";return t.startsWith("/")||(t=`/${t}`),t=t.replace(/\/{2,}/g,"/"),t.length>1&&t.endsWith("/")&&(t=t.slice(0,-1)),t}function $u(e){let t={};return e&&new URLSearchParams(e.startsWith("?")?e.slice(1):e).forEach((r,o)=>{t[o]=r}),t}function vh(e){let t=new URLSearchParams;for(let[n,r]of Object.entries(e))r!=null&&t.append(n,String(r));return t.toString()}function Da(e){let t=e||"/",n="",r=t.indexOf("#");r>-1&&(n=t.slice(r+1),t=t.slice(0,r));let o={},i=t.indexOf("?");return i>-1&&(o=$u(t.slice(i+1)),t=t.slice(0,i)),{path:Wr(t),query:o,hash:n}}function hh(e){let t=U.base.replace(/\/$/,"");return!t||t===""?e:e===t?"/":e.startsWith(`${t}/`)?e.slice(t.length):e}function Du(){return typeof window=="undefined"?{path:"/",query:{},hash:""}:U.mode==="hash"?Da(window.location.hash.slice(1)||"/"):{path:Wr(hh(window.location.pathname)),query:$u(window.location.search),hash:window.location.hash.slice(1)}}function Pu(e,t,n){let r=vh(t);return`${e}${r?`?${r}`:""}${n?`#${n}`:""}`}function Pa(e){let t=Pu(e.path,e.query,e.hash);if(U.mode==="hash"){let{pathname:r,search:o}=window.location;return`${r}${o}#${t}`}return`${U.base==="/"?"":U.base.replace(/\/$/,"")}${t}`||"/"}var Ra=!1,gi=!1;function Ha(e,t,n){if(!Ra)try{n?window.history.replaceState(e,"",t):window.history.pushState(e,"",t);return}catch(i){if(!(i instanceof Error)||i.name!=="SecurityError")throw i;Ra=!0}if(U.mode!=="hash")return;let r=t.indexOf("#");if(r<0)return;let o=t.slice(r);if(window.location.hash!==o){gi=!0;try{window.location.hash=o}finally{setTimeout(()=>{gi=!1},0)}}}function Hu(e,t){let n=e==="*"?"*":Wr(e),r=n==="*"?["*"]:n.split("/").filter(Boolean),o=[],i=r.length*10;for(let s of r){if(s==="*"||s==="**"){o.push({type:"wildcard",value:"*",optional:!0}),i-=30;continue}if(s.startsWith(":")){let a=s.endsWith("?"),l=s.slice(1,a?-1:void 0);o.push({type:"param",value:l,optional:a}),i+=a?1:2;continue}o.push({type:"static",value:s,optional:!1}),i+=4}return{pattern:n,segments:o,score:i,record:t}}function gh(e,t){let n={},r=0;for(let o of e){if(o.type==="wildcard")return n["*"]=t.slice(r).map(Ca).join("/"),n;if(r>=t.length){if(o.optional)continue;return null}let i=t[r];if(o.type==="static"){if(Ca(i)!==o.value)return null;r++;continue}n[o.value]=Ca(i),r++}return r===t.length?n:null}function Ca(e){try{return decodeURIComponent(e)}catch(t){return e}}function bh(e){let t=e.split("/").filter(Boolean),n=null;for(let r of mt){let o=gh(r.segments,t);o&&(!n||r.score>n.route.score)&&(n={route:r,params:o})}return n}function Na(e){var t,n;return e&&(n=(t=mt.find(r=>r.pattern===e))==null?void 0:t.record)!=null?n:null}function Gn(e){let{path:t,query:n,hash:r}=Da(e);return Oa(t,n,r)}function Oa(e,t,n){var o,i;let r=bh(e);return{path:e,fullPath:Pu(e,t,n),params:r?r.params:{},query:t,hash:n,name:(o=r==null?void 0:r.route.record.name)!=null?o:"",meta:(i=r==null?void 0:r.route.record.meta)!=null?i:{},matched:r?r.route.pattern:null}}function Qn(){return{path:de.path,fullPath:de.fullPath,params:{...de.params},query:{...de.query},hash:de.hash,name:de.name,meta:de.meta,matched:de.matched}}function Fa(e){de.path=e.path,de.fullPath=e.fullPath,de.params=e.params,de.query=e.query,de.hash=e.hash,de.name=e.name,de.meta=e.meta,de.matched=e.matched;let t=Na(e.matched);t!=null&&t.title&&typeof document!="undefined"&&(document.title=U.titleTemplate.includes("%s")?U.titleTemplate.replace("%s",t.title):t.title)}async function Ia(e,t){let n=Na(e.matched);if(n!=null&&n.redirect)return n.redirect;if(n!=null&&n.beforeEnter){let r=await n.beforeEnter(e,t);if(r===!1)return!1;if(typeof r=="string")return r}if(U.beforeEach){let r=await U.beforeEach(e,t);if(r===!1)return!1;if(typeof r=="string")return r}return!0}function yi(){typeof window!="undefined"&&Cu.set(Xn,window.scrollY)}function za(e,t,n){typeof window!="undefined"&&Se(()=>{requestAnimationFrame(()=>{var o;let r=i=>{Math.abs(window.scrollY-i)>1&&window.scrollTo(0,i)};if(U.scrollBehavior){let i=U.scrollBehavior(e,t,n);if(i===!1)return;if(typeof i=="number"){r(i);return}}if(e.hash){let i=(o=document.getElementById(e.hash))!=null?o:/^[\w-]+$/.test(e.hash)?document.querySelector(`[name="${e.hash}"]`):null;if(i){i.scrollIntoView({behavior:"smooth",block:"start"});return}}r(n!=null?n:0)})})}async function Wt(e,t={}){var a,l;if(typeof window=="undefined")return!1;Nu();let n=Qn(),r=Gn(e);if(!t.force&&r.fullPath===n.fullPath)return!0;for(let c=0;;c++){if(c>Au)return X(`Router: too many redirects when navigating to "${e}".`),!1;let d=await Ia(r,n);if(d===!1)return ze.emit("navigation",{from:n.fullPath,to:r.fullPath,cancelled:!0,matched:r.matched}),!1;if(typeof d=="string"){r=Gn(d);continue}break}yi();let o=le("rota"),i={...(a=t.state)!=null?a:{},[mi]:o},s=Pa(r);return Ha(i,s,t.replace===!0),Xn=o,Fa(r),t.scroll!==!1&&za(r,n,null),(l=U.afterEach)==null||l.call(U,Qn(),n),ze.emit("navigation",{from:n.fullPath,to:r.fullPath,matched:r.matched}),!0}async function yh(e){var c,d;if(gi)return;let{path:t,query:n,hash:r}=Du(),o=Oa(t,n,r),i=Qn();if(o.fullPath===i.fullPath)return;let s=await Ia(o,i);if(s===!1){Ha({[mi]:Xn},Pa(i),!0),ze.emit("navigation",{from:i.fullPath,to:o.fullPath,cancelled:!0,matched:o.matched});return}if(typeof s=="string"){Wt(s,{replace:!0});return}yi();let a=e.state,l=a&&a[mi]||le("rota");Xn=l,Fa(o),za(o,i,(c=Cu.get(l))!=null?c:0),(d=U.afterEach)==null||d.call(U,Qn(),i),ze.emit("navigation",{from:i.fullPath,to:o.fullPath,matched:o.matched})}function bi(e){yh(e)}function Nu(){hi||typeof window=="undefined"||(hi=!0,"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual"),window.addEventListener("popstate",bi),U.mode==="hash"&&window.addEventListener("hashchange",bi),window.addEventListener("beforeunload",yi))}function xh(){!hi||typeof window=="undefined"||(hi=!1,window.removeEventListener("popstate",bi),window.removeEventListener("hashchange",bi),window.removeEventListener("beforeunload",yi),Ra=!1,gi=!1)}async function wh(){var i;if(typeof window=="undefined")return;let{path:e,query:t,hash:n}=Du(),r=Qn(),o=Oa(e,t,n);for(let s=0;;s++){if(s>Au){X("Router: too many redirects in the initial route.");return}let a=await Ia(o,r);if(a===!1)return;if(typeof a=="string"){o=Gn(a);continue}break}Xn=le("rota"),Ha({[mi]:Xn},Pa(o),!0),Fa(o),o.hash&&za(o,r,null),(i=U.afterEach)==null||i.call(U,Qn(),r)}function Eh(e,t){let n=Hu(e,t),r=mt.findIndex(o=>o.pattern===n.pattern);r>-1?mt.splice(r,1,n):mt.push(n)}function kh(e){let t=e==="*"?"*":Wr(e),n=mt.findIndex(r=>r.pattern===t);n>-1&&mt.splice(n,1)}function Th(){return[...mt].sort((e,t)=>t.score-e.score).map(e=>e.pattern)}function Lh(e){e?vi.delete(e):vi.clear()}function Mh(e){var t,n,r,o,i,s,a,l,c,d;U.mode=(t=e.mode)!=null?t:"history",U.base=Wr((n=e.base)!=null?n:"/"),U.beforeEach=(r=e.beforeEach)!=null?r:null,U.afterEach=(o=e.afterEach)!=null?o:null,U.linkActiveClass=(i=e.linkActiveClass)!=null?i:"v-link-active",U.linkExactActiveClass=(s=e.linkExactActiveClass)!=null?s:"v-link-exact-active",U.transition=(a=e.transition)!=null?a:!0,U.titleTemplate=(l=e.titleTemplate)!=null?l:"%s",U.scrollBehavior=(c=e.scrollBehavior)!=null?c:null,mt.length=0;for(let[u,p]of Object.entries((d=e.routes)!=null?d:{}))mt.push(Hu(u,p));return Ru=!0,Nu(),wh(),_r}var Sh={get current(){return de},push:(e,t={})=>Wt(e,t),replace:(e,t={})=>Wt(e,{...t,replace:!0}),navigate:Wt,back:()=>{typeof window!="undefined"&&window.history.back()},forward:()=>{typeof window!="undefined"&&window.history.forward()},go:e=>{typeof window!="undefined"&&window.history.go(e)},resolve:Gn,addRoute:Eh,removeRoute:kh,patterns:Th,stop:xh,clearViewCache:Lh,get ready(){return Ru}},_r=Object.defineProperties(Mh,Object.getOwnPropertyDescriptors(Sh));N("$route",()=>de);N("$router",()=>_r);async function Ah(e){let t=vi.get(e);if(t!==void 0)return t;let n=await he.get(e,{responseType:"text"}),r=typeof n=="string"?n:String(n!=null?n:"");return vi.set(e,r),r}function Ch(e){return Object.keys(e).sort().map(n=>`${n}=${e[n]}`).join("&")}y("router-view",({el:e,scope:t,modifiers:n,effect:r,cleanup:o})=>{Uo(e);let i=e.innerHTML,s=U.transition&&!n["no-transition"],a=0,l=()=>{for(let u of Array.from(e.childNodes))G(u);e.textContent=""},c=(u,p)=>{if(l(),u!=null&&u.component){let f=document.createElement("div");f.setAttribute(`${x.prefix}component`,u.component),f.className="v-router-page",e.appendChild(f),ee(f,t);return}e.innerHTML=p!=null?p:i;for(let f of Array.from(e.childNodes))ee(f,t)},d=async(u,p)=>{let f=null;if(u!=null&&u.view){e.classList.add("v-router-loading");try{f=await Ah(u.view)}catch(m){K(m,`v-router-view loading "${u.view}"`),f=""}finally{e.classList.remove("v-router-loading")}if(p!==a)return}s?ci(()=>c(u,f)):c(u,f)};r(()=>{let u=de.matched;Ch(de.params);let p=Na(u);d(p,++a)}),o(()=>{a++,l()})},{priority:j.DEFAULT});var Rh=/^[a-z][a-z0-9+.-]*:/i;function Mu(e){return!!(!e||e.startsWith("//")||Rh.test(e))}function Su(e,t,n){var i;let r=t.trim();if(r){if(r.startsWith("/")||r.startsWith("#"))return r;let s=n(r);return typeof s=="string"&&s?s:r}let o=(i=e.getAttribute("href"))!=null?i:"";return U.mode==="hash"&&o.startsWith("#")?o.slice(1)||"/":o}function $a(e,t){let{path:n}=Da(e);return n==="/"||t?de.path===n:de.path===n||de.path.startsWith(`${n}/`)}y("link",({el:e,expression:t,modifiers:n,effect:r,cleanup:o,evaluate:i})=>{let s=e,a=l=>{var u;if(l.defaultPrevented||l.metaKey||l.ctrlKey||l.shiftKey||l.altKey||typeof l.button=="number"&&l.button!==0)return;let c=s.getAttribute("target");if(c&&c!=="_self"||s.hasAttribute("download")||((u=s.getAttribute("rel"))!=null?u:"").split(/\s+/).includes("external"))return;let d=Su(e,t,i);d&&(Mu(d)||U.mode!=="hash"&&d.startsWith("#")||(l.preventDefault(),Wt(d,{replace:!!n.replace,scroll:n["no-scroll"]?!1:void 0})))};e.addEventListener("click",a),o(()=>e.removeEventListener("click",a)),r(()=>{let l=Su(e,t,i);if(!l||Mu(l))return;let c=$a(l,!0),d=c||$a(l,!1);e.classList.toggle(U.linkActiveClass,d),e.classList.toggle(U.linkExactActiveClass,c),c?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})});y("route-active",({el:e,expression:t,arg:n,modifiers:r,effect:o,evaluate:i})=>{let s=n||"active";o(()=>{var d;let a=t.trim(),l=a.startsWith("/")||!a?a:(d=i(a))!=null?d:a,c=l?$a(String(l),!!r.exact):!1;e.classList.toggle(s,c)})});me();ce();var $h="voodoo:locale",z=Y({locale:x.locale||"pt-BR",fallback:"en",currency:x.currency||"BRL",messages:{}}),Jn=$h,Zn="",Ba=new Map;function xi(e,t){let n=z.messages[e];if(!n)return null;let r=n[t];if(typeof r=="string")return r;let o=n;for(let i of t.split(".")){if(o==null||typeof o=="string")return null;o=o[i]}return typeof o=="string"?o:null}function wi(e){let t=[e],n=e.split("-")[0];n&&n!==e&&t.push(n);for(let r of Object.keys(z.messages))r!==e&&r.split("-")[0]===n&&t.push(r);return t}var Ou=new Map;function Dh(e,t){try{let n=Ou.get(e);return n||Ou.set(e,n=new Intl.PluralRules(e)),n.select(t)}catch(n){return t===1?"one":"other"}}var Ph=["zero","one","two","few","many","other"];function Hh(e,t,n){var i;if(e.length<=1)return(i=e[0])!=null?i:"";let r=Dh(n,t);if(e.length===2)return r==="one"?e[0]:e[1];if(e.length===3)return t===0?e[0]:r==="one"?e[1]:e[2];let o=Ph.indexOf(r);return e[Math.min(o<0?e.length-1:o,e.length-1)]}var Nh=/\{\s*([\w.$-]+)\s*\}/g;function Oh(e,t){return e.indexOf("{")===-1?e:e.replace(Nh,(n,r)=>{let o=t[r];return o==null?n:String(o)})}function Fh(e){return e==null?{}:typeof e=="number"?{n:e}:e}function er(e,t){var i,s;if(!e)return"";let n=Fh(t),r=z.locale,o=null;for(let a of wi(r))if(o=xi(a,e),o!==null)break;if(o===null&&z.fallback&&z.fallback!==r){for(let a of wi(z.fallback))if(o=xi(a,e),o!==null)break}if(o===null)return e;if(o.includes("|")){let a=Number((s=(i=n.n)!=null?i:n.count)!=null?s:0),l=o.split("|").map(c=>c.trim());o=Hh(l,Number.isNaN(a)?0:a,r)}return Oh(o,n)}function Ih(e,t){let n=t!=null?t:z.locale;for(let r of wi(n))if(xi(r,e)!==null)return!0;if(z.fallback&&z.fallback!==n){for(let r of wi(z.fallback))if(xi(r,e)!==null)return!0}return!1}function Fu(e,t={}){return ua(e,{...t,locale:z.locale})}function Iu(e,t){return da(e,{locale:z.locale,currency:t!=null?t:z.currency})}function zu(e,t="short"){return fa(e,t,z.locale)}function Bu(e){return pa(e,z.locale)}function ki(){return z.locale}function zh(e){var t;return(t=z.messages[e!=null?e:z.locale])!=null?t:{}}function Ei(e,t){let n=z.messages[e];return n?Jo(n,t):z.messages[e]=t,e}async function ja(e,t){if(typeof t!="string"){Ei(e,t);return}let n=Ba.get(e);if(n)return n;let r=he.get(t,{responseType:"json"}).then(o=>{o&&typeof o=="object"&&Ei(e,o)}).catch(o=>{K(o,`i18n ao carregar "${t}"`)}).finally(()=>{Ba.delete(e)});return Ba.set(e,r),r}function Kr(e){let t=e==null?void 0:e.trim();if(!t||t===z.locale)return Promise.resolve();let n=z.locale;return z.locale=t,z.currency=z.currency||x.currency,x.locale=t,ei(t,z.currency),Jn&&ue.set(Jn,t),typeof document!="undefined"&&(document.documentElement.lang=t),ze.emit("locale",{from:n,to:t}),!z.messages[t]&&Zn?ja(t,Zn.replace("{locale}",t)):Promise.resolve()}function ju(){var n;if(typeof navigator=="undefined")return null;let e=Object.keys(z.messages);if(!e.length)return null;let t=(n=navigator.languages)!=null&&n.length?[...navigator.languages]:[navigator.language];for(let r of t){if(!r)continue;let o=e.find(a=>a.toLowerCase()===r.toLowerCase());if(o)return o;let i=r.split("-")[0].toLowerCase(),s=e.find(a=>a.split("-")[0].toLowerCase()===i);if(s)return s}return null}function Bh(e={}){var o,i,s,a;if(e.messages)for(let[l,c]of Object.entries(e.messages))Ei(l,c);z.fallback=(o=e.fallback)!=null?o:z.fallback,z.currency=(s=(i=e.currency)!=null?i:x.currency)!=null?s:z.currency,Zn=(a=e.loadPath)!=null?a:Zn,e.persist===!1?Jn=null:typeof e.persist=="string"&&(Jn=e.persist);let t=Jn?ue.get(Jn):void 0,n=e.detect===!1?null:ju(),r=t||n||e.locale||z.locale||z.fallback;return z.locale=r,x.locale=r,ei(r,z.currency),typeof document!="undefined"&&(document.documentElement.lang=r),!z.messages[r]&&Zn&&ja(r,Zn.replace("{locale}",r)),Yr}var jh={get locale(){return z.locale},get fallback(){return z.fallback},get locales(){return Object.keys(z.messages)},t:er,te:Ih,n:Fu,c:Iu,d:zu,rt:Bu,setLocale:Kr,getLocale:ki,addMessages:Ei,loadMessages:ja,messagesOf:zh,detectLocale:ju},Yr=Object.defineProperties(Bh,Object.getOwnPropertyDescriptors(jh));N("$t",()=>er);N("$locale",()=>z.locale);N("$i18n",()=>Yr);N("$n",()=>Fu);N("$c",()=>Iu);N("$d",()=>zu);N("$rt",()=>Bu);var qh=/^[A-Za-z_$][\w$-]*(\.[A-Za-z_$][\w$-]*)*$/;function Vh(e,t){let n=e.trim();if(!n)return"";if(qh.test(n))return n;let r=t(n);return typeof r=="string"?r:n}function Uh(e,t){var o;let n=(o=Te(e,`${x.prefix}t-params`))!=null?o:Te(e,"data-v-t-params");if(!n)return{};let r=t(n);return r&&typeof r=="object"?r:{}}y("t",({el:e,arg:t,expression:n,effect:r,evaluate:o})=>{r(()=>{let i=Vh(n,o);if(!i)return;let s=er(i,Uh(e,o));t?e.setAttribute(t,s):e.textContent!==s&&(e.textContent=s)})});y("t-params",()=>{});y("locale",({el:e,expression:t,effect:n,cleanup:r,evaluate:o})=>{let i=()=>{let a=t.trim();if(!a)return"";if(/^[A-Za-z]{2,3}([-_][A-Za-z0-9]{2,8})*$/.test(a))return a.replace("_","-");let l=o(a);return typeof l=="string"?l:a},s=()=>{let a=i();a&&Kr(a)};e.addEventListener("click",s),r(()=>e.removeEventListener("click",s)),n(()=>{e.classList.toggle("v-locale-active",i()===z.locale)})});me();ce();He();He();ce();var qa=new WeakMap;function Kt(e,t){var n;return(n=Te(e,`${x.prefix}${t}`))!=null?n:Te(e,`data-v-${t}`)}function Ti(e,t){return Ft(e,`${x.prefix}${t}`)||Ft(e,`data-v-${t}`)}function Z(e,t){let n=qa.get(e);return n&&t in n?n[t]:Kt(e,t)}function Li(e,t,n){var o;let r=(o=qa.get(e))!=null?o:{};r[t]=n,qa.set(e,r)}function _(e){y(e,({el:t,expression:n})=>{Li(t,e,n)},{priority:j.BIND})}function fe(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function vt(e,t,n,r,o){if(!e.trim())return;let i=t.child({$el:n,$event:r!=null?r:null,$detail:o}),s=q(e,i,"directive de UI");return typeof s=="function"?s.call(t.data,o!=null?o:r):s}var Wh=`
.v-visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;
  clip:rect(0 0 0 0);white-space:nowrap;border:0}
`,_t=null;function Qe(e){if(typeof document=="undefined")return;oe("ui-live",Wh),(!_t||!_t.isConnected)&&(_t=document.createElement("div"),_t.className="v-visually-hidden",_t.setAttribute("role","status"),_t.setAttribute("aria-live","polite"),document.body.appendChild(_t));let t=_t;t.textContent="",setTimeout(()=>{t.textContent=e},40)}function Mi(e,t,n){return Vo(e,t).filter(r=>Pn(r,n)===e)}He();ce();var _h=`
...
`;function Gr(){ge(),oe("dnd",_h)}var tr=new Map,nr=new Map;function Ua(e,t){if(t&&t.trim())return t.trim();let n=e.closest("[data-v-dnd-group]");return(n==null?void 0:n.getAttribute("data-v-dnd-group"))||null}function ht(e){return Array.from(e.children).filter(t=>!t.classList.contains("v-drag-ghost"))}function Kh(e,t){var n;return(n=e.getAttribute("data-id"))!=null?n:e.id||String(t)}function qu(e){return ht(e).map((t,n)=>Kh(t,n))}function Vu(e){let t=getComputedStyle(e);return t.display.includes("flex")?t.flexDirection.startsWith("row"):t.display.includes("grid")?t.gridAutoFlow.startsWith("column"):!1}var $=null,Xr=0;function Yh(e,t){let n=e.cloneNode(!0);n.classList.add("v-drag-ghost"),n.classList.remove("v-dragging","v-grabbed"),n.removeAttribute("id");for(let r of Array.from(n.querySelectorAll("[id]")))r.removeAttribute("id");return n.style.width=`${t.width}px`,n.style.height=`${t.height}px`,n.setAttribute("aria-hidden","true"),document.body.appendChild(n),n}function Uu(e,t){if(!($!=null&&$.ghost))return;let n=$.axis==="y"?$.lastX:e,r=$.axis==="x"?$.lastY:t;$.ghost.style.transform=`translate3d(${Math.round(n-$.grabX)}px, ${Math.round(r-$.grabY)}px, 0)`}function Xh(e){let t=e;for(;t&&t!==document.body&&t!==document.documentElement;){let n=getComputedStyle(t),r=(n.overflowY==="auto"||n.overflowY==="scroll")&&t.scrollHeight>t.clientHeight+2,o=(n.overflowX==="auto"||n.overflowX==="scroll")&&t.scrollWidth>t.clientWidth+2;if(r||o)return t;t=t.parentElement}return null}function Gh(){if(!$)return;let e=56,t=16,n=$.lastX,r=$.lastY,o=document.elementFromPoint(n,r),i=Xh(o!=null?o:$.overList);if(i){let s=i.getBoundingClientRect();r-s.top<e?i.scrollTop-=t:s.bottom-r<e&&(i.scrollTop+=t),n-s.left<e?i.scrollLeft-=t:s.right-n<e&&(i.scrollLeft+=t);return}r<e?window.scrollBy(0,-t):window.innerHeight-r<e&&window.scrollBy(0,t),n<e?window.scrollBy(-t,0):window.innerWidth-n<e&&window.scrollBy(t,0)}function Qh(){let e=()=>{!$||$.keyboard||(Gh(),Xr=requestAnimationFrame(e))};Xr=requestAnimationFrame(e)}function Jh(){Xr&&cancelAnimationFrame(Xr),Xr=0}function Wu(e,t){let n=tr.get(e);return n?e===t.startList?!0:!n.group||!t.group?!1:n.group===t.group:!1}function Wa(e,t){return!(e.accept&&!t.item.matches(e.accept)||e.group&&e.group!==t.group)}function _u(e,t){for(let n of nr.values())n.el.classList.toggle("v-drop-active",t&&Wa(n,e));for(let n of tr.values())n.el.classList.toggle("v-drop-active",t&&Wu(n.el,e))}function Zh(e,t,n,r){let o=Vu(e),i=null;for(let s of ht(e)){if(s===t)continue;let a=s.getBoundingClientRect(),l=o?a.left+a.width/2:a.top+a.height/2;if((o?n:r)<l){i=s;break}}if(i){(t.nextElementSibling!==i||t.parentElement!==e)&&e.insertBefore(t,i);return}e.lastElementChild!==t&&e.appendChild(t)}function _a(e,t){Gr();let n=e.getBoundingClientRect(),r=t.mode==="sort"?e.parentElement:null;$={item:e,mode:t.mode,data:t.data,group:t.group,axis:t.axis,ghost:null,pointerId:t.pointerId,grabX:t.keyboard?n.width/2:t.x-n.left,grabY:t.keyboard?n.height/2:t.y-n.top,startParent:e.parentElement,startNext:e.nextSibling,startList:r,startIndex:r?ht(r).indexOf(e):-1,overDrop:null,overList:r,keyboard:!!t.keyboard,lastX:t.x,lastY:t.y},e.classList.add("v-dragging"),e.setAttribute("aria-grabbed","true"),t.keyboard?e.classList.add("v-grabbed"):($.ghost=Yh(e,n),Uu(t.x,t.y),Qh()),_u($,!0),document.addEventListener("keydown",Yu,!0),fe(e,"voodoo:drag-start",{item:e,data:t.data,group:t.group})}function eg(e,t){var a,l,c;if(!$)return;$.lastX=e,$.lastY=t,Uu(e,t);let n=document.elementFromPoint(e,t),r=(a=n==null?void 0:n.closest(".v-sortable"))!=null?a:null,o=(l=n==null?void 0:n.closest(".v-droppable"))!=null?l:null;$.mode==="sort"&&r&&Wu(r,$)?($.overList&&$.overList!==r&&$.overList.classList.remove("v-drop-over"),$.overList=r,r.classList.add("v-drop-over"),Zh(r,$.item,e,t)):$.overList&&!r&&$.overList.classList.remove("v-drop-over");let i=o?nr.get(o):void 0,s=i?Wa(i,$):!1;$.overDrop&&$.overDrop!==o&&($.overDrop.classList.remove("v-drop-over"),$.overDrop=null),o&&s&&(o.classList.add("v-drop-over"),$.overDrop=o),(c=$.ghost)==null||c.classList.toggle("v-drag-invalid",!!o&&!s)}function tg(e){e.startParent&&(e.startNext&&e.startNext.parentNode===e.startParent?e.startParent.insertBefore(e.item,e.startNext):e.startParent.appendChild(e.item))}function Ku(e){var t,n,r;(t=e.ghost)==null||t.remove(),e.item.classList.remove("v-dragging","v-grabbed"),e.item.setAttribute("aria-grabbed","false"),(n=e.overDrop)==null||n.classList.remove("v-drop-over"),(r=e.overList)==null||r.classList.remove("v-drop-over"),_u(e,!1),Jh(),document.removeEventListener("keydown",Yu,!0),$=null}function Ka(){var i;let e=$;if(!e)return;let t=e.item.parentElement,n=t?ht(t).indexOf(e.item):-1,r=e.overDrop,o=r?nr.get(r):void 0;if(e.mode==="sort"&&t&&tr.has(t)&&(t!==e.startList||n!==e.startIndex)){let a={item:e.item,oldIndex:e.startIndex,newIndex:n,from:e.startList,to:t,order:qu(t)};fe(t,"voodoo:sorted",a),e.startList&&e.startList!==t&&fe(e.startList,"voodoo:sorted",{...a,order:qu(e.startList)}),Qe(`Item moved to position ${n+1} of ${ht(t).length}`)}if(r&&o){let s={item:e.item,data:e.data,from:(i=e.startList)!=null?i:e.startParent,to:r,index:n},a=new CustomEvent("voodoo:drop",{detail:s,bubbles:!0});r.dispatchEvent(a),vt(o.expression,o.scope,r,a,s),Qe("Item dropped in drop zone")}fe(e.item,"voodoo:drag-end",{item:e.item,data:e.data}),Ku(e)}function Va(){let e=$;e&&(tg(e),fe(e.item,"voodoo:drag-cancel",{item:e.item}),Qe("Drag canceled"),Ku(e))}function Yu(e){!$||e.key!=="Escape"||(e.preventDefault(),Va())}function Xu(e,t,n){let r=null,o=-1,i=0,s=0,a=!1,l=f=>{if(f.pointerId===o){if(!a){if(Math.hypot(f.clientX-i,f.clientY-s)<4||!r)return;a=!0,_a(r,{mode:t.mode,data:t.data(),group:t.group(),axis:t.axis(),pointerId:o,x:i,y:s})}f.preventDefault(),eg(f.clientX,f.clientY)}},c=()=>{window.removeEventListener("pointermove",l),window.removeEventListener("pointerup",d),window.removeEventListener("pointercancel",u),r=null,o=-1,a=!1},d=f=>{f.pointerId===o&&(a&&Ka(),c())},u=()=>{a&&Va(),c()},p=f=>{if(f.button!==0||$)return;let m=f.target;if(!m||m.closest('input,textarea,select,option,[contenteditable="true"]')||t.handle&&!m.closest(t.handle))return;let h=t.itemFrom(m);h&&(r=h,o=f.pointerId,i=f.clientX,s=f.clientY,a=!1,window.addEventListener("pointermove",l,{passive:!1}),window.addEventListener("pointerup",d),window.addEventListener("pointercancel",u))};e.addEventListener("pointerdown",p),n(()=>{e.removeEventListener("pointerdown",p),a&&Va(),c()})}function ng(e){return e?Array.from(tr.values()).filter(t=>t.group===e).map(t=>t.el).sort((t,n)=>t.compareDocumentPosition(n)&Node.DOCUMENT_POSITION_FOLLOWING?-1:1):[]}function rg(e,t){if(!$)return!1;let n=e.parentElement;if(!n)return!1;let r=Vu(n),o=t==="ArrowDown"||r&&t==="ArrowRight",i=t==="ArrowUp"||r&&t==="ArrowLeft",s=ht(n),a=s.indexOf(e);if(o||i){let l=a+(o?1:-1);return l<0||l>=s.length?!1:(o?n.insertBefore(e,s[l].nextSibling):n.insertBefore(e,s[l]),Qe(`Position ${l+1} of ${s.length}`),e.focus(),!0)}if(!r&&(t==="ArrowLeft"||t==="ArrowRight")){let l=ng($.group),c=l.indexOf(n);if(c===-1)return!1;let d=l[c+(t==="ArrowRight"?1:-1)];return d?(d.appendChild(e),Qe(`Moved to list ${l.indexOf(d)+1} of ${l.length}`),e.focus(),!0):!1}return!1}function og(e){return Array.from(nr.values()).filter(t=>Wa(t,e)).map(t=>t.el)}y("dnd-group",({el:e,expression:t})=>{Gr();let n=t.trim()||"default";e.setAttribute("data-v-dnd-group",n),e.classList.add("v-dnd-group")});y("sortable",({el:e,expression:t,cleanup:n})=>{Gr(),e.classList.add("v-sortable");let r=Z(e,"sortable-handle")||t.trim()||null,o={el:e,group:Ua(e,Z(e,"sortable-group")),handle:r};tr.set(e,o),e.hasAttribute("aria-label")||e.setAttribute("aria-label","Sortable list");let i=l=>{var c;l.hasAttribute("tabindex")||l.setAttribute("tabindex","0"),l.hasAttribute("aria-grabbed")||l.setAttribute("aria-grabbed","false"),r?(c=l.querySelector(r))==null||c.classList.add("v-drag-handle"):l.classList.add("v-drag-handle")};for(let l of ht(e))i(l);let s=typeof MutationObserver=="undefined"?null:new MutationObserver(()=>{for(let l of ht(e))i(l)});s==null||s.observe(e,{childList:!0}),Xu(e,{mode:"sort",handle:r,group:()=>o.group,data:()=>null,axis:()=>null,itemFrom:l=>{let c=ht(e).find(d=>d===l||d.contains(l));return c!=null?c:null}},n);let a=l=>{let c=l.target;if(!c)return;let d=ht(e).find(u=>u===c||u.contains(c));if(d){if(l.key===" "||l.key==="Spacebar"){if(l.preventDefault(),$&&$.item===d){Ka(),Qe("Item dropped");return}if($)return;_a(d,{mode:"sort",data:null,group:o.group,axis:null,pointerId:-1,x:0,y:0,keyboard:!0}),Qe("Item grabbed. Use arrow keys to move and space to drop.");return}!$||$.item!==d||l.key.startsWith("Arrow")&&rg(d,l.key)&&l.preventDefault()}};e.addEventListener("keydown",a),n(()=>{e.removeEventListener("keydown",a),s==null||s.disconnect(),tr.delete(e)})});_("sortable-group");_("sortable-handle");y("draggable",({el:e,expression:t,scope:n,cleanup:r})=>{var m;Gr(),e.classList.add("v-draggable");let o=Z(e,"draggable-handle")||null,i=(Z(e,"draggable-axis")||"").trim().toLowerCase(),s=i==="x"||i==="y"?i:null,a=Z(e,"draggable-data")||t.trim(),l=Ua(e,Z(e,"draggable-group"));o?(m=e.querySelector(o))==null||m.classList.add("v-drag-handle"):e.classList.add("v-drag-handle"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("aria-grabbed","false"),e.hasAttribute("aria-roledescription")||e.setAttribute("aria-roledescription","draggable item");let c=()=>a?q(a,n,"v-draggable-data"):null;Xu(e,{mode:"free",handle:o,group:()=>l,data:c,axis:()=>s,itemFrom:()=>e},r);let d=[],u=0,p=()=>{d.forEach((v,g)=>v.classList.toggle("v-drop-over",g===u));let h=d[u];!h||!$||($.overDrop=h,ve.reducedMotion?h.scrollIntoView({block:"nearest"}):h.scrollIntoView({block:"nearest",behavior:"smooth"}),Qe(h.getAttribute("aria-label")||`Target ${u+1} of ${d.length}`))},f=h=>{if(h.key===" "||h.key==="Spacebar"){if(h.preventDefault(),$&&$.item===e){Ka(),d=[];return}if($)return;_a(e,{mode:"free",data:c(),group:l,axis:s,pointerId:-1,x:0,y:0,keyboard:!0}),d=$?og($):[],u=0,d.length?p():Qe("No targets available");return}if(!(!$||$.item!==e||!d.length)){if(h.key==="ArrowDown"||h.key==="ArrowRight"){h.preventDefault(),u=(u+1)%d.length,p();return}(h.key==="ArrowUp"||h.key==="ArrowLeft")&&(h.preventDefault(),u=(u-1+d.length)%d.length,p())}};e.addEventListener("keydown",f),r(()=>{e.removeEventListener("keydown",f);for(let h of d)h.classList.remove("v-drop-over")})});_("draggable-handle");_("draggable-axis");_("draggable-data");_("draggable-group");y("droppable",({el:e,expression:t,scope:n,cleanup:r})=>{Gr(),e.classList.add("v-droppable");let o={el:e,group:Ua(e,Z(e,"droppable-group")),accept:Z(e,"droppable-accept"),expression:t,scope:n};nr.set(e,o),e.hasAttribute("aria-dropeffect")||e.setAttribute("aria-dropeffect","move"),r(()=>{nr.delete(e),e.classList.remove("v-drop-over","v-drop-active")})});_("droppable-accept");_("droppable-group");var ig=`
.v-visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;
  clip:rect(0 0 0 0);white-space:nowrap;border:0}
...
`;function xe(){ge(),oe("ui",ig)}function rr(e,t){var r;let n=t.trim();if(n)try{let o=document.querySelector(n);if(o)return o}catch(o){}return(r=e.nextElementSibling)!=null?r:null}function Rt(e,t){return e.id||(e.id=le(`${t}-`)),e.id}var nf='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,summary,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function Qr(e){return Array.from(e.querySelectorAll(nf)).filter(t=>!t.hasAttribute("disabled")&&t.getClientRects().length>0)}function Ci(e,t){let n=Qr(e);if(!n.length){t.preventDefault(),e.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;if(t.shiftKey&&(i===r||!e.contains(i))){t.preventDefault(),o.focus();return}!t.shiftKey&&i===o&&(t.preventDefault(),r.focus())}function Be(e,t){let n=e.tagName;if(n==="BUTTON"||n==="A"||n==="INPUT"||n==="SUMMARY"){e.classList.add("v-focus-ring");return}e.hasAttribute("role")||e.setAttribute("role","button"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.classList.add("v-focus-ring");let r=o=>{o.key!=="Enter"&&o.key!==" "||(o.preventDefault(),e.click())};e.addEventListener("keydown",r),t(()=>e.removeEventListener("keydown",r))}var Ya=0,rf="";function of(){if(Ya++>0)return;let e=window.innerWidth-document.documentElement.clientWidth;rf=document.body.style.paddingRight,e>0&&(document.body.style.paddingRight=`${e}px`),document.body.classList.add("v-scroll-lock")}function sf(){Ya!==0&&(--Ya>0||(document.body.classList.remove("v-scroll-lock"),document.body.style.paddingRight=rf))}function af(e){return e.hasAttribute("hidden")||e.style.display==="none"?!0:e.isConnected?getComputedStyle(e).display==="none":!1}function sg(e,t=!0){if(e.removeAttribute("hidden"),t&&!ve.reducedMotion){_n(e);return}e.style.removeProperty("display"),getComputedStyle(e).display==="none"&&(e.style.display="block")}function ag(e,t=!0){if(t&&!ve.reducedMotion){Kn(e);return}e.style.display="none"}var lg={top:"bottom",bottom:"top",left:"right",right:"left"};function lf(e,t){let n=(e||"").trim().toLowerCase();return n==="top"||n==="bottom"||n==="left"||n==="right"?n:t}function cf(e,t,n,r="center",o=8){t.style.position="fixed",t.style.left="0px",t.style.top="0px";let i=e.getBoundingClientRect(),s=t.getBoundingClientRect(),a=document.documentElement.clientWidth,l=document.documentElement.clientHeight,c={top:i.top,bottom:l-i.bottom,left:i.left,right:a-i.right},d={top:s.height+o,bottom:s.height+o,left:s.width+o,right:s.width+o},u=n;if(c[u]<d[u]){let m=lg[u];if(c[m]>=d[m])u=m;else for(let h of Object.keys(c))c[h]-d[h]>c[u]-d[u]&&(u=h)}let p=0,f=0;return u==="top"||u==="bottom"?(p=u==="top"?i.top-s.height-o:i.bottom+o,f=r==="start"?i.left:i.left+i.width/2-s.width/2,r==="start"&&f+s.width>a-o&&(f=i.right-s.width)):(f=u==="left"?i.left-s.width-o:i.right+o,p=r==="start"?i.top:i.top+i.height/2-s.height/2),f=Math.min(Math.max(o,f),Math.max(o,a-s.width-o)),p=Math.min(Math.max(o,p),Math.max(o,l-s.height-o)),t.style.left=`${Math.round(f)}px`,t.style.top=`${Math.round(p)}px`,t.setAttribute("data-placement",u),u}var Si=[],Gu=!1,cg={esc:"escape",space:" ",spacebar:" ",enter:"enter",ret:"enter",del:"delete",ins:"insert",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright",plus:"+",minus:"-",comma:",",period:".",slash:"/",question:"?"},dg=typeof navigator!="undefined"&&/Mac|iPhone|iPad|iPod/i.test(navigator.userAgent||"");function Qa(e){var r;let t=e.trim().toLowerCase().split("+").map(o=>o.trim()).filter(Boolean);if(!t.length)return null;let n={ctrl:!1,shift:!1,alt:!1,meta:!1,key:"",hasModifier:!1};for(let o of t)o==="ctrl"||o==="control"?n.ctrl=!0:o==="shift"?n.shift=!0:o==="alt"||o==="option"?n.alt=!0:o==="meta"||o==="cmd"||o==="command"||o==="super"?n.meta=!0:o==="mod"?dg?n.meta=!0:n.ctrl=!0:n.key=(r=cg[o])!=null?r:o;return n.key?(n.hasModifier=n.ctrl||n.alt||n.meta,n):null}function ug(e,t){return e.ctrl!==t.ctrlKey||e.alt!==t.altKey||e.meta!==t.metaKey||t.key.toLowerCase()!==e.key?!1:e.key.length===1&&!/^[a-z0-9 ]$/.test(e.key)?e.shift?t.shiftKey:!0:e.shift===t.shiftKey}function fg(e){let t=e;return!t||typeof t.tagName!="string"?!1:t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT"?!0:t.isContentEditable===!0}function df(e){let t=[];return e.ctrl&&t.push("Control"),e.alt&&t.push("Alt"),e.shift&&t.push("Shift"),e.meta&&t.push("Meta"),t.push(e.key===" "?"Space":e.key.length===1?e.key.toUpperCase():e.key),t.join("+")}function pg(e){if(e.defaultPrevented)return;let t=fg(e.target);for(let n of[...Si])for(let r of n.combos)if(ug(r,e)&&!(t&&!n.options.allowInInput&&!r.hasModifier)){n.options.preventDefault!==!1&&e.preventDefault(),n.handler(e);break}}function Jr(e,t,n={}){let r=e.split(",").map(i=>Qa(i)).filter(i=>i!==null);if(!r.length||typeof document=="undefined")return()=>{};let o={combos:r,handler:t,options:n};return Si.push(o),Gu||(Gu=!0,document.addEventListener("keydown",pg)),()=>{let i=Si.indexOf(o);i>-1&&Si.splice(i,1)}}y("toggle",({el:e,expression:t,modifiers:n,cleanup:r})=>{xe();let o=rr(e,t);if(!o)return;let i=typeof n.class=="string"?n.class:null,s=!n.instant;e.setAttribute("aria-controls",Rt(o,"v-toggle")),Be(e,r);let a=i?o.classList.contains(i):!af(o),l=()=>{e.setAttribute("aria-expanded",String(a))},c=d=>{d.preventDefault(),i?(o.classList.toggle(i),a=o.classList.contains(i)):a?(ag(o,s),a=!1):(sg(o,s),a=!0),l(),fe(e,"voodoo:toggle",{target:o,open:a})};l(),e.addEventListener("click",c),r(()=>e.removeEventListener("click",c))});var Xa=class{constructor(t){P(this,"panel");P(this,"triggers",new Set);P(this,"listeners",new Set);P(this,"open");P(this,"duration");this.panel=t,this.duration=Q(Z(t,"collapse-duration"),240);let n=(Z(t,"collapse")||"").trim().toLowerCase();this.open=n==="open"||n==="true"||!af(t),t.classList.add("v-collapse-panel"),Rt(t,"v-collapse"),this.open||(t.style.display="none"),this.sync()}sync(){for(let t of this.triggers)t.setAttribute("aria-expanded",String(this.open)),t.setAttribute("aria-controls",this.panel.id);for(let t of this.listeners)t(this.open)}show(){this.open||(this.open=!0,this.panel.removeAttribute("hidden"),ve.reducedMotion?this.panel.style.removeProperty("display"):cn(this.panel,this.duration),this.sync(),fe(this.panel,"voodoo:collapse",{open:!0}))}hide(){this.open&&(this.open=!1,ve.reducedMotion?this.panel.style.display="none":dn(this.panel,this.duration),this.sync(),fe(this.panel,"voodoo:collapse",{open:!1}))}toggle(){this.open?this.hide():this.show()}},Qu=new WeakMap;function Ja(e){let t=Qu.get(e);return t||Qu.set(e,t=new Xa(e)),t}y("collapse",({el:e})=>{xe(),Ja(e)});y("collapse-toggle",({el:e,expression:t,cleanup:n})=>{xe();let r=rr(e,t);if(!r)return;let o=Ja(r);o.triggers.add(e),o.sync(),Be(e,n);let i=s=>{s.preventDefault(),o.toggle()};e.addEventListener("click",i),n(()=>{e.removeEventListener("click",i),o.triggers.delete(e)})});_("collapse-duration");var Ai=class{constructor(t,n,r){P(this,"trigger");P(this,"panel");P(this,"kind");P(this,"placement");P(this,"open",!1);P(this,"lastFocus",null);P(this,"homeParent");P(this,"homeNext");P(this,"reposition",()=>{this.open&&cf(this.trigger,this.panel,this.placement,this.kind==="menu"?"start":"center")});P(this,"onDocumentPointerDown",t=>{let n=t.target;n&&(this.panel.contains(n)||this.trigger.contains(n)||this.hide())});P(this,"onKeyDown",t=>{if(!this.open)return;if(t.key==="Escape"){t.preventDefault(),this.hide(!0);return}if(this.kind!=="menu"){t.key==="Tab"&&Ci(this.panel,t);return}let n=this.items();if(!n.length)return;let r=n.indexOf(document.activeElement);if(t.key==="Enter"||t.key===" "){let o=n[r];if(!o)return;t.preventDefault(),this.hide(!0),o.click();return}if(t.key==="ArrowDown"||t.key==="ArrowUp"){t.preventDefault();let o=t.key==="ArrowDown"?1:-1,i=(r+o+n.length)%n.length;n[r===-1&&o===-1?n.length-1:i].focus();return}if(t.key==="Home"){t.preventDefault(),n[0].focus();return}if(t.key==="End"){t.preventDefault(),n[n.length-1].focus();return}t.key==="Tab"&&this.hide()});this.trigger=t,this.panel=n,this.kind=r,this.homeParent=n.parentElement,this.homeNext=n.nextSibling,this.placement=lf(Z(t,r==="menu"?"dropdown-position":"popover-position"),"bottom"),Rt(n,r==="menu"?"v-menu":"v-popover"),n.classList.add(r==="menu"?"v-dropdown-menu":"v-popover"),n.hidden=!0,r==="menu"?uf(n):n.setAttribute("role","dialog"),t.setAttribute("aria-haspopup",r==="menu"?"menu":"dialog"),t.setAttribute("aria-controls",n.id),t.setAttribute("aria-expanded","false")}items(){return Array.from(this.panel.querySelectorAll('[role="menuitem"]'))}show(){var t;this.open||(this.open=!0,this.lastFocus=document.activeElement,this.panel.parentElement!==document.body&&document.body.appendChild(this.panel),this.panel.hidden=!1,this.reposition(),requestAnimationFrame(()=>this.panel.classList.add("v-in")),this.trigger.setAttribute("aria-expanded","true"),document.addEventListener("pointerdown",this.onDocumentPointerDown,!0),document.addEventListener("keydown",this.onKeyDown,!0),window.addEventListener("resize",this.reposition),window.addEventListener("scroll",this.reposition,!0),this.kind==="dialog"&&((t=Qr(this.panel)[0])==null||t.focus()),fe(this.trigger,"voodoo:popup",{open:!0,panel:this.panel}))}hide(t=!1){var r;if(!this.open)return;this.open=!1,this.panel.classList.remove("v-in"),this.trigger.setAttribute("aria-expanded","false"),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!0),document.removeEventListener("keydown",this.onKeyDown,!0),window.removeEventListener("resize",this.reposition),window.removeEventListener("scroll",this.reposition,!0);let n=()=>{this.open||(this.panel.hidden=!0)};ve.reducedMotion?n():setTimeout(n,160),t&&((r=this.lastFocus)!=null?r:this.trigger).focus(),fe(this.trigger,"voodoo:popup",{open:!1,panel:this.panel})}toggle(){this.open?this.hide(!0):this.show()}dispose(){this.hide(),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!0),document.removeEventListener("keydown",this.onKeyDown,!0),window.removeEventListener("resize",this.reposition),window.removeEventListener("scroll",this.reposition,!0),!(!this.homeParent||this.panel.parentElement===this.homeParent)&&(this.homeNext&&this.homeNext.parentNode===this.homeParent?this.homeParent.insertBefore(this.panel,this.homeNext):this.homeParent.appendChild(this.panel))}};function uf(e){xe(),e.classList.add("v-dropdown-menu"),e.hasAttribute("role")||e.setAttribute("role","menu");for(let t of Array.from(e.children)){let n=t;n.hasAttribute("role")||n.matches("a,button,[tabindex]")&&(n.setAttribute("role","menuitem"),n.setAttribute("tabindex","-1"))}}y("dropdown-menu",({el:e})=>{uf(e)});y("dropdown",({el:e,expression:t,cleanup:n})=>{xe();let r=rr(e,t);if(!r)return;let o=new Ai(e,r,"menu");Be(e,n);let i=a=>{a.preventDefault(),o.toggle()},s=a=>{var c;if(a.key==="ArrowDown"||a.key==="ArrowUp"){a.preventDefault(),o.open||o.show();let d=o.items();d.length&&d[a.key==="ArrowDown"?0:d.length-1].focus();return}if(a.key!=="Enter"&&a.key!==" ")return;let l=a.defaultPrevented;a.preventDefault(),l||o.toggle(),o.open&&((c=o.items()[0])==null||c.focus())};e.addEventListener("click",i),e.addEventListener("keydown",s),n(()=>{e.removeEventListener("click",i),e.removeEventListener("keydown",s),o.dispose()})});y("popover",({el:e,expression:t,cleanup:n})=>{xe();let r=rr(e,t);if(!r)return;let o=new Ai(e,r,"dialog");Be(e,n);let i=s=>{s.preventDefault(),o.toggle()};e.addEventListener("click",i),n(()=>{e.removeEventListener("click",i),o.dispose()})});_("dropdown-position");_("popover-position");y("tooltip",({el:e,expression:t,cleanup:n})=>{xe();let r=t.trim();if(!r)return;let o=lf(Z(e,"tooltip-position"),"top"),i=Q(Z(e,"tooltip-delay"),200),s=!e.hasAttribute("tabindex")&&!e.hasAttribute("disabled")&&!e.matches(nf);s&&e.setAttribute("tabindex","0");let a=null,l=null,c=()=>{let v=document.createElement("div");return v.className="v-tooltip",v.setAttribute("role","tooltip"),v.id=le("v-tip-"),v.textContent=r,document.body.appendChild(v),v},d=()=>{a&&cf(e,a,o)},u=()=>{a||(a=c(),e.setAttribute("aria-describedby",a.id),d(),requestAnimationFrame(()=>a==null?void 0:a.classList.add("v-in")),window.addEventListener("resize",d),window.addEventListener("scroll",d,!0))},p=()=>{if(l&&(clearTimeout(l),l=null),!a)return;let v=a;a=null,e.removeAttribute("aria-describedby"),window.removeEventListener("resize",d),window.removeEventListener("scroll",d,!0),v.classList.remove("v-in"),ve.reducedMotion?v.remove():setTimeout(()=>v.remove(),160)},f=()=>{l||a||(l=setTimeout(()=>{l=null,u()},i))},m=v=>{v.key==="Escape"&&p()},h=()=>{s&&e.focus()};e.addEventListener("mouseenter",f),e.addEventListener("focusin",u),e.addEventListener("pointerdown",h),e.addEventListener("mouseleave",p),e.addEventListener("focusout",p),e.addEventListener("keydown",m),n(()=>{p(),s&&e.removeAttribute("tabindex"),e.removeEventListener("mouseenter",f),e.removeEventListener("focusin",u),e.removeEventListener("pointerdown",h),e.removeEventListener("mouseleave",p),e.removeEventListener("focusout",p),e.removeEventListener("keydown",m)})});_("tooltip-position");_("tooltip-delay");y("tabs",({el:e,expression:t,cleanup:n})=>{xe();let r=Mi(e,"tab","tabs"),o=Mi(e,"tab-panel","tabs");if(!r.length)return;let i=(v,g)=>Kt(v,"tab")||String(g),s=r[0].parentElement;s&&!s.hasAttribute("role")&&s.setAttribute("role","tablist");let a=((s==null?void 0:s.getAttribute("aria-orientation"))||"").trim().toLowerCase()==="vertical";s==null||s.setAttribute("aria-orientation",a?"vertical":"horizontal");let l=Ti(e,"tabs-url")?Kt(e,"tabs-url")||"tab":null;r.forEach((v,g)=>{let b=i(v,g),w=o.find(T=>Kt(T,"tab-panel")===b);v.classList.add("v-tab","v-focus-ring"),v.setAttribute("role","tab"),Rt(v,"v-tab"),w&&(Rt(w,"v-panel"),w.setAttribute("role","tabpanel"),w.setAttribute("aria-labelledby",v.id),v.setAttribute("aria-controls",w.id))});let c="",d=(v,g=!1)=>{if(r.some((b,w)=>i(b,w)===v)){c=v,r.forEach((b,w)=>{let T=i(b,w)===v;b.setAttribute("aria-selected",String(T)),b.setAttribute("tabindex",T?"0":"-1"),b.classList.toggle("v-active",T),T&&g&&b.focus()});for(let b of o)b.hidden=Kt(b,"tab-panel")!==v;l&&Vt.set(l,v),fe(e,"voodoo:tab",{id:v})}},u=v=>{let g=Pn(v.target,"tab");!g||!r.includes(g)||(v.preventDefault(),d(i(g,r.indexOf(g))))},p=v=>{let g=Pn(v.target,"tab");if(!g||!r.includes(g))return;let b=r.indexOf(g),w=a?"ArrowDown":"ArrowRight",T=a?"ArrowUp":"ArrowLeft",k=-1;v.key===w?k=(b+1)%r.length:v.key===T?k=(b-1+r.length)%r.length:v.key==="Home"?k=0:v.key==="End"&&(k=r.length-1),k!==-1&&(v.preventDefault(),d(i(r[k],k),!0))},f=()=>{if(!l)return;let v=Vt.get(l);v&&v!==c&&d(v)};e.addEventListener("click",u),e.addEventListener("keydown",p),window.addEventListener("popstate",f),n(()=>{e.removeEventListener("click",u),e.removeEventListener("keydown",p),window.removeEventListener("popstate",f)});let h=(l?Vt.get(l):void 0)||t.trim()||i(r[0],0);d(h),c||d(i(r[0],0))});_("tab");_("tab-panel");_("tabs-url");y("accordion",({el:e,cleanup:t})=>{xe();let n=Mi(e,"accordion-item","accordion");if(!n.length)return;let r=Ti(e,"accordion-single"),o=[],i=[];for(let l of n){let c=l.firstElementChild,d=l.lastElementChild;if(!c||!d||c===d)continue;let u=(Kt(l,"accordion-item")||"").trim().toLowerCase();u!=="open"&&u!=="true"&&(d.style.display="none");let p=Ja(d);p.triggers.add(c),p.sync(),c.classList.add("v-accordion-header","v-focus-ring"),c.hasAttribute("role")||c.setAttribute("role","button"),c.hasAttribute("tabindex")||c.setAttribute("tabindex","0"),Rt(d,"v-accordion-panel"),c.setAttribute("aria-controls",d.id),c.setAttribute("aria-expanded",String(p.open)),n.length<=6&&!d.hasAttribute("role")&&(d.setAttribute("role","region"),d.setAttribute("aria-labelledby",Rt(c,"v-accordion-header"))),o.push(c),i.push(p)}let s=l=>{var p;let c=(p=l.target)==null?void 0:p.closest(".v-accordion-header");if(!c)return;let d=o.indexOf(c);if(d===-1)return;l.preventDefault();let u=i[d];if(r&&!u.open)for(let f of i)f!==u&&f.hide();u.toggle()},a=l=>{var p;let c=(p=l.target)==null?void 0:p.closest(".v-accordion-header");if(!c)return;let d=o.indexOf(c);if(d===-1)return;if(l.key==="Enter"||l.key===" "){l.preventDefault(),c.click();return}let u=-1;l.key==="ArrowDown"?u=(d+1)%o.length:l.key==="ArrowUp"?u=(d-1+o.length)%o.length:l.key==="Home"?u=0:l.key==="End"&&(u=o.length-1),u!==-1&&(l.preventDefault(),o[u].focus())};e.addEventListener("click",s),e.addEventListener("keydown",a),t(()=>{e.removeEventListener("click",s),e.removeEventListener("keydown",a)})});_("accordion-item");_("accordion-single");var Ga=class{constructor(t){P(this,"origem",null);P(this,"panel");P(this,"triggers",new Set);P(this,"open",!1);P(this,"backdrop",null);P(this,"lastFocus",null);P(this,"onKeyDown",t=>{if(this.open){if(t.key==="Escape"){t.preventDefault(),this.hide();return}t.key==="Tab"&&Ci(this.panel,t)}});P(this,"onPointerDown",t=>{let n=t.target;if(!(!n||this.panel.contains(n))){for(let r of this.triggers)if(r.contains(n))return;this.hide()}});this.panel=t;let n=(Z(t,"drawer-side")||"right").trim().toLowerCase();t.classList.add("v-drawer-panel"),t.setAttribute("data-side",["left","right","top","bottom"].includes(n)?n:"right"),t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.hasAttribute("tabindex")||t.setAttribute("tabindex","-1"),Rt(t,"v-drawer"),t.hidden=!0,this.label()}label(){let t=this.panel;if(t.hasAttribute("aria-labelledby")||t.hasAttribute("aria-label"))return;let n=t.querySelector("[data-drawer-title],h1,h2,h3,h4");n&&t.setAttribute("aria-labelledby",Rt(n,"v-drawer-title"))}sync(){for(let t of this.triggers)t.setAttribute("aria-expanded",String(this.open)),t.setAttribute("aria-controls",this.panel.id),t.setAttribute("aria-haspopup","dialog")}show(){var n,r;if(this.open)return;this.open=!0,this.lastFocus=document.activeElement,this.backdrop=document.createElement("div"),this.backdrop.className="v-drawer-backdrop",this.backdrop.addEventListener("click",()=>this.hide()),document.body.appendChild(this.backdrop),this.panel.parentElement!==document.body&&(this.origem=document.createComment(" v-drawer "),(n=this.panel.parentNode)==null||n.insertBefore(this.origem,this.panel),document.body.appendChild(this.panel)),this.panel.hidden=!1,this.label(),of();let t=()=>{var o;(o=this.backdrop)==null||o.classList.add("v-in"),this.panel.classList.add("v-open")};ve.reducedMotion?t():requestAnimationFrame(t),document.addEventListener("keydown",this.onKeyDown,!0),document.addEventListener("pointerdown",this.onPointerDown,!0),((r=Qr(this.panel)[0])!=null?r:this.panel).focus(),this.sync(),fe(this.panel,"voodoo:drawer",{open:!0})}hide(){var n,r;if(!this.open)return;this.open=!1,this.panel.classList.remove("v-open"),(n=this.backdrop)==null||n.classList.remove("v-in"),document.removeEventListener("keydown",this.onKeyDown,!0),document.removeEventListener("pointerdown",this.onPointerDown,!0);let t=()=>{var o;this.open||(this.panel.hidden=!0,(o=this.backdrop)==null||o.remove(),this.backdrop=null,this.origem&&this.origem.parentNode&&(this.origem.parentNode.insertBefore(this.panel,this.origem),this.origem.remove(),this.origem=null))};ve.reducedMotion?t():setTimeout(t,300),sf(),(r=this.lastFocus)==null||r.focus(),this.sync(),fe(this.panel,"voodoo:drawer",{open:!1})}toggle(){this.open?this.hide():this.show()}},Ju=new WeakMap;function Za(e){let t=Ju.get(e);return t||Ju.set(e,t=new Ga(e)),t}y("drawer-content",({el:e})=>{xe(),Za(e)});function ff(e,t,n){xe();let r=rr(e,t);if(!r)return;let o=Za(r);o.triggers.add(e),o.sync(),Be(e,n);let i=s=>{s.preventDefault(),o.toggle()};e.addEventListener("click",i),n(()=>{e.removeEventListener("click",i),o.triggers.delete(e)})}y("drawer",({el:e,expression:t,cleanup:n})=>{ff(e,t,n)});y("offcanvas",({el:e,expression:t,cleanup:n})=>{ff(e,t,n)});y("drawer-close",({el:e,expression:t,cleanup:n})=>{var i,s;let r=t.trim()?rr(e,t):(i=e.closest(".v-drawer-panel"))!=null?i:Pn(e,"drawer-content");if(!r)return;Be(e,n),!e.hasAttribute("aria-label")&&!((s=e.textContent)!=null&&s.trim())&&e.setAttribute("aria-label","Close");let o=a=>{a.preventDefault(),Za(r).hide()};e.addEventListener("click",o),n(()=>e.removeEventListener("click",o))});_("drawer-side");y("theme-toggle",({el:e,cleanup:t})=>{Be(e,t);let n=()=>{let i=ft.resolved==="dark";e.setAttribute("aria-pressed",String(i)),e.dataset.vTheme=ft.resolved,e.hasAttribute("aria-label")||e.setAttribute("aria-label",i?"Switch to light theme":"Switch to dark theme")},r=i=>{i.preventDefault(),ft.toggle(),n()},o=()=>n();n(),e.addEventListener("click",r),document.addEventListener("voodoo:theme",o),t(()=>{e.removeEventListener("click",r),document.removeEventListener("voodoo:theme",o)})});y("focus",({el:e,expression:t,modifiers:n,effect:r,evaluate:o})=>{let i=()=>{e.focus({preventScroll:!!n.quiet});let s=e;n.select&&typeof s.select=="function"&&s.select()};if(!t.trim()){Se(i);return}r(()=>{o()&&Se(i)})},{priority:j.INIT});y("focus-trap",({el:e,expression:t,effect:n,evaluate:r,cleanup:o})=>{let i=!t.trim(),s=a=>{!i||a.key!=="Tab"||e.isConnected&&Ci(e,a)};t.trim()?n(()=>{let a=!!r();a&&!i&&Se(()=>{var l;return((l=Qr(e)[0])!=null?l:e).focus()}),i=a}):Se(()=>{var a;return((a=Qr(e)[0])!=null?a:e).focus()}),e.hasAttribute("tabindex")||e.setAttribute("tabindex","-1"),document.addEventListener("keydown",s,!0),o(()=>document.removeEventListener("keydown",s,!0))});y("click-outside",({el:e,expression:t,scope:n,cleanup:r})=>{let o=i=>{if(!e.isConnected)return;let s=i.target;!s||e===s||e.contains(s)||vt(t,n,e,i)};document.addEventListener("pointerdown",o,!0),r(()=>document.removeEventListener("pointerdown",o,!0))});y("escape",({el:e,expression:t,scope:n,cleanup:r})=>{let o=i=>{i.key!=="Escape"||!e.isConnected||vt(t,n,e,i)};document.addEventListener("keydown",o),r(()=>document.removeEventListener("keydown",o))});y("hotkey",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim();if(!o)return;let i=Jr(o,()=>e.click(),{allowInInput:!!n.force,preventDefault:n.default!==!0}),s=Qa(o.split(",")[0]);s&&!e.hasAttribute("aria-keyshortcuts")&&e.setAttribute("aria-keyshortcuts",df(s)),r(i)});y("scroll-to",({el:e,expression:t,cleanup:n})=>{let r=o=>{let i=t.trim()||e.getAttribute("href")||"";if(!i)return;o.preventDefault();let s=parseFloat(Z(e,"scroll-offset")||"0")||0,a=ve.reducedMotion?"auto":"smooth";if(i==="top"||i==="#top"){window.scrollTo({top:0,behavior:a});return}if(i==="bottom"){window.scrollTo({top:document.body.scrollHeight,behavior:a});return}let l=null;try{l=document.querySelector(i)}catch(u){l=null}if(!l)return;let c=l.getBoundingClientRect().top+window.scrollY-s;window.scrollTo({top:c,behavior:a});let d=l;d.hasAttribute("tabindex")||d.setAttribute("tabindex","-1"),d.focus({preventScroll:!0})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});y("scrollspy",({el:e,cleanup:t})=>{let n=Array.from(e.querySelectorAll('a[href^="#"]'));if(!n.length)return;let r=Z(e,"scrollspy-class")||"v-active",o=parseFloat(Z(e,"scroll-offset")||"0")||0,i=n.map(c=>{let d=c.getAttribute("href")||"",u=d.length>1?document.querySelector(d):null;return u?{link:c,section:u}:null}).filter(c=>c!==null);if(!i.length)return;let s=null,a=()=>{let c=i[0];for(let d of i)d.section.getBoundingClientRect().top-o<=8&&(c=d);if(c.link!==s){s=c.link;for(let d of i){let u=d.link===s;d.link.classList.toggle(r,u),u?d.link.setAttribute("aria-current","true"):d.link.removeAttribute("aria-current")}fe(e,"voodoo:scrollspy",{id:c.section.id,link:c.link})}},l=Hr(a,100);window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),Se(a),t(()=>{l.cancel(),window.removeEventListener("scroll",l),window.removeEventListener("resize",l)})});_("scroll-offset");_("scrollspy-class");y("sticky",({el:e,expression:t,cleanup:n})=>{xe();let r=parseFloat(t.trim()||Z(e,"sticky-offset")||"0")||0;if(e.classList.add("v-sticky"),e.style.setProperty("--v-sticky-offset",`${r}px`),typeof IntersectionObserver=="undefined")return;let o=new IntersectionObserver(i=>{for(let s of i){let a=s.intersectionRatio<1&&s.boundingClientRect.top<=r+1;e.classList.toggle("v-stuck",a)}},{threshold:[1],rootMargin:`-${r+1}px 0px 0px 0px`});o.observe(e),n(()=>o.disconnect())});_("sticky-offset");y("visible",({el:e,expression:t,scope:n,modifiers:r,cleanup:o})=>{var c;let i=!!r.repeat,s=Number((c=r.threshold)!=null?c:.1)||.1,a=typeof r.margin=="string"?r.margin:"0px";if(typeof IntersectionObserver=="undefined"){vt(t,n,e,void 0,{visible:!0});return}let l=new IntersectionObserver(d=>{for(let u of d)u.isIntersecting&&(vt(t,n,e,void 0,u),i||l.unobserve(e))},{threshold:s,rootMargin:a});l.observe(e),o(()=>l.disconnect())});y("infinite-scroll",({el:e,expression:t,scope:n,cleanup:r})=>{let o=Z(e,"infinite-distance")||"200px",i=!1,s=()=>{i=!1},a=()=>{if(i)return;i=!0,e.setAttribute("aria-busy","true");let d=vt(t,n,e,void 0,{page:"next"}),u=()=>{e.removeAttribute("aria-busy"),setTimeout(s,120)};d&&typeof d.then=="function"?d.then(u,u):setTimeout(u,300)};if(typeof IntersectionObserver=="undefined")return;let l=document.createElement("div");l.className="v-infinite-sentinel",l.setAttribute("aria-hidden","true"),l.style.cssText="width:100%;height:1px;pointer-events:none",e.appendChild(l);let c=new IntersectionObserver(d=>{for(let u of d)u.isIntersecting&&a()},{rootMargin:`0px 0px ${o} 0px`});c.observe(l),r(()=>{c.disconnect(),l.remove()})});_("infinite-distance");function pf(e,t,n,r){if(xe(),!t)return;e.classList.add("v-lazy");let o=a=>{r?e.style.backgroundImage=`url("${a}")`:e.src=a,e.classList.add("v-lazy-loaded")},i=()=>{let a=new Image;a.onload=()=>o(t),a.onerror=()=>{let l=Z(e,"lazy-error");e.classList.add("v-lazy-failed"),l?o(l):e.classList.add("v-lazy-loaded")},a.src=t};if(!r&&e.tagName==="IMG"){let a=e;a.hasAttribute("loading")||(a.loading="lazy"),a.hasAttribute("decoding")||(a.decoding="async")}if(typeof IntersectionObserver=="undefined"){i();return}let s=new IntersectionObserver(a=>{for(let l of a)l.isIntersecting&&(s.disconnect(),i())},{rootMargin:"200px"});s.observe(e),n(()=>s.disconnect())}y("lazy-src",({el:e,expression:t,cleanup:n})=>{pf(e,t.trim(),n,!1)});y("lazy-bg",({el:e,expression:t,cleanup:n})=>{pf(e,t.trim(),n,!0)});_("lazy-error");y("skeleton",({el:e,expression:t,effect:n,evaluate:r,cleanup:o})=>{xe();let i=l=>{e.classList.toggle("v-skeleton",l),l?e.setAttribute("aria-busy","true"):e.removeAttribute("aria-busy")};if(t.trim()){n(()=>i(!!r()));return}let s=()=>{var l;return((l=e.textContent)!=null?l:"").trim().length>0||e.querySelector("img,svg,video,canvas")!==null};if(s()){i(!1);return}if(i(!0),typeof MutationObserver=="undefined")return;let a=new MutationObserver(()=>{s()&&(i(!1),a.disconnect())});a.observe(e,{childList:!0,subtree:!0,characterData:!0}),o(()=>a.disconnect())});async function el(e){var t;try{if((t=navigator.clipboard)!=null&&t.writeText)return await navigator.clipboard.writeText(e),!0}catch(n){}try{let n=document.createElement("textarea");n.value=e,n.setAttribute("readonly",""),n.style.cssText="position:fixed;top:-1000px;left:-1000px;opacity:0",document.body.appendChild(n),n.select();let r=document.execCommand("copy");return n.remove(),r}catch(n){return!1}}function tl(e,t){xe();let n=Z(e,"copy-label")||(t?"Copied!":"Could not copy");e.dataset.vCopyLabel=n,e.classList.add(t?"v-copied":"v-copy-failed"),Qe(n),setTimeout(()=>e.classList.remove("v-copied","v-copy-failed"),1600)}function mf(e,t){var r;let n=Z(e,"copy-from");if(n){let o=document.querySelector(n);if(o){let i=o;return typeof i.value=="string"&&i.value?i.value:((r=o.textContent)!=null?r:"").trim()}}return t.trim()}y("copy",({el:e,expression:t,cleanup:n})=>{xe(),Be(e,n);let r=o=>{o.preventDefault();let i=mf(e,t);i&&el(i).then(s=>{tl(e,s),fe(e,"voodoo:copy",{text:i,ok:s})})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});y("copy-from",({el:e,expression:t,cleanup:n})=>{if(xe(),Li(e,"copy-from",t),Ti(e,"copy"))return;Be(e,n);let r=o=>{o.preventDefault();let i=mf(e,"");i&&el(i).then(s=>{tl(e,s),fe(e,"voodoo:copy",{text:i,ok:s})})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});_("copy-label");function mg(e,t){let n=document.createElement("iframe");n.setAttribute("aria-hidden","true"),n.setAttribute("title","Print"),n.style.cssText="position:fixed;right:0;bottom:0;width:0;height:0;border:0;visibility:hidden";let r=Array.from(document.querySelectorAll('link[rel="stylesheet"],style')).map(o=>o.outerHTML).join(`
`);n.srcdoc=`<!doctype html><html><head><meta charset="utf-8"><title>${I(t)}</title>${r}</head><body>${e.outerHTML}</body></html>`,n.addEventListener("load",()=>{let o=n.contentWindow;if(!o){n.remove();return}o.focus(),o.print(),setTimeout(()=>n.remove(),1e3)}),document.body.appendChild(n)}y("print",({el:e,expression:t,cleanup:n})=>{Be(e,n);let r=o=>{o.preventDefault();let i=t.trim(),s=i?document.querySelector(i):null;if(!i){window.print();return}s&&mg(s,document.title)};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});y("share",({el:e,expression:t,cleanup:n})=>{xe(),Be(e,n);let r=o=>{o.preventDefault();let i=t.trim()||Z(e,"share-url")||location.href,s={title:Z(e,"share-title")||document.title,url:i},a=Z(e,"share-text");a&&(s.text=a);let l=navigator;if(typeof l.share=="function"){l.share(s).then(()=>fe(e,"voodoo:share",{data:s,method:"native"}),()=>{});return}el(i).then(c=>{tl(e,c),fe(e,"voodoo:share",{data:s,method:"clipboard",ok:c})})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});_("share-title");_("share-url");_("share-text");y("fullscreen",({el:e,expression:t,cleanup:n})=>{var s;Be(e,n);let r=t.trim()&&(s=document.querySelector(t.trim()))!=null?s:e,o=()=>{e.setAttribute("aria-pressed",String(document.fullscreenElement===r))},i=a=>{var c;if(a.preventDefault(),document.fullscreenElement){document.exitFullscreen().catch(()=>{});return}let l=r;typeof r.requestFullscreen=="function"?r.requestFullscreen().catch(()=>{}):(c=l.webkitRequestFullscreen)==null||c.call(l)};o(),e.addEventListener("click",i),document.addEventListener("fullscreenchange",o),n(()=>{e.removeEventListener("click",i),document.removeEventListener("fullscreenchange",o)})});y("download",({el:e,expression:t,cleanup:n})=>{Be(e,n);let r=o=>{let i=t.trim()||e.getAttribute("href")||"";if(!i)return;o.preventDefault();let s=document.createElement("a");s.href=i,s.rel="noopener",s.download=Z(e,"download-name")||"",s.style.display="none",document.body.appendChild(s),s.click(),s.remove(),fe(e,"voodoo:download",{href:i,name:s.download})};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});_("download-name");y("resizable",({el:e,expression:t,cleanup:n})=>{xe();let r=(t.trim()||"both").toLowerCase(),o=r==="both"||r==="horizontal",i=r==="both"||r==="vertical";e.classList.add("v-resizable"),getComputedStyle(e).position==="static"&&(e.style.position="relative");let s=[],a=[];o&&a.push("right"),i&&a.push("bottom"),o&&i&&a.push("corner");let l=(c,d)=>{let u=0,p=0,f=0,m=0,h=g=>{d!=="bottom"&&(e.style.width=`${Math.max(32,f+g.clientX-u)}px`),d!=="right"&&(e.style.height=`${Math.max(32,m+g.clientY-p)}px`)},v=g=>{var b;(b=c.releasePointerCapture)==null||b.call(c,g.pointerId),c.removeEventListener("pointermove",h),c.removeEventListener("pointerup",v),c.removeEventListener("pointercancel",v),fe(e,"voodoo:resized",{width:e.getBoundingClientRect().width,height:e.getBoundingClientRect().height})};c.addEventListener("pointerdown",g=>{var w;if(g.button!==0)return;g.preventDefault();let b=e.getBoundingClientRect();u=g.clientX,p=g.clientY,f=b.width,m=b.height,(w=c.setPointerCapture)==null||w.call(c,g.pointerId),c.addEventListener("pointermove",h),c.addEventListener("pointerup",v),c.addEventListener("pointercancel",v)}),c.addEventListener("keydown",g=>{let b=g.shiftKey?4:16,w=e.getBoundingClientRect(),T=!0;g.key==="ArrowRight"&&d!=="bottom"?e.style.width=`${w.width+b}px`:g.key==="ArrowLeft"&&d!=="bottom"?e.style.width=`${Math.max(32,w.width-b)}px`:g.key==="ArrowDown"&&d!=="right"?e.style.height=`${w.height+b}px`:g.key==="ArrowUp"&&d!=="right"?e.style.height=`${Math.max(32,w.height-b)}px`:T=!1,T&&(g.preventDefault(),fe(e,"voodoo:resized",{width:e.getBoundingClientRect().width,height:e.getBoundingClientRect().height}))})};for(let c of a){let d=document.createElement("div");d.className="v-resize-handle",d.setAttribute("data-dir",c),d.setAttribute("role","separator"),d.setAttribute("tabindex","0"),d.setAttribute("aria-orientation",c==="bottom"?"horizontal":"vertical"),d.setAttribute("aria-label","Resize"),l(d,c),e.appendChild(d),s.push(d)}n(()=>{for(let c of s)c.remove()})});function Zu(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function vg(){let e=[];for(let t of Vo(document,"command-item")){let n=(Kt(t,"command-item")||t.textContent||"").trim();n&&(t.closest("[hidden]")||e.push({label:n,hint:Z(t,"command-hint")||"",el:t}))}return e}function ef(){if(xe(),document.querySelector(".v-command"))return;let e=vg(),t=document.activeElement,n=document.createElement("div");n.className="v-command",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Command palette"),n.tabIndex=-1;let r=document.createElement("div");r.className="v-command-box";let o=document.createElement("input");o.className="v-command-input",o.type="search",o.placeholder="Search command...",o.setAttribute("aria-label","Search command"),o.setAttribute("role","combobox"),o.setAttribute("aria-expanded","true"),o.setAttribute("autocomplete","off");let i=document.createElement("ul");i.className="v-command-list",i.id=le("v-cmd-list-"),i.setAttribute("role","listbox"),o.setAttribute("aria-controls",i.id),r.append(o,i),n.appendChild(r),document.body.appendChild(n),of();let s=e,a=0,l=m=>{let h=m.target;!h||n.contains(h)||o.focus()},c=()=>{document.removeEventListener("focusin",l,!0),document.removeEventListener("keydown",f,!0),n.remove(),sf(),t==null||t.focus()},d=()=>{let m=s[a];m&&(c(),m.el.click())},u=()=>{var h;if(i.replaceChildren(),!s.length){let v=document.createElement("li");v.className="v-command-empty",v.textContent="No command found",i.appendChild(v);return}s.forEach((v,g)=>{let b=document.createElement("li");b.className="v-command-option",b.id=`${i.id}-${g}`,b.setAttribute("role","option"),b.setAttribute("aria-selected",String(g===a));let w=document.createElement("span");if(w.textContent=v.label,b.appendChild(w),v.hint){let T=document.createElement("span");T.className="v-command-hint",T.textContent=v.hint,b.appendChild(T)}b.addEventListener("click",()=>{a=g,d()}),b.addEventListener("pointermove",()=>{a!==g&&(a=g,u())}),i.appendChild(b)});let m=i.children[a];m&&(o.setAttribute("aria-activedescendant",m.id),(h=m.scrollIntoView)==null||h.call(m,{block:"nearest"}))},p=()=>{let m=Zu(o.value.trim());s=m?e.filter(h=>Zu(`${h.label} ${h.hint}`).includes(m)):e,a=0,u()},f=m=>{if(m.key==="Escape"){m.preventDefault(),c();return}if(m.key==="ArrowDown"){m.preventDefault(),a=s.length?(a+1)%s.length:0,u();return}if(m.key==="ArrowUp"){m.preventDefault(),a=s.length?(a-1+s.length)%s.length:0,u();return}if(m.key==="Enter"){m.preventDefault(),d();return}m.key==="Tab"&&Ci(n,m)};n.addEventListener("pointerdown",m=>{m.target===n&&c()}),o.addEventListener("input",p),document.addEventListener("keydown",f,!0),u(),o.focus(),document.addEventListener("focusin",l,!0)}y("command",({el:e,expression:t,cleanup:n})=>{xe();let r=t.trim()||Z(e,"command-key")||"mod+k",o=a=>{a.preventDefault(),ef()},i=Jr(r,()=>ef(),{allowInInput:!0}),s=Qa(r.split(",")[0]);s&&!e.hasAttribute("aria-keyshortcuts")&&e.setAttribute("aria-keyshortcuts",df(s)),Be(e,n),e.addEventListener("click",o),n(()=>{i(),e.removeEventListener("click",o)})});y("command-item",({el:e,expression:t})=>{Li(e,"command-item",t),!e.hasAttribute("data-v-command-label")&&t.trim()&&e.setAttribute("data-v-command-label",t.trim())});_("command-key");_("command-hint");var tf=["pointerdown","pointermove","keydown","wheel","touchstart","scroll"];y("idle",({el:e,expression:t,scope:n,cleanup:r})=>{let o=Q(Z(e,"idle-after"),6e4),i=null,s=!1,a=()=>{s=!0,vt(t,n,e,void 0,{idle:!0,after:o}),fe(e,"voodoo:idle",{after:o})},l=()=>{i&&clearTimeout(i),s=!1,i=setTimeout(a,o)},c=()=>{if(s){l();return}l()};for(let d of tf)window.addEventListener(d,c,{passive:!0});l(),r(()=>{i&&clearTimeout(i);for(let d of tf)window.removeEventListener(d,c)})});_("idle-after");function vf(e,t,n,r,o,i){let s=a=>{vt(t,n,e,a,{online:navigator.onLine}),fe(e,`voodoo:${o}`,{online:navigator.onLine})};window.addEventListener(o,s),r(()=>window.removeEventListener(o,s)),i&&navigator.onLine===(o==="online")&&Se(()=>s())}y("online",({el:e,expression:t,scope:n,modifiers:r,cleanup:o})=>{vf(e,t,n,o,"online",!!r.immediate)});y("offline",({el:e,expression:t,scope:n,modifiers:r,cleanup:o})=>{vf(e,t,n,o,"offline",r["no-immediate"]!==!0)});me();ce();He();me();ce();He();var at={required:"Please fill in this field.",email:"Enter a valid email address.",url:"Enter a valid URL.",number:"Enter a valid number.",integer:"Enter a whole number.",decimal:"Enter a valid decimal number.",alpha:"Use letters only.",alphanumeric:"Use letters and numbers only.",minlength:"Use at least {param} characters.",maxlength:"Use at most {param} characters.",min:"The smallest allowed value is {param}.",max:"The largest allowed value is {param}.",between:"Enter a value between {min} and {max}.",match:"The fields do not match.",regex:"That format is not valid.",date:"Enter a valid date.",after:"The date has to be later than {param}.",before:"The date has to be earlier than {param}.",accepted:"You have to tick this to continue.",same:"The values have to be the same.",different:"The values have to be different.",in:"Choose one of the allowed options.",notin:"That value is not allowed.",phone:"Enter a valid phone number, including the area code.",cpf:"Invalid CPF.",cnpj:"Invalid CNPJ.",cep:"Invalid postcode.",creditcard:"Invalid card number.",strongpassword:"Use {param} characters or more, with an upper case letter, a lower case letter, a number and a symbol.",unique:"That value is already taken.",invalid:"Invalid value."};function gf(e,t){var i,s,a,l,c,d;let n=(i=t.param)!=null?i:"",r=n.split(","),o={param:n,field:(s=t.field)!=null?s:"field",value:(a=t.value)!=null?a:"",min:((l=r[0])!=null?l:"").trim(),max:((d=(c=r[1])!=null?c:r[0])!=null?d:"").trim()};return e.replace(/\{(\w+)\}/g,(u,p)=>p in o?o[p]:u)}var Di=new Map;function J(e,t,n){let r=e.toLowerCase();Di.set(r,{name:r,fn:t,message:n}),n&&!at[r]&&(at[r]=n),y(`validate-${r}`,({el:o,cleanup:i})=>{Bi(o,i)})}function $t(e,t){var n;return(n=Te(e,`${x.prefix}${t}`))!=null?n:Te(e,`data-v-${t}`)}function hg(e,t){return $t(e,t)!==null}var gg=new Set(["INPUT","SELECT","TEXTAREA"]),bg=new Set(["submit","button","reset","image"]);function Je(e){var t;return!!e&&typeof e=="object"&&gg.has((t=e.tagName)!=null?t:"")}function gt(e){return e.tagName==="SELECT"?"select":e.tagName==="TEXTAREA"?"textarea":(e.getAttribute("type")||"text").toLowerCase()}function to(e){var n;let t=gt(e);if(t==="checkbox"||t==="radio")return e.checked?e.value||"on":"";if(t==="file"){let r=e.files;return r&&r.length?String(r.length):""}return(n=e.value)!=null?n:""}function ol(e){return e.name||e.id||`field-${e.tagName.toLowerCase()}`}function yg(e){var o,i;let t=$t(e,"label");if(t)return t;if(e.id&&typeof document!="undefined"){let s=document.querySelector(`label[for="${Ri(e.id)}"]`),a=(o=s==null?void 0:s.textContent)==null?void 0:o.trim();if(a)return a.replace(/\s*\*$/,"")}let n=e.closest("label"),r=(i=n==null?void 0:n.textContent)==null?void 0:i.trim();return r?r.replace(/\s*\*$/,""):e.getAttribute("aria-label")||e.getAttribute("placeholder")||e.name||"field"}function Ri(e){let t=globalThis.CSS;return t&&typeof t.escape=="function"?t.escape(e):e.replace(/["'\\\]\[]/g,"\\$&")}function Pi(e,t){var s,a,l;let n=t.trim();if(!n||typeof document=="undefined")return null;let r=(a=(s=e.form)!=null?s:e.closest("form"))!=null?a:document;if(/^[#.[]/.test(n)){let c=(l=r.querySelector(n))!=null?l:document.querySelector(n);return Je(c)?c:null}let o=r.querySelector(`[name="${Ri(n)}"]`);if(Je(o))return o;let i=document.getElementById(n);return Je(i)?i:null}var xg=/^[^\s@]+@[^\s@.]+(?:\.[^\s@.]+)+$/,wg=/^-?\d+$/,Eg=/^-?\d+(?:[.,]\d+)?$/,kg=/^[A-Za-zÀ-ÖØ-öø-ɏ]+$/,Tg=/^[A-Za-z0-9À-ÖØ-öø-ɏ]+$/;function no(e){return e.replace(/\D/g,"")}function Hi(e){return Number(String(e).replace(/\s/g,"").replace(/\.(?=\d{3}\b)/g,"").replace(",","."))}function Lg(e){let t=no(e);if(t.length!==11||/^(\d)\1{10}$/.test(t))return!1;let n=0;for(let i=0;i<9;i++)n+=Number(t[i])*(10-i);let r=n*10%11;if(r===10&&(r=0),r!==Number(t[9]))return!1;n=0;for(let i=0;i<10;i++)n+=Number(t[i])*(11-i);let o=n*10%11;return o===10&&(o=0),o===Number(t[10])}function Mg(e){let t=no(e);if(t.length!==14||/^(\d)\1{13}$/.test(t))return!1;let n=r=>{let o=r-7,i=0;for(let a=0;a<r;a++)i+=Number(t[a])*o--,o<2&&(o=9);let s=i%11;return s<2?0:11-s};return n(12)===Number(t[12])&&n(13)===Number(t[13])}function Sg(e){let t=no(e);if(t.length<13||t.length>19)return!1;let n=0,r=!1;for(let o=t.length-1;o>=0;o--){let i=Number(t[o]);r&&(i*=2,i>9&&(i-=9)),n+=i,r=!r}return n%10===0}function Ag(e){let t=no(e);return!(t.length!==10&&t.length!==11||Number(t.slice(0,2))<11||t.length===11&&t[2]!=="9"||t.length===10&&Number(t[2])<2)}function mn(e){let t=e.trim();if(!t)return null;let n=/^(\d{2})\/(\d{2})\/(\d{4})$/.exec(t);if(n){let i=new Date(Number(n[3]),Number(n[2])-1,Number(n[1]));return i.getFullYear()===Number(n[3])&&i.getMonth()===Number(n[2])-1&&i.getDate()===Number(n[1])?i:null}let r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(r){let i=new Date(Number(r[1]),Number(r[2])-1,Number(r[3]));return i.getFullYear()===Number(r[1])&&i.getMonth()===Number(r[2])-1&&i.getDate()===Number(r[3])?i:null}let o=Date.parse(t);return Number.isNaN(o)?null:new Date(o)}function Ni(e,t){if(!e)return null;let n=e.trim().toLowerCase();if(n==="hoje"||n==="today"||n==="now"||n==="agora")return new Date;let r=mn(e);if(r)return r;let o=Pi(t,e);return o?mn(to(o)):null}J("required",(e,t,n)=>{let r=gt(n);if(r==="checkbox"||r==="radio")return n.checked;if(r==="file"){let o=n.files;return!!o&&o.length>0}return e.trim().length>0});J("email",e=>xg.test(e.trim()));J("url",e=>{let t=e.trim();if(!t)return!1;try{let n=new URL(/^[a-z][a-z0-9+.-]*:\/\//i.test(t)?t:`https://${t}`);return n.hostname.includes(".")&&!n.hostname.endsWith(".")}catch(n){return!1}});J("number",e=>e.trim()!==""&&Number.isFinite(Hi(e)));J("integer",e=>wg.test(e.trim()));J("decimal",(e,t)=>{var i;let n=e.trim();if(!Eg.test(n))return!1;if(!t)return!0;let r=Number(t);return Number.isFinite(r)?((i=n.split(/[.,]/)[1])!=null?i:"").length<=r:!0});J("alpha",e=>kg.test(e.trim().replace(/\s+/g,"")));J("alphanumeric",e=>Tg.test(e.trim().replace(/\s+/g,"")));J("minlength",(e,t)=>e.trim().length>=Number(t!=null?t:0));J("maxlength",(e,t)=>e.trim().length<=Number(t!=null?t:1/0));J("min",(e,t,n)=>{let r=Ni(t,n);if(r&&gt(n).startsWith("date")){let o=mn(e);return!o||o.getTime()>=r.getTime()}return Hi(e)>=Number(t!=null?t:0)});J("max",(e,t,n)=>{let r=Ni(t,n);if(r&&gt(n).startsWith("date")){let o=mn(e);return!o||o.getTime()<=r.getTime()}return Hi(e)<=Number(t!=null?t:1/0)});J("between",(e,t)=>{let[n,r]=(t!=null?t:"").split(",").map(i=>Number(i.trim())),o=Hi(e);return Number.isFinite(o)&&o>=n&&o<=r});J("match",(e,t,n)=>{if(!t)return!0;let r=Pi(n,t);return r?to(r)===e:!0});J("same",(e,t,n)=>{if(!t)return!0;let r=Pi(n,t);return!r||to(r)===e});J("different",(e,t,n)=>{if(!t)return!0;let r=Pi(n,t);return!r||to(r)!==e});J("regex",(e,t,n)=>{var o;if(!t)return!0;let r=(o=$t(n,"regex-flags"))!=null?o:"";try{return new RegExp(t,r).test(e)}catch(i){return X(`Invalid regular expression in ${x.prefix}regex: ${t}`),!0}});J("date",e=>mn(e)!==null);J("after",(e,t,n)=>{let r=Ni(t,n),o=mn(e);return!r||!o?!0:o.getTime()>r.getTime()});J("before",(e,t,n)=>{let r=Ni(t,n),o=mn(e);return!r||!o?!0:o.getTime()<r.getTime()});J("accepted",(e,t,n)=>{let r=gt(n);return r==="checkbox"||r==="radio"?n.checked:["1","true","on","yes","sim"].includes(e.trim().toLowerCase())});J("in",(e,t)=>(t!=null?t:"").split(",").map(n=>n.trim()).includes(e.trim()));J("notin",(e,t)=>!(t!=null?t:"").split(",").map(n=>n.trim()).includes(e.trim()));J("phone",e=>Ag(e));J("cpf",e=>Lg(e));J("cnpj",e=>Mg(e));J("cep",e=>no(e).length===8);J("creditcard",e=>Sg(e));J("strongpassword",(e,t)=>{let n=Number(t)>0?Number(t):8;return e.length>=n&&/[a-zà-ÿ]/.test(e)&&/[A-ZÀ-ß]/.test(e)&&/\d/.test(e)&&/[^\w\s]/.test(e)?!0:gf(at.strongpassword,{param:String(n)})});J("unique",async(e,t,n)=>{let r=t||$t(n,"unique-url")||"";if(!r||!e.trim())return!0;try{let o=await he.get(r,{params:{value:e,field:ol(n)},timeout:8e3});return o&&typeof o=="object"&&"available"in o?o.available===!0?!0:at.unique:o?at.unique:!0}catch(o){if(o instanceof ke){if(o.status===404)return!0;if(o.status>=400&&o.status<500)return at.unique}return!0}});var Cg={"strong-password":"strongpassword","credit-card":"creditcard","min-length":"minlength","max-length":"maxlength","not-in":"notin","nao-vazio":"required",obrigatorio:"required"},Rg=new Set(["required","accepted"]);function $g(e){var o;let t=null;if(e.startsWith(x.prefix)?t=e.slice(x.prefix.length):e.startsWith("data-v-")&&(t=e.slice(7)),!t)return null;let n=t.indexOf(".");if(n>-1&&(t=t.slice(0,n)),t==="validate")return null;t.startsWith("validate-")&&(t=t.slice(9));let r=(o=Cg[t])!=null?o:t;return Di.has(r)?r:null}function il(e){let t=[],n=new Set,r=(d,u)=>{n.has(d)||!Di.has(d)||(n.add(d),t.push({name:d,param:u}))};for(let[d,u]of ud(e)){let p=$g(d);if(p){if(u.trim()==="false"){n.add(p);continue}r(p,u)}}let o=gt(e);e.hasAttribute("required")&&r("required",""),o==="email"&&r("email",""),o==="url"&&r("url",""),(o==="number"||o==="range")&&r("number","");let i=e.getAttribute("minlength");i&&r("minlength",i);let s=e.getAttribute("maxlength");s&&r("maxlength",s);let a=e.getAttribute("min");a&&r("min",a);let l=e.getAttribute("max");l&&r("max",l);let c=e.getAttribute("pattern");return c&&r("regex",c),t.sort((d,u)=>d.name==="required"?-1:u.name==="required"?1:0),t}var Dg=`
...
`;function Oi(){ge(),oe("forms-validate",Dg)}function bf(e){var r,o,i;let t=$t(e,"error-target");if(t&&typeof document!="undefined"){let s=(i=(o=(r=e.form)!=null?r:e.closest("form"))==null?void 0:o.querySelector(t))!=null?i:document.querySelector(t);if(s)return{parent:s,anchor:null};X(`Target for ${x.prefix}error-target not found: ${t}`)}let n=e.parentElement;return n?{parent:n,anchor:e}:null}function yf(e){let t=bf(e);if(!t)return null;if(t.anchor){let n=t.anchor.nextElementSibling;return n&&n.classList.contains("v-field-error")?n:null}return t.parent.querySelector(".v-field-error")}function Fi(e,t){Oi(),e.classList.add("v-invalid"),e.classList.remove("v-valid"),e.setAttribute("aria-invalid","true");let n=yf(e);if(!n){let o=bf(e);if(!o)return;n=document.createElement("span"),n.className="v-field-error",n.id=e.id?`${e.id}-error`:le("v-error-"),n.setAttribute("role","alert"),n.setAttribute("aria-live","polite"),o.anchor?o.anchor.insertAdjacentElement("afterend",n):o.parent.appendChild(n)}n.textContent=t;let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.push(n.id),e.setAttribute("aria-describedby",r.join(" "))}function nl(e,t=!1){e.classList.remove("v-invalid"),e.classList.toggle("v-valid",t),e.removeAttribute("aria-invalid");let n=yf(e);if(n){let r=(e.getAttribute("aria-describedby")||"").split(/\s+/).filter(o=>o&&o!==n.id);r.length?e.setAttribute("aria-describedby",r.join(" ")):e.removeAttribute("aria-describedby"),n.remove()}}function ro(e){for(let n of zi(e,!1))nl(n);for(let n of Array.from(e.querySelectorAll(".v-field-error")))n.remove();let t=e.querySelector(".v-form-error");t&&t.remove();for(let n of Array.from(e.querySelectorAll(".v-invalid, .v-valid")))n.classList.remove("v-invalid","v-valid"),n.removeAttribute("aria-invalid")}function sl(e){let t={};if(!e||typeof e!="object")return t;let n=e,r=n.errors&&typeof n.errors=="object"?n.errors:n;for(let[o,i]of Object.entries(r))o==="message"||o==="mensagem"||o==="errors"||(typeof i=="string"?t[o]=i:Array.isArray(i)&&typeof i[0]=="string"&&(t[o]=i[0]));return t}function Pg(e,t){let n=t.replace(/\.(\w+)/g,"[$1]"),r=[t,n,`${t}[]`,`${n}[]`];for(let i of r){let s=e.querySelector(`[name="${Ri(i)}"]`);if(Je(s))return s}let o=e.querySelector(`#${Ri(t)}`);return Je(o)?o:null}function Ii(e,t){let n=sl(t),r=[];for(let[o,i]of Object.entries(n)){let s=Pg(e,o);s?Fi(s,i):r.push(i)}return r.length&&Hg(e,r),n}function Hg(e,t){Oi();let n=e.querySelector(".v-form-error");if(n||(n=document.createElement("div"),n.className="v-form-error",n.setAttribute("role","alert"),e.prepend(n)),n.textContent="",t.length===1){n.textContent=t[0];return}let r=document.createElement("ul");for(let o of t){let i=document.createElement("li");i.textContent=o,r.appendChild(i)}n.appendChild(r)}function al(e){let t=e.querySelector(".v-invalid");if(!t)return!1;try{t.focus({preventScroll:!0})}catch(r){t.focus()}let n=typeof window!="undefined"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;return typeof t.scrollIntoView=="function"&&t.scrollIntoView({block:"center",behavior:n?"auto":"smooth"}),!0}function zi(e,t=!0){let n=e.tagName==="FORM"?Array.from(e.elements):Array.from(e.querySelectorAll("input, select, textarea")),r=[];for(let o of n)Je(o)&&(o.disabled||bg.has(gt(o))||t&&il(o).length===0||r.push(o));return r}async function ll(e,t={}){var s,a;if(!Je(e))return{valid:!0};let n=il(e);if(!n.length)return t.silent||nl(e),{valid:!0};let r=to(e),o=$t(e,"error-message"),i=r.trim()==="";for(let l of n){if(i&&!Rg.has(l.name))continue;let c=Di.get(l.name);if(!c)continue;let d;try{d=await c.fn(r,l.param||void 0,e)}catch(f){X(`Rule "${l.name}" failed to execute`,f);continue}if(d===!0)continue;let u=o!=null?o:typeof d=="string"?d:(a=(s=at[l.name])!=null?s:c.message)!=null?a:at.invalid,p=gf(u,{field:yg(e),param:l.param,value:r});return t.silent||(Fi(e,p),hf(e,{valid:!1,message:p,rule:l.name})),{valid:!1,message:p,rule:l.name}}return t.silent||(nl(e,!i),hf(e,{valid:!0})),{valid:!0}}function cl(e){return Je(e)?ll(e):dl(e)}async function dl(e){let t=zi(e),n=await Promise.all(t.map(o=>ll(o))),r={};return t.forEach((o,i)=>{var a;let s=n[i];s.valid||(r[ol(o)]=(a=s.message)!=null?a:at.invalid)}),{valid:Object.keys(r).length===0,errors:r}}function hf(e,t){e.dispatchEvent(new CustomEvent("voodoo:field-validated",{bubbles:!0,detail:{field:ol(e),...t}}))}function Ng(e){let t=e.indexOf("[");if(t===-1)return[e];let n=[e.slice(0,t)],r=/\[([^\]]*)\]/g,o;for(;(o=r.exec(e))!==null;)n.push(o[1]);return n}function Og(e,t,n){let r=e;for(let o=0;o<t.length;o++){let i=t[o],s=o===t.length-1,a=t[o+1];if(i===""){if(!Array.isArray(r))return;if(s){r.push(n);return}let c=a===""?[]:{};r.push(c),r=c;continue}if(Array.isArray(r)){let c=Number(i);if(!Number.isInteger(c))return;if(s){r[c]=n;return}let d=r[c];(d==null||typeof d!="object")&&(d=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[c]=d),r=d;continue}if(s){r[i]=n;return}let l=r[i];(l==null||typeof l!="object")&&(l=a===""||/^\d+$/.test(a!=null?a:"")?[]:{},r[i]=l),r=l}}function Fg(e,t){var a,l,c,d;let n=zi(e,!1),r=[],o=new Map;for(let u of n)gt(u)==="checkbox"&&u.name&&o.set(u.name,((a=o.get(u.name))!=null?a:0)+1);let i=t.trim!==!1,s=t.numbers!==!1;for(let u of n){if(!u.name||u.disabled&&!t.includeDisabled)continue;let p=gt(u);if(p==="file"){let m=Array.from((l=u.files)!=null?l:[]);if(!m.length)continue;let h=u.multiple||u.name.endsWith("[]");r.push({name:u.name,value:h?m:m[0]});continue}if(p==="checkbox"){if(((c=o.get(u.name))!=null?c:1)>1||u.name.endsWith("[]")){if(!u.checked)continue;let h=u.name.endsWith("[]")?u.name:`${u.name}[]`;r.push({name:h,value:u.value||"on"})}else r.push({name:u.name,value:u.checked});continue}if(p==="radio"){if(!u.checked)continue;r.push({name:u.name,value:u.value});continue}if(u.tagName==="SELECT"&&u.multiple){let m=Array.from(u.selectedOptions).map(v=>v.value),h=u.name.endsWith("[]")?u.name:`${u.name}[]`;for(let v of m)r.push({name:h,value:v});continue}let f=(d=u.value)!=null?d:"";if(i&&typeof f=="string"&&(f=f.trim()),s&&(p==="number"||p==="range")&&f!==""){let m=Number(f);Number.isFinite(m)&&(f=m)}r.push({name:u.name,value:f})}return r}function Ig(e){for(let t of zi(e,!1)){if(gt(t)!=="file")continue;let n=t.files;if(n&&n.length)return!0}return!1}function xf(e,t,n){if(n instanceof File||typeof Blob!="undefined"&&n instanceof Blob){e.append(t,n);return}if(Array.isArray(n)){let r=t.endsWith("[]")?t:`${t}[]`;for(let o of n)xf(e,r,o);return}if(typeof n=="boolean"){e.append(t,n?"1":"0");return}e.append(t,n==null?"":String(n))}function or(e,t={}){let n=Fg(e,t);if(t.formData||Ig(e)){let o=new FormData;for(let i of n)xf(o,i.name,i.value);return o}let r={};for(let o of n)Og(r,Ng(o.name),o.value);return r}var Zr=new WeakSet,eo=new WeakSet;async function $i(e){(await ll(e)).valid?eo.delete(e):eo.add(e)}function Bi(e,t){if(!Je(e)){X(`${x.prefix}validate only works on input, select, or textarea.`);return}if(Zr.has(e))return;Zr.add(e),Oi();let n=()=>{$i(e)},r=()=>{eo.has(e)&&$i(e)};e.addEventListener("blur",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{Zr.delete(e),eo.delete(e),e.removeEventListener("blur",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}var rl=new WeakSet;function wf(e){return rl.has(e)||hg(e,"validate")}function zg(e,t){rl.add(e),Oi(),e.tagName==="FORM"&&(e.noValidate=!0);let n=o=>{let i=o.target;!Je(i)||Zr.has(i)||il(i).length!==0&&$i(i)},r=o=>{let i=o.target;!Je(i)||Zr.has(i)||eo.has(i)&&$i(i)};e.addEventListener("focusout",n),e.addEventListener("input",r),e.addEventListener("change",n),t(()=>{rl.delete(e),e.removeEventListener("focusout",n),e.removeEventListener("input",r),e.removeEventListener("change",n)})}y("validate",({el:e,cleanup:t})=>{if(e.tagName==="FORM"||e.hasAttribute(`${x.prefix}submit`)){zg(e,t);return}Bi(e,t)});var Bg=["required","email","url","number","integer","minlength","maxlength","min","max","match","regex","cpf","cnpj","cep","phone","date","accepted","strong-password"];for(let e of Bg)y(e,({el:t,cleanup:n})=>{Bi(t,n)});for(let e of["error-message","error-target","regex-flags","unique-url"])y(e,({el:t,cleanup:n})=>{Je(t)&&Bi(t,n)});function kf(){return Y({loading:!1,saving:!1,success:!1,errors:{},message:"",data:null,status:0,dirty:!1,progress:0})}var ir=new WeakMap,pl=new WeakMap,jg=kf();function oo(e){let t=ir.get(e);return t||(t=kf(),ir.set(e,t)),t}function qg(e){let t=e;for(;t;){let n=pl.get(t);if(n)return n;let r=t.el;if(r){let o=r.closest("form"),i=o?ir.get(o):void 0;if(i)return i;let s=r.querySelector("form"),a=s?ir.get(s):void 0;if(a)return a}t=t.parent}if(typeof document!="undefined")for(let n of Array.from(document.forms)){let r=ir.get(n);if(r)return r}return jg}N("$form",e=>qg(e));var sr=new WeakMap,Vg=["submit","upload","dropzone","autosave","get","post","put","patch","delete","load","load-visible","search","resource"];function Ef(e){return Vg.some(t=>Ft(e,`${x.prefix}${t}`)||Ft(e,`data-v-${t}`))}function Ce(e,t){var i,s,a;let n=$t(e,t);if(n!==null)return n;let r=e.closest("form");if(r&&r!==e){let l=$t(r,t);if(l!==null)return l}let o=(a=(i=sr.get(e))==null?void 0:i[t])!=null?a:r?(s=sr.get(r))==null?void 0:s[t]:void 0;return o!=null?o:null}function Vi(e,t){return Ce(e,t)!==null}function Ze(e,t){y(e,({el:n,expression:r})=>{var a,l;let o=(a=n.closest("form"))!=null?a:n,i=(l=sr.get(o))!=null?l:{};if(i[e]=r,sr.set(o,i),!Ef(o)&&!Ef(n)){X(`${x.prefix}${e} needs an element with ${x.prefix}submit, ${x.prefix}upload, ${x.prefix}dropzone, or ${x.prefix}autosave.`);return}let s=t==null?void 0:t(r);s&&X(s)})}var Ug=["GET","POST","PUT","PATCH","DELETE","HEAD","OPTIONS"];Ze("method",e=>e&&!Ug.includes(e.trim().toUpperCase())?`${x.prefix}method received an unknown verb: ${e}`:null);Ze("redirect");Ze("reset-success");Ze("disable-loading");Ze("loading-class");Ze("on-success");Ze("on-error");Ze("on-complete");Ze("toast-success");Ze("toast-error");Ze("confirm");Ze("form-data");y("loading",({el:e,expression:t})=>{var i,s;let n=(i=e.closest("form"))!=null?i:e,r=(s=sr.get(n))!=null?s:{};r.loading=t,sr.set(n,r);let o=Tf(t);if(!o){X(`${x.prefix}loading element not found: ${t}`);return}Lf(o,!1)});var Wg=`
...
`;function io(){ge(),oe("forms-ajax",Wg)}function Yt(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0}))}function Ui(e,t){let n=e.trim();n.includes("{")&&(n=n.replace(/\{([^{}]+)\}/g,(o,i)=>{let s=q(i.trim(),t,`${x.prefix}submit`);return s==null?o:String(s)}));let r=x.baseURL;return r&&!/^[a-z][a-z0-9+.-]*:\/\//i.test(n)&&!n.startsWith("//")&&(n=`${r.replace(/\/$/,"")}/${n.replace(/^\//,"")}`),n}function ml(e){var r;if(!e||typeof e!="object")return"";let t=e,n=(r=t.message)!=null?r:t.mensagem;return typeof n=="string"?n:""}function vl(e,t="",n={}){if(e==null)return n;if(Array.isArray(e))return e.forEach((r,o)=>vl(r,`${t}[${o}]`,n)),n;if(typeof e=="object"&&!(e instanceof File)){for(let[r,o]of Object.entries(e))vl(o,t?`${t}[${r}]`:r,n);return n}return t&&(n[t]=String(e)),n}function _g(e){return Array.from(e.querySelectorAll('button[type="submit"], button:not([type]), input[type="submit"], input[type="image"]'))}function Tf(e){return!e||typeof document=="undefined"?null:document.querySelector(e)}var ul=new WeakMap;function Lf(e,t){var n;if(t){e.hidden=!1,e.style.display=(n=ul.get(e))!=null?n:"",e.removeAttribute("aria-hidden");return}ul.has(e)||ul.set(e,e.style.display==="none"?"":e.style.display),e.style.display="none",e.setAttribute("aria-hidden","true")}function qi(e,t){let{host:n,form:r,state:o}=e;o.loading=t,r.classList.toggle("v-loading",t),r.setAttribute("aria-busy",t?"true":"false");let i=Ce(n,"loading-class");if(i)for(let a of i.split(/\s+/).filter(Boolean))r.classList.toggle(a,t);if(Vi(n,"disable-loading"))for(let a of _g(r))a.disabled=t;let s=Ce(n,"loading");if(s){let a=Tf(s);a&&Lf(a,t)}}function Wi(e,t,n,r){let o=Ce(e.host,t);if(!o)return;let i=e.scope.child({$data:n,$response:r,$form:e.state,$el:e.host}),s=q(o,i,`${x.prefix}${t}`);typeof s=="function"&&s.call(e.scope.data,n,r)}function Kg(e,t){let n=Ce(e.host,"target");if(!n||typeof t!="string")return;let r=document.querySelector(n);if(!r){X(`${x.prefix}target destination not found: ${n}`);return}let o=(Ce(e.host,"swap")||"innerHTML").trim().toLowerCase();if(o==="none")return;if(o==="text"){r.textContent=t;return}let i=document.createElement("template");i.innerHTML=t;let s=Array.from(i.content.childNodes),a=Ae(r);switch(o){case"inner":case"innerhtml":for(let l of Array.from(r.children))G(l);r.textContent="",r.append(...s);break;case"afterbegin":case"prepend":r.prepend(...s);break;case"beforeend":case"append":r.append(...s);break;case"beforebegin":r.before(...s);break;case"afterend":r.after(...s);break;case"outer":case"outerhtml":case"replace":G(r),r.replaceWith(...s);break;default:X(`Unknown mode in ${x.prefix}swap: ${o}`);return}for(let l of s)l.nodeType===1&&ee(l,a)}function Mf(e,t,n){var l;let{state:r,form:o,host:i}=e;r.success=!0,r.errors={},r.data=t,r.status=n,r.dirty=!1,r.message=ml(t),Kg(e,t),Vi(i,"reset-success")&&o.tagName==="FORM"&&(o.reset(),ro(o));let s=Ce(i,"toast-success");s!==null&&it.success(s||r.message||"All set!"),Wi(e,"on-success",t,{status:n}),Yt(o,"voodoo:success",{data:t,status:n,form:o,state:r});let a=Ce(i,"redirect");if(a!==null&&typeof window!="undefined"){let c=t&&typeof t=="object"?(l=t.redirect)!=null?l:t.url:null,d=e.scope.child({$data:t,$form:r}),u=a?Ui(a,d):String(c!=null?c:"");u&&window.location.assign(u)}}function hl(e,t){var c,d;let{state:n,form:r,host:o}=e,i=t instanceof ke?t:new ke(t instanceof Error?t.message:String(t)),s=(d=(c=i.response)==null?void 0:c.data)!=null?d:null;n.success=!1,n.data=s,n.status=i.status,n.message=ml(s)||i.message;let a=sl(s);(i.status===422||Object.keys(a).length>0)&&(n.errors=Ii(r,s),al(r));let l=Ce(o,"toast-error");l!==null&&it.error(l||ml(s)||"Could not submit the form."),Wi(e,"on-error",s,i),Yt(r,"voodoo:error",{error:i,data:s,status:i.status,form:r,state:n})}function Sf(e,t){Wi(e,"on-complete",e.state.data,{ok:t,status:e.state.status}),Yt(e.form,"voodoo:complete",{ok:t,status:e.state.status,data:e.state.data,form:e.form,state:e.state})}async function Yg(e,t){let{host:n,form:r,state:o,scope:i}=e;if(o.loading)return;let s=Ce(n,"confirm");if(s!==null&&typeof window!="undefined"&&!window.confirm(s||"Confirm this action?"))return;if(wf(r)){ro(r);let p=await dl(r);if(o.errors=p.errors,!p.valid){al(r),Yt(r,"voodoo:invalid",{errors:p.errors,form:r,state:o});return}}let a=(Ce(n,"method")||r.getAttribute("method")||"POST").trim().toUpperCase(),l=Ui(t,i)||(r.tagName==="FORM"?r.action:"")||(typeof location!="undefined"?location.href:""),c=or(r,{formData:Vi(n,"form-data")}),d=a==="GET"||a==="HEAD";qi(e,!0),o.success=!1,o.progress=0,Yt(r,"voodoo:submit",{url:l,method:a,form:r,state:o});let u=!1;try{let p=await jt({url:l,method:a,body:d?void 0:c,params:d&&!(c instanceof FormData)?vl(c):void 0});u=!0,Mf(e,p.data,p.status)}catch(p){hl(e,p)}finally{qi(e,!1),Sf(e,u)}}y("submit",({el:e,scope:t,expression:n,cleanup:r})=>{io();let o=e,i=oo(o),s=t.child({$form:i},o);pl.set(s,i),pl.set(t,i),It(o,s);for(let d of Array.from(o.childNodes))d.nodeType===1&&It(d,s);let a={host:o,form:o,scope:s,state:i},l=d=>{d.preventDefault(),Yg(a,n)},c=d=>{var f;let u=d.detail;if(!u||!u.field)return;let p={...i.errors};u.valid?delete p[u.field]:p[u.field]=(f=u.message)!=null?f:"",i.errors=p};o.addEventListener("submit",l),o.addEventListener("voodoo:field-validated",c),r(()=>{ir.delete(o),o.removeEventListener("submit",l),o.removeEventListener("voodoo:field-validated",c)})},{priority:j.DATA-1});function Xg(e){let t=Ce(e,"progress");if(t){let o=document.querySelector(t);return o||(X(`${x.prefix}progress bar not found: ${t}`),null)}let n=e.nextElementSibling;if(n&&n.classList.contains("v-progress"))return n;io();let r=document.createElement("div");return r.className="v-progress",r.setAttribute("role","progressbar"),r.setAttribute("aria-valuemin","0"),r.setAttribute("aria-valuemax","100"),r.innerHTML='<span class="v-progress-bar"></span>',e.insertAdjacentElement("afterend",r),r}function ji(e,t,n){if(!e)return;let r=Math.max(0,Math.min(100,Math.round(t)));if(e.tagName==="PROGRESS")e.value=r,e.max=100;else{let o=e.classList.contains("v-progress-bar")?e:e.querySelector(".v-progress-bar, [data-progress-bar]");o?o.style.width=`${r}%`:e.style.width=`${r}%`}e.setAttribute("aria-valuenow",String(r)),n?e.setAttribute("data-state",n):e.removeAttribute("data-state")}function Gg(e,t,n){let r=new FormData,i=t.length>1||n.endsWith("[]")?n.endsWith("[]")?n:`${n}[]`:n;for(let a of t)r.append(i,a);let s=e.closest("form");if(s){let a=or(s,{formData:!0});if(a instanceof FormData)for(let[l,c]of a.entries())c instanceof File||r.append(l,c)}return r}async function Af(e,t,n,r){if(!n.length||e.state.loading)return;let{state:o,form:i,host:s}=e,a=Ui(t,e.scope);if(!a){X(`${x.prefix}upload needs a destination URL.`);return}let l=Xg(s),c=Gg(s,n,r);qi(e,!0),o.success=!1,o.progress=0,ji(l,0,"loading"),Yt(i,"voodoo:upload",{url:a,files:n,form:i,state:o});let d=!1;try{let u=(Ce(s,"method")||"POST").trim().toUpperCase(),p=await he.upload(a,c,{method:u==="PUT"||u==="PATCH"?u:"POST",onProgress:f=>{o.progress=f,ji(l,f,"loading"),Yt(i,"voodoo:progress",{percent:f,form:i,state:o})}});d=!0,o.progress=100,ji(l,100,"done"),Mf(e,p,200)}catch(u){ji(l,o.progress,"error"),hl(e,u)}finally{qi(e,!1),Sf(e,d)}}y("upload",({el:e,scope:t,expression:n,cleanup:r})=>{var c;let o=e;if(o.tagName!=="INPUT"||(o.getAttribute("type")||"").toLowerCase()!=="file"){X(`${x.prefix}upload needs an <input type="file">.`);return}io();let i=(c=o.closest("form"))!=null?c:o,s=oo(i),a={host:o,form:i,scope:t,state:s},l=()=>{var u;let d=Array.from((u=o.files)!=null?u:[]);d.length&&Af(a,n,d,o.name||"file")};o.addEventListener("change",l),r(()=>o.removeEventListener("change",l))});y("dropzone",({el:e,scope:t,expression:n,cleanup:r})=>{var b,w,T;io(),e.classList.add("v-dropzone"),e.hasAttribute("tabindex")||(e.tabIndex=0),e.hasAttribute("role")||e.setAttribute("role","button"),(b=e.textContent)!=null&&b.trim()||(e.textContent="Drag files here or click to choose");let o=(w=e.closest("form"))!=null?w:e,i=oo(o),s={host:e,form:o,scope:t,state:i},a=Ce(e,"field")||"file",l=document.createElement("input");l.type="file",l.hidden=!0,l.tabIndex=-1,e.hasAttribute("accept")&&(l.accept=(T=e.getAttribute("accept"))!=null?T:""),e.hasAttribute("multiple")&&(l.multiple=!0),e.appendChild(l);let c=k=>{k.length&&(e.classList.add("v-dropzone-busy"),e.classList.remove("v-dropzone-error"),Af(s,n,k,a).finally(()=>{e.classList.remove("v-dropzone-busy"),i.success||e.classList.add("v-dropzone-error")}))},d=0,u=k=>{k.preventDefault(),d++,e.classList.add("v-dropzone-over")},p=k=>{k.preventDefault(),k.dataTransfer&&(k.dataTransfer.dropEffect="copy")},f=()=>{d=Math.max(0,d-1),d===0&&e.classList.remove("v-dropzone-over")},m=k=>{var D,C;k.preventDefault(),d=0,e.classList.remove("v-dropzone-over");let A=Array.from((C=(D=k.dataTransfer)==null?void 0:D.files)!=null?C:[]);c(l.multiple?A:A.slice(0,1))},h=k=>{k.target!==l&&l.click()},v=k=>{k.key!=="Enter"&&k.key!==" "||(k.preventDefault(),l.click())},g=()=>{var A;let k=Array.from((A=l.files)!=null?A:[]);c(k),l.value=""};e.addEventListener("dragenter",u),e.addEventListener("dragover",p),e.addEventListener("dragleave",f),e.addEventListener("drop",m),e.addEventListener("click",h),e.addEventListener("keydown",v),l.addEventListener("change",g),r(()=>{e.removeEventListener("dragenter",u),e.removeEventListener("dragover",p),e.removeEventListener("dragleave",f),e.removeEventListener("drop",m),e.removeEventListener("click",h),e.removeEventListener("keydown",v),l.removeEventListener("change",g),l.remove()})});var Qg={idle:"",saving:"Saving...",saved:"Changes saved",error:"Could not save"};function Jg(e){let t=Ce(e,"autosave-status");if(t){let o=document.querySelector(t);if(o)return o;X(`${x.prefix}autosave-status element not found: ${t}`)}let n=e.querySelector(".v-autosave-status");if(n)return n;let r=document.createElement("span");return r.className="v-autosave-status",r.setAttribute("aria-live","polite"),e.appendChild(r),r}function fl(e,t){e.setAttribute("data-state",t),e.textContent=Qg[t]}y("autosave",({el:e,scope:t,expression:n,modifiers:r,cleanup:o})=>{var m,h,v;io();let i=e,s=oo(i),a={host:i,form:i,scope:t,state:s},l=Jg(i),c=(v=(h=(m=typeof r.delay=="string"?r.delay:null)!=null?m:Object.keys(r).find(g=>/^[\d.]+(ms|s|m)?$/.test(g)))!=null?h:Ce(i,"autosave-delay"))!=null?v:1e3,d=Q(c,1e3),u=async()=>{let g=Ui(n,t);if(!g){X(`${x.prefix}autosave needs a destination URL.`);return}if(s.loading)return;s.saving=!0,fl(l,"saving");let b=(Ce(i,"method")||"POST").trim().toUpperCase();try{let w=await jt({url:g,method:b,body:or(i,{formData:Vi(i,"form-data")})});s.data=w.data,s.status=w.status,s.dirty=!1,s.success=!0,fl(l,"saved"),Wi(a,"on-success",w.data,{status:w.status}),Yt(i,"voodoo:autosave",{data:w.data,status:w.status,form:i,state:s})}catch(w){fl(l,"error"),hl(a,w)}finally{s.saving=!1}},p=Ke(()=>{u()},d),f=()=>{s.dirty=!0,p()};i.addEventListener("input",f),i.addEventListener("change",f),o(()=>{p.cancel(),i.removeEventListener("input",f),i.removeEventListener("change",f)})});y("guard",({el:e,expression:t,cleanup:n})=>{var c;let r=(c=e.tagName==="FORM"?e:e.closest("form"))!=null?c:e,o=oo(r),i=t.trim()||"There are unsaved changes.",s=()=>{o.dirty=!0},a=()=>{o.dirty=!1},l=d=>{!o.dirty||o.loading||(d.preventDefault(),d.returnValue=i)};r.addEventListener("input",s),r.addEventListener("change",s),r.addEventListener("reset",a),r.addEventListener("voodoo:success",a),window.addEventListener("beforeunload",l),n(()=>{r.removeEventListener("input",s),r.removeEventListener("change",s),r.removeEventListener("reset",a),r.removeEventListener("voodoo:success",a),window.removeEventListener("beforeunload",l)})});me();ce();function so(e){let t={};for(let[n,r]of Object.entries(e))if(typeof r!="function"&&!n.startsWith("$"))try{JSON.stringify(r),t[n]=Me(r)}catch(o){}return t}function Cf(e,t){if(e.id)return`${t}:${location.pathname}:#${e.id}`;let n=[],r=e;for(;r&&r!==document.body;){let o=r.parentElement,i=o?Array.from(o.children).indexOf(r):0;n.unshift(`${r.tagName.toLowerCase()}${i}`),r=o}return`${t}:${location.pathname}:${n.join(">")}`}y("persist",({el:e,scope:t,expression:n,cleanup:r})=>{let o=n.trim()?`voodoo:persist:${n.trim()}`:Cf(e,"voodoo:persist"),i=ue.get(o);if(i&&typeof i=="object")for(let[l,c]of Object.entries(i))l in t.data&&(t.data[l]=c);let s=Ke(()=>{ue.set(o,so(t.data))},120),a=Ie(t.data,()=>s(),{deep:!0});s(),r(()=>{s.flush(),a()})},{priority:j.DATA-1});y("sync",({el:e,scope:t,expression:n,cleanup:r})=>{if(typeof BroadcastChannel=="undefined")return;let o=n.trim()||Cf(e,"voodoo:sync"),i=new BroadcastChannel(o),s=Math.random().toString(36).slice(2),a=!1,l=Ke(()=>{if(!a)try{i.postMessage({from:s,state:so(t.data)})}catch(d){K(d,"v-sync")}},60);i.addEventListener("message",d=>{let u=d.data;if(!(!u||u.from===s)){a=!0;for(let[p,f]of Object.entries(u.state))p in t.data&&t.data[p]!==f&&(t.data[p]=f);queueMicrotask(()=>{a=!1})}});let c=Ie(t.data,()=>l(),{deep:!0});r(()=>{c(),i.close()})},{priority:j.DATA-1});var gl=new WeakMap;function bl(e){let t=e;for(;t;){let n=gl.get(t);if(n)return n;t=t.parentElement}return null}y("history",({el:e,scope:t,expression:n,cleanup:r})=>{var f;let o=Number(n)||50,i=[JSON.parse(JSON.stringify(so(t.data)))],s=0,a=!1,l=Y({canUndo:!1,canRedo:!1,size:1,undo(){s<=0||(s--,d())},redo(){s>=i.length-1||(s++,d())},clear(){i.length=0,i.push(JSON.parse(JSON.stringify(so(t.data)))),s=0,c()}});function c(){l.canUndo=s>0,l.canRedo=s<i.length-1,l.size=i.length}function d(){a=!0;let m=i[s];for(let[h,v]of Object.entries(m))t.data[h]=JSON.parse(JSON.stringify(v));c(),queueMicrotask(()=>{a=!1})}let u=Ke(()=>{if(a)return;let m=JSON.stringify(so(t.data));m!==JSON.stringify(i[s])&&(i.splice(s+1),i.push(JSON.parse(m)),i.length>o&&i.shift(),s=i.length-1,c())},Q((f=e.getAttribute("v-history-debounce"))!=null?f:void 0,300)),p=Ie(t.data,()=>u(),{deep:!0});gl.set(e,l),t.set("$history",l),r(()=>{p(),u.cancel(),gl.delete(e)})},{priority:j.DATA-1});y("undo",({el:e,cleanup:t})=>{let n=()=>{var r;return(r=bl(e))==null?void 0:r.undo()};e.addEventListener("click",n),t(()=>e.removeEventListener("click",n))});y("redo",({el:e,cleanup:t})=>{let n=()=>{var r;return(r=bl(e))==null?void 0:r.redo()};e.addEventListener("click",n),t(()=>e.removeEventListener("click",n))});y("storage",({el:e,expression:t,cleanup:n,scope:r})=>{let o=t.trim();if(!o)return;let i=e,s=ue.get(`voodoo:field:${o}`);s!=null&&"value"in i&&(i.value=String(s));let a=()=>{ue.set(`voodoo:field:${o}`,i.value)};i.addEventListener("input",a),n(()=>i.removeEventListener("input",a))});N("$history",e=>e.el?bl(e.el):null);ce();var ar=null,Xt=.35,Dt=!1,Rf=!1,yl="voodoo:sound:volume",Pf="voodoo:sound:muted";function vn(){if(Rf)return;Rf=!0;let e=ue.get(yl);typeof e=="number"&&e>=0&&e<=1&&(Xt=e);let t=ue.get(Pf);typeof t=="boolean"&&(Dt=t),typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches&&ue.get(yl)===void 0&&(Xt=.18)}function $f(){var t;if(typeof window=="undefined")return null;if(ar)return ar.state==="suspended"&&ar.resume(),ar;let e=(t=window.AudioContext)!=null?t:window.webkitAudioContext;if(!e)return null;try{return ar=new e,ar}catch(n){return null}}function Df(e,t,n){var c,d,u,p;let r=e.currentTime+((c=t.atraso)!=null?c:0),o=r+t.duracao,i=e.createOscillator();i.type=(d=t.forma)!=null?d:"sine",i.frequency.setValueAtTime(t.frequencia,r),t.ate!==void 0&&t.ate!==t.frequencia&&i.frequency.exponentialRampToValueAtTime(Math.max(1,t.ate),o);let s=e.createGain(),a=Xt*n*((u=t.volume)!=null?u:1),l=(p=t.ataque)!=null?p:.008;s.gain.setValueAtTime(1e-4,r),s.gain.exponentialRampToValueAtTime(Math.max(1e-4,a),r+l),s.gain.exponentialRampToValueAtTime(1e-4,o),i.connect(s),s.connect(e.destination),i.start(r),i.stop(o+.02)}var _i={click:{volume:.5,camadas:[{frequencia:660,ate:440,duracao:.06,forma:"triangle"}]},pop:{volume:.5,camadas:[{frequencia:880,ate:1320,duracao:.07,forma:"sine"}]},hover:{volume:.22,camadas:[{frequencia:1200,duracao:.035,forma:"sine"}]},success:{volume:.6,camadas:[{frequencia:523.25,duracao:.1,forma:"sine"},{frequencia:783.99,duracao:.18,forma:"sine",atraso:.09}]},complete:{volume:.6,camadas:[{frequencia:523.25,duracao:.1,forma:"sine"},{frequencia:659.25,duracao:.1,forma:"sine",atraso:.09},{frequencia:1046.5,duracao:.22,forma:"sine",atraso:.18}]},error:{volume:.6,camadas:[{frequencia:392,duracao:.12,forma:"square",volume:.5},{frequencia:261.63,duracao:.24,forma:"square",volume:.5,atraso:.1}]},warning:{volume:.55,camadas:[{frequencia:587.33,duracao:.1,forma:"triangle"},{frequencia:587.33,duracao:.14,forma:"triangle",atraso:.14}]},notify:{volume:.5,camadas:[{frequencia:987.77,duracao:.14,forma:"sine"},{frequencia:1318.51,duracao:.3,forma:"sine",atraso:.08,volume:.6}]},type:{volume:.18,camadas:[{frequencia:2200,duracao:.018,forma:"square"}]},open:{volume:.4,camadas:[{frequencia:330,ate:660,duracao:.14,forma:"sine"}]},close:{volume:.4,camadas:[{frequencia:660,ate:330,duracao:.14,forma:"sine"}]},deny:{volume:.5,camadas:[{frequencia:220,duracao:.08,forma:"square",volume:.5},{frequencia:180,duracao:.12,forma:"square",volume:.5,atraso:.07}]},coin:{volume:.45,camadas:[{frequencia:987.77,duracao:.06,forma:"square"},{frequencia:1318.51,duracao:.16,forma:"square",atraso:.05}]},levelup:{volume:.55,camadas:[{frequencia:523.25,duracao:.08,forma:"square"},{frequencia:659.25,duracao:.08,forma:"square",atraso:.07},{frequencia:783.99,duracao:.08,forma:"square",atraso:.14},{frequencia:1046.5,duracao:.26,forma:"square",atraso:.21}]},drop:{volume:.5,camadas:[{frequencia:180,ate:90,duracao:.12,forma:"triangle"}]}},Zg={do:261.63,"do#":277.18,re:293.66,"re#":311.13,mi:329.63,fa:349.23,"fa#":369.99,sol:392,"sol#":415.3,la:440,"la#":466.16,si:493.88,c:261.63,d:293.66,e:329.63,f:349.23,g:392,a:440,b:493.88};function Ki(e){let t=String(e).trim().toLowerCase(),n=/^([a-z]+#?)(\d)?$/.exec(t);if(!n)return null;let r=Zg[n[1]];if(r===void 0)return null;let o=n[2]?Number(n[2]):4;return r*2**(o-4)}var Yi=new Map;function eb(e,t){let n=Yi.get(e);n||(n=new Audio(e),n.preload="auto",Yi.set(e,n)),n.volume=Math.max(0,Math.min(1,Xt*t)),n.currentTime=0,n.play().catch(()=>{})}function Hf(e){return/^(https?:)?\/\//.test(e)||/^[./]/.test(e)||/\.(mp3|wav|ogg|m4a|aac)$/i.test(e)}var Gt={play(e,t={}){var l,c,d;if(vn(),Dt||!e)return;let n=String(e).trim(),r=(l=t.volume)!=null?l:1;if(Hf(n)){eb(n,r);return}let o=_i[n];if(!o){let u=Ki(n);u!==null&&this.tone(u,200,{volume:r});return}let i=$f();if(!i)return;let s=(c=t.tom)!=null?c:1,a=((d=o.volume)!=null?d:1)*r;for(let u of o.camadas)Df(i,s===1?u:{...u,frequencia:u.frequencia*s,ate:u.ate===void 0?void 0:u.ate*s},a)},tone(e,t=200,n={}){var o,i;if(vn(),Dt)return;let r=$f();r&&Df(r,{frequencia:e,duracao:t/1e3,forma:(o=n.forma)!=null?o:"sine"},(i=n.volume)!=null?i:.5)},note(e,t=250,n={}){let r=Ki(e);r!==null&&this.tone(r,t,n)},melody(e,t=150,n={}){vn(),!Dt&&e.forEach((r,o)=>{let i=typeof r=="number"?r:Ki(r);i!==null&&setTimeout(()=>this.tone(i,t*1.6,n),o*t)})},volume(e){return vn(),e===void 0||(Xt=Math.max(0,Math.min(1,e)),ue.set(yl,Xt)),Xt},mute(e=!0){vn(),Dt=e,ue.set(Pf,Dt)},unmute(){this.mute(!1)},toggle(){return vn(),this.mute(!Dt),Dt},get muted(){return vn(),Dt},get names(){return Object.keys(_i)},define(e,t){_i[e]=t},preload(...e){for(let t of e){if(Yi.has(t))continue;let n=new Audio(t);n.preload="auto",Yi.set(t,n)}}};y("sound",({el:e,arg:t,expression:n,modifiers:r,scope:o,cleanup:i,evaluate:s})=>{let a=t||"click",l=()=>{let u=n.trim();if(!u)return"click";if(_i[u]||Hf(u)||Ki(u)!==null)return u;let p=s();return typeof p=="string"?p:u},c=r.volume!==void 0?Number(r.volume):void 0,d=()=>{Gt.play(l(),c===void 0?{}:{volume:c})};e.addEventListener(a,d),i(()=>e.removeEventListener(a,d))});y("mute",({el:e,cleanup:t})=>{let n=()=>{let o=Gt.muted;e.setAttribute("aria-pressed",String(o)),e.classList.toggle("v-muted",o)},r=()=>{Gt.toggle(),n(),Gt.muted||Gt.play("pop")};e.addEventListener("click",r),n(),t(()=>e.removeEventListener("click",r))});N("$sound",()=>Gt);me();ce();function ao(){return typeof window=="undefined"||typeof window.matchMedia!="function"?!1:ve.reducedMotion}var cr=new Set,gn=0;function Bf(e){gn=0;let t=Array.from(cr);for(let n of t)cr.has(n)&&n(e);cr.size>0&&(gn=requestAnimationFrame(Bf))}function jf(e){typeof requestAnimationFrame=="function"&&(cr.add(e),gn||(gn=requestAnimationFrame(Bf)))}function Qi(e){cr.delete(e),cr.size===0&&gn&&(cancelAnimationFrame(gn),gn=0)}var qf=12e3;function tb(e){return e*e*(2.70158*e-1.70158)}var lo={linear(e){return e},easeIn(e){return e*e*e},easeOut(e){return 1-Math.pow(1-e,3)},easeInOut(e){return e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2},easeOutBack(e){return 1+2.70158*Math.pow(e-1,3)+1.70158*Math.pow(e-1,2)},easeOutExpo(e){return e>=1?1:1-Math.pow(2,-10*e)},anticipate(e){let t=e*2;return t<1?.5*tb(t):.5*(2-Math.pow(2,-10*(t-1)))},bounce(e){let r=e;return r<1/2.75?7.5625*r*r:r<2/2.75?(r-=1.5/2.75,7.5625*r*r+.75):r<2.5/2.75?(r-=2.25/2.75,7.5625*r*r+.9375):(r-=2.625/2.75,7.5625*r*r+.984375)}};function nb(e){if(typeof e=="function")return e;if(typeof e=="string"){let t=lo[e];if(t)return t}return lo.easeOut}var Sl={x:0,y:0,z:0,parallax:0,rotate:0,rotateX:0,rotateY:0,skewX:0,skewY:0,scale:1,scaleX:1,scaleY:1},rb={x:"px",y:"px",z:"px",parallax:"px",rotate:"deg",rotateX:"deg",rotateY:"deg",skewX:"deg",skewY:"deg",scale:"",scaleX:"",scaleY:""},Vf={translateX:"x",translateY:"y",translateZ:"z",rotateZ:"rotate"},Al={blur:0,brightness:1,saturate:1,grayscale:0,contrast:1},ob={blur:"px",brightness:"",saturate:"",grayscale:"",contrast:""},ib=new Set(["opacity","z-index","font-weight","line-height","flex-grow","flex-shrink","order","zoom","fill-opacity","stroke-opacity","stroke-width","stroke-dashoffset","stroke-dasharray"]),El=new WeakMap,kl=new WeakMap;function Ji(e){let t=El.get(e);return t||(t={...Sl},El.set(e,t)),t}function Uf(e){let t=kl.get(e);return t||(t={...Al},kl.set(e,t)),t}function Re(e){return Math.round(e*1e3)/1e3}function Tl(e){let t=El.get(e);if(!t)return;let n=[],r=t.y+t.parallax;(t.x||r||t.z)&&n.push(`translate3d(${Re(t.x)}px, ${Re(r)}px, ${Re(t.z)}px)`),t.rotateX&&n.push(`rotateX(${Re(t.rotateX)}deg)`),t.rotateY&&n.push(`rotateY(${Re(t.rotateY)}deg)`),t.rotate&&n.push(`rotate(${Re(t.rotate)}deg)`),(t.skewX||t.skewY)&&n.push(`skew(${Re(t.skewX)}deg, ${Re(t.skewY)}deg)`);let o=t.scale*t.scaleX,i=t.scale*t.scaleY;(o!==1||i!==1)&&n.push(`scale(${Re(o)}, ${Re(i)})`),n.length>0?e.style.transform=n.join(" "):e.style.removeProperty("transform")}function sb(e){let t=kl.get(e);if(!t)return;let n=[];t.blur&&n.push(`blur(${Re(t.blur)}px)`),t.brightness!==1&&n.push(`brightness(${Re(t.brightness)})`),t.saturate!==1&&n.push(`saturate(${Re(t.saturate)})`),t.grayscale&&n.push(`grayscale(${Re(t.grayscale)})`),t.contrast!==1&&n.push(`contrast(${Re(t.contrast)})`),n.length>0?e.style.filter=n.join(" "):e.style.removeProperty("filter")}var ab=/^([+-]?(?:\d+\.?\d*|\.\d+))([a-z%]*)$/i,Wf=/^#([0-9a-f]{3,8})$/i;function Xi(e){if(typeof e!="string")return!1;let t=e.trim().toLowerCase();return t==="transparent"||Wf.test(t)||t.startsWith("rgb")||t.startsWith("hsl")}function lb(e,t,n){let r=(e%360+360)%360,o=(1-Math.abs(2*n-1))*t,i=o*(1-Math.abs(r/60%2-1)),s=n-o/2,a;return r<60?a=[o,i,0]:r<120?a=[i,o,0]:r<180?a=[0,o,i]:r<240?a=[0,i,o]:r<300?a=[i,0,o]:a=[o,0,i],[Math.round((a[0]+s)*255),Math.round((a[1]+s)*255),Math.round((a[2]+s)*255)]}function Nf(e){var i,s;let t=e.trim().toLowerCase();if(t==="transparent")return[0,0,0,0];let n=Wf.exec(t);if(n){let a=n[1];(a.length===3||a.length===4)&&(a=a.split("").map(d=>d+d).join(""));let l=parseInt(a.slice(0,6),16),c=a.length===8?parseInt(a.slice(6,8),16)/255:1;return[l>>16&255,l>>8&255,l&255,c]}let r=(i=t.match(/-?(?:\d+\.?\d*|\.\d+)%?/g))!=null?i:[],o=(a,l)=>{var u;let c=(u=r[a])!=null?u:"0",d=parseFloat(c);return c.endsWith("%")?d/100*l:d};if(t.startsWith("hsl")){let a=c=>{var p;let d=(p=r[c])!=null?p:"0",u=parseFloat(d);return d.endsWith("%")||u>1?u/100:u},l=lb(parseFloat((s=r[0])!=null?s:"0"),a(1),a(2));return[l[0],l[1],l[2],r.length>3?o(3,1):1]}return[o(0,255),o(1,255),o(2,255),r.length>3?o(3,1):1]}function cb(e){let t=Math.max(0,Math.min(1,e[3]));return`rgba(${Math.round(e[0])}, ${Math.round(e[1])}, ${Math.round(e[2])}, ${Re(t)})`}function _f(e){return e.startsWith("--")?e:e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}function Kf(e,t,n,r){if(t==="transform")return Ji(e)[n];if(t==="filter")return Uf(e)[n];if(typeof getComputedStyle!="function")return e.style.getPropertyValue(r).trim();let o=getComputedStyle(e).getPropertyValue(r);return o?o.trim():""}function db(e,t,n){var u;let r=(u=Vf[t])!=null?u:t,o=r in Sl?"transform":r in Al?"filter":"style",i=o==="style"?_f(r):r,s=o==="transform"?rb[r]:o==="filter"?ob[r]:ib.has(i)?"":"px",a=Array.isArray(n)?[n[0],n[1]]:[Kf(e,o,r,i),n],l={kind:o,prop:r,cssName:i,mode:"number",unit:s,from:0,to:0,fromColor:[0,0,0,1],toColor:[0,0,0,1],fromText:String(a[0]),toText:String(a[1])};if(Xi(a[0])||Xi(a[1]))return o!=="style"?null:(l.mode="color",l.fromColor=Xi(a[0])?Nf(String(a[0])):[0,0,0,0],l.toColor=Xi(a[1])?Nf(String(a[1])):[0,0,0,0],l);let c=Of(a[0],s),d=Of(a[1],s);return!c||!d?o!=="style"?null:(l.mode="discrete",l):(l.from=c.value,l.to=d.value,l.unit=d.unit||c.unit||s,l)}function Of(e,t){if(typeof e=="number")return Number.isFinite(e)?{value:e,unit:t}:null;let n=ab.exec(e.trim());return n?{value:parseFloat(n[1]),unit:n[2]||t}:null}function lr(e,t,n){let r=!1,o=!1;for(let i of t){if(i.kind==="transform"){Ji(e)[i.prop]=i.from+(i.to-i.from)*n,r=!0;continue}if(i.kind==="filter"){Uf(e)[i.prop]=i.from+(i.to-i.from)*n,o=!0;continue}if(i.mode==="color"){let a=[i.fromColor[0]+(i.toColor[0]-i.fromColor[0])*n,i.fromColor[1]+(i.toColor[1]-i.fromColor[1])*n,i.fromColor[2]+(i.toColor[2]-i.fromColor[2])*n,i.fromColor[3]+(i.toColor[3]-i.fromColor[3])*n];e.style.setProperty(i.cssName,cb(a));continue}if(i.mode==="discrete"){e.style.setProperty(i.cssName,n>=1?i.toText:i.fromText);continue}let s=i.from+(i.to-i.from)*n;e.style.setProperty(i.cssName,`${Re(s)}${i.unit}`)}r&&Tl(e),o&&sb(e)}function Yf(e,t){let n=[];for(let[r,o]of Object.entries(t)){if(o==null)continue;let i=db(e,r,o);i&&n.push(i)}return n}function Ff(e,t){for(let n of Cl(e))lr(n,Yf(n,t),0)}function ub(e,t){var r;let n={};for(let o of Object.keys(t)){let i=(r=Vf[o])!=null?r:o,s=i in Sl?"transform":i in Al?"filter":"style";n[o]=Kf(e,s,i,s==="style"?_f(i):i)}return n}function xl(e){return typeof HTMLElement!="undefined"&&e instanceof HTMLElement?!0:typeof SVGElement!="undefined"&&e instanceof SVGElement}function Cl(e){if(!e)return[];if(typeof e=="string")return typeof document=="undefined"?[]:Array.from(document.querySelectorAll(e)).filter(xl);if(xl(e))return[e];let t=e;if(typeof t.length!="number")return[];let n=[];for(let r=0;r<t.length;r++){let o=t[r];xl(o)&&n.push(o)}return n}function Zi(e){return{finished:Promise.resolve(),stop(){e==null||e()}}}function Ll(e,t,n){var w,T,k,A,D,C,se;let r=Yf(e,t);if(ao()&&!n.force)return lr(e,r,1),(w=n.onUpdate)==null||w.call(n,1),(T=n.onComplete)==null||T.call(n),Zi();let o=Math.max(0,(k=n.duration)!=null?k:400),i=Math.max(0,(A=n.delay)!=null?A:0),s=nb(n.easing),a=Math.max(0,Math.floor((D=n.repeat)!=null?D:0)),l=(C=n.repeatType)!=null?C:"loop",c=n.spring===!0?{}:n.spring?n.spring:null,d,u=new Promise(O=>{d=O}),p=!0,f=-1,m=-1,h=0,v=(se=c==null?void 0:c.velocity)!=null?se:0;function g(O){var en,Ln,gc,bc,yc,xc,wc;if(!p)return;f<0&&(f=O,m=O);let pe=O-f-i;if(pe<0)return;let ae=Math.min(64,Math.max(0,O-m));if(m=O,pe>qf){b(1);return}if(c){let cm=(en=c.stiffness)!=null?en:170,dm=(Ln=c.damping)!=null?Ln:26,um=(gc=c.mass)!=null?gc:1,Ec=Math.max(1,Math.round(ae)),kc=ae/Ec/1e3;for(let Tc=0;Tc<Ec;Tc++){let mm=(-cm*(h-1)-dm*v)/um;v+=mm*kc,h+=v*kc}let fm=(bc=c.restDelta)!=null?bc:.001,pm=(yc=c.restSpeed)!=null?yc:.01;if(Math.abs(1-h)<fm&&Math.abs(v)<pm){b(1);return}lr(e,r,h),(xc=n.onUpdate)==null||xc.call(n,h);return}if(o===0){b(1);return}let R=a+1,S=Math.floor(pe/o),B=(pe-S*o)/o,Ve=!1;S>=R&&(S=R-1,B=1,Ve=!0);let Ue;if(S%2===1&&l==="reverse"?Ue=s(1-B):S%2===1&&l==="mirror"?Ue=1-s(B):Ue=s(B),Ve){b(Ue);return}lr(e,r,Ue),(wc=n.onUpdate)==null||wc.call(n,Ue)}function b(O){var pe,ae;p&&(p=!1,Qi(g),lr(e,r,O),(pe=n.onUpdate)==null||pe.call(n,O),d(),(ae=n.onComplete)==null||ae.call(n))}return lr(e,r,c?h:s(0)),jf(g),{finished:u,stop(){p&&(p=!1,Qi(g),d())}}}function Pt(e,t,n={}){let r=Cl(e);if(r.length===0)return Zi();if(r.length===1)return Ll(r[0],t,n);let o=r.map(i=>Ll(i,t,n));return{finished:Promise.all(o.map(i=>i.finished)).then(()=>{}),stop(){for(let i of o)i.stop()}}}function Rl(e,t,n={}){var g,b,w,T,k,A,D,C;if(ao())return(g=n.onUpdate)==null||g.call(n,t),(b=n.onComplete)==null||b.call(n),Zi();let r=(w=n.stiffness)!=null?w:170,o=(T=n.damping)!=null?T:26,i=(k=n.mass)!=null?k:1,s=Math.abs(t-e)||1,a=(A=n.restDelta)!=null?A:s*.001,l=(D=n.restSpeed)!=null?D:s*.01,c=e,d=(C=n.velocity)!=null?C:0,u=!0,p=-1,f=0,m,h=new Promise(se=>{m=se});function v(se){var S,B,Ve,Ue;if(!u)return;if(p<0){p=se,(S=n.onUpdate)==null||S.call(n,c);return}let O=Math.min(64,Math.max(0,se-p));p=se,f+=O;let pe=Math.max(1,Math.round(O)),ae=O/pe/1e3;for(let en=0;en<pe;en++){let Ln=(-r*(c-t)-o*d)/i;d+=Ln*ae,c+=d*ae}if(Math.abs(t-c)<a&&Math.abs(d)<l||f>qf){u=!1,Qi(v),c=t,(B=n.onUpdate)==null||B.call(n,t),m(),(Ve=n.onComplete)==null||Ve.call(n);return}(Ue=n.onUpdate)==null||Ue.call(n,c)}return jf(v),{finished:h,stop(){u&&(u=!1,Qi(v),m())}}}function Xf(e,t,n,r){return r==="last"?(t-1-e)*n:r==="center"?Math.abs(e-(t-1)/2)*n:e*n}function $l(e,t,n={}){var l,c,d;let r=Cl(e);if(r.length===0)return Zi();let o=(l=n.delay)!=null?l:60,i=(c=n.start)!=null?c:0,s=(d=n.from)!=null?d:"first",a=r.map((u,p)=>Ll(u,t,{...n,delay:i+Xf(p,r.length,o,s)}));return{finished:Promise.all(a.map(u=>u.finished)).then(()=>{}),stop(){for(let u of a)u.stop()}}}function fb(e){return e==="all"?.99:e==="any"?0:typeof e=="number"?Math.max(0,Math.min(1,e)):.25}function es(e,t,n={}){var s,a,l;let r=(s=n.once)!=null?s:!0,o;if(typeof IntersectionObserver=="undefined")return o=t({target:e,isIntersecting:!0,intersectionRatio:1}),()=>{typeof o=="function"&&o()};let i=new IntersectionObserver(c=>{for(let d of c)d.isIntersecting?(o=t(d),r&&i.disconnect()):typeof o=="function"&&(o(),o=void 0)},{root:(a=n.root)!=null?a:null,rootMargin:(l=n.margin)!=null?l:"0px",threshold:fb(n.amount)});return i.observe(e),()=>{i.disconnect(),typeof o=="function"&&o()}}function Dl(e,t){let n=!1,r=!1;if(typeof window=="undefined")return t(0),()=>{n=!0};let o=()=>{if(r=!1,n)return;let s=e.getBoundingClientRect(),a=window.innerHeight||document.documentElement.clientHeight||1,l=a+s.height||1,c=(a-s.top)/l;t(Math.max(0,Math.min(1,c)))},i=()=>{r||n||(r=!0,requestAnimationFrame(o))};return window.addEventListener("scroll",i,{passive:!0}),window.addEventListener("resize",i),o(),()=>{n=!0,window.removeEventListener("scroll",i),window.removeEventListener("resize",i)}}var pb={opacity:[0,1],duration:420,easing:"easeOut"},mb={opacity:[0,1],y:[24,0],duration:520,easing:"easeOutExpo"},vb={opacity:[0,1],y:[-24,0],duration:520,easing:"easeOutExpo"},hb={opacity:[0,1],scale:[.92,1],duration:460,easing:"easeOutBack"},gb={opacity:[0,1],x:[36,0],duration:500,easing:"easeOutExpo"},bb={opacity:[0,1],x:[-36,0],duration:500,easing:"easeOutExpo"},yb={opacity:[0,1],scale:[.6,1],spring:{stiffness:420,damping:18}},xb={opacity:[0,1],blur:[10,0],duration:560,easing:"easeOut"},wb={opacity:[0,1],rotateX:[-80,0],duration:620,easing:"easeOutBack"},hn={fadeIn:pb,fadeUp:mb,fadeDown:vb,scaleIn:hb,slideLeft:gb,slideRight:bb,pop:yb,blurIn:xb,flip:wb},Eb=new Set(["duration","delay","easing","spring","repeat","repeatType","force","from","start","onUpdate","onComplete"]);function ts(e){let t={},n={};for(let[r,o]of Object.entries(e))o!=null&&(Eb.has(r)?n[r]=o:t[r]=o);return{keyframes:t,options:n}}function Gf(e){let t=e.trim();return t?/^['"`]/.test(t)||/^[[{(]/.test(t)?!0:/^[$A-Za-z_][\w$]*(?:\.[$A-Za-z_][\w$]*|\[[^\]]*\])*$/.test(t):!1}function co(e,t){let n=e.trim();if(!n)return null;if(hn[n])return hn[n];if(!Gf(n))return null;let r=t();return typeof r=="string"&&hn[r]?hn[r]:r&&typeof r=="object"?r:null}function bt(e,t){var n;return(n=e.getAttribute(`${x.prefix}${t}`))!=null?n:e.getAttribute(`data-v-${t}`)}function If(e,t){return e.hasAttribute(`${x.prefix}${t}`)||e.hasAttribute(`data-v-${t}`)}var Qf=new WeakMap;function Jf(e){let t=bt(e,"motion-stagger-from");return t==="last"||t==="center"?t:"first"}function kb(e){return If(e,"motion")||If(e,"motion-scroll")}function Zf(e){let t=e.parentElement;if(!t)return 0;let n=Qf.get(t);if(!n){let i=bt(t,"motion-stagger");if(i===null)return 0;n={step:Q(i,60),from:Jf(t)}}let r=Array.from(t.children).filter(kb),o=r.indexOf(e);return o<0?0:Xf(o,r.length,n.step,n.from)}y("motion",({el:e,expression:t,evaluate:n,cleanup:r})=>{var c;let o=co(t,n);if(!o){X(`v-motion did not recognize the variant "${t}".`);return}let{keyframes:i,options:s}=ts(o),a=Zf(e);a>0&&(s.delay=((c=s.delay)!=null?c:0)+a);let l=Pt(e,i,s);r(()=>l.stop())});y("motion-scroll",({el:e,expression:t,evaluate:n,modifiers:r,cleanup:o})=>{var m,h;let i=co(t,n);if(!i){X(`v-motion-scroll did not recognize the variant "${t}".`);return}let{keyframes:s,options:a}=ts(i),l=Zf(e);l>0&&(a.delay=((m=a.delay)!=null?m:0)+l);let c=!r.repeat,d=bt(e,"motion-scroll-amount"),u=d===null?.25:parseFloat(d)||0;ao()||Ff(e,s);let p=null,f=es(e,()=>{if(p==null||p.stop(),p=Pt(e,s,a),!c)return()=>{p==null||p.stop(),ao()||Ff(e,s)}},{once:c,amount:u,margin:(h=bt(e,"motion-scroll-margin"))!=null?h:"0px"});o(()=>{f(),p==null||p.stop()})});y("motion-stagger",({el:e,expression:t,evaluate:n})=>{let r=n(),o=typeof r=="number"&&Number.isFinite(r)?r:Q(t,60);Qf.set(e,{step:o,from:Jf(e)})},{priority:j.BIND});function ep(e,t,n,r,o,i){let{keyframes:s,options:a}=ts(t),l={...o,...a},c=null,d=null,u=m=>{d==null||d.stop(),d=Pt(e,m,l)},p=()=>{c||(c=ub(e,s)),u(s)},f=()=>{c&&u(c)};for(let m of n)e.addEventListener(m,p);for(let m of r)e.addEventListener(m,f);i(()=>{for(let m of n)e.removeEventListener(m,p);for(let m of r)e.removeEventListener(m,f);d==null||d.stop()})}y("motion-hover",({el:e,expression:t,evaluate:n,cleanup:r})=>{let o=co(t,n);if(!o){X(`v-motion-hover did not recognize the variant "${t}".`);return}ep(e,o,["mouseenter","focusin"],["mouseleave","focusout"],{duration:220,easing:"easeOut"},r)});y("motion-tap",({el:e,expression:t,evaluate:n,cleanup:r})=>{let o=co(t,n);if(!o){X(`v-motion-tap did not recognize the variant "${t}".`);return}ep(e,o,["pointerdown"],["pointerup","pointercancel","pointerleave","blur"],{duration:140,easing:"easeOut"},r)});y("parallax",({el:e,expression:t,evaluate:n,cleanup:r})=>{if(ao()||typeof window=="undefined")return;let o=n(),i=typeof o=="number"&&Number.isFinite(o)?o:parseFloat(t)||.3;e.style.willChange="transform";let s=!1,a=()=>{s=!1;let c=e.getBoundingClientRect(),d=window.innerHeight||document.documentElement.clientHeight||1,u=c.top+c.height/2;Ji(e).parallax=(d/2-u)*i,Tl(e)},l=()=>{s||(s=!0,requestAnimationFrame(a))};window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),a(),r(()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l),Ji(e).parallax=0,Tl(e),e.style.removeProperty("will-change")})});var Gi=new Map,wl=null,Ml=!1;function zf(){Ml||typeof requestAnimationFrame!="function"||(Ml=!0,requestAnimationFrame(Tb))}function Tb(){var e;Ml=!1;for(let t of Gi.values()){if(!t.el.isConnected||t.animating)continue;let n=t.el.getBoundingClientRect(),r=t.rect;t.rect=n;let o=r.left-n.left,i=r.top-n.top,s=n.width>0?r.width/n.width:1,a=n.height>0?r.height/n.height:1,l=Math.abs(o)>=1||Math.abs(i)>=1,c=Math.abs(s-1)>=.01||Math.abs(a-1)>=.01;!l&&!c||(t.animating=!0,(e=t.control)==null||e.stop(),t.control=Pt(t.el,{x:[o,0],y:[i,0],scaleX:[s,1],scaleY:[a,1]},t.options),t.control.finished.then(()=>{t.animating=!1,t.el.isConnected&&(t.rect=t.el.getBoundingClientRect())}))}}function Lb(){var t;if(wl||typeof MutationObserver=="undefined")return;let e=(t=x.root)!=null?t:document.body;e&&(wl=new MutationObserver(zf),wl.observe(e,{childList:!0,subtree:!0}),window.addEventListener("resize",zf))}y("flip",({el:e,expression:t,evaluate:n,cleanup:r})=>{if(typeof document=="undefined")return;let o=co(t,n),i=o?ts(o).options:{};i.duration===void 0&&i.spring===void 0&&(i.spring={stiffness:340,damping:34}),Lb(),Gi.set(e,{el:e,rect:e.getBoundingClientRect(),options:i,control:null,animating:!1}),r(()=>{var s,a;(a=(s=Gi.get(e))==null?void 0:s.control)==null||a.stop(),Gi.delete(e)})});function Mb(e,t){let n={minimumFractionDigits:t,maximumFractionDigits:t};e==="currency"&&(n.style="currency",n.currency=x.currency);let r=new Intl.NumberFormat(x.locale,n);return e==="percent"?o=>`${r.format(o)}%`:o=>r.format(o)}y("count",({el:e,evaluate:t,effect:n,cleanup:r})=>{var p,f,m,h,v;let o=Q((p=bt(e,"count-duration"))!=null?p:void 0,1400),i=Math.max(0,Math.min(6,parseInt((f=bt(e,"count-decimals"))!=null?f:"0",10)||0)),s=(m=bt(e,"count-format"))!=null?m:"number",a=(h=bt(e,"count-prefix"))!=null?h:"",l=(v=bt(e,"count-suffix"))!=null?v:"",c=Mb(s,i),d=0,u=null;n(()=>{let g=Number(t()),b=Number.isFinite(g)?g:0,w=d;u==null||u.stop(),u=Pt(e,{},{duration:o,easing:"easeOutExpo",onUpdate(T){d=w+(b-w)*T,e.textContent=`${a}${c(d)}${l}`}})}),r(()=>u==null?void 0:u.stop())});y("typewriter",({el:e,expression:t,evaluate:n,effect:r,cleanup:o})=>{var l;let i=Q((l=bt(e,"typewriter-speed"))!=null?l:void 0,45),s=Gf(t),a=null;r(()=>{var u;let c=s?String((u=n())!=null?u:""):t;if(a==null||a.stop(),e.textContent="",!c)return;let d=-1;a=Pt(e,{},{duration:Math.max(1,c.length*i),easing:"linear",onUpdate(p){let f=Math.round(p*c.length);f!==d&&(d=f,e.textContent=c.slice(0,f))}})}),o(()=>a==null?void 0:a.stop())});He();ce();function Sb(){return typeof window=="undefined"||typeof window.matchMedia!="function"?!1:ve.reducedMotion}var uo=["#6D3BF5","#FF3D8B","#2ED9A5","#FFB35C","#9B7BFF","#FF4D4D","#14111F","#3BB6F5"],Ab=`
...
`;function E(e){return Math.round(e*100)/100}function ye(e){let t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:0}function bn(e,t,n){return e<t?t:e>n?n:e}var tp=new Map;function np(e,t){let n=`${x.locale}|${x.currency}|${e}`,r=tp.get(n);return r||(r=new Intl.NumberFormat(x.locale,t),tp.set(n,r)),r}function $e(e,t="number"){if(!Number.isFinite(e))return"";if(t==="currency")return np("currency",{style:"currency",currency:x.currency,maximumFractionDigits:2}).format(e);let n=np("number",{maximumFractionDigits:2}).format(e);return t==="percent"?`${n}%`:n}function Cb(e){return!!e&&typeof e=="object"&&Array.isArray(e.data)}function je(e,t){let n=e[t];return n===void 0||n===""?`#${t+1}`:n}function Rb(e,t){var c,d,u;let n=e.colors&&e.colors.length>0?e.colors:uo,r=Array.isArray(e.labels),o=r?e.labels.map(p=>String(p)):[],i=[],s=e.data,a=(c=e.name)!=null?c:"Value";if(typeof s=="number")i.push({name:a,values:[s],xs:null,color:n[0]});else if(Array.isArray(s)&&s.length>0){let p=s[0];if(typeof p=="number")i.push({name:a,values:s.map(ye),xs:null,color:n[0]});else if(Cb(p))s.forEach((f,m)=>{i.push({name:f.name||`Serie ${m+1}`,values:(f.data||[]).map(ye),xs:null,color:f.color||n[m%n.length]})});else{let f=s,m=[],h=[],v=!1;f.forEach((g,b)=>{m.push(ye(g.value!==void 0?g.value:g.y)),typeof g.x=="number"?(v=!0,h.push(g.x)):h.push(b),!r&&g.label!==void 0&&(o[b]=String(g.label))}),i.push({name:a,values:m,xs:v?h:null,color:n[0]})}}let l=t==="pie"||t==="donut";if(l)for(let p=0;p<((u=(d=i[0])==null?void 0:d.values.length)!=null?u:0);p++)o[p]===void 0&&(o[p]=je(o,p));return{series:i,labels:o,categorical:l}}function $b(e,t){if(e.categorical){let n=e.series[0];return n?n.values.map((r,o)=>({key:je(e.labels,o),name:je(e.labels,o),color:t[o%t.length]})):[]}return e.series.map(n=>({key:n.name,name:n.name,color:n.color}))}function Db(e,t,n){var r;if(t.size===0)return e;if(e.categorical){let o=e.series[0];if(!o)return e;let i=[],s=[],a=[];return o.values.forEach((l,c)=>{let d=je(e.labels,c);t.has(d)||(i.push(l),s.push(d),a.push(n[c%n.length]))}),{series:[{...o,values:i,xs:null,color:(r=a[0])!=null?r:o.color}],labels:s,categorical:!0}}return{series:e.series.filter(o=>!t.has(o.name)),labels:e.labels,categorical:!1}}function rp(e,t){let n=Math.abs(e)||1,r=Math.floor(Math.log10(n)),o=n/Math.pow(10,r),i;return t?o<1.5?i=1:o<3?i=2:o<7?i=5:i=10:o<=1?i=1:o<=2?i=2:o<=5?i=5:i=10,i*Math.pow(10,r)}function Hl(e,t,n=5){if(e===t){let c=Math.abs(e)||1;return Hl(e-c*.5,t+c*.5,n)}let r=rp(t-e,!1),o=rp(r/Math.max(1,n-1),!0),i=Math.max(0,Math.min(10,-Math.floor(Math.log10(o))+2)),s=Math.floor(e/o)*o,a=Math.ceil(t/o)*o,l=[];for(let c=s;c<=a+o*.5;c+=o)l.push(Number(c.toFixed(i)));return{min:s,max:a,ticks:l}}function Nl(e,t,n,r){let o=1/0,i=-1/0;if(n){let s=0;for(let a of e.series)s=Math.max(s,a.values.length);for(let a=0;a<s;a++){let l=0,c=0;for(let d of e.series){let u=ye(d.values[a]);u>=0?l+=u:c+=u}o=Math.min(o,c),i=Math.max(i,l)}}else for(let s of e.series)for(let a of s.values)Number.isFinite(a)&&(o=Math.min(o,a),i=Math.max(i,a));return(!Number.isFinite(o)||!Number.isFinite(i))&&(o=0,i=1),r&&(o=Math.min(o,0),i=Math.max(i,0)),t.min!==void 0&&(o=t.min),t.max!==void 0&&(i=t.max),o===i&&(i=o+(Math.abs(o)||1)),{min:o,max:i}}function op(e){if(e.length===0)return"";let t=[`M ${E(e[0][0])} ${E(e[0][1])}`];for(let n=1;n<e.length;n++)t.push(`L ${E(e[n][0])} ${E(e[n][1])}`);return t.join(" ")}function Pb(e){if(e.length<3)return op(e);let t=[`M ${E(e[0][0])} ${E(e[0][1])}`];for(let n=0;n<e.length-1;n++){let r=n>0?e[n-1]:e[n],o=e[n],i=e[n+1],s=n+2<e.length?e[n+2]:i,a=o[0]+(i[0]-r[0])/6,l=o[1]+(i[1]-r[1])/6,c=i[0]-(s[0]-o[0])/6,d=i[1]-(s[1]-o[1])/6;t.push(`C ${E(a)} ${E(l)}, ${E(c)} ${E(d)}, ${E(i[0])} ${E(i[1])}`)}return t.join(" ")}function Hb(e,t){return t?Pb(e):op(e)}function lt(e,t,n,r){return[e+Math.cos(r)*n,t+Math.sin(r)*n]}function Nb(e,t,n,r,o,i){let s=i-o>Math.PI?1:0,[a,l]=lt(e,t,n,o),[c,d]=lt(e,t,n,i);if(r<=0)return`M ${E(e)} ${E(t)} L ${E(a)} ${E(l)} A ${E(n)} ${E(n)} 0 ${s} 1 ${E(c)} ${E(d)} Z`;let[u,p]=lt(e,t,r,o),[f,m]=lt(e,t,r,i);return`M ${E(a)} ${E(l)} A ${E(n)} ${E(n)} 0 ${s} 1 ${E(c)} ${E(d)} L ${E(f)} ${E(m)} A ${E(r)} ${E(r)} 0 ${s} 0 ${E(u)} ${E(p)} Z`}var Ob=7;function ip(e){let t=0;for(let n of e)t=Math.max(t,n.length);return t*Ob+12}function Ol(e,t){let{options:n,dataset:r,width:o,height:i}=e,s=Nl(r,n,t.stacked,t.baselineZero),a=n.min!==void 0&&n.max!==void 0?{min:s.min,max:s.max,ticks:sp(s.min,s.max,5)}:Hl(s.min,s.max,5),l=a.ticks.map(T=>$e(T,e.format)),c=n.showGrid!==!1&&!t.bare,d=r.labels.length>0&&!t.bare,u=t.bare?3:16,p=t.bare?3:16,f=t.bare?3:c?bn(ip(l),32,140):8,m=t.bare?3:d?26:10,h=Math.max(1,o-f-p),v=Math.max(1,i-u-m),g=a.max-a.min||1,b=T=>u+v*(1-(T-a.min)/g),w="";if(c){let T=[];a.ticks.forEach((k,A)=>{let D=E(b(k));T.push(`<line class="v-chart-grid" x1="${E(f)}" y1="${D}" x2="${E(f+h)}" y2="${D}"/>`),T.push(`<text class="v-chart-axis" x="${E(f-8)}" y="${D+4}" text-anchor="end">${I(l[A])}</text>`)}),w=`<g>${T.join("")}</g>`}return{left:f,top:u,innerW:h,innerH:v,min:a.min,max:a.max,ticks:a.ticks,y:b,grid:w}}function sp(e,t,n){let r=(t-e)/Math.max(1,n-1),o=[];for(let i=0;i<n;i++)o.push(Number((e+r*i).toFixed(6)));return o}function Fl(e,t,n,r,o){if(e.length===0||t===0)return"";let i=Math.max(1,Math.floor(o/56)),s=Math.max(1,Math.ceil(t/i)),a=[];for(let l=0;l<t;l+=s){let c=e[l];c===void 0||c===""||a.push(`<text class="v-chart-axis" x="${E(n(l))}" y="${E(r)}" text-anchor="middle">${I(c)}</text>`)}return a.join("")}function fo(e){let t=e.labels.length;for(let n of e.series)t=Math.max(t,n.values.length);return t}function yn(e){return`<text class="v-chart-empty" x="${E(e.width/2)}" y="${E(e.height/2)}" text-anchor="middle">No data</text>`}function xn(e,t,n){return`<title>${I(e)}: ${I($e(t,n))}</title>`}function Fb(e,t){if(e.values.length===0)return e.name;let n=1/0,r=-1/0;for(let s of e.values)n=Math.min(n,s),r=Math.max(r,s);let o=e.values[0],i=e.values[e.values.length-1];return`${e.name}: from ${$e(o,t)} to ${$e(i,t)}, minimum ${$e(n,t)}, maximum ${$e(r,t)}`}function Ib(e){let t=e.type==="sparkline",n=e.type==="area",r=fo(e.dataset);if(r===0)return yn(e);let o=Ol(e,{stacked:!1,baselineZero:n,bare:t}),i=c=>r<=1?o.left+o.innerW/2:o.left+o.innerW*c/(r-1),s=e.options.smooth===!0,a=[o.grid],l=o.y(bn(0,o.min,o.max));for(let c of e.dataset.series){let d=[];for(let f=0;f<r;f++)d.push([i(f),o.y(ye(c.values[f]))]);if(d.length===0)continue;let u=Hb(d,s);if(n){let f=`${u} L ${E(d[d.length-1][0])} ${E(l)} L ${E(d[0][0])} ${E(l)} Z`;a.push(`<path class="v-chart-area" d="${f}" fill="${I(c.color)}" fill-opacity="0.16"/>`)}let p=e.animated?' pathLength="1" stroke-dasharray="1"':"";a.push(`<path class="v-chart-line" d="${u}" stroke="${I(c.color)}"${p}><title>${I(Fb(c,e.format))}</title></path>`),!t&&r<=40&&d.forEach((f,m)=>{a.push(`<circle class="v-chart-point" cx="${E(f[0])}" cy="${E(f[1])}" r="3.5" fill="${I(c.color)}">`+xn(`${c.name} ${je(e.dataset.labels,m)}`,ye(c.values[m]),e.format)+"</circle>")}),e.options.showValues&&!t&&d.forEach((f,m)=>{a.push(`<text class="v-chart-value" x="${E(f[0])}" y="${E(f[1]-10)}" text-anchor="middle">${I($e(ye(c.values[m]),e.format))}</text>`)})}return t||a.push(Fl(e.dataset.labels,r,i,o.top+o.innerH+18,o.innerW)),ap(e,r,i,c=>{let d=1/0;for(let u of e.dataset.series)d=Math.min(d,o.y(ye(u.values[c])));return Number.isFinite(d)?d:o.top}),a.join("")}function ap(e,t,n,r){for(let o=0;o<t;o++)e.hits.push({x:n(o),y:r(o),title:je(e.dataset.labels,o),rows:e.dataset.series.map(i=>({name:i.name,color:i.color,value:ye(i.values[o])}))})}function zb(e){let t=e.type==="stacked",n=fo(e.dataset);if(n===0)return yn(e);let r=Ol(e,{stacked:t,baselineZero:!0,bare:!1}),o=r.innerW/n,i=t?1:Math.max(1,e.dataset.series.length),s=Math.min(o*.3,18),a=Math.max(2,(o-s)/i),l=r.y(bn(0,r.min,r.max)),c=Math.min(4,a/2),d=[r.grid],u=p=>r.left+o*p+o/2;for(let p=0;p<n;p++){let f=0,m=0;e.dataset.series.forEach((h,v)=>{let g=ye(h.values[p]),b,w,T;if(t){let D=g>=0?f:m,C=D+g;g>=0?f=C:m=C,b=Math.min(r.y(D),r.y(C)),w=Math.max(r.y(D),r.y(C)),T=r.left+o*p+s/2}else b=Math.min(r.y(g),l),w=Math.max(r.y(g),l),T=r.left+o*p+s/2+v*a;let k=t?Math.max(2,o-s):a*.86,A=Math.max(g===0?0:1,w-b);d.push(`<rect class="v-chart-bar" x="${E(T)}" y="${E(b)}" width="${E(k)}" height="${E(A)}" rx="${E(c)}" fill="${I(h.color)}" style="transform-origin:${E(T+k/2)}px ${E(l)}px;transition-delay:${p*30}ms">`+xn(`${h.name} ${je(e.dataset.labels,p)}`,g,e.format)+"</rect>"),e.options.showValues&&!t&&d.push(`<text class="v-chart-value" x="${E(T+k/2)}" y="${E(b-6)}" text-anchor="middle">${I($e(g,e.format))}</text>`)})}return d.push(Fl(e.dataset.labels,n,u,r.top+r.innerH+18,r.innerW)),ap(e,n,u,p=>{if(t){let m=0;for(let h of e.dataset.series)m+=Math.max(0,ye(h.values[p]));return r.y(m)}let f=l;for(let m of e.dataset.series)f=Math.min(f,r.y(ye(m.values[p])));return f}),d.join("")}function Bb(e){let t=fo(e.dataset);if(t===0)return yn(e);let n=Nl(e.dataset,e.options,!1,!0),r=e.options.min!==void 0&&e.options.max!==void 0?{min:n.min,max:n.max,ticks:sp(n.min,n.max,5)}:Hl(n.min,n.max,5),o=bn(ip(e.dataset.labels.length>0?e.dataset.labels:[""]),24,e.width*.4),i=e.dataset.labels.length>0?o:12,s=12,a=e.options.showGrid===!1?12:26,l=Math.max(1,e.width-i-20),c=Math.max(1,e.height-s-a),d=r.max-r.min||1,u=b=>i+l*(b-r.min)/d,p=u(bn(0,r.min,r.max)),f=c/t,m=Math.max(1,e.dataset.series.length),h=Math.min(f*.3,16),v=Math.max(2,(f-h)/m),g=[];if(e.options.showGrid!==!1)for(let b of r.ticks){let w=E(u(b));g.push(`<line class="v-chart-grid" x1="${w}" y1="${E(s)}" x2="${w}" y2="${E(s+c)}"/>`),g.push(`<text class="v-chart-axis" x="${w}" y="${E(s+c+16)}" text-anchor="middle">${I($e(b,e.format))}</text>`)}for(let b=0;b<t;b++){let w=e.dataset.labels[b];w&&g.push(`<text class="v-chart-axis" x="${E(i-8)}" y="${E(s+f*b+f/2+4)}" text-anchor="end">${I(w)}</text>`);let T=p;e.dataset.series.forEach((k,A)=>{let D=ye(k.values[b]),C=Math.min(u(D),p);T=Math.max(T,u(D));let se=Math.max(D===0?0:1,Math.abs(u(D)-p)),O=s+f*b+h/2+A*v;g.push(`<rect class="v-chart-barh" x="${E(C)}" y="${E(O)}" width="${E(se)}" height="${E(v*.86)}" rx="${E(Math.min(4,v/2))}" fill="${I(k.color)}" style="transform-origin:${E(p)}px ${E(O+v/2)}px;transition-delay:${b*30}ms">`+xn(`${k.name} ${je(e.dataset.labels,b)}`,D,e.format)+"</rect>"),e.options.showValues&&g.push(`<text class="v-chart-value" x="${E(C+se+6)}" y="${E(O+v*.6)}">${I($e(D,e.format))}</text>`)}),e.hits.push({x:T,y:s+f*b+f/2,title:je(e.dataset.labels,b),rows:e.dataset.series.map(k=>({name:k.name,color:k.color,value:ye(k.values[b])}))})}return g.join("")}function jb(e){let t=e.dataset.series[0];if(!t||t.values.length===0)return yn(e);let n=e.type==="donut",r=t.values.map(p=>Math.max(0,ye(p))),o=r.reduce((p,f)=>p+f,0);if(o<=0)return yn(e);let i=e.width/2,s=e.height/2,a=Math.max(12,Math.min(e.width,e.height)/2-14),l=n?a*.62:0,c=`transform-origin:${E(i)}px ${E(s)}px`,d=[],u=-Math.PI/2;return r.forEach((p,f)=>{let m=p/o*Math.PI*2,h=e.palette[f%e.palette.length],v=je(e.dataset.labels,f),g=m>=Math.PI*2-1e-6,b=g?n?`<circle class="v-chart-slice" data-hit="${f}" cx="${E(i)}" cy="${E(s)}" r="${E((a+l)/2)}" fill="none" stroke="${I(h)}" stroke-width="${E(a-l)}" style="${c}">`:`<circle class="v-chart-slice" data-hit="${f}" cx="${E(i)}" cy="${E(s)}" r="${E(a)}" fill="${I(h)}" style="${c}">`:`<path class="v-chart-slice" data-hit="${f}" d="${Nb(i,s,a,l,u,u+m)}" fill="${I(h)}" style="${c};transition-delay:${f*45}ms">`;d.push(`${b}${xn(v,p,e.format)}${g?"</circle>":"</path>"}`);let w=u+m/2,[T,k]=lt(i,s,(a+l)/2,w);if(e.hits.push({x:T,y:k,title:v,rows:[{name:v,color:h,value:p}]}),e.options.showValues&&m>.3){let[A,D]=lt(i,s,n?(a+l)/2:a*.68,w),C=Math.round(p/o*100);d.push(`<text class="v-chart-value" x="${E(A)}" y="${E(D+4)}" text-anchor="middle">${C}%</text>`)}u+=m}),n&&d.push(`<text class="v-chart-center" x="${E(i)}" y="${E(s+2)}" text-anchor="middle">${I($e(o,e.format))}</text>`,`<text class="v-chart-center-sub" x="${E(i)}" y="${E(s+20)}" text-anchor="middle">Total</text>`),d.join("")}function qb(e){let t=fo(e.dataset);if(t<3)return yn(e);let r=Nl(e.dataset,e.options,!1,!0).max||1,o=e.width/2,i=e.height/2,s=Math.max(20,Math.min(e.width,e.height)/2-28),a=c=>-Math.PI/2+Math.PI*2*c/t,l=[];for(let c=1;c<=4;c++){let d=[];for(let u=0;u<t;u++)d.push(lt(o,i,s*c/4,a(u)));l.push(`<polygon class="v-chart-radar-web" points="${d.map(u=>`${E(u[0])},${E(u[1])}`).join(" ")}"/>`)}for(let c=0;c<t;c++){let[d,u]=lt(o,i,s,a(c));l.push(`<line class="v-chart-grid" x1="${E(o)}" y1="${E(i)}" x2="${E(d)}" y2="${E(u)}"/>`);let p=e.dataset.labels[c];if(p){let[f,m]=lt(o,i,s+14,a(c)),h=Math.abs(f-o)<4?"middle":f>o?"start":"end";l.push(`<text class="v-chart-axis" x="${E(f)}" y="${E(m+4)}" text-anchor="${h}">${I(p)}</text>`)}}for(let c of e.dataset.series){let d=[];for(let u=0;u<t;u++){let p=bn(ye(c.values[u])/r,0,1);d.push(lt(o,i,s*p,a(u)))}l.push(`<polygon class="v-chart-radar-area v-chart-slice" points="${d.map(u=>`${E(u[0])},${E(u[1])}`).join(" ")}" fill="${I(c.color)}" fill-opacity="0.22" stroke="${I(c.color)}" style="transform-origin:${E(o)}px ${E(i)}px"/>`),d.forEach((u,p)=>{l.push(`<circle class="v-chart-point" data-hit="${p}" cx="${E(u[0])}" cy="${E(u[1])}" r="3.5" fill="${I(c.color)}">`+xn(`${c.name} ${je(e.dataset.labels,p)}`,ye(c.values[p]),e.format)+"</circle>")})}for(let c=0;c<t;c++){let[d,u]=lt(o,i,s*.7,a(c));e.hits.push({x:d,y:u,title:je(e.dataset.labels,c),rows:e.dataset.series.map(p=>({name:p.name,color:p.color,value:ye(p.values[c])}))})}return l.join("")}function Vb(e){let t=fo(e.dataset);if(t===0)return yn(e);let n=Ol(e,{stacked:!1,baselineZero:!1,bare:!1}),r=1/0,o=-1/0;for(let c of e.dataset.series){let d=c.xs;if(d)for(let u of d)r=Math.min(r,u),o=Math.max(o,u)}let i=Number.isFinite(r)&&Number.isFinite(o)&&o>r,s=(c,d)=>i&&c.xs?n.left+n.innerW*(c.xs[d]-r)/(o-r):t<=1?n.left+n.innerW/2:n.left+n.innerW*d/(t-1),a=[n.grid],l=0;for(let c of e.dataset.series)c.values.forEach((d,u)=>{let p=s(c,u),f=n.y(ye(d));a.push(`<circle class="v-chart-point v-chart-slice" data-hit="${l}" cx="${E(p)}" cy="${E(f)}" r="4.5" fill="${I(c.color)}" style="transform-origin:${E(p)}px ${E(f)}px">`+xn(`${c.name} ${je(e.dataset.labels,u)}`,ye(d),e.format)+"</circle>"),e.hits.push({x:p,y:f,title:je(e.dataset.labels,u),rows:[{name:c.name,color:c.color,value:ye(d)}]}),l++});return i||a.push(Fl(e.dataset.labels,t,c=>t<=1?n.left+n.innerW/2:n.left+n.innerW*c/(t-1),n.top+n.innerH+18,n.innerW)),a.join("")}function Ub(e){var m,h,v,g,b;let t=e.dataset.series[0],n=t?ye(t.values[0]):0,r=(m=e.options.max)!=null?m:100,o=(h=e.options.min)!=null?h:0,i=bn((n-o)/(r-o||1),0,1),s=e.width/2,a=e.height/2,l=Math.max(16,Math.min(e.width,e.height)/2-16),c=Math.max(8,l*.2),d=l-c/2,u=2*Math.PI*d,p=u*(1-i),f=e.palette[0];return e.hits.push({x:s,y:a-d,title:(v=t==null?void 0:t.name)!=null?v:"Progresso",rows:[{name:(g=t==null?void 0:t.name)!=null?g:"Progresso",color:f,value:n}]}),`<circle class="v-chart-track" cx="${E(s)}" cy="${E(a)}" r="${E(d)}" stroke-width="${E(c)}"/><circle class="v-chart-ring" data-hit="0" cx="${E(s)}" cy="${E(a)}" r="${E(d)}" fill="none" stroke="${I(f)}" stroke-width="${E(c)}" stroke-linecap="round" stroke-dasharray="${E(u)}" style="--v-ring-full:${E(u)};--v-ring-offset:${E(p)};transform:rotate(-90deg);transform-origin:${E(s)}px ${E(a)}px">`+xn((b=t==null?void 0:t.name)!=null?b:"Progresso",n,e.format)+`</circle><text class="v-chart-center" x="${E(s)}" y="${E(a+4)}" text-anchor="middle">${Math.round(i*100)}%</text>`+(t?`<text class="v-chart-center-sub" x="${E(s)}" y="${E(a+22)}" text-anchor="middle">${I($e(n,e.format))}</text>`:"")}var Wb=new Set(["pie","donut","scatter","progress","radar"]);function _b(e){return e==="sparkline"?56:260}function Kb(e,t){return e.showLegend===!1?!1:e.showLegend===!0?!0:t.categorical||t.series.length>1}var Yb={line:"line",area:"area",bar:"bar",column:"horizontal bar",stacked:"stacked bar",pie:"pie",donut:"donut",sparkline:"trend",radar:"radar",scatter:"scatter",progress:"progress"};function Xb(e,t,n){if(t.series.length===0)return"Chart with no data.";let r=(t.series.length===1,"series"),o=[`${Yb[e]} chart with ${t.series.length} ${r}.`];for(let i of t.series){if(i.values.length===0)continue;let s=1/0,a=-1/0,l=0;for(let d of i.values)s=Math.min(s,d),a=Math.max(a,d),l+=d;let c=l/i.values.length;o.push(`${i.name}: ${i.values.length} points, minimum ${$e(s,n)}, maximum ${$e(a,n)}, average ${$e(c,n)}.`)}return o.join(" ")}function Gb(e){switch(e.type){case"bar":case"stacked":return zb(e);case"column":return Bb(e);case"pie":case"donut":return jb(e);case"radar":return qb(e);case"scatter":return Vb(e);case"progress":return Ub(e);default:return Ib(e)}}function Qb(e,t){return e.length===0?"":`<div class="v-chart-legend">${e.map(r=>{let o=t.has(r.key);return`<button type="button" class="v-chart-key" data-key="${I(r.key)}" aria-pressed="${o?"false":"true"}"><span class="v-chart-dot" style="background:${I(r.color)}"></span>${I(r.name)}</button>`}).join("")}</div>`}function ns(e){var v,g,b;let t=e.el,n=e.options,r=(v=n.type)!=null?v:"line",o=n.colors&&n.colors.length>0?n.colors:uo,i=(g=n.format)!=null?g:"number",s=Math.max(160,Math.round(t.clientWidth||n.width||640)),a=Math.max(48,Math.round((b=n.height)!=null?b:t.clientHeight||_b(r)));e.lastWidth=s,e.viewWidth=s,e.viewHeight=a;let l=Rb(n,r),c=$b(l,o),d=Db(l,e.hidden,o),u=n.animate!==!1&&!Sb();e.hits=[],e.shapeHits=Wb.has(r),e.hitAxis=r==="column"?"y":"x";let p={type:r,options:n,dataset:d,palette:o,width:s,height:a,animated:u,format:i,hits:e.hits},f=Gb(p),m=Xb(r,d,i);t.classList.add("v-chart"),t.classList.toggle("v-chart-animate",u),t.classList.remove("v-chart-in");let h=[`<svg class="v-chart-svg" viewBox="0 0 ${s} ${a}" preserveAspectRatio="xMidYMid meet" `,`style="height:${a}px" role="img" aria-label="${I(m)}">`,f,"</svg>"];Kb(n,l)&&h.push(Qb(c,e.hidden)),n.tooltip!==!1&&h.push('<div class="v-chart-tip" hidden></div>'),t.innerHTML=h.join(""),u&&typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{requestAnimationFrame(()=>t.classList.add("v-chart-in"))})}function Jb(e,t){let n=e.rows.map(r=>`<div class="v-chart-tip-row"><span class="v-chart-dot" style="background:${I(r.color)}"></span>${I(r.name)}<b>${I($e(r.value,t))}</b></div>`);return`<div class="v-chart-tip-title">${I(e.title)}</div>${n.join("")}`}function lp(e){let t=e.el.querySelector(".v-chart-tip");t&&(t.hidden=!0)}function Zb(e,t){var a;if(e.options.tooltip===!1||e.hits.length===0)return;let n=e.el.querySelector(".v-chart-tip"),r=e.el.querySelector("svg");if(!n||!r)return;let o=r.getBoundingClientRect();if(o.width===0||o.height===0)return;let i;if(e.shapeHits){let l=t.target,c=l&&typeof l.closest=="function"?l.closest("[data-hit]"):null,d=c?Number(c.getAttribute("data-hit")):-1;d>=0&&(i=e.hits[d])}else if(e.hitAxis==="y"){let l=(t.clientY-o.top)/o.height*e.viewHeight,c=1/0;for(let d of e.hits){let u=Math.abs(d.y-l);u<c&&(c=u,i=d)}}else{let l=(t.clientX-o.left)/o.width*e.viewWidth,c=1/0;for(let d of e.hits){let u=Math.abs(d.x-l);u<c&&(c=u,i=d)}}if(!i){lp(e);return}let s=e.el.getBoundingClientRect();n.innerHTML=Jb(i,(a=e.options.format)!=null?a:"number"),n.style.left=`${o.left-s.left+i.x/e.viewWidth*o.width}px`,n.style.top=`${o.top-s.top+i.y/e.viewHeight*o.height}px`,n.hidden=!1}function ey(e){let t=e.el,n=i=>{var l;let s=i.target;if(!s||typeof s.closest!="function")return;let a=(l=s.closest("[data-key]"))==null?void 0:l.getAttribute("data-key");a!=null&&(e.hidden.has(a)?e.hidden.delete(a):e.hidden.add(a),ns(e))},r=i=>Zb(e,i),o=()=>lp(e);t.addEventListener("click",n),t.addEventListener("pointermove",r),t.addEventListener("pointerleave",o),e.teardown.push(()=>{t.removeEventListener("click",n),t.removeEventListener("pointermove",r),t.removeEventListener("pointerleave",o)})}function ty(e){if(typeof ResizeObserver=="undefined")return;let t=new ResizeObserver(()=>{let n=Math.round(e.el.clientWidth);n===0||n===e.lastWidth||(e.frame&&cancelAnimationFrame(e.frame),e.frame=requestAnimationFrame(()=>{e.frame=0,ns(e)}))});t.observe(e.el),e.observer=t}function ur(e,t){ge(),oe("charts",Ab);let n={el:e,options:{...t},hidden:new Set,hits:[],shapeHits:!1,hitAxis:"x",viewWidth:1,viewHeight:1,lastWidth:0,observer:null,frame:0,teardown:[]};return ey(n),ns(n),ty(n),{el:e,get options(){return n.options},update(r){Object.assign(n.options,r),ns(n)},destroy(){var r;n.frame&&cancelAnimationFrame(n.frame),n.frame=0,(r=n.observer)==null||r.disconnect(),n.observer=null;for(let o of n.teardown)o();n.teardown.length=0,e.classList.remove("v-chart","v-chart-animate","v-chart-in"),e.innerHTML=""}}}function et(e,t){var n;return(n=Te(e,`${x.prefix}${t}`))!=null?n:Te(e,`data-v-${t}`)}function dr(e,t){return e===null?t:e===""||e==="true"||e==="1"?!0:e==="false"||e==="0"?!1:t}function ny(e,t){let r=!!t&&typeof t=="object"&&!Array.isArray(t)&&"data"in t?{...t}:{data:t!=null?t:[]},o=et(e,"chart-type");o&&(r.type=o),r.type||(r.type="line");let i=et(e,"chart-height");i&&(r.height=parseFloat(i)||r.height);let s=et(e,"chart-format");s&&(r.format=s);let a=et(e,"chart-colors");a&&(r.colors=a.split(",").map(v=>v.trim()).filter(Boolean));let l=et(e,"chart-max");l!==null&&l!==""&&(r.max=parseFloat(l));let c=et(e,"chart-min");c!==null&&c!==""&&(r.min=parseFloat(c));let d=et(e,"chart-smooth");d!==null&&(r.smooth=dr(d,!0));let u=et(e,"chart-grid");u!==null&&(r.showGrid=dr(u,!0));let p=et(e,"chart-legend");p!==null&&(r.showLegend=dr(p,!0));let f=et(e,"chart-values");f!==null&&(r.showValues=dr(f,!0));let m=et(e,"chart-tooltip");m!==null&&(r.tooltip=dr(m,!0));let h=et(e,"chart-animate");return h!==null&&(r.animate=dr(h,!0)),r}function Pl(e,t=0){if(!e||typeof e!="object"||t>3)return 1;let n=0;if(Array.isArray(e)){for(let r of e)n+=Pl(r,t+1);return n}for(let r of Object.values(e))n+=Pl(r,t+1);return n}y("chart",({el:e,evaluate:t,effect:n,cleanup:r})=>{let o=null;n(()=>{let i=t();Pl(i);let s=ny(e,i);o?o.update(s):o=ur(e,s)}),r(()=>{o==null||o.destroy(),o=null})});var Il={render:ur,format:$e,colors:uo};me();ce();He();He();ce();var ry=/^#([0-9a-f])([0-9a-f])([0-9a-f])[0-9a-f]?$/i,oy=/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})(?:[0-9a-f]{2})?$/i,iy=/^rgba?\(([^)]+)\)$/i,sy=/^hsla?\(([^)]+)\)$/i;function cp(e){return e.split(/[\s,/]+/).map(t=>parseFloat(t)).filter(t=>!Number.isNaN(t))}function ay(e,t,n){let r=(e%360+360)%360,o=qe(t/100,0,1),i=qe(n/100,0,1),s=(1-Math.abs(2*i-1))*o,a=s*(1-Math.abs(r/60%2-1)),l=i-s/2,c=Math.floor(r/60)%6,d=[[s,a,0],[a,s,0],[0,s,a],[0,a,s],[a,0,s],[s,0,a]],[u,p,f]=d[c];return{r:Math.round((u+l)*255),g:Math.round((p+l)*255),b:Math.round((f+l)*255)}}function yt(e){let t=String(e!=null?e:"").trim();if(!t)return null;let n=ry.exec(t);if(n)return{r:parseInt(n[1]+n[1],16),g:parseInt(n[2]+n[2],16),b:parseInt(n[3]+n[3],16)};let r=oy.exec(t);if(r)return{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)};let o=iy.exec(t);if(o){let[s,a,l]=cp(o[1]);return s===void 0||a===void 0||l===void 0?null:{r:qe(s,0,255),g:qe(a,0,255),b:qe(l,0,255)}}let i=sy.exec(t);if(i){let[s,a,l]=cp(i[1]);return s===void 0||a===void 0||l===void 0?null:ay(s,a,l)}return null}function qe(e,t,n){return e<t?t:e>n?n:e}function mr(e){let t=e/255;return t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function zl(e){return e<=.0031308?e*12.92:1.055*Math.pow(e,.4166666666666667)-.055}function ly(e){let t=mr(e.r),n=mr(e.g),r=mr(e.b),o=.4122214708*t+.5363325363*n+.0514459929*r,i=.2119034982*t+.6806995451*n+.1073969566*r,s=.0883024619*t+.2817188376*n+.6299787005*r,a=Math.cbrt(o),l=Math.cbrt(i),c=Math.cbrt(s);return{l:.2104542553*a+.793617785*l-.0040720468*c,a:1.9779984951*a-2.428592205*l+.4505937099*c,b:.0259040371*a+.7827717662*l-.808675766*c}}function cy(e){let t=e.l+.3963377774*e.a+.2158037573*e.b,n=e.l-.1055613458*e.a-.0638541728*e.b,r=e.l-.0894841775*e.a-1.291485548*e.b,o=t*t*t,i=n*n*n,s=r*r*r;return{r:zl(4.0767416621*o-3.3077115913*i+.2309699292*s),g:zl(-1.2684380046*o+2.6097574011*i-.3413193965*s),b:zl(-.0041960863*o-.7034186147*i+1.707614701*s)}}function os(e){let t=ly(e),n=Math.sqrt(t.a*t.a+t.b*t.b),r=Math.atan2(t.b,t.a)*180/Math.PI;return r<0&&(r+=360),{l:t.l,c:n,h:n<1e-5?0:r}}function dp(e){let t=e.h*Math.PI/180;return cy({l:e.l,a:Math.cos(t)*e.c,b:Math.sin(t)*e.c})}function pr(e){let t=Math.max(0,e.c);for(let r=0;r<32;r++){let o=dp({l:qe(e.l,0,1),c:t,h:e.h});if(o.r>=-.001&&o.r<=1.001&&o.g>=-.001&&o.g<=1.001&&o.b>=-.001&&o.b<=1.001)return{r:Math.round(qe(o.r,0,1)*255),g:Math.round(qe(o.g,0,1)*255),b:Math.round(qe(o.b,0,1)*255)};t*=.92}let n=dp({l:qe(e.l,0,1),c:0,h:e.h});return{r:Math.round(qe(n.r,0,1)*255),g:Math.round(qe(n.g,0,1)*255),b:Math.round(qe(n.b,0,1)*255)}}function Bl(e){return qe(Math.round(e),0,255).toString(16).padStart(2,"0")}function wn(e){return`#${Bl(e.r)}${Bl(e.g)}${Bl(e.b)}`}function fr(e,t){return`rgba(${Math.round(e.r)}, ${Math.round(e.g)}, ${Math.round(e.b)}, ${Number(t.toFixed(3))})`}function vp(e){return wn(pr(e))}function ql(e){return .2126*mr(e.r)+.7152*mr(e.g)+.0722*mr(e.b)}function Vl(e,t){let n=typeof e=="string"?yt(e):e,r=typeof t=="string"?yt(t):t;if(!n||!r)return 1;let o=ql(n),i=ql(r),s=Math.max(o,i),a=Math.min(o,i);return(s+.05)/(a+.05)}var hp={r:255,g:255,b:255},is={r:0,g:0,b:0};function po(e){let t=typeof e=="string"?yt(e):e;return t?Vl(t,hp)>=Vl(t,is)?"#ffffff":"#000000":"#ffffff"}var Ul=[50,100,200,300,400,500,600,700,800,900],gp=[.973,.941,.889,.819,.732,.638,.558,.478,.399,.327],dy=[.14,.26,.46,.68,.88,1,.97,.89,.78,.65],bp=[.244,.286,.343,.408,.484,.588,.668,.748,.836,.928],uy=[.3,.42,.6,.78,.92,1,.92,.78,.57,.33];function yp(e,t=!1){var a;let n=typeof e=="string"?(a=yt(e))!=null?a:is:e,r=os(n),o=t?bp:gp,i=t?uy:dy,s={};return Ul.forEach((l,c)=>{s[String(l)]=vp({l:o[c],c:r.c*i[c],h:r.h})}),s}var ss={violeta:{primary:"#6D3BF5",accent:"#FF3D8B",success:"#16A34A",warning:"#D97706",danger:"#E11D48",info:"#7C6BFF"},oceano:{primary:"#0E7BC4",accent:"#0FB5C9",success:"#0F9D6E",warning:"#D08700",danger:"#DC2F3E",info:"#3B82F6"},floresta:{primary:"#1F8A4C",accent:"#7FA80E",success:"#18A05A",warning:"#C97A0A",danger:"#C93A2E",info:"#2C8FA8"},poente:{primary:"#E4632A",accent:"#D62F63",success:"#3E9B52",warning:"#D99000",danger:"#D32F2F",info:"#B45FC0"},grafite:{primary:"#4C5A70",accent:"#2E7FD1",success:"#2F8F60",warning:"#B57A12",danger:"#C2453F",info:"#5B7A99"}},xp=["primary","accent","success","warning","danger","info"],Wl="voodoo:palette",up="voodoo-palette",fy="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif",py="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace";function fp(e,t){let n=(e!=null?e:"").trim();return n?n.includes(",")?n:`${/^['"]/.test(n)?n:`'${n}'`}, ${t}`:t}var my=/^([\d.]+)(px|rem|em)$/;function vy(e){let t=(e||"12px").trim(),n=my.exec(t);if(!n)return{"--v-radius":t,"--v-radius-sm":`calc(${t} * 0.6)`,"--v-radius-lg":`calc(${t} * 1.5)`,"--v-radius-xl":`calc(${t} * 2)`,"--v-radius-full":"999px"};let r=parseFloat(n[1]),o=n[2],i=s=>`${Math.round(s*1e3)/1e3}${o}`;return{"--v-radius":i(r),"--v-radius-sm":i(Math.max(r*.55,0)),"--v-radius-lg":i(r*1.5),"--v-radius-xl":i(r*2),"--v-radius-full":"999px"}}function pp(e,t){var c,d,u,p;let n={},r={},o={};for(let f of xp){let m=(c=yt(e[f]))!=null?c:is,h=os(m),v=yp(m,t);r[f]=v;for(let O of Ul)n[`--v-${f}-${O}`]=v[String(O)];let g=t?{l:Math.max(h.l,.62),c:h.c*.95,h:h.h}:h,b=t?{l:Math.min(g.l+.07,.94),c:g.c*.95,h:g.h}:{l:Math.max(g.l-.055,.12),c:g.c,h:g.h},w=t?{l:Math.min(g.l+.13,.97),c:g.c*.88,h:g.h}:{l:Math.max(g.l-.105,.1),c:g.c,h:g.h},T=pr(g),k=pr(b),A=pr(w);n[`--v-${f}`]=wn(t?T:m),n[`--v-${f}-hover`]=wn(k),n[`--v-${f}-active`]=wn(A),n[`--v-${f}-contrast`]=po(t?T:m),n[`--v-${f}-contrast-hover`]=po(k),n[`--v-${f}-contrast-active`]=po(A);let D=v[50],C=v[100],se=t?v[800]:v[700];n[`--v-${f}-soft`]=D,n[`--v-${f}-soft-hover`]=C,n[`--v-${f}-soft-text`]=se,n[`--v-${f}-ring`]=fr(T,t?.45:.32),n[`--v-${f}-border`]=t?v[300]:v[200],o[f]=n[`--v-${f}-contrast`]}let i=(u=yt((d=e.neutral)!=null?d:e.primary))!=null?u:is,s=os(i).h,a=(f,m)=>vp({l:f,c:m,h:s}),l={};if(Ul.forEach((f,m)=>{let h=t?bp:gp;l[String(f)]=a(h[m],.012),n[`--v-neutral-${f}`]=l[String(f)]}),r.neutral=l,t)n["--v-surface"]=a(.248,.021),n["--v-surface-2"]=a(.196,.021),n["--v-surface-3"]=a(.305,.024),n["--v-surface-inset"]=a(.17,.02),n["--v-text"]=a(.965,.008),n["--v-text-muted"]=a(.748,.017),n["--v-text-soft"]=a(.63,.017),n["--v-border"]=a(.355,.023),n["--v-border-strong"]=a(.46,.026),n["--v-overlay"]="rgba(0, 0, 0, 0.62)",n["--v-shadow-sm"]="0 1px 2px rgba(0, 0, 0, 0.5)",n["--v-shadow"]="0 10px 30px rgba(0, 0, 0, 0.5)",n["--v-shadow-lg"]="0 24px 60px rgba(0, 0, 0, 0.62)";else{let f=pr({l:.24,c:.028,h:s});n["--v-surface"]=a(1,0),n["--v-surface-2"]=a(.981,.006),n["--v-surface-3"]=a(.955,.009),n["--v-surface-inset"]=a(.968,.008),n["--v-text"]=wn(f),n["--v-text-muted"]=a(.53,.023),n["--v-text-soft"]=a(.655,.018),n["--v-border"]=a(.906,.012),n["--v-border-strong"]=a(.828,.016),n["--v-overlay"]=fr(f,.45),n["--v-shadow-sm"]=`0 1px 2px ${fr(f,.08)}`,n["--v-shadow"]=`0 10px 30px ${fr(f,.14)}`,n["--v-shadow-lg"]=`0 24px 60px ${fr(f,.2)}`}return n["--v-focus-ring"]=n["--v-primary-ring"],o.surface=po((p=yt(n["--v-surface"]))!=null?p:hp),{vars:n,scales:r,contrast:o}}function jl(e,t){let n=Object.entries(t).map(([r,o])=>`  ${r}: ${o};`).join(`
`);return`${e} {
${n}
}`}var vo=null,mo=null;function hy(e){var r,o,i,s,a,l,c,d,u;let t=(r=ss[e.preset])!=null?r:ss.violeta,n={primary:(o=e.primary)!=null?o:t.primary,accent:(i=e.accent)!=null?i:t.accent,success:(s=e.success)!=null?s:t.success,warning:(a=e.warning)!=null?a:t.warning,danger:(l=e.danger)!=null?l:t.danger,info:(c=e.info)!=null?c:t.info,neutral:(d=e.neutral)!=null?d:t.neutral};for(let p of xp)yt(n[p])||(console.warn(`[Voodoo] invalid color in palette.${p}: "${n[p]}". Using preset.`),n[p]=t[p]);return{colors:n,radius:(u=e.radius)!=null?u:"12px",font:fp(e.font,fy),mono:fp(e.monoFont,py)}}function gy(e){if(typeof document=="undefined"||!x.injectStyles)return;ge();let t=document.getElementById(up);t||(t=document.createElement("style"),t.id=up,t.setAttribute("data-voodoo","palette"),document.head.appendChild(t)),t.textContent=e}function rs(e={}){let{colors:t,radius:n,font:r,mono:o}=hy(e),i=pp(t,!1),s=pp(t,!0),a={...vy(n),"--v-font-sans":r,"--v-font-mono":o},l=["/* Palette generated by V.palette(). Do not edit manually. */",jl(":root",{...a,...i.vars}),`@media (prefers-color-scheme: dark) {
${jl(':root:not([data-theme="light"])',s.vars)}
}`,jl(':root[data-theme="dark"]',s.vars)].join(`
`);gy(l);let c={colors:t,radius:n,font:r,monoFont:o,light:i.scales,dark:s.scales,contrast:i.contrast,css:l};if(vo=c,mo={...e},e.persist!==!1&&typeof document!="undefined"){let d={...e};delete d.persist,ue.set(Wl,d)}return typeof document!="undefined"&&document.dispatchEvent(new CustomEvent("voodoo:palette",{detail:c})),c}var mp=!1;function _l(){if(vo&&mp)return vo;mp=!0;let e=ue.get(Wl),t=e&&typeof e=="object"?{...e,persist:!1}:{persist:!1};return rs(t)}function ho(){vo||_l()}function wp(){return _l()}var Ep=Object.assign(rs,{presets:ss,get names(){return Object.keys(ss)},get current(){return vo},get options(){return mo},init:_l,ensure:ho,reset(){return ue.remove(Wl),rs({persist:!1})},use(e){return rs({...mo!=null?mo:{},preset:e,primary:void 0,accent:void 0})},scale:yp,contrastText:po,contrastRatio:Vl,luminance(e){let t=typeof e=="string"?yt(e):e;return t?ql(t):0},convert:{parseColor:yt,rgbToOklch:os,oklchToRgb:pr,toHex:wn,toRgba:fr}});function te(e){if(e===!0)return!0;if(e===!1||e===null||e===void 0)return!1;if(typeof e=="number")return e!==0;let t=String(e).trim().toLowerCase();return t===""||t==="true"||t==="1"||t==="yes"}function be(...e){let t={};for(let n of e){let r=`is${n.charAt(0).toUpperCase()}${n.slice(1)}`;t[r]=function(){return te(this[n])}}return t}var F={type:"any",default:!1},L={type:"string",default:""};function vr(e,t){var i;if(t==null||typeof t!="string")return t;let n=t.trim();if(!n)return null;if(n.startsWith("[")||n.startsWith("{"))try{return JSON.parse(n)}catch(s){return null}let r=n.split(/[.[(]/)[0].trim();if(!/^[A-Za-z_$][\w$]*$/.test(r))return null;let o=(i=e.$scope)==null?void 0:i.parent;return!o||!o.has(r)?null:q(n,o,"list attribute")}function bo(e){return String(e).split(",").map(t=>t.trim()).filter(Boolean)}function Qt(e,t){let n=e.$el;Object.defineProperty(n,"value",{configurable:!0,enumerable:!1,get:t.get,set:t.set})}function go(e){e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))}var Lp={check:'<path d="m5 12.5 4.4 4.4L19 7.6"/>',x:'<path d="M6 6l12 12M18 6 6 18"/>',plus:'<path d="M12 5v14M5 12h14"/>',minus:'<path d="M5 12h14"/>',search:'<circle cx="11" cy="11" r="6.5"/><path d="m16 16 4 4"/>',"chevron-down":'<path d="m6 9.5 6 6 6-6"/>',"chevron-up":'<path d="m6 14.5 6-6 6 6"/>',"chevron-left":'<path d="m14.5 6-6 6 6 6"/>',"chevron-right":'<path d="m9.5 6 6 6-6 6"/>',"arrow-up":'<path d="M12 19V5M6 11l6-6 6 6"/>',"arrow-down":'<path d="M12 5v14M6 13l6 6 6-6"/>',"arrow-right":'<path d="M5 12h14M13 6l6 6-6 6"/>',"arrow-left":'<path d="M19 12H5M11 6l-6 6 6 6"/>',user:'<circle cx="12" cy="8.5" r="3.6"/><path d="M4.8 20a7.4 7.4 0 0 1 14.4 0"/>',users:'<circle cx="9.5" cy="8.5" r="3.2"/><path d="M3.4 19.5a6.4 6.4 0 0 1 12.2 0M16 5.6a3.2 3.2 0 0 1 0 5.9M17.4 14.4a6.4 6.4 0 0 1 3.2 5.1"/>',mail:'<rect x="3" y="5" width="18" height="14" rx="2.5"/><path d="m3.8 7 8.2 6 8.2-6"/>',lock:'<rect x="4.5" y="10.5" width="15" height="9.5" rx="2.4"/><path d="M8 10.5V8a4 4 0 0 1 8 0v2.5"/>',eye:'<path d="M2.6 12S6.4 5.8 12 5.8 21.4 12 21.4 12 17.6 18.2 12 18.2 2.6 12 2.6 12Z"/><circle cx="12" cy="12" r="2.8"/>',"eye-off":'<path d="M4 4l16 16M9.9 6.2A9.3 9.3 0 0 1 12 6c5.6 0 9.4 6 9.4 6a17 17 0 0 1-3.3 3.9M6.3 8.2A17 17 0 0 0 2.6 12S6.4 18 12 18c1 0 1.9-.2 2.7-.5"/>',calendar:'<rect x="3.5" y="5" width="17" height="15" rx="2.4"/><path d="M8 3v4M16 3v4M3.5 10h17"/>',clock:'<circle cx="12" cy="12" r="8.6"/><path d="M12 7.4V12l3 1.8"/>',star:'<path d="m12 4 2.5 5.2 5.5.8-4 3.9 1 5.6-5-2.7-5 2.7 1-5.6-4-3.9 5.5-.8z"/>',info:'<circle cx="12" cy="12" r="8.6"/><path d="M12 11v5.2M12 7.6v.2"/>',alert:'<circle cx="12" cy="12" r="8.6"/><path d="M12 7.5v5M12 16.4v.2"/>',warning:'<path d="M12 4.4 2.8 19.6h18.4z"/><path d="M12 10v3.8M12 16.9v.2"/>',trash:'<path d="M4.5 7h15M9.5 7V5.2A1.2 1.2 0 0 1 10.7 4h2.6a1.2 1.2 0 0 1 1.2 1.2V7M6.6 7l.8 12a1.6 1.6 0 0 0 1.6 1.5h6a1.6 1.6 0 0 0 1.6-1.5l.8-12"/>',edit:'<path d="M4.5 19.5h4l10-10a2.1 2.1 0 0 0-3-3l-10 10z"/><path d="M14 6.5 17.5 10"/>',copy:'<rect x="8.5" y="8.5" width="11.5" height="11.5" rx="2.2"/><path d="M15.5 5.5A1.5 1.5 0 0 0 14 4H6a2 2 0 0 0-2 2v8a1.5 1.5 0 0 0 1.5 1.5"/>',download:'<path d="M12 4v11M7.5 11 12 15.5 16.5 11M4.5 19.5h15"/>',upload:'<path d="M12 20V8.5M7.5 12.5 12 8l4.5 4.5M4.5 4.5h15"/>',settings:'<circle cx="12" cy="12" r="3.1"/><path d="M19.6 14.4a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.03 1.56V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.56 1.7 1.7 0 0 0-1.87.34l-.06.06A2 2 0 1 1 4.15 16.9l.06-.06a1.7 1.7 0 0 0 .34-1.87A1.7 1.7 0 0 0 3 13.94H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.55-1.1 1.7 1.7 0 0 0-.34-1.87l-.06-.06A2 2 0 1 1 7.08 4.08l.06.06a1.7 1.7 0 0 0 1.87.34H9a1.7 1.7 0 0 0 1-1.56V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.56 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87V10a1.7 1.7 0 0 0 1.56 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.3 1z"/>',home:'<path d="M4 10.5 12 4l8 6.5V19a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 19z"/><path d="M9.6 20.5v-6h4.8v6"/>',heart:'<path d="M12 20s-7.5-4.6-7.5-9.4A4.1 4.1 0 0 1 12 8.2a4.1 4.1 0 0 1 7.5 2.4C19.5 15.4 12 20 12 20Z"/>',bell:'<path d="M18 9a6 6 0 1 0-12 0c0 5.2-2 6.5-2 6.5h16S18 14.2 18 9"/><path d="M13.7 19.5a2 2 0 0 1-3.4 0"/>',filter:'<path d="M4 5.5h16l-6.2 7.3v5.3l-3.6 2v-7.3z"/>',external:'<path d="M14 4.5h5.5V10M19 5l-8 8"/><path d="M18 13.5V18a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 18V7.5A1.5 1.5 0 0 1 6 6h4.5"/>',refresh:'<path d="M20 11a8 8 0 0 0-13.7-4.8L4 8.4"/><path d="M4 4.5v4h4M4 13a8 8 0 0 0 13.7 4.8L20 15.6"/><path d="M20 19.5v-4h-4"/>',folder:'<path d="M4 7.5A1.5 1.5 0 0 1 5.5 6h3.7l2 2.4h7.3A1.5 1.5 0 0 1 20 9.9v7.6a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5z"/>',file:'<path d="M13.5 4H7a1.5 1.5 0 0 0-1.5 1.5v13A1.5 1.5 0 0 0 7 20h10a1.5 1.5 0 0 0 1.5-1.5V9z"/><path d="M13.5 4v5h5"/>',image:'<rect x="4" y="5" width="16" height="14" rx="2.2"/><circle cx="9" cy="10" r="1.7"/><path d="m5 17 4.6-4.3 3.4 3 2.6-2.3L19 17"/>',link:'<path d="M10.6 13.4a3.6 3.6 0 0 0 5.1 0l2.4-2.4a3.6 3.6 0 0 0-5.1-5.1l-1.3 1.3"/><path d="M13.4 10.6a3.6 3.6 0 0 0-5.1 0l-2.4 2.4a3.6 3.6 0 0 0 5.1 5.1l1.3-1.3"/>',menu:'<path d="M4 7h16M4 12h16M4 17h16"/>',more:'<circle cx="6" cy="12" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="18" cy="12" r="1.4"/>',logout:'<path d="M14.5 8V6a1.5 1.5 0 0 0-1.5-1.5H6A1.5 1.5 0 0 0 4.5 6v12A1.5 1.5 0 0 0 6 19.5h7a1.5 1.5 0 0 0 1.5-1.5v-2"/><path d="M9.5 12h10.5M16.5 8.5 20 12l-3.5 3.5"/>',card:'<rect x="3" y="6" width="18" height="12" rx="2.4"/><path d="M3 10h18"/>',chart:'<path d="M4.5 19.5h15"/><path d="M7.5 19.5V11M12 19.5V5.5M16.5 19.5v-6"/>',box:'<path d="M20 8.6 12 4 4 8.6v6.8L12 20l8-4.6z"/><path d="m4 8.6 8 4.6 8-4.6M12 13.2V20"/>',inbox:'<path d="M4 13.5h4l1.4 2.4h5.2l1.4-2.4h4"/><path d="M4.6 13.5 7 5.6A1.5 1.5 0 0 1 8.5 4.5h7A1.5 1.5 0 0 1 17 5.6l2.4 7.9V18a1.5 1.5 0 0 1-1.5 1.5H6A1.5 1.5 0 0 1 4.5 18z"/>'};function by(e){let t=String(e!=null?e:"").trim();if(!t)return"";let n=Lp[t];return n?`<svg class="v-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${n}</svg>`:""}var yy=`
...
`,kp=!1;function xy(){kp||(kp=!0,ge(),ho(),oe("components",yy))}function ie(e,t){var r;let n=t.beforeMount;t.methods={svgIcon:o=>by(o),hasFlag:o=>te(o),...(r=t.methods)!=null?r:{}},t.beforeMount=function(){xy(),n==null||n.call(this)},zt(e,t)}ie("v-button",{props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},icon:L,iconRight:L,type:{type:"string",default:"button"},loading:F,disabled:F,block:F,rounded:F,ariaLabel:L},computed:{...be("loading","disabled","block","rounded"),blocked(){return te(this.disabled)||te(this.loading)}},template:`
  ...
  `});var Ey={info:"info",primary:"info",success:"check",warning:"warning",danger:"alert",neutral:"info"};ie("v-alert",{props:{tone:{type:"string",default:"info"},title:L,icon:L,closable:F,closeLabel:{type:"string",default:"Close alert"}},state(){return{visible:!0}},computed:{...be("closable"),resolvedIcon(){return this.icon==="none"?"":this.icon||Ey[this.tone]||"info"},liveRole(){return this.tone==="danger"?"alert":"status"}},methods:{dismiss(){this.visible=!1,this.emit("close")}},template:`
  ...
  `});function Ty(e){return Array.isArray(e)?e.map(t=>{var n,r,o,i,s,a;if(t!=null&&typeof t=="object"){let l=t;return{label:String((o=(r=(n=l.label)!=null?n:l.text)!=null?r:l.title)!=null?o:""),href:String((a=(s=(i=l.href)!=null?i:l.url)!=null?s:l.to)!=null?a:"")}}return{label:String(t),href:""}}):typeof e!="string"?[]:bo(e).map(t=>{let n=t.indexOf(":");return n===-1?{label:t,href:""}:{label:t.slice(0,n).trim(),href:t.slice(n+1).trim()}})}ie("v-breadcrumb",{inheritScope:!0,props:{items:{type:"any",default:""},separator:{type:"string",default:"/"},ariaLabel:{type:"string",default:"Breadcrumb"}},computed:{crumbs(){var e;return Ty((e=vr(this,this.items))!=null?e:this.items)}},methods:{isLast(e){return e===this.crumbs.length-1}},template:`
  ...
  `});async function My(e){try{if(typeof navigator!="undefined"&&navigator.clipboard)return await navigator.clipboard.writeText(e),!0}catch(t){}try{let t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();let n=document.execCommand("copy");return t.remove(),n}catch(t){return!1}}ie("v-code-block",{props:{code:L,language:L,filename:L,copyLabel:{type:"string",default:"Copy"},copiedLabel:{type:"string",default:"Copied"},wrap:F},state(){return{copied:!1}},computed:{...be("wrap"),header(){return this.filename||this.language||""},buttonLabel(){return this.copied?this.copiedLabel:this.copyLabel},buttonIcon(){return this.copied?"check":"copy"}},methods:{async copy(){let e=this.$refs.code,t=this.code||(e==null?void 0:e.textContent)||"";await My(String(t))&&(this.copied=!0,this.emit("copy",t),setTimeout(()=>{this.copied=!1},1800))}},template:`
  ...
  `});var pE=Object.keys(Lp);He();ce();var ct={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},Xl={duration:220,size:"md"},Sy=`
...
`;function ds(){ge(),ho(),oe("dialog",Sy)}var Gl={info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.6v.2"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m8.2 12.3 2.6 2.6 5-5.2"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4.6 2.9 19.4h18.2z"/><path d="M12 10v4M12 17.2v.2"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/></svg>',question:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M9.6 9.4a2.4 2.4 0 1 1 3.2 2.3c-.6.2-.8.7-.8 1.3v.5M12 16.6v.2"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg>'},tt=[],Ql=new WeakMap,Jl=0,Mp="",Sp="";function Ay(){if(Jl++>0)return;let e=document.body;Mp=e.style.overflow,Sp=e.style.paddingRight;let t=window.innerWidth-document.documentElement.clientWidth;if(e.style.overflow="hidden",t>0){let n=parseFloat(getComputedStyle(e).paddingRight)||0;e.style.paddingRight=`${n+t}px`}}function Cy(){Jl!==0&&(--Jl>0||(document.body.style.overflow=Mp,document.body.style.paddingRight=Sp))}var Ry='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function Zl(e){return Array.from(e.querySelectorAll(Ry)).filter(t=>t.hasAttribute("disabled")||t.getAttribute("aria-hidden")==="true"?!1:t.offsetWidth>0||t.offsetHeight>0||t.getClientRects().length>0)}function ec(){return tt[tt.length-1]}function $y(){return typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches}var cs=!1;function Ap(e){let t=ec();if(!t)return;if(e.key==="Escape"){if(t.options.closeOnEscape===!1)return;e.preventDefault(),t.handle.close(void 0);return}if(e.key!=="Tab")return;let n=Zl(t.handle.panel);if(!n.length){e.preventDefault(),t.handle.panel.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;e.shiftKey&&(i===r||!t.handle.panel.contains(i))?(e.preventDefault(),o.focus()):!e.shiftKey&&i===o&&(e.preventDefault(),r.focus())}function Cp(e){var o;let t=ec();if(!t)return;let n=e.target;if(n&&t.handle.root.contains(n))return;((o=Zl(t.handle.panel)[0])!=null?o:t.handle.panel).focus()}function Dy(){cs||(cs=!0,document.addEventListener("keydown",Ap,!0),document.addEventListener("focusin",Cp,!0))}function Py(){cs&&(cs=!1,document.removeEventListener("keydown",Ap,!0),document.removeEventListener("focusin",Cp,!0))}function Rp(e){var p,f,m,h,v,g,b;ds();let t=le("v-dialog-"),n=$y()?0:Xl.duration,r=document.createElement("div");r.className="v-dialog-root",r.id=t,r.setAttribute("data-size",(p=e.size)!=null?p:Xl.size),r.setAttribute("data-position",(f=e.position)!=null?f:"center"),r.style.setProperty("--v-dialog-ms",`${n}ms`),r.style.setProperty("--v-dialog-layer",String(tt.length*2));let o=document.createElement("div");o.className="v-dialog-backdrop",r.appendChild(o);let i=document.createElement("div");i.className="v-dialog-panel",e.plain&&i.classList.add("is-plain"),e.className&&i.classList.add(...e.className.split(/\s+/).filter(Boolean)),i.setAttribute("role",(m=e.role)!=null?m:"dialog"),i.setAttribute("aria-modal","true"),i.tabIndex=-1,e.labelledBy?i.setAttribute("aria-labelledby",e.labelledBy):e.ariaLabel&&i.setAttribute("aria-label",e.ariaLabel),e.describedBy&&i.setAttribute("aria-describedby",e.describedBy),r.appendChild(i);let s=document.createElement("div");if(s.className="v-dialog-body",e.source){let w=document.createComment(" v-modal ");(h=e.source.parentNode)==null||h.insertBefore(w,e.source),Kl.set(e.source,w),e.source.classList.add("v-dialog-open"),e.source.removeAttribute("hidden"),s.appendChild(e.source)}else e.content&&s.appendChild(e.content);if(i.appendChild(s),e.closable!==!1){let w=document.createElement("button");w.type="button",w.className="v-dialog-x",w.setAttribute("aria-label",ct.close),w.innerHTML=Gl.close,w.addEventListener("click",()=>d.close(void 0)),i.appendChild(w)}let a=!1,l=()=>{},c=new Promise(w=>{l=w}),d={id:t,root:r,panel:i,body:s,key:(v=e.key)!=null?v:null,source:(g=e.source)!=null?g:null,closed:c,close(w){if(a)return;a=!0;let T=tt.findIndex(A=>A.handle===d);T>-1&&tt.splice(T,1),Ql.delete(r),u.locked&&Cy(),tt.length||Py(),r.classList.remove("is-open"),r.classList.add("is-closing");let k=()=>{var D;let A=e.source;if(A){let C=Kl.get(A);A.classList.remove("v-dialog-open"),C&&C.parentNode?(C.parentNode.insertBefore(A,C),C.remove()):A.remove(),Kl.delete(A),Zs(A,"modal-content")&&A.setAttribute("hidden","")}if(r.remove(),(D=e.onClose)==null||D.call(e,w,d),l(w),e.restoreFocus!==!1){let C=u.previousFocus;C&&typeof C.focus=="function"&&C.isConnected&&C.focus()}};n>0?setTimeout(k,n):k()}},u={handle:d,options:e,previousFocus:document.activeElement,locked:e.lockScroll!==!1};return o.addEventListener("click",()=>{e.closeOnBackdrop!==!1&&d.close(void 0)}),u.locked&&Ay(),tt.push(u),Ql.set(r,u),Dy(),document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add("is-open");let w=Hy(e,i);w==null||w.focus()}),(b=e.onOpen)==null||b.call(e,d),d}var Kl=new WeakMap;function Hy(e,t){var i;let n=e.initialFocus;if(n instanceof HTMLElement)return n;if(typeof n=="string"){let s=t.querySelector(n);if(s)return s}let r=t.querySelector("[autofocus],[data-autofocus]");return r||((i=Zl(t)[0])!=null?i:t)}function Ny(e){if(e instanceof HTMLElement)return e;let t=String(e!=null?e:"").trim();if(!t)return null;let n=/^[\w-]+$/.test(t)?`#${t}`:t;return document.querySelector(n)}function as(e){return typeof e=="string"?e.trim()||null:e.id?`#${e.id}`:null}function ls(e){let t=/^[\w-]+$/.test(e)?`#${e}`:e;return tt.find(n=>{var o;if(n.handle.key===e||n.handle.key===t)return!0;let r=n.handle.source;return!!r&&((o=r.matches)==null?void 0:o.call(r,t))})}var En={open(e,t={}){var s,a;let n=Ny(e);if(!n)return console.warn(`[Voodoo] modal.open: target not found (${String(e)}).`),null;let r=(s=as(e))!=null?s:n.id?`#${n.id}`:null,o=r?ls(r):void 0;if(o)return o.handle;let i=n.querySelector("[data-dialog-title],h1,h2,h3");return i&&!i.id&&(i.id=le("v-dialog-title-")),Rp({...t,source:n,key:r,labelledBy:(a=i==null?void 0:i.id)!=null?a:null})},close(e,t){var o;if(e===void 0){(o=ec())==null||o.handle.close(t);return}let n=as(e),r=n?ls(n):void 0;r==null||r.handle.close(t)},closeAll(e){for(let t of[...tt].reverse())t.handle.close(e)},toggle(e,t={}){let n=as(e),r=n?ls(n):void 0;return r?(r.handle.close(void 0),null):this.open(e,t)},isOpen(e){if(e===void 0)return tt.length>0;let t=as(e);return!!(t&&ls(t))},get opened(){return tt.map(e=>e.handle)},get count(){return tt.length},configure(e){Object.assign(Xl,e)},labels(e){return Object.assign(ct,e),ct}};function hr(e){var a,l;ds();let t=document.createDocumentFragment(),n=e.title?le("v-dialog-title-"):null,r=e.description?le("v-dialog-desc-"):null,o=null;if(e.title||e.description||e.icon){o=document.createElement("div"),o.className="v-dialog-head";let c=e.icon&&e.icon!=="none"?e.icon:null;if(c&&Gl[c]){let u=document.createElement("div");u.className="v-dialog-icon",u.setAttribute("aria-hidden","true"),u.setAttribute("data-tone",(a=e.tone)!=null?a:Oy(c)),u.innerHTML=Gl[c],o.appendChild(u)}let d=document.createElement("div");if(d.className="v-dialog-heading",e.title){let u=document.createElement("h2");u.className="v-dialog-title",u.id=n,u.textContent=e.title,d.appendChild(u)}if(e.description){let u=document.createElement("p");u.className="v-dialog-desc",u.id=r,u.textContent=e.description,d.appendChild(u)}o.appendChild(d)}let i=document.createDocumentFragment();if(e.text)for(let c of e.text.split(`
`)){let d=document.createElement("p");d.textContent=c,i.appendChild(d)}if(e.html){let c=document.createElement("div");for(c.innerHTML=e.html;c.firstChild;)i.appendChild(c.firstChild)}e.node&&i.appendChild(e.node),t.appendChild(i);let s=(l=e.buttons)!=null?l:[{label:ct.ok,value:!0,variant:"primary",autofocus:!0}];return new Promise(c=>{var u;let d=Rp({...e,content:t,role:e.tone==="danger"?"alertdialog":"dialog",labelledBy:n,describedBy:r,key:null,onClose(p){var f;(f=e.onClose)==null||f.call(e,p,d),c(p===void 0?null:p)}});if(o&&d.panel.insertBefore(o,d.body),s.length){let p=document.createElement("div");p.className="v-dialog-foot";for(let f of s){let m=document.createElement("button");m.type="button",m.className="v-dlg-btn",m.setAttribute("data-variant",(u=f.variant)!=null?u:"secondary"),m.textContent=f.label,f.autofocus&&m.setAttribute("data-autofocus",""),m.addEventListener("click",()=>{var v,g;((v=f.onClick)==null?void 0:v.call(f,d))!==!1&&f.close!==!1&&d.close((g=f.value)!=null?g:null)}),p.appendChild(m)}d.panel.appendChild(p)}d.body.childNodes.length||d.body.remove()})}function Oy(e){return e==="success"||e==="warning"||e==="danger"?e:"default"}function tc(e,t={}){var n;return hr({icon:"info",size:"sm",...t,text:e,buttons:[{label:(n=t.confirmLabel)!=null?n:ct.ok,value:!0,variant:t.tone==="danger"?"danger":"primary",autofocus:!0}]}).then(()=>{})}function us(e,t={}){var r,o,i;let n=t.danger?"danger":(r=t.tone)!=null?r:"default";return hr({icon:n==="danger"?"warning":"question",size:"sm",...t,tone:n,text:e,buttons:[{label:(o=t.cancelLabel)!=null?o:ct.cancel,value:!1,variant:"secondary"},{label:(i=t.confirmLabel)!=null?i:ct.confirm,value:!0,variant:n==="danger"?"danger":"primary",autofocus:!0}]}).then(s=>s===!0)}function nc(e,t={}){var m,h,v,g;ds();let n=(m=t.type)!=null?m:"text",r=le("v-prompt-"),o=`${r}-hint`,i=`${r}-error`,s=document.createElement("div");s.className="v-dialog-field";let a=document.createElement("label");a.className="v-dialog-label",a.htmlFor=r,a.textContent=e,s.appendChild(a);let l=n==="textarea"?document.createElement("textarea"):document.createElement("input");if(l.className="v-dialog-input",l.id=r,l instanceof HTMLInputElement&&(l.type=n==="textarea"?"text":n),l.value=(h=t.value)!=null?h:"",t.placeholder&&(l.placeholder=t.placeholder),t.required&&(l.required=!0),l.setAttribute("data-autofocus",""),s.appendChild(l),t.hint){let b=document.createElement("p");b.className="v-dialog-hint",b.id=o,b.textContent=t.hint,s.appendChild(b),l.setAttribute("aria-describedby",o)}let c=document.createElement("p");c.className="v-dialog-error",c.id=i,c.hidden=!0,c.setAttribute("role","alert"),s.appendChild(c);let d=()=>n==="number"?l.value.trim():l.value,u=b=>{var k,A;let w=d(),T=null;return t.required&&!w.trim()?T=ct.required:T=(A=(k=t.validate)==null?void 0:k.call(t,w))!=null?A:null,T?(c.textContent=T,c.hidden=!1,l.setAttribute("aria-invalid","true"),l.setAttribute("aria-describedby",i),l.focus(),!1):(c.hidden=!0,l.removeAttribute("aria-invalid"),b.close(w),!0)},p=null;return l.addEventListener("keydown",b=>{let w=b;w.key==="Enter"&&(n==="textarea"&&!w.ctrlKey&&!w.metaKey||(b.preventDefault(),p&&u(p)))}),hr({icon:"question",size:"sm",...t,node:s,text:void 0,buttons:[{label:(v=t.cancelLabel)!=null?v:ct.cancel,value:null,variant:"secondary"},{label:(g=t.confirmLabel)!=null?g:ct.confirm,variant:"primary",close:!1,onClick(b){return p=b,u(b),!1}}],onOpen(b){var w;p=b,(w=t.onOpen)==null||w.call(t,b)}}).then(b=>typeof b=="string"?b:null)}y("modal",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim();e.setAttribute("aria-haspopup","dialog");let i=s=>{if(s.preventDefault(),n.close){En.close(o||void 0);return}if(n.toggle){o&&En.toggle(o);return}o&&En.open(o)};e.addEventListener("click",i),r(()=>e.removeEventListener("click",i))});y("modal-content",({el:e})=>{ds(),e.id||(e.id=le("v-modal-")),e.classList.contains("v-dialog-open")||e.setAttribute("hidden","")},{priority:j.REF});y("modal-close",({el:e,expression:t,cleanup:n})=>{let r=o=>{o.preventDefault();let i=e.closest(".v-dialog-root"),s=i?Ql.get(i):void 0;s?s.handle.close(t.trim()||void 0):En.close(void 0,t.trim()||void 0)};e.addEventListener("click",r),n(()=>e.removeEventListener("click",r))});var Yl=!1;y("confirm",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=t.trim()||ct.confirmQuestion,i=s=>{var u,p,f;if(Yl)return;s.preventDefault(),s.stopImmediatePropagation();let a=s.target instanceof HTMLElement?s.target:e,l=(u=Te(e,`${x.prefix}confirm-title`))!=null?u:void 0,c=(p=Te(e,`${x.prefix}confirm-label`))!=null?p:void 0,d=(f=Te(e,`${x.prefix}confirm-cancel`))!=null?f:void 0;us(o,{title:l,confirmLabel:c,cancelLabel:d,danger:!!n.danger,size:"sm"}).then(m=>{if(m){Yl=!0;try{a.click()}finally{Yl=!1}}})};e.addEventListener("click",i,!0),r(()=>e.removeEventListener("click",i,!0))},{priority:j.REF});N("$modal",()=>En);N("$dialog",()=>hr);N("$alert",()=>tc);N("$confirm",()=>us);N("$prompt",()=>nc);me();ce();var xo=new Map;function Le(e,t){xo.set(e.trim().toLowerCase(),t)}var Fy={9:/\d/,A:/[A-Za-zÀ-ÖØ-öø-ÿ]/,S:/[0-9A-Za-zÀ-ÖØ-öø-ÿ]/,"*":/[\s\S]/},Iy=/[0-9A-Za-zÀ-ÖØ-öø-ÿ]/,Pp=new Set(["currency","percent"]);function kn(e,t){let n="",r=0;for(let o=0;o<t.length;o++){let i=t[o];if(i==="\\"){let a=t[++o];if(a===void 0||r>=e.length)break;n+=a;continue}let s=Fy[i];if(s){for(;r<e.length&&!s.test(e[r]);)r++;if(r>=e.length)break;n+=e[r++];continue}if(r>=e.length)break;e[r]===i&&r++,n+=i}return n}function ps(e,t={}){var h,v,g,b,w;let n=Math.max(0,Math.trunc((h=t.decimals)!=null?h:2)),r=(v=t.decimal)!=null?v:",",o=(g=t.thousands)!=null?g:".",i=(b=t.prefix)!=null?b:"R$ ",s=(w=t.suffix)!=null?w:"",a=String(e!=null?e:""),l=a.trim().startsWith("-"),c=a.replace(/\D/g,"").slice(0,15);if(!c)return"";let d=c.padStart(n+1,"0"),u=n?d.slice(0,d.length-n):d,p=n?d.slice(d.length-n):"",m=u.replace(/^0+(?=\d)/,"").replace(/\B(?=(\d{3})+(?!\d))/g,o);return`${l?"-":""}${i}${m}${n?r+p:""}${s}`}function Hp(e,t=2){return ps(e,{prefix:"",suffix:"%",decimals:t})}Le("cpf","999.999.999-99");Le("cnpj","99.999.999/9999-99");Le("cep","99999-999");Le("date","99/99/9999");Le("time","99:99");Le("datetime","99/99/9999 99:99");Le("cvv","9999");Le("cpfcnpj",e=>{let t=e.replace(/\D/g,"");return kn(t,t.length<=11?"999.999.999-99":"99.999.999/9999-99")});Le("phone",e=>{let t=e.replace(/\D/g,"").slice(0,11);return kn(t,t.length<=10?"(99) 9999-9999":"(99) 99999-9999")});Le("currency",e=>ps(e));Le("percent",e=>Hp(e));Le("card",e=>{let t=e.replace(/\D/g,"").slice(0,19);return/^3[47]/.test(t)?kn(t,"9999 999999 99999"):t.length>16?kn(t,"9999 9999 9999 9999 999"):kn(t,"9999 9999 9999 9999")});Le("plate",e=>{let t=e.replace(/[^0-9A-Za-z]/g,"").toUpperCase().slice(0,7),n=t.length>=5&&/\d/.test(t[4]);return kn(t,n?"AAA-9999":"AAA9A99")});Le("hex",e=>{let t=e.replace(/[^0-9a-fA-F]/g,"").toUpperCase().slice(0,6);return t?`#${t}`:""});Le("ip",e=>{let t=e.replace(/[^\d.]/g,"").split(".").slice(0,4),n=[];for(let r of t){if(r===""){n.push("");continue}let o=Math.min(255,Number(r.slice(0,3)));n.push(String(o))}return n.join(".")});function yo(e,t){let n=e==null?"":String(e);if(!t)return n;let r=xo.get(t.trim().toLowerCase());return typeof r=="function"?r(n):kn(n,typeof r=="string"?r:t)}function ms(e,t){let n=e==null?"":String(e),r=t?t.trim().toLowerCase():"";if(r&&Pp.has(r)){let o=n.trim().startsWith("-"),i=n.replace(/\D/g,"").replace(/^0+(?=\d)/,"");if(!i)return"";let s=i.padStart(3,"0"),a=`${s.slice(0,s.length-2)}.${s.slice(s.length-2)}`;return o?`-${a}`:a}return n.replace(/[^0-9A-Za-zÀ-ÖØ-öø-ÿ]/g,"")}var Np=Object.assign((e,t)=>yo(e,t),{apply:yo,unmask:ms,register:Le,currency:ps,percent:Hp,presets:xo});function fs(e){return e!==void 0&&Iy.test(e)}function $p(e,t){let n=0,r=Math.min(t,e.length);for(let o=0;o<r;o++)fs(e[o])&&n++;return n}function Dp(e,t){if(t<=0)return 0;let n=0;for(let r=0;r<e.length;r++)if(fs(e[r])&&(n++,n===t))return r+1;return e.length}var rc=new WeakSet;function Op(e,t,n){var m;if(rc.has(e))return;rc.add(e);let r=Object.getPrototypeOf(e),o=(m=Object.getOwnPropertyDescriptor(r,"value"))!=null?m:Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,"value"),i=o==null?void 0:o.get,s=o==null?void 0:o.set,a=()=>{var h;return String(i?i.call(e):(h=e.getAttribute("value"))!=null?h:"")},l=h=>{s?s.call(e,h):e.setAttribute("value",h)},c=h=>{try{e.setSelectionRange(h,h)}catch(v){}};i&&s&&(Object.defineProperty(e,"value",{configurable:!0,enumerable:!0,get(){let h=String(i.call(e));return t.clean?t.clean(h):h},set(h){s.call(e,t.format(h==null?"":String(h)))}}),n(()=>{let h=a();Reflect.deleteProperty(e,"value"),l(h)}));let d=()=>{var w,T;let h=a(),v=(w=e.selectionStart)!=null?w:h.length,g=$p(h,v),b=t.format(h);b!==h&&l(b),t.rightToLeft?c(Math.max(0,b.length-((T=t.suffixLength)!=null?T:0))):c(Dp(b,g))},u=()=>d(),p=h=>{var A,D;if(h.key!=="Backspace")return;let v=(A=e.selectionStart)!=null?A:0,g=(D=e.selectionEnd)!=null?D:0;if(v!==g||v===0)return;let b=a();if(fs(b[v-1]))return;let w=v-1;for(;w>=0&&!fs(b[w]);)w--;if(h.preventDefault(),w<0)return;let T=b.slice(0,w)+b.slice(v),k=$p(T,w);l(t.format(T)),c(Dp(a(),k)),e.dispatchEvent(new Event("input",{bubbles:!0}))};e.addEventListener("input",u),e.addEventListener("keydown",p),n(()=>{rc.delete(e),e.removeEventListener("input",u),e.removeEventListener("keydown",p)});let f=a();f&&l(t.format(f))}function Fp(e,t){if(e.tagName!=="INPUT"&&e.tagName!=="TEXTAREA")return X(`${x.prefix}${t} only works on input or textarea.`),null;let n=e,r=(n.getAttribute("type")||"text").toLowerCase();return r==="number"||r==="range"||r==="date"||r==="color"?(X(`${x.prefix}${t} doesn't work with input type="${r}". Use type="text".`),null):n}y("mask",({el:e,expression:t,modifiers:n,cleanup:r})=>{let o=Fp(e,"mask");if(!o)return;let i=t.trim();if(!i){X(`${x.prefix}mask needs a pattern or mask name.`);return}let s=i.toLowerCase(),a=!!n.unmask||!!n.raw;Op(o,{format:l=>yo(l,i),clean:a?l=>ms(l,s):void 0,rightToLeft:Pp.has(s),suffixLength:s==="percent"?1:0},r)},{priority:j.MODEL+5});y("mask-currency",({el:e,expression:t,modifiers:n,cleanup:r})=>{var p,f,m,h;let o=Fp(e,"mask-currency");if(!o)return;let i=v=>{var g;return(g=e.getAttribute(`${x.prefix}${v}`))!=null?g:e.getAttribute(`data-v-${v}`)},s=(p=typeof n.decimals=="string"?n.decimals:null)!=null?p:i("mask-decimals"),a=s!==null&&s!==""?Number(s):2,l=t.trim()?t:"",c={prefix:n.plain?"":l||i("mask-prefix")||"R$ ",suffix:(f=i("mask-suffix"))!=null?f:"",decimals:Number.isFinite(a)?a:2,decimal:n.dot?".":",",thousands:n.dot?",":"."},d=!!n.unmask||!!n.raw,u=(m=c.decimals)!=null?m:2;Op(o,{format:v=>ps(v,c),clean:d?v=>{let g=v.replace(/\D/g,"").replace(/^0+(?=\d)/,"");if(!g)return"";if(u===0)return g;let b=g.padStart(u+1,"0"),w=`${b.slice(0,b.length-u)}.${b.slice(b.length-u)}`;return v.trim().startsWith("-")?`-${w}`:w}:void 0,rightToLeft:!0,suffixLength:((h=c.suffix)!=null?h:"").length},r)},{priority:j.MODEL+5});ce();He();var ko="v-xray-flash",qp=200,zy=400,Ye=!1,Ip=!1,W=null,nt="estado",Tn="auto",br=[],yr=[],Jt=new Map,gs=new Set,Eo=new Map,To=[],oc=new WeakMap,we={effects:0,mutations:0,effectsPerSecond:0,updatesPerSecond:0,history:[]},xt=[],vs=0,hs=0,xr=0,wr=0,wo=null,By=`
.v-xray-root{
  all: initial;
  --vx-accent:#6D3BF5;
  --vx-accent-2:#FF3D8B;
...
`;function M(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n!==void 0&&(r.textContent=n),r}function ys(e){if(!e||!W)return!1;let t=e.nodeType===1?e:e.parentElement;return!!t&&W.root.contains(t)}function Er(e){if(!e)return"(no element)";let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:"",r=typeof e.className=="string"&&e.className?`.${e.className.trim().split(/\s+/).slice(0,2).join(".")}`:"";return`${t}${n}${r}`}function Vp(e,t=64){var r;if(e===null)return"null";if(e===void 0)return"undefined";let n=typeof e;if(n==="function")return"function()";if(n==="string")return`"${Zo(e,t)}"`;if(n==="number"||n==="boolean"||n==="symbol")return String(e);if(typeof Element!="undefined"&&e instanceof Element)return`<${e.tagName.toLowerCase()}>`;try{return Zo((r=JSON.stringify(e))!=null?r:String(e),t)}catch(o){return String(e)}}function jy(e){var t;if(typeof e=="string")return e;try{return(t=JSON.stringify(e))!=null?t:""}catch(n){return String(e)}}function qy(e,t){if(typeof t=="string")return e;try{return JSON.parse(e)}catch(n){return e}}function Up(e){let t=new Date(e),n=r=>String(r).padStart(2,"0");return`${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`}function Wp(e,t){for(let n of e.effects)t.push(n);for(let n of e.children)Wp(n,t)}function sc(e){let t=[];for(let n of cd(e))Wp(n,t);return t}function _p(e){let t=sc(e).length;for(let n of Array.from(e.childNodes))n.nodeType===3&&(t+=sc(n).length);return t}function Kp(e){if(!e||!Ye||ys(e))return;let t=Eo.get(e);t&&window.clearTimeout(t),gs.add(e),e.classList.add(ko);let n=window.setTimeout(()=>{e.classList.remove(ko),Eo.delete(e),window.setTimeout(()=>gs.delete(e),0)},460);Eo.set(e,n)}function zp(e,t){for(let n of sc(e)){if(Jt.has(n))continue;let r=n.fn;Jt.set(n,r),n.fn=()=>(we.effects++,Kp(t),r())}}function Vy(){for(let[e,t]of Jt)e.fn=t;Jt.clear()}function Yp(){if(!Ye||typeof document=="undefined")return;for(let[n]of Jt)n.active||Jt.delete(n);let e=document.createTreeWalker(document.body,NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_TEXT),t=e.currentNode;for(;t;){if(t.nodeType===1){let n=t;if(W&&W.root.contains(n)){t=Uy(e);continue}zp(n,n)}else t.nodeType===3&&t.parentElement&&zp(t,t.parentElement);t=e.nextNode()}Ky()}function Uy(e){let t=e.currentNode,n=e.nextSibling();if(n)return n;let r=e.parentNode();for(;r;){if(n=e.nextSibling(),n)return n;r=e.parentNode()}return e.currentNode=t,null}function Wy(){let e=[],t=document.body.querySelectorAll("*");for(let n=0;n<t.length&&e.length<zy;n++){let r=t[n];W&&W.root.contains(r)||ta(r)&&e.push(r)}return e}function _y(e){return Dn(e).map(t=>t.arg?`${t.name}:${t.arg}`:t.name)}function Ky(){var t;if(!Ye||!W)return;let e=W.overlay;e.textContent="",To.length=0;for(let n of Wy()){let r=M("div","v-xray-box"),o=!!((t=ot(n))!=null&&t.component);r.dataset.kind=o?"component":"directive";let i=M("span","v-xray-tag",_y(n).join(" "));r.appendChild(i),e.appendChild(r),To.push({el:n,box:r})}cc()}function cc(){if(Ye)for(let e of To){if(!e.el.isConnected){e.box.style.display="none";continue}let t=e.el.getBoundingClientRect();if(t.width===0&&t.height===0){e.box.style.display="none";continue}e.box.style.display="block",e.box.style.left=`${t.left}px`,e.box.style.top=`${t.top}px`,e.box.style.width=`${t.width}px`,e.box.style.height=`${t.height}px`}}function Yy(){wr||(wr=requestAnimationFrame(()=>{wr=0,cc()}))}function Xy(e,t=40){let n=new Set,r=[],o=e;for(;o&&r.length<t;){let i=[];try{i=Object.keys(o.data)}catch(s){i=[]}for(let s of i){if(n.has(s))continue;n.add(s);let a;try{a=o.data[s]}catch(l){a="(read error)"}if(r.push([s,a]),r.length>=t)break}o=o.parent}return r}function Gy(e){var s;if(!W)return;let t=W.card;t.textContent="";let n=Ae(e),r=(s=n.owner)==null?void 0:s.component;t.appendChild(M("strong","v-xray-card-title",Er(e))),t.appendChild(M("span","v-xray-section","Directives"));let o=Dn(e);if(!o.length)t.appendChild(M("div","v-xray-val","none"));else for(let a of o){let l=M("div","v-xray-row");l.appendChild(M("span","v-xray-key",a.raw)),l.appendChild(M("span","v-xray-val",a.expression||"(no value)")),t.appendChild(l)}t.appendChild(M("span","v-xray-section","Component")),t.appendChild(M("div","v-xray-val",r?`${r.$name} in ${Er(r.$el)}`:"none")),t.appendChild(M("span","v-xray-section","Scope"));let i=Xy(n);if(!i.length)t.appendChild(M("div","v-xray-val","root scope empty"));else for(let[a,l]of i){let c=M("div","v-xray-row");c.appendChild(M("span","v-xray-key",a)),c.appendChild(M("span","v-xray-val",Vp(l))),t.appendChild(c)}t.appendChild(M("span","v-xray-section","Reactivity")),t.appendChild(M("div","v-xray-val",`${_p(e)} effect(s) depend on this element`))}function Qy(e,t){if(!W)return;let n=W.card,r=320,o=Math.min(n.scrollHeight||200,window.innerHeight*.6),i=e+16+r>window.innerWidth?Math.max(8,e-r-16):e+16,s=t+16+o>window.innerHeight?Math.max(8,t-o-16):t+16;n.style.left=`${i}px`,n.style.top=`${s}px`}function Bp(e){if(!Ye||!W)return;let t=e.target;if(!t||ys(t)){W.card.dataset.open="0",wo=null;return}let n=t;for(;n&&n!==document.body&&!ta(n);)n=n.parentElement;if(!n||n===document.body){W.card.dataset.open="0",wo=null;return}n!==wo&&(wo=n,Gy(n)),W.card.dataset.open="1",Qy(e.clientX,e.clientY)}function Jy(){let e=new Map,t=document.body.querySelectorAll("*");for(let r=0;r<t.length;r++){let o=t[r];if(W&&W.root.contains(o))continue;let i=ot(o);i&&e.set(o,i)}let n=[];for(let[r,o]of e){let i=0,s=r.parentElement;for(;s;)e.has(s)&&i++,s=s.parentElement;n.push({el:r,scope:o,depth:i})}return n}function bs(e,t,n){let r=M("div","v-xray-row");if(r.appendChild(M("span","v-xray-key",e)),typeof t=="function")return r.appendChild(M("span","v-xray-val","function()")),r;let o=M("input","v-xray-input");return o.type="text",o.value=jy(t),o.spellcheck=!1,o.addEventListener("change",()=>{try{n(qy(o.value,t)),o.dataset.error="0"}catch(i){o.dataset.error="1"}}),o.addEventListener("keydown",i=>{i.key==="Enter"&&o.blur()}),r.appendChild(o),r}function Zy(){let e=document.createDocumentFragment(),t=Jy();if(!t.length)return e.appendChild(M("span","v-xray-empty","No scopes on the page. Use v-data or a component.")),e;for(let n of t){let r=M("div","v-xray-group");r.style.marginLeft=`${Math.min(n.depth,4)*8}px`;let o=M("div","v-xray-group-head");o.appendChild(M("span","v-xray-badge",n.scope.component?"component":"scope")),o.appendChild(M("span",void 0,Er(n.el))),o.addEventListener("click",()=>Gp(n.el)),r.appendChild(o);let i=M("div","v-xray-rows"),s=[];try{s=Object.keys(n.scope.data)}catch(a){s=[]}if(!s.length)i.appendChild(M("span","v-xray-empty","no variables"));else for(let a of s){let l;try{l=n.scope.data[a]}catch(c){l=void 0}i.appendChild(bs(a,l,c=>{n.scope.set(a,c)}))}r.appendChild(i),e.appendChild(r)}return e}function ex(){var n;let e=document.createDocumentFragment(),t=[...Ct];if(!t.length)return e.appendChild(M("span","v-xray-empty","No components mounted.")),e;for(let r of t){let o=M("div","v-xray-group"),i=M("div","v-xray-group-head");i.appendChild(M("span","v-xray-badge",r.$name)),i.appendChild(M("span",void 0,Er(r.$el))),i.appendChild(M("span","v-xray-badge",`${_p(r.$el)} effects`)),i.lastChild.dataset.tone="mute",i.addEventListener("click",()=>Gp(r.$el)),o.appendChild(i);let s=M("div","v-xray-rows"),a=(n=r.$props)!=null?n:{},l=Object.keys(a);if(l.length){s.appendChild(M("span","v-xray-section","Props"));for(let u of l)s.appendChild(bs(u,a[u],p=>{a[u]=p}))}let c=r.$scope,d=[];try{d=Object.keys(c.data).filter(u=>!l.includes(u))}catch(u){d=[]}if(d.length){s.appendChild(M("span","v-xray-section","State"));for(let u of d){let p;try{p=c.data[u]}catch(f){p=void 0}s.appendChild(bs(u,p,f=>{c.set(u,f)}))}}o.appendChild(s),e.appendChild(o)}return e}function tx(){let e=document.createDocumentFragment(),t=Go();if(!t.length)return e.appendChild(M("span","v-xray-empty","No global stores. Create one with V.store().")),e;for(let n of t){let r=Fn[n],o=M("div","v-xray-group"),i=M("div","v-xray-group-head");i.appendChild(M("span","v-xray-badge","store")),i.firstChild.dataset.tone="alt",i.appendChild(M("span",void 0,n)),o.appendChild(i);let s=M("div","v-xray-rows"),a=r?Object.keys(r):[];if(!a.length)s.appendChild(M("span","v-xray-empty","empty store"));else for(let l of a)s.appendChild(bs(l,r[l],c=>{r[l]=c}));o.appendChild(s),e.appendChild(o)}return e}function Xp(e,t,n,r){let o=M("div","v-xray-log");if(o.appendChild(M("span","v-xray-log-time",e)),o.appendChild(M("span","v-xray-log-main",t)),n!==void 0){let i=M("span",r==="fail"?"v-xray-fail":r==="ok"?"v-xray-ok":void 0,n);o.appendChild(i)}return o}function nx(){let e=document.createDocumentFragment(),t=M("button","v-xray-btn","clear log");if(t.addEventListener("click",()=>{br.length=0,Zt()}),e.appendChild(t),!br.length)return e.appendChild(M("span","v-xray-empty","No events yet. Interact with the page.")),e;for(let n of[...br].reverse())e.appendChild(Xp(Up(n.at),`${n.type} on ${n.target}`,n.detail||n.source));return e}function rx(){let e=document.createDocumentFragment(),t=M("button","v-xray-btn","clear log");if(t.addEventListener("click",()=>{yr.length=0,Zt()}),e.appendChild(t),!yr.length)return e.appendChild(M("span","v-xray-empty","No requests yet. v-get, v-post and V.http show up here.")),e;for(let n of[...yr].reverse())e.appendChild(Xp(Up(n.at),`${n.method} ${n.url}`,`${n.status||"---"} ${Math.round(n.duration)}ms`,n.ok?"ok":"fail"));return e}function ox(){let e=document.createDocumentFragment(),t=M("div","v-xray-metric");t.appendChild(M("span","v-xray-metric-value",String(we.updatesPerSecond))),t.appendChild(M("span",void 0,"DOM updates per second")),e.appendChild(t);let n=M("div","v-xray-metric");n.appendChild(M("span","v-xray-metric-value",String(we.effectsPerSecond))),n.appendChild(M("span",void 0,"reactive effects triggered per second")),e.appendChild(n);let r=M("div","v-xray-metric");r.appendChild(M("span","v-xray-metric-value",String(we.effects))),r.appendChild(M("span",void 0,"effects triggered since x-ray was enabled")),e.appendChild(r);let o=M("div","v-xray-chart"),i=Math.max(1,...we.history.map(s=>Math.max(s.effects,s.updates)));for(let s of we.history){let a=M("div","v-xray-bar"),l=Math.max(s.effects,s.updates);a.style.height=`${Math.max(2,Math.round(l/i*46))}px`,a.title=`${s.effects} effects, ${s.updates} updates`,o.appendChild(a)}return e.appendChild(o),e.appendChild(M("span","v-xray-hint",`${Jt.size} effects instrumented, peak of ${i} per second`)),e}var ix=[{id:"estado",label:"Estado"},{id:"componentes",label:"Componentes"},{id:"stores",label:"Stores"},{id:"eventos",label:"Eventos"},{id:"rede",label:"Rede"},{id:"desempenho",label:"Desempenho"}];function Zt(){if(!W)return;let e=document.activeElement;if(!(e instanceof HTMLInputElement&&W.body.contains(e))){switch(W.body.textContent="",nt){case"estado":W.body.appendChild(Zy());break;case"componentes":W.body.appendChild(ex());break;case"stores":W.body.appendChild(tx());break;case"eventos":W.body.appendChild(nx());break;case"rede":W.body.appendChild(rx());break;case"desempenho":W.body.appendChild(ox());break}for(let t of Array.from(W.tabs.children)){let n=t;n.dataset.active=n.dataset.id===nt?"1":"0"}W.status.textContent=`${To.length} elements with directives, ${Ct.size} components, ${Jt.size} effects observed`}}function Gp(e){e.scrollIntoView({behavior:"smooth",block:"center"}),Kp(e)}function sx(){let e=M("div","v-xray-root");e.setAttribute(`${x.prefix}ignore`,""),e.setAttribute("role","complementary"),e.setAttribute("aria-label","Voodoo x-ray inspector"),Tn!=="auto"&&(e.dataset.vXrayTheme=Tn);let t=M("div","v-xray-overlay");e.appendChild(t);let n=M("div","v-xray-card");n.dataset.open="0",e.appendChild(n);let r=M("div","v-xray-panel"),o=M("div","v-xray-header"),i=M("div","v-xray-brand");i.appendChild(M("span","v-xray-dot")),i.appendChild(document.createTextNode("Voodoo x-ray")),o.appendChild(i);let s=M("button","v-xray-btn","theme");s.addEventListener("click",()=>{Tn=Tn==="auto"?"dark":Tn==="dark"?"light":"auto",Tn==="auto"?delete e.dataset.vXrayTheme:e.dataset.vXrayTheme=Tn}),o.appendChild(s);let a=M("button","v-xray-btn","close");a.addEventListener("click",()=>Qp()),o.appendChild(a),r.appendChild(o);let l=M("div","v-xray-tabs");for(let u of ix){let p=M("button","v-xray-tab",u.label);p.dataset.id=u.id,p.dataset.active=u.id===nt?"1":"0",p.addEventListener("click",()=>{nt=u.id,Zt()}),l.appendChild(p)}r.appendChild(l);let c=M("div","v-xray-body");r.appendChild(c);let d=M("div","v-xray-status","starting");return r.appendChild(d),e.appendChild(r),document.body.appendChild(e),{root:e,overlay:t,card:n,panel:r,tabs:l,body:c,status:d}}var ax=["click","dblclick","submit","input","change","keydown","keyup","focus","blur","contextmenu","drop","paste"];function jp(e){br.push(e),br.length>qp&&br.shift(),nt==="eventos"&&Zt()}function ic(e){yr.push(e),yr.length>qp&&yr.shift(),nt==="rede"&&Zt()}function lx(e,t){let n=e;for(let r=0;n&&r<6;r++){for(let o of Dn(n))if(o.name===t||o.name==="on"&&o.arg===t)return n;n=n.parentElement}return null}function cx(){let e=new Set(ax),t=document.body.querySelectorAll("*");for(let n=0;n<t.length;n++){let r=t[n];if(!(W&&W.root.contains(r)))for(let o of Dn(r))o.name==="on"&&o.arg&&e.add(o.arg)}return[...e]}function dx(){let e=t=>{if(!Ye)return;let n=t.target;if(!n||n.nodeType!==1||ys(n))return;let r=lx(n,t.type),o=t.__voodoo===!0;!r&&!o||jp({at:Date.now(),type:t.type,target:Er(r!=null?r:n),detail:o?"component emit":"",source:o?"component":"v-on"})};for(let t of cx())document.addEventListener(t,e,!0),xt.push(()=>document.removeEventListener(t,e,!0));xt.push(ze.on("event",t=>{var n,r;jp({at:Date.now(),type:t.type,target:Er((n=t.el)!=null?n:null),detail:Vp(t.detail),source:(r=t.source)!=null?r:"bus"})}))}function ux(){xt.push(he.interceptors.request.use(e=>(oc.set(e,performance.now()),e))),xt.push(he.interceptors.response.use(e=>{var n,r;let t=(n=oc.get(e.config))!=null?n:performance.now();return ic({at:Date.now(),method:((r=e.config.method)!=null?r:"GET").toUpperCase(),url:e.config.url,status:e.status,ok:e.ok,duration:performance.now()-t,source:"http"}),e})),xt.push(he.interceptors.error.use(e=>{var r,o,i;let t=e.config,n=t&&(r=oc.get(t))!=null?r:performance.now();return ic({at:Date.now(),method:((o=t==null?void 0:t.method)!=null?o:"GET").toUpperCase(),url:(i=t==null?void 0:t.url)!=null?i:"(unknown)",status:e.status,ok:!1,duration:performance.now()-n,source:"http"}),e})),xt.push(ze.on("network",e=>{var t,n,r,o,i;ic({at:Date.now(),method:((t=e.method)!=null?t:"GET").toUpperCase(),url:e.url,status:(n=e.status)!=null?n:0,ok:(r=e.ok)!=null?r:!e.error,duration:(o=e.duration)!=null?o:0,source:(i=e.source)!=null?i:"bus"})}))}var gr=null;function fx(){gr=new MutationObserver(e=>{let t=!1;for(let n of e){let r=n.target;ys(r)||n.type==="attributes"&&n.attributeName==="class"&&r.nodeType===1&&gs.has(r)||(we.mutations++,n.type==="childList"&&n.addedNodes.length&&(t=!0))}t&&!xr&&(xr=window.setTimeout(()=>{xr=0,Yp()},250))}),gr.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0})}function px(){hs=window.setInterval(()=>{we.effectsPerSecond=we.effects-ac,we.updatesPerSecond=we.mutations-lc,ac=we.effects,lc=we.mutations,we.history.push({effects:we.effectsPerSecond,updates:we.updatesPerSecond}),we.history.length>40&&we.history.shift(),nt==="desempenho"&&Zt()},1e3),vs=window.setInterval(()=>{cc(),(nt==="estado"||nt==="componentes"||nt==="stores")&&Zt()},700)}var ac=0,lc=0;function mx(){if(Ye||typeof document=="undefined"||!document.body)return;Ye=!0,ge(),oe("xray",By),W=sx(),nt=nt||"estado",we.effects=0,we.mutations=0,ac=0,lc=0,we.history.length=0,Yp(),dx(),ux(),fx(),px();let e=()=>Yy();window.addEventListener("scroll",e,!0),window.addEventListener("resize",e),document.addEventListener("mousemove",Bp,!0),xt.push(()=>window.removeEventListener("scroll",e,!0)),xt.push(()=>window.removeEventListener("resize",e)),xt.push(()=>document.removeEventListener("mousemove",Bp,!0)),Zt()}function Qp(){if(Ye){Ye=!1;for(let e of xt.splice(0))try{e()}catch(t){}gr==null||gr.disconnect(),gr=null,hs&&window.clearInterval(hs),vs&&window.clearInterval(vs),xr&&window.clearTimeout(xr),wr&&cancelAnimationFrame(wr),hs=vs=xr=wr=0;for(let[e,t]of Eo)window.clearTimeout(t),e.classList.remove(ko);Eo.clear(),gs.clear(),Vy(),To.length=0,wo=null,W==null||W.root.remove(),W=null}}function Jp(){return Ye}function vx(e){let t=e.toLowerCase().split("+").map(o=>o.trim()).filter(Boolean);if(!t.length)return null;let n=t.pop(),r={ctrl:!1,alt:!1,shift:!1,meta:!1,code:/^f\d{1,2}$/.test(n)?n.toUpperCase():n.length===1&&n>="a"&&n<="z"?`Key${n.toUpperCase()}`:n.length===1&&n>="0"&&n<="9"?`Digit${n}`:n.charAt(0).toUpperCase()+n.slice(1)};for(let o of t)if(o==="ctrl"||o==="control")r.ctrl=!0;else if(o==="alt"||o==="option")r.alt=!0;else if(o==="shift")r.shift=!0;else if(o==="meta"||o==="cmd"||o==="command"||o==="win")r.meta=!0;else return null;return r}function dc(){Ip||typeof document=="undefined"||(Ip=!0,document.addEventListener("keydown",e=>{let t=x.xrayShortcut;if(t===!1)return;let n=vx(typeof t=="string"?t:"ctrl+shift+f2");n&&(e.ctrlKey!==n.ctrl||e.altKey!==n.alt||e.shiftKey!==n.shift||e.metaKey!==n.meta||e.code!==n.code&&e.key.toUpperCase()!==n.code.replace(/^Key/,"")||(e.preventDefault(),Lo()))}))}function Lo(e){return dc(),(e!=null?e:!Ye)?mx():Qp(),Ye}me();ce();var hx=new Set(["SCRIPT","STYLE","PRE","CODE","SAMP","KBD","TEXTAREA","TEMPLATE","NOSCRIPT"]);N("$__jsx",e=>e);bd(e=>xs(e),()=>Mo());var Zp=Symbol("voodoo.jsx.template");function gx(e){return typeof e=="object"&&e!==null&&Zp in e}function bx(e,t){var p;let n=[],r=[],o="",i=0,s=null,a=!1,l=e,c=t,d=!1,u=null;for(;l;){if(l.nodeType===Node.TEXT_NODE){let f=(p=l.textContent)!=null?p:"";for(;c<f.length;c++){let m=f[c];if(a){a=!1,o+=m;continue}if(s){m==="\\"?a=!0:m===s&&(s=null),o+=m;continue}if(m==='"'||m==="'"||m==="`"){s=m,o+=m;continue}if(m==="{"){i++,i>1&&(o+=m);continue}if(m==="}"){if(i--,i===0){c++,d=!0;break}o+=m;continue}o+=m}if(r.push(l),d){u={node:l,offset:c};break}}else if(l.nodeType===Node.ELEMENT_NODE){if(i===0)return null;o+=`$t(${n.length}, $__jsx)`,n.push(l),r.push(l)}else r.push(l);c=0,l=l.nextSibling}return d?{source:o,templates:n,nodes:r,tail:u}:null}function em(e,t,n,r){var o;if(!(e==null||e===!1||e===!0)){if(Array.isArray(e)){for(let i of e)em(i,t,n,r);return}if(gx(e)){let i=e,a=t[i.index].cloneNode(!0),l=(o=i.scope)!=null?o:n;fc(a,l),Mo(),ee(a,l),r.push(a);return}r.push(document.createTextNode(String(e)))}}function fc(e,t){var o,i,s;if(hx.has(e.tagName))return;let n=t!=null?t:Ae(e),r=e.firstChild;for(;r;){let a=r.nextSibling;if(r.nodeType===Node.ELEMENT_NODE){fc(r,(o=ot(r))!=null?o:n),r=a;continue}if(r.nodeType!==Node.TEXT_NODE){r=a;continue}let c=((i=r.textContent)!=null?i:"").indexOf("{");if(c<0){r=a;continue}let d=bx(r,c);if(!d||d.templates.length===0){r=a;continue}yx(e,d,n),r=(s=d.nodes[d.nodes.length-1])==null?void 0:s.nextSibling}}var uc=[];function yx(e,t,n){var u;let{source:r,templates:o,nodes:i,tail:s}=t,a;try{a=We(r)}catch(p){x.devtools&&console.warn(`[Voodoo] could not parse the inline expression: ${r}`,p);return}s&&s.offset<((u=s.node.textContent)!=null?u:"").length&&s.node.splitText(s.offset);let l=document.createComment("v-jsx");e.insertBefore(l,i[0]);for(let p of i)p.remove();let c=[];uc.push(()=>d());function d(){let p=Ae(l),m=(p===_e&&n?n:p).child({$t:(v,g)=>({[Zp]:!0,index:v,scope:g})}),h=Fe(()=>{let v=Fo(H(a,m)),g=[];em(v,o,m,g);for(let b of c)b.remove();c=g;for(let b of g)e.insertBefore(b,l)});Xe(l,()=>{h.effect.stop();for(let v of c)v.remove()})}}function xx(e=document.body){var t;for(let n of Array.from(e.childNodes)){if(n.nodeType!==Node.TEXT_NODE)continue;let r=((t=n.textContent)!=null?t:"").trim();if(!r.startsWith("{")||!r.endsWith("}")||!/\b(const|let|var)\s/.test(r))continue;let o=r.slice(1,-1).replace(/\b(?:const|let|var)\s+/g,""),i=Y({});try{H(We(o),new Lt(i))}catch(s){return x.devtools&&console.warn("[Voodoo] could not read the declaration block",s),null}return n.remove(),i}return null}function Mo(){let e=uc.splice(0,uc.length);for(let t of e)try{t()}catch(n){console.error("[Voodoo] a JSX region failed to render",n)}}function xs(e=document.body){let t=xx(e);t&&Object.assign(_e.data,t),fc(e,Ae(e))}function tm(e=document.body){xs(e),Mo()}He();var rm="voodoo:devtools:widget-position",pc="voodoo:devtools:widget-hidden",wx=4,ne=null,kr=!1,mc=0,ws=0,So=[],Ex=`
.v-devtools-widget{
  all: initial;
  --vw-accent:#6D3BF5;
  --vw-accent-2:#FF3D8B;
