...
`});var Px={};Ao(Px,{default:()=>Dx});me();var re=class extends Error{constructor(n,r,o){let i=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${i}`);P(this,"source",r);P(this,"position",o);this.name="VoodooSyntaxError"}},Cm=[">>>=","===","!==","**=","...",">>>","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","&=","|=","^=","<<",">>","+","-","*","/","%","!","<",">","=","&","|","^","~","(",")","[","]","{","}",",",".","?",":",";"],Am=/[A-Za-z_$À-￿]/,Rm=/[A-Za-z0-9_$À-￿]/;function $m(e){return Am.test(e)}function Dm(e){return Rm.test(e)}function No(e){return e>="0"&&e<="9"}var Fc={n:`
...
`,Ep=!1;function yy(){Ep||(Ep=!0,ge(),ho(),oe("components",by))}function ie(e,t){var r;let n=t.beforeMount;t.methods={svgIcon:o=>gy(o),hasFlag:o=>te(o),...(r=t.methods)!=null?r:{}},t.beforeMount=function(){yy(),n==null||n.call(this)},zt(e,t)}ie("v-button",{props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},icon:L,iconRight:L,type:{type:"string",default:"button"},loading:F,disabled:F,block:F,rounded:F,ariaLabel:L},computed:{...be("loading","disabled","block","rounded"),blocked(){return te(this.disabled)||te(this.loading)}},template:`
  ...
  `});var wy={info:"info",primary:"info",success:"check",warning:"warning",danger:"alert",neutral:"info"};ie("v-alert",{props:{tone:{type:"string",default:"info"},title:L,icon:L,closable:F,closeLabel:{type:"string",default:"Close alert"}},state(){return{visible:!0}},computed:{...be("closable"),resolvedIcon(){return this.icon==="none"?"":this.icon||wy[this.tone]||"info"},liveRole(){return this.tone==="danger"?"alert":"status"}},methods:{dismiss(){this.visible=!1,this.emit("close")}},template:`
  ...
  `});function ky(e){return Array.isArray(e)?e.map(t=>{var n,r,o,i,s,a;if(t!=null&&typeof t=="object"){let l=t;return{label:String((o=(r=(n=l.label)!=null?n:l.text)!=null?r:l.title)!=null?o:""),href:String((a=(s=(i=l.href)!=null?i:l.url)!=null?s:l.to)!=null?a:"")}}return{label:String(t),href:""}}):typeof e!="string"?[]:bo(e).map(t=>{let n=t.indexOf(":");return n===-1?{label:t,href:""}:{label:t.slice(0,n).trim(),href:t.slice(n+1).trim()}})}ie("v-breadcrumb",{inheritScope:!0,props:{items:{type:"any",default:""},separator:{type:"string",default:"/"},ariaLabel:{type:"string",default:"Breadcrumb"}},computed:{crumbs(){var e;return ky((e=vr(this,this.items))!=null?e:this.items)}},methods:{isLast(e){return e===this.crumbs.length-1}},template:`
  ...
  `});async function Ly(e){try{if(typeof navigator!="undefined"&&navigator.clipboard)return await navigator.clipboard.writeText(e),!0}catch(t){}try{let t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();let n=document.execCommand("copy");return t.remove(),n}catch(t){return!1}}ie("v-code-block",{props:{code:L,language:L,filename:L,copyLabel:{type:"string",default:"Copy"},copiedLabel:{type:"string",default:"Copied"},wrap:F},state(){return{copied:!1}},computed:{...be("wrap"),header(){return this.filename||this.language||""},buttonLabel(){return this.copied?this.copiedLabel:this.copyLabel},buttonIcon(){return this.copied?"check":"copy"}},methods:{async copy(){let e=this.$refs.code,t=this.code||(e==null?void 0:e.textContent)||"";await Ly(String(t))&&(this.copied=!0,this.emit("copy",t),setTimeout(()=>{this.copied=!1},1800))}},template:`
  ...
  `});var fE=Object.keys(Tp);He();ce();var ct={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},Xl={duration:220,size:"md"},My=`
...
`,Ex=`<svg class="v-devtools-mark" viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
</svg>`;function kx(){try{let e=localStorage.getItem(nm);if(!e)return null;let t=JSON.parse(e);return typeof(t==null?void 0:t.x)!="number"||typeof(t==null?void 0:t.y)!="number"?null:t}catch(e){return null}}function Tx(e){try{localStorage.setItem(nm,JSON.stringify(e))}catch(t){}}function vc(e,t){let n=e.offsetWidth||120,r=e.offsetHeight||38,o=Math.min(Math.max(8,t.x),Math.max(8,window.innerWidth-n-8)),i=Math.min(Math.max(8,t.y),Math.max(8,window.innerHeight-r-8));e.style.left=`${o}px`,e.style.top=`${i}px`,e.style.right="auto",e.style.bottom="auto"}function Lx(){let e=document.createElement("div");e.className="v-devtools-widget",e.setAttribute("data-voodoo-devtools","widget");let t=document.createElement("button");t.type="button",t.className="v-devtools-btn",t.setAttribute("aria-label","Open Voodoo devtools (Ctrl+Shift+F2)"),t.setAttribute("aria-pressed","false"),t.title="Voodoo devtools \u2014 click to inspect, drag to move (Ctrl+Shift+F2)",t.innerHTML=Ex;let n=document.createElement("span");n.className="v-devtools-label",n.textContent="Voodoo";let r=document.createElement("span");r.className="v-devtools-count",r.textContent="0";let o=document.createElement("span");o.className="v-devtools-pulse",o.setAttribute("data-on","false"),t.append(n,r,o);let i=document.createElement("button");i.type="button",i.className="v-devtools-close",i.setAttribute("aria-label","Hide the devtools widget in this tab"),i.title="Hide in this tab",i.textContent="\xD7",e.append(t,i),document.body.appendChild(e);let s=kx();return s?vc(e,s):(e.style.right="16px",e.style.bottom="16px"),{root:e,button:t,pulse:o,counter:r,close:i}}function Mx(e,t){let n=!1,r=!1,o=0,i=0,s=0,a=0,l=f=>{var h,v;if(f.button!==0)return;let m=e.root.getBoundingClientRect();n=!0,r=!1,s=f.clientX,a=f.clientY,o=f.clientX-m.left,i=f.clientY-m.top,(v=(h=e.button).setPointerCapture)==null||v.call(h,f.pointerId)},c=f=>{if(!n)return;let m=Math.hypot(f.clientX-s,f.clientY-a);!r&&m<xx||(r=!0,f.preventDefault(),vc(e.root,{x:f.clientX-o,y:f.clientY-i}))},d=f=>{var h,v;if(!n)return;if(n=!1,(v=(h=e.button).releasePointerCapture)==null||v.call(h,f.pointerId),!r){t();return}let m=e.root.getBoundingClientRect();Tx({x:m.left,y:m.top})},u=f=>{f.key!=="Enter"&&f.key!==" "||(f.preventDefault(),t())},p=()=>{let f=e.root.getBoundingClientRect();e.root.style.left&&vc(e.root,{x:f.left,y:f.top})};return e.button.addEventListener("pointerdown",l),e.button.addEventListener("pointermove",c),e.button.addEventListener("pointerup",d),e.button.addEventListener("pointercancel",d),e.button.addEventListener("keydown",u),window.addEventListener("resize",p),()=>{e.button.removeEventListener("pointerdown",l),e.button.removeEventListener("pointermove",c),e.button.removeEventListener("pointerup",d),e.button.removeEventListener("pointercancel",d),e.button.removeEventListener("keydown",u),window.removeEventListener("resize",p)}}function Sx(){ne&&(ne.pulse.setAttribute("data-on","true"),window.clearTimeout(ws),ws=window.setTimeout(()=>{ne==null||ne.pulse.setAttribute("data-on","false")},320))}function tm(){if(!ne)return;let e=At.size,t=e===1?"1 component":`${e} components`;ne.counter.textContent!==t&&(ne.counter.textContent=t)}function Cx(){if(kr||typeof document=="undefined"||!document.body)return;try{if(sessionStorage.getItem(pc)==="1")return}catch(r){}kr=!0,oe("devtools-widget",wx),ne=Lx();let e=()=>{let r=Lo();ne==null||ne.root.setAttribute("data-active",String(r)),ne==null||ne.button.setAttribute("aria-pressed",String(r))};So.push(Mx(ne,e));let t=r=>{r.stopPropagation();try{sessionStorage.setItem(pc,"1")}catch(o){}rm(),console.info("[Voodoo] devtools widget hidden. Use V.devtoolsWidget(true) to bring back.")};ne.close.addEventListener("click",t),So.push(()=>ne==null?void 0:ne.close.removeEventListener("click",t));let n=()=>{let r=Qp();ne==null||ne.root.setAttribute("data-active",String(r)),ne==null||ne.button.setAttribute("aria-pressed",String(r))};document.addEventListener("keyup",n),So.push(()=>document.removeEventListener("keyup",n));for(let r of["network","event","navigation","update"])So.push(ze.on(r,Sx));tm(),mc=window.setInterval(tm,1e3)}function rm(){if(kr){kr=!1;for(let e of So.splice(0))try{e()}catch(t){}window.clearInterval(mc),window.clearTimeout(ws),mc=0,ws=0,ne==null||ne.root.remove(),ne=null}}function om(e){if(e!=null?e:!kr){try{sessionStorage.removeItem(pc)}catch(n){}Cx()}else rm();return kr}var sm=((e,t)=>Sa(e,t));function im(e,t,n){return((...r)=>($r(e,t),n(...r)))}Object.assign(sm,ui,{query:Sa,ready:Ca,fromHtml:Tu,jsx:em,extractJsx:xs,activateJsx:Mo,Collection:pt,router:Wr,route:de,navigate:_t,resolveRoute:Gn,i18n:Yr,t:er,setLocale:Kr,getLocale:ki,modal:En,alert:tc,confirm:us,prompt:nc,dialog:hr,validator:J,validate:cl,validateForm:im("V.validateForm","V.validate",cl),serializeForm:or,messages:at,showFormErrors:Ii,showFieldError:Fi,clearErrors:ro,mask:Hp,masks:xo,applyMask:yo,unmask:ms,registerMask:Le,animate:Pt,spring:Rl,stagger:$l,inView:es,scrollProgress:Dl,motion:hn,easings:lo,chart:im("V.chart","V.renderChart",ur),renderChart:ur,charts:Il,chartColors:uo,palette:wp,hotkey:Jr,sound:Gt,xray:Lo,enableXrayShortcut:dc,devtoolsWidget:om,devtools:ze,magic:N});var hc=sm;ce();function Ax(e){if(window.VOODOO_DEVTOOLS===!0)return!0;for(let t of["devtools","data-devtools"]){if(!e.hasAttribute(t))continue;let n=e.getAttribute(t);return n===null||n===""||n.toLowerCase()!=="false"}return!1}function Rx(){var s;if(typeof document=="undefined")return{manual:!1};let e=(s=document.currentScript)!=null?s:document.querySelector('script[src*="voodoo"]');if(!e)return{manual:!1};let t=e.hasAttribute("data-manual")||e.hasAttribute("data-defer-init"),n=e.getAttribute("data-prefix");n&&(x.prefix=n);let r=e.getAttribute("data-base-url");r&&(x.baseURL=r);let o=e.getAttribute("data-locale");o&&(x.locale=o),Ax(e)&&(x.devtools=!0);let i=e.getAttribute("data-xray-shortcut");return i!==null&&(x.xrayShortcut=i==="false"||i===""?!1:i),e.hasAttribute("data-no-styles")&&(x.injectStyles=!1),e.hasAttribute("data-no-observer")&&(x.autoDiscover=!1),e.hasAttribute("data-keep-attributes")&&(x.cleanAttributes=!1),{manual:t}}function $x(e){if(typeof e.devtoolsWidget=="function"){e.devtoolsWidget(!0);return}console.info("[Voodoo] devtools requested, but this build does not include the inspector. Use voodoo.full.min.js to get the widget and full devtools panel.")}function am(e){var o;if(typeof window=="undefined")return;let t=Rx(),n=window;if(n.V=e,n.Voodoo=e,Ne.V=e,Ne.Voodoo=e,x.baseURL&&((o=e.http)!=null&&o.setBaseURL)&&e.http.setBaseURL(x.baseURL),t.manual||!x.autoStart)return;Ko(()=>{ft.init(),xp(),e.start(),typeof e.enableXrayShortcut=="function"&&e.enableXrayShortcut(),x.devtools&&$x(e)})}am(hc);var Dx=hc;return ym(Px);})();
