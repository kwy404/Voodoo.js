...
`});var um={};or(um,{default:()=>cm});X();var z=class extends Error{constructor(n,r,o){let i=`${r}
${" ".repeat(Math.max(0,o))}^`;super(`${n}

${i}`);S(this,"source",r);S(this,"position",o);this.name="VoodooSyntaxError"}},yu=[">>>=","===","!==","**=","...",">>>","<<=",">>=","&&=","||=","??=","?.","=>","==","!=","<=",">=","&&","||","??","**","++","--","+=","-=","*=","/=","%=","&=","|=","^=","<<",">>","+","-","*","/","%","!","<",">","=","&","|","^","~","(",")","[","]","{","}",",",".","?",":",";"],bu=/[A-Za-z_$À-￿]/,wu=/[A-Za-z0-9_$À-￿]/;function Eu(e){return bu.test(e)}function xu(e){return wu.test(e)}function ur(e){return e>="0"&&e<="9"}var zs={n:`
...
Expression: ${r}`:n);S(this,"expression",r);this.name="VoodooRuntimeError"}},Vo=Symbol("spread"),An=class{constructor(t){S(this,"value",t)}};function Gs(e){return e instanceof An?e.value:e}var Mu=new Set(["__proto__","constructor","prototype"]);function ta(e){return typeof e=="string"&&Mu.has(e)}function Ye(e,t){if(ta(e))throw new J(`Access blocked to "${String(e)}": template expressions cannot reach the prototype chain. Expose a method in state instead.`,t);return e}function M(e,t){var n,r;switch(e.t){case"lit":return e.v;case"tpl":{let o=(n=e.quasis[0])!=null?n:"";for(let i=0;i<e.exprs.length;i++)o+=Qe(M(e.exprs[i],t)),o+=(r=e.quasis[i+1])!=null?r:"";return o}case"id":{Ye(e.n);let o=t.lookup(e.n);return o?o[e.n]:e.n in pe?pe[e.n]:void 0}case"member":{let o=M(e.o,t);if(o==null){if(e.opt)return;throw new J(`Could not read "${_o(e,t)}" from ${o===null?"null":"undefined"}`)}let i=Ye(e.computed?M(e.p,t):e.p.v);return o[i]}case"new":{let o=M(e.callee,t);if(typeof o!="function")throw new J(`Cannot construct ${Qe(o)}: it is not a constructor`);if(o===Function)throw new J("Cannot construct Function: expressions never compile code");let i=Js(e.args,t);return Reflect.construct(o,i)}case"call":{let o,i;if(e.callee.t==="member"){let s=M(e.callee.o,t);if(s==null){if(e.callee.opt||e.opt)return;throw new J(`Could not call "${_o(e.callee,t)}" from ${s===null?"null":"undefined"}`)}let a=Ye(e.callee.computed?M(e.callee.p,t):e.callee.p.v);o=s,i=s[a]}else if(e.callee.t==="id"){Ye(e.callee.n);let s=t.lookup(e.callee.n);s?(o=s,i=s[e.callee.n]):i=pe[e.callee.n]}else i=M(e.callee,t);if(i==null&&e.opt)return;if(typeof i!="function"){let s=e.callee.t==="id"?e.callee.n:_o(e.callee,t);throw e.callee.t==="id"&&!t.lookup(s)&&!(s in pe)?Su.has(s)?new J(`"${s}" is blocked. Expressions run in a sandbox without access to it.`):new J(`"${s}" was not found. Expressions cannot reach window: expose it with V.config.globals.${s} = ..., or put it in scope with V.data({ ${s} }).`):new J(`"${s}" is not a function`)}return i.apply(o,Js(e.args,t))}case"unary":{if(e.op==="...")return{[Vo]:M(e.a,t)};if(e.op==="delete"){if(e.a.t!=="member")throw new J("delete needs a property, as in `delete user.name` or `delete list[0]`");let i=M(e.a.o,t);if(i==null)return!0;let s=Ye(e.a.computed?M(e.a.p,t):e.a.p.v);return delete i[s]}if(e.op==="typeof"){if(e.a.t==="id"){if(ta(e.a.n))return"undefined";let i=t.lookup(e.a.n);return typeof(i?i[e.a.n]:pe[e.a.n])}return typeof M(e.a,t)}let o=M(e.a,t);switch(e.op){case"!":return!o;case"-":return-o;case"+":return+o;case"~":return~o;case"void":return}throw new J(`Unsupported unary operator: ${e.op}`)}case"update":{let o=Number(M(e.a,t)),i=e.op==="++"?o+1:o-1;return Zs(e.a,i,t),e.prefix?i:o}case"bin":{let o=M(e.l,t),i=M(e.r,t);switch(e.op){case"+":return o+i;case"-":return o-i;case"*":return o*i;case"/":return o/i;case"%":return o%i;case"**":return o**i;case"==":return o==i;case"!=":return o!=i;case"===":return o===i;case"!==":return o!==i;case"<":return o<i;case">":return o>i;case"<=":return o<=i;case">=":return o>=i;case"in":return o in i;case"instanceof":return o instanceof i;case"&":return o&i;case"|":return o|i;case"^":return o^i;case"<<":return o<<i;case">>":return o>>i;case">>>":return o>>>i}throw new J(`Unsupported operator: ${e.op}`)}case"logic":{let o=M(e.l,t);return e.op==="&&"?o&&M(e.r,t):e.op==="||"?o||M(e.r,t):o!=null?o:M(e.r,t)}case"cond":return M(e.test,t)?M(e.cons,t):M(e.alt,t);case"assign":{let o;if(e.op==="=")o=M(e.value,t);else if(e.op==="&&="||e.op==="||="||e.op==="??="){let i=M(e.target,t);if(!(e.op==="&&="?!!i:e.op==="||="?!i:i==null))return i;o=M(e.value,t)}else{let i=M(e.target,t),s=M(e.value,t);switch(e.op){case"+=":o=i+s;break;case"-=":o=i-s;break;case"*=":o=i*s;break;case"/=":o=i/s;break;case"%=":o=i%s;break;case"**=":o=i**s;break;default:throw new J(`Unsupported assignment: ${e.op}`)}}return Zs(e.target,o,t),o}case"if":return M(e.test,t)?M(e.cons,t):e.alt?M(e.alt,t):void 0;case"method":{let o=e.params,i=e.body;return function(...s){let a=Xs(o,s,t),l=this,c=l!==null&&typeof l=="object"?t.child(l):t;return Gs(M(i,c.child(a)))}}case"arrow":{let o=e.params,i=e.body;return(...s)=>Gs(M(i,t.child(Xs(o,s,t))))}case"obj":{let o={};for(let i of e.props)if(i.spread)Object.assign(o,M(i.spread,t));else{let s=Ye(i.key!==null?i.key:String(M(i.keyExpr,t)));if(i.getter){let a=M(i.value,t);Object.defineProperty(o,s,{enumerable:!0,configurable:!0,get(){return a.call(this)}});continue}o[s]=M(i.value,t)}return o}case"arr":{let o=[];for(let i of e.els)i&&typeof i=="object"&&"spread"in i?o.push(...M(i.spread,t)):o.push(M(i,t));return o}case"return":return new An(e.a?M(e.a,t):void 0);case"seq":{let o;for(let i of e.body)if(o=M(i,t),o instanceof An)return o;return o}}throw new J(`Unknown node: ${e.t}`)}function Wo(e,t,n,r){if(e.kind==="rest"){n[e.name]=t;return}if(e.def!==void 0&&t===void 0&&(t=M(e.def,r.child(n))),e.kind==="id"){n[e.name]=t;return}if(e.kind==="obj"){if(t==null)throw new J(`Cannot destructure ${t===null?"null":"undefined"}`);let i=new Set;for(let{key:s,value:a}of e.props)i.add(s),Wo(a,t[Ye(s)],n,r);if(e.rest){let s={};for(let a of Object.keys(t))i.has(a)||(s[a]=t[a]);n[e.rest]=s}return}let o=Array.isArray(t)?t:Array.from(t);e.elements.forEach((i,s)=>{i&&Wo(i,o[s],n,r)}),e.rest&&(n[e.rest]=o.slice(e.elements.length))}function Xs(e,t,n){let r={};for(let o=0;o<e.length;o++){let i=e[o];Wo(i,i.kind==="rest"?t.slice(o):t[o],r,n)}return r}function Js(e,t){let n=[];for(let r of e){let o=M(r,t);o&&typeof o=="object"&&Vo in o?n.push(...o[Vo]):n.push(o)}return n}function Zs(e,t,n){if(e.t==="id"){Ye(e.n),n.set(e.n,t);return}if(e.t==="member"){let r=M(e.o,n);if(r==null)throw new J("Could not write to null or undefined");let o=Ye(e.computed?M(e.p,n):e.p.v);r[o]=t;return}throw new J("Invalid assignment target")}function _o(e,t){return e.t==="member"?e.computed?String(M(e.p,t)):String(e.p.v):e.t==="id"?e.n:"value"}function Qe(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return String(e);if(e instanceof Date)return e.toLocaleString();if(typeof e=="object")try{return JSON.stringify(e)}catch(t){return String(e)}return String(e)}ee();X();var Sn=new Map;function H(e,t){Sn.set(e.startsWith("$")?e:`$${e}`,t)}var Ko=new Map;function Vt(e,t){Ko.set(e,t)}var xt=class e{constructor(t={},n=null,r=null){this.refs={},this.component=null,this.provides=null,this.magicCache=null,this.data=t,this.parent=n,this.el=r}get root(){let t=this;for(;t.parent;)t=t.parent;return t}inject(t,n){let r=this;for(;r;){if(r.provides&&t in r.provides)return r.provides[t];r=r.parent}return n}get owner(){let t=this;for(;t;){if(t.component)return t;t=t.parent}return null}get allRefs(){let t=[],n=this;for(;n;)t.unshift(n),n=n.parent;let r={};for(let o of t)Object.assign(r,o.refs);return r}lookup(t){let n=this;for(;n;){if(t in n.data)return n.data;n=n.parent}if(t.charCodeAt(0)===36&&Sn.has(t))return this.magicContainer(t,Sn);if(Ko.has(t))return this.magicContainer(t,Ko)}has(t){return this.lookup(t)!==void 0}get(t){let n=this.lookup(t);return n?n[t]:void 0}set(t,n){let r=this;for(;r;){if(t in r.data){r.data[t]=n;return}r=r.parent}this.data[t]=n}child(t={},n=null){return new e(t,this,n!=null?n:this.el)}reactiveChild(t,n=null){return new e(V(t),this,n!=null?n:this.el)}magicContainer(t,n){this.magicCache||(this.magicCache=new Map);let r=this.magicCache.get(t);if(r)return r;let o=n.get(t),i=this,s={};return Object.defineProperty(s,t,{get:()=>o(i),set:a=>{let l=o(i);l&&typeof l=="object"&&"set"in l&&l.set(a)},enumerable:!0,configurable:!0}),this.magicCache.set(t,s),s}},je=new xt(V({}));X();ee();ee();function Be(){return E.devtools===!0}function Xe(e){if(!e)return"(no element)";let t=e.tagName.toLowerCase();e.id&&(t+=`#${e.id}`);let n=(e.getAttribute("class")||"").trim().split(/\s+/).filter(Boolean);return n.length&&(t+=`.${n.slice(0,2).join(".")}`),`<${t}>`}function Tt(e){Be()&&console.warn(`[Voodoo] ${e}`)}var ra=new Set;function Mn(e,t){Be()&&(ra.has(e)||(ra.add(e),console.warn(`[Voodoo] ${t}`)))}var Cu=new Set(["confirm-title","confirm-label","confirm-cancel","hold-duration"]);function oa(e,t,n){Be()&&(Cu.has(n)||Mn(`unknown-directive:${n}`,`unknown directive "${t}" at ${Xe(e)}. No directive named "${n}" was registered. Check the spelling or register with V.directive("${n}", ...).`))}function ia(e,t){Mn(`unknown-component:${t}`,`component "${t}" not registered at ${Xe(e)}. Register with V.component("${t}", { ... }) before using the tag, or remove the attribute to leave the element as plain HTML.`)}function Yo(e,t,n,r){if(!Be())return;let o=r instanceof Error?r.message.split(`
...
`);s=(a=u.pop())!=null?a:"";for(let d of u)d.trim()&&t(d)}s.trim()&&t(s)},interceptors:{request:{use(e){return Lr.push(e),()=>{let t=Lr.indexOf(e);t>-1&&Lr.splice(t,1)}}},response:{use(e){return Ar.push(e),()=>{let t=Ar.indexOf(e);t>-1&&Ar.splice(t,1)}}},error:{use(e){return Pn.push(e),()=>{let t=Pn.indexOf(e);t>-1&&Pn.splice(t,1)}}}},setHeader(e,t){t===null?delete de.headers[e]:de.headers[e]=t},setToken(e,t="Bearer"){this.setHeader("Authorization",e?`${t} ${e}`:null)},setBaseURL(e){de.baseURL=e},clearCache:Dd,flushOfflineQueue:Wa,parseDuration:_};Ee();var jd=`
...
`;b("mute",({el:e,cleanup:t})=>{Q("mute",Dp);let n=()=>{let o=mt.muted;e.setAttribute("aria-pressed",String(o)),e.classList.toggle("v-muted",o),e.classList.toggle("v-mute-on",!o)},r=()=>{mt.toggle(),n(),mt.muted||mt.play("pop")};e.addEventListener("click",r),n(),t(()=>e.removeEventListener("click",r))});H("$sound",()=>mt);Ee();ee();Ee();ee();var Pp=/^#([0-9a-f])([0-9a-f])([0-9a-f])[0-9a-f]?$/i,Np=/^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})(?:[0-9a-f]{2})?$/i,Op=/^rgba?\(([^)]+)\)$/i,Fp=/^hsla?\(([^)]+)\)$/i;function Cc(e){return e.split(/[\s,/]+/).map(t=>parseFloat(t)).filter(t=>!Number.isNaN(t))}function $p(e,t,n){let r=(e%360+360)%360,o=be(t/100,0,1),i=be(n/100,0,1),s=(1-Math.abs(2*i-1))*o,a=s*(1-Math.abs(r/60%2-1)),l=i-s/2,c=Math.floor(r/60)%6,u=[[s,a,0],[a,s,0],[0,s,a],[0,a,s],[a,0,s],[s,0,a]],[d,f,p]=u[c];return{r:Math.round((d+l)*255),g:Math.round((f+l)*255),b:Math.round((p+l)*255)}}function We(e){let t=String(e!=null?e:"").trim();if(!t)return null;let n=Pp.exec(t);if(n)return{r:parseInt(n[1]+n[1],16),g:parseInt(n[2]+n[2],16),b:parseInt(n[3]+n[3],16)};let r=Np.exec(t);if(r)return{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)};let o=Op.exec(t);if(o){let[s,a,l]=Cc(o[1]);return s===void 0||a===void 0||l===void 0?null:{r:be(s,0,255),g:be(a,0,255),b:be(l,0,255)}}let i=Fp.exec(t);if(i){let[s,a,l]=Cc(i[1]);return s===void 0||a===void 0||l===void 0?null:$p(s,a,l)}return null}function be(e,t,n){return e<t?t:e>n?n:e}function En(e){let t=e/255;return t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function ls(e){return e<=.0031308?e*12.92:1.055*Math.pow(e,.4166666666666667)-.055}function Ip(e){let t=En(e.r),n=En(e.g),r=En(e.b),o=.4122214708*t+.5363325363*n+.0514459929*r,i=.2119034982*t+.6806995451*n+.1073969566*r,s=.0883024619*t+.2817188376*n+.6299787005*r,a=Math.cbrt(o),l=Math.cbrt(i),c=Math.cbrt(s);return{l:.2104542553*a+.793617785*l-.0040720468*c,a:1.9779984951*a-2.428592205*l+.4505937099*c,b:.0259040371*a+.7827717662*l-.808675766*c}}function jp(e){let t=e.l+.3963377774*e.a+.2158037573*e.b,n=e.l-.1055613458*e.a-.0638541728*e.b,r=e.l-.0894841775*e.a-1.291485548*e.b,o=t*t*t,i=n*n*n,s=r*r*r;return{r:ls(4.0767416621*o-3.3077115913*i+.2309699292*s),g:ls(-1.2684380046*o+2.6097574011*i-.3413193965*s),b:ls(-.0041960863*o-.7034186147*i+1.707614701*s)}}function fo(e){let t=Ip(e),n=Math.sqrt(t.a*t.a+t.b*t.b),r=Math.atan2(t.b,t.a)*180/Math.PI;return r<0&&(r+=360),{l:t.l,c:n,h:n<1e-5?0:r}}function Rc(e){let t=e.h*Math.PI/180;return jp({l:e.l,a:Math.cos(t)*e.c,b:Math.sin(t)*e.c})}function wn(e){let t=Math.max(0,e.c);for(let r=0;r<32;r++){let o=Rc({l:be(e.l,0,1),c:t,h:e.h});if(o.r>=-.001&&o.r<=1.001&&o.g>=-.001&&o.g<=1.001&&o.b>=-.001&&o.b<=1.001)return{r:Math.round(be(o.r,0,1)*255),g:Math.round(be(o.g,0,1)*255),b:Math.round(be(o.b,0,1)*255)};t*=.92}let n=Rc({l:be(e.l,0,1),c:0,h:e.h});return{r:Math.round(be(n.r,0,1)*255),g:Math.round(be(n.g,0,1)*255),b:Math.round(be(n.b,0,1)*255)}}function cs(e){return be(Math.round(e),0,255).toString(16).padStart(2,"0")}function $t(e){return`#${cs(e.r)}${cs(e.g)}${cs(e.b)}`}function bn(e,t){return`rgba(${Math.round(e.r)}, ${Math.round(e.g)}, ${Math.round(e.b)}, ${Number(t.toFixed(3))})`}function Oc(e){return $t(wn(e))}function ds(e){return .2126*En(e.r)+.7152*En(e.g)+.0722*En(e.b)}function fs(e,t){let n=typeof e=="string"?We(e):e,r=typeof t=="string"?We(t):t;if(!n||!r)return 1;let o=ds(n),i=ds(r),s=Math.max(o,i),a=Math.min(o,i);return(s+.05)/(a+.05)}var Fc={r:255,g:255,b:255},po={r:0,g:0,b:0};function Jn(e){let t=typeof e=="string"?We(e):e;return t?fs(t,Fc)>=fs(t,po)?"#ffffff":"#000000":"#ffffff"}var ps=[50,100,200,300,400,500,600,700,800,900],$c=[.973,.941,.889,.819,.732,.638,.558,.478,.399,.327],Bp=[.14,.26,.46,.68,.88,1,.97,.89,.78,.65],Ic=[.244,.286,.343,.408,.484,.588,.668,.748,.836,.928],qp=[.3,.42,.6,.78,.92,1,.92,.78,.57,.33];function jc(e,t=!1){var a;let n=typeof e=="string"?(a=We(e))!=null?a:po:e,r=fo(n),o=t?Ic:$c,i=t?qp:Bp,s={};return ps.forEach((l,c)=>{s[String(l)]=Oc({l:o[c],c:r.c*i[c],h:r.h})}),s}var mo={violeta:{primary:"#6D3BF5",accent:"#FF3D8B",success:"#16A34A",warning:"#D97706",danger:"#E11D48",info:"#7C6BFF"},oceano:{primary:"#0E7BC4",accent:"#0FB5C9",success:"#0F9D6E",warning:"#D08700",danger:"#DC2F3E",info:"#3B82F6"},floresta:{primary:"#1F8A4C",accent:"#7FA80E",success:"#18A05A",warning:"#C97A0A",danger:"#C93A2E",info:"#2C8FA8"},poente:{primary:"#E4632A",accent:"#D62F63",success:"#3E9B52",warning:"#D99000",danger:"#D32F2F",info:"#B45FC0"},grafite:{primary:"#4C5A70",accent:"#2E7FD1",success:"#2F8F60",warning:"#B57A12",danger:"#C2453F",info:"#5B7A99"}},Bc=["primary","accent","success","warning","danger","info"],ms="voodoo:palette",Hc="voodoo-palette",zp="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif",Up="ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace";function Dc(e,t){let n=(e!=null?e:"").trim();return n?n.includes(",")?n:`${/^['"]/.test(n)?n:`'${n}'`}, ${t}`:t}var _p=/^([\d.]+)(px|rem|em)$/;function Vp(e){let t=(e||"12px").trim(),n=_p.exec(t);if(!n)return{"--v-radius":t,"--v-radius-sm":`calc(${t} * 0.6)`,"--v-radius-lg":`calc(${t} * 1.5)`,"--v-radius-xl":`calc(${t} * 2)`,"--v-radius-full":"999px"};let r=parseFloat(n[1]),o=n[2],i=s=>`${Math.round(s*1e3)/1e3}${o}`;return{"--v-radius":i(r),"--v-radius-sm":i(Math.max(r*.55,0)),"--v-radius-lg":i(r*1.5),"--v-radius-xl":i(r*2),"--v-radius-full":"999px"}}function Pc(e,t){var c,u,d,f;let n={},r={},o={};for(let p of Bc){let m=(c=We(e[p]))!=null?c:po,v=fo(m),g=jc(m,t);r[p]=g;for(let B of ps)n[`--v-${p}-${B}`]=g[String(B)];let h=t?{l:Math.max(v.l,.62),c:v.c*.95,h:v.h}:v,y=t?{l:Math.min(h.l+.07,.94),c:h.c*.95,h:h.h}:{l:Math.max(h.l-.055,.12),c:h.c,h:h.h},w=t?{l:Math.min(h.l+.13,.97),c:h.c*.88,h:h.h}:{l:Math.max(h.l-.105,.1),c:h.c,h:h.h},T=wn(h),x=wn(y),C=wn(w);n[`--v-${p}`]=$t(t?T:m),n[`--v-${p}-hover`]=$t(x),n[`--v-${p}-active`]=$t(C),n[`--v-${p}-contrast`]=Jn(t?T:m),n[`--v-${p}-contrast-hover`]=Jn(x),n[`--v-${p}-contrast-active`]=Jn(C);let N=g[50],R=g[100],le=t?g[800]:g[700];n[`--v-${p}-soft`]=N,n[`--v-${p}-soft-hover`]=R,n[`--v-${p}-soft-text`]=le,n[`--v-${p}-ring`]=bn(T,t?.45:.32),n[`--v-${p}-border`]=t?g[300]:g[200],o[p]=n[`--v-${p}-contrast`]}let i=(d=We((u=e.neutral)!=null?u:e.primary))!=null?d:po,s=fo(i).h,a=(p,m)=>Oc({l:p,c:m,h:s}),l={};if(ps.forEach((p,m)=>{let v=t?Ic:$c;l[String(p)]=a(v[m],.012),n[`--v-neutral-${p}`]=l[String(p)]}),r.neutral=l,t)n["--v-surface"]=a(.248,.021),n["--v-surface-2"]=a(.196,.021),n["--v-surface-3"]=a(.305,.024),n["--v-surface-inset"]=a(.17,.02),n["--v-text"]=a(.965,.008),n["--v-text-muted"]=a(.748,.017),n["--v-text-soft"]=a(.63,.017),n["--v-border"]=a(.355,.023),n["--v-border-strong"]=a(.46,.026),n["--v-overlay"]="rgba(0, 0, 0, 0.62)",n["--v-shadow-sm"]="0 1px 2px rgba(0, 0, 0, 0.5)",n["--v-shadow"]="0 10px 30px rgba(0, 0, 0, 0.5)",n["--v-shadow-lg"]="0 24px 60px rgba(0, 0, 0, 0.62)";else{let p=wn({l:.24,c:.028,h:s});n["--v-surface"]=a(1,0),n["--v-surface-2"]=a(.981,.006),n["--v-surface-3"]=a(.955,.009),n["--v-surface-inset"]=a(.968,.008),n["--v-text"]=$t(p),n["--v-text-muted"]=a(.53,.023),n["--v-text-soft"]=a(.655,.018),n["--v-border"]=a(.906,.012),n["--v-border-strong"]=a(.828,.016),n["--v-overlay"]=bn(p,.45),n["--v-shadow-sm"]=`0 1px 2px ${bn(p,.08)}`,n["--v-shadow"]=`0 10px 30px ${bn(p,.14)}`,n["--v-shadow-lg"]=`0 24px 60px ${bn(p,.2)}`}return n["--v-focus-ring"]=n["--v-primary-ring"],o.surface=Jn((f=We(n["--v-surface"]))!=null?f:Fc),{vars:n,scales:r,contrast:o}}function us(e,t){let n=Object.entries(t).map(([r,o])=>`  ${r}: ${o};`).join(`
`);return`${e} {
${n}
}`}var er=null,Zn=null;function Wp(e){var r,o,i,s,a,l,c,u,d;let t=(r=mo[e.preset])!=null?r:mo.violeta,n={primary:(o=e.primary)!=null?o:t.primary,accent:(i=e.accent)!=null?i:t.accent,success:(s=e.success)!=null?s:t.success,warning:(a=e.warning)!=null?a:t.warning,danger:(l=e.danger)!=null?l:t.danger,info:(c=e.info)!=null?c:t.info,neutral:(u=e.neutral)!=null?u:t.neutral};for(let f of Bc)We(n[f])||(console.warn(`[Voodoo] invalid color in palette.${f}: "${n[f]}". Using preset.`),n[f]=t[f]);return{colors:n,radius:(d=e.radius)!=null?d:"12px",font:Dc(e.font,zp),mono:Dc(e.monoFont,Up)}}function Kp(e){if(typeof document=="undefined"||!E.injectStyles)return;se();let t=document.getElementById(Hc);t||(t=document.createElement("style"),t.id=Hc,t.setAttribute("data-voodoo","palette"),document.head.appendChild(t)),t.textContent=e}function uo(e={}){let{colors:t,radius:n,font:r,mono:o}=Wp(e),i=Pc(t,!1),s=Pc(t,!0),a={...Vp(n),"--v-font-sans":r,"--v-font-mono":o},l=["/* Palette generated by V.palette(). Do not edit manually. */",us(":root",{...a,...i.vars}),`@media (prefers-color-scheme: dark) {
${us(':root:not([data-theme="light"])',s.vars)}
}`,us(':root[data-theme="dark"]',s.vars)].join(`
`);Kp(l);let c={colors:t,radius:n,font:r,monoFont:o,light:i.scales,dark:s.scales,contrast:i.contrast,css:l};if(er=c,Zn={...e},e.persist!==!1&&typeof document!="undefined"){let u={...e};delete u.persist,G.set(ms,u)}return typeof document!="undefined"&&document.dispatchEvent(new CustomEvent("voodoo:palette",{detail:c})),c}var Nc=!1;function gs(){if(er&&Nc)return er;Nc=!0;let e=G.get(ms),t=e&&typeof e=="object"?{...e,persist:!1}:{persist:!1};return uo(t)}function vs(){er||gs()}function hs(){return gs()}var qc=Object.assign(uo,{presets:mo,get names(){return Object.keys(mo)},get current(){return er},get options(){return Zn},init:gs,ensure:vs,reset(){return G.remove(ms),uo({persist:!1})},use(e){return uo({...Zn!=null?Zn:{},preset:e,primary:void 0,accent:void 0})},scale:jc,contrastText:Jn,contrastRatio:fs,luminance(e){let t=typeof e=="string"?We(e):e;return t?ds(t):0},convert:{parseColor:We,rgbToOklch:fo,oklchToRgb:wn,toHex:$t,toRgba:bn}});var $e={confirm:"Confirm",cancel:"Cancel",ok:"OK",close:"Close",confirmQuestion:"Are you sure?",required:"Please fill in this field."},ws={duration:220,size:"md"},Yp=`
...
`;function yo(){se(),vs(),Q("dialog",Yp)}var Es={info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.6v.2"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m8.2 12.3 2.6 2.6 5-5.2"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4.6 2.9 19.4h18.2z"/><path d="M12 10v4M12 17.2v.2"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/></svg>',question:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M9.6 9.4a2.4 2.4 0 1 1 3.2 2.3c-.6.2-.8.7-.8 1.3v.5M12 16.6v.2"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg>'},Ce=[],xs=new WeakMap,Ts=0,zc="",Uc="";function Qp(){if(Ts++>0)return;let e=document.body;zc=e.style.overflow,Uc=e.style.paddingRight;let t=window.innerWidth-document.documentElement.clientWidth;if(e.style.overflow="hidden",t>0){let n=parseFloat(getComputedStyle(e).paddingRight)||0;e.style.paddingRight=`${n+t}px`}}function Gp(){Ts!==0&&(--Ts>0||(document.body.style.overflow=zc,document.body.style.paddingRight=Uc))}var Xp='a[href],area[href],button:not([disabled]),input:not([disabled]):not([type="hidden"]),select:not([disabled]),textarea:not([disabled]),iframe,object,embed,[contenteditable="true"],[tabindex]:not([tabindex="-1"])';function ks(e){return Array.from(e.querySelectorAll(Xp)).filter(t=>t.hasAttribute("disabled")||t.getAttribute("aria-hidden")==="true"?!1:t.offsetWidth>0||t.offsetHeight>0||t.getClientRects().length>0)}function Ls(){return Ce[Ce.length-1]}function Jp(){return typeof matchMedia!="undefined"&&matchMedia("(prefers-reduced-motion: reduce)").matches}var ho=!1;function _c(e){let t=Ls();if(!t)return;if(e.key==="Escape"){if(t.options.closeOnEscape===!1)return;e.preventDefault(),t.handle.close(void 0);return}if(e.key!=="Tab")return;let n=ks(t.handle.panel);if(!n.length){e.preventDefault(),t.handle.panel.focus();return}let r=n[0],o=n[n.length-1],i=document.activeElement;e.shiftKey&&(i===r||!t.handle.panel.contains(i))?(e.preventDefault(),o.focus()):!e.shiftKey&&i===o&&(e.preventDefault(),r.focus())}function Vc(e){var o;let t=Ls();if(!t)return;let n=e.target;if(n&&t.handle.root.contains(n))return;((o=ks(t.handle.panel)[0])!=null?o:t.handle.panel).focus()}function Zp(){ho||(ho=!0,document.addEventListener("keydown",_c,!0),document.addEventListener("focusin",Vc,!0))}function em(){ho&&(ho=!1,document.removeEventListener("keydown",_c,!0),document.removeEventListener("focusin",Vc,!0))}function Wc(e){var f,p,m,v,g,h,y;yo();let t=ue("v-dialog-"),n=Jp()?0:ws.duration,r=document.createElement("div");r.className="v-dialog-root",r.id=t,r.setAttribute("data-size",(f=e.size)!=null?f:ws.size),r.setAttribute("data-position",(p=e.position)!=null?p:"center"),r.style.setProperty("--v-dialog-ms",`${n}ms`),r.style.setProperty("--v-dialog-layer",String(Ce.length*2));let o=document.createElement("div");o.className="v-dialog-backdrop",r.appendChild(o);let i=document.createElement("div");i.className="v-dialog-panel",e.plain&&i.classList.add("is-plain"),e.className&&i.classList.add(...e.className.split(/\s+/).filter(Boolean)),i.setAttribute("role",(m=e.role)!=null?m:"dialog"),i.setAttribute("aria-modal","true"),i.tabIndex=-1,e.labelledBy?i.setAttribute("aria-labelledby",e.labelledBy):e.ariaLabel&&i.setAttribute("aria-label",e.ariaLabel),e.describedBy&&i.setAttribute("aria-describedby",e.describedBy),r.appendChild(i);let s=document.createElement("div");if(s.className="v-dialog-body",e.source){let w=document.createComment(" v-modal ");(v=e.source.parentNode)==null||v.insertBefore(w,e.source),ys.set(e.source,w),e.source.classList.add("v-dialog-open"),e.source.removeAttribute("hidden"),s.appendChild(e.source)}else e.content&&s.appendChild(e.content);if(i.appendChild(s),e.closable!==!1){let w=document.createElement("button");w.type="button",w.className="v-dialog-x",w.setAttribute("aria-label",$e.close),w.innerHTML=Es.close,w.addEventListener("click",()=>u.close(void 0)),i.appendChild(w)}let a=!1,l=()=>{},c=new Promise(w=>{l=w}),u={id:t,root:r,panel:i,body:s,key:(g=e.key)!=null?g:null,source:(h=e.source)!=null?h:null,closed:c,close(w){if(a)return;a=!0;let T=Ce.findIndex(C=>C.handle===u);T>-1&&Ce.splice(T,1),xs.delete(r),d.locked&&Gp(),Ce.length||em(),r.classList.remove("is-open"),r.classList.add("is-closing");let x=()=>{var N;let C=e.source;if(C){let R=ys.get(C);C.classList.remove("v-dialog-open"),R&&R.parentNode?(R.parentNode.insertBefore(C,R),R.remove()):C.remove(),ys.delete(C),ri(C,"modal-content")&&C.setAttribute("hidden","")}if(r.remove(),(N=e.onClose)==null||N.call(e,w,u),l(w),e.restoreFocus!==!1){let R=d.previousFocus;R&&typeof R.focus=="function"&&R.isConnected&&R.focus()}};n>0?setTimeout(x,n):x()}},d={handle:u,options:e,previousFocus:document.activeElement,locked:e.lockScroll!==!1};return o.addEventListener("click",()=>{e.closeOnBackdrop!==!1&&u.close(void 0)}),d.locked&&Qp(),Ce.push(d),xs.set(r,d),Zp(),document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add("is-open");let w=tm(e,i);w==null||w.focus()}),(y=e.onOpen)==null||y.call(e,u),u}var ys=new WeakMap;function tm(e,t){var i;let n=e.initialFocus;if(n instanceof HTMLElement)return n;if(typeof n=="string"){let s=t.querySelector(n);if(s)return s}let r=t.querySelector("[autofocus],[data-autofocus]");return r||((i=ks(t)[0])!=null?i:t)}function nm(e){if(e instanceof HTMLElement)return e;let t=String(e!=null?e:"").trim();if(!t)return null;let n=/^[\w-]+$/.test(t)?`#${t}`:t;return document.querySelector(n)}function go(e){return typeof e=="string"?e.trim()||null:e.id?`#${e.id}`:null}function vo(e){let t=/^[\w-]+$/.test(e)?`#${e}`:e;return Ce.find(n=>{var o;if(n.handle.key===e||n.handle.key===t)return!0;let r=n.handle.source;return!!r&&((o=r.matches)==null?void 0:o.call(r,t))})}var It={open(e,t={}){var s,a;let n=nm(e);if(!n)return console.warn(`[Voodoo] modal.open: target not found (${String(e)}).`),null;let r=(s=go(e))!=null?s:n.id?`#${n.id}`:null,o=r?vo(r):void 0;if(o)return o.handle;let i=n.querySelector("[data-dialog-title],h1,h2,h3");return i&&!i.id&&(i.id=ue("v-dialog-title-")),Wc({...t,source:n,key:r,labelledBy:(a=i==null?void 0:i.id)!=null?a:null})},close(e,t){var o;if(e===void 0){(o=Ls())==null||o.handle.close(t);return}let n=go(e),r=n?vo(n):void 0;r==null||r.handle.close(t)},closeAll(e){for(let t of[...Ce].reverse())t.handle.close(e)},toggle(e,t={}){let n=go(e),r=n?vo(n):void 0;return r?(r.handle.close(void 0),null):this.open(e,t)},isOpen(e){if(e===void 0)return Ce.length>0;let t=go(e);return!!(t&&vo(t))},get opened(){return Ce.map(e=>e.handle)},get count(){return Ce.length},configure(e){Object.assign(ws,e)},labels(e){return Object.assign($e,e),$e}};function xn(e){var a,l;yo();let t=document.createDocumentFragment(),n=e.title?ue("v-dialog-title-"):null,r=e.description?ue("v-dialog-desc-"):null,o=null;if(e.title||e.description||e.icon){o=document.createElement("div"),o.className="v-dialog-head";let c=e.icon&&e.icon!=="none"?e.icon:null;if(c&&Es[c]){let d=document.createElement("div");d.className="v-dialog-icon",d.setAttribute("aria-hidden","true"),d.setAttribute("data-tone",(a=e.tone)!=null?a:rm(c)),d.innerHTML=Es[c],o.appendChild(d)}let u=document.createElement("div");if(u.className="v-dialog-heading",e.title){let d=document.createElement("h2");d.className="v-dialog-title",d.id=n,d.textContent=e.title,u.appendChild(d)}if(e.description){let d=document.createElement("p");d.className="v-dialog-desc",d.id=r,d.textContent=e.description,u.appendChild(d)}o.appendChild(u)}let i=document.createDocumentFragment();if(e.text)for(let c of e.text.split(`
